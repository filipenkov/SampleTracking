...
:showhelp
echo.
echo Usage: atlas-create-fecru-plugin [options]
echo.
...
echo Executing: %MAVEN_EXECUTABLE% com.atlassian.maven.plugins:maven-fecru-plugin:3.6.1:create %MVN_PARAMS%
%MAVEN_EXECUTABLE% com.atlassian.maven.plugins:maven-fecru-plugin:3.6.1:create %MVN_PARAMS%
