...
:showhelp
echo.
echo Usage: atlas-release [options]
echo.
...
echo Executing: %MAVEN_EXECUTABLE% com.atlassian.maven.plugins:maven-amps-dispatcher-plugin:3.6.1:release %MVN_PARAMS%
%MAVEN_EXECUTABLE% com.atlassian.maven.plugins:maven-amps-dispatcher-plugin:3.6.1:release %MVN_PARAMS%
