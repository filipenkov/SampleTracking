...
echo Executing: %MAVEN_EXECUTABLE% com.atlassian.maven.plugins:maven-refapp-plugin:3.6.1:create %MVN_PARAMS%
%MAVEN_EXECUTABLE% com.atlassian.maven.plugins:maven-refapp-plugin:3.6.1:create %MVN_PARAMS%
