...
:showhelp
echo.
echo Usage: atlas-create-crowd-plugin [options]
echo.
...
echo Executing: %MAVEN_EXECUTABLE% com.atlassian.maven.plugins:maven-crowd-plugin:3.6.1:create %MVN_PARAMS%
%MAVEN_EXECUTABLE% com.atlassian.maven.plugins:maven-crowd-plugin:3.6.1:create %MVN_PARAMS%
