...
:showhelp
echo.
echo Usage: atlas-create-jira-plugin-module [options]
echo.
...
echo Executing: %MAVEN_EXECUTABLE% com.atlassian.maven.plugins:maven-jira-plugin:3.6.1:create-plugin-module %MVN_PARAMS%
%MAVEN_EXECUTABLE% com.atlassian.maven.plugins:maven-jira-plugin:3.6.1:create-plugin-module %MVN_PARAMS%
