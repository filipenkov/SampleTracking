...
:showhelp
echo.
echo Usage: atlas-create-crowd-plugin-module [options]
echo.
...
echo Executing: %MAVEN_EXECUTABLE% com.atlassian.maven.plugins:maven-crowd-plugin:3.6.1:create-plugin-module %MVN_PARAMS%
%MAVEN_EXECUTABLE% com.atlassian.maven.plugins:maven-crowd-plugin:3.6.1:create-plugin-module %MVN_PARAMS%
