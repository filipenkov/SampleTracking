...
:showhelp
echo.
echo Usage: atlas-create-bamboo-plugin [options]
echo.
...
echo Executing: %MAVEN_EXECUTABLE% com.atlassian.maven.plugins:maven-bamboo-plugin:3.6.1:create %MVN_PARAMS%
%MAVEN_EXECUTABLE% com.atlassian.maven.plugins:maven-bamboo-plugin:3.6.1:create %MVN_PARAMS%
