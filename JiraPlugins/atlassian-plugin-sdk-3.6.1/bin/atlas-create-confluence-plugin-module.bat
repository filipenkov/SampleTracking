...
echo Executing: %MAVEN_EXECUTABLE% com.atlassian.maven.plugins:maven-confluence-plugin:3.6.1:create-plugin-module %MVN_PARAMS%
%MAVEN_EXECUTABLE% com.atlassian.maven.plugins:maven-confluence-plugin:3.6.1:create-plugin-module %MVN_PARAMS%
