...
public class AuthenticatorAccessor
{
    ...
    {
    	final List<AuthenticationProviderModuleDescriptor> descriptors = pluginAccessor.getEnabledModuleDescriptorsByClass(AuthenticationProviderModuleDescriptor.class);
