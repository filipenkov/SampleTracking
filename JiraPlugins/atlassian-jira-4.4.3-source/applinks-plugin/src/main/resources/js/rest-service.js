...
AJS.toInit(function() {
    AppLinks = AJS.$.extend(window.AppLinks || {}, {
        ...
        SPI: {
            BASE_URL: AJS.params.contextPath + "/rest/applinks/1.0",
            ...
            verifyTwoWayLinkDetails : function (remoteUrl, rpcUrl, username, password, success, failure) {
                var url = AppLinks.SPI.BASE_URL + '/applicationlinkForm/details/?username='+ encodeURIComponent(username) + "&password=" + encodeURIComponent(password) + "&remoteUrl=" + encodeURIComponent(remoteUrl) + "&rpcUrl=" + encodeURIComponent(rpcUrl);
                AppLinks.get(url, success, failure);
            },
