            ...
            settings = {
                ...
                onshow: function(popup) {
                    ...
                    if (currentApplication.hasOutgoing === true) {
                        $("#outgoing-auth").attr("src", AJS.params.contextPath + "/plugins/servlet/applinks/auth/conf/config-tabs?direction=OUTBOUND&applicationId=" + currentApplication.id);
                    ...
                    if (currentApplication.hasIncoming === true){
                        $("#incoming-auth").attr("src", AJS.params.contextPath + "/plugins/servlet/applinks/auth/conf/config-tabs?direction=INBOUND&applicationId=" + currentApplication.id);
