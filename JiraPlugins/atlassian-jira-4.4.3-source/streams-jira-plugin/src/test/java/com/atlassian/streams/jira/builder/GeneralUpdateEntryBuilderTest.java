...
public class GeneralUpdateEntryBuilderTest
{
    ...
    {
        Parameters<HasId, HasPostedDate, HasAlternateLinkUri, HasApplicationType, NeedsRenderer, NeedsActivityObject, NeedsVerb, NeedsAuthors> params = newParams();
    ...
    private Parameters<HasId, HasPostedDate, HasAlternateLinkUri, HasApplicationType, NeedsRenderer, NeedsActivityObject, NeedsVerb, NeedsAuthors> newParams()
    {
        return params().
            id(URI.create("urn:1")).
