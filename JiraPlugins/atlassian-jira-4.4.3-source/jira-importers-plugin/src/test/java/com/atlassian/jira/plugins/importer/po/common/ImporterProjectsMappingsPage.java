...
public class ImporterProjectsMappingsPage extends AbstractImporterWizardPage {
	@Override
	...
	public ImporterProjectsMappingsPage editProject(String id, @Nullable String name, @Nullable String key, @Nullable String lead) {
		driver.findElement(By.id(ImporterProjectMappingsPage.getProjectFieldId(id) + "_project_edit")).click();

		fillProjectDetails(driver, name, key);

		return this;
	}

	public ImporterProjectsMappingsPage createProject(String id, @Nullable String name, @Nullable String key) {
		createProject(driver, ImporterProjectMappingsPage.getProjectFieldId(id), name, key);
		return this;
	}

	public static void createProject(AtlassianWebDriver driver, String id, @Nullable String name, @Nullable String key) {
