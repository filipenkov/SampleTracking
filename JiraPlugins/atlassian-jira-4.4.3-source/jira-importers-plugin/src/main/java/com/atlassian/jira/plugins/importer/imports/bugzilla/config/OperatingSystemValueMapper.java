...
public class OperatingSystemValueMapper extends AbstractValueMappingDefinition {
	private static final String COMPUTER_FIELD = "op_sys";

	public OperatingSystemValueMapper(final JdbcConnection jdbcConnection, final JiraAuthenticationContext authenticationContext) {
	...
	public String getDescription() {
		return getI18n().getText("jira-importer-plugin.config.bugzilla.mappings.value.os");
	}
