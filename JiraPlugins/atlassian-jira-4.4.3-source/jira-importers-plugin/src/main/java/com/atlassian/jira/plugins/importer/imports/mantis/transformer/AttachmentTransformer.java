...
public class AttachmentTransformer extends AbstractAttachmentTransformer {
	...
	public AttachmentTransformer(final String ixBug, MantisConfigBean configBean, SiteConfiguration mantisUrl,
			ImportLogger log) {
		this.ixBug = ixBug;
	...
	public ExternalAttachment transform(final ResultSet rs) throws SQLException {
		...
		if (StringUtils.isNotBlank(fileName)) {
			...
			try {
				...
				externalAttachment = new ExternalAttachment(fileName, file, configBean.getTimestamp(rs, "date_added"));
