...
public class ExternalUtilsBuilder {
	...
	public ExternalUtilsBuilder setComponentManager(ProjectComponentManager componentManager) {
		this.componentManager = componentManager;
		return this;
	}

	public ExternalUtilsBuilder setCustomFieldManager(CustomFieldManager customFieldManager) {
	...
	public ExternalUtilsBuilder setFieldScreenManager(FieldScreenManager fieldScreenManager) {
	...
	public ExternalUtilsBuilder setFieldConfigSchemeManager(FieldConfigSchemeManager fieldConfigSchemeManager) {
		this.fieldConfigSchemeManager = fieldConfigSchemeManager;
		return this;
	}

	public ExternalUtilsBuilder setJiraContextTreeManager(JiraContextTreeManager treeManager) {
	...
	public ExternalUtils createExternalUtils() {
		return new ExternalUtils(projectManager, issueManager, authenticationContext,
				versionManager, componentManager, customFieldManager,
				constantsManager, workflowManager, fieldScreenManager, permissionManager,
				...
				fieldConfigSchemeManager, treeManager);
	}
