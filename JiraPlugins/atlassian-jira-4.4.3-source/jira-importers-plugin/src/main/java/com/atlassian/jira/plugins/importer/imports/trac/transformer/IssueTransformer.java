...
public class IssueTransformer extends AbstractIssueTransformer<TracConfigBean> {
	...
	private final SimpleExternalLabelsMapper.CreateLabelFromString labelFactory = new SimpleExternalLabelsMapper.CreateLabelFromString();
	...
	public ExternalIssue transform(final ResultSet rs) throws SQLException {
		...
		externalIssue.setLabels(LabelParser.buildFromString(labelFactory, rs.getString("keywords")));
