...
import com.atlassian.jira.plugins.importer.web.trac.TracSetupPage;
...
public class TracImporterController extends AbstractImporterController {
	...
	public TracImporterController(JiraDataImporter importer, ExternalUtils utils, TracWikiConverter wikiConverter) {
	...
	public String getTitle() {
		return utils.getAuthenticationContext().getI18nHelper().getText("jira-importer-plugin.external.trac");
	}

	@Override
	public String getDescription() {
		return utils.getAuthenticationContext().getI18nHelper().getText("jira-importer-plugin.external.trac.description");
	}
	...
	public ImportProcessBean createImportProcessBean(AbstractSetupPage setupPage) {
		...
		try {
			...
			File temporaryConfigFile = setupPage.getMultipart().getFile(TracSetupPage.CONFIG_FILE_INPUT_NAME);
	...
	public String getSupportedVersions() {
		return utils.getAuthenticationContext().getI18nHelper().getText("jira-importer-plugin.external.trac.versions");
	}
