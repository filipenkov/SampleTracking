...
public interface EntityAsEventService
{
    ...
    static class IssueDateResult
    {
        ...
        public IssueDateResult(User assignee, DateTime start, DateTime end, boolean allDay, String issueKey, String issueSummary, String issueDescription, String type, String typeIconUrl, String status, String statusIconUrl, DateTime issueCreated, DateTime issueUpdated)
        {
