...
import com.atlassian.core.cron.MockI18nBean;
 ...
 * TODO: javadoc
 */
public class TestCronExpressionDescriptor extends TestCase
{
    private void assertPrettySchedule(String expectedPretty, String cronString)
    {
        ...
        MockI18nBean i18n = new MockI18nBean(); // locale specific test
