 ...
 * Last CVS Commit: $Date: 2006/05/12 04:45:29 $
 * Author of last CVS Commit: $Author: nmenere $
...
public class DefaultVelocityManager implements VelocityManager
{
    ...
    private static final Category log = Category.getInstance(DefaultVelocityManager.class);
