...
{
    public MockAbstractMailServer(Long id, String name, String description, MailProtocol protocol, String serverName, String port, String username, String password )
    {
        super(id, name, description, protocol, serverName, port, username, password, 10000);
    }
