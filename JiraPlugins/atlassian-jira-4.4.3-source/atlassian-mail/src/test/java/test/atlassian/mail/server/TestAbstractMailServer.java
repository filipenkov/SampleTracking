...
public class TestAbstractMailServer extends TestCase
{
    ...
    {
        MockAbstractMailServer mams = new MockAbstractMailServer(1L, "name", "desc", MailProtocol.POP,"serverName", "port", "username", "password");
    ...
    {
        MockAbstractMailServer mams = new MockAbstractMailServer(1L, "name", "desc", MailProtocol.POP,"serverName","port", "", "");
    ...
    public void testSystemPropertiesAreSet()
    {
        ...
        try
        {
            ...
            mams = new MockAbstractMailServer(1L, "name", "desc", MailProtocol.POP,"serverName","port", "", "");
