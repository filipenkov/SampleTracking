---------------------------------------------------------------------
JIRA @VERSION@-#@BUILD_NUMBER@ STANDALONE DISTRIBUTION README
---------------------------------------------------------------------

Thank you for downloading the JIRA @VERSION@ - Standalone distribution. This
distribution comes with a built-in Tomcat @TOMCAT_VERSION@ application server,
so it runs (almost) out the box.
...
2. Set the JAVA_HOME variable to where you installed Java. Windows installers
   may do this for you. See the following instructions for details:
...
http://docs.atlassian.com/jira/docs-@DOCS_VERSION@/Installing+JIRA+Standalone
