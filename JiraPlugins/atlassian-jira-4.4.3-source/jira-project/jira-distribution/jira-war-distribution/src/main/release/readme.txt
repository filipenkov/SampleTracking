...
You can also download the standalone distribution which is bundled with
Apache Tomcat and will run out of the box. This distribution is a lot easier
to set up and you can always migrate your data between JIRA installations
