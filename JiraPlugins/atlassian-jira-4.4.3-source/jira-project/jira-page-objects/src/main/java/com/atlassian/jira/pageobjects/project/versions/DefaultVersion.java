...
public class DefaultVersion implements Version
{
    ...
    {
        version.find(ByJquery.$(".jira-restfultable-editable[data-field-name=" + fieldName + "]")).click();
    ...
    public VersionOperationDropdown openOperationsCog()
    {
        ...
        driver.executeScript("jQuery('#" + version.getAttribute("id") + "').addClass('jira-restfultable-active')");

        PageElement operationsCog = version.find(getOperationsCogLocator());
        
        operationsCog.javascript().hover();
