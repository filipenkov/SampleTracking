...
public class Component
{
    ...
    public DeleteComponentDialog delete()
    {
        ...
        atlassianWebDriver.executeScript("jQuery('#" + row.getAttribute("id") + "').addClass('jira-restfultable-active')");
        row.find(By.className("project-config-component-delete")).click();
