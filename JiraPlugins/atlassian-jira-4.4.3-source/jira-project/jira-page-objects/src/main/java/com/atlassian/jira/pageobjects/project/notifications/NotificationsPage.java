...
import com.atlassian.jira.pageobjects.project.summary.notifications.ViewMailServers;
...
public class NotificationsPage extends AbstractJiraPage
{
    ...
    public ViewMailServers configureMailServer()
    {
        configureMailServer.click();
        return binder.bind(ViewMailServers.class);
    }
