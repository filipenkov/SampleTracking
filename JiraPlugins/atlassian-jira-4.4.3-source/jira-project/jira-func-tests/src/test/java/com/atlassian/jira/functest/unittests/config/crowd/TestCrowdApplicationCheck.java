...
public class TestCrowdApplicationCheck
{
    ...
    public void testCheckWithGoodApplications()
    {
        ...
        config.setCrowdApplications(asList(application1, application2));
    ...
    public void testCheckWithBadApplications() throws Exception
    {
        ...
        JiraConfig config = new JiraConfig();
        config.setCrowdApplications(asList(application1, application2, application3));
    ...
    public void testFixWithGoodApplications()
    {
        ...
        Assert.assertEquals(asList(application1, application2), config.getCrowdApplications());
    }
    ...
    public void testFixWithBadApplications() throws Exception
    {
        ...
        Assert.assertEquals(asList(expectedApplication1, expectedApplication2, expectedApplication3), config.getCrowdApplications());
    }
    ...
    public void testFixWithBadApplicationsButDisabled() throws Exception
    {
        ...
        Assert.assertEquals(asList(application1, application2, application3), config.getCrowdApplications());
    }
