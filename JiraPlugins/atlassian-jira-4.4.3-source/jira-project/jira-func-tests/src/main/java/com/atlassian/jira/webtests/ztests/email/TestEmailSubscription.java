...
/**
 * Test email subscriptions in JIRA. This does not test shared subscriptions to shared filters as these are not present
 * on standard.
 * <p/>
...
public class TestEmailSubscription extends AbstractSubscriptionEmailTest
{
    ...
    public void testGroupZeroResults() throws Exception
    {
        ...
        assertTextMessageValid(currentMessage, FilterConfig.ADMIN_FILTER_ZERO_RESULTS, EmailFuncTestCase.DEAFULT_FROM_ADDRESS, ADMIN_EMAIL, ADMIN_USERNAME);
        ...
        assertTextMessageValid(currentMessage, FilterConfig.ADMIN_FILTER_ZERO_RESULTS, EmailFuncTestCase.DEAFULT_FROM_ADDRESS, BOB_EMAIL, ADMIN_USERNAME);
        ...
        assertHtmlMessageValid(currentMessage, FilterConfig.ADMIN_FILTER_ZERO_RESULTS, EmailFuncTestCase.DEAFULT_FROM_ADDRESS, FRED_EMAIL, ADMIN_USERNAME);
        body = EmailKit.getBody(currentMessage);
        assertNotPartialLink(body);
        assertNotEditLink(body);
    }
    ...
    public void testGroupCompleteResults() throws Exception
    {
        ...
        assertTextMessageValid(currentMessage, FilterConfig.ADMIN_FILTER_FULL, EmailFuncTestCase.DEAFULT_FROM_ADDRESS, ADMIN_EMAIL, ADMIN_USERNAME);
        String body = EmailKit.getBody(currentMessage);
        assertNotPartialLink(body);
        assertEditLink(body);
        ...
        assertTextMessageValid(currentMessage, FilterConfig.ADMIN_FILTER_FULL, EmailFuncTestCase.DEAFULT_FROM_ADDRESS, BOB_EMAIL, ADMIN_USERNAME);
        body = EmailKit.getBody(currentMessage);
        assertNotPartialLink(body);
        assertNotEditLink(body);
        ...
        assertHtmlMessageValid(currentMessage, FilterConfig.ADMIN_FILTER_FULL, EmailFuncTestCase.DEAFULT_FROM_ADDRESS, FRED_EMAIL, ADMIN_USERNAME);
        body = EmailKit.getBody(currentMessage);
        assertNotPartialLink(body);
        assertNotEditLink(body);
    }
    ...
    public void testGroupPartialResults() throws Exception
    {
        ...
        assertTextMessageValid(currentMessage, FilterConfig.ADMIN_FILTER_PARTIAL, EmailFuncTestCase.DEAFULT_FROM_ADDRESS, ADMIN_EMAIL, ADMIN_USERNAME);
        String body = EmailKit.getBody(currentMessage);
        body = assertPartialLink(FilterConfig.ADMIN_FILTER_PARTIAL, body);
        assertEditLink(body);
        ...
        assertTextMessageValid(currentMessage, FilterConfig.ADMIN_FILTER_PARTIAL, EmailFuncTestCase.DEAFULT_FROM_ADDRESS, BOB_EMAIL, ADMIN_USERNAME);
        body = EmailKit.getBody(currentMessage);
        body = assertPartialLink(FilterConfig.ADMIN_FILTER_PARTIAL, body);
        assertNotEditLink(body);
        ...
        assertHtmlMessageValid(currentMessage, FilterConfig.ADMIN_FILTER_PARTIAL, EmailFuncTestCase.DEAFULT_FROM_ADDRESS, FRED_EMAIL, ADMIN_USERNAME);
        body = EmailKit.getBody(currentMessage);
        body = assertPartialLink(FilterConfig.ADMIN_FILTER_PARTIAL, body);
        assertNotEditLink(body);
    }
    ...
    public void testPersonalZeroResults() throws Exception
    {
        ...
        assertHtmlMessageValid(messages[0], FilterConfig.FRED_FILTER_ZERO_RESULTS, EmailFuncTestCase.DEAFULT_FROM_ADDRESS, FRED_EMAIL, FRED_USERNAME);
    ...
    public void testPersonalCompleteResults() throws Exception
    {
        ...
        assertHtmlMessageValid(messages[0], FilterConfig.FRED_FILTER_FULL, EmailFuncTestCase.DEAFULT_FROM_ADDRESS, FRED_EMAIL, FRED_USERNAME);
        String body = EmailKit.getBody(messages[0]);
        assertNotPartialLink(body);
        assertEditLink(body);
    }
    ...
    public void testPersonalPartialResults() throws Exception
    {
        ...
        assertHtmlMessageValid(messages[0], FilterConfig.FRED_FILTER_PARTIAL, EmailFuncTestCase.DEAFULT_FROM_ADDRESS, FRED_EMAIL, FRED_USERNAME);
        String body = EmailKit.getBody(messages[0]);
        body = assertPartialLink(FilterConfig.FRED_FILTER_PARTIAL, body);
        assertEditLink(body);
    }
    ...
    public void testSubscriptionIsHtmlEncoded() throws Exception
    {
        ...
        assertHtmlMessageValid(currentMessage, ADMIN_FILTER_XSS, EmailFuncTestCase.DEAFULT_FROM_ADDRESS, ADMIN_EMAIL, ADMIN_USERNAME);
        String body = EmailKit.getBody(currentMessage);
    ...
    public void testUserNameIsEncodedInHtml() throws InterruptedException, MessagingException
    {
        ...
        text.assertTextPresent(body, "&lt;b&gt;Description&lt;/b&gt;");
        text.assertTextSequence(body, new String[] { "<b>Subscriber</b>:", "&lt;b&gt;xss&lt;/b&gt;" });
    }
}
