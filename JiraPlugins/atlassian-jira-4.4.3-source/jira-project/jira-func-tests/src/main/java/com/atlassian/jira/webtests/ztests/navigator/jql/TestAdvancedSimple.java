...
public class TestAdvancedSimple extends AbstractJqlFuncTest
{
    ...
    public void testJQLErrors() throws Exception
    {
        ...
        assertInvalidJqlAndSwitchToBasic("reporter = INVALID", "Could not find username: INVALID", createFilterFormParam("reporter", "INVALID"));
        assertInvalidJqlAndSwitchToBasic("assignee = INVALID", "Could not find username: INVALID", createFilterFormParam("assignee", "INVALID"));
