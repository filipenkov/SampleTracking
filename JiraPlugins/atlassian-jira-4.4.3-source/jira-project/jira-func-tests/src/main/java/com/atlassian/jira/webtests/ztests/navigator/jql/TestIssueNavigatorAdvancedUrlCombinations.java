...
public class TestIssueNavigatorAdvancedUrlCombinations extends FuncTestCase
{
    ...
    public void testIssueNavigatorInvalidAdvancedQueryUrlNoActionParams() throws Exception
    {
        ...
        assertions.getIssueNavigatorAssertions().assertJqlErrors("The value 'Blah' does not exist for the field 'assignee'.");
    }
    ...
    public void testIssueNavigatorInvalidAdvancedQueryAndSorting() throws Exception
    {
        ...
        assertions.getIssueNavigatorAssertions().assertJqlErrors("The value 'Blub' does not exist for the field 'assignee'.");
    }
    ...
    private void assertDisplayingIssuesText(int pageStart, int pageEnd, int total)
    {
        tester.assertTextPresent(String.format(
                "Displaying issues <span id=\"results-count-start\">%d</span> to %d of <strong id=\"results-count-total\">%d</strong> matching issues.",
                pageStart,
                pageEnd,
                total
        ));
