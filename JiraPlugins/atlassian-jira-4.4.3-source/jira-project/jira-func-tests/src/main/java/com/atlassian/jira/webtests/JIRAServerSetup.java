...
public class JIRAServerSetup extends ServerSetup
{
    ...
    public static final JIRAServerSetup SMTP = new JIRAServerSetup(25 + PORT_OFFSET, null, JIRAServerSetup.PROTOCOL_SMTP);
    public static final JIRAServerSetup SMTPS = new JIRAServerSetup(465 + PORT_OFFSET, null, JIRAServerSetup.PROTOCOL_SMTPS);
    public static final JIRAServerSetup POP3 = new JIRAServerSetup(110 + PORT_OFFSET, null, JIRAServerSetup.PROTOCOL_POP3);
    public static final JIRAServerSetup POP3S = new JIRAServerSetup(995 + PORT_OFFSET, null, JIRAServerSetup.PROTOCOL_POP3S);
    public static final JIRAServerSetup IMAP = new JIRAServerSetup(143 + PORT_OFFSET, null, JIRAServerSetup.PROTOCOL_IMAP);
    public static final JIRAServerSetup IMAPS = new JIRAServerSetup(993 + PORT_OFFSET, null, JIRAServerSetup.PROTOCOL_IMAPS);
