...
public class TestPersonalLicense extends FuncTestCase
{
    ...
    public void testCreateIssueOverLicenseLimit()
    {
        ...
        //issues!
        administration.usersAndGroups().addUser(BOB_USERNAME);
        navigation.issue().goToCreateIssueForm(null,null);
    ...
    public void testPersonalLicenseCannotSubmitSupportRequest()
    {
        ...
        tester.assertTextPresent("Your license does not entitle you to support");
        text.assertTextPresent(new WebPageLocator(tester), "Please note that your license (JIRA " + edition + ": Personal) does not entitle you to support.");
        text.assertTextPresent(new WebPageLocator(tester), "If you are experiencing problems, please see the JIRA documentation, try our forums or consider purchasing a full license.");

        //now try to hack the URL and ensure the warning is also shown
        tester.gotoPage("/secure/admin/JiraSupportRequest.jspa");
        tester.assertTextPresent("Support Request");
        tester.assertTextPresent("You can send a support request email here.");
        text.assertTextPresent(new WebPageLocator(tester), "Please note that your license (JIRA " + edition + ": Personal) does not entitle you to support. If you are experiencing problems, please see the JIRA documentation, try our forums or consider purchasing a full license.");
    }
    ...
    public void testSignupOverLicenseLimit()
    {
        ...
        XPathLocator anchorLocator = new XPathLocator(tester,"//div[@id='header-details-user']/a");
        text.assertTextPresent(anchorLocator, "Devman");
        navigation.logout();
        tester.gotoPage("login.jsp");
...
//        text.assertTextPresent(new WebPageLocator(tester), "Please contact your JIRA administrators for further assistance.");
