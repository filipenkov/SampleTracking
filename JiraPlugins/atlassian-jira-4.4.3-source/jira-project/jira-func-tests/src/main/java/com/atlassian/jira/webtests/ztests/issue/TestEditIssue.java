...
public class TestEditIssue extends JIRAWebTest
{
    ...
    public void testUpdateIssueWithVersionCF() throws Exception
    {
        ...
        submit("show");
        selectOption("customfield_10000", "New Version 1"); // search for the same version
        submit("show");

        // issue should be present
        assertTextPresent("HSP-1");
        assertTextPresent("Bug 1");
        ...
        selectOption("customfield_10000", "New Version 1"); // search for the same version as before
        submit("show");

        // issue should not be present in results
        assertTextNotPresent("HSP-1");
        assertTextNotPresent("Bug 1");
    }
    ...
    public void testEditClosedIssue()
    {
        ...
        submit("Transition");
        assertLinkNotPresentWithText("editIssue");
    ...
    public void testEditIssueWithCustomFieldsAndRemoveValues()
    {
        ...
        selectOption("customfield_10000:1", "Please select...");
        selectOption("customfield_10000", "Please select...");
