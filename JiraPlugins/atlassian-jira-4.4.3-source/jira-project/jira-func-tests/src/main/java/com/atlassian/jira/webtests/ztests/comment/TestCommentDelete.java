...
public class TestCommentDelete extends JIRAWebTest
{
    ...
    public void testDeleteCommentReindexesIssue()
    {
        ...
        clickLink("find_link");
        setFormElement("query", "\"Unique Comment\"");
        setFormElement("body", "true");
        submit("show");
    ...
    public void testDeleteCommentWithNoPermissions()
    {
        ...
        assertTextSequence(new String[]{"Delete Comment", "You do not have the permission for this comment."});
    }
    ...
    public void testOneCanNotEditCommentThatOneCanNotSee()
    {
        ...
        assertTextSequence(new String[]{"Edit Comment", "You do not have the permission for this comment."});
