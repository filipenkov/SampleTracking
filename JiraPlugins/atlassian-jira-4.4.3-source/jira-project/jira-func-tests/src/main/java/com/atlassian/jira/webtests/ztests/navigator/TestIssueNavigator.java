...
//                dateOptions[1]);
    ...
    public void testIssueNavigatorSelectGroup()
    {
        ...
        administration.restoreData("TestIssueNavigatorCommon.xml");
        administration.usersAndGroups().addGroup(GROUP_NAME);
        administration.usersAndGroups().addUserToGroup(BOB_USERNAME, GROUP_NAME);
    ...
    public void testBackToPreviousViewLinks()
    {
        ...
        navigation.issueNavigator().displayAllIssues();
        assertions.getIssueNavigatorAssertions().assertIssueNavigatorDisplaying(new XPathLocator(tester,"//*[@class='" + RESULTS_COUNT_CLASS + "']"),"1", "4", "4");
    ...
    private void assertPrintableViewsBackToPreviousViewLink()
    {
        ...
        assertions.getIssueNavigatorAssertions().assertIssueNavigatorDisplaying(new XPathLocator(tester,"//*[@class='" + RESULTS_COUNT_CLASS + "']"),fromIssueCount, toIssueCount, totalIssueCount);
        tester.clickLink("printable");
        assertExpectedIssueLinksPresent();
        assertions.getIssueNavigatorAssertions().assertIssueNavigatorDisplaying(new XPathLocator(tester,"//*[@class='borderedHeader']"),fromIssueCount, toIssueCount, totalIssueCount);
