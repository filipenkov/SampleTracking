...
public class TestIssueLinkTypeResource extends RestFuncTest
{
    ...
    public void testGetAllIssueLinkTypes() throws Exception
    {
        ...
        assertEquals(getBaseUrlPlus("rest/api/2.0.alpha1/issueLinkType/10100") ,type.self.toString());
        type = list.get(1);
        ...
        assertEquals(getBaseUrlPlus("rest/api/2.0.alpha1/issueLinkType/10000") ,type.self.toString());
    }
