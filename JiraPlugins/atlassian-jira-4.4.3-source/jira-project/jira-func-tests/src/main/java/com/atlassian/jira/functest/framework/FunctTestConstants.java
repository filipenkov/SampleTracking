...
public interface FunctTestConstants
{
    ...
    public static final String CLONERS_OUTWARD_LINK_NAME = CLONERS_LINK_TYPE_NAME + " Outward";
    public static final String CLONERS_INWARD_LINK_NAME = CLONERS_LINK_TYPE_NAME + " Inward";
