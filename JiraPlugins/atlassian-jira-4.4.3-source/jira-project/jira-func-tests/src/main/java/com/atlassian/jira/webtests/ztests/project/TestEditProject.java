...
public class TestEditProject extends FuncTestCase
{
    ...
    public void testEditProjectSuccess()
    {
        ...
        assertEquals(null, dog.description);
        ...
        tester.gotoPage("/plugins/servlet/project-config/" + dog.key + "/summary");
        ...
        assertions.assertNodeByIdHasText("project-config-header-name", "Dogs");
    ...
    {
        tester.gotoPage("/plugins/servlet/project-config/" + "DOG" + "/summary");
        tester.clickLink("edit_project");
        tester.assertTextPresent("Edit Project: Canine");
    ...
    public void testEditWithFieldsExceedingLimits() throws Exception
    {
        ...
        tester.setFormElement("name", StringUtils.repeat("N", 151));
        tester.setFormElement("url", StringUtils.repeat("U", 256));
        tester.submit("Update");

        tester.assertTextPresent("The project name must not exceed 150 characters in length");
    ...
    {
        tester.gotoPage("/plugins/servlet/project-config/" + "VG" + "/summary");
        tester.clickLink("edit_project");
