...
public class AbstractTestIssueNavigatorView extends JIRAWebTest
{
    ...
    protected final List issueFieldColumnMap = new ArrayList();
    ...
    protected static final Map ISSUE_PRIORITY_IMAGE_MAP = new HashMap();

    static
    {
        ISSUE_PRIORITY_IMAGE_MAP.put(PRIORITY_MAJOR, "priority_major.gif");
        ISSUE_PRIORITY_IMAGE_MAP.put(PRIORITY_MINOR, "priority_minor.gif");
        ISSUE_PRIORITY_IMAGE_MAP.put(PRIORITY_TRIVIAL, "priority_trivial.gif");
    }
    ...
    protected final List commentItems = new ArrayList();
    ...
    protected static class Item
    {
        ...
        public void setAttribute(String name, String value, Map attributes)
        {
            attributeMap.put(name, value);
            Map m = (Map) attributeAttributesMap.get(name);
            if (m == null)
            {
                m = new Hashtable();
        ...
        public Map getAttributeAttributesMap(String attributeName)
        {
            final Map map = (Map) attributeAttributesMap.get(attributeName);
    ...
    public static class CustomField
    {
        ...
        {
            StringBuffer sb = new StringBuffer("CustomField[");
            sb.append("\n  id = ");
            sb.append(id);
            sb.append("\n  key = ");
            sb.append(key);
    ...
    protected Item createItem1()
    {
        ...
        final Map typeAttributes = new HashMap();
        typeAttributes.put("iconUrl", baseUrl + "/images/icons/newfeature.gif");
        final Map priorityAttributes = new HashMap();
        priorityAttributes.put("iconUrl", baseUrl + "/images/icons/priority_trivial.gif");
        final Map statusAttributes = new HashMap();
        statusAttributes.put("iconUrl", baseUrl + "/images/icons/status_open.gif");
    ...
    protected Item createItem2()
    {
        ...
        final Map typeAttributes = new HashMap();
        typeAttributes.put("iconUrl", baseUrl + "/images/icons/bug.gif");
        final Map priorityAttributes = new HashMap();
        priorityAttributes.put("iconUrl", baseUrl + "/images/icons/priority_minor.gif");
        final Map statusAttributes = new HashMap();
        statusAttributes.put("iconUrl", baseUrl + "/images/icons/status_inprogress.gif");
    ...
    protected Item createItem3()
    {
        ...
        typeAttributes.put("iconUrl", baseUrl + "/images/icons/bug.gif");
        final Map priorityAttributes = new HashMap();
        priorityAttributes.put("iconUrl", baseUrl + "/images/icons/priority_major.gif");
        final Map statusAttributes = new HashMap();
        statusAttributes.put("iconUrl", baseUrl + "/images/icons/status_resolved.gif");
