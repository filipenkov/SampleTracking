...
import static com.atlassian.jira.webtests.ztests.bundledplugins2.rest.client.matcher.HasErrorMessage.hasErrorMessage;
...
public class TestIssueResourceWatchers extends RestFuncTest
{
    ...
    public void testWatchingDisabled() throws Exception
    {
        ...
        assertNull(issue.fields.watcher);
    }
    ...
    public void testViewWatchersRequestExpanded() throws Exception
    {
        ...
        assertEquals(getBaseUrl() + "/rest/api/2.0.alpha1/issue/HSP-1/watchers", issue.fields.watcher.value.self);
    }
    ...
    public void testViewWatchersNoPermissionToViewButCanStillSeeCount() throws Exception
    {
        ...
        assertEquals(2, issue.fields.watcher.value.watchCount);
    }
    ...
    public void testViewWatchersNoPermissionToViewButCanStillSeeMyselfAndCount() throws Exception
    {
        ...
        Watchers watchers = issue.fields.watcher.value;
        assertEquals(getBaseUrl() + "/rest/api/2.0.alpha1/issue/HSP-2/watchers", watchers.self);
    ...
    public void testViewWatchersIsNotWatching() throws Exception
    {
        ...
        Watchers watchers = issue.fields.watcher.value;
        assertEquals(getBaseUrl() + "/rest/api/2.0.alpha1/issue/HSP-1/watchers", watchers.self);
    ...
    public void testWatchers_Anonymous() throws Exception
    {
        ...
        Watchers watchers = watchersClient.anonymous().get("HSP-1");
        assertEquals(getBaseUrl() + "/rest/api/2.0.alpha1/issue/HSP-1/watchers", watchers.self);
        assertEquals(2, watchers.watchCount);
        assertFalse(watchers.isWatching);
    ...
    {
        restoreData(true);
        Watchers watchers = watchersClient.get("HSP-1");
        assertEquals(getBaseUrl() + "/rest/api/2.0.alpha1/issue/HSP-1/watchers", watchers.self);
    ...
    {
        Watchers watchers = watchersClient.get(issueKey);
