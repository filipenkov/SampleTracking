...
public class TestSimpleAdvancedView extends FuncTestCase
{
    ...
    public void testSystemFieldErrors() throws Exception
    {
        ...
        assertJql(new NavigatorSearch(new ReporterCondition().setUser("INVALID")), "reporter = INVALID", "The value 'INVALID' does not exist for the field 'reporter'.");
        assertJql(new NavigatorSearch(new AssigneeCondition().setUser("INVALID")), "assignee = INVALID", "The value 'INVALID' does not exist for the field 'assignee'.");
