...
public class TestIssueNavigatorEncoding extends FuncTestCase
{
    ...
    public void testProjectNameIsEncoded() throws Exception
    {
        ...
        tester.assertTextPresent("<option title=\"" + PROJECT_14_INCH_MONITORS + "\" value=\"10000\">" + PROJECT_14_INCH_MONITORS + "</option>");
        tester.assertTextPresent("<option title=\"" + PROJECT_SCRIPT_HACK + "\" value=\"10010\">" + PROJECT_SCRIPT_HACK + "</option>");
    }
    ...
    public void testHtmlCustomFieldValuesNotDoubleEncoded()
    {
        ...
        text.assertTextSequence(pageLocator.getHTML(), new String[] { "My Multi Checkbox", "<b>My Option</b>",
                "My Multi Select", "<b>My Option 2</b>",
                "My Radio Buttons", "<b>My Option 3</b>",
                "My Select List", "<b>My Option</b>" });
        text.assertTextNotPresent(pageLocator.getHTML(), "&lt;b&gt;My Option&lt;/b&gt;");
        text.assertTextNotPresent(pageLocator.getHTML(), "&lt;b&gt;My Option 2&lt;/b&gt;");
        text.assertTextNotPresent(pageLocator.getHTML(), "&lt;b&gt;My Option 3&lt;/b&gt;");
    }
