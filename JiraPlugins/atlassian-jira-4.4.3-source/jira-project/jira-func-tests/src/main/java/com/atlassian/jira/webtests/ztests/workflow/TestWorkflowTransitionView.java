...
public class TestWorkflowTransitionView extends JIRAWebTest
{
    ...
    private void copyWorkflowAndAddTransitions()
    {
        ...
        addTransition(WORKFLOW_COPIED, "Open", TRANSITION_NAME_1, TRANSITION_DESC, "Closed", TRANSITION_FIELD_SCREEN);
        addTransition(WORKFLOW_COPIED, "Open", TRANSITION_NAME_2, TRANSITION_DESC, "Closed", TRANSITION_FIELD_SCREEN);
    }
