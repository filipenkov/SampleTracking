...
public class TestIssueSecurityActions extends JIRAWebTest
{
    ...
    {
        log("Issue Secuirty: Adding a security level to a security scheme");
    ...
    {
        log("Issue Secuirty: Deleting a security level to a security scheme");
    ...
    public void issueSecurityAssociateSchemeToProject()
    {
        ...
        tester.gotoPage("/plugins/servlet/project-config/" + "HSP" + "/issuesecurity");
        assertions.assertNodeByIdHasText("project-config-issuesecurity-scheme-name", SECURITY_SCHEME_NAME);
