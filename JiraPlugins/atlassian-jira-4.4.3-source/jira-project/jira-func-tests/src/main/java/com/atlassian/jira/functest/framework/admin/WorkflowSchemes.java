...
public interface WorkflowSchemes extends Navigable<WorkflowSchemes>
{
     ...
     * @see com.atlassian.jira.functest.framework.FunctTestConstants
     */
    WorkflowSchemes assignWorkflow(String schemeName, String issueTypeName, String workflowName);
     ...
     */
    WorkflowSchemes assignWorkflowToAllIssueTypes(String schemeName, String workflowName);
}
