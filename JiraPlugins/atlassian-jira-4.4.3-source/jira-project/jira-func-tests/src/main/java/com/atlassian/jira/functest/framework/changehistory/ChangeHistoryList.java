...
public class ChangeHistoryList implements List
{
    ...
    {
        StringBuffer sb = new StringBuffer("ChangeHistoryList [").append(changeHistoryList.size()).append("]");
        for (Iterator iterator = changeHistoryList.iterator(); iterator.hasNext();)
        {
            ChangeHistorySet changeHistorySet = (ChangeHistorySet) iterator.next();
            sb.append("\n\t");
