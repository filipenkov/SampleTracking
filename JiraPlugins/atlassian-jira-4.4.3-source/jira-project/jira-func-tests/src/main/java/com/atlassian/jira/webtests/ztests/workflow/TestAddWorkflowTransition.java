...
public class TestAddWorkflowTransition extends FuncTestCase
{
    ...
    public void testAddWorkflowTransitionSpecialCharacters()
    {
        ...
        administration.workflowSchemes().goTo().addWorkflowScheme(WORKFLOW_SCHEME, "Test workflow scheme.");
        administration.workflowSchemes().goTo().assignWorkflow(WORKFLOW_SCHEME, "Bug", WORKFLOW_NAME);
