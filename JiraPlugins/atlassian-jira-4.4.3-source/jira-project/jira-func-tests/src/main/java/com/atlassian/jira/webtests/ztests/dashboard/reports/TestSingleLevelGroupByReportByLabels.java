...
public class TestSingleLevelGroupByReportByLabels extends FuncTestCase {
    ...
    public void testSeveralIssuesWithSharedAndDistinctLabels () {
        ...
        tableAssertions.assertTableCellHasText (webTable, 2, 2, KEY_IMPROVEMENT_WITH_LABEL_A);
        tableAssertions.assertTableCellHasText (webTable, 3, 2, KEY_BUG_WITH_LABELS_A_AND_B);
        tableAssertions.assertTableCellHasText (webTable, 4, 2, KEY_BUG_WITH_LABEL_A);

        tableAssertions.assertTableCellHasText (webTable, 5, 0, "Label: B");
        tableAssertions.assertTableCellHasText (webTable, 6, 2, KEY_IMPROVEMENT_WITH_LABELS_B_AND_C);
        tableAssertions.assertTableCellHasText (webTable, 7, 2, KEY_IMPROVEMENT_WITH_LABEL_B);
        tableAssertions.assertTableCellHasText (webTable, 8, 2, KEY_BUG_WITH_LABELS_A_AND_B);
        tableAssertions.assertTableCellHasText (webTable, 9, 2, KEY_BUG_WITH_LABEL_B);

        tableAssertions.assertTableCellHasText (webTable, 10, 0, "Label: C");
        tableAssertions.assertTableCellHasText (webTable, 11, 2, KEY_IMPROVEMENT_WITH_LABELS_B_AND_C);
        tableAssertions.assertTableCellHasText (webTable, 12, 2, KEY_IMPROVEMENT_WITH_LABEL_C);
