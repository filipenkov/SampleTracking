...
public abstract class AbstractTestIssueNavigatorColumnsView extends AbstractTestIssueNavigatorView
{
    ...
    protected class ItemVerifier
    {
        ...
        public void verify()
        {
            ...
            {
                AbstractTestIssueNavigatorView.IssueLink link = (AbstractTestIssueNavigatorView.IssueLink) i.next();
            ...
            verifyCustomFieldLinks(ISSUE_MULTI_GROUP_PICKER_FIELD, CF_MULTI_GROUP_PICKER_FIELD);
        ...
        {
            return issueFieldColumnMap.indexOf(key);
        }
        ...
        protected void verifyCustomFieldLinks(String columnKey, String customFieldName)
        {
            ...
            if (customField != null)
            {
                ...
                for (Iterator i = values.iterator(); i.hasNext();)
                {
                    final String link = ((CustomField.Value) i.next()).getLink();
                    if (link != null)
                    {
                        final int column = getColumn(columnKey);
