...
public class TestSignupWithExternalUserManagement extends FuncTestCase
{
    ...
    public void testCantSignupWithExternalUserManagementOn() throws Exception
    {
        ...
        // Assert we are on the Login portlet because it doesn't have the "Welcome" message.
        tester.assertTextNotPresent("Welcome to Rasta JIRA");
        String url = tester.getDialog().getResponse().getURL().getPath();
        assertTrue(url.endsWith("Dashboard.jspa"));
