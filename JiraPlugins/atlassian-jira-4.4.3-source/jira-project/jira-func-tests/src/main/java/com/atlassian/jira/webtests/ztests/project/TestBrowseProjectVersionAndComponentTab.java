...
public class TestBrowseProjectVersionAndComponentTab extends FuncTestCase
{
    ...
    public void testVersionOrder() throws SAXException
    {
        ...
        assertions.assertNodeHasText("//div[@id='content-top']//h1", "No Components");
        assertions.assertNodeHasText("//div[@id='content-top']//h2", "V3");
    ...
    public void testComponentsTab() throws SAXException
    {
        ...
        assertions.assertNodeHasText("//div[@id='content-top']//h1", "No Versions");
        assertions.assertNodeHasText("//div[@id='content-top']//h2", "Component 1");
    ...
    public void testEmptyAndExpandedColumnsInSummary()
    {
        ...
        assertions.assertNodeHasText("//div[@id='primary']", "There is no information to display for the summary of this version. This could be a version with no issues or activity.");
        
        navigation.browseVersionTabPanel("NOCOMPS", "Version 2", "summary");
        assertions.assertNodeDoesNotExist("//div[@id='secondary']");
        assertions.assertNodeExists("//div[@id='primary']");

        navigation.browseComponentTabPanel("NOVERSIONS", "<b>Component 2</b>", "summary");
        assertions.assertNodeHasText("//div[@id='primary']", "There is no information to display for the summary of this component. This could be a component with no issues, versions or activity.");

        navigation.browseComponentTabPanel("NOVERSIONS", "Component 1", "summary");
        assertions.assertNodeDoesNotExist("//div[@id='secondary']");
        assertions.assertNodeExists("//div[@id='primary']");
        assertions.assertNodeExists("//div[@id='fragcomponentdescription']");

        navigation.browseComponentTabPanel("HSP", "New Component 1", "summary");
        assertions.assertNodeDoesNotExist("//div[@id='secondary']");
        assertions.assertNodeExists("//div[@id='primary']");
        assertions.assertNodeExists("//div[@id='fragdueversions']");
