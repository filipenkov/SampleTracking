...
public class TestWatchers extends JIRAWebTest
{
    ...
    private static final String XPATH_WATCHERS_LINK_TITLE = String.format("//a[@id='%s']/@title", ID_WATCH_LINK);
    ...
    private void assertWatching(final int watcherCount)
    {
        ...
        assertEquals(MSG_STOP_WATCHING, getXpathText(XPATH_WATCHERS_LINK_TITLE));
    ...
    private void assertNotWatching(final int watcherCount)
    {
        ...
        //Should see this title when we can watch.
        assertEquals(MSG_START_WATCHING, getXpathText(XPATH_WATCHERS_LINK_TITLE));
        //Make sure the watch count is correct.
        assertEquals(watcherCount, getWatchCount());
