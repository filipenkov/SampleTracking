...
public class TestNotificationEmails extends EmailFuncTestCase
{
    ...
    {
        super.setUpTest();
        administration.restoreData("TestNotificationEmails.xml");
    ...
    /*
     * JRA-20604, JRADEV-1246: Make sure that comments are sent in the e-mails that result from transiting an issue.
     */
    ...
    private void assertMessageAndType(MimeMessage message, String expectedComment, boolean html)
    {
        ...
        assertTrue(body.contains("<div id=\"email-body\">") == html);
    ...
    {
        return new MailBox(getUserInbox(email), email);
    }
