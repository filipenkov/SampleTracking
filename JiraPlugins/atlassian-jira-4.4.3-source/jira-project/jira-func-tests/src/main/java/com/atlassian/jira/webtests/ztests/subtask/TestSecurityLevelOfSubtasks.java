...
public class TestSecurityLevelOfSubtasks extends JIRAWebTest
{
    ...
    public void testBulkEditWithSubtasksOnly()
    {
        ...
        // Operation Details
        assertCollapsedTextSequence(new String[] {
            "Bulk Operation Step 3 of 4: Operation Details",
        ...
        assertEquals("The security level of subtasks is inherited from parents.", webTable.getCellAsText(1,1).trim());
        // Change the priority
        ...
        assertCollapsedTextSequence(new String[] {
            ...
            "Please confirm that the correct issues and changes have been entered.",
            "Updated Fields",
            "Priority",
            "Minor",
            "Assignee",
    ...
    public void testChangeProjectsSecurityLevelScheme()
    {
        ...
        tester.gotoPage("/plugins/servlet/project-config/" + "RAT" + "/issuesecurity");
