...
public class TestOpsBarStructure extends FuncTestCase
{
    ...
    public void testLoginButton()
    {
        ...
        IdLocator locator = new IdLocator(tester, "ops-login");
        assertEquals(0, locator.getNodes().length);

        navigation.issue().viewIssue("ANON-1");

        locator = new IdLocator(tester, "ops-login");
        ...
        text.assertTextPresent(new IdLocator(tester, "issue_header_summary"), "Anon viewable issue");
    ...
    public void testOpsbarTransitionOrder()
    {
        ...
        navigation.issue().viewIssue("HSP-1");
        final String operationsGroup = "//div[@class='ops-menus']/ul[3]";
        ...
        tester.clickLink("createDraft_Copy of jira");
        ...
        navigation.gotoAdminSection("workflows");
        tester.clickLink("steps_draft_Copy of jira");
        ...
        navigation.gotoAdminSection("workflows");
        tester.clickLink("publishDraft_Copy of jira");
