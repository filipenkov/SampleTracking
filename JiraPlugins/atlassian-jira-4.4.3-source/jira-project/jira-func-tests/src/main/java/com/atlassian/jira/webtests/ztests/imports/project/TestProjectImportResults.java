...
public class TestProjectImportResults extends AbstractProjectImportTestCase
{
    ...
    private void _testProjectNullAssigneeType(final String currentSystemXML, final String defaultAssignee) throws Exception
    {
        File tempFile = null;
        try
        {
            ...
            doImportAndAssertDefaultAssignee(defaultAssignee);
    ...
    private void doImportAndAssertDefaultAssignee(final String defaultAssignee)
    {
        ...
        tester.gotoPage("/plugins/servlet/project-config/MKY/people");
        assertions.assertNodeByIdHasText("project-config-header-name", "monkey");
        assertions.assertNodeByIdHasText("project-config-panel-people-default-assignee", defaultAssignee);
    ...
    public void testCustomFieldNoLongerExistsTryingToImport() throws Exception
    {
        ...
        try
        {
            ...
            text.assertTextPresentHtmlEncoded("The custom field 'Cascading Select CF' of type 'Cascading Select' is required for the import but does not exist in the current JIRA instance.");
        }
        finally
        {
            if (tempFile != null)
    ...
    public void testCreateUsers() throws Exception
    {
        ...
        try
        {
            ...
            assertTrue(stringContains(projectDetailsResults, "Key: MKY"));
            assertTrue(stringContains(projectDetailsResults, "Description: This is a description for a monkey project."));
            assertTrue(stringContains(projectDetailsResults, "Lead: " + FRED_FULLNAME));
            assertTrue(stringContains(projectDetailsResults, "URL: http://monkeyproject.example.com"));
            assertTrue(stringContains(projectDetailsResults, "Default Assignee: Project Lead"));
            assertTrue(stringContains(projectDetailsResults, "Components: 3"));
            assertTrue(stringContains(projectDetailsResults, "Versions: 3"));

            xPathLocator = new XPathLocator(tester, "//div[@id='customfields']/ul");
            String userRoleIssueResults = xPathLocator.getText();

            assertTrue(stringContains(userRoleIssueResults, "Users: 2 out of 2"));
            assertTrue(stringContains(userRoleIssueResults, "Administrators: 1 users, 1 groups"));
            assertTrue(stringContains(userRoleIssueResults, "Developers: 1 users, 2 groups"));
            assertTrue(stringContains(userRoleIssueResults, "Users: 1 users, 2 groups"));
            assertTrue(stringContains(userRoleIssueResults, "Issues created: 2 out of 2"));
    ...
    private void _testSimpleImport(final String attachmentFilename) throws Exception
    {
        ...
        try
        {
            ...
            assertTrue(stringContains(userRoleIssueResults, "Users: 1 users, 2 groups"));
            assertTrue(stringContains(userRoleIssueResults, "Issues created: 2 out of 2"));
            assertTrue(stringContains(userRoleIssueResults, "Attachments: 1 out of 1"));
    ...
    public void testIssueDataSimpleAllDataResolutionDate() throws Exception
    {
        ...
        assertTrue(stringContains(userRoleIssueResults, "Developers: 1 users, 2 groups"));
        assertTrue(stringContains(userRoleIssueResults, "Users: 1 users, 2 groups"));
        assertTrue(stringContains(userRoleIssueResults, "Issues created: 3 out of 3"));
    ...
    public void testIssueDataSimpleMinimalData() throws Exception
    {
        ...
        try
        {
            ...
            assertEquals(null, details.getDescription());
            ...
            assertEquals(0, details.getCustomFields().size());
    ...
    public void testUpdateProjectOverwriteDetails() throws Exception
    {
        ...
        try
        {
            ...
            // Assert that the Project was created with all details
            // We test the link in testCreateProject(). lets test the OK button also takes us to the View Project for Monkey
            tester.submit("OK");
            assertions.assertNodeByIdHasText("project-config-header-name", "monkey");
    ...
    public void testUpdateProjectOverwriteDetailsWithSenderAddressAndComponentLeads() throws Exception
    {
        ...
        try
        {
            ...
            assertTrue(stringContains(projectDetailsResults, "Key: MKY"));
            assertTrue(stringContains(projectDetailsResults, "Description: This is a description for a monkey project."));
            assertTrue(stringContains(projectDetailsResults, "Sender Address: jira-monkey-test@example.com"));
            ...
            // Assert Project propeties
            tester.gotoPage("/plugins/servlet/project-config/" + "MKY" + "/summary");
            tester.assertTextInElement("project-config-email", "jira-monkey-test@example.com");
    ...
    public void testUpdateProjectDoNotOverwriteDetails() throws Exception
    {
        ...
        try
        {
            ...
            String projectDetailsResults = xPathLocator.getText();
            assertTrue(stringContains(projectDetailsResults, "Key: MKY"));
            assertTrue(stringContains(projectDetailsResults, "Description: existing monk thing"));
