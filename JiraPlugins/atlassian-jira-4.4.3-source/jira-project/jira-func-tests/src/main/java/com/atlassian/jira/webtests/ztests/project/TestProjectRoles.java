...
public class TestProjectRoles extends FuncTestCase
{
    ...
    public void addGroupToProjectRole(String groupName, String projectKey, String roleName)
    {
        ...
        final Response response = projectRoleClient.addActors(projectKey, roleName, new String[] { groupName }, null);
    }
    ...
    {
     ProjectRoleClient projectRoleClient = new ProjectRoleClient(environmentData);
     final Response response = projectRoleClient.addActors(projectKey, roleName, null, new String[] { userName });
    }
    ...
    public void testAddDefaultUsersAndDefaultGroupsToRole()
    {
        ...
        tester.submit("add");
        tester.assertTextPresent(APOSTROPHE_ENTITY + "detkin" + APOSTROPHE_ENTITY + " does not exist.");

        // Assert that an error is thrown on the default screen for adding a user that already exists
        navigation.gotoAdmin();
        tester.clickLink("project_role_browser");
        tester.clickLink("manage_test role");
        tester.clickLink(EDIT_USER_ACTORS);
        ...
        tester.submit("add");
        tester.assertTextPresent(APOSTROPHE_ENTITY + ADMIN_USERNAME + APOSTROPHE_ENTITY + " is already a member of the project role.");
    ...
    public void testDeleteProjectRoleWorkflowConditions()
    {
        ...
        tester.clickLink("steps_live_Copy of jira workflow");
    ...
    public void testViewUsages()
    {
        ...
        assertions.getLinkAssertions().assertLinkPresentWithExactText
                ("//table[@id='relatednotificationschemes']", "Default Notification Scheme");
        assertions.getLinkAssertions().assertLinkPresentWithExactText
                ("//table[@id='relatednotificationschemes']", "Other Notification Scheme");

        assertions.getLinkAssertions().assertLinkPresentWithExactText
                ("//table[@id='relatedpermissionschemes']", "Default Permission Scheme");
        assertions.getLinkAssertions().assertLinkPresentWithExactText
                ("//table[@id='relatedpermissionschemes']", "Other Permission Scheme");
