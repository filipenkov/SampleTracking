...
public class TestXsrfAdminIssueTypeScreenSchemes extends FuncTestCase
{
        ...
        new XsrfTestSuite(
                ...
                new XsrfCheck(
                        ...
                        new XsrfCheck.Setup()
                        {
                            ...
                            {
                                navigate();
                                tester.clickLink("edit_issuetypescreenscheme_" + ISSUE_TYPE_SCREEN_SCHEME_NAME);
                            }
                        },
                ...
                new XsrfCheck(
                        ...
                        new XsrfCheck.Setup()
                        {
                            ...
                            {
                                navigate();
                                tester.clickLink("copy_issuetypescreenscheme_" + ISSUE_TYPE_SCREEN_SCHEME_NAME);
                            }
                        },
                ...
                new XsrfCheck(
                        ...
                        new XsrfCheck.Setup()
                        {
                            ...
                            {
                                navigate();
                                tester.clickLink("delete_issuetypescreenscheme_" + ISSUE_TYPE_SCREEN_SCHEME_NAME);
                            }
                        },
    ...
    {
        navigate();
        tester.clickLink("configure_issuetypescreenscheme_" + ISSUE_TYPE_SCREEN_SCHEME_NAME);
    }
