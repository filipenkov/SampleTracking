...
public class TestEnvironmentField extends FuncTestCase
{
    ...
    public void testEnvironmentFieldNeverHidden() throws Exception
    {
        ...
        //tester.setFormElement("fieldScreenName", "");
        // Click Link 'Configure' (id='configure_fieldscreen_Default Screen').
        tester.clickLink("configure_fieldscreen_Default Screen");
        //tester.setFormElement("newTabName", "");
        //tester.setFormElement("newFieldPosition_environment", "");
        tester.checkCheckbox("removeField_10", "on");
