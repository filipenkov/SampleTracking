...
public class TestIssueResourceVotes extends RestFuncTest
{
    ...
    protected void setUpTest()
    {
        ...
        issueREST = String.format("/rest/api/2.0.alpha1/issue/%s", issueKey);
    ...
    public void testVote_votingDisabled() throws Exception
    {
        ...
        administration.usersAndGroups().addUser("barney");
    ...
    {
        return issueClient.get(issueKey).fields.votes.value.votes;
    }
    ...
    private boolean i_voted(String user)
    {
        ...
        return issue.fields.votes.value.hasVoted;
    }
}
