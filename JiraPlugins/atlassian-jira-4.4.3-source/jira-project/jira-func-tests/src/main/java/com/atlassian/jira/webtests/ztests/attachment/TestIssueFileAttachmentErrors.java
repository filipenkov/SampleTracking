...
public class TestIssueFileAttachmentErrors extends FuncTestCase
{
    ...
    {
        assertErrorResponse("/secure/attachment/idontparse/DummyAttachment", 404, "Attachment not found (id idontparse)");
    }
    ...
    public void testTryDownloadAsZipWhenZipDisabled() throws Exception
    {
        ...
        assertErrorResponse("/secure/attachmentzip/10000.zip", 404, "Attachments as ZIP support is disabled");
    }
