...
public class TestReindexingSubtasks extends JIRAWebTest
{
    ...
    public void testMoveSingleIssue()
    {
        ...
        assertTextSequence(new String[] { "Type", "Improvement", "Bug" });
        assertTextSequence(new String[] { "Status", "Open", "(Copy of jira)", "Open", "(jira)" });
        assertTextSequence(new String[] { "Security Level", "MyFriendsOnly", "None" });
        submit("Move");
        ...
        assertTextSequence(new String[] { "Type", "Bug", "Bug" });
        assertTextSequence(new String[] { "Security Level", "None", "Level KingRat" });
        submit("Move");
    ...
    public void testBulkMoveIssue() throws SAXException
    {
        ...
        assertCollapsedTextSequence(new String[] {
                "Bulk Operation Step 2 of 4: Choose Operation",
    ...
    public void testBulkWorkflowTransitionIssue()
    {
        ...
        submit("Next");
        assertTextPresent("Bulk Operation Step 3 of 4: Operation Details");
    ...
    public void testConvertSingleIssueToSubtask()
    {
        ...
        //note, this should really be assertTextNotPresent("COW-35"), however it is present in the
        // 'previous' search link.  So making sure it only occurs after the summary of the issue
        //should be good enough.  In other words this checks that there's no link to the parent issue before the
        //summary.
        assertTextPresentAfterText("COW-35", "Get new milk bucket");
