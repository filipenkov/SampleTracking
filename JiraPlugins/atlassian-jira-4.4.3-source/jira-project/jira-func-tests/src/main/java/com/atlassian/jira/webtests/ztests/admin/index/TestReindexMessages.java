...
public class TestReindexMessages extends FuncTestCase
{
    ...
    {
        administration.restoreBlankInstance();
        String customFieldId = administration.customFields().addCustomField("com.atlassian.jira.plugin.system.customfieldtypes:userpicker", "UserCF", new String[] { }, new String[] { });
        String numericCustomFieldId = customFieldId.split("_")[1];

        // set to a different searcher - message
        administration.customFields().setCustomFieldSearcher(numericCustomFieldId, "com.atlassian.jira.plugin.system.customfieldtypes:userpickergroupsearcher");
        assertCustomFieldMessage();
        administration.reIndex();
        ...
        administration.customFields().setCustomFieldSearcher(numericCustomFieldId, "com.atlassian.jira.plugin.system.customfieldtypes:userpickersearcher");
        assertCustomFieldMessage();
        administration.reIndex();
