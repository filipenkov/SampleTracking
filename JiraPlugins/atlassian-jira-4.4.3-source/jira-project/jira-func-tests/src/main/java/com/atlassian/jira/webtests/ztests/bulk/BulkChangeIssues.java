...
public abstract class BulkChangeIssues extends JIRAWebTest
{
    ...
    {
        return addIssue(PROJECT_HOMOSAP, PROJECT_HOMOSAP_KEY, "Bug", summary, "Major", null, null, null, ADMIN_FULLNAME, "test environment", "description for " + summary, null, null, null);
    }
    ...
    protected void addIssues(int numOfIssues)
    {
        ...
        {
            addIssue(PROJECT_HOMOSAP, PROJECT_HOMOSAP_KEY, "Bug", "random_" + numOfIssues, "Major", null, null, null, ADMIN_FULLNAME, "test environment", "\"generated by loop\"", null, null, null);
        }
    }
    ...
    protected void addIssues(String prefix, int numOfIssues)
    {
        for (int i = 0; i < numOfIssues; i++)
        {
            addIssue(PROJECT_HOMOSAP, PROJECT_HOMOSAP_KEY, "Bug", prefix + i, "Major", null, null, null, ADMIN_FULLNAME, "test environment", "\"generated by loop with prefix\"", null, null, null);
        }
    }
    ...
    {
        return addIssue(project, projectKey, "Bug", summary, "Critical", null, null, null, ADMIN_FULLNAME, "environment", "this issue is not in project " + project, null, null, null);
    }
