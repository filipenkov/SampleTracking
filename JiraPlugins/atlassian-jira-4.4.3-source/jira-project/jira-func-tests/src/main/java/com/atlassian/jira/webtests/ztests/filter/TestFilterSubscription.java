...
public class TestFilterSubscription extends JIRAWebTest
{
    ...
    public void testAdvancedExpressionWithBothMinuteAndHourIncrements()
    {
        ...
        assertFormElementHasValue("filter.subscription.prefix.cronString", cronExpr);
    }
    ...
    public void testAdvancedMode()
    {
        ...
        tester.submit("Subscribe");
        assertTextPresent("There was a problem validating your cron expression. Please check the syntax and try again.");
    ...
    public void testDeleteSubscription()
    {
        ...
        assertTextPresent("View Subscriptions for Test Filter");
    ...
    public void testDeleteGroupWithSubscription()
    {
        ...
        tester.submit("show");
        tester.clickLinkWithText("Save");
        tester.setFormElement("filterName", "delete-group-filter");
        tester.submit("saveasfilter_submit");

        navigation.issueNavigator().displayAllIssues();
        tester.clickLink("managefilters");
        tester.clickLink("subscribe_delete-group-filter");
        tester.selectOption("groupName", "delete-me");
        tester.submit("Subscribe");
