...
public class Test500Page extends FuncTestCase
{
    ...
    public void test500PageServiceParamVisibility()
    {
        ...
        text.assertTextSequence(locator.page(), "usessl:", "No SSL");
        ...
        text.assertTextSequence(locator.page(), "handler:", "Create Or Comment Handler");
    ...
    private void assertServiceParamsNotVisible()
    {
        ...
        text.assertTextNotPresent(locator.page(), "Create Or Comment Handler");
    }
}
