...
public class TestAdjustFavourite extends FuncTestCase
{
    ...
    {
        final StringBuffer buffer = new StringBuffer("/secure/AddFavourite.jspa?ignore=me");
    ...
    private void assertFilterIsFavourite(final long filterId)
    {
        ...
        for (Iterator iterator = list.getFilterItems().iterator(); iterator.hasNext();)
        {
            FilterItem filterItem = (FilterItem) iterator.next();
