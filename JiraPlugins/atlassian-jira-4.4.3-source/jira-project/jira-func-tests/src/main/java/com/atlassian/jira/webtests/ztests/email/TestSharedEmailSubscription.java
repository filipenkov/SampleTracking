...
public class TestSharedEmailSubscription extends AbstractSubscriptionEmailTest
{
    ...
    public void testHtmlSharedZeroResults() throws Exception
    {
        ...
        assertHtmlMessageValid(messages[0], FilterConfig.ADMIN_FILTER_ZERO_RESULTS, EmailFuncTestCase.DEAFULT_FROM_ADDRESS, FRED_EMAIL, FRED_USERNAME);
    ...
    public void testHtmlSharedCompleteResults() throws Exception
    {
        ...
        assertHtmlMessageValid(messages[0], FilterConfig.ADMIN_FILTER_FULL, EmailFuncTestCase.DEAFULT_FROM_ADDRESS, FRED_EMAIL, FRED_USERNAME);
        String body = GreenMailUtil.getBody(messages[0]);
        assertNotPartialLink(body);
        assertEditLink(body);
    }
    ...
    public void testHtmlSharedPartialResults() throws Exception
    {
        ...
        assertHtmlMessageValid(messages[0], FilterConfig.ADMIN_FILTER_PARTIAL, EmailFuncTestCase.DEAFULT_FROM_ADDRESS, FRED_EMAIL, FRED_USERNAME);
        String body = GreenMailUtil.getBody(messages[0]);
    ...
    public void testTextSharedZeroResults() throws Exception
    {
        ...
        assertTextMessageValid(messages[0], FilterConfig.ADMIN_FILTER_ZERO_RESULTS, EmailFuncTestCase.DEAFULT_FROM_ADDRESS, BOB_EMAIL, BOB_USERNAME);
        String body = GreenMailUtil.getBody(messages[0]);
        assertNotPartialLink(body);
        assertEditLink(body);
    }
    ...
    public void testTextSharedCompleteResults() throws Exception
    {
        ...
        assertTextMessageValid(messages[0], FilterConfig.ADMIN_FILTER_FULL, EmailFuncTestCase.DEAFULT_FROM_ADDRESS, BOB_EMAIL, BOB_USERNAME);
        String body = GreenMailUtil.getBody(messages[0]);
        assertNotPartialLink(body);
        assertEditLink(body);
    }
    ...
    public void testTextSharedPartialResults() throws Exception
    {
        ...
        assertTextMessageValid(messages[0], FilterConfig.ADMIN_FILTER_PARTIAL, EmailFuncTestCase.DEAFULT_FROM_ADDRESS, BOB_EMAIL, BOB_USERNAME);
        String body = GreenMailUtil.getBody(messages[0]);
        body = assertPartialLink(FilterConfig.ADMIN_FILTER_PARTIAL, body);
        assertEditLink(body);
    }
