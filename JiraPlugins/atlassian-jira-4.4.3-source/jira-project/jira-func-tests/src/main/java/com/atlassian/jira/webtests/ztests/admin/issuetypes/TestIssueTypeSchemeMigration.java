...
public class TestIssueTypeSchemeMigration extends JIRAWebTest
{
    ...
    {
        FuncTestHelperFactory funcTestHelperFactory = new FuncTestHelperFactory(tester, getEnvironmentData());

        TextAssertions text = funcTestHelperFactory.getTextAssertions();
        Administration admin = funcTestHelperFactory.getAdministration();
        final Navigation navigation = funcTestHelperFactory.getNavigation();
        ...
        tester.clickLinkWithText("Konfiguration bearbeiten");
        ...
        XPathLocator finishLocator = new XPathLocator(tester, "//*[@id=\"nextButton\" and @value=\"Fertigstellen\"]");
...
//        XPathLocator locator = new XPathLocator(tester, "//*[@class=\"jiraformbody\"]");
//        text.assertRegexMatch(locator, "Vorgangstypschema:[ \\t]+monkey");
    ...
    public void testIssueTypeSchemeMigrationNoSubtasksMultiProjects() throws SAXException
    {
        ...
        assertTableCellHasImage(issueTable, 1, 0, "issue_subtask.gif");
        assertTableCellHasImage(issueTable, 2, 0, "newfeature.gif");
        assertTableCellHasImage(issueTable, 3, 0, "genericissue.gif");
        assertTableCellHasImage(issueTable, 4, 0, "bug.gif");
        ...
        assertTableCellHasImage(issueTable, 1, 0, "issue_subtask.gif");
        assertTableCellHasImage(issueTable, 2, 0, "bug.gif");
        assertTableCellHasImage(issueTable, 3, 0, "genericissue.gif");
        assertTableCellHasImage(issueTable, 4, 0, "bug.gif");
        navigation.issue().gotoIssue("HSP-4");
        assertTextPresentAfterText("Another Subtask", "Type:");
