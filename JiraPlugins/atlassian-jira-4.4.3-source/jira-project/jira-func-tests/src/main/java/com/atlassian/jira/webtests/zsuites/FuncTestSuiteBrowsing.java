...
import com.atlassian.jira.webtests.ztests.admin.TestAdministrators;
...
import com.atlassian.jira.webtests.ztests.admin.TestManageTrackbacks;
...
import com.atlassian.jira.webtests.ztests.admin.TestSupportRequest;
import com.atlassian.jira.webtests.ztests.admin.TestSystemInfoPage;
import com.atlassian.jira.webtests.ztests.admin.TestTaskAdmin;
...
import com.atlassian.jira.webtests.ztests.attachment.TestAttachmentsBlockSortingOnViewIssue;
...
import com.atlassian.jira.webtests.ztests.misc.TestCvsIntegration;
import com.atlassian.jira.webtests.ztests.misc.TestDateInputValidationOnCreateIssue;
import com.atlassian.jira.webtests.ztests.misc.TestDateRangePicker;
...
import com.atlassian.jira.webtests.ztests.misc.TestTrackbackSettings;
import com.atlassian.jira.webtests.ztests.misc.TestURLRewriteFilter;
...
import com.atlassian.jira.webtests.ztests.navigator.TestReturnToSearch;
...
public class FuncTestSuiteBrowsing extends FuncTestSuite
{
    ...
    public FuncTestSuiteBrowsing()
    {
        ...
        addTest(TestDateRangePicker.class);
        ...
        addTest(TestAdministrators.class);
        addTest(TestAnnouncementBanner.class);
        addTest(TestAssignToMe.class);
        addTest(TestAttachFile.class);
        addTest(TestAttachmentsBlockSortingOnViewIssue.TestAttachmentsListSorting.class);
        addTest(TestAttachmentsBlockSortingOnViewIssue.TestImageAttachmentsGallerySorting.class);
        addTest(TestCronEditorUpgradeTask.class);
        addTest(TestCustomCreateButtonName.class);
        addTest(TestCvsIntegration.class);
        ...
        addTest(TestManageTrackbacks.class);
        ...
        addTest(TestReturnToSearch.class);
        ...
        addTest(TestSupportRequest.class);
        addTest(TestTaskAdmin.class);
        ...
        addTest(TestTrackbackSettings.class);
        addTest(TestDateInputValidationOnCreateIssue.class);
        addTest(TestURLRewriteFilter.class);
