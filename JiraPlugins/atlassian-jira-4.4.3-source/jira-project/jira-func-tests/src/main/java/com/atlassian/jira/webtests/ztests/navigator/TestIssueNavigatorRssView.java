...
public class TestIssueNavigatorRssView extends AbstractTestIssueNavigatorXmlView
{
    ...
    public void testCommentsRssFeedUpdated() throws IOException, SAXException, ParserConfigurationException, TransformerException
    {
        ...
        // search for all issues that were updated in last 2 days, there should be none
    ...
    public void _testRssFeedsHaveCorrectLinkToTheFilter(String rssView) throws DocumentException
    {
        ...
        String filterId = Integer.toString(saveFilter("rssview", ""));
        gotoFilter("rssview");
        assertIssueNavigatorDisplaying("1", "1", "1");
        assertLinkPresentWithText("Feature 00");
    ...
    public void testCommentRssFeedForIssues()
    {
        ...
        try
        {
            ...
            for (Iterator iterator = commentItems.iterator(); iterator.hasNext();)
            {
                Item item = (Item) iterator.next();
    ...
    public void testCommentRssFeedForIssuesWithAbsoluteDateRange()
    {
        ...
        // from - to matching a comment created date but no issues
        goBackFromRssView();
        displayAllIssues();
    ...
    public void testCommentRssFeedForIssuesWithRelativeDateRange()
    {
        ...
        submit("show");
        clickLink("rssComments");
        // Check that only comment 4 (with a date after 17/Apr/06) is listed in the RSS. Comments 1, 2 and 3
        ...
        submit("show");
        //check that no issues were found and no rss comments feed link exists
        assertTextPresent("No matching issues found.");
        assertLinkNotPresent("rssComments");
    ...
    public void testRssIssueFeedForXssDescription()
    {
        ...
        // Click Link 'Issues' (id='rssIssues').
    ...
    public void testRssCommentFeedForXssDescription()
    {
        ...
        // Click Link 'Comments' (id='rssComments').
