...
class DashboardImpl extends AbstractFuncTestUtil implements Dashboard
{
    ...
    {
        tester.gotoPage("/secure/AddFavourite.jspa?entityType=PortalPage&entityId=" + id);
        return this;
    }

    public Dashboard unFavouriteDashboard(final long id)
    {
        tester.gotoPage("/secure/RemoveFavourite.jspa?entityType=PortalPage&entityId=" + id);
        return this;
    }
    ...
    {
        tester.gotoPage("/secure/RestoreDefaultDashboard.jspa?confirm=true");
        return this;
    }
    ...
    {
        tester.gotoPage(createAddUrl(info, cloneId));
    }
    ...
    {
        tester.gotoPage(createEditUrl(info));
    }
