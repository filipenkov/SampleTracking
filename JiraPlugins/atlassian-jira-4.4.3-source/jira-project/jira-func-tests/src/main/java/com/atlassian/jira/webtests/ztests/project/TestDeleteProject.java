...
public class TestDeleteProject extends FuncTestCase
{
    ...
    {
        assertProjectDeletedInStandardEdition();
    ...
    public void testDeleteProjectEnterprise()
    {
        ...
        //some additional enterprise checks here
        ...
        tester.assertTextNotPresent("homosapien");
        text.assertTextPresent(new TableCellLocator(tester, "workflow_schemes_table", 1, 2), "Inactive");
        ...
        tester.assertTextPresent("The table below shows existing Issue Type Screen Schemes.");
        tester.assertTextNotPresent("homosapien");
    }
