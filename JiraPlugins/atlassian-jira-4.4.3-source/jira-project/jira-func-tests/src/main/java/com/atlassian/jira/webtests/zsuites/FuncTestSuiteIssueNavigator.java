...
import com.atlassian.jira.webtests.ztests.navigator.TestIssueNavigatorPageShown;
...
import com.atlassian.jira.webtests.ztests.navigator.TestIssueNavigatorSearchFilter;
...
import com.atlassian.jira.webtests.ztests.navigator.TestNavigatorPages;
...
public class FuncTestSuiteIssueNavigator extends FuncTestSuite
{
    ...
    public FuncTestSuiteIssueNavigator()
    {
        ...
        addTest(TestNavigatorPages.class);
