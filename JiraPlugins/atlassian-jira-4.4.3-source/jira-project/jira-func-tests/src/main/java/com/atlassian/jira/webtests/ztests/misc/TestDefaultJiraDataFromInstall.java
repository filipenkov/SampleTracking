...
public class TestDefaultJiraDataFromInstall extends JIRAWebTest
{
    ...
    private void _testDefaultSubTaskOptions()
    {
        ...
        assertions.getTableAssertions().assertTableContainsRowOnce(subTaskTypesTable,
                new Object[] {"Sub-task", "The sub-task of the issue", new ImageCell(ISSUE_IMAGE_SUB_TASK), new XsrfLinkCell("EditSubTaskIssueTypes!default.jspa?id=5", "Edit")});

        // assert Sub Task appears as part of the Default Issue Type Scheme
        tester.clickLinkWithText("Manage");
    ...
    public void _testEnterpriseDefaultJiraPermissions() throws SAXException
    {
        ...
        assertEquals(5, projectPermissionsTable.getRowCount()); //3 + 1 header row
        ...
        assertTrue(tableCellHasText(projectPermissionsTable, 3, 0, "View Version Control"));
        ...
        assertEquals(13, issuePermissionsTable.getRowCount());
        ...
        assertTrue(tableCellHasText(issuePermissionsTable, 12, 0, "Set Issue Security"));
        assertNoRole(issuePermissionsTable, 12);
