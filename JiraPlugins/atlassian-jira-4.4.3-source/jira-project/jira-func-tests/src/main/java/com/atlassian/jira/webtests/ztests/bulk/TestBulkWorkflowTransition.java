...
public class TestBulkWorkflowTransition extends BulkChangeIssues
{
    ...
    public void testNotAvailableFields()
    {
        ...
        navigation.workflows().chooseWorkflowAction("jira_2_6");
    ...
    public void testWorkflowTransitionCompleteWalkthrough()
    {
        ...
        grantGlobalPermission(BULK_CHANGE, Groups.USERS);
        _testToOperationDetailsWorkflowTranisition();
        navigation.workflows().chooseWorkflowAction("jira_5_5");
        assertTextPresent(WORKFLOW_TRANSITION_EDIT_TEXT);
    ...
    public void testBulkTransitionWithCommentVisibility()
    {
        ...
        // Choose the workflow to transition
        navigation.workflows().chooseWorkflowAction("jira_3_4");
    ...
    /**
     * Multiple Screen Tabs - project & issue type
     */
    ...
    public void testForIssueSchemeConflictsBetweenProjects()
    {
        ...
        // "Change Security Level: NOTE: The projects of the selected issues are associated with different issue level security schemes."
        _testToOperationDetailsWorkflowTranisition();
        navigation.workflows().chooseWorkflowAction("jira_5_5");
        assertTextPresent(WORKFLOW_TRANSITION_EDIT_TEXT);
        ...
        assertTableRowsEqual("tab2", 17, new String[][] {
                { "N/A", "Change Security Level", "NOTE: The projects of the selected issues are associated with different issue level security schemes." } });
    ...
    public void testEnsurePostFunctionExecutedInWorkflow()
    {
        restoreWithGlobalWorkflowPermission("TestBulkWorkflowTransitionEnterprise.xml");
        _testToOperationDetailsWorkflowTranisition();
        navigation.workflows().chooseWorkflowAction("Second Workflow_2_6");
        assertTextPresent(WORKFLOW_TRANSITION_EDIT_TEXT);
    ...
    public void testCustomFieldContextAndIssueTypeBehaviour()
    {
        ...
        assertTableRowsEqual("editfields", 4, new String[][] {
