...
public class AdministrationImpl extends AbstractFuncTestUtil implements Administration, FuncTestLogger
{
            ...
            final Navigation navigation, final Assertions assertions)
    {
        ...
        this.project = new ProjectImpl(tester, environmentData, navigation, assertions, asynchronousTasks);
        ...
        this.workflowSchemes = new WorkflowSchemesImpl(tester, environmentData, childLogIndentLevel());
    ...
    {
        restoreData(path, fileName, clearCache, username, password, useDefaultPaths, LicenseKeys.V2_COMMERCIAL.getLicenseString());
    }
    ...
    {
        tester.gotoPage(PAGE_TRACKBACKS);
        tester.checkCheckbox("acceptPings", "true");
    ...
    {
        final String deleteLink = "del_" + permission + "_" + group;
    ...
    public void addGlobalPermission(final int permission, final String group)
    {
        ...
        final String addUrl = page.addXsrfToken("secure/admin/jira/GlobalPermissions.jspa?groupName=" + group + "&permType=" + permission + "&action=add");
