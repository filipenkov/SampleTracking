 ...
 * </p>
 * <p>
 * This Test is only suitable for Enterprise Edition, because it uses "Field Configuration Schemes".
...
public class TestMoveIssueAndRemoveFieldsEnterprise extends JIRAWebTest
{
    ...
    {
        super.setUp();
        restoreData("TestMoveIssueAndRemoveFieldsEnterprise.xml");
    }
    ...
    public void testMoveIssueType() throws SAXException
    {
        ...
        WebTable moveConfirmTable = getTable("move_confirm_table");
        ...
        assertTableHasMatchingRow(moveConfirmTable, "Type", "Bug", "Task");
        assertTableHasMatchingRow(moveConfirmTable, "Priority", "Minor", "");
        assertTableHasMatchingRow(moveConfirmTable, "Fix Version/s", "v1.1", "");
        assertTableHasMatchingRow(moveConfirmTable, "Affects Version/s", "v1.0", "");
        assertTableHasMatchingRow(moveConfirmTable, "Security Level", "Level KingRat", "");
        ...
        text.assertTextPresent(locator, "Mahatma Gandhi");
        locator = new IdLocator(tester, "priority-val");
        assertTrue(locator.getNodes().length == 0);
        locator = new IdLocator(tester, "fixfor-val");
        assertTrue(locator.getNodes().length == 0);
        locator = new IdLocator(tester, "versions-val");
        assertTrue(locator.getNodes().length == 0);
        locator = new IdLocator(tester, "security-val");
        assertTrue(locator.getNodes().length == 0);
        ...
        tester.gotoPage("/plugins/servlet/project-config/" + "RAT" + "/fields");
        assertions.assertNodeByIdHasText("project-config-fields-scheme-name", "Hidden Treasure FC Scheme");
        ...
        gotoIssue("RAT-13");
        // Assert the Issue Key
        locator = new IdLocator(tester, "key-val");
        text.assertTextPresent(locator, "RAT-13");
        
        // Assert Priority missing
        locator = new IdLocator(tester, "assignee-val");
        text.assertTextPresent(locator, "Mahatma Gandhi");
        ...
        assertTableCellHasImageInContext(issueTable, 1, 0, "/images/icons/issue_subtask.gif");
        assertTableCellHasText("issuetable", 1, 1, "RAT-14");
        assertTableCellHasImageInContext(issueTable, 1, 5, "/images/icons/priority_minor.gif");
        assertEquals("", issueTable.getCellAsText(1, 11).trim());
        assertTableCellHasText("issuetable", 1, 12, "v1.1");
        assertTableCellHasText("issuetable", 1, 13, "v1.0");
        // Assert "RAT-13" is now task and has lost hidden fields.
        assertTableCellHasImageInContext(issueTable, 2, 0, "/images/icons/task.gif");
    ...
    public void testMoveIssueTypeOnSubtask() throws SAXException
    {
        ...
        assertTextNotPresent("Fix Version");
        assertTextNotPresent("Affects Version");
        ...
        WebTable issueTable = getTable("issuetable");
        // Assert "RAT-14"
        assertTableCellHasImageInContext(issueTable, 1, 0, "/images/icons/subtask.gif");
        assertTableCellHasText("issuetable", 1, 1, "RAT-14");
    ...
    public void testMoveProject() throws SAXException
    {
        ...
        assertTableHasMatchingRow(moveConfirmTable, "Type", "Bug", "Bug");
        assertTableHasMatchingRow(moveConfirmTable, "Priority", "Minor", "");
        assertTableHasMatchingRow(moveConfirmTable, "Fix Version/s", "v1.1", "");
        assertTableHasMatchingRow(moveConfirmTable, "Affects Version/s", "v1.0", "");
        assertTableHasMatchingRow(moveConfirmTable, "Security Level", "Level KingRat", "");
        ...
        tester.gotoPage("/plugins/servlet/project-config/" + "PIG" + "/fields");
        assertions.assertNodeByIdHasText("project-config-fields-scheme-name", "Bug is Limited FC Scheme");
        tester.clickLink("project-config-fields-scheme-change");
        ...
        assertTableCellHasImageInContext(issueTable, 4, 0, "/images/icons/issue_subtask.gif");
        assertTableCellHasText("issuetable", 4, 1, "PIG-16");
        assertTableCellHasImageInContext(issueTable, 4, 5, "/images/icons/priority_minor.gif");
        ...
        assertTableCellHasImageInContext(issueTable, 5, 0, "/images/icons/bug.gif");
    ...
    public void testBulkMoveIssueType() throws SAXException
    {
        ...
        assertTableCellHasImageInContext(issueTable, 2, 0, "/images/icons/bug.gif");
        assertTableCellHasText("issuetable", 2, 1, "RAT-13");
        assertTableCellHasImageInContext(issueTable, 2, 5, "/images/icons/priority_minor.gif");
        assertTableCellHasText("issuetable", 2, 11, "Level KingRat");
        assertTableCellHasText("issuetable", 2, 12, "v1.1");
        assertTableCellHasText("issuetable", 2, 13, "v1.0");
        // Assert current setup of "RAT-12"
        assertTableCellHasImageInContext(issueTable, 3, 0, "/images/icons/bug.gif");
        assertTableCellHasText("issuetable", 3, 1, "RAT-12");
        assertTableCellHasImageInContext(issueTable, 3, 5, "/images/icons/priority_blocker.gif");
        assertTableCellHasText("issuetable", 3, 11, "Level KingRat");
        assertTableCellHasText("issuetable", 3, 12, "v0.9");
        assertTableCellHasText("issuetable", 3, 13, "v0.1");
        ...
        selectOption("10022_1_issuetype", "Task");
        submit("Next");
        ...
        assertEquals("", issueTable.getCellAsText(3, 12).trim());
    ...
    public void testBulkMoveIssueTypeOnSubtask() throws SAXException
    {
        ...
        selectOption("10022_5_10022_issuetype", "Limited Subtask");
        submit("Next");
    ...
    public void testBulkMoveProject() throws SAXException
    {
        ...
        assertTableCellHasImageInContext(issueTable, rowNum, 0, "/images/icons/bug.gif");
        ...
        assertEquals("", issueTable.getCellAsText(rowNum, 12).trim());
        ...
        assertTableCellHasImageInContext(issueTable, 3, 0, "/images/icons/issue_subtask.gif");
        assertTableCellHasText("issuetable", 3, 1, "PIG-17");
        assertTableCellHasText("issuetable", 3, 2, "Get Uncle Matty a new Leg");
        // Assert priority
        assertTableCellHasImageInContext(issueTable, 3, 5, "/images/icons/priority_minor.gif");
        // security, Fix Version and Affects Version should be null
        assertEquals("", issueTable.getCellAsText(3, 11).trim());
        assertEquals("", issueTable.getCellAsText(3, 12).trim());
        assertEquals("", issueTable.getCellAsText(3, 13).trim());
    ...
    public void testBulkMigrate_AltersIssue() throws SAXException
    {
        gotoAdmin();
        // Edit Project Rattus
        gotoPage("/plugins/servlet/project-config/RAT/issuetypes");
        ...
        selectOption("schemeId", "Bugless Scheme");
        submit(" OK ");
        ...
        gotoPage("/plugins/servlet/project-config/RAT/issuetypes");
        assertions.assertNodeByIdHasText("project-config-header-name", "Rattus");
        assertions.assertNodeByIdHasText("project-config-issuetype-scheme-name", "Bugless Scheme");
...
//        assertions.assertNodeByIdHasText("project-config-header-name", "Rattus");
        ...
        assertEquals("", issueTable.getCellAsText(2, 13).trim());
        // Assert "RAT-12"
        assertTableCellHasImageInContext(issueTable, 3, 0, "/images/icons/task.gif");
        assertTableCellHasText("issuetable", 3, 1, "RAT-12");
        assertTableCellHasNoImage(issueTable, 3, 5);
        assertEquals("", issueTable.getCellAsText(3, 11).trim());
        assertEquals("", issueTable.getCellAsText(3, 12).trim());
    ...
    public void testBulkMigrate_AltersSubtask() throws SAXException
    {
        ...
        checkCheckbox("createType", "chooseScheme");
        selectOption("schemeId", "No Subtask Scheme");
        submit(" OK ");
        ...
        gotoPage("/plugins/servlet/project-config/RAT/issuetypes");
        assertions.assertNodeByIdHasText("project-config-header-name", "Rattus");
        assertions.assertNodeByIdHasText("project-config-issuetype-scheme-name", "No Subtask Scheme");
    ...
    public void testConvertSubtaskToIssue() throws SAXException
    {
        ...
        WebTable issueTable = getTable("issuetable");
        // Assert subtask has changed appropriately "RAT-14"
        assertTableCellHasImageInContext(issueTable, 1, 0, "/images/icons/task.gif");
        assertTableCellHasText("issuetable", 1, 1, "RAT-14");
        assertTableCellHasNoImage(issueTable, 1, 5);
        assertEquals("", issueTable.getCellAsText(1, 11).trim());
        assertTrue(issueTable.getCellAsText(1, 12).trim().equals(""));
    ...
    public void testConvertIssueToSubtaskOfIssueWithNoSecurity() throws SAXException
    {
        ...
        setFormElement("parentIssueKey", "RAT-10");
        selectOption("issuetype", "Limited Subtask");
        submit("Next >>");
        ...
        WebTable issueTable = getTable("issuetable");
        // Assert "RAT-12"
        assertTableCellHasImageInContext(issueTable, 3, 0, "/images/icons/subtask.gif");
        assertTableCellHasText("issuetable", 3, 1, "RAT-12");
        assertEquals("", issueTable.getCellAsText(3, 11).trim());
    ...
    public void testConvertIssueToSubtaskOfIssueWithSecurity() throws SAXException
    {
        ...
        // Convert to subtask
        clickLink("issue-to-subtask");
        setFormElement("parentIssueKey", "RAT-11");
        selectOption("issuetype", "Limited Subtask");
        submit("Next >>");
        assertTextPresent("Convert Issue to Sub-task: RAT-12");
        assertTextPresent("All fields will be updated automatically.");
    ...
    public void testMoveSubtaskToNewParentWithHiddenSecurity() throws SAXException
    {
        ...
        // Select new Parent
        setFormElement("parentIssue", "RAT-10");
        ...
        assertTableCellHasText("issuetable", 1, 1, "RAT-14");
        assertTableCellHasNoText(issueTable, 1, 11);
        assertTrue(issueTable.getCellAsText(1, 12).trim().equals("v1.1"));
        assertTrue(issueTable.getCellAsText(1, 13).trim().equals("v1.0"));
    }
    ...
    public void testMoveSubtaskWithHiddenSecurityToNewParent() throws SAXException
    {
        ...
        assertTextPresent("Select a new parent issue for this subtask.");
        // Select new Parent
        setFormElement("parentIssue", "RAT-11");
        submit("Change Parent");
    ...
    {
        return getDialog().getResponse().getTableWithID(tableID);
    }
}
