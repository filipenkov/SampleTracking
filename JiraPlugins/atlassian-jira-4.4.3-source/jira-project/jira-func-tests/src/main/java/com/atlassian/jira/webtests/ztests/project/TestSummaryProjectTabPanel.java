...
public class TestSummaryProjectTabPanel extends FuncTestCase
{
    ...
    public void testProjectUrl() throws Exception
    {
        ...
        navigation.browseProject("HSP");
        text.assertTextNotPresent(new XPathLocator(tester, "//div[@id='primary']/div[1]//li"), "URL:");
        ...
        // recheck url
        navigation.browseProject("HSP");
        text.assertTextPresent(new XPathLocator(tester, "//div[@id='primary']/div[1]//li"), "URL:");
        tester.assertLinkPresentWithText("http://www.homosapien.com");
    }

    public void testProjectKey() throws Exception
    {
        navigation.browseProject("HSP");
        text.assertTextSequence(new XPathLocator(tester, "//div[@id='primary']/div[1]//li"), new String[] { "Key:", "HSP" });
    }
