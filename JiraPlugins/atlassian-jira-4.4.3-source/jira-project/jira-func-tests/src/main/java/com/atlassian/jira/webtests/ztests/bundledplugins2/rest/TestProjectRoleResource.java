...
public class TestProjectRoleResource extends RestFuncTest
{
    ...
    {
        final Map<String, String> mky = projectRoleClient.get("MKY");
    ...
    public void testViewRoleActorsIsSortedByDisplayName() throws Exception
    {
        ...
        administration.usersAndGroups().addUser("aaaa", "aaaa", "zzzz", "aaa@aaa.com");
        administration.usersAndGroups().addUser("zzzz", "zzzz", "aaaa", "zzz@zzz.com");
    ...
    public void testSetRoleActors() throws Exception
    {
        ...
        administration.usersAndGroups().addUser("aaaa", "aaaa", "zzzz", "aaa@aaa.com");
        administration.usersAndGroups().addUser("zzzz", "zzzz", "aaaa", "zzz@zzz.com");
        administration.usersAndGroups().addGroup("ladida");

        projectRoleClient.setActors("MKY", "Users", MapBuilder.<String, String[]>newBuilder()
                .add("atlassian-user-role-actor", new String[]{"aaaa", "zzzz"})
                .add("atlassian-group-role-actor", new String[]{"ladida"})
                .toMap()
        );
        ...
        final Response response = projectRoleClient.setActors("MKY", "Users", MapBuilder.<String, String[]>newBuilder()
                .add("atlassian-user-role-actor", new String[] { "aaaa"})
                .add("atlassian-group-role-actor", new String[] { "azza" })
                .toMap()
        );

        assertEquals(NOT_FOUND.getStatusCode(), response.statusCode);
        assertEquals(new Errors().addError("'azza' does not exist."), response.entity);
    }
