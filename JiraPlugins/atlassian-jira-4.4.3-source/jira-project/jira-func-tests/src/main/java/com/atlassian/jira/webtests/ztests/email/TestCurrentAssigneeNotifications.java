...
public class TestCurrentAssigneeNotifications extends EmailFuncTestCase
{
            ...
            throws MessagingException, IOException
    {
        ...
        for (Object msg : messagesForRecipient)
        {
            ...
            final String body = String.valueOf(message.getContent());
            assertTrue(subject.indexOf("HSP-1") != -1);
            assertTrue(body.indexOf("HSP-1") != -1);
            assertTrue(body.indexOf("Assignee: homer") != -1);
            assertTrue(body.indexOf("(was: bart)") != -1);
        }
    }
