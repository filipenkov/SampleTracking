...
public class TestCloneIssueWithSubTasks extends JIRAWebTest
{
    ...
    public void testCloneWithLinks()
    {
        ...
        assertTextSequence(new String[]{"This issue <strong>out</strong>", "HSP-3"});
        assertTextSequence(new String[]{"This issue <strong>in</strong>", "HSP-4"});
        assertTextSequence(new String[]{"This issue <strong>outward</strong>", "HSP-5"});
        assertTextSequence(new String[]{"This issue <strong>inward</strong>", "HSP-6"});
    ...
    public void testCloneWithClonersLink()
    {
        ...
        assertTextPresent(LINKS_TEXT);
        assertTextSequence(new String[]{"This issue <strong>" + CLONERS_INWARD_LINK_NAME + "</strong>", originalIssueKey});

        // Ensure the Cloners link appears on the issue that was cloned
        gotoIssue(originalIssueKey);
        assertTextPresent(LINKS_TEXT);
        assertTextSequence(new String[]{"This issue <strong>" + CLONERS_OUTWARD_LINK_NAME + "</strong>", cloneIssueKey});
    }
