...
public class TestMoveSubTaskEnterprise extends EmailFuncTestCase
{
    ...
    {
        GreenMail smtpServer = configureAndStartSmtpServer();
...
//        testStrings.add("If you think it was sent incorrectly contact one of the administrators: "+ baseUrl + "secure/Administrators.jspa");
        ...
        assertTrue(body.indexOf("Parent Issue: COW-38  (was: COW-35)") > -1);
        assertTrue(body.indexOf("Security: A  (was: MyFriendsOnly)") > -1);
    }
