...
//        _testWizardCancelForMoveSubTaskParent();//todo - test cant find any button with value: Cancel
    ...
    {
        activateSubTasks();
        setFormElement("name", NEW_SUBTASK_TYPE);
        setFormElement("description", "temporary subtask type");
        submit("Add");
    }
    ...
    public void testMoveParentSubTaskLinks()
    {
        ...
        assertTextSequence(new String[]{"This issue", linkLabel, firstParent, origParentName});
    }
//    /**
