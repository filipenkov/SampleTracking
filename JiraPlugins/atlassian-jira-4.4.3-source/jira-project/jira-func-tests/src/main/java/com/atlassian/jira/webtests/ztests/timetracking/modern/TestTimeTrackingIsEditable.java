...
public class TestTimeTrackingIsEditable extends FuncTestCase
{
    ...
    private void addTimeTrackingFieldToResolveIssueScreen()
    {
        ...
        tester.assertLinkPresent("configure_fieldscreen_Resolve Issue Screen");
        tester.clickLink("configure_fieldscreen_Resolve Issue Screen");
        tester.selectOption("fieldId","Time Tracking");
