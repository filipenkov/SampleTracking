...
/**
 * Uses the tests defined in {@link AbstractTestCreateWorklogAsField} to test the "log work" system field on Resolve
 * transitions.
 *
 * @since v4.2
 */
...
public class TestCreateWorklogOnResolveTransition extends AbstractTestCreateWorklogAsField
{
    ...
    protected LogWorkRunner getLogWorkRunner()
    {
        ...
        {
            logWorkRunner = new ResolveTransitionLogWorkRunner();
        }
