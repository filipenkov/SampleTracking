...
import com.atlassian.jira.webtests.ztests.workflow.TestDraftWorkflowEnterprise;
...
import com.atlassian.jira.webtests.ztests.workflow.TestWorkflowMigrationEnterprise;
import com.atlassian.jira.webtests.ztests.workflow.TestWorkflowNameEditingEnterprise;
...
public class FuncTestSuiteWorkflow extends FuncTestSuite
{
    ...
    public FuncTestSuiteWorkflow()
    {
        ...
        addTest(TestWorkflowMigrationEnterprise.class);
        addTest(TestWorkflowNameEditingEnterprise.class);
        ...
        addTest(TestDraftWorkflowEnterprise.class);
