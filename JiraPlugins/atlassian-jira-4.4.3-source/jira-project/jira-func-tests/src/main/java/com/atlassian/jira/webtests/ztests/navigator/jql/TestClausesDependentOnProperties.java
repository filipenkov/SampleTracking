...
public class TestClausesDependentOnProperties extends FuncTestCase
{
    ...
    {
        administration.generalConfiguration().setUserSearchingByFullName(true);
        ...
        // turn off the full name searching
        administration.generalConfiguration().setUserSearchingByFullName(false);

        // now full name search wont work, but user name search will
        assertSearchError("assignee = '" + FRED_FULLNAME + "'", "The value '" + FRED_FULLNAME + "' does not exist for the field 'assignee'.");
        assertSearchResults("assignee = fred");
        assertSearchError("reporter = '" + FRED_FULLNAME + "'", "The value '" + FRED_FULLNAME + "' does not exist for the field 'reporter'.");
        assertSearchResults("reporter = fred");
        assertSearchError("UserCF = '" + FRED_FULLNAME + "'", "The value '" + FRED_FULLNAME + "' does not exist for the field 'UserCF'.");
        assertSearchResults("UserCF = fred");
    }
