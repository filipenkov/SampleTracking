...
public class TestAddIssueSecurity extends FuncTestCase
{
    ...
    public void setUpTest()
    {
        administration.issueSecuritySchemes().newScheme(TEST_SCHEME_NAME, "blah").newLevel(TEST_SECURITY_LEVEL_NAME,
                "blah");
        administration.usersAndGroups().addGroup("group1");
    ...
    public void tearDownTest()
    {
        ...
        administration.usersAndGroups().deleteGroup("group1");
        administration.usersAndGroups().deleteUser("user1");
        administration.usersAndGroups().deleteUser("user2");
    }
    ...
    {
        goToTestLevel().addIssueSecurity(IssueSecurity.GROUP, "group1")
                .addIssueSecurity(IssueSecurity.USER, "user1")
                .addIssueSecurity(IssueSecurity.USER, "user2");
        goToAddSecurityIssue();
        assertCannotAddIssueSecurity(IssueSecurity.GROUP, "group1");
