...
public class TestFavouriteAndMyFilters extends FuncTestCase
{
    ...
    static final FilterItem FILTER_10000 = new FilterItem(10000L, "All", "", ADMIN_LONG, 2L, Collections.<WebTestSharePermission>emptyList(), false, 1L, OPERATIONS, 0L);
    static final FilterItem FILTER_10001 = new FilterItem(10001L, "All My", "yadayada", JOE_LONG, 2L, GLOBAL_SHARE, true, 2L, OPERATIONS, 3L);
    static final FilterItem FILTER_10010 = new FilterItem(10010L, "Nick", "", ADMIN_LONG, 2L, GLOBAL_SHARE, false, 4L, OPERATIONS, 0L);
    static final FilterItem FILTER_10020 = new FilterItem(10020L, "New Features", "", ADMIN_LONG, 0L, GROUP_DEVELOPERS_SHARE, true, 0L, OPERATIONS, 1L);
    static final FilterItem FILTER_10030 = new FilterItem(10030L, "Nobody's All", "Yadyayda", NOBODY_LONG, 2L, Collections.<WebTestSharePermission>emptyList(), true, 0L, OPERATIONS, 1L);
    ...
    public void testOperations()
    {
        ...
        filterItem.setOperations(ImmutableList.of("Edit", "Delete", "Columns"));
    ...
    public void testDeleteUser()
    {
        ...
        navigation.login(ADMIN_USERNAME, ADMIN_PASSWORD);
        _testDeleteConfirm(ADMIN_USERNAME, 3, 2, 0);
    ...
    private void _testDeleteConfirm(String user, int row, int shared, int favs)
    {
        ...
        tester.gotoPage("secure/admin/user/DeleteUser!default.jspa?returnUrl=UserBrowser.jspa&name=" + user);

        TableCellLocator cellLocator = new TableCellLocator(tester, "delete_user_confirm", row, 1);
        text.assertTextPresent(cellLocator, "" + shared);
        cellLocator = new TableCellLocator(tester, "delete_user_confirm", row + 1, 1);
        text.assertTextPresent(cellLocator, "" + favs);
    }
    ...
    private void checkAnonymousScreen(List /*<FilterItems>*/ expectedFilters)
    {
        ...
        text.assertTextPresent(xpath("//ul[@id='filter_type_table']"), "Search");
        text.assertTextPresent(xpath("//ul[@id='filter_type_table']"), "Popular");
        text.assertTextNotPresent(xpath("//ul[@id='filter_type_table']"), "Favourite");
        text.assertTextNotPresent(xpath("//ul[@id='filter_type_table']"), "My");
