...
import com.atlassian.jira.webtest.selenium.capture.FFMpegSuiteListener;
...
//                new LogPageSourceListener(),
                new LogTestInformationListener("=====WEB DRIVER"),
                new DumpPageSourceListener(),
    ...
    {
        return new JiraTestWatchDog(WebDriverCategoryPredicate.INSTANCE, 3, 1, TimeUnit.MINUTES, 4,
    ...
    {
        this.listeners = Lists.newArrayList(checkNotNull(listeners));
