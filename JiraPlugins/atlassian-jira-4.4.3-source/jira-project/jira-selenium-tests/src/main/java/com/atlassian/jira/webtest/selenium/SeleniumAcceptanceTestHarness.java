...
import com.atlassian.jira.webtest.selenium.admin.avatarpicker.TestAvatarPicker;
...
import com.atlassian.jira.webtest.selenium.admin.issuetypes.TestIssueTypeSchemes;
import com.atlassian.jira.webtest.selenium.admin.licenses.TestUserLimitedLicense;
import com.atlassian.jira.webtest.selenium.admin.lookandfeel.TestLookAndFeel;
import com.atlassian.jira.webtest.selenium.admin.upm.TestUpm;
import com.atlassian.jira.webtest.selenium.ajaxissuepicker.TestAjaxIssuePicker;
...
import com.atlassian.jira.webtest.selenium.ajaxuserpicker.TestUserPickerErrorHandling;
import com.atlassian.jira.webtest.selenium.applinks.TestAppLinksAdministration;
import com.atlassian.jira.webtest.selenium.assignee.TestAssignFormDirtyWarning;
import com.atlassian.jira.webtest.selenium.assignee.TestAssigneeFieldNoContext;
import com.atlassian.jira.webtest.selenium.auidialog.actions.TestIssueActionsDialog;
...
import com.atlassian.jira.webtest.selenium.auidialog.hints.TestHintsInDialogs;
...
import com.atlassian.jira.webtest.selenium.dashboard.TestPortletUpgrade;
...
import com.atlassian.jira.webtest.selenium.gadgets.TestAdminGadget;
...
import com.atlassian.jira.webtest.selenium.gadgets.TestPieChartGadget;
...
import com.atlassian.jira.webtest.selenium.gadgets.TestResolutionTimeGadget;
...
import com.atlassian.jira.webtest.selenium.gadgets.TestUnknownLegacyPortlet;
...
import com.atlassian.jira.webtest.selenium.issue.TestAvailableActionsAndOperations;
import com.atlassian.jira.webtest.selenium.issue.TestAvailableActionsAndOperationsInGadgets;
...
import com.atlassian.jira.webtest.selenium.issue.TestCreateAndEditLabels;
import com.atlassian.jira.webtest.selenium.issue.TestCreateIssue;
...
import com.atlassian.jira.webtest.selenium.issue.TestEditLabelsPicker;
...
import com.atlassian.jira.webtest.selenium.issue.dialogs.TestManageAttachments;
...
import com.atlassian.jira.webtest.selenium.jql.TestJqlAutoCompleteFieldsNotVisibleWhenHidden;
...
import com.atlassian.jira.webtest.selenium.keyboardcommands.TestKeyboardCommands;
import com.atlassian.jira.webtest.selenium.keyboardcommands.TestKeyboardUpCommandToViewIssue;
import com.atlassian.jira.webtest.selenium.menu.TestCreateIssueMenu;
import com.atlassian.jira.webtest.selenium.menu.TestDashboardMenu;
import com.atlassian.jira.webtest.selenium.menu.TestIssuesMenu;
import com.atlassian.jira.webtest.selenium.menu.TestProjectMenu;
...
import com.atlassian.jira.webtest.selenium.navigator.TestIssueNavigatorIssueTypeFilter;
...
import com.atlassian.jira.webtest.selenium.plugin.reloadable.TestPortletModuleTypeEnabling;
...
import com.atlassian.jira.webtest.selenium.popupuserpicker.TestPopupIssueTypePicker;
...
import com.atlassian.jira.webtest.selenium.user.TestUserAvatar;
...
import com.atlassian.jira.webtest.selenium.websudo.TestWebSudo;
import com.atlassian.jira.webtest.selenium.workflows.TestPublishDraftWorkflow;
...
public class SeleniumAcceptanceTestHarness extends FuncTestSuite
{
    ...
    private SeleniumAcceptanceTestHarness()
    {
        ...
        runOnlyQuarantinedTests = new Boolean(System.getProperty("atlassian.test.run.only.quarantined"));
        ...
        addTest(TestPopupIssueTypePicker.class);

        addTest(TestAjaxIssuePicker.class);
        addTest(TestEditLabelsPicker.class);
        addTest(TestCreateAndEditLabels.class);
        ...
        addTest(TestUserPickerErrorHandling.class);
        ...
        addTest(TestIssueNavigatorIssueTypeFilter.class);
        ...
        addTest(TestIssueActionsDialog.class);
        ...
        // HEADER
        addTest(TestDashboardMenu.class);
        addTest(TestProjectMenu.class);
        addTest(TestCreateIssueMenu.class);
        ...
        // A long running JQL test, should be here to allow the batches to split better
        addTest(TestJqlAutoCompleteFieldsNotVisibleWhenHidden.class);
        ...
        addTest(TestResolutionTimeGadget.class);
        addTest(TestStatsGadget.class);
        addTest(TestPieChartGadget.class);
        ...
        addTest(TestAvatarPicker.class);
        addTest(TestPortletUpgrade.class);
        addTest(TestActivityStream.class);
        addTest(TestLookAndFeel.class);

        addTest(TestAvailableActionsAndOperations.class);
        addTest(TestAvailableActionsAndOperationsInGadgets.class);
        addTest(TestKeyboardShortcutHintsInIssueNavigator.class);

        addTest(TestKeyboardCommands.class);
        ...
        addTest(TestUnknownLegacyPortlet.class);
        ...
        addTest(TestPublishDraftWorkflow.class);
        addTest(TestUserAvatar.class);
        addTest(TestHintsInDialogs.class);
        ...
        //Dirty Forms
        addTest(TestAssignFormDirtyWarning.class);

        addTest(TestUpm.class);
        ...
        addTest(TestPortletModuleTypeEnabling.class);

        // WebSudo
        addTest(TestWebSudo.class);
