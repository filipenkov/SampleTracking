...
public class TestDeleteIssue extends AbstractIssueDialogTest
{
...
//        artificialLogout();
    ...
    public void testDeleteRedirectsCorrectly() 
    {
        ...
        assertThat.textNotPresent("Issue Navigator");
    ...
    {
        assertThat.elementHasText("jquery=h1.item-summary", "Issue Navigator");
    }
