...
public class TestDashboardEditing extends JiraSeleniumTest
{
    ...
    private static final String GADGET_DROPDOWN = "li[@class='aui-dd-parent dd-allocated']/a[contains(@class,'aui-dd-trigger standard')]";
        private static final String GADGET_DELETE_LINK = "li[@class='aui-dd-parent dd-allocated active']/ul[@class='aui-dropdown standard aui-dropdown-right']//li/a[@class='item-link delete']";
    private static final String FINISH_ADD_GADGET = "css=button.finish";
    private static final String GADGET_COLOUR_OPTION = "li[@class='aui-dd-parent dd-allocated active']/ul[@class='aui-dropdown standard aui-dropdown-right']/li[@class='item-link gadget-colors";
