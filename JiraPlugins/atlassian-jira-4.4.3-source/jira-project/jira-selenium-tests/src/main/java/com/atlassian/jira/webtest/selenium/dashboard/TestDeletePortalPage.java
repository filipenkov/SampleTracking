...
public class TestDeletePortalPage extends AbstractAuiDialogTest
{
    ...
    {
        assertOnManageDashboardsPage();
        assertThat.elementHasText("jquery=div.active-area h2", "Favourite Dashboards");
    }

    private void assertOnMyDashboardsPage()
    {
        assertOnManageDashboardsPage();
        assertThat.elementHasText("jquery=div.active-area h2", "My Dashboards");
    }

    private void assertOnManageDashboardsPage()
    {
        assertThat.elementHasText("jquery=div#content-top h2", "Manage Dashboards");
    }
