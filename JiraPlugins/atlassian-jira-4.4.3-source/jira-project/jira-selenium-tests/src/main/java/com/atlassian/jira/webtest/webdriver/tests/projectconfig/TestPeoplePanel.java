...
import com.atlassian.jira.pageobjects.pages.admin.MoveUserToGroupPage;
...
public class TestPeoplePanel extends BaseJiraWebTest
{
    ...
    public void testServerError()
    {
        ...
        pageBinder.navigateToAndBind(MoveUserToGroupPage.class, "project")
        ...
        final WindowSession windowSession = jira.openWindowSession();
        final WindowSession.BrowserWindow groups = windowSession.openNewWindow("groups");
        groups.switchTo();

        jira.gotoLoginPage().loginAsSysAdmin(MoveUserToGroupPage.class, "project")
    ...
    public void testInvalidProjectLeadErrors()
    {
        ...
        assertFalse(editDialog.setProjectLead("doaks").submitUpdate());
        ...
        assertFalse(editDialog.setProjectLead("").submitUpdate());
