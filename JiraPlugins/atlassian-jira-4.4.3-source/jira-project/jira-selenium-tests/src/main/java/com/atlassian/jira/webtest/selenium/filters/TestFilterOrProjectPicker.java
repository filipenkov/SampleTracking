...
public class TestFilterOrProjectPicker extends GadgetTest
{
    ...
    private static final String POPUP_TITLE = "Filter or Project Picker";
    ...
    private void _testPopupFilter()
    {
        ...
        assertThat.textPresentByTimeout(POPUP_TITLE, TIMEOUT);
    ...
    private void _testPopupProject()
    {
        ...
        client.selectWindow(POPUP_TITLE);
        waitFor(5000);
        assertThat.textPresentByTimeout(POPUP_TITLE);
