...
public class TestIssueTypesPanel extends BaseJiraWebTest
{
    ...
    private static final String BASE_WORKFLOW_URL = "/secure/admin/workflows/WorkflowDesigner.jspa?workflowMode=live&wfName=";
    ...
    public void testDefault()
    {
        ...
        assertEquals(7, issueTypes.size());
    ...
    {
        return new IssueType.Link(name, jira.getProductInstance().getContextPath() + BASE_WORKFLOW_URL + name);
    }
    ...
    private IssueType.Link getFieldConfigurationLink(String name, String id)
    {
        ...
        return new IssueType.Link(name, jira.getProductInstance().getContextPath() + url);
    }

    private IssueType.Link getScreenSchemeLink(String name, String id)
    {
        return new IssueType.Link(name, jira.getProductInstance().getContextPath() + BASE_SCREEN_SCHEME_URL + id);
    }
