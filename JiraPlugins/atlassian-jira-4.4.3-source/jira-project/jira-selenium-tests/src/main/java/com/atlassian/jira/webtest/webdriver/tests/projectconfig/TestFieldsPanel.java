...
public class TestFieldsPanel extends BaseJiraWebTest
{
    ...
    public void testFieldSchemeWithMultipleFieldConfigs()
    {
        ...
        assertTrue(canEditScheme(fieldsPanel, "Multiple Field Configuration Scheme"));
        fieldsPanel = pageBinder.navigateToAndBind(FieldsPanel.class, "LALA");
    ...
    public void testFieldSchemeWithXSS()
    {
        ...
        assertTrue(canEditScheme(fieldsPanel, "<strong>Oh noes</strong>"));
        fieldsPanel = pageBinder.navigateToAndBind(FieldsPanel.class, "XSS");
    ...
    private boolean canEditScheme(final FieldsPanel fieldsPanel, final String schemeName)
    {
        final EditFieldSchemePage editFieldSchemePage = fieldsPanel.gotoEditConfigScheme();
