...
public class TestIssueNavigatorCollapsing extends JiraSeleniumTest
{
    ...
    public void testCollapsing()
    {
        ...
        assertThat.elementNotPresent("jquery=#iss-wrap.lhc-collapsed");

        client.click("jquery=.toggle-lhc");

        assertThat.elementPresentByTimeout("jquery=#iss-wrap.lhc-collapsed");

        getNavigator().gotoFindIssues();
        assertThat.elementPresentByTimeout("jquery=#iss-wrap.lhc-collapsed",1500);

        client.click("jquery=.toggle-lhc");
        assertThat.elementNotPresentByTimeout("jquery=#iss-wrap.lhc-collapsed");
        getNavigator().gotoFindIssues();        
        assertThat.elementNotPresentByTimeout("jquery=#iss-wrap.lhc-collapsed",1500);
