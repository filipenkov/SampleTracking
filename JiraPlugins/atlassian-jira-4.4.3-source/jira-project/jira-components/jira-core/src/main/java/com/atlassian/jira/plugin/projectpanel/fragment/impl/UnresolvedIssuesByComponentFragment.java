...
public class UnresolvedIssuesByComponentFragment extends AbstractUnresolvedIssuesFragment implements ProjectTabPanelFragment
{
    ...
    public UnresolvedIssuesByComponentFragment(final VelocityManager velocityManager, final ApplicationProperties applicationProperites, final JiraAuthenticationContext jiraAuthenticationContext)
    {
    ...
    protected Map<String, Object> createVelocityParams(final BrowseContext ctx)
    {
        ...
        velocityParams.put("urlUtil", new ComponentUrlUtil(getSearchRequest(ctx), jiraAuthenticationContext.getUser(), applicationProperites));
