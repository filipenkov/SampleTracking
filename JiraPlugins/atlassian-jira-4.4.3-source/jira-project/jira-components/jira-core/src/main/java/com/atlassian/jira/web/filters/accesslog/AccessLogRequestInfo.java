...
public class AccessLogRequestInfo
{
    ...
    private void recordLog4JInformation(final HttpServletRequest httpServletRequest, final String requestId, final String atlassianSessionId)
    {
        ...
        final String url = getShortenedRequestUrl(httpServletRequest);
        final String ipAddr = getRemoteAddr(httpServletRequest);
    ...
    private String getShortenedRequestUrl(final HttpServletRequest httpServletRequest)
    {
    ...
    private String removeHostName(final String requestURL)
    {
    ...
    private String removeContextPath(final HttpServletRequest httpServletRequest, String requestURL)
    {
    ...
    private String getRemoteAddr(final HttpServletRequest httpServletRequest)
    {
    ...
    private String generateUniqueRequestId(final long requestCount, final long concurrentRequests)
    {
        ...
        //
        return new StringBuilder().append(sinceEpoch).append("x").append(requestCount).append("x").append(concurrentRequests).toString();
    }
