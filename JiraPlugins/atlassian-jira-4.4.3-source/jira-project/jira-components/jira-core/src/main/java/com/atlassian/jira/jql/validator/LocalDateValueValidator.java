...
class LocalDateValueValidator
{
    ...
    LocalDateValueValidator(final JqlOperandResolver operandResolver, TimeZoneManager timeZoneManager)
    {
        this(operandResolver, new JqlLocalDateSupportImpl(timeZoneManager));
    }
