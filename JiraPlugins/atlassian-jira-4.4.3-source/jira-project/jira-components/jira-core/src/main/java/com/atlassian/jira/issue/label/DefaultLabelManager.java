...
public class DefaultLabelManager implements LabelManager
{
    ...
    public Set<Label> setLabels(final com.opensymphony.user.User remoteUser, final Long issueId, final Set<String> labels, final boolean sendNotification, final boolean causesChangeNotification)
    {
        return setLabels((User) remoteUser, issueId, labels, sendNotification, causesChangeNotification);
    }
    ...
    public Set<Label> setLabels(final com.opensymphony.user.User remoteUser, final Long issueId, final Long customFieldId,
            final Set<String> labels, final boolean sendNotification, final boolean causesChangeNotification)
    {
        return setLabels((User) remoteUser, issueId, customFieldId, labels, sendNotification, causesChangeNotification);
    }
    ...
    public Label addLabel(final com.opensymphony.user.User remoteUser, final Long issueId, final String label, final boolean sendNotification)
    {
        return addLabel((User) remoteUser, issueId, label, sendNotification);
    }
    ...
    public Label addLabel(final com.opensymphony.user.User remoteUser, final Long issueId, final Long customFieldId, final String label,
            final boolean sendNotification)
    {
        return addLabel((User) remoteUser, issueId, customFieldId, label, sendNotification);
    }
    ...
    public Set<String> getSuggestedLabels(final com.opensymphony.user.User user, final Long issueId, final String token)
    {
    ...
    public Set<String> getSuggestedLabels(final com.opensymphony.user.User user, final Long issueId, final Long customFieldId, final String token)
    {
            ...
            User remoteUser, boolean sendNotification)
    {
        ...
        updateBean.setChangeItems(EasyList.build(createLabelsChangeItem(newLabels, oldLabels, customFieldId)));
        doUpdate(updateBean);
    }
