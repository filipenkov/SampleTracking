...
public class AggregateOriginalEstimateSystemField extends AbstractAggregateDurationSystemField
{
    ...
    public AggregateOriginalEstimateSystemField(VelocityManager velocityManager, ApplicationProperties applicationProperties,
                                                JiraAuthenticationContext authenticationContext, AggregateTimeTrackingCalculatorFactory calculatorFactory)
    {
        super(IssueFieldConstants.AGGREGATE_TIME_ORIGINAL_ESTIMATE, "common.concepts.aggregate.original.estimate", "common.concepts.aggregate.original.estimate", ORDER_DESCENDING, new IssueLongFieldComparator(IssueFieldConstants.AGGREGATE_TIME_SPENT), velocityManager, applicationProperties, authenticationContext, calculatorFactory);
    }
