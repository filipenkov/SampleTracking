...
public final class FilterOperationsBean
{
     ...
     * @param username the name of the remote user or null if there is none.
     * @param isAdvancedScreen true iff the operations are to be displayed on the advanced screen
     * @return a FilterOperationsBean representing the correct state of the operations panel for filters.
     */
    public static FilterOperationsBean create(SearchRequest searchRequest, boolean validFilter, String username, final boolean isAdvancedScreen)
    {
        FilterOperationsBean bean = new FilterOperationsBean();
        if (searchRequest != null)
        {
            boolean ownFilter = StringUtils.equals(searchRequest.getOwnerUserName(), username);
