...
public class ActivityUserProfileFragment implements UserProfileFragment
{
    ...
    public String getFragmentHtml(User profileUser, User currentUser)
    {
        ...
        prefsBuilder.add(PREF_USERNAME, profileUser.getName());
        ...
        final String html = "<div class=\"mod-header\"><h3>" + i18n.getText("common.concepts.activity.stream") + "</h3></div><div class=\"mod-content\">" + baos.toString() + "</div>";
        return html;
