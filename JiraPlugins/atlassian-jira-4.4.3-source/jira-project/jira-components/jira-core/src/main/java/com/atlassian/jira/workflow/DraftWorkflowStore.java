...
public interface DraftWorkflowStore
{
     ...
     *
     * @param authorName The username of the user making the edit
     ...
     */
    JiraWorkflow createDraftWorkflow(String authorName, JiraWorkflow parentWorkflow) throws DataAccessException, IllegalStateException, IllegalArgumentException;
     ...
     *
     * @param username is the username of the user updating this draft workflow.
     * @param parentWorkflowName of the saved parent workflow.
     ...
     * @throws DataAccessException RuntimeException wrapper around a DB Exception.
     */
    JiraWorkflow updateDraftWorkflow(String username, String parentWorkflowName, JiraWorkflow workflow) throws DataAccessException;
     ...
     *
     * This method should only be used by upgrade tasks. Use {@link #updateDraftWorkflow(String, String, JiraWorkflow)}
     * instead.
     *
     * @param parentWorkflowName of the saved parent workflow.
     * @param workflow           The {@link JiraWorkflow} to use for the update.
