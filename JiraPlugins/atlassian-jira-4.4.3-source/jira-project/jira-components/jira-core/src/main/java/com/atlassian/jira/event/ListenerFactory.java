...
public class ListenerFactory
{
     ...
     */
    public static JiraListener getListener(String className, Map params) throws ListenerException
    {
        try
        {
            final ComponentClassManager componentClassManager = ComponentManager.getInstance().getComponentClassManager();
