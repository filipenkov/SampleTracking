 ...
 * @since v4.0
 */
public class RecentlyCreatedChartPortlet extends AbstractChartPortlet implements SearchRequestAwareChartPortlet
{
    private static final Logger log = Logger.getLogger(RecentlyCreatedChartPortlet.class);
    private final ChartFactory chartFactory;


    public RecentlyCreatedChartPortlet(JiraAuthenticationContext authenticationContext, PermissionManager permissionManager,
