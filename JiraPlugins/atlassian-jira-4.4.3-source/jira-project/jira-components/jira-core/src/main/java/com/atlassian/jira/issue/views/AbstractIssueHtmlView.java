...
public abstract class AbstractIssueHtmlView extends AbstractIssueView
{
    ...
    public String getBody(Issue issue, IssueViewRequestParams issueViewFieldParams)
    {
        ...
        bodyParams.put("fieldVisibility", new FieldVisibilityBean());
        ...
        bodyParams.put("fieldScreenRenderer", fieldScreenRendererFactory.getFieldScreenRenderer(user, issue, IssueOperations.VIEW_ISSUE_OPERATION, true));
        ...
        if (applicationProperties.getDefaultString(JIRA_ISSUE_ACTIONS_ORDER).equals(ACTION_ORDER_DESC))
        {
    ...
    public String getFooter(Issue issue)
    {
        ...
        footerParams.put("generatedInfo", SearchRequestViewUtils.getGeneratedInfo(authenticationContext.getUser()));
