...
abstract class AbstractAsyncIndexerCommand implements Callable<IndexCommandResult>, ProvidesTaskProgress
{
    ...
    public AbstractAsyncIndexerCommand(final JohnsonEventContainer eventCont, final IndexLifecycleManager indexManager, final Logger log, final I18nHelper i18nHelper)
    {
    ...
    {
        final Event appEvent = new Event(EventType.get("reindex"), IndexAdminImpl.JIRA_IS_BEING_REINDEXED, EventLevel.get(EventLevel.WARNING));
        if (eventCont != null)
        {
