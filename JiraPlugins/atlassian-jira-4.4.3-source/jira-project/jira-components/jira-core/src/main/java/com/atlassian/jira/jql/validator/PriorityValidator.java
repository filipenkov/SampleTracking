...
public class PriorityValidator implements ClauseValidator
{
    ...
    public PriorityValidator(final PriorityResolver priorityResolver, final JqlOperandResolver operandResolver)
    {
        this.supportedOperatorsValidator = getSupportedOperatorsValidator();
        this.rawValuesExistValidator = new RawValuesExistValidator(operandResolver, new IssueConstantInfoResolver<Priority>(priorityResolver));
    }
