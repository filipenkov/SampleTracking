...
public class SaveAsFilter extends SearchDescriptionEnabledAction implements FilterOperationsAction
{
    ...
    public SaveAsFilter(final IssueSearcherManager issueSearcherManager, final ColumnLayoutManager columnLayoutManager, final SearchRequestService searchRequestService, final ShareTypeFactory shareTypeFactory, final JiraAuthenticationContext authCtx, final PermissionManager permissionsManager, final UserSharingPreferencesUtil userSharingPreferencesUtil, final SearchService searchService, final SearchSortUtil searchSortUtil)
    {
    ...
    protected void doValidation()
    {
        ...
        final String userName = (getRemoteUser() != null) ? getRemoteUser().getName() : null;
    ...
    protected String doExecute() throws Exception
    {
        ...
        if (!ctx.getErrorCollection().hasAnyErrors())
        {
            ...
            if ((saveColumnLayout == null) || Key.FILTER.equalsIgnoreCase(saveColumnLayout))
            {
                ...
                {
                    final EditableSearchRequestColumnLayout currLayout = columnLayoutManager.getEditableSearchRequestColumnLayout(getRemoteUser(),
                            oldSearchRequest);
            ...
            else if (Key.PERSONAL.equalsIgnoreCase(saveColumnLayout))
            {
                ...
                final EditableSearchRequestColumnLayout currLayout = new EditableSearchRequestColumnLayoutImpl(columnLayoutManager.getColumnLayout(
                        getRemoteUser()).getColumnLayoutItems(), getRemoteUser(), oldSearchRequest);
                saveColumnLayout(currLayout, newSearchRequest);
            }
