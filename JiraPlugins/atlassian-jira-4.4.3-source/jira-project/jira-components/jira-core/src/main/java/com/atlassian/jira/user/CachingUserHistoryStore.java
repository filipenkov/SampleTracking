...
public class CachingUserHistoryStore implements UserHistoryStore, Startable
{
     ...
     */
    private final Function<User, ManagedLock> lockManager = ManagedLocks.weakManagedLockFactory(new Function<User, String>()
    {
        public String get(final User input)
        {
    ...
    {
        this(delegatingStore, applicationProperties, eventPublisher, DEFAULT_MAX_THRESHOLD);
    }
    ...
    CachingUserHistoryStore(@NotNull final OfBizUserHistoryStore delegatingStore, @NotNull final ApplicationProperties applicationProperties,
            final EventPublisher eventPublisher, int maxThreshold)
    {
    ...
    private void flushCache(final UserHistoryItem.Type type, final User user)
    {
    ...
    private static final class Key
    {
        ...
        public Key(final User user, final UserHistoryItem.Type type)
        {
