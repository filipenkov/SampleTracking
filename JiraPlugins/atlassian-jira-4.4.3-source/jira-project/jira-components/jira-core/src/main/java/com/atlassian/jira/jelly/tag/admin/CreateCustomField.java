...
public class CreateCustomField extends TagSupport
{
        ...
        try
        {
            ...
            else if (CustomFieldScope.PROJECT.equals(getFieldScope()))
            {
                createdCustomField = customFieldManager.createCustomField(getFieldName(), 
                                                                          ...
                                                                          customFieldType, 
                                                                          cfs, 
                                                                          EasyList.build(new ProjectContext(getProjectGv(), treeManager)),
                                                                          EasyList.buildNull());
            }
            else
            {
    ...
    public String getIssueTypeId()
    {
        ...
        {
            List issueTypes = constantsManager.getAllIssueTypes();
    ...
    {
        return projectManager.getProject(getProject());
    }
