...
public abstract class AbstractCustomFieldStatisticsMapper implements StatisticsMapper
{
    ...
    public SearchRequest getSearchUrlSuffix(Object value, SearchRequest searchRequest)
    {
        ...
        else
        {
            if (value != null)
            {
                final SearchService searchService = ComponentManager.getComponent(SearchService.class);
                final User user = ComponentAccessor.getJiraAuthenticationContext().getUser();
