...
public class WikiRendererHelpAction extends JiraWebActionSupport
{
    ...
    private void loadMacroHelp()
    {
        ...
        List macroDescriptors = pluginAccessor.getEnabledModuleDescriptorsByClass(MacroModuleDescriptor.class);
        for (Iterator iterator = macroDescriptors.iterator(); iterator.hasNext();)
        {
            MacroModuleDescriptor descriptor = (MacroModuleDescriptor) iterator.next();
    ...
    private void loadContentLinkHelp()
    {
        ...
        List contentLinkDescriptors = pluginAccessor.getEnabledModuleDescriptorsByClass(ContentLinkResolverDescriptor.class);
        for (Iterator iterator = contentLinkDescriptors.iterator(); iterator.hasNext();)
        {
            ContentLinkResolverDescriptor descriptor = (ContentLinkResolverDescriptor) iterator.next();
            if (descriptor.hasHelp())
            {
                if (descriptor.getHelpSection() == null)
                {
    ...
    private void loadRendererComponentFactoriesHelp()
    {
        ...
        List descriptors = pluginAccessor.getEnabledModuleDescriptorsByClass(RendererComponentFactoryDescriptor.class);
        for (Iterator iterator = descriptors.iterator(); iterator.hasNext();)
        {
            RendererComponentFactoryDescriptor descriptor = (RendererComponentFactoryDescriptor) iterator.next();
            if (descriptor.hasHelp())
            {
                if (descriptor.getHelpSection() == null)
                {
