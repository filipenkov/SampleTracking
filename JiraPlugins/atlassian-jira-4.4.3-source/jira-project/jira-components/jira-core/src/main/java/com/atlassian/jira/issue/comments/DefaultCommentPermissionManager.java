...
public class DefaultCommentPermissionManager implements CommentPermissionManager
{
    ...
    {
        return hasBrowsePermission((User) user, comment);
    }
    ...
    {
        return hasEditPermission((User) user, comment);
    }
    ...
    {
        return hasEditAllPermission((User) user, issue);
    }
    ...
    {
        return hasEditOwnPermission((User) user, issue);
    }
    ...
    @Override
    public boolean hasDeleteAllPermission(com.opensymphony.user.User user, Issue issue)
    {
        return hasDeleteAllPermission((User) user, issue);
    }
    ...
    @Override
    public boolean hasDeleteOwnPermission(com.opensymphony.user.User user, Issue issue)
    {
        return hasDeleteOwnPermission((User) user, issue);
    }
    ...
    {
        return isUserCommentAuthor((User) user, comment);
    }
