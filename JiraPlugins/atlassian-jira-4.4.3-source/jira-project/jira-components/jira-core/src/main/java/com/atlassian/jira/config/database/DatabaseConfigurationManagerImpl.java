...
public class DatabaseConfigurationManagerImpl implements DatabaseConfigurationManager
{
    ...
    private DatabaseConfig createInternalConfig(JiraHome jiraHome)
    {
        ...
        JdbcDatasource datasource = new JdbcDatasource(jdbcUrl, driver, "sa", "", DEFAULT_POOL_SIZE, null, 4000L, 5000L);
    ...
    public void activateDatabase()
    {
        ...
        try
        {
            setupLock.lock();
            {
                ...
                final PropertiesManager propertiesManager = componentLocator.getComponentInstanceOfType(PropertiesManager.class);
