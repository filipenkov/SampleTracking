...
public class PopularIssueTypesUtilImpl implements PopularIssueTypesUtil
{
    ...
    public PopularIssueTypesUtilImpl(final IssueTypeSchemeManager issueTypeSchemeManager, final TranslationManager translationManager, final JiraAuthenticationContext jiraAuthenticationContext)
    {
    ...
    @Override
    public List<IssueType> getPopularIssueTypesForProject(Project project, com.opensymphony.user.User user)
    {
        return getPopularIssueTypesForProject(project, (User) user);
    }
    ...
    @Override
    public List<IssueType> getOtherIssueTypesForProject(Project project, com.opensymphony.user.User user)
    {
        return getOtherIssueTypesForProject(project, (User) user);
    }
    ...
    @Override
    public PopularIssueTypesHolder getPopularAndOtherIssueTypesForProject(Project project, com.opensymphony.user.User user)
    {
        return getPopularAndOtherIssueTypesForProject(project, (User) user);
    }
    ...
    Set<IssueType> getPopularIssueTypesFromSearch(final Project project, final User user, final String period)
    {
        ...
        return getIssueTypesFromStatsMap(mapWrapper.keySet());
    }
    ///CLOVER:ON
     ...
     */
    ///CLOVER:OFF
    private Set<IssueType> getIssueTypesFromStatsMap(final Collection issueTypeGVs)
    {
        Set<IssueType> types = new LinkedHashSet<IssueType>(issueTypeGVs.size());
        for (Object issueTypeGV : issueTypeGVs)
        {
            types.add(new IssueTypeImpl((GenericValue) issueTypeGV, translationManager, jiraAuthenticationContext));
        }
        return types;
    }
    ///CLOVER:ON
