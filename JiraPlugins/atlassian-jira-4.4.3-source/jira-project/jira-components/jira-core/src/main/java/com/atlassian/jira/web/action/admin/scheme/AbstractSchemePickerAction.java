...
public abstract class AbstractSchemePickerAction extends AbstractSchemeToolAction
{
    ...
    {
        StringBuffer redirectString = new StringBuffer(getRedirectPage());
    ...
    public Map getSchemes() throws GenericEntityException
    {
        ...
        for (Iterator iterator = getSchemeTypes().values().iterator(); iterator.hasNext();)
        {
            String schemeType = (String) iterator.next();
