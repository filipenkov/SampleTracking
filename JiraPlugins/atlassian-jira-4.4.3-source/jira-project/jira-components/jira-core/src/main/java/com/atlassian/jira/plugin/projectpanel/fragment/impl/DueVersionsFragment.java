...
public class DueVersionsFragment extends AbstractFragment implements ComponentTabPanelFragment
{
    ...
    public DueVersionsFragment(final VelocityManager velocityManager, final ApplicationProperties applicationProperites, final JiraAuthenticationContext jiraAuthenticationContext, final VersionManager versionManager)
    {
