...
public class LocalDateValidator implements ClauseValidator
{
    ...
    public LocalDateValidator(final JqlOperandResolver operandResolver,  TimeZoneManager timeZoneManager)
    {
        notNull("operandResolver", operandResolver);
        this.localDateValueValidator = new LocalDateValueValidator(operandResolver, timeZoneManager);
