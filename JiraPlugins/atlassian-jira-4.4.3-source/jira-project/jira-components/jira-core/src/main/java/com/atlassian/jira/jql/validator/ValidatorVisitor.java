 ...
 * {@link com.atlassian.jira.jql.operand.OperandHandler#validate(com.atlassian.crowd.embedded.api.User, com.atlassian.query.operand.Operand, com.atlassian.query.clause.TerminalClause)}
...
public class ValidatorVisitor implements ClauseVisitor<MessageSet>
{
    ...
    public ValidatorVisitor(ValidatorRegistry validatorRegistry, JqlOperandResolver operandResolver, OperatorUsageValidator operatorUsageValidator, User searcher)
    {
    ...
    public static class ValidatorVisitorFactory
    {
        ...
        public ValidatorVisitor createVisitor(User searcher)
        {
            return new ValidatorVisitor(validatorRegistry, operandResolver, operatorUsageValidator, searcher);
        }
    }
}
