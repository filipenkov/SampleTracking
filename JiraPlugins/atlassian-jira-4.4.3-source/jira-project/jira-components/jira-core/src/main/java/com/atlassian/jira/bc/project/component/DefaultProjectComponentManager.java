...
public class DefaultProjectComponentManager implements ProjectComponentManager
{
     ...
     * @param issueManager
     */
    public DefaultProjectComponentManager(ProjectComponentStore store, final IssueManager issueManager)
    {
        this.store = store;
            ...
            throws IllegalArgumentException
    {
        try
        {
            ...
            return convertToProjectComponent(store.store(component));
        }
            ...
            throws EntityNotFoundException
    {
        ...
        return convertToProjectComponent(component);
    }
    ...
    {
        return store.findComponentsBylead(userName);
    }
