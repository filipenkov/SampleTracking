...
public interface SearchRequestAdminManager
{
     ...
     * see the requested search request. This method should not be used unless you know you have to, instead
     * you should use {@link #getSearchRequestById(com.opensymphony.user.User, Long)}.
     *
