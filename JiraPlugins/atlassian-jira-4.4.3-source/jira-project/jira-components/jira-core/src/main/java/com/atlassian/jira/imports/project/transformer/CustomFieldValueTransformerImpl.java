...
public class CustomFieldValueTransformerImpl implements CustomFieldValueTransformer
{
    ...
    public ExternalCustomFieldValueImpl transform(final ProjectImportMapper projectImportMapper, final ExternalCustomFieldValueImpl externalCustomFieldValue, final Long newProjectId)
    {
