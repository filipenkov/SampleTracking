...
public class DefaultRecentCommentManager implements RecentCommentManager
{
    ...
    @Override
    public CommentIterator getRecentComments(SearchRequest searchRequest, com.opensymphony.user.User user)
            throws SearchException
    {
        return getRecentComments(searchRequest, (User) user);
    }
    ...
    public CommentIterator getRecentComments(SearchRequest searchRequest, User user) throws SearchException
    {
        ...
        return new LuceneCommentIterator(user, commentService, getCommentsHits(searchRequest, user));
    }

    private Hits getCommentsHits(final SearchRequest request, final User user) throws SearchException
    {
        ...
        try
        {
            ...
            return searcher.search(commentQuery,
    ...
    private BooleanQuery createIssueIdQuery(final SearchRequest request, final User user)
    {
    ...
    private Collection<String> getIssueIds(SearchRequest searchRequest, final User user) throws IOException, SearchException
    {
    ...
    private org.apache.lucene.search.Query getDateClauses(final SearchRequest searchRequest, final User user) throws SearchException
    {
