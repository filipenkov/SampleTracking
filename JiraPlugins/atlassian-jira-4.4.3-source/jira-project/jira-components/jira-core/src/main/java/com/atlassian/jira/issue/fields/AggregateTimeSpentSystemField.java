...
public class AggregateTimeSpentSystemField extends AbstractAggregateDurationSystemField
{
    ...
    public AggregateTimeSpentSystemField(VelocityManager velocityManager, ApplicationProperties applicationProperties,
                                         JiraAuthenticationContext authenticationContext, AggregateTimeTrackingCalculatorFactory calculatorFactory)
    {
        super(IssueFieldConstants.AGGREGATE_TIME_SPENT, "common.concepts.aggregate.time.spent", "common.concepts.aggregate.time.spent", ORDER_DESCENDING, new IssueLongFieldComparator(IssueFieldConstants.AGGREGATE_TIME_SPENT), velocityManager, applicationProperties, authenticationContext, calculatorFactory);
    }
