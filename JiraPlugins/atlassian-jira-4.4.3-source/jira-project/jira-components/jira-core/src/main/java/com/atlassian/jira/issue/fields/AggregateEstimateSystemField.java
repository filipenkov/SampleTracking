...
public class AggregateEstimateSystemField extends AbstractAggregateDurationSystemField
{
    ...
    public AggregateEstimateSystemField(VelocityManager velocityManager, ApplicationProperties applicationProperties,
                                        JiraAuthenticationContext authenticationContext, AggregateTimeTrackingCalculatorFactory calculatorFactory)
    {
        super(IssueFieldConstants.AGGREGATE_TIME_ESTIMATE, "common.concepts.aggregate.remaining.estimate", "common.concepts.aggregate.remaining.estimate", ORDER_DESCENDING, new IssueLongFieldComparator(IssueFieldConstants.AGGREGATE_TIME_SPENT), velocityManager, applicationProperties, authenticationContext, calculatorFactory);
    }
