...
public class DefaultConfiguration implements Configuration
{
    ...
    public DefaultConfiguration(final @NotNull Directory directory, final @NotNull Analyzer analyzer)
    {
        this(directory, analyzer, Default.writerConfiguration);
    }

    public DefaultConfiguration(final @NotNull Directory directory, final @NotNull Analyzer analyzer, final @NotNull IndexWriterConfiguration writerConfiguration)
    {
