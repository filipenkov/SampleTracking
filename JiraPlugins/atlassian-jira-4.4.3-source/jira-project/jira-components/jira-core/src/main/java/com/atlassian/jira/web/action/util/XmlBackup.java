...
public class XmlBackup extends ProjectActionSupport
{
    ...
    public XmlBackup(final ExportService exportService)
    {
    ...
    protected String doExecute() throws Exception
    {
        try
        {
            ...
            final ServiceOutcome<Void> outcome = exportService.export(getLoggedInUser(), filename, TaskProgressSink.NULL_SINK);
            if (outcome.isValid())
            {
                return SUCCESS;
            }
