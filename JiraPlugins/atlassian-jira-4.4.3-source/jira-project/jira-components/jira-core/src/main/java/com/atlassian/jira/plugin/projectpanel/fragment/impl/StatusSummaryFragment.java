...
public class StatusSummaryFragment extends AbstractMultiFragment
{
    ...
    public StatusSummaryFragment(final VelocityManager velocityManager, final ApplicationProperties applicationProperites, final JiraAuthenticationContext jiraAuthenticationContext, final ConstantsManager constantsManager)
    {
    ...
    protected Map<String, Object> createVelocityParams(final BrowseContext ctx)
    {
        ...
        velocityParams.put("urlUtil", new StatusUrlUtil(getSearchRequest(ctx), jiraAuthenticationContext.getUser(), applicationProperites));
    ...
    private void transformStatisticMapWrapper(final StatisticMapWrapper map)
    {
        ...
        for (Object o : map.entrySet())
        {
            ...
            GenericValue gv = (GenericValue) entry.getKey();
            final Status status = constantsManager.getStatusObject(gv.getString("id"));
