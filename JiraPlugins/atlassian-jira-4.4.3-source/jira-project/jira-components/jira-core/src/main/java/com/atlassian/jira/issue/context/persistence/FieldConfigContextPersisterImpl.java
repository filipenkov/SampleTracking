...
public class FieldConfigContextPersisterImpl implements FieldConfigContextPersister
{
    ...
    public void removeContextsForProjectCategory(final GenericValue projectCategory)
    {
        final int result = delegator.removeByAnd(ENTITY_TABLE_NAME, build(ENTITY_PROJECT_CATEGORY, projectCategory.getLong("id")));
        if (log.isDebugEnabled())
        {
