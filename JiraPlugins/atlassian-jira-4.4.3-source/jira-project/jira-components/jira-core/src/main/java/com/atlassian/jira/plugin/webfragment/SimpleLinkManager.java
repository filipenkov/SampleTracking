 ...
 * This should be used in preference over the {@link com.atlassian.jira.plugin.webfragment.JiraWebInterfaceManager} as this
 * is more powerful due to being able produce links via {@link SimpleLinkFactory}.  Though the links produced
...
public interface SimpleLinkManager
{
     ...
     * @return true if the loaction should be loaded lazily if possible, false otherwise
     *
     * @deprecated Please use {@link #shouldLocationBeLazy(String, com.atlassian.crowd.embedded.api.User, com.atlassian.jira.plugin.webfragment.model.JiraHelper)} instead. Since v4.3
     */
    boolean shouldLocationBeLazy(String location, com.opensymphony.user.User remoteUser, JiraHelper jiraHelper);
     ...
     * @return The list of links for the given section
     *
     * @deprecated Please use {@link #getLinksForSection(String, com.atlassian.crowd.embedded.api.User, com.atlassian.jira.plugin.webfragment.model.JiraHelper)} instead. Since v4.3
     */
    @NotNull
    List<SimpleLink> getLinksForSection(@NotNull String section, com.opensymphony.user.User remoteUser, @NotNull JiraHelper jiraHelper);
     ...
     * @return The list of links for the given section
     *
     * @deprecated Please use {@link #getLinksForSectionIgnoreConditions(String, com.atlassian.crowd.embedded.api.User, com.atlassian.jira.plugin.webfragment.model.JiraHelper)} instead. Since v4.3
     */
    @NotNull
    List<SimpleLink> getLinksForSectionIgnoreConditions(@NotNull String section, com.opensymphony.user.User remoteUser, @NotNull JiraHelper jiraHelper);
     ...
     * @return The list of sections for the give location
     *
     * @deprecated Please use {@link #getSectionsForLocation(String, com.atlassian.crowd.embedded.api.User, com.atlassian.jira.plugin.webfragment.model.JiraHelper)} instead. Since v4.3
     */
    @NotNull
    List<SimpleLinkSection> getSectionsForLocation(@NotNull String location, com.opensymphony.user.User remoteUser, @NotNull JiraHelper jiraHelper);
     ...
     */
    @NotNull
    List<SimpleLinkSection> getNotEmptySectionsForLocation(@NotNull String location, com.opensymphony.user.User remoteUser, @NotNull JiraHelper jiraHelper);
}
