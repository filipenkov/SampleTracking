...
public abstract class AbstractEditWorkflowTransitionDescriptorParams extends AbstractWorkflowTransitionAction
{
    ...
    protected String getRedirectUrl()
    {
        ...
        if (getStep() == null)
        {
            redirectUrl = "ViewWorkflowTransition.jspa?workflowName=" + URLEncoder.encode(getWorkflow().getName()) +
    ...
    protected void setupWorkflowModuleDescriptor()
    {
        ...
        if ("class".equalsIgnoreCase(type) && args.containsKey("class.name"))
        {
            ...
            try
            {
                workflowModuleDescriptor = (AbstractWorkflowModuleDescriptor) getWorkflowModuleDescriptor(className, getPluginType());
                return;
            }
     ...
     */
    protected AbstractWorkflowModuleDescriptor getWorkflowModuleDescriptor(String className, final String pluginType) throws PluginParseException
    {
