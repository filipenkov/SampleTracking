...
public class TransitionWorkflow extends JiraDynaBeanTagSupport implements CustomFieldValuesAwareTag
{
    ...
    public void doTag(XMLOutput xmlOutput) throws MissingAttributeException, JellyTagException
    {
        ...
        User previousUser = authenticationContext.getUser();
    ...
    {
        if (!issueUtilsBean.isValidAction(issue, action.getId()))
        {
    ...
    {
        final Map workflowTransitionParams = new HashMap();
    ...
    private ActionDescriptor getActionByName(JiraWorkflow workflow, Issue issue) throws JellyTagException
    {
        ...
        for (Iterator iterator = workflow.getAllActions().iterator(); iterator.hasNext();)
        {
            ...
            if (workflowActionProperty.equalsIgnoreCase(actionDescriptor.getName()))
            {
                ...
                // wrong action.
                if (issueUtilsBean.isValidAction(issue, actionDescriptor.getId()))
                {
