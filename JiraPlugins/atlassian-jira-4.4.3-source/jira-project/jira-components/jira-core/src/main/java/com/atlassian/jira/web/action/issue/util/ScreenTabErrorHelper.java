...
public class ScreenTabErrorHelper implements Serializable
{
     ...
     */
    public int initialiseTabsWithErrors(final SortedSet<FieldScreenRenderTab> tabsWithErrors, final Map<String, Object> errors, final FieldScreenRenderer fieldScreenRenderer, final Map webParameters)
    {
