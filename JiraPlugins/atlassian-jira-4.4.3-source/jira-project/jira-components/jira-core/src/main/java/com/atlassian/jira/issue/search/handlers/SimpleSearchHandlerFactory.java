 ...
 * @since v4.0
 */
public abstract class SimpleSearchHandlerFactory implements SearchHandlerFactory
{
     ...
     * @param queryValidator the validatr to place in the handler.
    ...
    public SimpleSearchHandlerFactory(final ComponentFactory factory, final ClauseInformation information,
            ...
            final ClauseValidator queryValidator, final FieldClausePermissionChecker.Factory clausePermissionFactory,
            ...
            final ClauseContextFactory clauseContextFactory, final ClauseValuesGenerator clauseValuesGenerator, ClauseSanitiser sanitiser)
    {
        ...
        this.queryValidator = notNull("queryValidator", queryValidator);
    ...
    public final SearchHandler createHandler(final SearchableField field)
    {
        ...
        {
            clauseHandler = new DefaultClauseHandler(clauseInformation, queryFactory, queryValidator, createClausePermissionHandler(field), clauseContextFactory);
        }
        else
        {
            clauseHandler = new DefaultValuesGeneratingClauseHandler(clauseInformation, queryFactory, queryValidator, createClausePermissionHandler(field), clauseContextFactory, clauseValuesGenerator);
        }
