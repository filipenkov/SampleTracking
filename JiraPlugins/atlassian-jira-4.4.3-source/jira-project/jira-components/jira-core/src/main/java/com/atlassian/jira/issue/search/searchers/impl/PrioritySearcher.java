...
public class PrioritySearcher extends AbstractInitializationSearcher implements IssueSearcher<SearchableField>
{
    ...
    public PrioritySearcher(FieldVisibilityManager fieldVisibilityManager,
            ...
            ApplicationProperties applicationProperties, VelocityManager velocityManager, PriorityResolver priorityResolver,
            FieldFlagOperandRegistry fieldFlagOperandRegistry)
    {
        ...
        final SearchContextVisibilityChecker searchContextVisibilityChecker = new AlwaysVisibleSearchContextVisibilityChecker();
        ...
        this.searchInputTransformer = new IssueConstantSearchInputTransformer<Priority>(constants.getJqlClauseNames(), constantInfoResolver, operandResolver, fieldFlagOperandRegistry, searchContextVisibilityChecker, priorityResolver);
