...
public class JiraImportProgressFilter extends AbstractHttpFilter
{
            ...
            throws IOException, ServletException
    {
        ...
        if (taskManagerReference.get() != null && taskManagerReference.get().getTask() != null)
        {
            ...
            final SimpleTaskDescriptorBean currentTaskDescriptor = new SimpleTaskDescriptorBean(taskManagerReference.get().<DataImportService.ImportResult>getTask(), locale);
            ...
            if (currentTaskDescriptor.isFinished())
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        {
                            //go back to the webwork action to deal with errors.
                            response.sendRedirect(request.getContextPath() + "/secure/admin/XmlRestore!finish.jspa");
                        }
                    }
                    return;
                }
    ...
    public static class SimpleTaskDescriptorBean
    {
        ...
        SimpleTaskDescriptorBean(TaskDescriptor<DataImportService.ImportResult> descriptor, Locale locale)
        {
        ...
        public String getText(String key) {
            return MessageFormat.format(resourceBundle.getString(key), new Object[0]);
        }
