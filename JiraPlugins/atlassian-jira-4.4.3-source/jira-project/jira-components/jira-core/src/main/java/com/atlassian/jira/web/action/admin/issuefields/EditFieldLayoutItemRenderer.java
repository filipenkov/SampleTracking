...
public class EditFieldLayoutItemRenderer extends AbstractConfigureFieldLayout
{
    ...
    public EditFieldLayoutItemRenderer(final FieldScreenManager fieldScreenManager, final RendererManager rendererManager,
            ...
            final ReindexMessageManager reindexMessageManager, final FieldLayoutSchemeHelper fieldLayoutSchemeHelper, final HackyFieldRendererRegistry hackyFieldRendererRegistry)
    {
    ...
    public long getEffectedIssuesCount() throws SearchException
    {
        ...
        {
            result = searchProvider.searchCountOverrideSecurity(getEffectedIssuesQuery(), getRemoteUser());
        }
        return result;
    }
    ...
    public String getEffectedIssuesQueryString()
    {
        ...
        {
            return searchService.getQueryString(getRemoteUser(), effectedIssuesQuery);
        }
        return "";
    }
    ...
    protected Query getEffectedIssuesQuery()
    {
        if(query == null)
        {
            ...
            for (Iterator iterator = getFieldLayoutManager().getRelatedProjects(getFieldLayout()).iterator(); iterator.hasNext();)
            {
