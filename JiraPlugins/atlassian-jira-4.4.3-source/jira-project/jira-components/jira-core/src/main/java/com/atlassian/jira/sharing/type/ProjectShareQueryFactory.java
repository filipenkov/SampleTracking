...
public class ProjectShareQueryFactory implements ShareQueryFactory<ProjectShareTypeSearchParameter>
{
    ...
    {
        return new Field(Name.FIELD, new ProjectSharePermission(permission).getIndexValue(), Field.Store.YES, Field.Index.UN_TOKENIZED);
    }
    ...
    static interface Visibility
    {
         ...
         */
        void check(User user, ProjectShareTypeSearchParameter parameter) throws IllegalStateException;
         ...
         */
        List<ProjectRole> getRoles(final User user, final Long projectId);
    }
    ...
    static class VisibilityImpl implements Visibility
    {
        ...
        public void check(final User user, final ProjectShareTypeSearchParameter projectParameter)
        {
        ...
        public List<ProjectRole> getRoles(final User user, final Long projectId)
        {
