...
public class AddFieldToScreen extends JiraDynaBeanTagSupport
{
    ...
    {
        this.addFieldToScreenUtil = ComponentManager.getComponentInstanceOfType(AddFieldToScreenUtil.class);
        this.fieldScreenManager = ComponentManager.getComponentInstanceOfType(FieldScreenManager.class);
    }
