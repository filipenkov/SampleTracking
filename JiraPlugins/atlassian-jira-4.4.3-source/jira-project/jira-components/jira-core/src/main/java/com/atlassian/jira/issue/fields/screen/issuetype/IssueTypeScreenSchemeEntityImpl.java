 ...
 * All rights reserved.
 */
public class IssueTypeScreenSchemeEntityImpl extends AbstractGVBean implements IssueTypeScreenSchemeEntity, Comparable
{
    ...
    {
        if (o instanceof IssueTypeScreenSchemeEntity)
        {
            IssueTypeScreenSchemeEntity issueTypeScreenSchemeEntity = (IssueTypeScreenSchemeEntity) o;
            return comparator.compare(this.getIssueTypeId(), issueTypeScreenSchemeEntity.getIssueTypeId());
        }

        throw new IllegalArgumentException("Can only compare IssueTypeScreenSchemeEntities.");
    }
}
