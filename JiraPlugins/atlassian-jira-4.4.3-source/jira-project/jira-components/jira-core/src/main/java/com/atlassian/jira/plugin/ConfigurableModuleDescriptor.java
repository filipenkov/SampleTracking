...
/**
 * A JiraResourcedModuleDescriptor that is able to be configured using an {@link ObjectConfiguration}.
 */
/**
 * A JiraResourcedModuleDescriptor that is able to be configured using an {@link ObjectConfiguration}.
 */
public abstract class ConfigurableModuleDescriptor<T> extends JiraResourcedModuleDescriptor<T>
{
    ...
    public ConfigurableModuleDescriptor(JiraAuthenticationContext authenticationContext, final ModuleFactory moduleFactory)
    {
