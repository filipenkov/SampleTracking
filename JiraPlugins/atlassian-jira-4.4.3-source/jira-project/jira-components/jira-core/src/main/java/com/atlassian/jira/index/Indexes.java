...
public class Indexes
{
     ...
     *         operations.
     */
    public static Index.Manager createQueuedIndexManager(final @NotNull String name, final @NotNull Configuration config)
    {
        ...
        return new DefaultManager(config, engine, new QueueingIndex(name, new DefaultIndex(engine)));
    }
     ...
     *         operations.
     */
    public static Index.Manager createSimpleIndexManager(final @NotNull Configuration config)
    {
