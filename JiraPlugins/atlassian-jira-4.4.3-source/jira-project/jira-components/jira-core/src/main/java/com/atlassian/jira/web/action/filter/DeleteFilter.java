...
public class DeleteFilter extends SearchDescriptionEnabledAction
{
    ...
    public int getOtherFavouriteCount()
    {
        if (otherFavouriteCount == null)
        {
            ...
            final boolean isFavourite = favouriteService.isFavourite(getRemoteUser(), request);
    ...
    public Collection getSubscriptions()
    {
        ...
        {
            subscriptions = subscriptionService.getVisibleSubscriptions(getRemoteUser(), getFilter());
        }
    ...
    protected SearchRequest getFilter()
    {
        if ((filter == null) && (filterId != null))
        {
            ...
            filter = searchRequestService.getFilter(ctx, filterId);
        }
        return filter;
    }
}