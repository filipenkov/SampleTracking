...
public class UpdateIssueFields extends AbstractViewIssue implements OperationContext
{
    ...
    public UpdateIssueFields(IssueLinkManager issueLinkManager, SubTaskManager subTaskManager, UpdateFieldsHelperBean updateFieldsHelperBean, FieldManager fieldManager)
    {
    ...
    {
        updateFieldsHelperBean.validate(getIssueObject(), this, ActionContext.getParameters(), getRemoteUser(), this, this);
    }

    @RequiresXsrfCheck
    protected String doExecute() throws Exception
    {
        final ActionResult actionResult = updateFieldsHelperBean.updateIssue(getIssueObject(), this, getRemoteUser(), this, this);
