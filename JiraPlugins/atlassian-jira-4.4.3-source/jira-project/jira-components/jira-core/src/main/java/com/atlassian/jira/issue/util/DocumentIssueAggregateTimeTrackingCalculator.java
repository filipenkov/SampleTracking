...
public class DocumentIssueAggregateTimeTrackingCalculator implements AggregateTimeTrackingCalculator
{
    ...
    public AggregateTimeTrackingBean getAggregates(final Issue issue)
    {
        ...
        Searcher searcher = searchProviderFactory.getSearcher(SearchProviderFactory.ISSUE_INDEX);
    ...
    static class AggregateHitCollector extends FieldableDocumentHitCollector
    {
        ...
        public AggregateHitCollector(Searchable searchable, AggregateTimeTrackingBean bean, LuceneFieldSorter remainingEstimateSorter, LuceneFieldSorter originalEstimateSorter, LuceneFieldSorter timeSpentSorter)
        {
            super(searchable);
