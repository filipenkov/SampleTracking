...
public class JiraGadgetPermissionManager implements GadgetPermissionManager
{
    ...
    @Override
    public Vote voteOn(PluginGadgetSpec pluginGadgetSpec, com.opensymphony.user.User remoteUser)
    {
        return voteOn(pluginGadgetSpec, (User) remoteUser);
    }
    ...
    @Override
    public DashboardState filterGadgets(DashboardState dashboardState, com.opensymphony.user.User remoteUser)
    {
        return filterGadgets(dashboardState, (User) remoteUser);
    }
    ...
    @Override
    public Vote voteOn(String completeGadgetKey, com.opensymphony.user.User remoteUser)
    {
        return voteOn(completeGadgetKey, (User) remoteUser);
    }
