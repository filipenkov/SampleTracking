...
public abstract class AbstractProgressBarSystemField extends NavigableFieldImpl
{
    ...
    public AbstractProgressBarSystemField(final String id, final String nameKey, final String columnHeadingKey, final VelocityManager velocityManager, final ApplicationProperties applicationProperties, final JiraAuthenticationContext authenticationContext)
    {
        super(id, nameKey, columnHeadingKey, ORDER_ASCENDING, null, velocityManager, applicationProperties, authenticationContext);
    }
