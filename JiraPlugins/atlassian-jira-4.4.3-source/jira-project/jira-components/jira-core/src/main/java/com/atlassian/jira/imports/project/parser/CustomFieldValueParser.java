...
public interface CustomFieldValueParser
{
     ...
     */
    ExternalCustomFieldValueImpl parse(Map attributes) throws ParseException;
     ...
     */
    EntityRepresentation getEntityRepresentation(ExternalCustomFieldValueImpl customFieldValue);
}