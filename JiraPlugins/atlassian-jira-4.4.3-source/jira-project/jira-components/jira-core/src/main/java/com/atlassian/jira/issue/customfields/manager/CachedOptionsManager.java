...
public class CachedOptionsManager extends DefaultOptionsManager implements Startable
{
    ...
    public CachedOptionsManager(OfBizDelegator delegator, CollectionReorderer reorderer,
            FieldConfigManager fieldConfigManager, final EventPublisher eventPublisher)
    {
