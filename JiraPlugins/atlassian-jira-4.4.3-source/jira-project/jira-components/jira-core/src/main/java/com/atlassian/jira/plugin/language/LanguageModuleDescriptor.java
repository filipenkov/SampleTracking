...
public class LanguageModuleDescriptor extends JiraResourcedModuleDescriptor<Language>
{
    ...
    public LanguageModuleDescriptor(final JiraAuthenticationContext authenticationContext, final ModuleFactory moduleFactory)
    {
     ...
     * @throws PluginParseException if language is null
     */
    @Override
