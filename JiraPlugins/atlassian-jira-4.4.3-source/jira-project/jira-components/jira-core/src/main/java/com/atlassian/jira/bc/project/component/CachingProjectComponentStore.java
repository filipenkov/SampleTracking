...
public class CachingProjectComponentStore implements ProjectComponentStore, Startable
{
     ...
     * @param eventPublisher used to register ourselves for a clear cache event.
     */
    public CachingProjectComponentStore(final ProjectComponentStore delegateStore, final EventPublisher eventPublisher)
    {
