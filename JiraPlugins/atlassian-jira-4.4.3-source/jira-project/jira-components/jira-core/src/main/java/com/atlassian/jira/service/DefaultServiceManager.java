...
public class DefaultServiceManager implements ServiceManager, Startable
{
    ...
    private static final String POP_SERVICE_CLASS_NAME = "com.atlassian.jira.service.services.pop.PopService";
    private static final String IMAP_SERVICE_CLASS_NAME = "com.atlassian.jira.service.services.imap.ImapService";
    ...
    public DefaultServiceManager(final ServiceConfigStore serviceConfigStore, final ComponentClassManager componentClassManager,
            final EventPublisher eventPublisher, final PermissionManager permissionManager, final InBuiltServiceTypes inBuiltServiceTypes)
    {
