...
public class TableLayoutUtilsImpl implements TableLayoutUtils
{
    ...
    public List<String> getDefaultColumnNames(String applicationPropertyName)
    {
        ...
        {
            final String property = applicationProperties.getDefaultString(applicationPropertyName);
    ...
    @Override
    public List<ColumnLayoutItem> getColumns(com.opensymphony.user.User user, List<String> fields) throws FieldException
    {
        return getColumns((User) user, fields);
    }
    ...
    @Override
    public List<ColumnLayoutItem> getColumns(com.opensymphony.user.User user, String applicationPropertyName, List<String> fields, boolean addDefaults)
            throws FieldException
    {
        return getColumns((User) user, applicationPropertyName, fields, addDefaults);
    }
    ...
    @Override
    public List<ColumnLayoutItem> getColumns(com.opensymphony.user.User user, String applicationPropertyName)
            throws FieldException
    {
        return getColumns((User) user, applicationPropertyName);
    }
