 ...
 * @since v3.13
 */
public class CachingWorkflowDescriptorStore implements WorkflowDescriptorStore, Startable
{
    ...
    public CachingWorkflowDescriptorStore(final WorkflowDescriptorStore delegate, final EventPublisher eventPublisher)
    {
