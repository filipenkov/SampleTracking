...
public class DefaultWebAttachmentManager implements WebAttachmentManager
{
            ...
            final Issue issue, final Project project) throws AttachmentException
    {
        ...
        final Long issueId = issue == null ? null : issue.getId();
        final TemporaryAttachment temporaryAttachment = new TemporaryAttachment(uniqueFile.getId(), issueId, uniqueFile.getFile(), filename, contentType);
    ...
    public TemporaryAttachment createTemporaryAttachment(InputStream stream, String fileName, String contentType,
            long size, Issue issue, Project project) throws AttachmentException
    {
