...
public class AbstractGroupToRoleAction extends AbstractSchemeToolAction
{
    ...
    {
        Set uniqueGroupNames = new TreeSet();
        ...
        for (Iterator iterator = getSchemeObjs().iterator(); iterator.hasNext();)
        {
            ...
            for (Iterator iterator2 = scheme.getEntities().iterator(); iterator2.hasNext();)
            {
                SchemeEntity schemeEntity = (SchemeEntity) iterator2.next();
