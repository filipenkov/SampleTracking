...
public class VersionOptionalValuesGenerator implements ValuesGenerator
{
    ...
    public Map getValues(Map params)
    {
        ...
        try
        {
            ...
            Collection unreleasedVersions = versionManager.getVersionsUnreleased(projectGV, false);
            ...
            List releasedIter = new ArrayList(versionManager.getVersionsReleased(projectGV, false));
