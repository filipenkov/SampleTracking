...
public class ChangeHistoryFieldConfigurationManager
{
    ...
    {
        return ImmutableMap.<String, ChangeHistoryFieldConfiguration>builder().put(IssueFieldConstants.STATUS, new ChangeHistoryFieldConfiguration(new StatusDateRangeBuilder(),BaseFieldIndexer.NO_VALUE_INDEX_VALUE, false)).
                                                         put(IssueFieldConstants.ASSIGNEE, new ChangeHistoryFieldConfiguration(new AssigneeDateRangeBuilder(), DocumentConstants.ISSUE_UNASSIGNED, false)).
                                                         put(IssueFieldConstants.REPORTER, new ChangeHistoryFieldConfiguration(new ReporterDateRangeBuilder(), DocumentConstants.ISSUE_NO_AUTHOR, false)).
                                                         put(IssueFieldConstants.RESOLUTION, new ChangeHistoryFieldConfiguration(new ResolutionDateRangeBuilder(), BaseFieldIndexer.NO_VALUE_INDEX_VALUE, false)).
                                                         put(IssueFieldConstants.PRIORITY, new ChangeHistoryFieldConfiguration(new PriorityDateRangeBuilder(), BaseFieldIndexer.NO_VALUE_INDEX_VALUE, false)).
                                                         put(SystemSearchConstants.FIX_FOR_VERSION,  new ChangeHistoryFieldConfiguration(new VersionDateRangeBuilder(SystemSearchConstants.FIX_FOR_VERSION,
                                                                 BaseFieldIndexer.NO_VALUE_INDEX_VALUE), BaseFieldIndexer.NO_VALUE_INDEX_VALUE, true)).build();
    }
