...
public class ViewTranslations extends AbstractManageIssueTypeOptionsAction
{
    ...
    private Collection issueConstants;
    ...
    public void doValidation()
    {
        ...
        Collection issueConstants = getIssueConstants();

        for (Iterator iterator = issueConstants.iterator(); iterator.hasNext();)
        {
            IssueConstant issueConstant = (IssueConstant) iterator.next();
    ...
    public String doExecute()
    {
        ...
        for (Iterator iterator = issueConstants.iterator(); iterator.hasNext();)
        {
            ...
            if (parameters.containsKey(issueConstantNameKey) && parameters.containsKey(issueConstantDescriptionKey))
            {
                ...
                {
                    issueConstant.setTranslation(nameTranslation, descTranslation, getIssueConstantTranslationPrefix(), locale);
                }
                else
                {
                    issueConstant.deleteTranslation(getIssueConstantTranslationPrefix(), locale);
                }
            }
        }
    ...
    public Collection getIssueConstants()
    {
        ...
        {
            issueConstants = new ArrayList();
            if (ISSUECONSTANT_ISSUETYPE.equals(getIssueConstantType()))
            {
                // Create a collection of Issue Constant Objects
            ...
            {
                // Create a collection of Issue Constant Objects
                Collection prioritiyGVs = constantsManager.getPriorities();
                for (Iterator iterator = prioritiyGVs.iterator(); iterator.hasNext();)
                {
                    GenericValue prioritiyGV = (GenericValue) iterator.next();
                    Priority priority = constantsManager.getPriorityObject(prioritiyGV.getString("id"));
            ...
            {
                // Create a collection of Issue Constant Objects
                Collection resolutionGVs = constantsManager.getResolutions();
                for (Iterator iterator = resolutionGVs.iterator(); iterator.hasNext();)
                {
                    GenericValue resolutionGV = (GenericValue) iterator.next();
            ...
            {
                // Create a collection of Issue Constant Objects
                Collection statusGVs = constantsManager.getStatuses();
                for (Iterator iterator = statusGVs.iterator(); iterator.hasNext();)
                {
            ...
            {
                // Create a collection of Issue Constant Objects
                Collection issueTypes = constantsManager.getSubTaskIssueTypes();
                for (Iterator iterator = issueTypes.iterator(); iterator.hasNext();)
                {
                    GenericValue issueTypeGV = (GenericValue) iterator.next();
                    IssueType issueType = constantsManager.getIssueTypeObject(issueTypeGV.getString("id"));
