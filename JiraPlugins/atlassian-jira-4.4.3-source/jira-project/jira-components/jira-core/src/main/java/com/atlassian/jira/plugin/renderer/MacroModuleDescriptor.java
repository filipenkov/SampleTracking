...
public class MacroModuleDescriptor extends JiraResourcedModuleDescriptor<Object>
{
    ...
    public Object createModule()
    {
        ...
        Object module = ComponentManager.getInstance().getContainer().getComponentInstanceOfType(getModuleClass());
