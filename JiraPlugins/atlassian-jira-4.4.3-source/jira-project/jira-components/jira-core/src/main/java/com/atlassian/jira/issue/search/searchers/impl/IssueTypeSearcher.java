...
public class IssueTypeSearcher extends AbstractInitializationSearcher implements IssueSearcher<SearchableField>
{
            ...
            final FieldFlagOperandRegistry fieldFlagOperandRegistry, final ProjectManager projectManager)
    {
        ...
        final SearchContextVisibilityChecker searchContextVisibilityChecker = new IssueTypeSearchContextVisibilityChecker(projectManager, issueTypeSchemeManager);
        ...
        this.searchRenderer = new IssueTypeSearchRenderer(searchInformation.getNameKey(), constantsManager, permissionsManager,
                velocityRequestContextFactory, applicationProperties, velocityManager,
                                                          issueTypeSchemeManager, optionSetManager, subTaskManager);
    }
