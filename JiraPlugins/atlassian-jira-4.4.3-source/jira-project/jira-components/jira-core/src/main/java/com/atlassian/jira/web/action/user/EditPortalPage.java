 ...
 */
public class EditPortalPage extends JiraWebActionSupport implements UserProfileAction
{
    ...
    public EditPortalPage(final PortalPageService portalPageService, final JiraAuthenticationContext authenticationContext, final EmailFormatter emailFormatter, final GroupPermissionChecker groupPermissionChecker, final ShareTypeFactory shareTypeFactory, final PermissionManager permissionsManager, final FavouritesService favouritesService)
    {
    ...
    public String doDefault()
    {
        ...
        if (portalPage != null)
        {
            ...
            else
            {
                ...
                setFavourite(favouritesService.isFavourite(getRemoteUser(), portalPage));
            }
        }
        else
        {
    ...
    private PortalPage getPortalPage()
    {
        if (pageId != null)
        {
            ...
            final JiraServiceContext ignoredCtx = new JiraServiceContextImpl(getRemoteUser());
