...
public interface AssociationManager
{
     ...
     * @param sink the sink node entity
     * @param associationType the association type
     * @return the created association
     *
     * @throws GenericEntityException If there is a DB Exception.
     *
     * @deprecated Please use {@link com.atlassian.jira.association.UserAssociationStore#createAssociation(String, com.atlassian.crowd.embedded.api.User, org.ofbiz.core.entity.GenericValue)}. Deprecated since v4.3
     */
    ...
    public List<User> getUserFromSink(GenericValue sink, String associationType, boolean useCache)
            throws GenericEntityException, EntityNotFoundException;
