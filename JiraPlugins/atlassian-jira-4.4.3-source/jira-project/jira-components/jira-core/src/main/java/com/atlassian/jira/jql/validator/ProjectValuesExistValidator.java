...
class ProjectValuesExistValidator extends ValuesExistValidator
{
    ...
    ProjectValuesExistValidator(final JqlOperandResolver operandResolver, ProjectIndexInfoResolver projectIndexInfoResolver, PermissionManager permissionManager, ProjectManager projectManager)
    {
