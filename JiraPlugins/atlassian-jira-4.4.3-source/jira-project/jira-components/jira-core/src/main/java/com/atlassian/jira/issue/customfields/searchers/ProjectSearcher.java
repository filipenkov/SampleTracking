        ...
        implements CustomFieldSearcher, SortableCustomFieldSearcher, CustomFieldStattable
{
    ...
    public void init(CustomField field)
    {
        ...
        this.searchInputTransformer = new ProjectCustomFieldSearchInputTransformer(searcherInformation.getId(), clauseNames, field, jqlOperandResolver, projectIndexInfoResolver, fieldFlagOperandRegistry, searchContextVisibilityChecker, projectResolver, customFieldInputHelper);
        this.customFieldSearcherClauseHandler = new SimpleCustomFieldClauseSanitiserValueGeneratingHandler(
                new ProjectValidator(projectResolver, jqlOperandResolver,permissionManager, projectManager),
