...
public class DefaultWorkflowService implements WorkflowService
{
    ...
    public JiraWorkflow createDraftWorkflow(final JiraServiceContext jiraServiceContext, final String parentWorkflowName)
    {
        ...
        final String username = jiraServiceContext.getUser() == null ? "" : jiraServiceContext.getUser().getName();
        try
        {
    ...
    {
        return permissionManager.hasPermission(Permissions.ADMINISTER, jiraServiceContext.getUser());
    }
}
