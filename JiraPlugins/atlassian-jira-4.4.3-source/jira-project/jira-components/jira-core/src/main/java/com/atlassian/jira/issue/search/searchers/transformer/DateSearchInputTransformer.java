...
public class DateSearchInputTransformer implements SearchInputTransformer
{
    ...
    public void populateFromQuery(final User searcher, final FieldValuesHolder fieldValuesHolder, final Query query, final SearchContext searchContext)
    {
        ...
        if (query.getWhereClause() != null)
        {
            ...
            final DateSearcherInputHelper.ConvertClauseResult clauseResult = helper.convertClause(query.getWhereClause(), searcher, allowTimeComponent);
    ...
    public boolean doRelevantClausesFitFilterForm(final User searcher, final Query query, final SearchContext searchContext)
    {
        if (query != null && query.getWhereClause() != null)
        {
            ...
            return inputHelper.convertClause(whereClause, searcher, allowTimeComponent).fitsFilterForm();
        }
        return true;
    }
