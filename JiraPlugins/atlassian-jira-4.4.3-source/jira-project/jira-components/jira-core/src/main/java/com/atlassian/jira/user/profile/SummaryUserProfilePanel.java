...
public class SummaryUserProfilePanel implements ViewProfilePanel
{
    ...
    private ActivityUserProfileFragment activityUserProfileFragment;
    private DetailsUserProfileFragment detailsUserProfileFragment;
    private AssignedAndOpenUserProfileFragment assignedAndOpenUserProfileFragment;
    private PreferencesUserProfileFragment preferencesUserProfileFragment;
    ...
    public SummaryUserProfilePanel(final EmailFormatter emailFormatter, final JiraAuthenticationContext context,
            ...
            final ApplicationProperties applicationProperties, VelocityManager velocityManager,
            ...
            final AvatarManager avatarManager, UserManager userManager, TimeZoneService timeZoneManager)
    {
        ...
        activityUserProfileFragment = new ActivityUserProfileFragment(pluginAccessor, ComponentManager.getOSGiComponentInstanceOfType(GadgetRequestContextFactory.class), i18nFactory);
        detailsUserProfileFragment = new DetailsUserProfileFragment(applicationProperties, context, velocityManager, emailFormatter, groupPermissionChecker, permissionManager, crowdService, userPropertyManager, webResourceManager, avatarManager, userManager);
        assignedAndOpenUserProfileFragment = new AssignedAndOpenUserProfileFragment(applicationProperties, context, velocityManager, permissionManager, searchService);
        preferencesUserProfileFragment = new PreferencesUserProfileFragment(applicationProperties, context, velocityManager, preferencesManager, localeManager, i18nFactory, timeZoneManager);
    ...
    {
        final User currentUser = context.getUser();
        ...
        params.put("detailsFrag", detailsUserProfileFragment);
        params.put("assignedFrag", assignedAndOpenUserProfileFragment);
        params.put("preferencesFrag", preferencesUserProfileFragment);
    ...
    private SimpleLink getAssignedAndOpen(final User profileUser, final I18nHelper i18n)
    {
        ...
        final String jql = searchService.getQueryString(context.getUser(), builder.buildQuery());
    ...
    {
        return !fieldVisibiltyManager.isFieldHidden(user, IssueFieldConstants.RESOLUTION);
    }
