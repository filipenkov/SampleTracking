...
public class RoadMapTabPanel implements ComponentTabPanel
{
    ...
    public RoadMapTabPanel(final VersionManager versionManager, final VersionDrillDownRenderer panelRenderer, final FieldVisibilityManager fieldVisibilityManager)
    {
