...
public class WebworkConfigurator implements Startable
{
    ...
    public WebworkConfigurator(final ClassLoader applicationClassLoader, final PluginsEventPublisher eventPublisher)
    {
    ...
    public void start() throws Exception
    {
        ...
        eventPublisher.register(configResetListener);
    }
