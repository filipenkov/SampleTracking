...
class RecentlyCreatedChart
{
    ...
    public Chart generateChart(final User remoteUser, final SearchRequest searchRequest, int days, final ChartFactory.PeriodName periodName, int width, int height)
    {
        ...
        try
        {
            ...
            HitCollector hitCollector = new ResolutionSplittingCreatedIssuesHitCollector(createdResolved, createdUnresolved, issueIndexManager.getIssueSearcher(), timePeriodClass, userTimeZone);
            ...
            CategoryDataset dataset = DataUtils.getCategoryDataset(
                    EasyList.build(createdUnresolvedSeries.data, createdResolvedSeries.data),
    ...
    static class ResolutionSplittingCreatedIssuesHitCollector extends DocumentHitCollector
    {
        ...
        public ResolutionSplittingCreatedIssuesHitCollector(Map<RegularTimePeriod, Number> resolvedMap, Map<RegularTimePeriod, Number> unresolvedMap, Searcher searcher, Class timePeriodClass, TimeZone timeZone)
        {
            super(searcher);
