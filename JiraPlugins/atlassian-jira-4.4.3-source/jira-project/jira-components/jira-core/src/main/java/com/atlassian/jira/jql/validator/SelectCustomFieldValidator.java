...
public class SelectCustomFieldValidator implements ClauseValidator
{
    ...
    public SelectCustomFieldValidator(final CustomField customField, final JqlSelectOptionsUtil jqlSelectOptionsUtil, final JqlOperandResolver jqlOperandResolver, final I18nHelper.BeanFactory beanFactory)
    {
    ...
    {
        return jqlSelectOptionsUtil.getOptions(customField, searcher, literal, false);
    }
