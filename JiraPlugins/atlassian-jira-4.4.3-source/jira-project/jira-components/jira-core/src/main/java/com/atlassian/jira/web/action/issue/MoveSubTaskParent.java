...
public class MoveSubTaskParent extends MoveIssue
{
    ...
    public MoveSubTaskParent(MoveSubTaskOperationManager moveSubTaskOperationManager, IssueLinkManager issueLinkManager,
                             ...
                             CommentService commentService, IssueTypeSchemeManager issueTypeSchemeManager)
    {
    ...
    protected void doValidation()
    {
        if (getMoveIssueBean() != null)
        {
            ...
            if (!isHasIssuePermission(Permissions.MOVE_ISSUE, currentIssue))
            {
            ...
            GenericValue oldParentIssue = getSubTaskManager().getParentIssue(currentIssue);
            ...
            else
            {
                ...
                {
                    if (newParentIssue.equals(currentIssue))
                    {
    ...
    protected String doExecute() throws RemoveException, CreateException
    {
        ...
        IssueUpdateBean iub = getSubTaskManager().changeParent(subTask, parentIssue, getRemoteUser());
        ...
        {
            String msg = "Error updating subtask moving to parent " + parentIssue.getLong("id");
            log.error(msg, e);
