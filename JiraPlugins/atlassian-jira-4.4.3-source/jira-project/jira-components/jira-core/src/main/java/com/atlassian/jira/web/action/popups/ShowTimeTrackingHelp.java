...
public class ShowTimeTrackingHelp extends JiraWebActionSupport
{
    ...
    public String getDefaultTimeUnit()
    {
        ...
        return map.get(applicationProperties.getString(APKeys.JIRA_TIMETRACKING_DEFAULT_UNIT));
    }

    public String getDaysPerWeek()                         
    {
        return applicationProperties.getString(APKeys.JIRA_TIMETRACKING_DAYS_PER_WEEK);
    }

    public String getHoursPerDay()
    {
        return applicationProperties.getString(APKeys.JIRA_TIMETRACKING_HOURS_PER_DAY);
    }
}
