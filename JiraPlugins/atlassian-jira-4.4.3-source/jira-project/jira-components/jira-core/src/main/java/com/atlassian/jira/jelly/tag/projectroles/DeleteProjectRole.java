...
public class DeleteProjectRole extends ProjectRoleTagSupport
{
    ...
    public void doTag(XMLOutput xmlOutput) throws MissingAttributeException, JellyTagException
    {
        ...
        if(!confirm)
        {
            checkIfRoleHasAssociations(getUser(), projectRole, errorCollection, projectRoleService);
        }

        projectRoleService.deleteProjectRole(getUser(), projectRole, errorCollection);
    ...
    private void checkIfRoleHasAssociations(User currentUser, ProjectRole projectRole, SimpleErrorCollection errorCollection, ProjectRoleService projectRoleService)
    {
        ...
        associatedSchemes.addAll(projectRoleService.getAssociatedNotificationSchemes(currentUser, projectRole, errorCollection));
        associatedSchemes.addAll(projectRoleService.getAssociatedPermissionSchemes(currentUser, projectRole, errorCollection));
