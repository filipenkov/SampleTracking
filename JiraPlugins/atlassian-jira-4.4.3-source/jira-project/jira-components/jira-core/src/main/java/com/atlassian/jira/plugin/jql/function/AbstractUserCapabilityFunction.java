...
public abstract class AbstractUserCapabilityFunction extends AbstractJqlFunction
{
    ...
    public MessageSet validate(final com.opensymphony.user.User searcher, final FunctionOperand functionOperand, final TerminalClause terminalClause)
    {
...
//        }
     ...
     */
    protected abstract List<QueryLiteral> getFunctionValuesList(QueryCreationContext queryCreationContext, FunctionOperand operand, User user, String capability);
