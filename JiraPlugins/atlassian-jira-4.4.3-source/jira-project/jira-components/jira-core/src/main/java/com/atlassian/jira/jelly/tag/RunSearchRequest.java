...
public class RunSearchRequest extends UserAwareDynaBeanTagSupport
{
    ...
    public void doTag(XMLOutput xmlOutput) throws JellyTagException
    {
        ...
        try
        {
            ...
            final SearchProvider searchProvider = ComponentManager.getComponentInstanceOfType(SearchProvider.class);
            ...
            throws JellyTagException
    {
        ...
        if (StringUtils.isNotEmpty(cfId))
        {
            ...
            CustomField customField = ManagerFactory.getCustomFieldManager().getCustomFieldObject(cfId);
            if (customField != null)
            {
        ...
        return ComponentManager.getInstance().getSearchRequestFactory().createFromParameters(null, getUser(), new ActionParamsImpl(params));
    }
