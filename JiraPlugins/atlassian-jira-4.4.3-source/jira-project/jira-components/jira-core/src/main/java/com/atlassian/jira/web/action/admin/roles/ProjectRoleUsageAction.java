...
public class ProjectRoleUsageAction extends AbstractProjectRole
{
    ...
    public List getAssociatedNotificationSchemes()
    {
        ...
        {
            associatedNotificationSchemes = new ArrayList(projectRoleService.getAssociatedNotificationSchemes(getRemoteUser(), getRole(), this));
    ...
    public MultiMap getAssociatedWorkflows()
    {
        ...
        {
            associatedWorkflows = projectRoleService.getAssociatedWorkflows(getRemoteUser(), getRole(), this);
        }
    ...
    public List getAssociatedPermissionSchemes()
    {
        ...
        {
            associatedPermissionSchemes = new ArrayList(projectRoleService.getAssociatedPermissionSchemes(getRemoteUser(), getRole(), this));
    ...
    public List getAssociatedIssueSecuritySchemes()
    {
        ...
        {
            associatedIssueSecuritySchemes = new ArrayList(projectRoleService.getAssociatedIssueSecuritySchemes(getRemoteUser(), getRole(), this));
    ...
    {
        ProjectRoleActors projectRoleActors = projectRoleService.getProjectRoleActors(getRemoteUser(), getRole(), project, this);
