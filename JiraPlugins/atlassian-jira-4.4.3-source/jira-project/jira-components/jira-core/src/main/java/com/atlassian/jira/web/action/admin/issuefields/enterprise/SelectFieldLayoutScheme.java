...
public class SelectFieldLayoutScheme extends JiraWebActionSupport
{
    ...
    protected String doExecute() throws Exception
    {
        ...
        if (fieldLayoutSchemeHelper.doesChangingFieldLayoutSchemeForProjectRequireMessage(getRemoteUser(), getProjectId(), currentFieldConfigurationSchemeId, newFieldConfigurationSchemeId))
        {
        ...
        return getRedirect("/plugins/servlet/project-config/" + getProject().getString("key") + "/fields");
    }
