...
abstract class AbstractUnresolvedIssuesFragment extends AbstractMultiFragment
{
    ...
    public AbstractUnresolvedIssuesFragment(final VelocityManager velocityManager, final ApplicationProperties applicationProperites, final JiraAuthenticationContext jiraAuthenticationContext)
    {
