        ...
        if (workflow != null)
        {
            ...
            for (Status statusObject : statusObjects)
            {
                ...
                else
                {
                    ...
                    log.info("Workflow: '" + workflow.getName() + "' associated with project: '" + project.getId() + "' and issue type: '" + issueTypeStr + "' contains a null status, you might want to fix that.");
                }
            }
        }
        return false;
