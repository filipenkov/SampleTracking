...
public interface ProjectImportPersister
{
    ...
    /**
     * Creates a project, with details based off of the ExternalProject in the backup project. The project will
     ...
     */
    Map /*<String,ProjectComponent>*/createComponents(BackupProject backupProject);
     ...
     */
    boolean createUser(final ExternalUser externalUser);
