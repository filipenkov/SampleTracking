    ...
    protected String doExecute() throws Exception
    {
        ...
        else
        {
            try
            {
                ...
                {
                    ActionResult aResult = CoreFactory.getActionDispatcher().execute(ActionNames.LISTENER_CREATE, EasyMap.build("name", "Email Listener", "clazz", "com.atlassian.jira.event.listeners.mail.MailListener"));
