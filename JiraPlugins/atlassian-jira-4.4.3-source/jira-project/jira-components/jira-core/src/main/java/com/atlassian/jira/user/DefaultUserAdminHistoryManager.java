...
public class DefaultUserAdminHistoryManager implements UserAdminHistoryManager
{
    ...
    @Override
    public void addAdminPageToHistory(com.opensymphony.user.User user, String key, String data)
    {
        addAdminPageToHistory((User) user, key, data);
    }
    ...
    @Override
    public List<UserHistoryItem> getAdminPageHistoryWithoutPermissionChecks(com.opensymphony.user.User user)
    {
        return getAdminPageHistoryWithoutPermissionChecks((User) user);
    }
