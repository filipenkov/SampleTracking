...
class CreatedVsResolvedChart
{
            ...
            throws IOException, SearchException
    {
        ...
        HitCollector hitCollector = new OneDimensionalObjectHitCollector(createdMapper, result, issueIndexManager.getIssueSearcher().getIndexReader());
            ...
            throws IOException, SearchException
    {
        ...
        HitCollector hitCollector = new OneDimensionalObjectHitCollector(resolvedMapper, data, issueIndexManager.getIssueSearcher().getIndexReader());
        searchProvider.search(query, remoteUser, hitCollector);
        return data;
    }
