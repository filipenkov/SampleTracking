...
public class CalendarResourceIncluder
{
    ...
    {
        return ComponentManager.getComponentInstanceOfType(CalendarLanguageUtil.class);
    }

    WebResourceManager getWebResourceManager()
    {
        return ComponentManager.getComponentInstanceOfType(WebResourceManager.class);
    }
     ...
     * @param locale user's locale
     * @since v3.12
     * @deprecated use {@link #includeForLocale(java.util.Locale)} instead.
     */
    @Deprecated
