...
public class DefaultPackageScannerConfiguration implements PackageScannerConfiguration, Startable
{
    ...
    public DefaultPackageScannerConfiguration(final BuildUtilsInfo buildUtilsInfo)
    {
        ...
        final String jiraOsgiVersion = new VersionNumber(hostVersion).getOSGIVersion();
        ...
        packageVersions = MapBuilder.<String, String>newBuilder()
                ...
                .add("com.atlassian.velocity*", jiraOsgiVersion)
                ...
                // com.atlassian.ip is exported at v2.0 because it clashes with crowd-integration-client-2.3.3.jar
                // This is fixed in JIRA 5.0 because we reomve dep on the shaded crowd-integration-client-2.3.3.jar
                .add("com.atlassian.ip*", "2.0.0")
