...
public final class LoginProperties
{
    ...
    private LoginProperties(final boolean loginSucceeded, final boolean loginError, final boolean communicationError, final boolean allowCookies, final boolean externalPasswordManagement, final boolean externalUserManagement, final boolean publicMode, final boolean isElevatedSecurityCheckShown, final boolean captchaFailure, final boolean loginFailedByPermssions)
    {
    ...
    public static class Builder
    {
        ...
        {
            return new LoginProperties(loginSucceeded, loginError, communicationError, allowCookies, externalPasswordManagement, externalUserManagement,
