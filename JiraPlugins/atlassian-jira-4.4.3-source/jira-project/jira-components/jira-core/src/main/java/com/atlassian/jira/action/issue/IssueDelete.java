...
public class IssueDelete extends AbstractIssueAction implements IssueDeleteInterface
{
    ...
    protected String doExecute() throws RemoveException, PermissionException
    {
        ...
        {
            issueManager.deleteIssue(getRemoteUser(), issue, currEventTypeOption, sendMail);
        }
        else
        {
            SimpleErrorCollection simpleErrorCollection = new SimpleErrorCollection();
            issueService.delete(getRemoteUser(), new IssueService.DeleteValidationResult(issue, simpleErrorCollection), currEventTypeOption, sendMail);
