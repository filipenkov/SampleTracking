        ...
        if (!modifiedFields.isEmpty())
        {
            ...
            for (final String fieldId : modifiedFields.keySet())
            {
                if (fieldManager.isOrderableField(fieldId))
                {
                    ...
                    FieldLayoutItem fieldLayoutItem = ComponentAccessor.getFieldLayoutManager().getFieldLayout(issue.getGenericValue()).getFieldLayoutItem(field);
            ...
            TextAnalyzer textAnalyzer = ComponentManager.getInstance().getTextAnalyzer();
            textAnalyzer.analyseContent(issue.getGenericValue(), modifiedText.toString());
        }
