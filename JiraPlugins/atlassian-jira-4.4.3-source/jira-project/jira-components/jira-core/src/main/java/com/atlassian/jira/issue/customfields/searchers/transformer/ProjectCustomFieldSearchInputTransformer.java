...
public class ProjectCustomFieldSearchInputTransformer extends AbstractSingleValueCustomFieldSearchInputTransformer implements SearchInputTransformer
{
    ...
    public ProjectCustomFieldSearchInputTransformer(String urlParameterName, final ClauseNames clauseNames, CustomField field,
            ...
            final SearchContextVisibilityChecker searchContextVisibilityChecker, final NameResolver<Project> projectResolver,
    ...
    protected CustomFieldParams getParamsFromSearchRequest(final User searcher, Query query, final SearchContext searchContext)
    {
        ...
        final Set<String> valuesAsStrings = indexedInputHelper.getAllNavigatorValuesForMatchingClauses(searcher, clauseNames, query, searchContext);
    ...
    Clause createSearchClause(final User searcher, final String value)
    {
        ...
        if (!value.equals("-1"))
        {
            ...
            return new TerminalClauseImpl(getClauseName(searcher, clauseNames), Operator.EQUALS, o);
        }
        return null;
    }
    ...
    IndexedInputHelper createIndexedInputHelper()
    {
        return new DefaultIndexedInputHelper<Project>(indexInfoResolver, jqlOperandResolver, fieldFlagOperandRegistry, searchContextVisibilityChecker);
    }
    ///CLOVER:ON
}
