 ...
 * </pre></code>
 */
public class WebworkModuleDescriptor extends JiraResourcedModuleDescriptor<Void> implements ConfigurationInterface
{
    ...
    public void init(final Plugin plugin, final Element element) throws PluginParseException
    {
        ...
        try
        {
            final electric.xml.Element root = new Document(element.asXML()).getRoot(); //hackiness needed to convert dom4j element to w3c element
            ...
            configurationReader = new XMLConfigurationReader(actionElement);
        }
