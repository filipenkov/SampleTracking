 ...
 * @since 3.12
 */
public class ProjectOperationModuleDescriptor extends JiraResourcedModuleDescriptor<PluggableProjectOperation> implements OrderableModuleDescriptor
{
    private int order;

    public ProjectOperationModuleDescriptor(JiraAuthenticationContext authenticationContext, final ModuleFactory moduleFactory)
    {
