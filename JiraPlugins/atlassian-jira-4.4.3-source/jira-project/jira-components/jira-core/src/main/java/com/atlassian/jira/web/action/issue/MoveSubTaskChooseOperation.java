...
public class MoveSubTaskChooseOperation extends MoveIssue
{
    ...
    public MoveSubTaskChooseOperation(IssueLinkManager issueLinkManager, SubTaskManager subTaskManager,
    ...
    {
        return moveSubTaskOperation.canPerform(getMoveIssueBean(), getRemoteUser());
    }
    ...
    {
        for (Iterator iterator = moveSubTaskOperations.iterator(); iterator.hasNext();)
        {
            MoveSubTaskOperation moveSubTaskOperation = (MoveSubTaskOperation) iterator.next();
