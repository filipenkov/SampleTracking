...
{
    public DateTimeRelativeNoTimeFormatter(DateTimeFormatterServiceProvider serviceProvider, ApplicationProperties applicationProperties, TimeZoneService timeZoneService, JiraAuthenticationContext jiraAuthenticationContext, JodaFormatterSupplier jodaFormatterSupplier, Clock clock)
    {
        super(serviceProvider, applicationProperties, timeZoneService, jiraAuthenticationContext, createNoDateFormatter(), new DateTimeDateFormatter(serviceProvider, jodaFormatterSupplier), clock);
    }
