...
public interface WorkflowPermission
{
     ...
     * @return Whether the workflow grants the permission.
     *
     * @deprecated Please use {@link #allows(int, com.atlassian.jira.issue.Issue, com.atlassian.crowd.embedded.api.User)}. Since v4.3
     */
    public boolean allows(int permission, Issue issue, com.opensymphony.user.User user);
}
