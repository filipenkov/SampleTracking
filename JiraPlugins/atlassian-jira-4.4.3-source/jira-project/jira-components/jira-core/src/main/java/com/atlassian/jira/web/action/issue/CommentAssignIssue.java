        ...
        implements OperationContext, WorkflowAwareAction
{
    ...
    public CommentAssignIssue(IssueLinkManager issueLinkManager, SubTaskManager subTaskManager,
            FieldScreenRendererFactory fieldScreenRendererFactory, IssueUtilsBean issueUtils,
            CommentService commentService, IssueService issueService)
    {
    ...
    {
        return !issueUtils.isValidAction(getIssueObject(), action);
    }
    ...
    protected void doValidation()
    {
        ...
        transitionResult = issueService.validateTransition(getRemoteUser(), getIssueObject().getId(), action, issueInputParameters);
    ...
    protected String doExecute() throws Exception
    {
        ...
        final IssueService.IssueResult transitionResult = issueService.transition(getRemoteUser(), this.transitionResult);
        if (!transitionResult.isValid())
        {
            addErrorCollection(transitionResult.getErrorCollection());
            return ERROR;
