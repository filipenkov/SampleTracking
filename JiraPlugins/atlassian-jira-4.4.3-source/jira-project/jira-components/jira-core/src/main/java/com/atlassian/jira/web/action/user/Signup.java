...
public class Signup extends JiraWebActionSupport
{
    ...
    public Signup(final ApplicationProperties applicationProperties, final UserService userService, final UserUtil userUtil, final JiraCaptchaService jiraCaptchaService)
    {
    ...
    protected String doExecute() throws Exception
    {
        ...
        User user = userService.createUserForSignup(result);
        if (user == null)
        {
