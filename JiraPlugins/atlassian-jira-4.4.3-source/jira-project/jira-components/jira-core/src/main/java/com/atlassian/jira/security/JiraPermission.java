...
public class JiraPermission
{
    ...
    public JiraPermission(int type, String group, String permType)
    {
        this.type = type;
        this.scheme = null;
        this.group = group;
    ...
    public JiraPermission(GenericValue permission)
    {
    ...
    public JiraPermission(int type, Long scheme, String group, String permType)
    {
        this.type = type;
    ...
    public JiraPermission(int type, GenericValue scheme, String group, String permType)
    {
        this.type = type;
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof JiraPermission))
        {
            return false;
        }

        final JiraPermission jiraPermission = (JiraPermission) o;
