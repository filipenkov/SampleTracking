...
public class BulkDelete extends AbstractBulkOperationDetailsAction
{
    ...
    {
        return getBulkDeleteOperation().canPerform(getBulkEditBean(), getRemoteUser());
    }
    ...
    public void doPerformValidation()
    {
        try
        {
            ...
            if (!getBulkDeleteOperation().canPerform(getBulkEditBean(), getRemoteUser()))
            {
    ...
    public String doPerform() throws Exception
    {
        ...
        try
        {
            getBulkDeleteOperation().perform(getBulkEditBean(), getRemoteUser());
        }
        catch (Exception e)
        {
