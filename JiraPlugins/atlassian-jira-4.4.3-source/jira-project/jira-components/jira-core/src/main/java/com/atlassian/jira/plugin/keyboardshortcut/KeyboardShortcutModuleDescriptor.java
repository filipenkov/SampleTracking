 ...
 * @since v4.1
 */
public class KeyboardShortcutModuleDescriptor extends JiraResourcedModuleDescriptor<KeyboardShortcut>
        implements OrderableModuleDescriptor
{
    ...
    private KeyboardShortcutManager.Context context = Context.global;
    ...
    public KeyboardShortcutModuleDescriptor(final JiraAuthenticationContext authenticationContext, final KeyboardShortcutManager keyboardShortcutManager, final ModuleFactory moduleFactory)
    {
    ...
    {
        return new KeyboardShortcut(context, operation, operationParam, order, shortcuts, descriptionKey, hidden);
    }
