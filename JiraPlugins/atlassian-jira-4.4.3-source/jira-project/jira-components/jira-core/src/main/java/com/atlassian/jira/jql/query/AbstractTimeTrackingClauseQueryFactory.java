...
public class AbstractTimeTrackingClauseQueryFactory implements ClauseQueryFactory
{
    ...
    public AbstractTimeTrackingClauseQueryFactory(final String indexField, final JqlOperandResolver operandResolver, final JqlDurationSupport jqlDurationSupport, final ApplicationProperties applicationProperties)
    {
        ...
        operatorFactories.add(new ActualValueEqualityQueryFactory(jqlDurationSupport, BaseFieldIndexer.NO_VALUE_INDEX_VALUE));
        operatorFactories.add(new ActualValueRelationalQueryFactory(jqlDurationSupport, BaseFieldIndexer.NO_VALUE_INDEX_VALUE));
