...
public class AvatarManagerImpl implements AvatarManager
{
    ...
    {
        readAvatarData(avatar, ImageSize.LARGE, dataAccessor);
    }

    public void readSmallAvatarData(final Avatar avatar, final Consumer<InputStream> dataAccessor) throws IOException
    {
        readAvatarData(avatar, ImageSize.SMALL, dataAccessor);
    }
    ...
    @Override
    public boolean hasPermissionToView(com.opensymphony.user.User remoteUser, Avatar.Type type, String ownerId)
    {
        return hasPermissionToView((User) remoteUser, type, ownerId);
    }
    ...
    public boolean hasPermissionToView(final User remoteUser, final Avatar.Type type, final String ownerId)
    {
        ...
        else if (USER.equals(type))
        {
            ...
            final boolean remoteUserIsSame = remoteUser != null && remoteUser.getName().equals(ownerId);
    ...
    @Override
    public boolean hasPermissionToEdit(com.opensymphony.user.User remoteUser, Avatar.Type type, String ownerId)
    {
        return hasPermissionToEdit((User) remoteUser, type, ownerId);
    }
    ...
    public boolean hasPermissionToEdit(final User remoteUser, final Avatar.Type type, final String ownerId)
    {
        ...
        else if (USER.equals(type))
        {
            ...
            if (remoteUser == null || ownerId == null)
            {
                return false;
            }
            final boolean isAdmin = permissionManager.hasPermission(Permissions.ADMINISTER, remoteUser);
            final boolean isOwner = StringUtils.equals(remoteUser.getName(), ownerId);
