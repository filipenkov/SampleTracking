...
public class AttachFile extends AbstractCommentableIssue implements OperationContext
{
    ...
    public AttachFile(final IssueLinkManager issueLinkManager, final SubTaskManager subTaskManager,
            final FieldScreenRendererFactory fieldScreenRendererFactory, final FieldManager fieldManager,
            final ProjectRoleManager projectRoleManager, final CommentService commentService, final AttachmentService attachmentService,
            final AttachmentManager attachmentManager, final IssueUpdater issueUpdater, final TemporaryAttachmentsMonitorLocator temporaryAttachmentsMonitorLocator)
    {
    ...
    {
        //clear out any temporary values
    ...
    protected String doExecute() throws Exception
    {
        ...
        final IssueUpdateBean issueUpdateBean = new IssueUpdateBean(getIssue(), getIssue(), EventType.ISSUE_UPDATED_ID, getRemoteUser());
    ...
    public List<TemporaryAttachment> getTemporaryAttachments() throws GenericEntityException
    {
        ...
        return new ArrayList<TemporaryAttachment>(temporaryAttachmentsMonitor.getByIssueId(getId()));
    }
