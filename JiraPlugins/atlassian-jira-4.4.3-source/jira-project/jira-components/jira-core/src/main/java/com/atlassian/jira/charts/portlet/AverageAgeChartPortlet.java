 ...
 * @since v4.0
 */
public class AverageAgeChartPortlet extends AbstractChartPortlet implements SearchRequestAwareChartPortlet
{
    private static final Logger log = Logger.getLogger(AverageAgeChartPortlet.class);
    private final ChartFactory chartFactory;


    public AverageAgeChartPortlet(JiraAuthenticationContext authenticationContext, PermissionManager permissionManager,
    ...
    private Map<String, Object> getVelocityParams(PortletConfiguration portletConfiguration, SearchRequest searchRequest)
    {
        ...
        try
        {
            ...
            final ChartFactory.PeriodName periodName = PeriodName.valueOf(portletConfiguration.getProperty("periodName"));
