...
public class ImportAll extends AbstractSetupAction
{
    ...
    {
        final DataImportParams params = new DataImportParams.Builder(filename).setLicenseString(licenseString).setUseDefaultPaths(useDefaultPaths).setQuickImport(quickImport).build();
    ...
    protected String doExecute() throws Exception
    {
        ...
        try
        {
            ...
            final DataImportAsyncCommand importCallable = new DataImportAsyncCommand(eventCont, dataImportService, getLoggedInUser(), result,
                    new Event(EventType.get("import"), "JIRA is currently being restored from backup", EventLevel.get(EventLevel.WARNING)), velocityRequestContextFactory.getJiraVelocityRequestContext(),
