...
public class FieldConfigImpl implements FieldConfig, Comparable
{
    ...
    public FieldConfigImpl(final Long id, final String name, final String description, List/* <FieldConfigItemType> */configItemTypes, final String fieldId)
    {
        ...
        final List /* <FieldConfigItemType> */configItems = new ArrayList(configItemTypes.size());
        for (final Iterator iterator = configItemTypes.iterator(); iterator.hasNext();)
        {
            final FieldConfigItemType type = (FieldConfigItemType) iterator.next();
    ...
    public CustomField getCustomField()
    {
        ...
        final CustomField customField = ManagerFactory.getCustomFieldManager().getCustomFieldObject(fieldId);
        if (customField == null)
        {
