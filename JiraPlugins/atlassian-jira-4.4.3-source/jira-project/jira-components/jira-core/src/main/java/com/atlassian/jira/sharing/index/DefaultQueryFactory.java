    ...
    private abstract class Builder extends QueryBuilder
    {
        ...
        QueryBuilder build()
        {
            ...
            if (params.getTextSearchMode() == SharedEntitySearchParameters.TextSearchMode.EXACT)
            {
                ...
                {
                    nameOrDescription.add(new Term(SharedEntityColumn.NAME.getCaseInsensitiveColumn(), 
                ...
                if (!StringUtils.isBlank(params.getDescription()))
                {
                    ...
                    nameOrDescription.add(new Term(SharedEntityColumn.DESCRIPTION.getSortColumn(),
            ...
            add(SharedEntityColumn.OWNER, params.getUserName(), BooleanClause.Occur.MUST);
