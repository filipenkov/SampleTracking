...
public class AddVersion extends ViewProject
{
    ...
    protected void doValidation()
    {
        ...
        validationResult = versionService.validateCreateVersion(getRemoteUser(), getProjectObject(), getName(), getReleaseDate(),
    ...
    protected String doExecute() throws Exception
    {
        ...
        versionService.createVersion(getRemoteUser(), validationResult);
