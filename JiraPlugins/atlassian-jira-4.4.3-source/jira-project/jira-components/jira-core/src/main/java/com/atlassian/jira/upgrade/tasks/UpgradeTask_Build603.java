...
public class UpgradeTask_Build603 extends AbstractReindexUpgradeTask
{
    ...
    public UpgradeTask_Build603(final ApplicationProperties applicationProperties, final IndexLifecycleManager indexManager, CrowdDirectoryService crowdDirectoryService)
    {
