 ...
 * @since v4.4
 */
public class DateTimeFormatterFactoryImpl implements DateTimeFormatterFactory, Startable
{
    /**
    ...
    public DateTimeFormatterFactoryImpl(TimeZoneService timeZoneService, JiraAuthenticationContext jiraAuthenticationContext, ApplicationProperties applicationProperties, EventPublisher eventPublisher, I18nHelper.BeanFactory i18nFactory)
    {
        this(timeZoneService, jiraAuthenticationContext, applicationProperties, eventPublisher, i18nFactory, RealClock.getInstance());
    }

    DateTimeFormatterFactoryImpl(TimeZoneService timeZoneService, JiraAuthenticationContext jiraAuthenticationContext, ApplicationProperties applicationProperties, EventPublisher eventPublisher, I18nHelper.BeanFactory i18nFactory, Clock clock)
    {
    ...
    public void start()
    {
        ...
        log.trace("Registered {} in event publisher: {}", this, eventPublisher);
    }
    ...
    private ImmutableMap<DateTimeStyle, DateTimeFormatStrategy> createFormatters()
    {
        ...
        return ImmutableMap.<DateTimeStyle, DateTimeFormatStrategy>builder()
                ...
                .put(DateTimeStyle.RELATIVE_WITH_TIME_ONLY, new DateTimeRelativeDatesWithTimeFormatter(serviceProvider, applicationProperties, timeZoneService, jiraAuthenticationContext, jodaFormatterCache, clock))
                .put(DateTimeStyle.RELATIVE_WITHOUT_TIME, new DateTimeRelativeNoTimeFormatter(serviceProvider, applicationProperties, timeZoneService, jiraAuthenticationContext, jodaFormatterCache, clock))
                .put(DateTimeStyle.RELATIVE_ALWAYS_WITH_TIME, new DateTimeRelativeDatesAlwaysWithTime(serviceProvider, applicationProperties, timeZoneService, jiraAuthenticationContext, jodaFormatterCache, clock))
    ...
    private class SettingsSupplier implements DateTimeSettings
    {
        ...
        public DateTimeZone timeZoneFor(@Nullable User user)
        {
            ...
            if (user != null)
            {
                TimeZone userTimeZone = timeZoneService.getUserTimeZoneInfo(serviceContext).toTimeZone();
            ...
            return DateTimeZone.forTimeZone(timeZoneService.getDefaultTimeZoneInfo(serviceContext).toTimeZone());
        }
