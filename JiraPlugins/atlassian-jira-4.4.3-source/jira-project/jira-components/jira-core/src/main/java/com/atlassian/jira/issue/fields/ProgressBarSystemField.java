...
public class ProgressBarSystemField extends AbstractProgressBarSystemField
{
    ...
    public ProgressBarSystemField(VelocityManager velocityManager, ApplicationProperties applicationProperties,
            JiraAuthenticationContext authenticationContext, TimeTrackingGraphBeanFactory factory)
    {
        super(IssueFieldConstants.PROGRESS, PROGRESS_BAR_NAME, PROGRESS_BAR_NAME, velocityManager, applicationProperties, authenticationContext);
