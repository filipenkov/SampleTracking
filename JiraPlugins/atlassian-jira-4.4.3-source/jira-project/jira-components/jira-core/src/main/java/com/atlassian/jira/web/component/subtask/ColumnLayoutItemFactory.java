...
public class ColumnLayoutItemFactory
{
    ...
    public ColumnLayoutItemFactory(PermissionManager permissionManager, VelocityManager velocityManager,
    ...
    {
        return new ActionsAndOperationsColumnLayoutItem(velocityManager, applicationProperties, authenticationContext, xsrfTokenGenerator);
    }
    ...
    public ColumnLayoutItem getSubTaskSimpleSummaryColumn()
    {
        return new SimpleColumnLayoutItem()
        {
            ...
            public String getHtml(Map displayParams, Issue issue)
            {
                ...
                html.append("<a href='").append(contextPath).append("/browse/").append(issue.getKey()).append("'>").append(TextUtils.htmlEncode(issue.getSummary())).append("</a>");
