...
public class DefaultProjectRoleService implements ProjectRoleService
{
    ...
    public DefaultProjectRoleService(ProjectRoleManager projectRoleManager, PermissionManager permissionManager,
            JiraAuthenticationContext jiraAuthenticationContext, RoleActorFactory roleActorFactory,
            NotificationSchemeManager notificationSchemeManager, PermissionSchemeManager permissionSchemeManager,
            WorkflowManager workflowManager, ProjectManager projectManager, ProjectFactory projectFactory,
            SchemeFactory schemeFactory, IssueSecurityLevelManager issueSecurityLevelManager, final SharePermissionDeleteUtils sharePermissionDeleteUtils)
    {
    ...
    {
        // Old OSUser Object
        return getProjectRoles((User) currentUser, errorCollection);
    }
    ...
    {
        // Old OSUser Object
        return getProjectRole((User) currentUser, id, errorCollection);
    }
    ...
    {
        // Old OSUser Object
        return getProjectRoleByName((User) currentUser, name, errorCollection);
    }
    ...
    {
        // Old OSUser Object
        return createProjectRole((User) currentUser, projectRole, errorCollection);
    }
    ...
    {
        // Old OSUser Object
        return isProjectRoleNameUnique((User) currentUser, name, errorCollection);
    }
    ...
    {
        // Old OSUser Object
        deleteProjectRole((User) currentUser, projectRole, errorCollection);
    }
    ...
    public void deleteProjectRole(User currentUser, ProjectRole projectRole, ErrorCollection errorCollection)
    {
        ...
        if (!internalError)
        {
            ...
            try
            {
                ManagerFactory.getIssueSecuritySchemeManager().removeEntities(PROJECTROLE_ISSUE_SECURITY_TYPE, projectRole.getId().toString());
            }
            catch (RemoveException e)
            {
    ...
    {
        // Old OSUser Object
        addActorsToProjectRole((User) currentUser, actors, projectRole, project, actorType, errorCollection);
    }
    ...
    {
        // Old OSUser Object
        return getProjectRoleActors((User) currentUser, projectRole, project, errorCollection);
    }
    ...
    {
        // Old OSUser Object
        return getDefaultRoleActors((User) currentUser, projectRole, collection);
    }
    ...
    {
        // Old OSUser Object
        removeActorsFromProjectRole((User) currentUser, actors, projectRole, project, actorType, errorCollection);
    }
    ...
    {
        // Old OSUser Object
        updateProjectRole((User) currentUser, projectRole, errorCollection);
    }
    ...
    boolean doesProjectRoleExistForAdministerProjectsPermission(Project project, ProjectRole projectRole)
    {
        ...
        try
        {
            schemes = permissionSchemeManager.getSchemes(project.getGenericValue());
        }
        ...
        {
            Scheme scheme = schemeFactory.getSchemeWithEntitiesComparable((GenericValue) iterator.next());
    ...
    {
        // Old OSUser Object
        addDefaultActorsToProjectRole((User) currentUser, actors, projectRole, type, errorCollection);
    }
    ...
    {
        // Old OSUser Object
        removeDefaultActorsFromProjectRole((User) currentUser, actors, projectRole, actorType, errorCollection);
    }
    ...
    {
        // Old OSUser Object
        removeAllRoleActorsByNameAndType((User) currentUser, name, type, errorCollection);
    }
    ...
    {
        // Old OSUser Object
        return validateRemoveAllRoleActorsByNameAndType((User) currentUser, name, type);
    }
    ...
    {
        // Old OSUser Object
        removeAllRoleActorsByProject((User) currentUser, project, errorCollection);
    }
    ...
    {
        // Old OSUser Object
        return getAssociatedNotificationSchemes((User) currentUser, projectRole, errorCollection);
    }
    ...
    {
        // Old OSUser Object
        return getAssociatedPermissionSchemes((User) currentUser, projectRole, errorCollection);
    }
    ...
    public Collection getAssociatedIssueSecuritySchemes(User currentUser, ProjectRole projectRole, ErrorCollection errorCollection)
    {
        ...
        if (!internalError)
        {
            schemes = ManagerFactory.getIssueSecuritySchemeManager().getSchemesContainingEntity(PROJECTROLE_ISSUE_SECURITY_TYPE, projectRole.getId().toString());
        }
        return schemes;
    }
    ...
    {
        // Old OSUser Object
        return getAssociatedWorkflows((User) currentUser, projectRole, errorCollection);
    }
    ...
    {
        // Old OSUser Object
        return getAssociatedIssueSecuritySchemes((User) currentUser, projectRole, errorCollection);
    }
    ...
    {
        // Old OSUser Object
        return getProjectsContainingRoleActorByNameAndType((User) currentUser, name, type, errorCollection);
    }
    ...
    {
        // Old OSUser Object
        return roleActorOfTypeExistsForProjects((User) currentUser, projectsToLimitBy, projectRole, projectRoleType, projectRoleParameter, errorCollection);
    }
    ...
    {
        // Old OSUser Object
        return getProjectIdsForUserInGroupsBecauseOfRole((User) currentUser, projectsToLimitBy, projectRole, projectRoleType, userName, errorCollection);
    }
    ...
    {
        // Old OSUser Object
        return hasProjectRolePermission((User) currentUser, project);
    }
    ...
    {
        return permissionManager.hasPermission(Permissions.PROJECT_ADMIN, project.getGenericValue(), currentUser);
    }
    ...
    private boolean roleActorsToRemoveContainsRoleActorFromProjectRole(RoleActor roleActorFromProjectRole, String actorType, User currentUser, Collection<String> actors, ProjectRole projectRole, Project project)
    {
        // We want to keep track of the amount of times we run into an existing role actor that contains the current
        // user within the users Set that the actor represents
        if (roleActorFromProjectRole.getType().equals(actorType) && roleActorFromProjectRole.contains(OSUserConverter.convertToOSUser(currentUser)))
        {
            for (String actorName : actors)
            {
