...
public class DefaultSimpleLinkManager implements SimpleLinkManager
{
    ...
    public boolean shouldLocationBeLazy(final String location, final com.opensymphony.user.User remoteUser, final JiraHelper jiraHelper)
    {
        return shouldLocationBeLazy(location, (User) remoteUser, jiraHelper);
    }
    ...
    public List<SimpleLink> getLinksForSection(@NotNull final String section, final com.opensymphony.user.User remoteUser, @NotNull final JiraHelper jiraHelper)
    {
        return getLinksForSection(section, (User) remoteUser, jiraHelper);
    }
    ...
    public List<SimpleLink> getLinksForSectionIgnoreConditions(@NotNull final String section, final com.opensymphony.user.User remoteUser, @NotNull final JiraHelper jiraHelper)
    {
        return getLinksForSectionIgnoreConditions(section, (User) remoteUser, jiraHelper);
    }
        ...
        while ((factory != null) || (item != null))
        {
            ...
            if ((factory != null) && (item != null))
            {
                if (factory.getWeight() < item.getWeight())
                {
                    ...
                    {
                        returnLinks.addAll(factoryModule.getLinks(osUser, jiraHelper.getContextParams()));
                    }
                    factory = factoryIterator.hasNext() ? factoryIterator.next() : null;
                }
                else
                {
                    final SimpleLink link = convertWebItemToSimpleLink(item, osUser, jiraHelper);
                    if (link != null)
                    {
    ...
    public List<SimpleLinkSection> getSectionsForLocation(@NotNull final String location, final com.opensymphony.user.User remoteUser, @NotNull final JiraHelper jiraHelper)
    {
        return getSectionsForLocation(location, (User) remoteUser, jiraHelper);
    }
    ...
    public List<SimpleLinkSection> getNotEmptySectionsForLocation(@NotNull String location, com.opensymphony.user.User remoteUser, @NotNull JiraHelper jiraHelper)
    {
       return getNotEmptySectionsForLocation(location, (User) remoteUser, jiraHelper);
    }
