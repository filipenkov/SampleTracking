...
class DateRangeTimeChart
{
    ...
    public Chart generateChart(final User remoteUser, final String dateFieldId, final SearchRequest searchRequest, int days, final ChartFactory.PeriodName periodName, int width, int height, long yAxisTimePeriod, String labelSuffixKey)
    {
        ...
        try
        {
            ...
            final TimeSeriesCollection chartDataset = DataUtils.reduceDataset(dataset, EasyList.build(i18nBean.getText("datacollector.averageresolution")));
    ...
    static class DateRangeObjectHitCollector extends DocumentHitCollector
    {
        ...
        public DateRangeObjectHitCollector(String dateDocumentConstant1, String dateDocumentConstant2,
                Map<RegularTimePeriod, List<Long>> result, Searcher searcher, Class timePeriodClass,
