...
public class UpdateFieldsHelperBeanImpl implements UpdateFieldsHelperBean
{
    ...
    @Override
    public ActionResult updateIssue(MutableIssue issueObject, OperationContext operationContext, com.opensymphony.user.User user, ErrorCollection errors, I18nHelper i18n)
            throws Exception
    {
        return updateIssue(issueObject, operationContext, (User) user, errors, i18n);
    }
    ...
    @Override
    public void validate(Issue issueObject, OperationContext operationContext, Map actionParams, com.opensymphony.user.User user, ErrorCollection errors, I18nHelper i18n)
    {
        validate(issueObject, operationContext, actionParams,(User) user, errors, i18n);
    }
    ...
    @Override
    public List getFieldsForEdit(com.opensymphony.user.User user, Issue issueObject)
    {
        return getFieldsForEdit((User) user, issueObject);
    }
    ...
    public boolean isEditable(Issue issue)
    {
        ...
        boolean hasPermission = permissionManager.hasPermission(Permissions.EDIT_ISSUE, issue.getGenericValue(), authenticationContext.getUser());
        if (hasPermission)
        {
    ...
    @Override
    public boolean isFieldValidForEdit(com.opensymphony.user.User user, String fieldId, Issue issueObject)
    {
        return isFieldValidForEdit((User) user, fieldId, issueObject);
    }
