...
public interface PortalPageStore
{
     ...
     */
    PortalPage getPortalPageByOwnerAndName(final User owner, final String portalPageName);
     ...
     */
    PortalPage getPortalPage(final Long portalPageId);
     ...
     */
    PortalPage create(final PortalPage portalPage);
     ...
     */
    PortalPage update(final PortalPage portalPage);
     ...
     */
    boolean updatePortalPageOptimisticLock(final Long portalPageId, Long currentVersion);
     ...
     */
    void delete(final Long portalPageId);
