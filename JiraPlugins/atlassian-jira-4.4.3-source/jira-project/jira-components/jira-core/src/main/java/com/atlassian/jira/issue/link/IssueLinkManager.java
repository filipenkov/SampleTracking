...
public interface IssueLinkManager
{
     ...
     * @throws CreateException   If there is an error when creating the "Change Item" for this operation. Note that the Link itself has most likely been created.
     *
     * @deprecated Use {@link #createIssueLink(Long, Long, Long, Long, com.atlassian.crowd.embedded.api.User)} instead. Since v4.3
     */
    public void createIssueLink(Long sourceIssueId, Long destinationIssueId, Long issueLinkTypeId, Long sequence, com.opensymphony.user.User remoteUser) throws CreateException;
     ...
     * @throws IllegalArgumentException if the supplied issueLink is null.
     *
     * @deprecated Use {@link #removeIssueLink(IssueLink, com.atlassian.crowd.embedded.api.User)} instead. Since v4.3
     */
     ...
     * @throws RemoveException
     *
     * @deprecated Use {@link #removeIssueLinks(org.ofbiz.core.entity.GenericValue, com.atlassian.crowd.embedded.api.User)} instead. Since v4.3
     */
     ...
     * @deprecated use {@link #getLinkCollection(com.atlassian.jira.issue.Issue, com.opensymphony.user.User)} instead
     */
     ...
     * @since v4.0
     *
     * @deprecated Use {@link #getLinkCollection(com.atlassian.jira.issue.Issue, com.atlassian.crowd.embedded.api.User)} instead. Since v4.3
     */
     ...
     * @return List of {@link IssueLink}s
     */
     ...
     * @throws RemoveException
     *
     * @deprecated Use {@link #changeIssueLinkType(IssueLink, IssueLinkType, com.atlassian.crowd.embedded.api.User)} instead. Since v4.3
     */
