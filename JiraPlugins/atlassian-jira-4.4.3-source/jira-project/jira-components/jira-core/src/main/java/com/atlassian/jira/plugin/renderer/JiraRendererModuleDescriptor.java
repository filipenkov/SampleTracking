...
public class JiraRendererModuleDescriptor extends JiraResourcedModuleDescriptor<JiraRendererPlugin>
{
    ...
    public JiraRendererModuleDescriptor(JiraAuthenticationContext authenticationContext, ApplicationProperties applicationProperties, final ModuleFactory moduleFactory)
    {
    ...
    public String getEditVM(String value, String issueKey, String rendererType, String fieldId, String fieldName, Map params, boolean singleLine)
    {
        ...
        JiraRendererPlugin renderer = (JiraRendererPlugin)getModule();
        params.put("req", ServletActionContext.getRequest());
