...
public class AbstractProjectEntityEdit extends JiraNonWebActionSupport
{
     ...
     *
     * @param relation relation to the project
     * @param entity This is the project entity (version , component etc)
     */
    // TODO: Delete this method - it is no longer required, and does not do what it is documented to do.
    protected void flushAffectedIssues(final String relation, final GenericValue entity) throws GenericEntityException
    {
        ManagerFactory.getProjectManager().refreshProjectDependencies(project);
    }
