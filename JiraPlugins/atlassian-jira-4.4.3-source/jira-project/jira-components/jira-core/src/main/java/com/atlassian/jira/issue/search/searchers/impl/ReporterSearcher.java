...
public class ReporterSearcher extends AbstractInitializationSearcher implements IssueSearcher<SearchableField>
{
    ...
    public ReporterSearcher(VelocityRequestContextFactory velocityRequestContextFactory,
            VelocityManager velocityManager, ApplicationProperties applicationProperties, UserPickerSearchService userPickerSearchService, GroupManager groupManager, UserManager userManager)
    {
        ...
        searchRenderer = new ReporterSearchRenderer(NAME_KEY, velocityRequestContextFactory, applicationProperties, velocityManager, userPickerSearchService);
