...
/**
 * Jelly tag that provides jelly access to {@link ProjectRoleService#isProjectRoleNameUnique(com.opensymphony.user.User, String, com.atlassian.jira.util.ErrorCollection)}
 */
