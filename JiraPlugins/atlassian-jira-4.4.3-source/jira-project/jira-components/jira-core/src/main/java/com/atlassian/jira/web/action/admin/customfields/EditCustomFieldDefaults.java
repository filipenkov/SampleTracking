...
public class EditCustomFieldDefaults extends AbstractEditConfigurationItemAction
{
    ...
    public EditCustomFieldDefaults(ExternalUtils externalUtils, FieldLayoutManager fieldLayoutManager,
    ...
    public static void populateDefaults(FieldConfig config, Map customFieldValuesHolder1)
    {
        ...
        if (defaultValues != null)
        {
            ...
            customFieldValuesHolder1.put(cf.getId(), paramsFromIssue);
        }
    }
    ...
    public String getCustomFieldHtml()
    {
        ...
        try
        {
            if(dummyIssue.getProject() != null && dummyIssue.getIssueType() != null)
            {
                FieldLayout fieldLayout = fieldLayoutManager.getFieldLayout(dummyIssue.getProject(), dummyIssue.getIssueType().getString("id"));
    ...
    {
        MutableIssue dummyIssue = externalUtils.newIssueInstance();
