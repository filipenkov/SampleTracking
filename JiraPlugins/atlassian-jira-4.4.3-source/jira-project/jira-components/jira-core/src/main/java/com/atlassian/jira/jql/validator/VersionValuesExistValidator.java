...
class VersionValuesExistValidator extends ValuesExistValidator
{
    ...
    VersionValuesExistValidator(final JqlOperandResolver operandResolver, VersionIndexInfoResolver versionIndexInfoResolver, PermissionManager permissionManager, VersionManager versionManager)
    {
