...
public interface PortletConfigurationManager
{
    ...
    /**
     * Adds a new legacy portlet to a dashboard.  Hopefully one day JIRA will no longer support legacy portlets and
     * this method can be deleted.
     *
     * @param portalPageId the portal page the configuration will belong to.
     * @param portletKey   the portal the configuration will be associated with.
     ...
     */
    PortletConfiguration addLegacyPortlet(Long portalPageId, String portletKey, Integer column, Integer row);
