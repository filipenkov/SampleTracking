...
public interface UserProfileFragment
{
     ...
     * @deprecated Use {@link #showFragment(User, User)}. Since v4.3
     */
    public boolean showFragment(com.opensymphony.user.User profileUser, com.opensymphony.user.User currentUser);
     ...
     * @deprecated Use {@link #getFragmentHtml(User, User)}. Since v4.3
     */
    public String getFragmentHtml(com.opensymphony.user.User profileUser, com.opensymphony.user.User currentUser);
