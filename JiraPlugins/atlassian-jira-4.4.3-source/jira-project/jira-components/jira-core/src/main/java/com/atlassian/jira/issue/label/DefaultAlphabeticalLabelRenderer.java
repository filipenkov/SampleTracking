...
public class DefaultAlphabeticalLabelRenderer implements AlphabeticalLabelRenderer
{
    ...
    public DefaultAlphabeticalLabelRenderer(final VelocityManager velocityManager,
            final JiraAuthenticationContext authenticationContext, final FieldManager fieldManager,
            final ProjectManager projectManager, final LabelUtil labelUtil,
            final ApplicationProperties applicationProperties, final I18nHelper.BeanFactory beanFactory)
    {
    ...
    @Override
    public String getHtml(final User remoteUser, final Long projectId, final String fieldId)
    {
        ...
        try
        {
            ...
            return velocityManager.getEncodedBody("templates/plugins/jira/projectpanels/", "labels-alphabetical.vm", applicationProperties.getEncoding(), startingParams);
        }
