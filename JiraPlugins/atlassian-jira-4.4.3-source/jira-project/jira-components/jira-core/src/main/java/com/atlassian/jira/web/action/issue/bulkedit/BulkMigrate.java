...
public class BulkMigrate extends BulkMove
{
    ...
    public String doChooseContext() throws Exception
    {
        ...
        getBulkMigrateOperation().chooseContext(currentRootBulkEditBean, getRemoteUser(), this, this);
        ...
        getBulkMigrateOperation().getBulkMoveOperation().finishChooseContext(rootMultiBulkMoveBean, getRemoteUser());
    ...
    public String doChooseSubTaskContext() throws Exception
    {
             ...
             iterator.hasNext();)
        {
            ...
            if (multiBulkMoveBean != null)
            {
                ...
                getBulkMigrateOperation().getBulkMoveOperation().finishChooseContext(multiBulkMoveBean,getRemoteUser());
            }
        }
