...
public class CantBrowseCreatedIssue extends JiraWebActionSupport
{
    ...
    {
        GenericValue issue = issueManager.getIssue(issueKey);
        if (issue != null && ManagerFactory.getPermissionManager().hasPermission(Permissions.BROWSE, issue, getRemoteUser()))
        {
