...
public class DueDateSystemField extends AbstractOrderableNavigableFieldImpl implements HideableField, RequirableField, DateField
{
    ...
    {
        super(IssueFieldConstants.DUE_DATE, DUE_DATE_NAME_KEY, velocityManager, applicationProperties, authenticationContext, permissionManager, factory);
    ...
    (
                    ...
                    final DateFieldFormat dateFieldFormat)
    {
        this(velocityManager, applicationProperties, permissionManager, authenticationContext, factory, dateFieldFormat, ComponentAccessor.getComponentOfType(DateTimeFieldChangeLogHelper.class));
    }
    ...
    public void validateParams(OperationContext operationContext, ErrorCollection errorCollection, I18nHelper i18n, Issue issue, FieldScreenRenderLayoutItem fieldScreenRenderLayoutItem)
    {
        ...
        if (fieldScreenRenderLayoutItem.isRequired() && !TextUtils.stringSet(dueDate))
        {
            ...
            {
                errorCollection.addErrorMessage(i18n.getText("createissue.error.due.date.required", i18n.getText(getNameKey()), issue.getProject().getString("name")));
            }
        }
    }
