...
public interface HintManager
{
     ...
     * @return all hints accessible to the user
     */
    List<Hint> getAllHints(com.opensymphony.user.User user, JiraHelper helper);
     ...
     * @return A random hint for the context specified or null if none exist
     */
    Hint getHintForContext(final com.opensymphony.user.User remoteUser, final JiraHelper jiraHelper, final Context context);
}
