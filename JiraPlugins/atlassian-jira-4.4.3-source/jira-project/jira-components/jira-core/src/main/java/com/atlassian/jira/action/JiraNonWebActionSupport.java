...
public class JiraNonWebActionSupport extends JiraActionSupport implements SafeAction
{
     ...
     */
    private com.opensymphony.user.User remoteUser;
    ...
    public com.opensymphony.user.User getRemoteUser()
    {
        if (remoteUser == null)
        {
            ...
            if (principal != null)
            {
                remoteUser = ManagerFactory.getUserManager().getUser(principal.getName());
            }
        }
        return remoteUser;
    }
     ...
     */
    public void setRemoteUser(final com.opensymphony.user.User remoteUser)
    {
