...
public class LookAndFeelBean
{
    ...
    public static final class DefaultColours
    {
        ...
        public static final String TEXT_LINKCOLOR = "#3c78b5";
        public static final String TEXT_ACTIVELINKCOLOR = "#3c78b5";
        public static final String TEXT_HEADINGCOLOR = "#3c78b5";
