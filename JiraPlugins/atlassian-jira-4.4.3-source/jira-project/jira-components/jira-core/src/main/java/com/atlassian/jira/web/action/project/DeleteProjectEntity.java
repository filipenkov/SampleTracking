...
public class DeleteProjectEntity extends IssueActionSupport
{
    ...
    protected boolean hasPermission() throws Exception
    {
        ...
        return permissionManager.hasPermission(Permissions.ADMINISTER, getRemoteUser()) || permissionManager.hasPermission(Permissions.PROJECT_ADMIN, getProject(), getRemoteUser());
    }
