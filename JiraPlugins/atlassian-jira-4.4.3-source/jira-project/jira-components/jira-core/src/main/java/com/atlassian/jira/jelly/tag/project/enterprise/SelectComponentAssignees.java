...
public class SelectComponentAssignees extends JiraDynaBeanTagSupport
{
    ...
    public void doTag(XMLOutput output) throws JellyTagException
    {
        ...
        try
        {
            ...
            ErrorCollection errors = selectComponentAssigneesUtil.execute(authenticationContext.getUser());
    ...
    private void validateAttributes() throws JellyTagException
    {
        ...
        if (selectComponentAssigneesUtil.hasPermission(project, authenticationContext.getUser()))
        {
        ...
        {
            throw new JellyTagException("User " + authenticationContext.getUser() + " does not have " +
