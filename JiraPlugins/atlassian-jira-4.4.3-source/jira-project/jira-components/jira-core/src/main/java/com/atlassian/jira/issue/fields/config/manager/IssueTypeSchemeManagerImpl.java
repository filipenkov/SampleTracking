...
public class IssueTypeSchemeManagerImpl implements IssueTypeSchemeManager
{
    ...
    {
        final String s = ManagerFactory.getApplicationProperties().getString(APKeys.DEFAULT_ISSUE_TYPE_SCHEME);
        return new Long(s);
    }
    ...
    public IssueType getDefaultValue(FieldConfig config)
    {
        if (config != null)
        {
            ...
            return ManagerFactory.getConstantsManager().getIssueTypeObject(issueTypeId);
        }
        else
        {
            return null;
    ...
    public IssueType getDefaultValue(GenericValue project)
    {
        if (project != null)
        {
            ...
            FieldConfig relevantConfig = issueTypeField.getRelevantConfig(new IssueContextImpl(project, null));
    ...
    {
        return configSchemeManager.getRelevantConfigScheme(new IssueContextImpl(project, null), getFieldManager().getIssueTypeField());
    }
