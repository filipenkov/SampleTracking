...
public class UserSearchInputTransformer implements SearchInputTransformer
{
    ...
    public UserSearchInputTransformer(UserFieldSearchConstantsWithEmpty searchConstants, final UserFitsNavigatorHelper userFitsNavigatorHelper, GroupManager groupManager, UserManager userManager)
    {
    ...
    public UserSearchInputTransformer(UserFieldSearchConstants searchConstants, final UserFitsNavigatorHelper userFitsNavigatorHelper, GroupManager groupManager, UserManager userManager)
    {
        this.groupManager = groupManager;
        this.userManager = userManager;
    ...
    {
        final String clauseName = searchConstants.getJqlClauseNames().getPrimaryName();
