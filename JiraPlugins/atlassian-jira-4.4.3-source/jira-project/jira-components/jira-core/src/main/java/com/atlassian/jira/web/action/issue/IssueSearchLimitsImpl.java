...
public class IssueSearchLimitsImpl implements IssueSearchLimits
{
    ...
    public int getMaxResults()
    {
        ...
        {
            log.warn("Cannot get issue navigator restriction clause for: {} key={}", applicationProperties.getDefaultBackedString(JIRA_SEARCH_VIEWS_DEFAULT_MAX), JIRA_SEARCH_VIEWS_DEFAULT_MAX);
            return DEFAULT_MAX_RESULTS;
        }
    }
}
