...
public class BulkOnlyIndexManager extends DefaultIndexManager
{
     ...
     */
    public BulkOnlyIndexManager(final IndexingConfiguration properties, final IssueIndexer issueIndexer, final IndexPathManager indexPathManager, final ReindexMessageManager reindexMessageManager)
    {
        super(properties, issueIndexer, indexPathManager, reindexMessageManager);
    }
