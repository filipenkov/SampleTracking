...
public class DateTimeRangeSearcher extends AbstractDateRangeSearcher
{
    ...
    {
        super(jqlOperandResolver, velocityRenderContext, applicationProperties, velocityManager, calendarUtils, new DateTimePickerConverter(dateTimeFormatterFactory), dateSupport, timeZoneManager);
    ...
    {
        this(context, jqlOperandResolver, velocityRenderContext, applicationProperties, velocityManager, calendarUtils, dateSupport, customFieldInputHelper, ComponentManager.getComponentInstanceOfType(TimeZoneManager.class), dateTimeFormatterFactory);
    }
