...
public class LabelParser
{
     ...
     *
     * @param labelsString a String containing labels separated by LabelsSystemField#SEPARATOR_CHAR
    ...
    public static <Y> Set<Y> buildFromString(CreateFromString<Y> factory, final String labelsString)
    {
        ...
        final String[] labelArray = StringUtils.split(labelsString, LabelsSystemField.SEPARATOR_CHAR);
