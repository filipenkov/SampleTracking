...
public class WorkRatioIndexer extends BaseFieldIndexer
{
    ...
    {
        return applicationProperties.getOption(APKeys.JIRA_OPTION_TIMETRACKING) && !fieldVisibilityManager.isFieldHidden(IssueFieldConstants.TIMETRACKING, issue);
    }
    ...
    public void addIndex(Document doc, Issue issue)
    {
        ...
        {
            doc.add(new Field(getDocumentFieldId(), WorkRatio.getPaddedWorkRatio(issue.getGenericValue()), Field.Store.YES, Field.Index.UN_TOKENIZED));
        }
    }
}
