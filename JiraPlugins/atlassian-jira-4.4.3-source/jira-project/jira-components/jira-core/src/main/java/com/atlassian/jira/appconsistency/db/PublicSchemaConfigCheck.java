...
public class PublicSchemaConfigCheck implements StartupCheck
{
    ...
    public boolean isOk()
    {
        if (Boolean.valueOf(System.getProperty(KEY_PUBLIC_SCHEMA_CONFIG_DISABLED)))
        {
    ...
    {
        return "You have an error in your " + SystemTenantDatabaseConfigurationLoader.FILENAME_DBCONFIG + " file.\n" +
    ...
    {
        return "<p>You have an error in your " + SystemTenantDatabaseConfigurationLoader.FILENAME_DBCONFIG + " file. " +
                "The schema-name=\"PUBLIC\" only works for a field-type-name of \"hsql\". " +
