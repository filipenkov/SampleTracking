...
public class FieldLayoutSchemeImpl extends AbstractGVBean implements FieldLayoutScheme
{
    ...
    public void store()
    {
        ...
        try
        {
            ...
            {
                for (final FieldLayoutSchemeEntity fieldLayoutSchemeEntity : schemeEntities.values())
                {
    ...
    {
        fieldLayoutSchemeEntity.setFieldLayoutScheme(this);
        lock.writeLock().lock();
        try
        {
    ...
    public void removeEntity(final String issueTypeId)
    {
        ...
        try
        {
            ...
            {
                final FieldLayoutSchemeEntity fieldLayoutSchemeEntity = getInternalSchemeEntities().get(issueTypeId);
                fieldLayoutSchemeEntity.setFieldLayoutScheme(null);
                getInternalSchemeEntities().remove(issueTypeId);
                fieldLayoutSchemeEntity.remove();
                store();
            }
        }
        finally
    ...
    public void remove()
    {
        if (getGenericValue() != null)
        {
            ...
            try
            {
                for (final FieldLayoutSchemeEntity fieldLayoutSchemeEntity : getInternalSchemeEntities().values())
                {
                    fieldLayoutSchemeEntity.remove();
                }
