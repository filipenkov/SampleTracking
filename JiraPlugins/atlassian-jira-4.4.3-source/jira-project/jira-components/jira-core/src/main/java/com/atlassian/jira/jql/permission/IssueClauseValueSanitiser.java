...
public class IssueClauseValueSanitiser implements ClauseSanitiser
{
    ...
    public Clause sanitise(final User user, final TerminalClause clause)
    {
        ...
        log.warn(String.format("Could not figure out how to reconcile original operand '%s' and sanitised operand '%s'", originalOperand.getDisplayString(), sanitisedOperand.getDisplayString()));
        return clause;
    }
