...
public class CronEditorWebComponent extends AbstractWebComponent
{
    ...
    public CronEditorWebComponent(final VelocityManager velocityManager, final ApplicationProperties applicationProperties)
    {
    ...
    public String getHtml(final CronEditorBean cronEditorBean, final String paramPrefix)
    {
        ...
        return getHtml(cronEditorBean, i18n, paramPrefix);
