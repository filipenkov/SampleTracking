...
public class JellyService extends AbstractService
{
    ...
    public void init(PropertySet props) throws ObjectConfigurationException
    {
        ...
        log.info("JellyService.init : " + KEY_INPUT_FILE + "=" + inputFilename + " " + KEY_OUTPUT_FILE + "=" + outputFilename);
    }

    public void run()
    {
        log.info("JellyService.run");
        if (inputFilename == null || outputFilename == null)
        {
            if (inputFilename == null) log.warn("Jelly service not running - " + KEY_INPUT_FILE + " not specified");
            if (outputFilename == null) log.warn("Jelly service not running - " + KEY_OUTPUT_FILE + " not specified");
            return;
        }
