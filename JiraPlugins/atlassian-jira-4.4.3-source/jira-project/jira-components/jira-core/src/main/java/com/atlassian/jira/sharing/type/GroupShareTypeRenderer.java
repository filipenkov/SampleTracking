...
public class GroupShareTypeRenderer extends VelocityShareTypeRenderer
{
    ...
    public GroupShareTypeRenderer(final EncodingConfiguration encoding, final VelocityManager velocityManager)
    {
    ...
    public String getShareTypeEditor(final JiraAuthenticationContext authenticationContext)
    {
        ...
        final List<String> groups = new ArrayList<String>(getGroupsForUser(authenticationContext.getUser()));
    ...
    public boolean isAddButtonNeeded(final JiraAuthenticationContext authenticationContext)
    {
        ...
        return !getGroupsForUser(authenticationContext.getUser()).isEmpty();
    }
