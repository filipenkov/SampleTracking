...
public class TimeTrackingAdmin extends JiraWebActionSupport
{
    ...
    public TimeTrackingAdmin(final ApplicationProperties applicationProperties, final FieldManager fieldManager, final JiraDurationUtils jiraDurationUtils, final JiraAuthenticationContext authenticationContext, final PluginAccessor pluginAccessor, final ReindexMessageManager reindexMessageManager)
    {
    ...
    public String doActivate() throws Exception
    {
        if (!isTimeTracking())
        {
            ...
            reindexMessageManager.pushMessage(getRemoteUser(), "admin.notifications.task.timetracking");
        }
