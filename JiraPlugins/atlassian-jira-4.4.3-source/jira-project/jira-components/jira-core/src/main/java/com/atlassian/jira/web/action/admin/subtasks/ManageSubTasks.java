...
public class ManageSubTasks extends JiraWebActionSupport
{
    ...
    private String iconurl = "/images/icons/issue_subtask.gif";
    ...
    {
        return subTaskManager.getSubTasksIssueTypes();
    }
    ...
    public String doAddSubTaskIssueType() throws Exception
    {
        ...
        try
        {
            ...
            subTaskManager.createSubTaskIssueType(getName(), new Long(getSubTasksIssueTypes().size()), getDescription(), getIconurl());
            return getRedirect(getActionName() + ".jspa");
        }
