...
public interface SearchRequestFactory
{
     ...
     * {@link com.atlassian.jira.issue.search.searchers.transformer.SearchInputTransformer#populateFromParams(com.opensymphony.user.User,com.atlassian.jira.issue.transport.FieldValuesHolder,com.atlassian.jira.issue.transport.ActionParams)}
     * and {@link com.atlassian.jira.issue.search.searchers.transformer.SearchInputTransformer#getSearchClause(com.opensymphony.user.User,com.atlassian.jira.issue.transport.FieldValuesHolder)}
     ...
     */
    SearchRequest createFromParameters(final SearchRequest oldSearchRequest, final com.opensymphony.user.User searchUser, final ActionParams parameterMap);
     ...
     * @return a new SearchRequest based off given parameters.
     */
    SearchRequest createFromQuery(final SearchRequest oldSearchRequest, final com.opensymphony.user.User searchUser, final Query query);
