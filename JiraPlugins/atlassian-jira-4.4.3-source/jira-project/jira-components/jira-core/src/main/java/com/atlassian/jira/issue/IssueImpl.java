...
public class IssueImpl extends AbstractIssue implements MutableIssue
{
    ...
    {
        setReporter(OSUserConverter.convertToOSUser(reporter));
    }
    ...
    {
        setAssignee(OSUserConverter.convertToOSUser(assignee));
    }
    ...
    public Collection<Version> getFixVersions()
    {
        if (fixVersions == null)
        {
            if (genericValue != null)
            {
                final List<Version> newValue = new ArrayList<Version>(versionManager.getFixVersionsByIssue(genericValue));
    ...
    public GenericValue getPriority()
    {
        ...
        {
            priority = constantsManager.getPriority(priorityId);
        }
    ...
    public void setPriorityId(String priorityId)
    {
        if (priorityId != null)
        {
            setPriority(constantsManager.getPriority(priorityId));
        }
        else
        {
            setPriority(null);
    ...
    public Collection<Version> getAffectedVersions()
    {
        if (affectedVersions == null)
        {
            if (genericValue != null)
            {
                final List<Version> newValue = new ArrayList<Version>(versionManager.getAffectedVersionsByIssue(genericValue));
                Collections.sort(newValue, VersionComparator.COMPARATOR);
...
//                }
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof IssueImpl))
        {
            return false;
        }

        final IssueImpl issue = (IssueImpl) o;
