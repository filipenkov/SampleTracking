...
public class SelectSearcher extends AbstractInitializationCustomFieldSearcher
        implements CustomFieldSearcher, SortableCustomFieldSearcher, CustomFieldStattable
{
    ...
    public SelectSearcher(final ComponentFactory componentFactory, final ComponentLocator componentLocator)
    {
    ...
    public void init(CustomField field)
    {
        ...
        ClauseQueryFactory queryFactory = new SelectCustomFieldClauseQueryFactory(field, jqlSelectOptionsUtil, jqlOperandResolver);
