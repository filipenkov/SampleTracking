...
public class RepositoryActionSupport extends JiraWebActionSupport
{
    ...
    protected String checkRepository(String repositoryName, String logFilePath, String cvsRoot, String moduleName, String password, long cvsTimeout, boolean fetchLog)
    {
        ...
        catch (LockException e)
        {
            ...
            final String message = "Error obtaining lock: " + e.getMessage(0);
            log.error(message, e);
            return getText("admin.errors.cvs.obtaining.lock", e.getMessage(0));
        }
        catch (IOException e)
        {
        ...
        {
            log.error("Error occurred while obtaining cvs log or parsing the cvs log.", t);
    ...
    private void checkLogFile()
    {
        try
        {
            File file = new FileImpl(getLogFilePath());
