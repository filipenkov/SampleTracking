        ...
        implements UserProfileAction, SharedEntitySearchAction, DropDownModelProvider<PortalPageDisplayBean>
{
    ...
    public ConfigurePortalPages(final PortalPageService portalPageService, final JiraAuthenticationContext authenticationContext,
                                final EmailFormatter emailFormatter, final GroupPermissionChecker groupPermissionChecker,
    ...
    //
    // Implementation of the UserProfileAction interface.
    //
...
//
    ...
    {
        return getRemoteUser() != null || Tab.MY.equals(tab) || Tab.FAVOURITES.equals(tab);
    }

    private void showMyTab()
    {
        pages = transformToDisplayBeans(portalPageService.getOwnedPortalPages(getRemoteUser()));
        view = Tab.MY;
    }
    ...
    private void showFavouritesTab()
    {
        ...
        pages = transformToDisplayBeans(portalPageService.getFavouritePortalPages(getRemoteUser()));
        view = Tab.FAVOURITES;
    }
