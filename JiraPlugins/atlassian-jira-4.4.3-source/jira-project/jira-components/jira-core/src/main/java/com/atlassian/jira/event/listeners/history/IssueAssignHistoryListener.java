...
public class IssueAssignHistoryListener extends AbstractIssueEventListener
{
    ...
    public void issueAssigned(final IssueEvent event)
    {
        ...
        {
            UserHistoryManager userHistoryManager = ComponentManager.getComponent(UserHistoryManager.class);
            userHistoryManager.addItemToHistory(UserHistoryItem.ASSIGNEE, user, assignee.getName());
        }
    }
