...
public class SchemeMergeResultAction extends AbstractMergeAction
{
    ...
    protected String doExecute() throws Exception
    {
        ...
        persistedDistilledSchemeResults = new ArrayList();
        for (Iterator iterator = getDistilledSchemeResults().getDistilledSchemeResults().iterator(); iterator.hasNext();)
        {
            ...
            {
                Scheme persistedScheme = schemeDistiller.persistNewSchemeMappings(getRemoteUser(), distilledSchemeResult, persistErrors);
