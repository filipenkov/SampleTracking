...
public class JqlQueryBuilder
{
    ...
    {
        JqlDateSupport dateSupport = new JqlDateSupportImpl(ComponentAccessor.getComponentOfType(TimeZoneManager.class));
        DefaultJqlClauseBuilder defaultJqlClauseBuilder = new DefaultJqlClauseBuilder(parent, new PrecedenceSimpleClauseBuilder(), dateSupport);
        if (copy != null)
        {
            defaultJqlClauseBuilder.addClause(copy);
        }
        return defaultJqlClauseBuilder;
    }
