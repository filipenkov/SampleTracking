...
public class ThumbnailSystemField extends NavigableFieldImpl
{
    ...
    public ThumbnailSystemField(VelocityManager velocityManager, ApplicationProperties applicationProperties, ThumbnailManager thumbnailManager, JiraAuthenticationContext authenticationContext)
    {
        super(IssueFieldConstants.THUMBNAIL, "issue.field.thumbnail", "issue.column.heading.thumbnail", velocityManager, applicationProperties, authenticationContext);
    ...
    public String getColumnViewHtml(FieldLayoutItem fieldLayoutItem, Map displayParams, Issue issue)
    {
        ...
        try
        {
            velocityParams.put("thumbnails", thumbnailManager.getThumbnails(issue, getAuthenticationContext().getUser()));
