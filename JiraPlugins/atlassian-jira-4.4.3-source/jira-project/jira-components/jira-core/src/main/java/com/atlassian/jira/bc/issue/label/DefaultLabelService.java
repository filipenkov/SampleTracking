...
public class DefaultLabelService implements LabelService
{
    ...
    public LabelsResult getLabels(final com.opensymphony.user.User user, final Long issueId)
    {
        return getLabels((User) user, issueId);
    }
    ...
    public LabelsResult getLabels(final com.opensymphony.user.User user, final Long issueId, final Long customFieldId)
    {
        return getLabels((User) user, issueId, customFieldId);
    }
    ...
    public SetLabelValidationResult validateSetLabels(final com.opensymphony.user.User user, final Long issueId, final Set<String> labels)
    {
        return validateSetLabels((User) user, issueId, labels);
    }
    ...
    public SetLabelValidationResult validateSetLabels(final com.opensymphony.user.User user, final Long issueId, final Long customFieldId, final Set<String> labels)
    {
        return validateSetLabels((User) user, issueId, customFieldId, labels);
    }
    ...
    public LabelsResult setLabels(final com.opensymphony.user.User user, final SetLabelValidationResult result, final boolean sendNotification, final boolean causeChangeNotification)
    {
        return setLabels((User) user, result, sendNotification, causeChangeNotification);
    }
    ...
    public AddLabelValidationResult validateAddLabel(final com.opensymphony.user.User user, final Long issueId, final String label)
    {
        return validateAddLabel((User) user, issueId, label);
    }
    ...
    public AddLabelValidationResult validateAddLabel(final com.opensymphony.user.User user, final Long issueId, final Long customFieldId, final String label)
    {
        return validateAddLabel((User) user, issueId, customFieldId, label);
    }
    ...
    public LabelsResult addLabel(final com.opensymphony.user.User user, final AddLabelValidationResult result, final boolean sendNotification)
    {
        return addLabel((User) user, result, sendNotification);
    }
    ...
    public LabelSuggestionResult getSuggestedLabels(final com.opensymphony.user.User user, final Long issueId, final String token)
    {
        return getSuggestedLabels((User) user, issueId, token);
    }
    ...
    public LabelSuggestionResult getSuggestedLabels(final com.opensymphony.user.User user, final Long issueId, final Long customFieldId, final String token)
    {
        return getSuggestedLabels((User) user, issueId, customFieldId, token);
    }
