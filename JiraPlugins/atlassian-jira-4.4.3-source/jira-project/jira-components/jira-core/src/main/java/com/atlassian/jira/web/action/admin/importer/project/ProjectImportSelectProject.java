...
public class ProjectImportSelectProject extends JiraWebActionSupport
{
    ...
    public String doExecute() throws Exception
    {
        ...
        final JiraServiceContext serviceContext = new JiraServiceContextImpl(getRemoteUser(), errorCollection);
    ...
    {
        final JiraServiceContext serviceContext = new JiraServiceContextImpl(getRemoteUser(), new SimpleErrorCollection());
