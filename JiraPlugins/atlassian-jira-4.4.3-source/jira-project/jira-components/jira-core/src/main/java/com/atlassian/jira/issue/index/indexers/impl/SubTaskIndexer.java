...
public class SubTaskIndexer extends BaseFieldIndexer
{
    ...
    public void addIndex(Document doc, Issue issue)
    {
        ...
        final List outwardLinks = issueLinkManager.getOutwardLinks(issue.getId());
        ...
        for (Iterator iterator = outwardLinks.iterator(); iterator.hasNext();)
        {
            ...
            {
                doc.add(new Field(getDocumentFieldId(), outwardLink.getDestinationId().toString(), Field.Store.YES, Field.Index.UN_TOKENIZED));
            }
        }
    }
}