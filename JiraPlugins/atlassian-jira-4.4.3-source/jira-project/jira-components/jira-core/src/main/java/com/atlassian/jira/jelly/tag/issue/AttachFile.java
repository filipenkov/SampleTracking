...
public class AttachFile extends JiraDynaBeanTagSupport
{
    ...
    public void doTag(XMLOutput xmlOutput) throws MissingAttributeException, JellyTagException
    {
        ...
        try
        {
            GenericValue issue = ManagerFactory.getIssueManager().getIssue(issueKey);
    ...
    private void attachFile(File file, User user, GenericValue issue, Timestamp createdDate) throws GenericEntityException, JellyTagException
    {
        try
        {
            if (createdDate == null)
    ...
    private Long getAttachmentId(GenericValue issue, String compareFilename)
    {
