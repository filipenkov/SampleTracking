...
public interface GadgetPermissionManager
{
     ...
     * @return Vote.DENY if the user doesn't have permission.  Vote.ALLOW otherwise
     */
    Vote voteOn(final PluginGadgetSpec pluginGadgetSpec, final com.opensymphony.user.User remoteUser);
     ...
     * @return A filtered dashboardstate with any offending gadgets removed.
     */
    DashboardState filterGadgets(final DashboardState dashboardState, final com.opensymphony.user.User remoteUser);
     ...
     * @return Vote.DENY if the user doesn't have permission.  Vote.ALLOW otherwise
     */
    Vote voteOn(String completeGadgetKey, com.opensymphony.user.User remoteUser);
