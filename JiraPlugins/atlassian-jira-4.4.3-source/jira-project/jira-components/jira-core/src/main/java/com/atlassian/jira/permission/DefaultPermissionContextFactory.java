...
public class DefaultPermissionContextFactory implements PermissionContextFactory
{
    ...
    {
        return new PermissionContextImpl(issue, issue.getProject(), issueStatus);
    }

    public PermissionContext getPermissionContext(PermissionContext oldCtx)
    {
        return new PermissionContextImpl(oldCtx.getIssue(), oldCtx.getProject(), oldCtx.getStatus());
    }
    ...
    public PermissionContext getPermissionContext(GenericValue projectOrIssue)
    {
        ...
        {
            return new PermissionContextImpl(null, projectOrIssue, null);
        }
