...
public class AggregateProgressBarSystemField extends AbstractProgressBarSystemField
{
    ...
    public AggregateProgressBarSystemField(VelocityManager velocityManager, ApplicationProperties applicationProperties,
    ...
    {
        super(IssueFieldConstants.AGGREGATE_PROGRESS, PROGRESS_BAR_NAME, PROGRESS_BAR_NAME, velocityManager, applicationProperties, authenticationContext);
