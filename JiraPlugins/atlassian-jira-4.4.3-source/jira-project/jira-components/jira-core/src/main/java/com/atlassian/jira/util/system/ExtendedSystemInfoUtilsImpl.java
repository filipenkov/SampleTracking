...
import static com.atlassian.core.ofbiz.CoreFactory.getGenericDelegator;
...
public class ExtendedSystemInfoUtilsImpl implements ExtendedSystemInfoUtils
{
    ...
    protected ExtendedSystemInfoUtilsImpl(final SystemInfoUtils systemInfoUtils, final ServiceManager serviceManager, final PluginAccessor pluginAccessor, final ApplicationProperties applicationProperties, final TrustedApplicationService trustedAppService, final GenericDelegator delegator, final I18nHelper i18nHelper, final UserUtil userUtil, final HashRegistryCache registry, final LocaleManager localeManager, final JiraLicenseService jiraLicenseService, final BuildUtilsInfo buildUtilsInfo, final UpgradeManager upgradeManager, final IssueIndexManager indexManager)
    {
    ...
    {
        this(new SystemInfoUtilsImpl(), getComponentInstanceOfType(ServiceManager.class), getComponentInstanceOfType(PluginAccessor.class),
                ComponentAccessor.getApplicationProperties(), getComponentInstanceOfType(TrustedApplicationService.class),
                getGenericDelegator(), i18nHelper, ComponentAccessor.getUserUtil(), getComponentInstanceOfType(HashRegistryCache.class),
                getComponentInstanceOfType(LocaleManager.class), getComponentInstanceOfType(JiraLicenseService.class),
                getComponentInstanceOfType(BuildUtilsInfo.class), getComponentInstanceOfType(UpgradeManager.class), getComponentInstanceOfType(IssueIndexManager.class));
    }
    ...
    public Map<String, String> getProps(final boolean showSensitiveInfo)
    {
        ...
        props.add(getText("admin.systeminfo.crowd.integration"),
                systemInfoUtils.isCrowdified() ? getText("admin.common.words.on") : getText("admin.common.words.off"));
    ...
    public Map<String, String> getBuildStats()
    {
        ...
        buildstats.add(getText("admin.systeminfo.build.revision"), String.valueOf(buildUtilsInfo.getSvnRevision()));
    ...
    public Map<String, String> getUsageStats()
    {
        ...
        try
        {
            final OfBizDelegator delegator = new DefaultOfBizDelegator(CoreFactory.getGenericDelegator());
            ...
            usageStats.add(getText("admin.systeminfo.attachments"), Long.toString(delegator.getCount("FileAttachment")));
    ...
    {
        final JiraLogLocator locator = ComponentManager.getComponentInstanceOfType(JiraLogLocator.class);
    ...
    {
        final JiraHome jiraHome = ComponentManager.getComponentInstanceOfType(JiraHome.class);
        try
        {
    ...
    public Collection<GenericValue> getListeners()
    {
        try
        {
            ...
            @SuppressWarnings ("unchecked")
            final List<GenericValue> allListeners = getDelegator().findAll("ListenerConfig");
    ...
    public Collection<Plugin> getPlugins()
    {
        ...
        plugins.addAll(pluginAccessor.getPlugins());
    ...
    {
        return ManagerFactory.getOutlookDateManager().getOutlookDate(i18nHelper.getLocale());
    }
