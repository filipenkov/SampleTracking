...
public class LabelsSearcher extends AbstractInitializationSearcher implements IssueSearcher<SearchableField>
{
    ...
    public LabelsSearcher(VelocityManager velocityManager, VelocityRequestContextFactory contextFactory, FieldVisibilityManager fieldVisibilityManager,
            ApplicationProperties applicationProperties, JqlOperandResolver operandResolver, FieldFlagOperandRegistry fieldFlagOperandRegistry)
    {
        ...
        final AlwaysVisibleSearchContextVisibilityChecker searchContextVisibilityChecker = new AlwaysVisibleSearchContextVisibilityChecker();
        ...
        searchRenderer = new LabelsSearchRenderer(constants, contextFactory, fieldVisibilityManager, applicationProperties, velocityManager, searcherInformation.getNameKey());
        searchInputTransformer = new LabelsSearchInputTransformer(new LabelIndexInfoResolver(false), operandResolver, fieldFlagOperandRegistry, searchContextVisibilityChecker);
    }
