...
public interface SchemeDistillerService
{
     ...
     * @exception com.atlassian.jira.exception.DataAccessException if something goes wrong at the db level.
     */
    public Scheme persistNewSchemeMappings(com.opensymphony.user.User user, DistilledSchemeResult distilledSchemeResult, ErrorCollection errorCollection) throws DataAccessException;
