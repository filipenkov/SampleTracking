...
public class VoterIndexer extends BaseFieldIndexer
{
    ...
    {
        for (final String username : voterAccessor.getVoterNames(issue))
        {
            indexFoldedKeyword(doc, getDocumentFieldId(), username, Locale.ENGLISH, issue);
        }
    }
}
