 ...
 */
public class SearchRequestViewModuleDescriptor extends JiraResourcedModuleDescriptor<SearchRequestView>
{
    ...
    public SearchRequestViewModuleDescriptor(JiraAuthenticationContext authenticationContext, SearchRequestURLHandler urlHandler, final ModuleFactory moduleFactory)
    {
