...
public class ResolutionSystemField extends AbstractOrderableNavigableFieldImpl
        implements HideableField, IssueConstantsField
{
    ...
    {
        super(IssueFieldConstants.RESOLUTION, RESOLUTION_NAME_KEY, velocityManager, applicationProperties, authenticationContext, permissionManager, searchHandlerFactory);
    ...
    Collection retrieveResolutions(final OperationContext operationContext, final Issue issue, final Map<String, Object> velocityParams)
    {
