...
class UserAuthorizer implements Authorizer
{
    ...
    public UserAuthorizer(final com.opensymphony.user.Group allowedGroup, final Authorizer delegate, final GroupManager groupManager)
    {
        this((Group) allowedGroup, delegate, groupManager);
    }
    ...
    @Override
    public Result isSearchRequestAuthorized(com.opensymphony.user.User user, SearchRequest searchRequest, SearchRequestParams params)
    {
        return isSearchRequestAuthorized((User) user, searchRequest, params);
    }
