...
public abstract class DatabaseConfigPanel
{
    ...
    {
        newSettings.setJdbcDriverClass(getClassName());
        newSettings.setJdbcUrl(getUrl(jiraHome));
        newSettings.setDbUsername(getUsername());
        newSettings.setDbPassword(getPassword());
