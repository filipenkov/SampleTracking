...
public class AccessLogFilter implements Filter
{
    ...
    private void recordUserInformation(final FilterCallState filterCallState)
    {
        ...
        {
            filterCallState.httpServletResponse.setHeader(AccessLogRequestInfo.X_USER_NAME_HEADER, userName == null ? ANONYMOUS : userName);
        }
    }
    ...
    private String ajustUrl(final HttpServletRequest httpServletRequest, final String url)
    {
