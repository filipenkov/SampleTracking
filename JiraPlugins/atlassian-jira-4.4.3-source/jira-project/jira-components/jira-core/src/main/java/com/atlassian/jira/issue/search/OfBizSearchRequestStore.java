...
public class OfBizSearchRequestStore implements SearchRequestStore
{
    ...
    public SearchRequest getRequestByAuthorAndName(final User author, final String name)
    {
        ...
        final List<GenericValue> genericValues = delegator.findByAnd(Table.NAME, EasyMap.build(Column.AUTHOR, author.getName(), Column.NAME, name));
    ...
    public SearchRequest create(final SearchRequest request)
    {
        ...
        final GenericValue gv = delegator.createValue(Table.NAME, EasyMap.build(Column.NAME, request.getName(), Column.PROJECT, null,
            Column.DESCRIPTION, request.getDescription(), Column.AUTHOR, request.getOwnerUserName(), Column.USER, request.getOwnerUserName(),
    ...
    public SearchRequest update(final SearchRequest request)
    {
        ...
        searchFilter.setString(Column.AUTHOR, request.getOwnerUserName());
    ...
    {
        return delegator.findByPrimaryKey(Table.NAME, EasyMap.build(Column.ID, id));
    }
    ...
    private List<GenericValue> getSearchRequestGVsOwnedBy(final User author)
    {
        ...
        entityExpressions.add(new EntityExpr(Column.AUTHOR, EntityOperator.EQUALS, author.getName()));
