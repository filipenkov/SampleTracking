...
public class FavouriteDashboardLinkFactory implements SimpleLinkFactory
{
    ...
    public List<SimpleLink> getLinks(final com.opensymphony.user.User user, final Map<String, Object> params)
    {
    ...
    private Long getCurrentDashboard(final com.opensymphony.user.User user)
    {
