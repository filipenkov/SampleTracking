...
public class ViewIssueTypeScreenSchemes extends JiraWebActionSupport
{
    ...
    public String doAddIssueTypeScreenScheme()
    {
        ...
        if (!invalidInput())
        {
            ...
            IssueTypeScreenSchemeEntity issueTypeScreenSchemeEntity = new IssueTypeScreenSchemeEntityImpl(issueTypeScreenSchemeManager, (GenericValue) null, fieldScreenSchemeManager, getConstantsManager());
