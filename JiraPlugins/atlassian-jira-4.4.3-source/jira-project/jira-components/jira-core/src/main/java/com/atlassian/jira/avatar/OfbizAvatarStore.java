...
public class OfbizAvatarStore implements AvatarStore
{
    ...
    public Avatar getById(final Long avatarId)
    {
        ...
        final GenericValue gv = ofBizDelegator.findByPrimaryKey(AVATAR_ENTITY, EasyMap.build(ID, avatarId));
    ...
    public List<Avatar> getCustomAvatarsForOwner(final Avatar.Type type, final String ownerId)
    {
        ...
        return getAvatars(EasyMap.build(SYSTEM_AVATAR, NOT_SYSTEM, AVATAR_TYPE, type.getName(), OWNER, ownerId));
    }
