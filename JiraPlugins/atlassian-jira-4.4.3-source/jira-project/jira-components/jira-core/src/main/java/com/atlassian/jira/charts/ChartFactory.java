...
public interface ChartFactory
{
    ...
    static class ChartContext
    {
        ...
        public ChartContext(final com.opensymphony.user.User remoteUser, final SearchRequest searchRequest, final int width, final int height)
        {
            this((User) remoteUser, searchRequest, width, height);
        }
        ...
        {
            return OSUserConverter.convertToOSUser(remoteUser);
        }
