...
public class TemplateContext
{
    ...
    public TemplateContext(IssueEvent issueEvent, TemplateIssueFactory templateIssueFactory,
    ...
    public Map<String, Object> getTemplateParams()
    {
        ...
        // http://confluence.atlassian.com/display/JIRA/JIRA+3.6+-+Velocity+Context+for+Email+Templates
        ...
        templateParams.put("remoteUser", TemplateUser.getUser(issueEvent.getRemoteUser()));

        LookAndFeelBean landf = LookAndFeelBean.getInstance(ComponentManager.getComponent(ApplicationProperties.class));
        ...
        {
            jiraLogo = resourceManager.getStaticResourcePrefix(UrlMode.AUTO) + jiraLogo;
        }
    ...
    public Map<String, Object> getChangeLogParams()
    {
        ...
        if (changelog != null)
        {
            ...
            try
            {
                commentParams.put("changelogauthor", (changelog.getString("author") != null ? UserUtils.getUser(changelog.getString("author")) : null));
            }
            catch (EntityNotFoundException e)
            {
                // The user was not found. Add a "dummy" user object so that the templates will not fail. JRA-3071
