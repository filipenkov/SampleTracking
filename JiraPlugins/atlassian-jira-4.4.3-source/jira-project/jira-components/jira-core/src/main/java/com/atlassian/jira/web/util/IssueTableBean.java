...
public class IssueTableBean
{
    ...
    public GenericValue getSecurityLevel(GenericValue issue) throws Exception
    {
        ...
        final IssueSecurityLevelManager secur = ManagerFactory.getIssueSecurityLevelManager();
    ...
    public Collection getFixVersions(GenericValue issue) throws GenericEntityException
    {
        ...
        return ManagerFactory.getIssueManager().getEntitiesByIssue(IssueRelationConstants.FIX_VERSION, issue);
    }
    ...
    public Collection getVersions(GenericValue issue) throws GenericEntityException
    {
        ...
        return ManagerFactory.getIssueManager().getEntitiesByIssue(IssueRelationConstants.VERSION, issue);
    }
    ...
    public Collection getComponents(GenericValue issue) throws GenericEntityException
    {
        ...
        return ManagerFactory.getIssueManager().getEntitiesByIssue(IssueRelationConstants.COMPONENT, issue);
    }
    ...
    {
        List subTaskIssues = new LinkedList();
        for (Iterator iterator = subTaskManager.getSubTaskIssueLinks(issue.getLong("id")).iterator(); iterator.hasNext();)
        {
