 ...
 * point on any new PropertiesManager instances injected by Pico will be backed by datadse property sets. using a
...
public class PropertiesManager
{
     ...
     * Singleton retriever
     *
     * @deprecated Declare a constructor dependency for dependency injection by PICO, or if absolutely needed in a
     *             static context use ComponentManager.getComponent(PropertiesManager.class) instead. Since v4.3
     */
    @Deprecated
    public static PropertiesManager getInstance()
    {
        return ComponentManager.getComponent(PropertiesManager.class);
    }
     ...
     *
     * @return a resttable reference to the global properties
     */
