...
public class TimeZoneServiceImpl implements TimeZoneService
{
    ...
    {
        return Iterables.filter(TimeZoneIds.getCanonicalIds(), new Predicate<String>()
        {
            @Override
    ...
    {
        TimeZone canonicalJVMTimeZone = TimeZoneIds.ensureCanonicalTimeZone(getJVMTimeZone());
