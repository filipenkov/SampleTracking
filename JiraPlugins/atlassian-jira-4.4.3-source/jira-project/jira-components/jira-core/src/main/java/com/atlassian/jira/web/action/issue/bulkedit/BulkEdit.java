...
public class BulkEdit extends AbstractBulkOperationDetailsAction
{
    ...
    public Map getEditActions()
    {
        if (editActions == null)
        {
            editActions = getBulkEditOperation().getActions(getBulkEditBean(), getRemoteUser());
        }
        return editActions;
    }
    ...
    public Collection getCustomFields()
    {
        ...
        {
//            customFields = getBulkEditOperation().getCustomFields(getBulkEditBean(), getRemoteUser());
