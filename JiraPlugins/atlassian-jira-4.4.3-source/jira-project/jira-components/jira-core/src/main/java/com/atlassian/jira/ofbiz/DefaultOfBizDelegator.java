...
public class DefaultOfBizDelegator implements OfBizDelegator
{
    ...
    public void removeAll(final List<GenericValue> genericValues) throws DataAccessException
    {
        try
        {
            delegatorInterface.removeAll(genericValues);
        }
        catch (final GenericEntityException e)
        {
            throw new DataAccessException(e);
    ...
    public int removeByOr(final String entityName, final String entityId, final List<Long> ids) throws DataAccessException, GenericModelException
    {
        ...
        try
        {
            ...
            // Generate SQL
            final StringBuffer removeSql = new StringBuffer("DELETE FROM ");
    ...
    public int removeByAnd(final String s, final Map map) throws DataAccessException
    {
        try
        {
            return delegatorInterface.removeByAnd(s, map);
        }
        catch (final GenericEntityException e)
        {
            throw new DataAccessException(e);
    ...
    public GenericValue findByPrimaryKey(final String entityName, final Map fields)
    {
    ...
    public long getCount(final String entityName)
    {
        ...
        try
        {
            final EntityCondition condition = new EntityFieldMap(EasyMap.build(), EntityOperator.AND);
            final GenericValue countGV = EntityUtil.getOnly(delegatorInterface.findByCondition(entityName + "Count", condition,
                EasyList.build(COUNT_FIELD_NAME), Collections.EMPTY_LIST));
    ...
    public int bulkUpdateByPrimaryKey(final String entityName, final Map<String, ?> updateValues, final List<Long> keys)
    {
        ...
        try
        {
            ...
            final StringBuffer updateSql = new StringBuffer("UPDATE ");
            ...
            {
                int i = 0;
                final StringBuffer idClause = new StringBuffer();
                final ArrayList<Long> idParams = new ArrayList<Long>();
    ...
    public int bulkUpdateByAnd(final String entityName, final Map updateValues, final Map criteria)
    {
        ...
        try
        {
            ...
            for (final Iterator iterator = updateValues.keySet().iterator(); iterator.hasNext();)
            {
                final String column = (String) iterator.next();
                updateSql.append(" ");
                final ModelField modelField = modelEntity.getField(column);
                updateSql.append(modelField.getColName());
                updateSql.append(" = ");
                params.add(new EntityConditionParam(modelField, updateValues.get(column)));
                updateSql.append("? ");
                if (iterator.hasNext())
                {
                    updateSql.append(", ");
    ...
    static final class Updater
    {
        ...
        Updater(@NotNull final ModelFieldTypeReader modelFieldTypeReader, @NotNull final String entityName)
        {
