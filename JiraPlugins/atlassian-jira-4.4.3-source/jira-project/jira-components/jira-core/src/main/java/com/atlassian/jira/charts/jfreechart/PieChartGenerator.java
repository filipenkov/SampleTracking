...
public class PieChartGenerator implements ChartGenerator
{
    ...
    public PieChartGenerator(PieDataset pieDataset, final I18nBean i18nBean)
    {
    ...
    public ChartHelper generateChart()
    {
        ...
        setPieChartDefaults(chart, pieDataset, i18nBean);
     ...
     */
    private static void setPieChartDefaults(JFreeChart chart, PieDataset dataset,final I18nBean i18nBean)
    {
