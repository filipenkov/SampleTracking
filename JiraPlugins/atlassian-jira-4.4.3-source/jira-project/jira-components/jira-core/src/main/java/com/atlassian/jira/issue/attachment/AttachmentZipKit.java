...
public class AttachmentZipKit
{
     ...
     *         for data and has extra {@link java.util.zip.ZipEntry} information
    ...
    public enum FileCriteria
    {
        ONLY_FILES
                {
                    boolean matches(final ZipEntry zipEntry)
                    {
        ...
        abstract boolean matches(final ZipEntry zipEntry);
    }
     ...
     * @throws IOException if the file cant be read and {@link java.util.zip.ZipException} if the the file is not a zip
     * file.
     */
    ...
    private static class AttachmentZipEntryImpl implements AttachmentZipEntry
    {
        ...
        public AttachmentZipEntryImpl(final int entryIndex, final ZipEntry zipEntry)
        {
