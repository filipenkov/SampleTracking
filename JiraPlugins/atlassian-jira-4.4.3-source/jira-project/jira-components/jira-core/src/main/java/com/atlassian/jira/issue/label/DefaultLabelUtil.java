...
public class DefaultLabelUtil implements LabelUtil
{
    ...
    public String getLabelJql(final com.opensymphony.user.User user, final String label)
    {
        return getLabelJql((User) user, label);
    }
    ...
    public String getLabelJql(final com.opensymphony.user.User user, final Long customFieldId, final String label)
    {
        return getLabelJql((User) user, customFieldId, label);
    }
    ...
    public String getLabelJqlForProject(final com.opensymphony.user.User user, final Long projectId, final String label)
    {
        return getLabelJqlForProject((User) user, projectId, label);
    }
    ...
    public String getLabelJqlForProject(final com.opensymphony.user.User user, final Long projectId, final Long customFieldId, final String label)
    {
        return getLabelJqlForProject((User) user, projectId, customFieldId, label);
    }
