...
public interface LoginService
{
     ...
     * @return true if the user can be authenticated
     */
    LoginResult authenticate(com.opensymphony.user.User user, String password);
     ...
     * @return LoginProperties with information to render the login gadget/form
     */
    LoginProperties getLoginProperties(final com.opensymphony.user.User remoteUser, final HttpServletRequest request);
}
