...
abstract class AbstractVersionValidator implements ClauseValidator
{
    ...
    AbstractVersionValidator(final VersionResolver versionResolver, final JqlOperandResolver operandResolver, PermissionManager permissionManager, VersionManager versionManager)
    {
        this.supportedOperatorsValidator = getSupportedOperatorsValidator();
        this.versionValuesExistValidator = new VersionValuesExistValidator(operandResolver, new VersionIndexInfoResolver(versionResolver), permissionManager, versionManager);
    }
