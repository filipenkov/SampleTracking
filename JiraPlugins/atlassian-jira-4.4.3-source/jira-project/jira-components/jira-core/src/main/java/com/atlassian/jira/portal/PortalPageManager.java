...
public interface PortalPageManager extends SharedEntityAccessor<PortalPage>
{
     ...
     * @return a PortalPage if the user is allowed to see it or null if they are not allowed
     */
    PortalPage getPortalPage(final com.opensymphony.user.User user, final Long portalPageId);
     ...
     * @return a Collection of PortalPage objects that are owned by the specified User
     */
    Collection<PortalPage> getAllOwnedPortalPages(final com.opensymphony.user.User owner);
     ...
     * @return a PortalPage object if one can be found with the name and owner or null if not
     */
    PortalPage getPortalPageByName(final com.opensymphony.user.User owner, final String pageName);
     ...
     * @return the newly created PortalPage with its new id
     */
    PortalPage createBasedOnClone(final com.opensymphony.user.User pageOwner, final PortalPage portalPage, final PortalPage clonePortalPage);
     ...
     * @return the result containing the PortalPages objects that match the request.
     */
    SharedEntitySearchResult<PortalPage> search(SharedEntitySearchParameters searchParameters, com.opensymphony.user.User user, int pagePosition, int pageWidth);
