...
public interface SearchRequestService
{
     ...
     */
    Collection<SearchRequest> getFavouriteFilters(com.opensymphony.user.User user);
     ...
     */
    Collection<SearchRequest> getOwnedFilters(com.opensymphony.user.User user);
     ...
     */
    Collection<SearchRequest> getNonPrivateFilters(com.opensymphony.user.User user);
     ...
     */
    Collection<SearchRequest> getFiltersFavouritedByOthers(com.opensymphony.user.User user);
     ...
     */
    void deleteAllFiltersForUser(JiraServiceContext serviceCtx, com.opensymphony.user.User user);
