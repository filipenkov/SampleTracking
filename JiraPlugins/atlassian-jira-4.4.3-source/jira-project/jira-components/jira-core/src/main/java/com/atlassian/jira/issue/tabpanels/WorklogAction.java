...
public class WorklogAction extends AbstractIssueAction
{
    ...
    public WorklogAction(IssueTabPanelModuleDescriptor descriptor, Worklog worklog, JiraDurationUtils jiraDurationUtils, boolean canEditWorklog, boolean canDeleteWorklog, final FieldLayoutManager fieldLayoutManager, final RendererManager rendererManager)
    {
        super(descriptor);
