...
public class MimeSniffingKit
{
    ...
    {
        final File attachmentFile = getFileForAttachment(attachment);
            ...
            throws IOException
    {
        ...
        else if (mimeSniffingPolicy.equalsIgnoreCase(APKeys.MIME_SNIFFING_WORKAROUND) && BrowserUtils.isIe456Or7(userAgent))
        {
            Ie6MimeSniffer sniffer = new Ie6MimeSniffer();
            byte[] fileBytes = getLeadingFileBytes(file, Ie6MimeSniffer.MAX_BYTES_TO_SNIFF);
