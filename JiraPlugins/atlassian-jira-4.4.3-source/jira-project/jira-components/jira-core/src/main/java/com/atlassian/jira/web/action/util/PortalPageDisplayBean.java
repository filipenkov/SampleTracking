...
public class PortalPageDisplayBean implements SharesListHelper
{
    ...
    {
        return portalPage.getOwnerUserName();
    }

    public String getOwnerFullName()
    {
        final String ownerUserName = getOwnerUserName();
        if (ownerUserName != null)
        {
            return userFormatManager.formatUser(ownerUserName, FullNameUserFormat.TYPE, "portal_page");
        }
        return null;
    }
    ...
    {
        return (getOwnerUserName() != null) && userNameEqualsUtil.equals(getOwnerUserName(), authCtx.getUser());
    }
