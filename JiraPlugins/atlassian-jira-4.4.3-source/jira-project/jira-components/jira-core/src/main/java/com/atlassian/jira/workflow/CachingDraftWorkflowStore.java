 ...
 * @since v3.13
 */
public class CachingDraftWorkflowStore implements DraftWorkflowStore, Startable
{
    ...
    public CachingDraftWorkflowStore(final DraftWorkflowStore delegate, final EventPublisher eventPublisher)
    {
    ...
    public JiraWorkflow getDraftWorkflow(final String parentWorkflowName) throws DataAccessException
    {
        ...
        try
        {
            ...
            if (workflowDescriptorXML == null)
            {
                //if an draft workflow is not in the cache, try to get it from the DB.
