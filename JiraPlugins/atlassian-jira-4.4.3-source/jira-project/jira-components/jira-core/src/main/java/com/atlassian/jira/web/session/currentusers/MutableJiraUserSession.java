...
class MutableJiraUserSession implements JiraUserSession
{
    ...
    /**
     * The user name might not be set the first time the session is hit.  So we record it everytime.  Also the number of
    ...
    void recordInteraction(HttpServletRequest httpServletRequest, final String userName)
    {
        ...
        this.ipAddress.set(httpServletRequest.getRemoteAddr());
