...
public class DeleteComment extends AbstractIssueSelectAction
{
    ...
    protected FieldScreenRenderer getFieldScreenRendererWithAllFields()
    {
        ...
        {
            fieldScreenRendererWithAllFields = fieldScreenRendererFactory.getFieldScreenRenderer(getRemoteUser(), getIssueObject(), IssueOperations.VIEW_ISSUE_OPERATION, false);
        }
    ...
    public Comment getCommentObject()
    {
        ...
        {
            commentObject = commentService.getCommentById(getRemoteUser(), getCommentId(), this);
        }
