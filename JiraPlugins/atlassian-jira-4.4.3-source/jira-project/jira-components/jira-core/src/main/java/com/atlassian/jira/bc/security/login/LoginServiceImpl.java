...
public class LoginServiceImpl implements LoginService
{
    ...
    public LoginServiceImpl(final LoginManager loginManager, final ApplicationProperties applicationProperties, final UserManager userManager)
    {
    ...
    public void resetFailedLoginCount(final com.opensymphony.user.User user)
    {
        resetFailedLoginCount((User) user);
    }
    ...
    public LoginResult authenticate(final com.opensymphony.user.User user, final String password)
    {
    ...
    public LoginProperties getLoginProperties(final com.opensymphony.user.User remoteUser, final HttpServletRequest request)
    {
        return getLoginProperties((User) remoteUser, request);
    }
