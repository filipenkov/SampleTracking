...
{
    public RecentIssuesFragment(final JiraAuthenticationContext jiraAuthenticationContext, final VelocityManager velocityManager, final SearchProvider searchProvider, final ApplicationProperties applicationProperites, final DateTimeFormatterFactory dateTimeFormatterFactory)
    {
