...
public class XMLObjectConfigurationFactory implements ObjectConfigurationFactory
{
     ...
     * object when the get function is called.  Uses the same class loader that
     * loaded this instance of XMLObjectConfigurationFactory to load the xml file
     * and descriptor classes.
     *
    ...
    /**
     * This procedure loads an xml file into a holder object which is then used to contruct a real
     * object when the get function is called.  Uses the provided class loader 
     * to load the xml file and descriptor classes.
     *
     * @param xmlFile the name of the resource on the classpath from which to load the config.
     * @param id      Identifier for the object configuration to retrieve.
    ...
    public void loadObjectConfiguration(String xmlFile, String id, ClassLoader classLoader) throws ObjectConfigurationException
    {
        if (xmlFile != null)
        {
            ...
            {
                throw new ObjectConfigurationException("An Error occured trying to parse the configuration file '" + xmlFile + "' please ensure the file exists.", e);
            }
            catch (ClassNotFoundException e)
            {
                throw new ObjectConfigurationException("An Error occured loading class:", e);
            }
    ...
    /**
     * Returns a ObjectConfigurationProperty from a string representaion of a number or a
     * string representaion of the type.
     *
