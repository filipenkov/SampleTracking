        ...
        implements CustomFieldSearcher, SortableCustomFieldSearcher, CustomFieldStattable
{
    ...
    public UserPickerSearcher(final UserResolver userResolver, final JqlOperandResolver operandResolver,
            final JiraAuthenticationContext context, UserConverter userConverter,
            UserPickerSearchService userPickerSearchService, final CustomFieldInputHelper customFieldInputHelper,
    ...
    public void init(CustomField field)
    {
        ...
        this.customFieldSearcherClauseHandler = new SimpleCustomFieldValueGeneratingClauseHandler(new UserCustomFieldValidator(userResolver, operandResolver),
