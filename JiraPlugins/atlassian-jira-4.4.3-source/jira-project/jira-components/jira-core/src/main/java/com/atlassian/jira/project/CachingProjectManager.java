...
public class CachingProjectManager extends AbstractProjectManager implements Startable
{
    ...
    public CachingProjectManager(ProjectManager delegateProjectManager, ProjectComponentManager projectComponentManager,
            ProjectFactory projectFactory, final EventPublisher eventPublisher, UserManager userManager, ApplicationProperties applicationProperties)
    {
    ...
    public long getNextId(Project project)
    {
        ...
        // JRA-20038: Getting the Next ID updates the counter column in the Project table, so we need to refresh the caches
        updateCache();
        return nextId;
    }
    ...
    @Override
    public void refreshProjectDependencies(GenericValue project)
    {
        cache.refreshProjectDependencies(project);
    }
    ...
    {
        delegateProjectManager.updateProject(updatedProject);
        updateCache();
    }
    ...
    @Override
    public Collection<GenericValue> getProjectsByLead(com.opensymphony.user.User leadUser)
    {
