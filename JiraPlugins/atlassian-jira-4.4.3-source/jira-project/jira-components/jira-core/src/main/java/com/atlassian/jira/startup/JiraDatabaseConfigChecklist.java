...
public class JiraDatabaseConfigChecklist
{
    ...
    public JiraDatabaseConfigChecklist(final DatabaseConfigurationManager databaseConfigurationManager)
    {
        this(databaseConfigurationManager, new StartupCheck[] {
                ...
                new BuildVersionCheck()
        });
    }

    JiraDatabaseConfigChecklist(DatabaseConfigurationManager databaseConfigurationManager, final StartupCheck[] checklist)
    {
