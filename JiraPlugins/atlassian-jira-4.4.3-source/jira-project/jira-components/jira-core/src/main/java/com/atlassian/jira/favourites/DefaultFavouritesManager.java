...
public class DefaultFavouritesManager implements FavouritesManager<SharedEntity>
{
    ...
    @Override
    public void addFavourite(com.opensymphony.user.User user, SharedEntity entity) throws PermissionException
    {
        addFavourite((User) user, entity);
    }
    ...
    @Override
    public void addFavouriteInPosition(com.opensymphony.user.User user, SharedEntity entity, long position)
            throws PermissionException
    {
        addFavouriteInPosition((User) user, entity, position);
    }
    ...
    @Override
    public void removeFavourite(com.opensymphony.user.User user, SharedEntity entity)
    {
        removeFavourite((User) user, entity);
    }
    ...
    @Override
    public boolean isFavourite(com.opensymphony.user.User user, SharedEntity entity) throws PermissionException
    {
        return isFavourite((User) user, entity);
    }
    ...
    @Override
    public Collection<Long> getFavouriteIds(com.opensymphony.user.User user, SharedEntity.TypeDescriptor<SharedEntity> entityType)
    {
        return getFavouriteIds((User) user, entityType);
    }
    ...
    @Override
    public void removeFavouritesForUser(com.opensymphony.user.User user, SharedEntity.TypeDescriptor<SharedEntity> entityType)
    {
        removeFavouritesForUser((User) user, entityType);
    }
    ...
    @Override
    public void increaseFavouriteSequence(com.opensymphony.user.User user, SharedEntity entity)
            throws PermissionException
    {
        increaseFavouriteSequence((User) user, entity);
    }
    ...
    @Override
    public void decreaseFavouriteSequence(com.opensymphony.user.User user, SharedEntity entity)
            throws PermissionException
    {
        decreaseFavouriteSequence((User) user, entity);
    }
    ...
    @Override
    public void moveToStartFavouriteSequence(com.opensymphony.user.User user, SharedEntity entity)
            throws PermissionException
    {
        moveToStartFavouriteSequence((User) user, entity);
    }
    ...
    @Override
    public void moveToEndFavouriteSequence(com.opensymphony.user.User user, SharedEntity entity)
            throws PermissionException
    {
        moveToEndFavouriteSequence((User) user, entity);
    }
     ...
     */
    void reorderFavourites(final User user, final SharedEntity entity, final FavouriteReordererCommand favouriteReordererCommand)
    {
        validateInput(user, entity);
     ...
     */
    private void removeDeadFavourites(final User user, final List<Long> deadFavourites, final SharedEntity.TypeDescriptor<SharedEntity> entityType)
    {
    ...
    private boolean hasUserPermissionToSeeEntity(final User user, final SharedEntity entity)
    {
        return shareManager.hasPermission(user, entity);
    }

    private void validateInput(final User user, final SharedEntity entity)
    {
        Assertions.notNull("user", user);
        Assertions.notNull("entity", entity);
        Assertions.notNull("entity type", entity.getEntityType());
    ...
    private void checkPermissions(final User user, final SharedEntity entity) throws PermissionException
    {
