...
public class OfBizDraftWorkflowStore implements DraftWorkflowStore
{
    ...
    public JiraWorkflow createDraftWorkflow(String authorName, JiraWorkflow parentWorkflow) throws DataAccessException, IllegalStateException, IllegalArgumentException
    {
        ...
        try
        {
            ...
            final WorkflowDescriptor parentWorkflowDescriptorCopy = copyAndUpdateWorkflowDescriptorMetaAttributes(parentWorkflow.getDescriptor(), authorName);
    ...
    public JiraWorkflow updateDraftWorkflowWithoutAudit(String parentWorkflowName, JiraWorkflow workflow) throws DataAccessException
    {
        ...
        try
        {
            ...
            final Object existingDraftAuthor = existingDescriptor.getMetaAttributes().get(JiraWorkflow.JIRA_META_UPDATE_AUTHOR_NAME);
            if (existingDraftAuthor != null)
            {
                updatedDescriptor.getMetaAttributes().put(JiraWorkflow.JIRA_META_UPDATE_AUTHOR_NAME, existingDraftAuthor);
            }
    ...
    public JiraWorkflow updateDraftWorkflow(String username, String parentWorkflowName, JiraWorkflow workflow) throws DataAccessException
    {
        ...
        try
        {
            ...
            final WorkflowDescriptor updatedDescriptor = copyAndUpdateWorkflowDescriptorMetaAttributes(workflow.getDescriptor(), username);
            // Set the new descriptor
            draftWorkflowGV.setString(DESCRIPTOR_ENTITY_FIELD, convertDescriptorToXML(updatedDescriptor));
    ...
    private WorkflowDescriptor copyAndUpdateWorkflowDescriptorMetaAttributes(WorkflowDescriptor parentWorkflow, String authorName) throws FactoryException
    {
        ...
        workflowDescriptor.getMetaAttributes().put(JiraWorkflow.JIRA_META_UPDATE_AUTHOR_NAME, authorName);
