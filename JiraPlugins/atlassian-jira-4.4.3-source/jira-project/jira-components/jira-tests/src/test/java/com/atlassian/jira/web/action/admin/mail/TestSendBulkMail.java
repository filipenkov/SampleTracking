...
public class TestSendBulkMail extends AbstractUsersIndexingTestCase
{
    ...
    public void testIsHasMailServerNoMailServer() throws Exception
    {
        ...
        sbm = new SendBulkMail((MailServerManager) mockMailServerManager.proxy(), null, null, null, userUtil);
        assertFalse(sbm.isHasMailServer());
        mockMailServerManager.verify();
    }

    public void testIsHasMailServerExceptionThrown() throws Exception
    {
        Mock mockMailServerManager = new Mock(MailServerManager.class);
        mockMailServerManager.setStrict(true);
        mockMailServerManager.expectAndThrow("getDefaultSMTPMailServer", new MailException("Test Mail Exception."));

        sbm = new SendBulkMail((MailServerManager) mockMailServerManager.proxy(), null, null, null, userUtil);
        assertFalse(sbm.isHasMailServer());
        checkSingleElementCollection(sbm.getErrorMessages(), "Error occurred while retrieving mail server information. Please refer to log for more details.");
        mockMailServerManager.verify();
    }
    ...
    public void testGetGroupsFieldSize()
    {
        // No need to pass a MailServerManager
        sbm = new SendBulkMail(null, null, null, null, userUtil);

        for (int i = 1; i <= SendBulkMail.MAX_MULTISELECT_SIZE - 1; i++)
        {
            UtilsForTests.getTestGroup("Test Group " + i);
            //due to the optgroup title in the select element, size = groupcount + 1
            assertEquals(i, sbm.getGroupsFieldSize() - 1);
        }

        UtilsForTests.getTestGroup("Test Group " + SendBulkMail.MAX_MULTISELECT_SIZE);
    ...
    public void testGetProjectsRolesFieldSize()
    {
        ...
        sbm = new SendBulkMail(null, mockPermissionManager, mockProjectRoleService, null, userUtil);
    ...
    public void testDoValidationExceptionRetrievingMailServer() throws Exception
    {
        Mock mockMailServerManager = new Mock(MailServerManager.class);
        mockMailServerManager.setStrict(true);
        mockMailServerManager.expectAndThrow("getDefaultSMTPMailServer", new MailException("Test Mail Exception."));
    ...
    {
        // Setup a group
        final Group testGroup = UtilsForTests.getTestGroup("test group");
    ...
    public void testDoValidationChosenProjectRoleHasNoMembers() throws Exception
    {
        ...
        sbm = new SendBulkMail((MailServerManager) mockMailServerManager.proxy(), null, mockProjectRoleService, mockProjectManager, userUtil);
    ...
    public void testDoValidationInvalidReplyToEmailFormat() throws Exception
    {
        // Setup a group
        final Group testGroup = UtilsForTests.getTestGroup("test group");
        final User testUser = UtilsForTests.getTestUser("Test User 1");
    ...
    public void testGetUsersUsingProjectRoles() throws Exception
    {
        ...
        final User testAdminUser = UtilsForTests.getTestUser("Test Admin User");
        ...
        User user1 = UtilsForTests.getTestUser("Test User 1");
        User user2 = UtilsForTests.getTestUser("Test User 2");
        User user3 = UtilsForTests.getTestUser("Test User 3");
        ...
        sbm = new SendBulkMail((MailServerManager) mockMailServerManager.proxy(), null, mockProjectRoleService, new MockProjectManager(), userUtil);
    ...
    public void testGetUsersUsingGroups() throws Exception
    {
        ...
        // Setup a group
        final Group testGroup1 = UtilsForTests.getTestGroup("test group 1");
        final Group testGroup2 = UtilsForTests.getTestGroup("test group 2");
        final Group testGroup3 = UtilsForTests.getTestGroup("test group 3");

        // Setup users
        final User testUser1 = UtilsForTests.getTestUser("Test User 1");
        final String testEmail1 = "email1@email.com";
        testUser1.setEmail(testEmail1);

        final User testUser2 = UtilsForTests.getTestUser("Test User 2");
        final String testEmail2 = "email2@email.com";
        testUser2.setEmail(testEmail2);

        final User testUser3 = UtilsForTests.getTestUser("Test User 3");
        final String testEmail3 = "email3@email.com";
        testUser3.setEmail(testEmail3);

        final User testUser4 = UtilsForTests.getTestUser("Test User 4");
        final String testEmail4 = "email4@email.com";
        testUser4.setEmail(testEmail4);

        // Add users to groups
        testGroup1.addUser(testUser1);
        testGroup1.addUser(testUser2);
        testGroup2.addUser(testUser2);
        testGroup2.addUser(testUser3);
        testGroup3.addUser(testUser4);
    ...
    {
        // Setup a group
        testGroup1 = UtilsForTests.getTestGroup("test group 1");
        testGroup2 = UtilsForTests.getTestGroup("test group 2");
        testGroup3 = UtilsForTests.getTestGroup("test group 3");
    ...
    private Email setupEmail(String expectedToList, User testAdminUser)
    {
        ...
        email.setFrom(testAdminUser.getEmail());
    ...
    public void testDoExecuteByBatch() throws Exception
    {
        ...
        testAdminUser.setEmail("admin@email.com");
        JiraTestUtil.loginUser(testAdminUser);
PropertiesManager.getInstance().getPropertySet()
