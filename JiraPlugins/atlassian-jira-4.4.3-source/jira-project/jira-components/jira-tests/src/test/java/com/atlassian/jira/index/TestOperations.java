...
public class TestOperations extends ListeningTestCase
{
    @Test
    ...
    {
        final Collection<Document> documents = EasyList.build(new Document(), new Document());
    ...
    public void testUpdate() throws Exception
    {
        ...
        create.perform(new MockWriter()
        {
            ...
            {
                assertSame(term, t);
                assertEquals(EasyList.build(document), d);
            }
        });
    }
