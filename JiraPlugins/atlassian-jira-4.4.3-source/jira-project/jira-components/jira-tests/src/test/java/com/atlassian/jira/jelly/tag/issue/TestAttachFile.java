...
public class TestAttachFile extends AbstractJellyTestCase
{
    ...
    protected void setUp() throws Exception
    {
        ...
        GenericValue project = UtilsForTests.getTestEntity("Project", EasyMap.build("name", "Project", "id", new Long(1), "key", "TST"));
        issue = UtilsForTests.getTestEntity("Issue", EasyMap.build("summary", "A summary", "project", project.getLong("id"), "key", "TST-1"));
    ...
    private void assertAndAttachFile(String option, String expectedCreated, String created, int expectedNumOfAttachments) throws JellyServiceException
    {
        ...
        assertNull(attachedFile.getAuthor());
        if (expectedCreated != null)
        {
        ...
        assertEquals(issue, attachedFile.getIssue());
    ...
    {
        StringBuffer script = new StringBuffer("<jira:AttachFile");
        if (issueKey != null)
        {
