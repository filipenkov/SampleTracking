...
{
    private DefaultSubTaskManager ditm;
    ...
    protected void setUp() throws Exception
    {
        ...
        applicationProperties = ManagerFactory.getApplicationProperties();
    ...
    public void testCreateSubTaskIssueType() throws CreateException
    {
        ...
        ditm.createSubTaskIssueType(name, sequence, description, iconurl);
        verifyMocks();
    }
    ...
    public void testUpdateSubTaskIssueType() throws StoreException
    {
        ...
        ditm.updateSubTaskIssueType(id, name, sequence, description, iconurl);
        verifyMocks();
    }
    ...
    public void testRemoveSubTaskIssueTypeDoesNotExist()
    {
        ...
        try
        {
            ditm.removeSubTaskIssueType(name);
    ...
    public void testEnableSubTasks() throws CreateException, GenericEntityException, StoreException
    {
        ...
        ditm = getDefaultSubTaskManager(mockApplicationProperties);
    ...
    public void testIssueTypeExistsById()
    {
        ...
        assertTrue(ditm.issueTypeExistsById(id));
        verifyMocks();

        mockConstantsManager.expectAndReturn("getIssueType", P.args(new IsEqual(id)), null);
        ditm = getDefaultSubTaskManager();
        assertFalse(ditm.issueTypeExistsById(id));
        verifyMocks();
    }
    ...
    public void testIssueTypeExistsByName()
    {
        ...
        mockConstantsManager.expectAndReturn("constantExists", P.args(new IsEqual("IssueType"), new IsEqual(name)), Boolean.FALSE);
        assertFalse(ditm.issueTypeExistsByName(name));
        verifyMocks();

        mockConstantsManager.expectAndReturn("constantExists", P.args(new IsEqual("IssueType"), new IsEqual(name)), Boolean.TRUE);
        ditm = getDefaultSubTaskManager();
        assertTrue(ditm.issueTypeExistsByName(name));
        verifyMocks();
    }
    ...
    public void testMoveSubTaskIssueTypeUpNullId() throws StoreException
    {
        try
        {
            ditm.moveSubTaskIssueTypeUp(null);
            fail("IllegalArgumentException should have been thrown.");
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void testMoveSubTaskIssueTypeUp() throws StoreException
    {
        ...
        ditm.moveSubTaskIssueTypeUp(id);
    ...
    public void testMoveSubTaskIssueTypeDownNullId() throws StoreException
    {
        try
        {
            ditm.moveSubTaskIssueTypeDown(null);
            fail("IllegalArgumentException should have been thrown.");
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void testMoveSubTaskIssueTypeDown() throws StoreException
    {
        ...
        ditm.moveSubTaskIssueTypeDown(id);
    ...
    public void testGetSubTaskIssueTypeByIdNullId()
    {
        try
        {
            ditm.getSubTaskIssueTypeById(null);
    ...
    public void testGetSubTaskIssueTypeByIdIssueTypeDoesNotExist()
    {
        final String id = "1";
        mockConstantsManager.expectAndReturn("getIssueType", P.args(new IsEqual(id)), null);
        final GenericValue subTaskIssueType = ditm.getSubTaskIssueTypeById(id);
    ...
    public void testGetSubTaskIssueTypeByIdIssueTypeIsNotSubTaskIssueType()
    {
        ...
        try
        {
            ...
            ditm.getSubTaskIssueTypeById(id);
            fail("IllegalArgumentException should have been thrown.");
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void testGetSubTaskIssueTypeById()
    {
        ...
        mockConstantsManager.expectAndReturn("getIssueType", P.args(new IsEqual(id)), issueTypeGV);
        final GenericValue subTaskIssueTypeGV = ditm.getSubTaskIssueTypeById(id);
    ...
    public void testGetSubTaskIssueTypes()
    {
        ...
        mockConstantsManager.expectAndReturn("getSubTaskIssueTypes", expected);
        assertEquals(expected, ditm.getSubTasksIssueTypes());
        verifyMocks();
    }
    ...
    public void testIsSubtask()
    {
        ...
        assertFalse(ditm.isSubTask(issue));
        verifyMocks();
        ...
        mockIssueLinkTypeManager.expectAndReturn("getIssueLinkType", P.args(new IsEqual(issueLinkTypeGV.getLong("id"))), new IssueLinkType(issueLinkTypeGV));
        ...
        mockIssueLinkManager.expectAndReturn("getInwardLinks", P.args(new IsEqual(issue.getLong("id"))), EasyList.build(new IssueLink(issueLinkGV, (IssueLinkTypeManager) mockIssueLinkTypeManager.proxy(), null)));
        ditm = getDefaultSubTaskManager();
        assertTrue(ditm.isSubTask(issue));
        verifyMocks();
    }

    public void testIsSubTaskIssueType()
    {
        assertFalse(ditm.isSubTaskIssueType(new MockGenericValue("IssueType")));
        assertFalse(ditm.isSubTaskIssueType(new MockGenericValue("IssueType", UtilMisc.toMap("description", "no style"))));
        assertFalse(ditm.isSubTaskIssueType(new MockGenericValue("IssueType", UtilMisc.toMap("style", null))));
        assertFalse(ditm.isSubTaskIssueType(new MockGenericValue("IssueType", UtilMisc.toMap("style", ""))));
        assertFalse(ditm.isSubTaskIssueType(new MockGenericValue("IssueType", UtilMisc.toMap("style", "invalid"))));

        assertTrue(ditm.isSubTaskIssueType(new MockGenericValue("IssueType", UtilMisc.toMap("style", SubTaskManager.SUB_TASK_ISSUE_TYPE_STYLE))));
    }

    public void testGetParentIssueIdNoParrent()
    {
        mockIssueLinkManager.expectAndReturn("getInwardLinks", P.args(new IsEqual(issue.getLong("id"))), Collections.EMPTY_LIST);
        assertNull(ditm.getParentIssueId(issue));
        verifyMocks();
    }
    ...
    public void testGetParentIssue()
    {
        ...
        mockIssueLinkManager.expectAndReturn("getInwardLinks", P.args(new IsEqual(issue.getLong("id"))), EasyList.build(new IssueLink(issueLinkGV, (IssueLinkTypeManager) mockIssueLinkTypeManager.proxy(), null)));
        assertEquals(parentIssueId, ditm.getParentIssueId(issue));
        verifyMocks();
    }
    ...
    public void testGetSubTaskBean()
    {
        ...
        final SubTaskBean subTaskBean = ditm.getSubTaskBean(issue, null);
    ...
    private List setupSubTasks(final GenericValue issue)
    {
        ...
        final List issueLinks = EasyList.build(new IssueLink(issueLinkGV1, (IssueLinkTypeManager) mockIssueLinkTypeManager.proxy(), mockIssueManager), new IssueLink(issueLinkGV2, (IssueLinkTypeManager) mockIssueLinkTypeManager.proxy(), mockIssueManager));
    ...
    public void testMoveSubTask()
    {
        ...
        ditm.moveSubTask(issue, currentSequence, sequence);
    ...
    public void testCreateSubTaskIssueLinkWithNulls() throws CreateException
    {
        try
        {
            ditm.createSubTaskIssueLink((GenericValue) null, null, null);
            fail("IllegalArgumentException should have been thrown.");
        }
        catch (IllegalArgumentException e)
        {
        ...
        try
        {
            ditm.createSubTaskIssueLink(issue, null, null);
            fail("IllegalArgumentException should have been thrown.");
        }
        catch (IllegalArgumentException e)
        {
    ...
    public void testCreateSubTaskIssueLinkException()
    {
        ...
        mockIssueLinkTypeManager.expectAndReturn("getIssueLinkTypesByStyle", P.args(new IsEqual(SubTaskManager.SUB_TASK_LINK_TYPE_STYLE)), EasyList.build(new IssueLinkType(issueLinkTypeGV)));
        ...
        try
        {
            ditm.createSubTaskIssueLink(issue, subTaskIssue, testUser);
    ...
    public void testCreateSubTaskIssueLinkFirstSubTaskLink() throws CreateException
    {
        final GenericValue subTaskIssue = UtilsForTests.getTestEntity("Issue", EasyMap.build("summary", "sub task test issue"));
    ...
    public void testCreateSubTaskIssueLink() throws CreateException
    {
        final GenericValue subTaskIssue = UtilsForTests.getTestEntity("Issue", EasyMap.build("summary", "sub task test issue"));
    ...
    public void testGetAllSubTaskIssueIds()
    {
        ...
        final IssueLinkType issueLinkType = new IssueLinkType(issueLinkTypeGV);
        ...
        final Collection result = ditm.getAllSubTaskIssueIds();
