 ...
 * @since v4.0
 */
public class TestJqlStringSupportImpl extends ListeningTestCase
{
    @Test
    ...
    public void testIsReservedString() throws Exception
    {
        ...
        builder.addAll("audit", "avg", "before", "begin", "between", "boolean", "break", "by", "byte", "catch", "cf");
        ...
        builder.addAll("uid", "union", "unique", "update", "user", "validate", "values", "view", "when", "whenever", "where");
