...
public class TestLoginManagerImpl extends MockControllerTestCase
{
    ...
    com.atlassian.crowd.embedded.api.User fred;
    ...
    {
        fred = new User("fred", new MockProviderAccessor(), new MockCrowdService());
    ...
    {
        expect(permissionManager.hasPermission(Permissions.ADMINISTER, fred)).andReturn(false);
        ...
        assertFalse(loginManager.authorise(fred, httpServletRequest));
    }
    ...
    public void testAuthoriseLogin_OK()
    {
        ...
        final LoginManagerImpl loginManager = instantiate(LoginManagerImpl.class);
        assertTrue(loginManager.authorise(fred, httpServletRequest));
    }

    @Test
    public void testAuthoriseLogin_OK_admin()
    {
        expect(permissionManager.hasPermission(Permissions.ADMINISTER, fred)).andReturn(true);
    ...
    public void testLogout() throws AuthenticatorException
    {
        ...
        expect(jiraAuthenticationContext.getUser()).andStubReturn(OSUserConverter.convertToOSUser(fred));
