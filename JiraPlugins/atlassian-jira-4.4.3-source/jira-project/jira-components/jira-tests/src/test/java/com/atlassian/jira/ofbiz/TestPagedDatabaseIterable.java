...
{
    private static final List<Long> IDS_123 = EasyList.build(new Long(1), new Long(2), new Long(3));
    ...
    {
        final List<Long> idList = EasyList.build(new Long(5), new Long(1), new Long(2), new Long(4), new Long(3));
        final List<Long> expectedList = EasyList.build(new Long(2), new Long(5), new Long(1), new Long(3), new Long(4));
    ...
    public void testWithSorting()
    {
        ...
        final List<Long> dbIterList = EasyList.build(new Long(1), new Long(2), new Long(3), new Long(4), new Long(5));
