...
public class TestIndexPathPropertiesAdaptor extends ListeningTestCase
{
    ...
    public void testIndexRootPath()
    {
        ...
        assertEquals(new File("/jira-home/caches/indexes").getAbsolutePath(), indexPathManager.getIndexRootPath());
    }
