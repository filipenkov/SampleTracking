 ...
 * @since v4.0
 */
public class TestDefaultJqlOperandResolver extends MockControllerTestCase
{
    ...
    {
        final JqlFunctionHandlerRegistry functionRegistry = mockController.getMock(JqlFunctionHandlerRegistry.class);
        mockController.replay();

        try
        {
            new DefaultJqlOperandResolver(null, new NoopI18nFactory());
        ...
        try
        {
            new DefaultJqlOperandResolver(functionRegistry, null);
    ...
    public void testGetValuesEmptyOperand() throws Exception
    {
        ...
        final OperandHandler<EmptyOperand> emptyHandler = mockController.getMock(OperandHandler.class);
        emptyHandler.getValues(queryCreationContext, EmptyOperand.EMPTY, clause);
        mockController.setReturnValue(expectedValues);
        mockController.replay();
    ...
    public void testGetValuesSingleValueOperand() throws Exception
    {
        ...
        final OperandHandler<SingleValueOperand> singleHandler = mockController.getMock(OperandHandler.class);
        singleHandler.getValues(queryCreationContext, operand, clause);
        mockController.setReturnValue(expectedValues);
        mockController.replay();
    ...
    public void testGetValuesMultiValueOperand() throws Exception
    {
        ...
        final OperandHandler<MultiValueOperand> multiHandler = mockController.getMock(OperandHandler.class);
        multiHandler.getValues(queryCreationContext, operand, clause);
        mockController.setReturnValue(expectedValues);
        mockController.replay();
    ...
    public void testGetValuesRegisteredFunction() throws Exception
    {
        ...
        final OperandHandler<FunctionOperand> funcHandler = mockController.getMock(FunctionOperandHandler.class);
        funcHandler.getValues(queryCreationContext, operand, clause);
        mockController.setReturnValue(expectedValues);

        final JqlFunctionHandlerRegistry registry = mockController.getMock(JqlFunctionHandlerRegistry.class);
        registry.getOperandHandler(operand);
        mockController.setReturnValue(funcHandler);
        mockController.replay();
    ...
    public void testValidateEmptyOperand() throws Exception
    {
        ...
        emptyHandler.validate(null, EmptyOperand.EMPTY, clause);
    ...
    public void testValidateSingleValueOperand() throws Exception
    {
        ...
        final OperandHandler<SingleValueOperand> singleHandler = mockController.getMock(OperandHandler.class);
        singleHandler.validate(null, operand, clause);
        mockController.setReturnValue(expectedResult);
        mockController.replay();
    ...
    public void testValidateMultiValueOperand() throws Exception
    {
        ...
        final OperandHandler<MultiValueOperand> multiHandler = mockController.getMock(OperandHandler.class);
        multiHandler.validate(null, operand, clause);
        mockController.setReturnValue(expectedResult);
        mockController.replay();
    ...
    public void testValidateRegisteredFunction() throws Exception
    {
        ...
        final OperandHandler<FunctionOperand> funcHandler = mockController.getMock(FunctionOperandHandler.class);
        funcHandler.validate(null, operand, clause);
        mockController.setReturnValue(expectedResult);
    ...
    public void testGetSingleValueMultiReturned()
    {
        ...
        final JqlFunctionHandlerRegistry functionRegistry = mockController.getMock(JqlFunctionHandlerRegistry.class);
        functionRegistry.getOperandHandler(operand);
        mockController.setReturnValue(new MockFunctionOperandHandler(10L, 20L));
        mockController.replay();
    ...
    public void testGetSingleValueHappy()
    {
        ...
        final JqlFunctionHandlerRegistry functionRegistry = mockController.getMock(JqlFunctionHandlerRegistry.class);
        functionRegistry.getOperandHandler(operand);
        mockController.setReturnValue(new MockFunctionOperandHandler(expectedValue));
        mockController.replay();
    ...
    public void testIsFunction() throws Exception
    {
        ...
        final OperandHandler<FunctionOperand> funcHandler = mockController.getMock(FunctionOperandHandler.class);
        funcHandler.isFunction();
        mockController.setReturnValue(true);

        final JqlFunctionHandlerRegistry functionRegistry = mockController.getMock(JqlFunctionHandlerRegistry.class);
        functionRegistry.getOperandHandler(knownFunc);
        mockController.setReturnValue(funcHandler);
        functionRegistry.getOperandHandler(unknownFunc);
        mockController.setReturnValue(null);
    ...
    public void testSanitiseFuncOperandNotSanitiseAware() throws Exception
    {
        ...
        final JqlFunction function = mockController.getMock(JqlFunction.class);
        final FunctionOperandHandler funcHandler = new FunctionOperandHandler(function);
    ...
    public void testSanitiseFuncOperandSanitiseAware() throws Exception
    {
        ...
        final JqlFunctionHandlerRegistry registry = mockController.getMock(JqlFunctionHandlerRegistry.class);
        registry.getOperandHandler(inputOperand);
        mockController.setReturnValue(funcHandler);
        mockController.replay();
    ...
    private DefaultJqlOperandResolver createResolver(JqlFunctionHandlerRegistry functionRegistry, OperandHandler<EmptyOperand> emptyHandler, OperandHandler<SingleValueOperand> singleHandler, OperandHandler<MultiValueOperand> multiHandler)
    {
        ...
        return new DefaultJqlOperandResolver(functionRegistry, new NoopI18nFactory(), emptyHandler, singleHandler, multiHandler);
    }
