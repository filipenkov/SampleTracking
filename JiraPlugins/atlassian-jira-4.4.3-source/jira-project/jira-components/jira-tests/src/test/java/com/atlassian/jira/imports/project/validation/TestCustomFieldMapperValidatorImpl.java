 ...
 * @since v3.13
 */
public class TestCustomFieldMapperValidatorImpl extends ListeningTestCase
{
    @Test
    ...
    public void testCustomFieldIsValidForRequiredContexts_InvalidContext()
    {
        ...
        final CustomField newCustomField = new CustomFieldImpl(new MockGenericValue("CustomField"), null, null, null, null, null, null, null)
        {
    ...
    {
        return new CustomFieldImpl(new MockGenericValue("CustomField", EasyMap.build("id", new Long(id), "name", name)), null, null, null, null, null, null, null)
        {
