...
public class TestComponentValuesExistValidator extends MockControllerTestCase
{
    ...
    public void testLongValueExist() throws Exception
    {
        ...
        ComponentValuesExistValidator validator = new ComponentValuesExistValidator(operandResolver, indexInfoResolver, permissionManager, componentManager, projectManager)
        {
            @Override
