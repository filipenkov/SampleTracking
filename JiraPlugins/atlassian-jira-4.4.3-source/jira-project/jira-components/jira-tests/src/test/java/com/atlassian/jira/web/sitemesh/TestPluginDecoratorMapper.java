...
public class TestPluginDecoratorMapper extends ListeningTestCase
{
    ...
    public void setUp() throws Exception
    {
        ...
        mockMapperDescriptor = new DecoratorMapperModuleDescriptor()
        {
    ...
    {
        setupPluginAccessorExpectation(DecoratorMapperModuleDescriptor.class, EasyList.build(new DecoratorMapperModuleDescriptor()
        {
            public DecoratorMapper getDecoratorMapper(Config config, DecoratorMapper parent)
            {
                return null;
    ...
    {
        return new DecoratorModuleDescriptor()
        {
