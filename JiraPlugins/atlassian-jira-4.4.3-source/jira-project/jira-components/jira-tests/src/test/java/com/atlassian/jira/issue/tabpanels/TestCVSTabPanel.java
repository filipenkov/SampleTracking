...
import com.atlassian.jira.issue.tabpanels.CVSTabPanel;
...
public class TestCVSTabPanel extends AbstractUsersTestCase
{
    ...
    public void testGetCommitsNullIssue() throws ImmutableException, DuplicateEntityException, GenericEntityException, RepositoryException
    {
        try
        {
