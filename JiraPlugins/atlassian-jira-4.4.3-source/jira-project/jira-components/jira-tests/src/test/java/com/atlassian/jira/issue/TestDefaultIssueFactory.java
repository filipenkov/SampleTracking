...
public class TestDefaultIssueFactory extends ListeningTestCase
{
    @Test
    public void testCopyHasSameParentAsOriginal() throws Exception
    {
        ...
        DefaultIssueFactory factory = new DefaultIssueFactory(null, null, null, null, null, null, null, null, null, null, projectComponentManager, null, null);
