...
/**
 */
public class TestAverageAgeChartPortlet extends AbstractChartPortletTest
{
    ...
    public void testGetVelocityParams() throws Exception
    {
        ...
        mockChartFactory.generateAverageAgeChart(context, 30, ChartFactory.PeriodName.daily);
        mockController.setReturnValue(new Chart(null, null, null, EasyMap.build("chart", new Object())));

        mockController.replay();

        final AverageAgeChartPortlet portlet = new AverageAgeChartPortlet(jiraAuthenticationContext,
