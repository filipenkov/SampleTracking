 ...
 */
public class TestJiraSortComparatorSource extends ListeningTestCase
{
    ...
    public void setUp() throws Exception
    {
        ...
        indexWriter = new IndexWriter(directory, new WhitespaceAnalyzer(), true);
    ...
    private void setupDataItems(IndexWriter indexWriter, String issueKey, String dueDateValue, String summaryValue) throws IOException
    {
        ...
        doc.add(new Field("issuetype", "bug", Field.Store.YES, Field.Index.UN_TOKENIZED));
        doc.add(new Field("key", issueKey, Field.Store.YES, Field.Index.UN_TOKENIZED));
        doc.add(new Field("duedate", dueDateValue, Field.Store.YES, Field.Index.UN_TOKENIZED));
        doc.add(new Field("summary", summaryValue, Field.Store.YES, Field.Index.UN_TOKENIZED));
    ...
    public void testValueRetrieval() throws IOException
    {
        ...
        assertEquals(MAX_DOCS, hits.length());
