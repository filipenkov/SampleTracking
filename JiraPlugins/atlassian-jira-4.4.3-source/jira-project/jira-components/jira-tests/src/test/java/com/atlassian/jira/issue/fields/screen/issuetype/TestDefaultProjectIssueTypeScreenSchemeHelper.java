...
public class TestDefaultProjectIssueTypeScreenSchemeHelper
{
    ...
    public void testGetActiveFieldScreenSchemesWithValidServiceResult()
    {
        ...
        EasyMock.expect(issueTypeScreenSchemeManager.getIssueTypeScreenScheme(EasyMock.eq(projectGV)))
        ...
        EasyMock.expect(issueTypeScreenSchemeManager.getIssueTypeScreenScheme(EasyMock.eq(unrelatedProjectGV)))
