...
public class UtilsForTestSetup
{
    ...
    {
        log.error("_______ Legacy Test setup invoked - Today JDBC, Tomorrow the World!");
        setupJiraHome();
        ...
        log.error("_______ Legacy Test Setup completed in " + (System.currentTimeMillis() - then) + " ms. db=" + (dbTime-then) + "ms, pico="+ (picoTime-dbTime) + "ms" );
