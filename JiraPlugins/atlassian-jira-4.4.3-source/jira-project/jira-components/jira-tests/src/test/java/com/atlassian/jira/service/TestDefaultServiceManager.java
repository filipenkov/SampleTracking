...
public class TestDefaultServiceManager extends LegacyJiraMockTestCase
{
    ...
    public void testAddService() throws Exception
    {
        ...
        DefaultServiceManager dsm = new DefaultServiceManager(serviceConfigStore, new MockComponentClassManager(), null, null, null);
    ...
    {
        DefaultServiceManager dsm = new DefaultServiceManager(ComponentManager.getComponentInstanceOfType(ServiceConfigStore.class), null, null, null, null);
        final String name = "test service";
    ...
    public void testAnonymousUsersShouldNotBeAbleToManageAnyService() throws Exception
    {
        ...
        DefaultServiceManager serviceManager =
                new DefaultServiceManager(serviceConfigStore, new MockComponentClassManager(), null, null, null);
    ...
    public void testSystemAdminUsersShouldBeAbleToManageAllServices() throws Exception
    {
        ...
        DefaultServiceManager serviceManager =
                new DefaultServiceManager(serviceConfigStore, new MockComponentClassManager(), null, mockPermissionManager, null);
    ...
    public void testAdminUsersShouldBeAbleToManageOnlyPopAndImapServices() throws Exception
    {
        final List<JiraServiceContainer> expectedServiceConfigsForAnAdminUser =
                ImmutableList.<JiraServiceContainer>of(
                        new MockJiraServiceContainer.Builder().id(1).serviceClass("com.atlassian.jira.service.services.imap.ImapService").build(),
                        new MockJiraServiceContainer.Builder().id(2).serviceClass("com.atlassian.jira.service.services.pop.PopService").build(),
                        new MockJiraServiceContainer.Builder().id(5).serviceClass("com.atlassian.jira.service.services.pop.PopService").build()
                );
        ...
        DefaultServiceManager serviceManager =
                new DefaultServiceManager(serviceConfigStore, new MockComponentClassManager(), null, mockPermissionManager, new DefaultInBuiltServiceTypes(mockPermissionManager));
