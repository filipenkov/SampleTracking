...
public class TestIssueNavigator extends AbstractUsersTestCase
{
    ...
    protected void setUp() throws Exception
    {
        ...
        EasyMock.replay(sessionSearchObjectManagerFactory, sessionSearchRequestManager, sessionNextPreviousPagerManager, sessionPagerFilterManager, sessionSelectedIssueManager);
        
        oldFieldManager = ManagerFactory.getFieldManager();
...
//        ManagerFactory.addService(IssueIndexManager.class, new MemoryIndexManager());
        ...
        final User u1 = UserManager.getInstance().createUser("Test User 1");
        UserManager.getInstance().createUser("Test Reporter 1");
        UserManager.getInstance().createUser("Test Assignee 1");

        final Group g1 = UserManager.getInstance().createGroup("Test Group");
        u1.addToGroup(g1);
...
//        ManagerFactory.removeService(IssueIndexManager.class);
    ...
    {
        final User u = UserManager.getInstance().getUser("Test User 1");
    ...
    private IssueNavigator getIsseueNavigator()
    {
        ...
        return new IssueNavigator(ComponentManager.getComponentInstanceOfType(SearchProvider.class),
            ManagerFactory.getFieldManager().getColumnLayoutManager(), ComponentManager.getComponentInstanceOfType(IssueSearcherManager.class),
            ComponentManager.getInstance().getSearchRequestFactory(), ComponentManager.getInstance().getSearchRequestService(), null, null, null, new PagerManager(null, sessionSearchObjectManagerFactory), searchService, ComponentManager.getComponentInstanceOfType(ApplicationProperties.class), new MockIndexLifecycleManager(), null, null, null, null, null, null);
    }
    ...
    public void testIsShowConfigureUserColumnLayoutNoColumnLayout() throws ColumnLayoutStorageException, EntityNotFoundException
    {
        // Create search request
    ...
    public void testIsShowConfigureUserColumnLayoutColumnLayout() throws ColumnLayoutStorageException, EntityNotFoundException
    {
        // Create search request
        final SearchRequest sr = setupSearchRequest();
    ...
    public void testIsShowConfigureUserColumnLayoutOverriddenColumnLayout() throws ColumnLayoutStorageException, EntityNotFoundException
    {
        // Create search request
        final SearchRequest sr = setupSearchRequest();
    ...
    public void testIsShowConfigureUserColumnLayoutOverriddenNoColumnLayout() throws ColumnLayoutStorageException, EntityNotFoundException
    {
        // Create search request
        final SearchRequest sr = setupSearchRequest();
    ...
    private SearchRequest setupSearchRequest() throws EntityNotFoundException
    {
        final User u = UserManager.getInstance().getUser("Test User 1");
    ...
    {
        IssueNavigator in = new IssueNavigator(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
