...
public class TestFieldConfigSchemeClauseContextUtil extends MockControllerTestCase
{
    ...
    public void testAddProjectIssueTypeContextsForProjectsOneProjectAllIssueTypesOtherConstrained() throws Exception
    {
        ...
        final MockGenericValue issueTypeGv1 = new MockGenericValue("blah", MapBuilder.newBuilder().add("id", "it1").toMap());
    ...
    public void testGetClauseContextForFieldContextGlobalProjectSpecifiedIssueTypeConfiguration() throws Exception
    {
        ...
        final MockGenericValue type1 = new MockGenericValue("issuetype", MapBuilder.newBuilder().add("id", "it1").toMap());
        final MockGenericValue type2 = new MockGenericValue("issuetype", MapBuilder.newBuilder().add("id", "it2").toMap());
    ...
    public void testGetClauseContextForFieldContextSpecifiedProjectSpecifiedIssueTypeConfiguration() throws Exception
    {
        ...
        fieldConfigScheme.getAssociatedProjects();
        mockController.setReturnValue(null);
        projectFactory.getProjects(Collections.<GenericValue>emptyList());
        mockController.setReturnValue(CollectionBuilder.<Project>newBuilder(mockProject1).asList());

        mockController.replay();

        final Set<ProjectIssueTypeContext> expectedContextSet = CollectionBuilder.<ProjectIssueTypeContext>newBuilder(new ProjectIssueTypeContextImpl(new ProjectContextImpl(mockProject1.getId()), new IssueTypeContextImpl("it1"))).asSet();
    ...
    public void testGetIssueTypeIdsForScheme() throws Exception
    {
        ...
        mockController.setReturnValue(CollectionBuilder.newBuilder(
                new MockGenericValue("IssueType", MapBuilder.newBuilder().add("id", "1").toMap()),
                new MockGenericValue("IssueType", MapBuilder.newBuilder().add("id", "2").toMap())
        ).asSet());
    ...
    {
        final FieldConfigScheme configScheme = mockController.getMock(FieldConfigScheme.class);
        final List<GenericValue> mockGVs = CollectionBuilder.<GenericValue>newBuilder(
                new MockGenericValue("Project", MapBuilder.newBuilder().add("id", "1").toMap()),
                new MockGenericValue("Project", MapBuilder.newBuilder().add("id", "2").toMap())
        ).asList();

        Project proj1 = new MockProject(1);
        Project proj2 = new MockProject(2);

        configScheme.getAssociatedProjects();
        mockController.setReturnValue(mockGVs);

        projectFactory.getProjects(mockGVs);
        mockController.setReturnValue(CollectionBuilder.newBuilder(proj1, proj2).asList());
