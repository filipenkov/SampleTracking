...
public class TestDefaultIssueConversionService extends ListeningTestCase
{
    ...
    public void testIsShouldCheckFieldValueNonCustomField()
    {
        ...
        JiraServiceContext context = new JiraServiceContextImpl(bob);
        assertTrue(service.isShouldCheckFieldValue(context, mockIssue, (CustomField) customFieldControl.proxy()));
    }
    ...
    public void testIsShouldCheckFieldValueFalse()
    {
        ...
        JiraServiceContext context = new JiraServiceContextImpl(bob);
        assertFalse(service.isShouldCheckFieldValue(context, mockIssue, (CustomField) customFieldControl.proxy()));
    }
