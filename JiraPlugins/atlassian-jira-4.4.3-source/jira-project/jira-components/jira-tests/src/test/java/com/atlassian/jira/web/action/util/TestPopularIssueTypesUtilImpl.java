...
public class TestPopularIssueTypesUtilImpl extends MockControllerTestCase
{
    ...
    public void testNoPopularTypesForUserButEnoughFromProject() throws Exception
    {
        ...
        TranslationManager translationManager = mockController.getMock(TranslationManager.class);
        JiraAuthenticationContext authenticationContext = mockController.getMock(JiraAuthenticationContext.class);
        mockController.replay();

        PopularIssueTypesUtilImpl util = new PopularIssueTypesUtilImpl(issueTypeSchemeManager, translationManager, authenticationContext)
        {
