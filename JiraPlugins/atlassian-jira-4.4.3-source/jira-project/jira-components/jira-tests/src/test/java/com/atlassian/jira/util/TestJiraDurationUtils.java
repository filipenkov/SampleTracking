...
public class TestJiraDurationUtils extends ListeningTestCase
{
    @Test
    ...
    public void testJiraDurationUtilsPretty()
    {
        ...
        JiraDurationUtils jdu = new JiraDurationUtils(ap, (JiraAuthenticationContext) ac.proxy(), timeTrackingConfiguration, null, new MockI18nBean.MockI18nBeanFactory());
