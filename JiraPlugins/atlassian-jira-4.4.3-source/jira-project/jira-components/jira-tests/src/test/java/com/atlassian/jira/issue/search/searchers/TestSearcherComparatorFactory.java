...
public class TestSearcherComparatorFactory extends MockControllerTestCase
{
    ...
    public void testCompareAndSort()
    {
        ...
        FixForVersionsSearcher fixForVersionsSearcher = new FixForVersionsSearcher(versionResolver, mockJqlOperandResolver, fieldFlagOperandRegistry, null, null, null, null, null, null);
