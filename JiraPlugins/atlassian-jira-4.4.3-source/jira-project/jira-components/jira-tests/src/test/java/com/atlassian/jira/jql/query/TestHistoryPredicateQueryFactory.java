...
public class TestHistoryPredicateQueryFactory
{
    ...
    public void testNullTerminalHistoryPredicate()
    {
        ...
        expect(mockPredicateOperandResolver.getValues(mockSearcher, null)).andStubReturn(null);
        replayMocks();
     ...
     private void setupTerminalPredicate()
    {
        ...
        expect(mockPredicateOperandResolver.getValues(mockSearcher, operand)).andStubReturn(Lists.newArrayList(new QueryLiteral(operand, now.getTime())));
