...
/** @since v3.13 */
public class TestReIndexAsyncIndexerCommand extends ListeningTestCase
{
    ...
    public void testReindexOK() throws Exception
    {
        ...
        final ReIndexAsyncIndexerCommand reIndexAsyncIndexerCommand = new ReIndexAsyncIndexerCommand(null, mockIssueIndexManager, log, i18nHelper);
    ...
    @Test
    public void testActivateCommandWithErrors() throws Exception
    {
        final Logger log = new QuietLogger(getClass().getName());
        final MockI18nBean i18nHelper = new MockI18nBean();
        final AtomicReference<Context> eventRef = new AtomicReference<Context>();
        ...
        {
            @SuppressWarnings("unused")
            public long reIndexAll(final Context event) throws IndexException
            {
                eventRef.set(event);
                throw new IndexException(TEST_MESSAGE);
            }
        ...
        errorCollection.addErrorMessage(TEST_MESSAGE);
