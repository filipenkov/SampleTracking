 ...
 * @since v3.13
 */
public class TestGroupShareTypeValidator extends ListeningTestCase
{
    ...
    public void setUp() throws Exception
    {
        ...
        group = new Group("test", mpa);
        notInGroup = new Group("NicksCoolGroup", mpa);
    ...
    {
        permissionMgr.hasPermission(Permissions.CREATE_SHARED_OBJECTS, ctx.getUser());
