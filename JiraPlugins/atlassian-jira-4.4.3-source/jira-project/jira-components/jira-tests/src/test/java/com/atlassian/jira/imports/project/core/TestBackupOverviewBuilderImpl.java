 ...
 * @since v3.13
 */
public class TestBackupOverviewBuilderImpl extends ListeningTestCase
{
    ...
    public void testBuildingBackupProjects()
    {
        ...
        ExternalIssue issue1 = new ExternalIssueImpl();
        issue1.setId(issueId1);
        issue1.setProject("1");
        issue1.setKey("TST1-1");
        ExternalIssue issue2 = new ExternalIssueImpl();
        issue2.setId(issueId2);
        issue2.setProject("2");
        issue2.setKey("TST2-1");
        ExternalIssue issue3 = new ExternalIssueImpl();
        issue3.setId(issueId3);
        issue3.setProject("1");
        issue3.setKey("TST1-2");
        ExternalIssue issue4 = new ExternalIssueImpl();
    ...
    public void testBuildingBackupProjectsNoVersionsComponentsCustomFieldConfigsOrIssuesIds()
    {
        ...
        BackupProjectImpl backupProject1 = new BackupProjectImpl(externalProject1, EasyList.build(), EasyList.build(), EasyList.build(), EasyList.build());
        BackupProjectImpl backupProject2 = new BackupProjectImpl(externalProject2, EasyList.build(), EasyList.build(), EasyList.build(), EasyList.build());
