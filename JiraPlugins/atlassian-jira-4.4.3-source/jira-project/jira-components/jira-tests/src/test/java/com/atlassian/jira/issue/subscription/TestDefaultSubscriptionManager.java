...
public class TestDefaultSubscriptionManager extends AbstractUsersIndexingTestCase
{
    ...
    protected void setUp() throws Exception
    {
        ...
        u = UserUtils.createUser("owen", "owen@atlassian.com");
    ...
    public void testGetSubscriptions() throws GenericEntityException
    {
        List<String> groupNames = new ArrayList<String>();
        ...
        final User testUser = UtilsForTests.getTestUser("test");
        final Group anotherGroup = UtilsForTests.getTestGroup("anothergroup");
    ...
    public void testUpdateSubscription() throws Exception
    {
        ...
        sm.updateSubscription(OSUserConverter.convertToOSUser(u), subscrip.getLong("id"), EasyMap.build("group", "newgroup", "emailOnEmpty", Boolean.TRUE.toString()), simpleTrigger);
