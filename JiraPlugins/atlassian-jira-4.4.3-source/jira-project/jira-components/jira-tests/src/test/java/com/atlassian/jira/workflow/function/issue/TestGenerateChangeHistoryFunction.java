...
public class TestGenerateChangeHistoryFunction extends AbstractUsersTestCase
{
    ...
    {
        GenericValue project = EntityUtils.createValue("Project", EasyMap.build("id", new Long(1), "name", "Test Project"));
        ...
        GenericValue issueGV = EntityUtils.createValue("Issue", EasyMap.build("id", new Long(1), "status", "1", "project", project.getLong("id"), "workflowId", new Long(100)));
        ...
        issueMock.expectAndReturn("getProject", project);
