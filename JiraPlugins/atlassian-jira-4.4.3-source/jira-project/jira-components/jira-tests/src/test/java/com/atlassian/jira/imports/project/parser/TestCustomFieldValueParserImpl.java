 ...
 * @since v3.13
 */
public class TestCustomFieldValueParserImpl extends ListeningTestCase
{
    ...
    public void testParseMinimalStringVal() throws ParseException
    {
        ...
        ExternalCustomFieldValueImpl customFieldValue = customFieldValueParser.parse(attributes);
