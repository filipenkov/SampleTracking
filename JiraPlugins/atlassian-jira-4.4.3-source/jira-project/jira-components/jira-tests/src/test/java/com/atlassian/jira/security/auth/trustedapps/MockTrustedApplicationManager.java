...
public class MockTrustedApplicationManager implements TrustedApplicationManager
{
    ...
    public MockTrustedApplicationManager(final Collection<TrustedApplicationInfo> infos)
    {
    ...
    @Override
    public boolean delete(com.opensymphony.user.User user, long id)
    {
    ...
    @Override
    public TrustedApplicationInfo store(com.opensymphony.user.User user, TrustedApplicationInfo info)
    {
    ...
    private static class Cache
    {
        ...
        {
            final TrustedApplicationInfo info = byId.remove(new Long(id));
            if (info != null)
            {
