...
public class TestResolutionDateSystemField extends MockControllerTestCase
{
    ...
    public void testGetColumnViewHtmlNoDate() throws VelocityException
    {
        ...
        final ResolutionDateSystemField field = new ResolutionDateSystemField(velocityManager, applicationProperties, authContext, null, mockColumnViewDateTimeHelper)
        {
            @Override
