...
public class TestDefaultLicenseDetails extends ListeningTestCase
{
    ...
    public void setUp() throws Exception
    {
        ...
        licenseDetails = new DefaultLicenseDetails(mockLicense, LICENSE_STRING, applicationProperties, externalLinkUtil, buildUtilsInfo)
        {
            @Override
    ...
    public void testGetLicenseExpiryStatusMessageForExpiredEvaluation()
    {
        ...
        assertTrue(licenseDetails.getLicenseExpiryStatusMessage(mockI18nHelper, OUTLOOK_DATE).indexOf("admin.license.expired") >= 0);
    }
    ...
    public void testGetLicenseExpiryStatusMessageForNonExpiredEvaluation()
    {
        ...
        assertTrue(licenseDetails.getLicenseExpiryStatusMessage(mockI18nHelper, OUTLOOK_DATE).indexOf("admin.license.expiresin") >= 0);
    }
    ...
    public void testGetLicenseExpiryStatusMessageForLicenseWithNonExpiredMaintenance()
    {
        ...
        assertTrue(licenseDetails.getLicenseExpiryStatusMessage(mockI18nHelper, OUTLOOK_DATE).indexOf("admin.support.available.until") >= 0);
    }
    ...
    public void testGetLicenseExpiryStatusMessageForPersonalLicenseWithNonExpiredMaintenance()
    {
        ...
        assertTrue(licenseDetails.getLicenseExpiryStatusMessage(mockI18nHelper, OUTLOOK_DATE).indexOf("admin.upgrades.available.until") >= 0);
    }
    ...
    public void testGetLicenseExpiryStatusMessageForLicenseWithExpiredMaintenance()
    {
        ...
        assertNull(licenseDetails.getLicenseExpiryStatusMessage(mockI18nHelper, OUTLOOK_DATE));
    }
    ...
    public void testGetLicenseStatusMessageEvaluation()
    {
        ...
        // expired
        assertTrue(licenseDetails.getLicenseStatusMessage(mockI18nHelper, OUTLOOK_DATE, "").indexOf("admin.license.evaluation.expired") >= 0);
    ...
    public void testGetLicenseStatusMessageEvaluationAlmostExpired()
    {
        ...
        mockLicense.setEvaluation(true);
        mockLicense.setExpiryDate(tenSecondsFromNow);
        assertTrue(licenseDetails.getLicenseStatusMessage(mockI18nHelper, OUTLOOK_DATE, "").indexOf("admin.license.evaluation.almost.expired") >= 0);
    ...
    public void testGetLicenseStatusMessageEvaluationNotAlmostExpired()
    {
        ...
        assertNull(licenseDetails.getLicenseStatusMessage(mockI18nHelper, OUTLOOK_DATE, ""));
    }
    ...
    public void testGetLicenseStatusMessageNewBuildOldLicenseForExpiredLicense()
    {
        ...
        user.set(new User("fred", new MockProviderAccessor("Fred", "fred@example.com"), new MockCrowdService()));

        mockLicense.setExpiryDate(tenSecondsBeforeNow);
        mockLicense.setMaintenanceExpiryDate(tenSecondsBeforeNow);
        setLicenseExtenstionTimestamp(fiftyDaysAgoInMillis);

        String message = licenseDetails.getLicenseStatusMessage(mockI18nHelper, OUTLOOK_DATE, "");
    ...
    public void testConstructor() throws Exception
    {
        try
        {
            new DefaultLicenseDetails(null, LICENSE_STRING, applicationProperties, externalLinkUtil, buildUtilsInfo);
        ...
        try
        {
            new DefaultLicenseDetails(mockLicense, LICENSE_STRING, null, externalLinkUtil, buildUtilsInfo);
            fail("Should have barfed");
        }
        catch (Exception expected)
        {
        ...
        try
        {
            new DefaultLicenseDetails(mockLicense, LICENSE_STRING, applicationProperties, null, buildUtilsInfo);
            fail("Should have barfed");
        }
        catch (Exception expected)
        {
        ...
        try
        {
            new DefaultLicenseDetails(mockLicense, null, applicationProperties, externalLinkUtil, buildUtilsInfo);
            fail("Should have barfed");
        }
        catch (Exception expected)
        {
