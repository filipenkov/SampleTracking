...
public class TestLuceneSearchProvider extends AbstractUsersIndexingTestCase
{
    ...
    protected void setUp() throws Exception
    {
        ...
        final Group group = UtilsForTests.getTestGroup("group");
        bob.addToGroup(group);
        carl = UtilsForTests.getTestUser("carl");
    ...
    private class MyDocumentHitCollector extends DocumentHitCollector
    {
        ...
        protected MyDocumentHitCollector(final Searchable searcher)
        {
            super(searcher);
        }
