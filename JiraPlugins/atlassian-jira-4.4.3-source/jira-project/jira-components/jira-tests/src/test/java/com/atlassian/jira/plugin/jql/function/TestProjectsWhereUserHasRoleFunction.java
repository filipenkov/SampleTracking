...
public class TestProjectsWhereUserHasRoleFunction extends MockControllerTestCase
{
    ...
    public void testValidateWrongArgs() throws Exception
    {
        ...
        MessageSet messageSet = projectsWhereUserHasRoleFunction.validate(new MockOSUser("bob"), new FunctionOperand("projectsWhereUserHasRole"), terminalClause);
        ...
        messageSet = projectsWhereUserHasRoleFunction.validate(new MockOSUser("bob"), new FunctionOperand("projectsWhereUserHasRole", "badArg1", "badArg2", "badArg3"), terminalClause);
        assertTrue(messageSet.hasAnyErrors());
        assertEquals(1, messageSet.getErrorMessages().size());
        ...
        messageSet = projectsWhereUserHasRoleFunction.validate(new MockOSUser("bob"), new FunctionOperand("projectsWhereUserHasRole", "BadRole"), terminalClause);
        assertEquals(1, messageSet.getErrorMessages().size());
    ...
    public void testValidateHappyPath() throws Exception
    {
        ...
        // User name supplied
        EasyMock.expect(userUtil.getUser("fred")).andReturn(OSUserConverter.convertToOSUser(theUser));
        EasyMock.expect(projectRoleManager.getProjectRole("Role1")).andReturn(projectRole1);
        replay(userUtil, projectRoleManager);

        MessageSet messageSet = projectsWhereUserHasRoleFunction.validate(new MockOSUser("bob"), new FunctionOperand("projectsWhereUserHasRole", "Role1"), terminalClause);
    ...
    public void testGetValuesHappyPath() throws Exception
    {
        ...
        EasyMock.expect(projectRoleManager.isUserInProjectRole((com.atlassian.crowd.embedded.api.User) theUser, projectRole1, project1)).andReturn(true);
        EasyMock.expect(projectRoleManager.isUserInProjectRole((com.atlassian.crowd.embedded.api.User) theUser, projectRole1, project2)).andReturn(true);
        EasyMock.expect(projectRoleManager.isUserInProjectRole((com.atlassian.crowd.embedded.api.User) theUser, projectRole1, project3)).andReturn(true);
        EasyMock.expect(projectRoleManager.isUserInProjectRole((com.atlassian.crowd.embedded.api.User) theUser, projectRole1, project4)).andReturn(false);
    ...
    public void testGetValuesAnonymous()
    {
        ...
        List<QueryLiteral> list = projectsWhereUserHasRoleFunction.getValues(new QueryCreationContextImpl(null), new FunctionOperand("projectsWhereUserHasRole", "Role1"), terminalClause);
        ...
        list = projectsWhereUserHasRoleFunction.getValues(new QueryCreationContextImpl(null), new FunctionOperand("projectsWhereUserHasRole", "Role1"), terminalClause);
        assertTrue(list.isEmpty());
        verify();
    }
