...
public class TestDefaultIssueLinkManager extends AbstractUsersTestCase
{
    ...
    private void setupManager(final IssueLinkTypeManager issueLinkTypeManager, final IssueUpdater issueUpdater)
    {
        dilm = new DefaultIssueLinkManager(genericDelegator, new DefaultIssueLinkCreator(issueLinkTypeManager, issueManager), issueLinkTypeManager,
                collectionReorderer, issueUpdater, indexManager, applicationProperties, null)
        {
            @Override
    ...
    public void testCreateIssueLinkSystemLinkTypeCreatesGenericValue() throws CreateException, GenericEntityException
    {
        ...
        final IssueLinkTypeManager issueLinkTypeManager = new MyIssueLinkTypeManager()
        {
            ...
            {
                return new IssueLinkType(issueLinkTypeGV);
            }
        };
        ...
        final IssueLinkCreator issueLinkCreator = new IssueLinkCreator()
        {
            ...
            {
                return new IssueLink(issueLinkGV, issueLinkTypeManager, issueManager);
            }
        };
            ...
            throws CreateException, GenericEntityException
    {
        ...
        final IssueLinkCreator issueLinkCreator = new IssueLinkCreator()
        {
            public IssueLink createIssueLink(final GenericValue issueLinkGV)
            {
                return new IssueLink(issueLinkGV, issueLinkTypeManager, mockIssueManager)
                {
                    @Override
        ...
        final User testUser = UtilsForTests.getTestUser("test user");
    ...
    public void testRemoveIssueLinkSystemLinkType() throws RemoveException, GenericEntityException
    {
        ...
        final GenericValue issueLinkGV = UtilsForTests.getTestEntity("IssueLink", EasyMap.build("source", new Long(0), "destination", new Long(1),
                "linktype", linkTypeId));
        final IssueLink issueLink = new IssueLink(issueLinkGV, (IssueLinkTypeManager) mockIssueLinkTypeManager.proxy(), null);
    ...
    public void testRemoveIssueLinkNonSystemLinkType() throws RemoveException, GenericEntityException
    {
        final User testUser = UtilsForTests.getTestUser("test user");
        ...
        final IssueLink issueLink = new IssueLink(issueLinkGV, (IssueLinkTypeManager) mockIssueLinkTypeManager.proxy(), issueManager);
    ...
    public void testGetLinkCollection() throws GenericEntityException
    {
        ...
        mockPermissionManager.expectAndReturn("hasPermission", P.args(new IsEqual(new Integer(Permissions.BROWSE)), new IsEqual(destinationIssue),
    ...
    private List setupIssueLinkSequence()
    {
        ...
        issueLinks.add(new IssueLink(issueLinkGV3, null, null));
        return issueLinks;
    }
    ...
    public void testChangeIssueLinkTypeNonSystemLink() throws RemoveException, GenericEntityException
    {
        final User testUser = UtilsForTests.getTestUser("test use");
    ...
    public void testChangeIssueLinkTypeSystemLink() throws RemoveException, GenericEntityException
    {
        final User testUser = UtilsForTests.getTestUser("test use");
    ...
    private List setupIssueLinkTypes(final boolean system) throws GenericEntityException
    {
        ...
        issueLinkTypes.add(new IssueLinkType(issueLinkTypeGV1));
        issueLinkTypes.add(new IssueLinkType(issueLinkTypeGV2));
    ...
    private List setupLinks(final GenericValue sourceIssue, final GenericValue destinationIssue, final List linkTypes)
    {
        ...
        for (final Iterator iterator = linkTypes.iterator(); iterator.hasNext();)
        {
            ...
            issueLinks.add(new IssueLink(issueLinkGV, issueLinkTypeManager, issueManager));
        }
...
class MyIssueManager implements IssueManager
{
    ...
    public List getIssueWatchers(final GenericValue issue)
    {
        return null;
    }

    public List getIssueWatchers(final Issue issue)
    {
        return null;
    }
