 ...
 * @since v4.1
 */
public class TestFieldScreenRendererFactoryImpl extends ListeningTestCase
{
    @Test
    ...
    public void testGetFieldScreenRendererOperation() throws Exception
    {
        ...
        final FieldScreenRenderer actualRenderer = factory.getFieldScreenRenderer(null, mockIssue, IssueOperations.VIEW_ISSUE_OPERATION, pred);
        assertSame(screenRenderer, actualRenderer);
    ...
    public void testGetFieldScreenRendererActionDescriptor() throws Exception
    {
        ...
        final FieldScreenRenderer actualRenderer = factory.getFieldScreenRenderer(null, mockIssue, desc);
        assertSame(screenRenderer, actualRenderer);
