...
public class TestCollectionReorderer extends ListeningTestCase
{
    ...
    {
        List<String> strings = EasyList.build(string1, string2, string3, string4);
        List<String> expected = EasyList.build(string1, string2, string3, string4);
        _testMove(strings, string1, expected, MOVE_TO_START);

        strings = EasyList.build(string1, string2, string3, string4);
        expected = EasyList.build(string2, string1, string3, string4);
        _testMove(strings, string2, expected, MOVE_TO_START);

        strings = EasyList.build(string1, string2, string3, string4);
        expected = EasyList.build(string3, string1, string2, string4);
        _testMove(strings, string3, expected, MOVE_TO_START);

        strings = EasyList.build(string1, string2, string3, string4);
        expected = EasyList.build(string4, string1, string2, string3);
    ...
    {
        List<String> strings = EasyList.build(string1, string2, string3, string4);
        List<String> expected = EasyList.build(string2, string3, string4, string1);
        _testMove(strings, string1, expected, MOVE_TO_END);

        strings = EasyList.build(string1, string2, string3, string4);
        expected = EasyList.build(string1, string3, string4, string2);
        _testMove(strings, string2, expected, MOVE_TO_END);

        strings = EasyList.build(string1, string2, string3, string4);
        expected = EasyList.build(string1, string2, string4, string3);
        _testMove(strings, string3, expected, MOVE_TO_END);

        strings = EasyList.build(string1, string2, string3, string4);
        expected = EasyList.build(string1, string2, string3, string4);
    ...
    {
        List<String> strings = EasyList.build(string1, string2, string3, string4);
        List<String> expected = EasyList.build(string2, string1, string3, string4);
        _testMove(strings, string1, expected, DECREASE_POSITION);

        strings = EasyList.build(string1, string2, string3, string4);
        expected = EasyList.build(string1, string3, string2, string4);
    ...
    public void testMoveToCollection()
    {
        ...
        strings = EasyList.build(string1, string2, string3, string4);
        expected = EasyList.build(string2, string3, string1, string4);
        ...
        strings = EasyList.build(string1, string2, string3, string4);
        expected = EasyList.build(string2, string3, string4, string1);
        collectionReorderer.moveToPosition(strings, 0, 3);
        assertEquals(expected, strings);

        // Reverse direction
        strings = EasyList.build(string1, string2, string3, string4);
        expected = EasyList.build(string1, string4, string2, string3);
