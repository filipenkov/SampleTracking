...
public class TestIssueCreateFunction extends AbstractUsersTestCase
{
    ...
    protected void setUp() throws Exception
    {
        ...
        assignee = UtilsForTests.getTestUser("Assignee User");
        reporter = UtilsForTests.getTestUser("Reporter User");
    ...
    private void doTestIssueCreated() throws GenericEntityException, WorkflowException
    {
        ...
        retrievedIssue = ManagerFactory.getIssueManager().getIssue("test-1");
