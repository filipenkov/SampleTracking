 ...
 *
 */
public class TestCachingDraftWorkflowStore extends ListeningTestCase
{
    ...
    public void testGetDraftWorkflow()
    {
        ...
        final CachingDraftWorkflowStore cachingDraftWorkflowStore = new CachingDraftWorkflowStore((DraftWorkflowStore) mockDelegate.proxy(), null)
        {
    ...
    public void testGetDraftWorkflowTwice()
    {
        ...
        final CachingDraftWorkflowStore cachingDraftWorkflowStore = new CachingDraftWorkflowStore(mockDraftWorkflowStore, null)
        {
    ...
    {
        final CachingDraftWorkflowStore cachingDraftWorkflowStore = new CachingDraftWorkflowStore(null, null);
        try
        {
    ...
    public void testCreateDraftWorkflow()
    {
        ...
        mockDelegate.expectAndReturn("createDraftWorkflow", new Constraint[] { P.eq("parentWorkflow"), P.eq(workflow) }, workflow);
        ...
        final JiraWorkflow jiraWorkflow = cachingDraftWorkflowStore.createDraftWorkflow("parentWorkflow", workflow);
        assertNotNull(jiraWorkflow);
    ...
    public void testCreateAndDeleteDraftWorkflow()
    {
        ...
        final DraftWorkflowStore mockDraftWorkflowStore = (DraftWorkflowStore) mockDraftWorkflowStoreControl.getMock();
        mockDraftWorkflowStore.createDraftWorkflow("parentWorkflow", workflow);
        ...
        cachingDraftWorkflowStore.createDraftWorkflow("parentWorkflow", workflow);
