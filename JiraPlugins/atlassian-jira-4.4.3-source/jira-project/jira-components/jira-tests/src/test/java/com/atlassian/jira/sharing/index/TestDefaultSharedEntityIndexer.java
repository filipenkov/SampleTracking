...
public class TestDefaultSharedEntityIndexer extends MockControllerTestCase
{
    ...
    private final ProviderAccessor providerAccessor = new MockProviderAccessor();

    private final User user = new User("testClear", providerAccessor, new MockCrowdService());
