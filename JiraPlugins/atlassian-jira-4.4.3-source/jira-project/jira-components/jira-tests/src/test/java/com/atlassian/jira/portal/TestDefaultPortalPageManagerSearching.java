...
public class TestDefaultPortalPageManagerSearching extends MockControllerTestCase
{
    ...
    public void setUp() throws Exception
    {
        ...
        portalPage1 = PortalPage.id(2L).name("two").description("two description").owner(user.getName()).build();
    }
    ...
    public void testSearchNullPrameters()
    {
        ...
        try
        {
            pageManager.search(null, null, 0, 10);
    ...
    public void testSearchZeroWidth()
    {
        ...
        try
        {
            pageManager.search(new SharedEntitySearchParametersBuilder().toSearchParameters(), null, 0, 0);
    ...
    public void testSearchIllegalOffset()
    {
        ...
        try
        {
            pageManager.search(new SharedEntitySearchParametersBuilder().toSearchParameters(), null, 0, -1);
            fail("An exception should be thrown on invalid width.");
        }
        catch (final IllegalArgumentException expected)
        {
