...
public class TestCreatedVsResolvedReport extends AbstractChartReportTestCase
{
    ...
    public void testGenerateReportHtml() throws Exception
    {
        ...
        mockChartFactory.generateCreatedVsResolvedChart(context, 30, PeriodName.weekly, VersionLabel.none, false, false);
        ...
        mockReportModuleDescriptor.getHtml("view", EasyMap.build("user", null,
                "indexing", true, "action", null, "report", createdVsResolvedReport,
