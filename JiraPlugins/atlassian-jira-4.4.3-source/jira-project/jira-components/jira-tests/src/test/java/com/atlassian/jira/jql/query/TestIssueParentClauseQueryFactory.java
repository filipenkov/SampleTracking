...
public class TestIssueParentClauseQueryFactory extends MockControllerTestCase
{
    ...
    public void testEqualsSingleValueKeyOverrideSecurity() throws Exception
    {
        ...
        EasyMock.expect(issueSupport.getIssues("TST-1"))
                .andReturn(Collections.<Issue>singletonList(new MockIssue(5L)));
    ...
    public void testGetIndexValuesForStringLiterals() throws Exception
    {
        ...
        expect(issueSupport.getIssues(stringLiteral, (com.atlassian.crowd.embedded.api.User) theUser)).andReturn(Collections.<Issue>singletonList(new MockIssue(555L)));
    ...
    public void testGetIndexValuesForStringLiteralsOverrideSecurity() throws Exception
    {
        ...
        expect(issueSupport.getIssues(stringLiteral)).andReturn(Collections.<Issue>singletonList(new MockIssue(555L)));
    ...
    public void testGetIndexValuesForStringLiteralsNoIssues() throws Exception
    {
        ...
        expect(issueSupport.getIssues(stringLiteral, (com.atlassian.crowd.embedded.api.User) theUser)).andReturn(Collections.<Issue>emptyList());
