...
public class TestDefaultUserManager extends TestCase
{
    ...
    public void testCanUpdateUser_externalUserManagement() throws Exception
    {
        ...
        final DefaultUserManager defaultUserManager = new DefaultUserManager(null, crowdDirectoryService, applicationProperties);

        assertTrue(defaultUserManager.canUpdateUser(mockUser));
        applicationProperties.setOption("jira.option.user.externalmanagement", true);
