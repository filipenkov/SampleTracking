 ...
 * @since v3.13
 */
public class TestCustomFieldValueTransformerImpl extends ListeningTestCase
{
    ...
    public void testTransformHappyPathStringValue() throws Exception
    {
        ...
        final ExternalCustomFieldValueImpl customFieldValue = customFieldValueTransformer.transform(projectImportMapper, externalCustomFieldValue, new Long(1));
