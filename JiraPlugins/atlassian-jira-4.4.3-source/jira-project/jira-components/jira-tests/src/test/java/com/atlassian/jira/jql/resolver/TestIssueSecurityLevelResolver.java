...
public class TestIssueSecurityLevelResolver extends MockControllerTestCase
{
    ...
    {
        List<GenericValue> expectedList = Arrays.<GenericValue>asList(createMockSecurityLevel(4L, "4"), createMockSecurityLevel(5L, "5"));
    ...
    public void testGetIssueSecurityLevelByIdHappyPath() throws Exception
    {
        ...
        final Collection<GenericValue> levels = CollectionBuilder.<GenericValue>newBuilder(
    ...
    {
        final Collection<GenericValue> expectedLevels = CollectionBuilder.<GenericValue>newBuilder(
                createMockSecurityLevel(3L, "3"),
                createMockSecurityLevel(2L, "2"),
    ...
    public void testGetIssueSecurityLevelsUsingStringOverrideSecurity() throws Exception
    {
        ...
        final Collection<GenericValue> levels = resolver.getIssueSecurityLevelsOverrideSecurity(Collections.singletonList(createLiteral("TheName")));
        assertEquals(expectedLevels, levels);
    }
