...
public class TestVotedIssuesFunction extends MockControllerTestCase
{
    ...
    public void testValidateWrongArgs() throws Exception
    {
        ...
        final MessageSet messageSet = votedIssuesFunction.validate(new MockOSUser("bob"), new FunctionOperand("votedIssues", "badArg"), terminalClause);
        assertTrue(messageSet.hasAnyErrors());
        assertEquals(1, messageSet.getErrorMessages().size());
    ...
    public void testValidateHappyPath() throws Exception
    {
        ...
        final MessageSet messageSet = votedIssuesFunction.validate(new MockOSUser("bob"), new FunctionOperand("votedIssues"), terminalClause);
    ...
    public void testGetValuesAnonymous()
    {
        ...
        final List<QueryLiteral> list = votedIssuesFunction.getValues(new QueryCreationContextImpl(null), new FunctionOperand("votedIssues"), terminalClause);
