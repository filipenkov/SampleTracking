...
public class TestCustomFieldImpl extends ListeningTestCase
{
    ...
    public void testExceptionDuringSearcherInit() throws Exception
    {
        ...
        final CustomFieldImpl customField = new CustomFieldImpl(customFieldGV, customFieldManager, authenticationContext, constantsManager, fieldConfigSchemeManager, permissionManager, rendererManager, contextUtil);
