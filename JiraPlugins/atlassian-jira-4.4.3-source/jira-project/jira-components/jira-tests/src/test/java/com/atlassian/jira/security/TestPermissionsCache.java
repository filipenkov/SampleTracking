 ...
 *
 */
public class TestPermissionsCache extends ListeningTestCase
{
    @Test
    public void testPermissionsCacheNullUser()
    {
        ...
        User user = new User("test", providerAccessorProxy, new MockCrowdService());;
    ...
    public void testPermissionsCache()
    {
        ...
        final ProviderAccessor providerAccessorProxy = new MockProviderAccessor();
        User user = new User("test", providerAccessorProxy, new MockCrowdService());;
        User user2 = new User("test2", providerAccessorProxy, new MockCrowdService());;
        final List projectList = EasyList.build(mockProject1, mockProject2);
        ...
        PermissionsCache permissionsCache = new PermissionsCache(mockProjectFactory);
        permissionsCache.setProjectsWithBrowsePermission(null, projectList);
        permissionsCache.setProjectsWithBrowsePermission(user, EasyList.build(mockProject3));
        permissionsCache.setProjectsWithBrowsePermission(user2, EasyList.build(mockProject4));
