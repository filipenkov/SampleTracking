 ...
 * @since v3.13
 */
public class TestIssueLevelSecurities extends MockControllerTestCase
{
...
//        ));
//
//        IssueLevelSecurities issueLevelSecurities = new IssueLevelSecurities(mockIssueSecuritySchemeManager, securityTypeManager, mockProjectManager)
//        {
...
//        mockGroupSecurityTypeControl.setReturnValue(false, 2);
        ...
        IssueLevelSecurities issueLevelSecurities = new IssueLevelSecurities(mockIssueSecuritySchemeManager, securityTypeManager, mockProjectManager, null, null)
        {
            public GenericValue getIssueSecurityLevel(final Long id) throws GenericEntityException
            {
                return new MockGenericValue("IssueSecurityLevel", EasyMap.build("id", id));
...
//        assertEquals(0, securityLevels.size());
    ...
    public void testGetAllUsersSecurityLevels() throws Exception
    {
        ...
        IssueLevelSecurities issueLevelSecurities = new IssueLevelSecurities(mockIssueSecuritySchemeManager, securityTypeManager, mockProjectManager, mockPermissionManager, null)
        {
            public GenericValue getIssueSecurityLevel(final Long id) throws GenericEntityException
            {
        ...
        Collection<GenericValue> securityLevels = issueLevelSecurities.getAllUsersSecurityLevels(userFred);
    ...
    public void testGetUsersSecurityLevelsByName() throws Exception
    {
        ...
        Collection<GenericValue> securityLevels = issueLevelSecurities.getUsersSecurityLevelsByName(userFred, "Level 1");
        assertEquals(2, securityLevels.size());
    ...
    public void testGetSecurityLevelsByName() throws Exception
    {
        ...
        Collection<GenericValue> securityLevels = issueLevelSecurities.getSecurityLevelsByName("Level 1");
        assertEquals(2, securityLevels.size());
        assertTrue(securityLevels.contains(mock100));
        assertTrue(securityLevels.contains(mock103));
    ...
    public void testGetAllSecurityLevels() throws Exception
    {
        ...
        IssueLevelSecurities issueLevelSecurities = new IssueLevelSecurities(issueSecuritySchemeManager, securityTypeManager, projectManager, permissionManager, null)
        {
            @Override
        ...
        final Collection<GenericValue> result = issueLevelSecurities.getAllSecurityLevels();
    ...
    {
        return new MockGenericValue("Scheme", MapBuilder.newBuilder().add("id", id).toMap());
    }
