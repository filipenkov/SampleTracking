...
public class TestJiraDashboardStateStoreManager extends MockControllerTestCase
{
    ...
    public void testRetrieveSuccess()
    {
        ...
        final LegacyGadgetUrlProvider provider = mockController.getMock(LegacyGadgetUrlProvider.class);
        provider.getLegacyURI("projects");
        mockController.setReturnValue(URI.create("http://localhost:8090/jira/rest/legacy/spec/projects.xml"));
        ...
        final GadgetState secondColSecondRow = secondColumnIterator.next();
        ...
        //Legacy portlet should have a URI created for it and the portlet_id substituted into the user prefs.
        assertEquals(GadgetId.valueOf(Long.toString(10027)), secondColfirstRow.getId());
        assertEquals(Color.color1, secondColfirstRow.getColor());
        assertEquals(URI.create("http://localhost:8090/jira/rest/legacy/spec/projects.xml"), secondColfirstRow.getGadgetSpecUri());

        assertEquals(GadgetId.valueOf(Long.toString(10231)), secondColSecondRow.getId());
        assertEquals(Color.color5, secondColSecondRow.getColor());
        assertEquals(URI.create("http://www.msn.com/"), secondColSecondRow.getGadgetSpecUri());
        assertEquals(Collections.<String, String>emptyMap(), secondColSecondRow.getUserPrefs());
    }
    ...
    public void testStoreDashboardWithPortalPageUpdate()
    {
        ...
        mockPortletConfigurationStore.store(eqPortletConfiguration(new PortletConfigurationImpl(10027L, 10020L, "projects", null, 0, 0, new MockPropertySet(), null, Color.color8, Collections.<String, String>emptyMap())));
        mockPortletConfigurationStore.store(eqPortletConfiguration(new PortletConfigurationImpl(10011L, 10020L, null, null, 1, 0, null, URI.create("http://www.google.com/"), Color.color6, Collections.<String, String>emptyMap())));
        ...
        mockPortletConfigurationStore.store(eqPortletConfiguration(new PortletConfigurationImpl(10231L, 10020L, null, null, 2, 0, null, URI.create("http://www.msn.com/"), Color.color5, Collections.<String, String>emptyMap())));
        mockPortletConfigurationStore.delete(eqPortletConfiguration(new PortletConfigurationImpl(10012L, 10020L, null, null, 0, 1, null, URI.create("/gadgets/sample.xml"), Color.color2, prefs)));

        final LegacyGadgetUrlProvider legacyGadgetUrlProvider = mockController.getMock(LegacyGadgetUrlProvider.class);
        expect(legacyGadgetUrlProvider.isLegacyGadget(URI.create("http://www.newgadget.com/"))).andReturn(false);
        ...
        GadgetState gadget2 = GadgetState.gadget(GadgetId.valueOf(Long.toString(10027))).specUri(URI.create("http://jira.atlassian.com/plugins/servlet/gadgets/g/com.atlassian.jira.gadgets/gadget-bridge.xml")).color(Color.color8).build();
        ...
        final List<GadgetState> col1 = CollectionBuilder.newBuilder(gadget2).asList();
        ...
        final JiraDashboardStateStoreManager stateStore = new JiraDashboardStateStoreManager(mockPortalPageStore, mockPortletConfigurationStore, null, legacyGadgetUrlProvider)
        {
            @Override
    ...
    {
        final PortletConfigurationStore mockPortletConfigurationStore = mockController.getMock(PortletConfigurationStore.class);
        final PortletConfigurationImpl pc = new PortletConfigurationImpl(10027L, 10020L, "projects", null, 0, 0, new MockPropertySet(), null, Color.color8, Collections.<String, String>emptyMap());
    ...
    public void testFindGagdetByIdSuccess()
    {
        ...
        mockController.replay();
        final JiraDashboardStateStoreManager stateStore = new JiraDashboardStateStoreManager(null, mockPortletConfigurationStore, null, null)
        {
            @Override
            public DashboardState retrieve(final DashboardId dashboardId)
                    throws DashboardNotFoundException, DashboardStateStoreException
    ...
    public List<PortletConfiguration> getPortletConfigurationMocks(final Map<String, String> prefs)
    {
        ...
        final PortletConfiguration pc1Gadget = new PortletConfigurationImpl(10011L, 10020L, null, null, 0, 0, null, URI.create("http://www.google.com/"), Color.color1, Collections.<String, String>emptyMap());
        final PortletConfiguration pc2Gadget = new PortletConfigurationImpl(10012L, 10020L, null, null, 0, 1, null, URI.create("/gadgets/sample.xml"), Color.color2, prefs);
        final PortletConfiguration pc3Legacy = new PortletConfigurationImpl(10027L, 10020L, "projects", mockPortlet, 1, 0, new MockPropertySet(), null, null, Collections.<String, String>emptyMap());
        final PortletConfiguration pc4Gadget = new PortletConfigurationImpl(10231L, 10020L, null, null, 1, 1, null, URI.create("http://www.msn.com/"), Color.color5, Collections.<String, String>emptyMap());

        return CollectionBuilder.newBuilder(pc1Gadget, pc2Gadget, pc3Legacy, pc4Gadget).asList();
    }
