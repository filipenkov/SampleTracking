...
public class TestIssueGVsIssueIterable extends ListeningTestCase
{
    ...
    public void testToString()
    {
        ...
        final Collection<GenericValue> issueGVs = EasyList.<GenericValue> build(//
            new MockGenericValue("Issue", EasyMap.build("id", new Long(1), "key", "TST-1")), //
            new MockGenericValue("Issue", EasyMap.build("id", new Long(54), "key", "TST-10")), //
            new MockGenericValue("Issue", EasyMap.build("id", new Long(956), "key", "ABC-24")), //
            new MockGenericValue("Issue", EasyMap.build("id", new Long(926), "key", "TST-100")),//
            new MockGenericValue("Issue", EasyMap.build("id", new Long(739), "key", "ANO-3")));
