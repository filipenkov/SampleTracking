 ...
 * <p/>
 * It will also guard against tests that dont call verify() and replay() on the MockController.
 *
 ...
 */
@Deprecated
public abstract class MockControllerTestCase extends ListeningTestCase
{
