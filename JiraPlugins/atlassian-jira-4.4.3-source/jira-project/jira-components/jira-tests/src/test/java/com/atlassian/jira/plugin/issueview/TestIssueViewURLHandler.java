 ...
 *
 */
public class TestIssueViewURLHandler extends ListeningTestCase
{
    private final Integer ERROR_400 = Integer.valueOf(400);
    private final Integer ERROR_404 = Integer.valueOf(404);
    private final Integer ERROR_500 = Integer.valueOf(500);
    ...
    {
        IssueViewURLHandler issueViewURLHandler = new DefaultIssueViewURLHandler(null, null, null, null, null, null, null);
        ...
        mockResponse.expectVoid("sendError", new Constraint[] { new IsEqual(ERROR_500), new IsEqual(ERROR_EXAMPLE) });
    ...
    public void testInvalidUser() throws IOException
    {
        ...
        Mock mockResponse = new Mock(HttpServletResponse.class);
        mockResponse.expectVoid("sendError", new Constraint[] { new IsEqual(ERROR_500), new IsEqual(ERROR_USER) });

        IssueViewURLHandler issueViewURLHandler = new DefaultIssueViewURLHandler(null, null, null, null, null, null, (CrowdService) mockCrowdService.proxy());
        issueViewURLHandler.handleRequest((HttpServletRequest) mockRequest.proxy(), (HttpServletResponse) mockResponse.proxy());
    ...
    public void testNoUser() throws IOException
    {
        ...
        IssueViewURLHandler issueViewURLHandler = new DefaultIssueViewURLHandler((PluginAccessor) mockPluginAccessor.proxy(), mockIssueManager, (PermissionManager) mockPermissionManager.proxy(), null, null, null, null);
        issueViewURLHandler.handleRequest((HttpServletRequest) mockRequest.proxy(), (HttpServletResponse) mockResponse.proxy());
    ...
    public void testNoPlugin() throws IOException
    {
        ...
        Mock mockResponse = new Mock(HttpServletResponse.class);
        mockResponse.expectVoid("sendError", new Constraint[] { new IsEqual(ERROR_500), new IsEqual(ERROR_PLUGIN) });

        IssueViewURLHandler issueViewURLHandler = new DefaultIssueViewURLHandler((PluginAccessor) mockPluginAccessor.proxy(), null, null, null, null, null, (CrowdService) mockCrowdService.proxy());
        issueViewURLHandler.handleRequest((HttpServletRequest) mockRequest.proxy(), (HttpServletResponse) mockResponse.proxy());
    ...
    public void testNoPermissionOnIssue() throws IOException
    {
        ...
        IssueViewURLHandler issueViewURLHandler = new DefaultIssueViewURLHandler((PluginAccessor) mockPluginAccessor.proxy(), mockIssueManager, (PermissionManager) mockPermissionManager.proxy(), null, null, null, (CrowdService) mockCrowdService.proxy());
        issueViewURLHandler.handleRequest((HttpServletRequest) mockRequest.proxy(), (HttpServletResponse) mockResponse.proxy());
    ...
    public void testNoFieldsDefined() throws Exception
    {
        ...
        IssueViewURLHandler issueViewURLHandler = new DefaultIssueViewURLHandler((PluginAccessor) mockPluginAccessor.proxy(), mockIssueManager, (PermissionManager) mockPermissionManager.proxy(), null, null, (IssueViewRequestParamsHelper) mockIssueViewRequestParamsHelper.proxy(), (CrowdService) mockCrowdService.proxy());
        issueViewURLHandler.handleRequest((HttpServletRequest) mockRequest.proxy(), (HttpServletResponse) mockResponse.proxy());
    ...
    public void testHandleRequestForMovedIssue() throws Exception
    {
        ...
        IssueViewURLHandler issueViewURLHandler = new DefaultIssueViewURLHandler((PluginAccessor) mockPluginAccessor.proxy(), mockIssueManager, null, null, mockChangeHistoryManager, null, (CrowdService) mockCrowdService.proxy());
