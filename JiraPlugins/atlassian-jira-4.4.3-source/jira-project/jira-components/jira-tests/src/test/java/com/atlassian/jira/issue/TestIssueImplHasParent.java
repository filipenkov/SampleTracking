...
public class TestIssueImplHasParent extends ListeningTestCase
{
    ...
    public void testIssueImplHasNoParent()
    {
        ...
        IssueImpl issue = new IssueImpl(gv, null, null, null, null, null, subTaskManager, null, null, null, null);
    ...
    public void testCopyIssueHasSameParent() throws Exception
    {
        ...
        IssueImpl copy = new IssueImpl(mock, null, null, null, null, null, null, null, null, projectComponentManager, null);
        assertEquals(mock.getParentId(), copy.getParentId());

        // check with parent id
        mock.setParentId(new Long(987));
        copy = new IssueImpl(mock, null, null, null, null, null, null, null, null, projectComponentManager, null);
        assertEquals(mock.getParentId(), copy.getParentId());
    }
    ...
    public void testCopyIssueHasSameParentGVNoParent() throws Exception
    {
        ...
        IssueImpl issue = new IssueImpl(gv, issueManager, null, versionManager, null, null, subTaskManager, null, labelManager, projectComponentManager, null);
        assertNull(issue.getParentId());

        IssueImpl copy = new IssueImpl(issue, null, null, null, null, null, null, null, null, projectComponentManager, null);
    ...
    private VersionManager createVersionManager()
    {
        ...
        versionManagerMock.expectAndReturn("getAffectedVersionsByIssue", P.ANY_ARGS, Collections.EMPTY_LIST);
        versionManagerMock.expectAndReturn("getFixVersionsByIssue", P.ANY_ARGS, Collections.EMPTY_LIST);
