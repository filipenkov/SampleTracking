...
public class TestQueueingIndex extends ListeningTestCase
{
    ...
    {
        final List<FutureOperation> operations = EasyList.build(new QueueingIndex.FutureOperation(new MockOperation()),
            new QueueingIndex.FutureOperation(new MockOperation(UpdateMode.BATCH)), new QueueingIndex.FutureOperation(new MockOperation()));
