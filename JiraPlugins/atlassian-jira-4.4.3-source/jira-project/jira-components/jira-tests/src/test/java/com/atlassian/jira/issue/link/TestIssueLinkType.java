...
public class TestIssueLinkType extends LegacyJiraMockTestCase
{
    ...
    public void testCompareToWrongOClass()
    {
        try
        {
            issueLinkType.compareTo(new Object());
            fail("IllegalArgumentException should have been thrown.");
        }
        catch (IllegalArgumentException e)
        {
            assertEquals("Object must be an IssueLinkType.", e.getMessage());
        }
    }
    ...
    public void testCompareToOtherNull()
    {
        ...
        final IssueLinkType issueLinkType2 = new IssueLinkType(issueLinkTypeGV2);
