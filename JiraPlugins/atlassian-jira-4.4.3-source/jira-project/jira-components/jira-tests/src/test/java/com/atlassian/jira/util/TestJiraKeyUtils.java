...
import com.atlassian.jira.util.JiraKeyUtils.DefaultKeyMatcher;
 ...
 */
public class TestJiraKeyUtils extends ListeningTestCase
{
    ...
    public void setUp()
    {
        ...
        oldKeyMatcher = getCurrentKeyMatcher();
        setKeyMatcher(new MockKeyMatcher(""));
    ...
    {
        JiraKeyUtils.setKeyMatcher(new MockKeyMatcher(""));
    ...
    public void testValidProjectKey()
    {
        ...
        JiraKeyUtils.setKeyMatcher(new MockKeyMatcher("([A-Z]+)"));
        ...
        JiraKeyUtils.setKeyMatcher(new MockKeyMatcher("([A-Z]{2,})"));
    ...
    public void testLinkBugKeysDefaultRegexPattern()
    {
        ...
        setKeyMatcher(new MockProductionKeyMatcher(PROJECT_REGEX, applicationProperties, issueManager));

        _testLinkBugKeys("http://localhost/browse/JRA-1", "JRA-1");
        _testLinkBugKeys("JRA-1 http://localhost/browse/JRA-1", "<a href=\""+ HTTP_BASE + "/browse/JRA-1\" title=\"Summary JRA-1\">JRA-1</a> http://localhost/browse/JRA-1", "JRA-1");
        _testLinkBugKeys("http://localhost/browse/JRA-1/JRA-1", "JRA-1");
        _testLinkBugKeys("JRA-1 http://localhost/browse/JRA-1/JRA-1", "<a href=\"" + HTTP_BASE + "/browse/JRA-1\" title=\"Summary JRA-1\">JRA-1</a> http://localhost/browse/JRA-1/JRA-1", "JRA-1");
        ...
        _testLinkBugKeys("JRA-1 <a href=\"http://localhost/browse/JRA-1\">http://localhost/browse/JRA-1</a>", "<a href=\"" + HTTP_BASE + "/browse/JRA-1\" title=\"Summary JRA-1\">JRA-1</a> <a href=\"http://localhost/browse/JRA-1\">http://localhost/browse/JRA-1</a>", "JRA-1");
        _testLinkBugKeys("http://localhost/browse/JRA-1 JRA-1 <a href=\"http://localhost/browse/JRA-1\">http://localhost/browse/JRA-1</a>", "http://localhost/browse/JRA-1 <a href=\"" + HTTP_BASE + "/browse/JRA-1\" title=\"Summary JRA-1\">JRA-1</a> <a href=\"http://localhost/browse/JRA-1\">http://localhost/browse/JRA-1</a>", "JRA-1");
        ...
        _testLinkBugKeys("http://localhost/browse/dhjdhajss\nJRA-1", "http://localhost/browse/dhjdhajss\n<a href=\""+ HTTP_BASE + "/browse/JRA-1\" title=\"Summary JRA-1\">JRA-1</a>", "JRA-1");
        _testLinkBugKeys("http://localhost/browse/dhjdhajss\tJRA-1", "http://localhost/browse/dhjdhajss\t<a href=\""+ HTTP_BASE + "/browse/JRA-1\" title=\"Summary JRA-1\">JRA-1</a>", "JRA-1");
        _testLinkBugKeys("http://localhost/browse/ONE-1|JRA-2", "http://localhost/browse/ONE-1|<a href=\""+ HTTP_BASE + "/browse/JRA-2\" title=\"Summary JRA-2\">JRA-2</a>", "JRA-2");
    ...
    public static KeyMatcher getCurrentKeyMatcher()
    {
        return JiraKeyUtils.getCurrentKeyMatcher();
    }

    public static void setKeyMatcher(final KeyMatcher keyMatcher)
    {
    ...
    public static class MockKeyMatcher extends DefaultKeyMatcher
    {
