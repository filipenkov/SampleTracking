...
public class TestProjectSelectStatisticsMapper extends ListeningTestCase
{
    @Test
    public void testEquals()
    {
        ...
        ProjectSelectStatisticsMapper mapper = new ProjectSelectStatisticsMapper((CustomField) mockCustomField.proxy(), null);
        ...
        ProjectSelectStatisticsMapper mapper2 = new ProjectSelectStatisticsMapper((CustomField) mockCustomField2.proxy(), (ProjectManager) mockProjectManager.proxy());
        ...
        ProjectSelectStatisticsMapper mapper3 = new ProjectSelectStatisticsMapper((CustomField) mockCustomField3.proxy(), (ProjectManager) mockProjectManager.proxy());
