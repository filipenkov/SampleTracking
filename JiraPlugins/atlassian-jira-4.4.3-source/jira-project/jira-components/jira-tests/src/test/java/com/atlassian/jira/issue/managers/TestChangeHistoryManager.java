...
public class TestChangeHistoryManager extends AbstractUsersTestCase
{
    ...
    public void testChangeHistory() throws EntityNotFoundException, GenericEntityException, DuplicateEntityException, ImmutableException
    {
    ...
    public void testChangeHistoryNone() throws EntityNotFoundException, GenericEntityException, DuplicateEntityException, ImmutableException
    {
        List changeHistories = changeHistoryManager.getChangeHistoriesForUser(issueObject, null);
        assertNotNull(changeHistories);
     ...
     */
    public void testMultipleChangeHistories() throws ImmutableException, DuplicateEntityException, GenericEntityException, EntityNotFoundException, RepositoryException
    {
        List changeHistories = changeHistoryManager.getChangeHistoriesForUser(issueObject, null);
        assertNotNull(changeHistories);
        assertTrue(changeHistories.isEmpty());
