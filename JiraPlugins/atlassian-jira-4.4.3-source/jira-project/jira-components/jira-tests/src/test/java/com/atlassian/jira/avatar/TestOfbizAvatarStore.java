...
public class TestOfbizAvatarStore extends MockControllerTestCase
{
    ...
    public void testGetById()
    {
        ...
        expect(mockOfBizDelegator.findByPrimaryKey("Avatar", EasyMap.build("id", 90909L))).andReturn(lookedUpGv);
    ...
    public void testGetByIdNull() {
        expect(mockOfBizDelegator.findByPrimaryKey("Avatar", EasyMap.build("id", 303L))).andReturn(null);
        replay();
        OfbizAvatarStore store = new OfbizAvatarStore(mockOfBizDelegator);
    ...
    public void testUpdate()
    {
        ...
        expect(mockOfBizDelegator.findByPrimaryKey("Avatar", EasyMap.build("id", 123L))).andReturn(gv);
        replay();
