 ...
 * @since 4.0.
 */
public class TestCachingFavouritesStore extends ListeningTestCase
{
    ...
    public void setUp() throws Exception
    {
        ...
        entity1 = PortalPage.id(ENTITY1_ID).name("page1").owner(testuser.getName()).build();
        entity2 = PortalPage.id(ENTITY2_ID).name("page2").owner(testuser.getName()).build();
    }
    ...
    public void testAddFavouriteHappy()
    {
        ...
        favStore.getFavouriteIds(testuser, PortalPage.ENTITY_TYPE);
    ...
    public void testGetFavouriteIdsHappy()
    {
        ...
        favStore.getFavouriteIds(testuser, SearchRequest.ENTITY_TYPE);
    ...
    {
        User userBad = new MockUser("userBad");
        User userBad2 = new MockUser("userBad2");
        ...
        favStore.getFavouriteIds(userBad, PortalPage.ENTITY_TYPE);
        favStoreCtrl.setReturnValue(portalList2);

        favStore.getFavouriteIds(userBad2, PortalPage.ENTITY_TYPE);
    ...
    public void testrUpdateSequenceEmptyList()
    {
        ...
        assertEquals(expectedPrimeList, store.getFavouriteIds(testuser, PortalPage.ENTITY_TYPE));
        assertEquals(expectedPrimeList, store.getFavouriteIds(testuser, PortalPage.ENTITY_TYPE));
    ...
    private FavouritesStore createFavouriteStore()
    {
        ...
        return new CachingFavouritesStore(favStore, null);
    }
}
