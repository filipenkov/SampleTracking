...
public class TestTimeTrackingAdmin extends MockControllerTestCase
{
    ...
    public void setUp() throws Exception
    {
        ...
        ComponentAccessor.initialiseWorker(new MockComponentWorker()
                .addMock(JiraAuthenticationContext.class,new MockAuthenticationContext(null,null))
        );

        replay();


        tta = new TimeTrackingAdmin(applicationProperties, (FieldManager) mockFieldManager.proxy(), mockJiraDurationUtils, null, null, reindexMessageManager);
    }
    ...
    {
        mockController.reset();
        TimeTrackingAdmin subclassedTta = new TimeTrackingAdmin(applicationProperties, (FieldManager) mockFieldManager.proxy(), mockJiraDurationUtils, null, null, reindexMessageManager) {
