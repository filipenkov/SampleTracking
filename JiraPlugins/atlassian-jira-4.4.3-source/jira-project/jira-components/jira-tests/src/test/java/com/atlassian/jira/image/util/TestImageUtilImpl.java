 ...
 * @since v4.0
 */
public class TestImageUtilImpl extends MockControllerTestCase
{

    @Test
    public void testGetColorNulls()
    {
        ImageUtils util = new ImageUtilsImpl();
    ...
    private Color getColor(String r, String g, String b, int a)
    {
