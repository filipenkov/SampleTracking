...
public class TestJiraHomeStartupCheck extends ListeningTestCase
{
    ...
    JiraHomeStartupCheck startupCheck;
    ...
    public void testDirectoryDoesntExistAndIsCreatedOk() throws Exception
    {
        ...
        try
        {
            ...
            for (String subdir : JiraHome.subdirs)
            {
    ...
    public void testIsLocked() throws Exception
    {
        ...
        try
        {
            ...
            //This rather complicated regex just looks for "......http://docs.atlassian.com/jira/<something>/How+do+I+unlock+my+JIRA+home+directory%3F?clicked=jirahelp# ....."
            String expectedRegex = String.format("\\QThe jira.home directory '%s' is already locked. Please see http://docs.atlassian.com/jira/\\E[^/]+\\Q/How+do+I+unlock+my+JIRA+home+directory%%3F# for more information on locked jira.home directories.\\E", file.getCanonicalPath());
            assertTrue(startupCheckShouldFailLocked.getFaultDescription().matches(expectedRegex));

            //This rather complicated regex just looks for "......http://docs.atlassian.com/jira/<something>/How+do+I+unlock+my+JIRA+home+directory%3F?clicked=jirahelp# .....
            expectedRegex = String.format("\\QThe jira.home directory &#39;%s&#39; is already locked. Please see <a href=\"http://docs.atlassian.com/jira/\\E[^/]+\\Q/How+do+I+unlock+my+JIRA+home+directory%%3F#\">the JIRA documentation</a> for more information on locked jira.home directories.\\E", file.getCanonicalPath());
            assertTrue(startupCheckShouldFailLocked.getHTMLFaultDescription().matches(expectedRegex));
    ...
    public void testIsReadonly() throws Exception
    {
        ...
        try
        {
            ...
            startupCheck.createAllHomeDirectories(file);
    ...
    public void testCannotCreateDirectory() throws Exception
    {
        ...
        try
        {
            ...
            final String expectedMessage = "Could not create jira.home directory '" + path + "'. Please see " + jiraHomeURL + " for more information on how to set up your JIRA home directory.";
            assertEquals(expectedMessage, startupCheck.getFaultDescription());
            assertEquals(expectedMessage, startupCheck.getHTMLFaultDescription());
            assertNull(startupCheck.getJiraHomeDirectory());
        }
