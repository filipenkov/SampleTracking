...
public class TestIdIndexedSearchInputTransformer extends MockControllerTestCase
{
    ...
    public void testPopulateFromParamsOneId() throws Exception
    {
        ...
        final IdIndexedSearchInputTransformer transformer = new MockIdIndexedSearchInputTransformer(new ClauseNames("testId"), mockIndexInfoResolver, mockJqlOperandResolver, mockFieldFlagOperandRegistry, searchContextVisibilityChecker);
    ...
    public void testPopulateFromSearchRequest() throws Exception
    {
        ...
        indexedInputHelper.getAllNavigatorValuesForMatchingClauses(null, new ClauseNames("testId"), query, searchContext);
        mockController.setReturnValue(Collections.singleton("stuff"));

        mockController.replay();

        final IdIndexedSearchInputTransformer transformer = new IdIndexedSearchInputTransformer(new ClauseNames("testId"), mockIndexInfoResolver, MockJqlOperandResolver.createSimpleSupport(), mockFieldFlagOperandRegistry, searchContextVisibilityChecker)
        {
            @Override
    ...
    public void testGetSearchClauseSingleValueStringOneId() throws Exception
    {
        ...
        final IdIndexedSearchInputTransformer transformer = new MockIdIndexedSearchInputTransformer(new ClauseNames("testId"), mockIndexInfoResolver, MockJqlOperandResolver.createSimpleSupport(), mockFieldFlagOperandRegistry, searchContextVisibilityChecker);
    ...
    public void testPopulateFromParamsTwoIds() throws Exception
    {
        ...
        final IdIndexedSearchInputTransformer transformer = new MockIdIndexedSearchInputTransformer(new ClauseNames("testFieldName"), "testSearcherId", mockIndexInfoResolver, mockJqlOperandResolver, mockFieldFlagOperandRegistry, searchContextVisibilityChecker);
        final FieldValuesHolderImpl valuesHolder = new FieldValuesHolderImpl();
        final String[] values = { "val1", "val2" };
    ...
    public void testGetSearchClauseSingleValueStringTwoIds() throws Exception
    {
        ...
        final IdIndexedSearchInputTransformer transformer = new MockIdIndexedSearchInputTransformer(new ClauseNames("testFieldName"), "testSearcherId", mockIndexInfoResolver, MockJqlOperandResolver.createSimpleSupport(), mockFieldFlagOperandRegistry, searchContextVisibilityChecker);
        final Clause clause = transformer.getSearchClause(null, valuesHolder);
    ...
    public void testValidateForNavigatorHappyPath() throws Exception
    {
        ...
        IdIndexedSearchInputTransformer<Version> transformer = new MockIdIndexedSearchInputTransformer<Version>(new ClauseNames(FIELD_NAME), vIndexInfoResolver, mockJqlOperandResolver, oFieldFlagOperandRegistry, searchContextVisibilityChecker)
        {
            @Override
            NavigatorStructureChecker<Version> createNavigatorStructureChecker()
            {
                return new NavigatorStructureChecker<Version>(new ClauseNames(FIELD_NAME), true, fieldFlagOperandRegistry, operandResolver, indexInfoResolver, searchContextVisibilityChecker)
                {
                    @Override
                    public boolean checkSearchRequest(final Query query, final SearchContext searchContext)
                    {
                        return true;
                    }
                };
    ...
    public void testValidateForNavigatorSadPath() throws Exception
    {
        ...
        IdIndexedSearchInputTransformer transformer = new MockIdIndexedSearchInputTransformer<Version>(new ClauseNames(FIELD_NAME), indexInfoResolver, mockJqlOperandResolver, fieldFlagOperandRegistry, searchContextVisibilityChecker)
        {
            @Override
            NavigatorStructureChecker<Version> createNavigatorStructureChecker()
            {
    ...
    public void testGetSearchClauseFlagMultiValues() throws Exception
    {
        ...
        final IdIndexedSearchInputTransformer transformer = new MockIdIndexedSearchInputTransformer(new ClauseNames("testdid"), mockIndexInfoResolver, jqlOperandResolver, mockFieldFlagOperandRegistry, searchContextVisibilityChecker);
        final Clause clause = transformer.getSearchClause(null, valuesHolder);
    ...
    public void testGetValuesFromHolderThrowsException() throws Exception
    {
        ...
        final IdIndexedSearchInputTransformer transformer = new MockIdIndexedSearchInputTransformer(new ClauseNames("testdid"), mockIndexInfoResolver, MockJqlOperandResolver.createSimpleSupport(), mockFieldFlagOperandRegistry, searchContextVisibilityChecker);
    ...
    {
        private MockIdIndexedSearchInputTransformer(ClauseNames id, IndexInfoResolver<T> indexInfoResolver, JqlOperandResolver operandResolver, FieldFlagOperandRegistry fieldFlagOperandRegistry, final SearchContextVisibilityChecker searchContextVisibilityChecker)
        {
            super(id, indexInfoResolver, operandResolver, fieldFlagOperandRegistry, searchContextVisibilityChecker);
        }

        private MockIdIndexedSearchInputTransformer(ClauseNames clauseNames, String urlParameterName, IndexInfoResolver<T> indexInfoResolver, JqlOperandResolver operandResolver, FieldFlagOperandRegistry fieldFlagOperandRegistry, final SearchContextVisibilityChecker searchContextVisibilityChecker)
        {
            super(clauseNames, urlParameterName, indexInfoResolver, operandResolver, fieldFlagOperandRegistry, searchContextVisibilityChecker);
        }
