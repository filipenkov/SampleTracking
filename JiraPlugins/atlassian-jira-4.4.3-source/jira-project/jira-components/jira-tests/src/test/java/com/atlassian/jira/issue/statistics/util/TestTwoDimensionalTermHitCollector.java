...
public class TestTwoDimensionalTermHitCollector extends AbstractHitCollectorTestCase
{
    ...
    {
        IndexReader reader = writeToRAM(docs);
        ...
        TwoDimensionalTermHitCollector hitCollector = new TwoDimensionalTermHitCollector(statsMap, reader, fieldVisibilityManager, new DefaultReaderCache(), aggregateField);
