...
public class MockUserHistoryManager implements UserHistoryManager
{
    ...
    @Override
    public void addItemToHistory(UserHistoryItem.Type type, com.opensymphony.user.User user, String entityId)
    {
    }
    ...
    @Override
    public void addItemToHistory(UserHistoryItem.Type type, com.opensymphony.user.User user, String entityId, String data)
    {
    }
    ...
    @Override
    public boolean hasHistory(UserHistoryItem.Type type, com.opensymphony.user.User user)
    {
        return false;
    }
    ...
    @Override
    public List<UserHistoryItem> getHistory(UserHistoryItem.Type type, com.opensymphony.user.User user)
    {
        return userHistoryItems;
    }
    ...
    @Override
    public void removeHistoryForUser(@NotNull com.opensymphony.user.User user)
    {
    }
}
