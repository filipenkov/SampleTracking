 ...
 * @since v4.0
 */
public class TestSystemSearchConstants extends ListeningTestCase
{
    @Test
    ...
    public void testSummary() throws Exception
    {
        ...
        assertEquals("query", constants.getSearcherId());
    ...
    public void testSystemNames() throws Exception
    {
        ...
        Set<String> expectedNames = new HashSet<String>(Arrays.asList("affectedVersion", "assignee", "category", "comment", "component",
                "created", "createdDate", "description", "due", "duedate", "environment", "filter", "fixVersion", "id", "issue", "issuekey", "issuetype",
                "key", "level", "originalEstimate", "parent", "priority", "project", "remainingEstimate", "reporter", "request",
                "resolution", "resolved", "resolutiondate", "savedfilter", "searchrequest", "status", "summary", "text", "timeestimate", "timeoriginalestimate",
