 ...
 * @since v3.13
 */
public class TestUserCustomFieldImporter extends ListeningTestCase
{
    @Test
    ...
    public void testGetMappedImportValue()
    {
        ...
        assertNull(userCustomFieldImporter.getMappedImportValue(new ProjectImportMapperImpl(null, null), getExternalCustomFieldValue(null), null).getValue());
        // Test with empty original value
        assertEquals("", userCustomFieldImporter.getMappedImportValue(new ProjectImportMapperImpl(null, null), getExternalCustomFieldValue(""), null).getValue());
        // Test with non-empty original value
        assertEquals("john.doe", userCustomFieldImporter.getMappedImportValue(new ProjectImportMapperImpl(null, null), getExternalCustomFieldValue("john.doe"), null).getValue());
    }
}
