 ...
 * @since v4.0
 */
public class TestActualValueEqualityQueryFactory extends MockControllerTestCase
{
    ...
    {
        final ActualValueEqualityQueryFactory factory = createFactory(BaseFieldIndexer.NO_VALUE_INDEX_VALUE);
    ...
    public void testEqualsNoResolvedLiterals() throws Exception
    {
        ...
        final IndexValueConverter indexValueConverter = mockController.getMock(IndexValueConverter.class);
    ...
    public void testInWithEmpty() throws Exception
    {
        ...
        final IndexValueConverter indexValueConverter = mockController.getMock(IndexValueConverter.class);
        indexValueConverter.convertToIndexValue(longLiteral);
    ...
    private void assertQueryHappy(Operator op, String expectedLuceneQuery, final Object value)
    {
        final ActualValueEqualityQueryFactory factory = createFactory(BaseFieldIndexer.NO_VALUE_INDEX_VALUE);
    ...
    private void assertQueryHappyMultiple(Operator op, String luceneQuery, final boolean expectedMustNotOccur, Object... values)
    {
        final ActualValueEqualityQueryFactory factory = createFactory(BaseFieldIndexer.NO_VALUE_INDEX_VALUE);

        final List<QueryLiteral> list = new ArrayList<QueryLiteral>();
        for (Object value : values)
        {
            list.add(createQL(value));
        }
    ...
    {
        final JqlDurationSupportImpl valueConverter = new JqlDurationSupportImpl()
        {
            @Override
    ...
    private BooleanQuery getEmptyQueryForField(String field)
    {
