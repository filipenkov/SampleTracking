 ...
 * @since v4.0
 */
public class TestDefaultAutoCompleteJsonGenerator extends MockedComponentManagerTestCase
{
    ...
    public void testGetVisibleFieldNamesJsonHappyPath() throws Exception
    {
        ...
        expect(searchHandlerManager.getVisibleClauseHandlers((User) null)).andReturn(CollectionBuilder.newBuilder(new MockValuesGeneratingClauseHandler("field1"), clauseHandler, new MockValuesGeneratingClauseHandler("cf[12345]", "Custom Field Name")).asList());
        ...
        expect(customField.getName()).andReturn("Custom Field Name");
    ...
    public void testGetVisibleFieldNamesJsonCustomFieldWithOnlyId() throws Exception
    {
        ...
        expect(searchHandlerManager.getVisibleClauseHandlers((User) null)).andReturn(CollectionBuilder.newBuilder(new MockValuesGeneratingClauseHandler("field1"), clauseHandler, new MockValuesGeneratingClauseHandler("cf[12345]")).asList());
    ...
    public void testGetVisibleFieldNamesJsonCustomFieldConflictsWithOtherField() throws Exception
    {
        ...
        expect(searchHandlerManager.getVisibleClauseHandlers((User) null)).andReturn(CollectionBuilder.newBuilder(new MockValuesGeneratingClauseHandler("field1"), clauseHandler, new MockValuesGeneratingClauseHandler("cf[12345]", "field1")).asList());
        ...
        final Field field = easyMockSupport.createMock(Field.class);
        final CustomField customField = easyMockSupport.createMock(CustomField.class);
        expect(customField.getName()).andReturn("field1");
    ...
    public void testGetVisibleFieldNamesJsonCustomFieldConflictsWithOtherCustomField() throws Exception
    {
        ...
        expect(searchHandlerManager.getVisibleClauseHandlers((User) null)).andReturn(CollectionBuilder.newBuilder(new MockValuesGeneratingClauseHandler("field1"), clauseHandler, new MockValuesGeneratingClauseHandler("cf[12345]", "Cust Field Conflicts"), new MockValuesGeneratingClauseHandler("cf[54321]", "Cust Field Conflicts")).asList());
        ...
        final Field field = easyMockSupport.createMock(Field.class);
        final CustomField customField = easyMockSupport.createMock(CustomField.class);
        expect(customField.getName()).andReturn("Cust Field Conflicts").times(2);
    ...
    public void testGetVisibleFunctionNamesJson() throws Exception
    {
        ...
        expect(jqlFunctionHandlerRegistry.getAllFunctionNames()).andReturn(CollectionBuilder.newBuilder("afunc", "echo", "cfunc", "bfunc", "currentUser").asMutableList());
