...
public class TestCachingVersionStore extends ListeningTestCase
{
    MemoryVersionStore underlyingStore;
    CachingVersionStore cachingVersionStore;

    @Before
    public void setUp() throws Exception
    {
        underlyingStore = new MemoryVersionStore();
        cachingVersionStore = new CachingVersionStore(underlyingStore, null);
    }
