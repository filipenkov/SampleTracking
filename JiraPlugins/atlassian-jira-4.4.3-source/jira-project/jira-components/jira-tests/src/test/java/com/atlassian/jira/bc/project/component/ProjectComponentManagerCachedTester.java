...
public class ProjectComponentManagerCachedTester extends ProjectComponentManagerTester
{
    ...
    public ProjectComponentManagerCachedTester(ProjectComponentStore store) throws EntityNotFoundException
    {
        super(new CachingProjectComponentStore(store, null));
        realStore = store;
