...
public class TestUpgradeUtils extends ListeningTestCase
{
    ...
    private DefaultOfBizDelegator defaultOfBizDelegator = null;
    ...
    public void setUp() throws Exception
    {
        ...
        defaultOfBizDelegator = new DefaultOfBizDelegator(CoreFactory.getGenericDelegator());
        upgradeUtils = new UpgradeUtils(defaultOfBizDelegator);
    ...
    public void testClearColumns() throws GenericEntityException
    {
        ...
        List jobs = defaultOfBizDelegator.findAll(QRTZJOB_DETAILS);
