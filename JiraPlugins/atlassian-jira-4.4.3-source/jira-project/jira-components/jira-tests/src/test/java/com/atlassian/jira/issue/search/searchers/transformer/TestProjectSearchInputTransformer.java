...
public class TestProjectSearchInputTransformer extends MockControllerTestCase
{
    ...
    public void setUp() throws Exception
    {
        ...
        theUser = new User("admin", mpa, new MockCrowdService());
    ...
    {
        searchContextVisibilityChecker = null;
    ...
    public void testPopulateFromParams() throws Exception
    {
        ...
        SearchInputTransformer transformer = new ProjectSearchInputTransformer(null, null, mockFieldFlagOperandRegistry, searchContextVisibilityChecker, projectManager, projectHistoryManager, authenticationContext);
    ...
    public void testPopulateFromSearchRequestEmptyMatchingValues() throws Exception
    {
        ...
        indexedInputHelper.getAllNavigatorValuesForMatchingClauses(theUser, SystemSearchConstants.forProject().getJqlClauseNames(), new QueryImpl(), searchContext);
        mockController.setReturnValue(Collections.emptySet());

        mockController.replay();

        final SearchInputTransformer transformer = new ProjectSearchInputTransformer(mockProjectIndexInfoResolver, MockJqlOperandResolver.createSimpleSupport(), mockFieldFlagOperandRegistry, searchContextVisibilityChecker, projectManager, projectHistoryManager, authenticationContext)
        {
    ...
    public void testPopulateFromSearchRequestHappyPath() throws Exception
    {
        ...
        final IndexedInputHelper indexedInputHelper = mockController.getMock(IndexedInputHelper.class);
        indexedInputHelper.getAllNavigatorValuesForMatchingClauses(theUser, new ClauseNames(IssueFieldConstants.PROJECT), new QueryImpl(), searchContext);
    ...
    public void testGetSearchClauseHappyPath() throws Exception
    {
        ...
        final ProjectSearchInputTransformer transformer = new ProjectSearchInputTransformer(null, null, mockFieldFlagOperandRegistry, searchContextVisibilityChecker, projectManager, projectHistoryManager, authenticationContext);
    ...
    public void testValidateForNavigatorHappyPath() throws Exception
    {
        ...
        final IndexInfoResolver<Project> indexInfoResolver = mockController.getMock(IndexInfoResolver.class);
        ...
        ProjectSearchInputTransformer transformer = new ProjectSearchInputTransformer(null, null, null, searchContextVisibilityChecker, projectManager, projectHistoryManager, authenticationContext)
        {
            @Override
            NavigatorStructureChecker<Project> createNavigatorStructureChecker()
            {
                return new NavigatorStructureChecker<Project>(SystemSearchConstants.forProject().getJqlClauseNames(), false, fieldFlagOperandRegistry, mockJqlOperandResolver, indexInfoResolver, searchContextVisibilityChecker)
                {
                    @Override
