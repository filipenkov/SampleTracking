...
public class TestDefaultPermissionSchemeManager extends ListeningTestCase
{
    ...
    public void testHasSchemePermissionWithUser() throws GenericEntityException
    {
        ...
        User user = new User("John", new MockProviderAccessor(), new MockCrowdService());
    ...
    {
        return new DefaultPermissionSchemeManager(null, permissionTypeManager, null, null, null, null, null)
        {
