...
public class TestIssueLink extends LegacyJiraMockTestCase
{
    ...
    protected void setUp() throws Exception
    {
        ...
        issueLinkType = new IssueLinkType(issueLinkTypeGV);
    ...
    private void setupIssueLink(IssueLinkTypeManager issueLinkTypeManager, IssueManager issueManager)
    {
        ...
        issueLink = new IssueLink(issueLinkGV, issueLinkTypeManager, issueManager);
    }
    ...
    public void testGetters()
    {
        ...
        mockIssueManager.expectAndReturn("getIssue", P.args(new IsEqual(sourceIssue.getLong("id"))), sourceIssue);
        ...
        assertEquals(sourceIssue, issueLink.getSource());
        verifyMocks();

        mockIssueManager.expectAndReturn("getIssue", P.args(new IsEqual(destinationIssue.getLong("id"))), destinationIssue);
        setupIssueLink((IssueLinkTypeManager) mockIssueLinkTypeManager.proxy(), (IssueManager) mockIssueManager.proxy());
        assertEquals(destinationIssue, issueLink.getDestination());
        verifyMocks();
    }
