...
public class TestIssueObjectIssueIterable extends ListeningTestCase
{
    @Test
    ...
    public void testToString()
    {
        ...
        final Collection<Issue> issues = EasyList.build(makeIssue(1, "TST-1"), makeIssue(1, "TST-10"), makeIssue(1, "ABC-24"),
            makeIssue(1, "TST-100"), makeIssue(1, "ANO-3"));
