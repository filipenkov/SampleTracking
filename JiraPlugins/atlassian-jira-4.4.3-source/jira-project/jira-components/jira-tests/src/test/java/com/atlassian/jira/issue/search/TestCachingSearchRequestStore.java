...
public class TestCachingSearchRequestStore extends MockControllerTestCase
{
    ...
    public void setUp() throws Exception
    {
        ...
        cachingStore = new CachingSearchRequestStore(deletegateStore, null);

        final ProviderAccessor accessor = new MockProviderAccessor();
        adminUser = new User("admin", accessor, new MockCrowdService());
        group = new Group("admin", accessor);
        fredUser = new User("fredUser", accessor, new MockCrowdService());
