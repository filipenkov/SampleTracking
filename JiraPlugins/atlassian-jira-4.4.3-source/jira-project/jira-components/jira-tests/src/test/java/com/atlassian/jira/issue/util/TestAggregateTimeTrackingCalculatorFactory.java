...
public class TestAggregateTimeTrackingCalculatorFactory extends ListeningTestCase
{
    ...
    public void testIssueImpl()
    {
        ...
        AggregateTimeTrackingCalculator calc = factory.getCalculator(new IssueImpl((GenericValue) null, null, null, null, null, null, null, null, null, null, null));
