 ...
 * @since v3.13
 */
public class TestBulkEditBeanImplSimple extends ListeningTestCase
{
    @Test
    public void testTargetIssueObjects()
    {
        ...
        issue1.setProject(new MockGenericValue("Project", EasyMap.build("id", new Long(1))));
        ...
        issue2.setProject(new MockGenericValue("Project", EasyMap.build("id", new Long(1))));
        ...
        bulkEditBean.initSelectedIssues(EasyList.build(issue1, issue2));
    ...
    public void testTargetIssueObjectsWithSubtasks()
    {
        ...
        parentBulkEditBean.initSelectedIssues(EasyList.build(parentIssue));
