...
public class TestDefaultFavouritesManager extends ListeningTestCase
{
    ...
    public void testAddFavSuccess() throws PermissionException
    {
        ...
        shareManager.hasPermission(user, entity);
    ...
    public void testFavInPosNullUserForAdd() throws PermissionException
    {
        ...
        try
        {
            manager.addFavouriteInPosition(null, entity, 1);
            fail("IAE expected");
        }
        catch (final IllegalArgumentException yay)
        {
    ...
    public void testAddFavInPosHappyPath() throws Exception
    {
        ...
        {
            @Override
            void reorderFavourites(final User user, final SharedEntity entity, final DefaultFavouritesManager.FavouriteReordererCommand favouriteReordererCommand)
            {
    ...
    public void testNullUserForAdd() throws PermissionException
    {
        ...
        try
        {
            manager.addFavourite(null, entity);
            fail("IAE expected");
        }
        catch (final IllegalArgumentException yay)
        {
    ...
    public void testNullTypeForSharableEntityIdentifierType()
    {
        try
        {
            new SharedEntity.Identifier(TestDefaultFavouritesManager.ENTITY_ID, null, (String) null);
    ...
    public void testNullIdForSharableEntityIdentifierType()
    {
        try
        {
            new SharedEntity.Identifier(null, SearchRequest.ENTITY_TYPE, (String) null);
    ...
    public void removeFavouritesForUser()
    {
        ...
        {
            @Override
            public void removeFavourite(final User innerUser, final SharedEntity entity)
            {
    ...
    public void removeFavouritesForUserNullParams()
    {
        ...
        try
        {
            manager.removeFavouritesForUser(null, entity.getEntityType());
    ...
    public void testNullAllParamsForRemove()
    {
        ...
        try
        {
            manager.removeFavourite(null, entity);
    ...
    public void testGetFavouriteIdsNullUserParam()
    {
        ...
        try
        {
            manager.getFavouriteIds(null, entity.getEntityType());
            fail("IllegalArgumentException should have been thrown");
        }
        catch (final IllegalArgumentException e)
        {
