 ...
 */
public class TestAttachmentZipKit extends ListeningTestCase
{
    ...
    public void testExtractInvalidFile()
    {
        ...
        try
        {
            ...
            fail("A: " + ZipException.class.getName() + " was expected.");
        }
        catch (ZipException expected){}
        catch (IOException ioe)
        {
            fail("A: " + IOException.class.getName() + " was thrown while trying to extract an invalid zip file. "
                    + "Instead, a: " + ZipException.class.getName() +  "should have been thrown.");
        }
    }
