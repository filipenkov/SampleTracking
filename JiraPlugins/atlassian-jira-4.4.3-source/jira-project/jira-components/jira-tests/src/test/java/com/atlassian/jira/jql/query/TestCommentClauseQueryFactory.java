...
public class TestCommentClauseQueryFactory extends MockControllerTestCase
{
    ...
    public void testCreateLevelRestrictionQueryForCommentsGroupRestrictions() throws Exception
    {
        ...
        final com.atlassian.crowd.embedded.api.User mockUser = new User("testDude", new MockProviderAccessor(), new MockCrowdService());
        ...
        {
            @Override
            Set<String> getGroups(final com.atlassian.crowd.embedded.api.User searcher)
            {
    ...
    public void testGetQueryHappyPath() throws Exception
    {
        ...
        {
            @Override
            List<Long> getVisibleProjectIds(final com.atlassian.crowd.embedded.api.User searcher)
            {
            ...
            @Override
            BooleanQuery createLevelRestrictionQueryForComments(final List<Long> projectIds, final com.atlassian.crowd.embedded.api.User searcher)
            {
