...
public class TestDefaultWorklogManager extends ListeningTestCase
{

    @Test
    public void testCreateWorklogNullWorklog()
    {
        final DefaultWorklogManager defaultWorklogManager = new DefaultWorklogManager(null, null, null, null);
        try
        {
    ...
    {
        final Mock mockTextAnalyzer = new Mock(TextAnalyzer.class);
        mockTextAnalyzer.expectVoid("analyseContent", P.ANY_ARGS);
        ...
        final DefaultWorklogManager defaultWorklogManager = new DefaultWorklogManager((TextAnalyzer) mockTextAnalyzer.proxy(), null,
    ...
    public void testUpdateWorklogHappyPath()
    {
        ...
        mockEditedWorklog.expectAndReturn("getIssue", null);
        mockEditedWorklog.expectAndReturn("getComment", null);
    ...
    public void testDeleteWorklogHappyPath()
    {
        ...
        final DefaultWorklogManager defaultWorklogManager = new DefaultWorklogManager(null, null, (WorklogStore) mockWorklogStore.proxy(),
