...
public class TestUpgradeManagerImplViaFile extends LegacyJiraMockTestCase
{
    ...
    protected void setUp() throws Exception
    {
        ...
        um = new UpgradeManagerImpl(jiraLicenseService, buildUtilsInfo, i18HelperFactory, applicationProperties,
                buildVersionRegistry, null, "teststandardupgrades.xml", mockDelegator);
    }
    ...
    public Collection<GenericValue> getUpgradeHistory() throws GenericEntityException
    {
        return CoreFactory.getGenericDelegator().findAll("UpgradeHistory", EasyList.build("id ASC"));
    }
}
