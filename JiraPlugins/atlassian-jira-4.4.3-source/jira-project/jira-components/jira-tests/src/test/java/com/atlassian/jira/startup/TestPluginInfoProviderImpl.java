...
public class TestPluginInfoProviderImpl extends MockControllerTestCase
{
    ...
    public void testGetSystemPlugins() throws Exception
    {
        ...
        final Collection<PluginInfoProvider.Info> systemPlugins = infoProvider.getSystemPlugins();
    ...
    public void testGetUserPlugins() throws Exception
    {
        ...
        final Collection<PluginInfoProvider.Info> userPlugins = infoProvider.getUserPlugins();

        standardAsserts(userPlugins, false);
    }

    private void standardAsserts(Collection<PluginInfoProvider.Info> plugins, final boolean isSystemPlugin)
    {
        assertNotNull(plugins);
        assertEquals(3, plugins.size());

        PluginInfoProvider.Info info;
