...
public class TestDefaultColumnLayoutManager extends AbstractUsersTestCase
{
    ...
    protected void setUp() throws Exception
    {
        ...
        clm = new AbstractColumnLayoutManager(defaultFieldManager)
        {
    ...
    protected int setupCustomFieldLayoutItems(int position)
    {
        ...
        UtilsForTests.getTestEntity("FieldLayoutItem", EasyMap.build("fieldlayout", fieldLayout.getLong("id"), "fieldidentifier",
            defaultFieldManager.getCustomFieldManager().getCustomFieldObject(cf1.getLong("id")).getId(), "verticalposition", new Long(position++),
            "ishidden", Boolean.FALSE.toString(), "isrequired", Boolean.FALSE.toString()));
        UtilsForTests.getTestEntity("FieldLayoutItem", EasyMap.build("fieldlayout", fieldLayout.getLong("id"), "fieldidentifier",
            defaultFieldManager.getCustomFieldManager().getCustomFieldObject(cf2.getLong("id")).getId(), "verticalposition", new Long(position++),
            "ishidden", Boolean.FALSE.toString(), "isrequired", Boolean.FALSE.toString()));
        UtilsForTests.getTestEntity("FieldLayoutItem", EasyMap.build("fieldlayout", fieldLayout.getLong("id"), "fieldidentifier",
            defaultFieldManager.getCustomFieldManager().getCustomFieldObject(cf3.getLong("id")).getId(), "verticalposition", new Long(position++),
