...
public class TestDistributionEnvForUpgrade extends TestCase
{
    ...
    {
        super.setUp();
        upgradeHelper = new UpgradeHelper("../../jira-distribution/jira-standalone-distribution/src/main/tomcat/")
        {
    ...
    {
        assertEquals("256m", upgradeHelper.getJvmMinMemory());
        isWindows = true;
        assertEquals("256m", upgradeHelper.getJvmMinMemory());
    }
    ...
    {
        assertEquals("256m", upgradeHelper.getJvmPermSize());
        isWindows = true;
        assertEquals("256m", upgradeHelper.getJvmPermSize());
    }
}
