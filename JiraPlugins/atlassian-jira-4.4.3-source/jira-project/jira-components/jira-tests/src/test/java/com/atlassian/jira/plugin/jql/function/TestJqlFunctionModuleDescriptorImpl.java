 ...
 * @since v4.0
 */
public class TestJqlFunctionModuleDescriptorImpl extends ListeningTestCase
{
    @Test
    public void testInitHappyPath() throws Exception
    {
        final JqlFunctionModuleDescriptor moduleDescriptor = new JqlFunctionModuleDescriptorImpl(new MockSimpleAuthenticationContext(null), null);
