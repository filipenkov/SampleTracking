...
public class TestCurrentAssignee extends AbstractUsersTestCase
{
    ...
    protected void setUp() throws Exception
    {
        ...
        newAssignee = UtilsForTests.getTestUser("Watcher 1");
        newAssignee.setEmail(NEW_ASSIGNEE_EMAIL);
        ...
        CoreFactory.getAssociationManager().createAssociation(newAssignee, issue, "WatchIssue");
        ...
        previousAssignee = UtilsForTests.getTestUser("TestCurrentAssignee_previousAssignee");
        previousAssignee.setEmail("previous_assignee@example.com");
