...
public class TestPieSegmentWrapper extends MockControllerTestCase
{
    ...
    {
        final MockGenericValue mockprojectGV = new MockGenericValue("project",
                EasyMap.build("id", (long) 10000, "name", "homosapien"));

        final MockGenericValue mockprojectGV2 = new MockGenericValue("project",
                EasyMap.build("id", (long) 900, "name", "monkey"));
    ...
    {
        MockProviderAccessor mockProviderAccessor = new MockProviderAccessor();
        User user = new MockOSUser("admin", "Administrator", "");
    ...
    {
        assertConstantPieSegment("resolution", "resolution", "Resolved", "common.resolution.unresolved", "Unresolved");
    }

    @Test
    public void testPriorities()
    {
        assertConstantPieSegment("priority", "priorities", "High", "gadget.filterstats.priority.nopriority", "No Priority!");
    }

    @Test
    public void testIssueType()
    {
        assertConstantPieSegment("issuetype", "issuetype", "Bug", null, null);
    }

    @Test
    public void testStatuses()
    {
        assertConstantPieSegment("status", "statuses", "Open", null, null);
    }
    ...
    private void assertConstantPieSegment(String keyType, String statisticType, String nameTranslation, String i18nNullKey, String i18nNullValue)
    {
        final MockGenericValue mockResolutionGV = new MockGenericValue(keyType, EasyMap.build("id", (long) 5));
        ...
        mockConstantsManager.getIssueConstant(mockResolutionGV);
        mockController.setReturnValue(mockIssueConstant);
        ...
        final PieSegmentWrapper pieSegmentWrapper = new PieSegmentWrapper(mockResolutionGV, mockI18nBean, statisticType, mockConstantsManager, null);

        assertEquals(mockResolutionGV, pieSegmentWrapper.getKey());
    ...
    {
        String customFieldValue = "theValue";


        final CustomField mockCustomField = mockController.getMock(CustomField.class);

        MockControl mockCustomFieldSearcherModuleDescriptorControl = MockClassControl.createControl(CustomFieldSearcherModuleDescriptor.class);
        CustomFieldSearcherModuleDescriptor mockCustomFieldSearcherModuleDescriptor = (CustomFieldSearcherModuleDescriptor) mockCustomFieldSearcherModuleDescriptorControl.getMock();
