...
public class TestJiraDashboardChangeVisitor extends MockControllerTestCase
{
    ...
    public void testGadgetColorChangeNoGadget()
    {
        ...
        final JiraDashboardChangeVisitor visitor = new JiraDashboardChangeVisitor(updatedState, mockPortletConfigurationStore, null, null);
    ...
    {
        final PortletConfigurationStore mockPortletConfigurationStore = mockController.getMock(PortletConfigurationStore.class);
        expect(mockPortletConfigurationStore.getByPortletId(10000L)).andReturn(new PortletConfigurationImpl(10000L, 10020L, "projects", null, 0, 0, new MockPropertySet(), null, Color.color1, Collections.<String, String>emptyMap()));
    ...
    {
        final PortletConfigurationStore mockPortletConfigurationStore = mockController.getMock(PortletConfigurationStore.class);
        final PortletConfigurationImpl pcToDelete = new PortletConfigurationImpl(10020L, 10025L, "projects", null, 0, 1, new MockPropertySet(), null, Color.color1, Collections.<String, String>emptyMap());
    ...
    public void testUpdateLayout()
    {
        ...
        final PortalPage portalPage = PortalPage.id(10025L).name("Test Dashboard").description("").owner("admin").favouriteCount(0L).layout(Layout.AAA).version(0L).build();
        ...
        final PortletConfigurationStore mockPortletConfigurationStore = mockController.getMock(PortletConfigurationStore.class);
        expect(mockPortletConfigurationStore.getByPortletId(10000L)).andReturn(new PortletConfigurationImpl(10000L, 10025L, "projects", null, 0, 0, new MockPropertySet(), null, Color.color1, Collections.<String, String>emptyMap()));
        expect(mockPortletConfigurationStore.getByPortletId(10030L)).andReturn(new PortletConfigurationImpl(10030L, 10025L, "projects", null, 0, 1, new MockPropertySet(), null, Color.color1, Collections.<String, String>emptyMap()));

        //only gadgets in the second column need their position changed.
        expect(mockPortletConfigurationStore.getByPortletId(10040L)).andReturn(new PortletConfigurationImpl(10040L, 10025L, "projects", null, 2, 0, new MockPropertySet(), null, Color.color1, Collections.<String, String>emptyMap()));
        mockPortletConfigurationStore.updateGadgetPosition(10040L, 0, 1, 10025L);
        expect(mockPortletConfigurationStore.getByPortletId(10050L)).andReturn(new PortletConfigurationImpl(10050L, 10025L, "projects", null, 2, 1, new MockPropertySet(), null, Color.color1, Collections.<String, String>emptyMap()));
        mockPortletConfigurationStore.updateGadgetPosition(10050L, 1, 1, 10025L);
        expect(mockPortletConfigurationStore.getByPortletId(10060L)).andReturn(new PortletConfigurationImpl(10060L, 10025L, "projects", null, 2, 2, new MockPropertySet(), null, Color.color1, Collections.<String, String>emptyMap()));
        ...
        mockController.replay();
        final JiraDashboardChangeVisitor visitor = new JiraDashboardChangeVisitor(updatedState, mockPortletConfigurationStore, mockPortalPageStore, null);
    ...
    public void testAddGadget()
    {
        ...
        expect(mockLegacyGadgetUrlProvider.isLegacyGadget(URI.create("http://example.gadet/spec2.xml"))).andReturn(false);
        ...
        final DashboardState updatedState = dashboard(DashboardId.valueOf(Long.toString(10025))).title("My Dashboard").
                layout(Layout.AA).columns(columns).build();
        mockController.replay();
        final JiraDashboardChangeVisitor visitor = new JiraDashboardChangeVisitor(updatedState, mockPortletConfigurationStore, null, mockLegacyGadgetUrlProvider);
