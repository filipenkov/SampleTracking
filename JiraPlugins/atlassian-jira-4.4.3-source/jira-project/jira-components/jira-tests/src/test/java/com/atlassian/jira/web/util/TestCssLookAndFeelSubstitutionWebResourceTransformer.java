...
public class TestCssLookAndFeelSubstitutionWebResourceTransformer extends ListeningTestCase
{
    ...
    private String transform(String input, LookAndFeelBean lAndF)
    {
        ...
        CssSubstitutionWebResourceTransformer.CssSubstitutionDownloadableResource r = new CssSubstitutionWebResourceTransformer.CssSubstitutionDownloadableResource(resource, lAndF);
