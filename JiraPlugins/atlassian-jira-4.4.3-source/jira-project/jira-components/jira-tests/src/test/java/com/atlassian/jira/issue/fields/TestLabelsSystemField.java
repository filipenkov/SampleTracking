 ...
 * @since v4.2
 */
public class TestLabelsSystemField extends ListeningTestCase
{
    ...
    public void setUp() throws Exception
    {
        ...
        labelsSystemField = new LabelsSystemField(null, null, mockAuthenticationContext, null, null, mockLabelManager, null);
    ...
    public void testGoodLabels()
    {
        expect(mockContext.getFieldValuesHolder())
                .andReturn(MapBuilder.newBuilder().add(IssueFieldConstants.LABELS,
    ...
    public void testEmptyLabelsIsRequired()
    {
        ...
        assertEquals("issue.field.required", errors.getErrors().get("labels"));
        verify(mockContext, mockErrors, mockI18n, mockRenderLayoutItem);
    }
