...
public class TestProfileLinkUserFormat extends ListeningTestCase
{
    ...
    public void testGetHtmlNullUser()
    {
        ...
        mockUserFormatModuleDescriptor.getHtml("view", EasyMap.build("username", null, "user", null, "fullname", null, "id", "testid", "userAvatarEnabled", false, "avatarURL", avatar10023Url));
    ...
    public void testGetHtmlUnknownUser()
    {
        ...
        UserFormatModuleDescriptor mockUserFormatModuleDescriptor = (UserFormatModuleDescriptor) mockUserFormatModuleDescriptorControl.getMock();
        ProfileLinkUserFormat userFormat = new ProfileLinkUserFormat(mockUserFormatModuleDescriptor, mockUserUtil, mockAvatarService, jiraAuthenticationContext);
        mockUserFormatModuleDescriptor.getHtml("view", EasyMap.build("username", "unknown", "user", null, "fullname", "unknown", "id", "testid", "userAvatarEnabled", false, "avatarURL", avatar10023Url));
    ...
    public void testGetHtmlKnownUserWithFullName()
    {
        ...
        UserFormatModuleDescriptor mockUserFormatModuleDescriptor = (UserFormatModuleDescriptor) mockUserFormatModuleDescriptorControl.getMock();
        ProfileLinkUserFormat userFormat = new ProfileLinkUserFormat(mockUserFormatModuleDescriptor, mockUserUtil, mockAvatarService, jiraAuthenticationContext);
        mockUserFormatModuleDescriptor.getHtml("view", EasyMap.build("username", "admin", "user", adminUser, "fullname", "Administrator", "id", "testid", "userAvatarEnabled", false, "avatarURL", avatar10023Url));
    ...
    public void testGetHtmlKnownUserWithNoFullName()
    {
        ...
        UserFormatModuleDescriptor mockUserFormatModuleDescriptor = (UserFormatModuleDescriptor) mockUserFormatModuleDescriptorControl.getMock();
        ProfileLinkUserFormat userFormat = new ProfileLinkUserFormat(mockUserFormatModuleDescriptor, mockUserUtil, mockAvatarService, jiraAuthenticationContext);
        mockUserFormatModuleDescriptor.getHtml("view", EasyMap.build("username", "admin", "user", adminUser, "fullname", "admin", "id", "testid", "userAvatarEnabled", false, "avatarURL", avatar10023Url));
        mockUserFormatModuleDescriptorControl.setReturnValue("<a>admin</a>");
        mockUserFormatModuleDescriptorControl.replay();
    ...
    public void testGetHtmlWithAvatar()
    {
        ...
        mockUserFormatModuleDescriptor.getHtml("view", EasyMap.build("username", "admin", "user", adminUser,
                "fullname", "Administrator", "id", "testid", "userAvatarEnabled", true, "avatarURL", avatar10023Url));
        mockUserFormatModuleDescriptorControl.setReturnValue("<a>admin</a>");
        mockUserFormatModuleDescriptorControl.replay();
    ...
    protected void mockAvatarService(boolean avatarsEnabled)
    {
        ...
        expect(mockAvatarService.isUserAvatarsEnabled()).andReturn(avatarsEnabled).anyTimes();
