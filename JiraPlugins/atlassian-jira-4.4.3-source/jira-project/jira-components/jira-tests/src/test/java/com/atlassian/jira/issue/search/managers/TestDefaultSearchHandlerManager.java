...
public class TestDefaultSearchHandlerManager extends MockControllerTestCase
{
    ...
    public void testConstructor() throws Exception
    {
        ...
        try
        {
            new DefaultSearchHandlerManager(fieldManager, null, systemClauseHandlerFactory, null, null);
        ...
        try
        {
            new DefaultSearchHandlerManager(null, customFieldManager, systemClauseHandlerFactory, null, null);
        ...
        try
        {
            new DefaultSearchHandlerManager(fieldManager, customFieldManager, null, null, null);
            fail("Should not accept null field manager.");
        }
        catch (IllegalArgumentException iae)
        {
    ...
    public void testSystemFields() throws Exception
    {
        ...
        assertTrue(defaultSearchHandlerManager.getSearchersByClauseName(null, "noid", null).isEmpty());
     ...
     */
    @Test
    public void testSystemFieldsNoPermission() throws Exception
    {
        ...
        assertClauseHandlers(defaultSearchHandlerManager, false, field1, field3, field4);
        assertSearchersByClauseName(defaultSearchHandlerManager, field1, field3, field4);
        assertClauseNamesByField(defaultSearchHandlerManager, field1, field3, field4);
        assertFieldByClauseNames(defaultSearchHandlerManager, false, field1, field3, field4);

        //Make sure we can't see sys2 directly.
        assertTrue(defaultSearchHandlerManager.getClauseHandler(null, "sys2").isEmpty());
        assertTrue(defaultSearchHandlerManager.getSearchersByClauseName(null, "sys2", null).isEmpty());
    ...
    public void testBadArguments() throws Exception
    {
        ...
        try
        {
            defaultSearchHandlerManager.getSearchersByClauseName(null, null, null);
            fail("Should not accept illegal argument.");
        }
        catch (IllegalArgumentException e)
        {
    ...
    private static void assertSearchers(final DefaultSearchHandlerManager defaultSearchHandlerManager, final SearchableField... fields)
    {
        ...
        for (SearcherGroup group : defaultSearchHandlerManager.getSearcherGroups(null))
        {
    ...
    private static void assertSearchersByClauseName(final DefaultSearchHandlerManager defaultSearchHandlerManager, final SearchableField... fields)
    {
        ...
        {
            final Collection<IssueSearcher<?>> searchersByClauseName = defaultSearchHandlerManager.getSearchersByClauseName(null, entry.getKey(), null);
