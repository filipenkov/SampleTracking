...
public class TestEnterpriseDeleteIssueType extends LegacyJiraMockTestCase
{
    ...
    private void setUpEnterpriseTests()
    {
        ...
        testUser = new User("test", new MockProviderAccessor(), new MockCrowdService());
    ...
    private DeleteIssueType newInstance()
    {
        ...
        return new DeleteIssueType(ComponentAccessor.getFieldLayoutManager(),
                ComponentAccessor.getProjectManager(),
                ComponentAccessor.getWorkflowManager(),
                ComponentAccessor.getWorkflowSchemeManager(),
                ComponentManager.getInstance().getIssueTypeScreenSchemeManager(),
                mockCustomFieldManager, mockIssueTypeSchemeManager, (FieldConfigSchemeManager) mockFieldConfigSchemeManager.proxy());
    }
    ...
    public void testEnterpriseNewTypeDifferentLayoutScheme() throws Exception
    {
        ...
        IssueTypeScreenSchemeManager issueTypeScreenSchemeManager = ComponentManager.getInstance().getIssueTypeScreenSchemeManager();
    ...
    public void testEnterpriseAvailableTypeExists() throws WorkflowException, GenericEntityException
    {
        ...
        Collection availableIssueTypes = deleteIssueType.getAvailableIssueTypes();
        assertFalse(availableIssueTypes.isEmpty());
        assertEquals(newIssueType, availableIssueTypes.iterator().next());
    }
