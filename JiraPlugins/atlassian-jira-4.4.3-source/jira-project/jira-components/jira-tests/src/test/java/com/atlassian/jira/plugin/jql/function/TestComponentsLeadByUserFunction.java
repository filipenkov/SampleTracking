...
public class TestComponentsLeadByUserFunction extends MockControllerTestCase
{
    ...
    public void testValidateWrongArgs() throws Exception
    {
        ...
        MessageSet messageSet = componentsLeadByUserFunction.validate(new User("bob", new MockProviderAccessor(), new MockCrowdService()), new FunctionOperand("componentsLeadByUser", "badArg1", "badArg2"), terminalClause);
        ...
        replay(userUtil);
        messageSet = componentsLeadByUserFunction.validate(new User("bob", new MockProviderAccessor(), new MockCrowdService()), new FunctionOperand("componentsLeadByUser", "badUser"), terminalClause);
        assertEquals(1, messageSet.getErrorMessages().size());
    ...
    public void testValidateHappyPath() throws Exception
    {
        ...
        MessageSet messageSet = componentsLeadByUserFunction.validate(new User("bob", new MockProviderAccessor(), new MockCrowdService()), new FunctionOperand("componentsLeadByUser"), terminalClause);
        assertFalse(messageSet.hasAnyErrors());

        // One valid user name supplied
        EasyMock.expect(userUtil.getUser("fred")).andReturn(theUser);
        replay(userUtil);
        messageSet = componentsLeadByUserFunction.validate(new User("bob", new MockProviderAccessor(), new MockCrowdService()), new FunctionOperand("componentsLeadByUser", "fred"), terminalClause);
        assertFalse(messageSet.hasAnyErrors());
    }
    ...
    public void testGetValuesHappyPath() throws Exception
    {
        ...
        EasyMock.expect(permissionManager.hasPermission(Permissions.BROWSE, project1, (com.atlassian.crowd.embedded.api.User) theUser)).andReturn(true);
        EasyMock.expect(permissionManager.hasPermission(Permissions.BROWSE, project2, (com.atlassian.crowd.embedded.api.User) theUser)).andReturn(true);
        EasyMock.expect(permissionManager.hasPermission(Permissions.BROWSE, project3, (com.atlassian.crowd.embedded.api.User) theUser)).andReturn(true);
        EasyMock.expect(permissionManager.hasPermission(Permissions.BROWSE, project3, (com.atlassian.crowd.embedded.api.User) theUser)).andReturn(true);

        User bill = new User("bill", new MockProviderAccessor(), new MockCrowdService());
        ...
        EasyMock.expect(projectManager.getProjectObj(component4.getProjectId())).andReturn(project3);
        EasyMock.expect(permissionManager.hasPermission(Permissions.BROWSE, project1, (com.atlassian.crowd.embedded.api.User) theUser)).andReturn(true);
        EasyMock.expect(permissionManager.hasPermission(Permissions.BROWSE, project2, (com.atlassian.crowd.embedded.api.User) theUser)).andReturn(false);
        EasyMock.expect(permissionManager.hasPermission(Permissions.BROWSE, project3, (com.atlassian.crowd.embedded.api.User) theUser)).andReturn(false);
        EasyMock.expect(permissionManager.hasPermission(Permissions.BROWSE, project3, (com.atlassian.crowd.embedded.api.User) theUser)).andReturn(false);

        bill = new User("bill", new MockProviderAccessor(), new MockCrowdService());
        EasyMock.expect(userUtil.getUserObject("bill")).andReturn(bill);
        EasyMock.expect(projectComponentManager.findComponentsByLead("bill")).andReturn(componentsList2);
        EasyMock.expect(projectManager.getProjectObj(component1.getProjectId())).andReturn(project1);
        EasyMock.expect(projectManager.getProjectObj(component2.getProjectId())).andReturn(project2);
    ...
    public void testGetValuesAnonymous()
    {
        ...
        EasyMock.expect(projectManager.getProjectObj(component1.getProjectId())).andReturn(project1);
        EasyMock.expect(projectManager.getProjectObj(component2.getProjectId())).andReturn(project2);
        EasyMock.expect(permissionManager.hasPermission(Permissions.BROWSE, project1, (com.atlassian.crowd.embedded.api.User) null)).andReturn(true);
        EasyMock.expect(permissionManager.hasPermission(Permissions.BROWSE, project2, (com.atlassian.crowd.embedded.api.User) null)).andReturn(true);
        replay(userUtil, projectComponentManager, projectManager, permissionManager);
        ...
        EasyMock.expect(projectManager.getProjectObj(component1.getProjectId())).andReturn(project1);
        EasyMock.expect(projectManager.getProjectObj(component2.getProjectId())).andReturn(project2);
        EasyMock.expect(permissionManager.hasPermission(Permissions.BROWSE, project1, (com.atlassian.crowd.embedded.api.User) null)).andReturn(false);
        EasyMock.expect(permissionManager.hasPermission(Permissions.BROWSE, project2, (com.atlassian.crowd.embedded.api.User) null)).andReturn(false);
        replay(userUtil, projectComponentManager, projectManager, permissionManager);
