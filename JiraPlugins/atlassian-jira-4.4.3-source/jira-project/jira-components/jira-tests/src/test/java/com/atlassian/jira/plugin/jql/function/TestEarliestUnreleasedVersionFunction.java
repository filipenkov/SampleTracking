 ...
 * @since v4.3
 */
public class TestEarliestUnreleasedVersionFunction extends ListeningTestCase
{
    ...
    public void setUp() throws Exception
    {
        ...
        unreleasedVersionList.add(new MockVersion(3, "V5", project1, 5l));
    ...
    @Test
    public void testValidateTooFewArguments() throws Exception
    {
        ...
        EarliestUnreleasedVersionFunction earliestUnreleasedVersionFunction = new EarliestUnreleasedVersionFunction(versionManager, projectResolver, permissionmanager)
        {
            @Override
        ...
        FunctionOperand function = new FunctionOperand(EarliestUnreleasedVersionFunction.FUNCTION_EARLIEST_UNRELEASED_VERSION, new ArrayList<String>());
        final MessageSet messageSet = earliestUnreleasedVersionFunction.validate(null, function, terminalClause);
        ...
        assertEquals("Function 'earliestUnreleasedVersion' expected '1' arguments but received '0'.", messageSet.getErrorMessages().iterator().next());
    }
    ...
    public void testValidateTooManyArguments() throws Exception
    {
        ...
        earliestunreleasedversionFunction.init(MockJqlFunctionModuleDescriptor.create("earliestUnreleasedVersion", true));

        FunctionOperand function = new FunctionOperand(EarliestUnreleasedVersionFunction.FUNCTION_EARLIEST_UNRELEASED_VERSION, Arrays.asList("should", "not", "be", "here"));
        final MessageSet messageSet = earliestunreleasedversionFunction.validate(null, function, terminalClause);
        assertTrue(messageSet.hasAnyMessages());
        assertTrue(messageSet.hasAnyErrors());
        assertFalse(messageSet.hasAnyWarnings());
        assertEquals(1, messageSet.getErrorMessages().size());
        assertEquals("Function 'earliestUnreleasedVersion' expected '1' arguments but received '4'.", messageSet.getErrorMessages().iterator().next());
    }
    ...
    public void testValidateProjectArgument() throws Exception
    {
        ...
        earliestunreleasedversionFunction.init(MockJqlFunctionModuleDescriptor.create("earliestUnreleasedVersion", true));
        FunctionOperand function = new FunctionOperand(EarliestUnreleasedVersionFunction.FUNCTION_EARLIEST_UNRELEASED_VERSION, Arrays.asList("c1"));
    ...
    public void testValidateBadProjectArgument() throws Exception
    {
        ...
        earliestunreleasedversionFunction.init(MockJqlFunctionModuleDescriptor.create("earliestUnreleasedVersion", true));
        FunctionOperand function = new FunctionOperand(EarliestUnreleasedVersionFunction.FUNCTION_EARLIEST_UNRELEASED_VERSION, Arrays.asList("badproject"));
        ...
        assertFalse(messageSet.hasAnyWarnings());
        assertEquals(1, messageSet.getErrorMessages().size());
        assertEquals("Could not resolve the project 'badproject' provided to function 'earliestUnreleasedVersion'.", messageSet.getErrorMessages().iterator().next());
    }
    ...
    public void testDataType() throws Exception
    {
        ...
        final VersionManager versionManager = EasyMock.createMock(VersionManager.class);
        EarliestUnreleasedVersionFunction earliestunreleasedversionFunction = new EarliestUnreleasedVersionFunction(versionManager, projectResolver, permissionmanager);
        assertEquals(JiraDataTypes.VERSION, earliestunreleasedversionFunction.getDataType());
    }
    ...
    public void testGetValues() throws Exception
    {
        ...
        EasyMock.expect(versionManager.getVersionsUnreleased(Long.valueOf(21), true)).andReturn(unreleasedVersionList);
        EasyMock.replay(projectResolver, permissionmanager, versionManager);

        final List<QueryLiteral> value = earliestunreleasedversionFunction.getValues(queryCreationContext, function, terminalClause);
        assertNotNull(value);
        assertEquals(1, value.size());
        assertEquals(4, value.get(0).getLongValue().longValue());
    }
    ...
    public void testGetValuesNoVersions() throws Exception
    {
        ...
        EasyMock.expect(projectResolver.get(21l)).andReturn(project1);
        EasyMock.expect(permissionmanager.hasPermission(Permissions.BROWSE, project1, theUser)).andReturn(true);
        EasyMock.expect(versionManager.getVersionsUnreleased(Long.valueOf(21), true)).andReturn(Collections.<Version>emptyList());
        EasyMock.replay(projectResolver, permissionmanager, versionManager);
    ...
    public void testGetMinimumNumberOfExpectedArguments() throws Exception
    {
        ...
        final VersionManager versionManager = EasyMock.createMock(VersionManager.class);
        EarliestUnreleasedVersionFunction earliestunreleasedversionFunction = new EarliestUnreleasedVersionFunction(versionManager, projectResolver, permissionmanager);
        assertEquals(1, earliestunreleasedversionFunction.getMinimumNumberOfExpectedArguments());
    }
