...
public class TestMembersOfFunction extends MockControllerTestCase
{
    ...
    private com.opensymphony.user.User testUser;

    @Before
    public void setUp() throws Exception
    {

        testUser = new MockOSUser("theUser");
        ...
        queryCreationContext = new QueryCreationContextImpl(null);
    }
    ...
    {
//        Group testGroup = UtilsForTests.getTestGroup("groupFunctionTestGroupDoesNotExist");
//        try
//        {
...
//        }
    ...
    {
//        Group testGroup1 = UtilsForTests.getTestGroup("groupForTest");
//        Group testGroup2 = UtilsForTests.getTestGroup("GROUPforTEST");
//        User testUser1 = UtilsForTests.getTestUser("groupUser1");
//        User testUser2 = UtilsForTests.getTestUser("groupUser2");
...
//        {
        ...
        List<Group> groups = Collections.singletonList(groupForTest);
        SortedSet<User> setOfUsers = new TreeSet<User>(new UserBestNameComparator());
        setOfUsers.add(userForTest);
        setOfUsers.add(user2ForTest);
        EasyMock.expect(userUtil.getAllUsersInGroups(groups)).andReturn(setOfUsers);

        groups = Collections.singletonList(group2ForTest);
        setOfUsers = new TreeSet<User>(new UserBestNameComparator());
        setOfUsers.add(user2ForTest);
        EasyMock.expect(userUtil.getAllUsersInGroups(groups)).andReturn(setOfUsers);
