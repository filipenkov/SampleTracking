...
public class TestTrustedApplicationSyntacticValidator extends ListeningTestCase
{
    class Fields
    {
    ...
    {
        return new JiraServiceContextImpl(new User("name", new MockProviderAccessor(), new MockCrowdService()));
    }
}
