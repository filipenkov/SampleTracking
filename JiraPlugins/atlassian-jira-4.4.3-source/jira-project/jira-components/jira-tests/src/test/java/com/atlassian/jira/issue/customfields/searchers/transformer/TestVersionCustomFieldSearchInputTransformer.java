...
public class TestVersionCustomFieldSearchInputTransformer extends MockControllerTestCase
{
    ...
    public void testGetParamsFromSearchRequest() throws Exception
    {
        ...
        indexInputHelper.getAllNavigatorValuesForMatchingClauses(theUser, new ClauseNames(name), query, searchContext);
    ...
    public void testGetClauseFromParamsValuesGetFiltered() throws Exception
    {
        ...
        transformer = new VersionCustomFieldSearchInputTransformer(clauseName, new ClauseNames(clauseName), customField, indexInfoResolver, operandResolver, fieldFlagOperandRegistry, searchContextVisibilityChecker, versionResolver, customFieldInputHelper, versionManager)
        {
            @Override
            IndexedInputHelper getIndexedInputHelper()
            {
    ...
    public void testGetSearchClauseNoNavigatorValues() throws Exception
    {
        ...
        transformer = new VersionCustomFieldSearchInputTransformer(urlParameterName, clauseNames, customField, indexInfoResolver, operandResolver, fieldFlagOperandRegistry, searchContextVisibilityChecker, versionResolver, customFieldInputHelper, versionManager);
        replay();
