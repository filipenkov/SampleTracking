...
public class TestWorkflowEditorTransitionConditionUtil extends ListeningTestCase
{
    ...
    public void testDeleteCondition()
    {
        ...
        conditionsDescriptor.setConditions(EasyList.build(condition1, DescriptorFactory.getFactory().createConditionDescriptor()));
    ...
    {
        conditionsDescriptor.setConditions(EasyList.build(DescriptorFactory.getFactory().createConditionDescriptor()));
    ...
    public void testDeleteLastNestedCondition()
    {
        ...
        conditionsDescriptor2.setConditions(EasyList.build(DescriptorFactory.getFactory().createConditionDescriptor()));
        conditionsDescriptor.setConditions(EasyList.build(conditionsDescriptor2));
    ...
    public void testDeleteLastDoublyNestedCondition()
    {
        ...
        conditionsDescriptor2.setConditions(EasyList.build(conditionsDescriptor3));
        conditionsDescriptor3.setConditions(EasyList.build(DescriptorFactory.getFactory().createConditionDescriptor()));
        conditionsDescriptor.setConditions(EasyList.build(conditionsDescriptor2));
    ...
    public void testDeleteNestedCondition()
    {
        ...
        conditionsDescriptor.setConditions(EasyList.build(conditionsDescriptor2, conditionDescriptor));
    ...
    public void testDeleteNestedCondition2()
    {
        ...
        conditionsDescriptor2.setConditions(EasyList.build(conditionDescriptor, conditionDescriptor2, conditionDescriptor3));

        ConditionDescriptor conditionDescriptor4 = DescriptorFactory.getFactory().createConditionDescriptor();
        conditionsDescriptor.setConditions(EasyList.build(conditionsDescriptor2, conditionDescriptor4));
    ...
    public void testDeleteSecondLastCondition()
    {
        ...
        ConditionsDescriptor conditionsDescriptor2 = DescriptorFactory.getFactory().createConditionsDescriptor();
        conditionsDescriptor2.setConditions(EasyList.build(DescriptorFactory.getFactory().createConditionDescriptor(), DescriptorFactory.getFactory().createConditionDescriptor()));


        ConditionsDescriptor conditionsDescriptor3 = DescriptorFactory.getFactory().createConditionsDescriptor();
        ConditionDescriptor conditionDescriptor = DescriptorFactory.getFactory().createConditionDescriptor();
        ConditionDescriptor conditionDescriptor2 = DescriptorFactory.getFactory().createConditionDescriptor();
        conditionsDescriptor3.setConditions(EasyList.build(conditionDescriptor, conditionDescriptor2));

        ConditionDescriptor conditionDescriptor4 = DescriptorFactory.getFactory().createConditionDescriptor();
        conditionsDescriptor.setConditions(EasyList.build(conditionsDescriptor2, conditionsDescriptor3, conditionDescriptor4));
    ...
    public void testDeleteLastConditionInBlock()
    {
        ...
        ConditionDescriptor conditionDescriptor = DescriptorFactory.getFactory().createConditionDescriptor();
        ConditionDescriptor conditionDescriptor2 = DescriptorFactory.getFactory().createConditionDescriptor();
        conditionsDescriptor2.setConditions(EasyList.build(conditionDescriptor, conditionDescriptor2));

        ConditionDescriptor conditionDescriptor3 = DescriptorFactory.getFactory().createConditionDescriptor();
        conditionsDescriptor.setConditions(EasyList.build(conditionsDescriptor2, conditionDescriptor3));
    ...
    public void testDeleteFirstConditionWithMultipleBlocks()
    {
        ...
        conditionsDescriptor1.setConditions(EasyList.build(conditionDescriptor11, conditionDescriptor12));
        ...
        conditionsDescriptor2.setConditions(EasyList.build(conditionDescriptor21, conditionDescriptor22));


        conditionsDescriptor.setConditions(EasyList.build(conditionsDescriptor1, conditionsDescriptor2));
    ...
    public void testAddConditionToExistingBlock()
    {
        ...
        ConditionDescriptor conditionDescriptor2 = DescriptorFactory.getFactory().createConditionDescriptor();
        ConditionsDescriptor conditionsDescriptor2 = DescriptorFactory.getFactory().createConditionsDescriptor();
        conditionsDescriptor.setConditions(EasyList.build(conditionsDescriptor2, conditionDescriptor1, conditionDescriptor2));
    ...
    public void testAddConditionToExistingNestedBlock()
    {
        ...
        ConditionDescriptor conditionDescriptor1 = DescriptorFactory.getFactory().createConditionDescriptor();
        ConditionDescriptor conditionDescriptor2 = DescriptorFactory.getFactory().createConditionDescriptor();
        conditionsDescriptor.setConditions(EasyList.build(conditionsDescriptor1, conditionsDescriptor2, conditionDescriptor1, conditionDescriptor2));
    ...
    public void testAddConditionToDoublyExistingNestedBlock()
    {
        ...
        conditionsDescriptor21.setConditions(EasyList.build(conditionDescriptor211, conditionDescriptor212));

        ConditionDescriptor conditionDescriptor22 = DescriptorFactory.getFactory().createConditionDescriptor();
        conditionsDescriptor2.setConditions(EasyList.build(conditionsDescriptor21, conditionDescriptor22));
    ...
    public void testAddNestedConditionsDescriptor()
    {
        ConditionDescriptor conditionDescriptor = DescriptorFactory.getFactory().createConditionDescriptor();
        ConditionDescriptor conditionDescriptor2 = DescriptorFactory.getFactory().createConditionDescriptor();
        conditionsDescriptor.setConditions(EasyList.build(conditionDescriptor, conditionDescriptor2));
    ...
    public void testAddDoublyNestedConditionsDescriptor()
    {
        ...
        ConditionDescriptor conditionDescriptor = DescriptorFactory.getFactory().createConditionDescriptor();
        ConditionDescriptor conditionDescriptor2 = DescriptorFactory.getFactory().createConditionDescriptor();
        conditionsDescriptor.setConditions(EasyList.build(conditionsDescriptor1, conditionsDescriptor2, conditionDescriptor, conditionDescriptor2));
    ...
    private void _testChangeOperatorOfNestedBlock(String oldOperator, String newOperator)
    {
        ...
        ConditionDescriptor conditionDescriptor11 = DescriptorFactory.getFactory().createConditionDescriptor();
        ConditionDescriptor conditionDescriptor12 = DescriptorFactory.getFactory().createConditionDescriptor();
        nestedDescriptor.setConditions(EasyList.build(conditionDescriptor11, conditionDescriptor12));

        ConditionsDescriptor nestedDescriptor2 = DescriptorFactory.getFactory().createConditionsDescriptor();
        ConditionDescriptor conditionDescriptor21 = DescriptorFactory.getFactory().createConditionDescriptor();
        ConditionDescriptor conditionDescriptor22 = DescriptorFactory.getFactory().createConditionDescriptor();
        nestedDescriptor2.setConditions(EasyList.build(conditionDescriptor21, conditionDescriptor22));

        ConditionDescriptor conditionDescriptor = DescriptorFactory.getFactory().createConditionDescriptor();
        conditionsDescriptor.setConditions(EasyList.build(nestedDescriptor, nestedDescriptor2, conditionDescriptor));
