 ...
 * @since v4.0
 */
public class TestJqlParseErrorMessages extends ListeningTestCase
{
    @Test
    ...
    public void testGenericErrorToken() throws Exception
    {
        ...
        actualMessage = JqlParseErrorMessages.genericParseError(Token.EOF_TOKEN);
        assertEquals(expectedMessage, actualMessage);
    ...
    public void testBadFieldName() throws Exception
    {
        ...
        JqlParseErrorMessage actualMessage = JqlParseErrorMessages.badFieldName(Token.EOF_TOKEN);
        assertEquals(expectedMessage, actualMessage);
    ...
    public void testBadSortOrder() throws Exception
    {
        ...
        JqlParseErrorMessage actualMessage = JqlParseErrorMessages.badSortOrder(Token.EOF_TOKEN);
        assertEquals(expectedMessage, actualMessage);
    ...
    public void testBadOperator() throws Exception
    {
        ...
        JqlParseErrorMessage actualMessage = JqlParseErrorMessages.badOperator(Token.EOF_TOKEN);
        assertEquals(expectedMessage, actualMessage);
    ...
    public void testBadCustomFieldId() throws Exception
    {
        ...
        JqlParseErrorMessage actualMessage = JqlParseErrorMessages.badCustomFieldId(Token.EOF_TOKEN);
        assertEquals(expectedMessage, actualMessage);
    ...
    public void testNeedLogicalOperator() throws Exception
    {
        ...
        JqlParseErrorMessage actualMessage = JqlParseErrorMessages.needLogicalOperator(Token.EOF_TOKEN);
        assertEquals(expectedMessage, actualMessage);
    ...
    public void testBadOperand() throws Exception
    {
        ...
        JqlParseErrorMessage actualMessage = JqlParseErrorMessages.badOperand(Token.EOF_TOKEN);
        assertEquals(expectedMessage, actualMessage);
    ...
    public void testBadFunctionArgument() throws Exception
    {
        ...
        JqlParseErrorMessage actualMessage = JqlParseErrorMessages.badFunctionArgument(Token.EOF_TOKEN);
        assertEquals(expectedMessage, actualMessage);
    ...
    public void testEmptyFunctionArgument() throws Exception
    {
        ...
        JqlParseErrorMessage actualMessage = JqlParseErrorMessages.emptyFunctionArgument(Token.EOF_TOKEN);
        assertEquals(expectedMessage, actualMessage);
    ...
    public void testExpectedText() throws Exception
    {
        ...
        JqlParseErrorMessage actualMessage = JqlParseErrorMessages.expectedText(Token.EOF_TOKEN, "end");
        assertEquals(expectedMessage, actualMessage);
        ...
        try
        {
            JqlParseErrorMessages.expectedText(Token.EOF_TOKEN, null);
            fail("Expected an error to be thrown.");
        }
        catch (IllegalArgumentException ignored)
        {
    ...
    public void testExpectedText2() throws Exception
    {
        ...
        JqlParseErrorMessage actualMessage = JqlParseErrorMessages.expectedText(Token.EOF_TOKEN, "end", "here");
        assertEquals(expectedMessage, actualMessage);
        ...
        try
        {
            JqlParseErrorMessages.expectedText(Token.EOF_TOKEN, null, "hjsahdkas");
            fail("Expected an error to be thrown.");
        }
        catch (IllegalArgumentException ignored)
        {
        ...
        try
        {
            JqlParseErrorMessages.expectedText(Token.EOF_TOKEN, "hrewhrejw", null);
            fail("Expected an error to be thrown.");
        }
        catch (IllegalArgumentException ignored)
        {
