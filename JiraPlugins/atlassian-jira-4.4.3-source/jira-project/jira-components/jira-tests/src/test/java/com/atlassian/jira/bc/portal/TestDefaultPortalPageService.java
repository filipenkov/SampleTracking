...
public class TestDefaultPortalPageService extends ListeningTestCase
{
    ...
    protected MockProviderAccessor mpa;
    protected User notTheOwner;
    ...
    public void setUp() throws Exception
    {
        ...
        portalPage3 = PortalPage.id(3L).name("three").description("three description").owner(user.getName()).build();
        portalPageClone = PortalPage.id(CLONE_ID).name("clone").description("clone description").owner(user.getName()).build();
        portalPageSystemDefault = PortalPage.id(CLONE_ID).name("clone").description("clone description").systemDashboard().build();

        final User notUser = new User("notMe", mpa, new MockCrowdService());
        portalPageNotOwnedByUser = PortalPage.id(CLONE_ID).name("notownedbyuser").description("").owner(notUser.getName()).build();
        notTheOwner = new User("notTheOwner", mpa, new MockCrowdService());
    }
    ...
    public void testFavouritePortalPages()
    {
        ...
        expect(favouritesManager.getFavouriteIds((com.atlassian.crowd.embedded.api.User) user, PortalPage.ENTITY_TYPE)).andReturn(favouriteIds);
    ...
    public void testFavouritePortalPagesNullUser()
    {
        ...
        final Collection results = service.getFavouritePortalPages(null);
    ...
    {
        expect(favouritesManager.getFavouriteIds((com.atlassian.crowd.embedded.api.User) user, PortalPage.ENTITY_TYPE)).andReturn(Collections.<Long>emptyList());
    ...
    /**
     * Check that {@link DefaultPortalPageService#isFavourite(com.opensymphony.user.User,
    ...
    {
        expect(favouritesManager.isFavourite((com.atlassian.crowd.embedded.api.User) user, portalPage1)).andReturn(true);

        expect(favouritesManager.isFavourite((com.atlassian.crowd.embedded.api.User) user, portalPage2)).andReturn(false);
    ...
    public void testIsFavouriteAnonymousUser()
    {
        ...
        assertFalse(service.isFavourite(null, portalPage2));
        assertFalse(service.isFavourite(null, portalPage3));
    }
    ...
    {
        expect(favouritesManager.isFavourite((com.atlassian.crowd.embedded.api.User) user, portalPage1)).andThrow(new PermissionException("testIsFavouriteWithException"));
    ...
    {
        expect(portalPageManager.getAllOwnedPortalPages((com.atlassian.crowd.embedded.api.User) user)).andReturn(Arrays.asList(portalPage3, portalPage2));
    ...
    {
        expect(portalPageManager.getAllOwnedPortalPages((com.atlassian.crowd.embedded.api.User) user)).andReturn(Arrays.asList(portalPage1, portalPage2, portalPage3));
        ...
        favouritesManager.removeFavouritesForUser((com.atlassian.crowd.embedded.api.User) user, PortalPage.ENTITY_TYPE);
        final PortalPageService service = createPortalPageService();
    ...
    public void testDeletePortalPage()
    {
        ...
        expect(portalPageManager.getPortalPage((com.atlassian.crowd.embedded.api.User) user, portalPage1.getId())).andReturn(portalPage1);
        portalPageManager.delete(portalPage1.getId());
    ...
    {
        final PortalPage pageOwnedByAnother = PortalPage.name("name").description("desc").owner("other").build();
    ...
    {
        expect(portalPageManager.getPortalPageById(portalPage1.getId())).andReturn(portalPage1);
        expect(portalPageManager.getPortalPage((com.atlassian.crowd.embedded.api.User) user, portalPage1.getId())).andReturn(null);
    ...
    {
        expect(portalPageManager.getPortalPage(null, portalPage1.getId())).andReturn(portalPage1);
    ...
    public void testGetPortalPageAnonymousUserDoesntExist()
    {
        ...
        expect(portalPageManager.getPortalPage(null, nonExistentId)).andReturn(null);
    ...
    public void testGetNonPrivatePortalPagesAll()
    {
        ...
        expect(portalPageManager.getAllOwnedPortalPages((com.atlassian.crowd.embedded.api.User) user)).andReturn(portalPages);
    ...
    public void testGetNonPrivatePortalPagesNullUser()
    {
        ...
        final Collection results = service.getNonPrivatePortalPages(null);
    ...
    {
        expect(portalPageManager.getAllOwnedPortalPages((com.atlassian.crowd.embedded.api.User) user)).andReturn(Collections.<PortalPage>emptyList());
    ...
    {
        portalPage1 = PortalPage.id(1L).name("one").description("one description").owner(user.getName()).favouriteCount(3L).build();
        portalPage2 = PortalPage.id(2L).name("two").description("two description").owner(user.getName()).favouriteCount(3L).build();
        portalPage3 = PortalPage.id(3L).name("three").description("three description").owner(user.getName()).favouriteCount(3L).build();
        ...
        expect(portalPageManager.getAllOwnedPortalPages((com.atlassian.crowd.embedded.api.User) user)).andReturn(Arrays.asList(portalPage2, portalPage3, portalPage1));

        expect(favouritesManager.getFavouriteIds((com.atlassian.crowd.embedded.api.User) user, PortalPage.ENTITY_TYPE)).andReturn(Arrays.asList(1L, 2L, 3L));

        final PortalPageService service = createPortalPageService();
        final Collection<PortalPage> result = service.getPortalPagesFavouritedByOthers((com.atlassian.crowd.embedded.api.User) user);
    ...
    {
        portalPage1 = PortalPage.id(1L).name("one").description("one description").owner(user.getName()).favouriteCount(3L).build();
        portalPage2 = PortalPage.id(2L).name("two").description("two description").owner(user.getName()).favouriteCount(2L).build();
        portalPage3 = PortalPage.id(3L).name("three").description("three description").owner(user.getName()).favouriteCount(0L).build();
        ...
        expect(favouritesManager.getFavouriteIds((com.atlassian.crowd.embedded.api.User) user, PortalPage.ENTITY_TYPE)).andReturn(Collections.singletonList(1L));
    ...
    {
        portalPage1 = PortalPage.id(1L).name("one").description("one description").owner(user.getName()).favouriteCount(2L).build();
        portalPage2 = PortalPage.id(2L).name("two").description("two description").owner(user.getName()).favouriteCount(1L).build();
        portalPage3 = PortalPage.id(3L).name("three").description("three description").owner(user.getName()).favouriteCount(3L).build();
        ...
        expect(portalPageManager.getAllOwnedPortalPages((com.atlassian.crowd.embedded.api.User) user)).andReturn(portalPages);
        expect(favouritesManager.getFavouriteIds((com.atlassian.crowd.embedded.api.User) user, PortalPage.ENTITY_TYPE)).andReturn(Arrays.asList(1L, 2L));
    ...
    {
        final User owner = new User("owen", mpa, new MockCrowdService());
        portalPage1 = PortalPage.id(1L).name("one").description("one description").owner(owner.getName()).build();
    ...
    public void testValidatePortalPageForUpdateWithBadNameAndSaved()
    {
        ...
        PortalPage newRequest = PortalPage.id(1L).name("testValidatePortalPageWithBadNameAndSaved").owner(user.getName()).build();
        final PortalPage oldRequest = PortalPage.id(2L).name("crapName").owner(user.getName()).build();
    ...
    public void testValidatePortalPageForUpdateUpdateName()
    {
        ...
        final PortalPage oldRequest = PortalPage.id(1L).name("crapName").owner(user.getName()).build();
    ...
    {
        final User otherUser = new User("otherUser", mpa, new MockCrowdService());
        final PortalPage otherPage = PortalPage.name("name").description("desc").owner(otherUser.getName()).build();
    ...
    */
    ...
    {
        final User notMe = new User("notMe", mpa, new MockCrowdService());
    ...
    {
        MockOSUser notMe = new MockOSUser("notMe");
        final JiraServiceContext context = createContext(notMe);
    ...
    public void testValidateForChangePortalPageSequenceNotFavourite() throws PermissionException
    {
        ...
        expect(favouritesManager.isFavourite((com.atlassian.crowd.embedded.api.User) notTheOwner, portalPage2)).andReturn(false);
    ...
    public void testValidateForChangePortalPageSequenceFavouriteError() throws PermissionException
    {
        ...
        expect(favouritesManager.isFavourite((com.atlassian.crowd.embedded.api.User) notTheOwner, portalPage2)).andThrow(new PermissionException("some exception"));
    ...
    public void testValidateForChangePortalPageSequenceGood() throws PermissionException
    {
        ...
        expect(favouritesManager.isFavourite((com.atlassian.crowd.embedded.api.User) notTheOwner, portalPage2)).andReturn(true);
    ...
    private void _testSequenceNotFavourite(final ReorderCommand reorderCommand) throws PermissionException
    {
        ...
        expect(favouritesManager.isFavourite((com.atlassian.crowd.embedded.api.User) notTheOwner, portalPage1)).andReturn(false);
    ...
    {
        final User otherUser = new User("other", mpa, new MockCrowdService());
        portalPage1 = PortalPage.id(1L).name("one").description("one description").owner(otherUser.getName()).build();
    ...
    public void testValidatePortalPageForCreateWithEmptyName()
    {
        ...
        PortalPage portalPage = PortalPage.name("").owner(user.getName()).build();
        final Set<SharePermission> permissions = Collections.<SharePermission>singleton(new SharePermissionImpl(new ShareType.Name("exampleType"), null, null));
    ...
    public void testValidatePortalPageForCreateWithBadNameAndNotSaved()
    {
        ...
        final PortalPage notSavedPortalPage = PortalPage.name("NotSaved").owner(user.getName()).build();
    ...
    public void testValidatePortalPageForCreateWithBadNameAndSaved()
    {
        ...
        final PortalPage newRequest = PortalPage.id(1L).name("testValidatePortalPageWithBadNameAndSaved").owner(user.getName()).build();
        final PortalPage oldRequest = PortalPage.id(2L).name("crapName").owner(user.getName()).build();
    ...
    {
        MockOSUser otherUser = new MockOSUser("otherUser");
    ...
    public void testCreateClonePortalPage()
    {
        ...
        expect(portalPageManager.getPortalPageByName(ctx.getUser(), portalPage3.getName())).andReturn(null);

        expect(portalPageManager.getPortalPage(ctx.getUser(), CLONE_ID)).andReturn(portalPageClone);

        expect(portalPageManager.createBasedOnClone(ctx.getUser(), portalPage3, portalPageClone)).andReturn(portalPage2);
