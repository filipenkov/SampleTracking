 ...
 * @since v3.13.2
 */
public class TestIssueTypeSchemeManagerImpl extends ListeningTestCase
{
    @Test
    public void testSchemeOrder()
    {
        ...
        final IssueTypeSchemeManager manager = new IssueTypeSchemeManagerImpl(mockFieldConfigSchemeManager, null, null, null)
        {
            @Override
