...
public class TestAttachmentPathManager extends ListeningTestCase
{
    private final MockJiraHome jiraHome = new MockJiraHome(new File("/jira-home").getAbsolutePath());
    ...
    public void testDefaultAttachmentPath() throws Exception
    {
        ...
        assertEquals(new File("/jira-home/data/attachments").getAbsolutePath(), attachmentPathManager.getDefaultAttachmentPath());
    }
    ...
    public void testAttachmentPath() throws Exception
    {
        ...
        assertEquals(new File("/jira-home/data/attachments").getAbsolutePath(), attachmentPathManager.getAttachmentPath());
    ...
    public void testSetUseDefaultDirectory() throws Exception
    {
        ...
        assertEquals(new File("/jira-home/data/attachments").getAbsolutePath(), applicationProperties.getString("jira.path.attachments"));
        assertEquals(AttachmentPathManager.Mode.DEFAULT, attachmentPathManager.getMode());
