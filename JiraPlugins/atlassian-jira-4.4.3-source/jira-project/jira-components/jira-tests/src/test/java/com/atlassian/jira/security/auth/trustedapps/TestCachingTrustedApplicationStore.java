...
public class TestCachingTrustedApplicationStore extends ListeningTestCase
{
    class CountingTrustedApplicationStore extends MockTrustedApplicationStore
    {
        ...
        public CountingTrustedApplicationStore(final Collection datas)
        {
            super(datas);
        }
    ...
    {
        final CountingTrustedApplicationStore countingStore = new CountingTrustedApplicationStore(new ArrayList());

        final CachingTrustedApplicationStore cachedStore = new CachingTrustedApplicationStore(countingStore, null);
    ...
    {
        final CountingTrustedApplicationStore countingStore = new CountingTrustedApplicationStore(EasyList.build(new MockTrustedApplicationData(1,
            "CONF", "confluencing", 1000)));
