...
public class TestOfBizProjectRoleAndActorStore extends LegacyJiraMockTestCase
{
    ...
    protected void setUp() throws Exception
    {
        ...
        projectRoleAndActorStore = new OfBizProjectRoleAndActorStore((OfBizDelegator) ComponentManager.getComponentInstanceOfType(OfBizDelegator.class), new MockProjectRoleManager.MockRoleActorFactory());
    }
    ...
    public void testGetProjectIdsForUserInGroupsBecauseOfRoleAllProjects() throws Exception
    {
        ...
        User testUser = UtilsForTests.getTestUser("dude");
        Group group = UtilsForTests.getTestGroup("mygroup");
    ...
    public void testGetProjectIdsForUserInGroupsBecauseOfRoleBatchGroupInClause() throws Exception
    {
        ...
        User testUser = UtilsForTests.getTestUser("dude");
        Group group = UtilsForTests.getTestGroup("mygroup");
        Group group2 = UtilsForTests.getTestGroup("myothergroup");
        testUser.addToGroup(group);
