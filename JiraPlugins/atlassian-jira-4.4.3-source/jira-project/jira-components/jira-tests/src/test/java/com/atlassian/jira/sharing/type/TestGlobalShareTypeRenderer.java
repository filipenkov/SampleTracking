 ...
 * @since v3.13
 */
public class TestGlobalShareTypeRenderer extends ListeningTestCase
{
    ...
    public void setUp() throws Exception
    {
        ...
        userCtx = createAuthenticationContext(TestGlobalShareTypeRenderer.USER, new MockI18nBean());
