...
public class MockFieldLayout implements FieldLayout
{
    ...
    public List<FieldLayoutItem> getVisibleLayoutItems(final User remoteUser, final GenericValue project, final List<String> issueTypes)
    {
        throw new UnsupportedOperationException();
    }

    public List<FieldLayoutItem> getVisibleCustomFieldLayoutItems(final User remoteUser, final GenericValue project, final List<String> issueTypes)
    {
        throw new UnsupportedOperationException();
    }
    ...
    public List<FieldLayoutItem> getRequiredFieldLayoutItems(final User remoteUser, final GenericValue project, final List<String> issueTypes)
    {
        throw new UnsupportedOperationException();
    }
