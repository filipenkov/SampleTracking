            ...
            <tr class="<ww:if test="/hlOptions/contains(./value) == true">rowHighlighted</ww:if>">
                ...
                <ww:if test="/cascadingSelect == true && !/selectedParentOptionId">
                    ...
                    <ww:if test="./disabled == true">
                        (<ww:text name="'admin.common.words.disabled'"/>)
                    </ww:if>
                    <span class="smallgrey"><ww:if test="/defaultValue(./optionId/toString()) == true">(<ww:text name="'admin.common.words.default'"/>)</ww:if></span>
...
<ww:else>
    ...
    <page:applyDecorator name="jiraform">
	    ...
	    <page:param name="buttons"><input class="toolbar-trigger" type="button" value="Done" onclick="location.href='ConfigureCustomField!default.jspa?customFieldId=<ww:property value="/customField/idAsLong" />'"></page:param>
