            ...
            <tr>
                ...
                <td>
                    <ww:component name="'status'" template="constanticon.jsp">
                        ...
                        <ww:param name="'iconurl'" value="constantsManager/status(.)/string('iconurl')" />
                        <ww:param name="'alt'"><ww:property value="/nameTranslation(/constantsManager/status(.))" /></ww:param>
                        <ww:param name="'title'"><ww:property value="nameTranslation(/constantsManager/status(.))" /> - <ww:property value="/descTranslation(/constantsManager/status(.))" /></ww:param>
                    </ww:component>
                    <ww:property value="/nameTranslation(/constantsManager/status(.))"/>
                </td>
                <td>
