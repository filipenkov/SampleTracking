...
(function($) {
    ...
    test("Test Translate No Key", function() {
        equals(AJS.InlineAttach.Text.tr(), undefined, "Return undefined on no key.");
    });

    test("Test Translate No Args", function() {
        equals(AJS.InlineAttach.Text.tr("upload.cancel"), "Cancel", "Return the translation.");
        equals(AJS.InlineAttach.Text.tr("doesnotexist.12627"), "doesnotexist.12627", "Return the key.");
    });

    test("Test Translate Args", function() {
        equals(AJS.InlineAttach.Text.tr("upload.bytes.per.second", 5), "5 B/sec", "Return the translation.");
        equals(AJS.InlineAttach.Text.tr("doesnotexist.12627", 5), "doesnotexist.12627", "Return the key.");
    });

    test("Test for fileSize No args", function() {
        equals(AJS.InlineAttach.Text.fileSize(), undefined, "Return undefined on no arguments.");
    });
    ...
    test("Test for fileSize Single Arg", function() {
        ...
        equals(test(0), mockTr("upload.kilobyte", 0), "0 should return as kB with no decimal places.");
        equals(test(512), mockTr("upload.kilobyte", "0.50"),"Return a 1/2 kB");
        equals(test(1024), mockTr("upload.kilobyte", "1.00"),"Return a 1 kB");
        equals(test(10 * KB + KB / 4), mockTr("upload.kilobyte", "10.25"),"Return a 10.25 kB");
        equals(test(Math.floor(MB * 0.995)), mockTr("upload.kilobyte", "1018.88"),"Return a 1018.88 kB");
        equals(test(Math.ceil(MB * 0.995)), mockTr("upload.megabyte", "1.00"),"Return a 1 MB because of rounding.");
        equals(test(MB*2.5), mockTr("upload.megabyte", "2.50"),"Return a 2.5 MB.");
        equals(test(Math.floor(GB * 0.995)), mockTr("upload.megabyte", "1018.88"),"Return a 1018.88 MB.");
        equals(test(Math.ceil(GB * 0.995)), mockTr("upload.gigabyte", "1.00"),"Return a 1.0 GB.");
        equals(test(GB*3.5), mockTr("upload.gigabyte", "3.50"),"Return a 3.5 GB.");
        equals(test(GB*1024), mockTr("upload.gigabyte", "1024.00"),"Return a 1024 GB.");
    });
    ...
    test("Test for currentOutOfTotalSize", function() {
        ...
        equals(test(0, 0), mockTr("upload.kilobyte.part", "0", "0"), "0/0 kb.");
        equals(test(5, 0.5 * MB), mockTr("upload.kilobyte.part", "0", "512.00"), "0/512.00 kb.");
        equals(test(6, 0.5 * MB), mockTr("upload.kilobyte.part", "0.01", "512.00"), "0.01/512.00 kb.");
        equals(test(KB, Math.floor(0.995 * MB)), mockTr("upload.kilobyte.part", "1.00", "1018.88"), "0.01/1018.88 kb.");
        equals(test(5*KB, Math.ceil(0.995 * MB)), "upload.megabyte.part,0,1.00", "0/1.00 MB.");
        equals(test(6*KB, Math.ceil(0.995 * MB)), mockTr("upload.megabyte.part", "0.01", "1.00"), "0.01/1.00 MB.");
        equals(test(0.5 * MB, Math.floor(0.995 * GB)), mockTr("upload.megabyte.part", "0.50", "1018.88"), "0.5/1018.88 MB.");
        equals(test(5 * MB, Math.ceil(0.995 * GB)), "upload.gigabyte.part,0,1.00", "0/1GB.");
        equals(test(6 * MB, Math.ceil(0.995 * GB)), mockTr("upload.gigabyte.part", "0.01", "1.00"), "0.01/1GB.");
        equals(test(8.5*GB, 9*GB), mockTr("upload.gigabyte.part", "8.50", "9.00"), "8.5/9GB.");
        equals(test(8.5*GB, 1055*GB), mockTr("upload.gigabyte.part", "8.50", "1055.00"), "8.5/1055GB.");
    });

    test("Test for Text.rate", function() {
        AJS.InlineAttach.Text.tr = mockTr;
        var test = AJS.$.proxy(AJS.InlineAttach.Text.rate, AJS.InlineAttach.Text);
        equals(test(0), mockTr("upload.bytes.per.second", "0"), "0 B/sec");
        equals(test(512), mockTr("upload.bytes.per.second", "512.00"), "512 B/sec");
        equals(test(Math.floor(0.995 * KB)), mockTr("upload.bytes.per.second", "1018.00"), "1018.00 B/sec");
        equals(test(Math.ceil(0.995 * KB)), mockTr("upload.kilobytes.per.second", "1.00"), "1.00 kB/sec");
        equals(test(3.75 * KB), mockTr("upload.kilobytes.per.second", "3.75"), "3.75 kB/sec");
        equals(test(Math.floor(0.995 * MB)), mockTr("upload.kilobytes.per.second", "1018.88"), "1018.88 kB/sec");
        equals(test(Math.ceil(0.995 * MB)), mockTr("upload.megabytes.per.second", "1.00"), "1.00 MB/sec");
        equals(test(5.25 * MB), mockTr("upload.megabytes.per.second", "5.25"), "5.25 MB/sec");
        equals(test(1025 * MB), mockTr("upload.megabytes.per.second", "1025.00"), "1025.00 MB/sec");
    });
    ...
    test("Test for Text.time", function() {
        ...
        equals(test(0), mockTr("upload.seconds", "0"), "0 sec");
        equals(test(45), mockTr("upload.seconds", "45"), "45 sec");
        equals(test(59), mockTr("upload.seconds", "59"), "59 sec");
        equals(test(60), mockTr("upload.minutes", "1"), "1 min");
        equals(test(60*30), mockTr("upload.minutes", "30"), "30 min");
        equals(test(60*59), mockTr("upload.minutes", "59"), "59 min");
        equals(test(60*60), mockTr("upload.hours", "1"), "1hr");
        equals(test(60*61), mockTr("upload.hours.minutes", "1", "1"), "1hr 1 min");
        equals(test(60*60.25), mockTr("upload.hours", "1"), "1.0004hr");
        equals(test(60*65), mockTr("upload.hours.minutes", "1", "5"), "1hr 5 min");
        equals(test(60*(60 + 59)), mockTr("upload.hours.minutes", "1", "59"), "1hr 59 min");
        equals(test(60*(60 + 60)), mockTr("upload.hours", "2"), "2hr");
        equals(test(60*(60 + 61)), mockTr("upload.hours.minutes", "2", "1"), "2hr 1 min");
        equals(test(60*(60 + 70.234)), mockTr("upload.hours.minutes", "2", "10"), "2hr 10min");
    });
    ...
    test("Test for Timer.schedule no scope", function() {
        ...
        equals(16, timeout, "Correct Timeout");
        ...
        equals(timer, scope, "Is the scope correctly set.");
    });
    ...
    test("Test for Timer.schedule scope", function() {
        ...
        equals(678, timeout, "Correct Timeout");
        ok(timer.timeoutId == 1, "Correct Id");
        ...
        ok(!timer.timeoutId, "Timer destroyed");
        ok(called, "Callback should be called.");
        equals(expectedScope, actualScope, "Is the scope correctly set.");
    });
    ...
    test("Test for Timer.schedule double schedule", function() {
        ...
        var _endTimeout = function(id) {
            equals(1, id, "Cancel called with the correct id.");
        };
    ...
    test("xhr constructor", function() {
        ...
        equals(1, testing(), "Should used direct");
        equals(AJS.InlineAttach.AjaxUpload._xhrDirect, AJS.InlineAttach.AjaxUpload.xhr, "Updated the function.");

        var jQueryConstructor = function() { return 2; };

        AJS.InlineAttach.AjaxUpload._xhrJquery = function() { return jQueryConstructor; };
        equals(2, testing(), "Should use jQuery");
        equals(jQueryConstructor, AJS.InlineAttach.AjaxUpload.xhr, "Updated the function.")
    });
    ...
    test("statechange aborted", function() {
        ...
        var upload = new testing({
            ...
            after: function() {
                afterCalled++;
                equals(abortCalled, afterCalled, "After called after the abort.");
            },
            before: function() {
                beforeCalled++;
            },
    ...
    test("test upload", function() {
        ...
        upload._renders = {
            form: function(postUrl) {
                equal(url, postUrl, "Is the post url correctly set?");
                return mockAjaxForm;
            }
        };
    ...
    test("Form init", function() {
        ...
        equal(this.$form.get(0), testing.$form.get(0), "Correct form found?");
    ...
    test("Form setAtlToken", function() {
        ...
        var testing = new AJS.InlineAttach.Form({$element: this.$input});
        equal(testing.setAtlToken(value), testing, "Returning itself?");
        equal(tokenElement.val(), value, "Is token value set correctly?");
    });
    ...
    test("Form disable/enable", function() {
        ...
        equal(submit1.attr("disabled"), true, "Submit 1 disabled?");
        equal(submit2.attr("disabled"), false, "Submit 2 enabled?");

        submit2.attr("disabled", true);
        testing.enable();

        equal(submit1.attr("disabled"), false, "Submit 1 enabled?");
        equal(submit2.attr("disabled"), true, "Submit 2 disabled?");
    });
    ...
    test("Add Progress", function() {
        ...
        AJS.InlineAttach.UploadProgress = function(file) {
            equals(file, expectedFile, "Input file is correct?");
            this.$element = file;
        };
        var prog = testing.addProgress(expectedFile);
        ok(prog, "Progress actuall returned?");
        equals(lastElement, expectedFile, "Element correct?");
    });
    ...
    test("Add Error", function() {
        ...
        equal(that, testing, "Returned self?");
        ok(lastElement, "The checkox was actually created?");
        equal(lastReplace, replaceObj, "The replacement object was correct");
    ...
    test("On Cancel", function() {
        ...
        equal(scope, testing, "Is scope correct for callback.");
    });
    ...
    test("onCancel", function() {
        ...
        var callback = function() {
            callbackCount++;
            equal(this, testing, "Callback called with correct scope?");
        };
    ...
    test("Constructor", function() {
        ...
        equal(timerScope, testing, "Timer scope correctly set?");
    ...
    test("Start", function() {
        ...
        equal(testing.start(), testing, "Returning self?");
    ...
    test("Update", function() {
        ...
        equal(testing.update(15), testing, "Returning self?");
    ...
    test("finish", function() {
        ...
        equal(testing.finish(), testing, "Returning self?");
    ...
    test("_update", function() {
        ...
        equals(testing._update(current), testing, "Returned self?");
        equals(lastPercentage, percentage, "Percentage is zero?");
        equals(timerCount, ++expectedTimer, "Timer reset correctly?");
        equals(lastTitle, MockText.currentOutOfTotalSize(current, file.size), "Title set correctly?");
        equals(lastContent, file.name, "Content set correctly?");
        ...
        equals(testing._update(current), testing, "Returned self?");
        equals(lastPercentage, 1, "Percentage is 1?");
        equals(timerCount,++expectedTimer , "Timer reset correctly?");
        equals(lastTitle, MockText.currentOutOfTotalSize(current, file.size), "Title set correctly?");
        equals(lastContent, file.name, "Content set correctly?");
        equals(testing.lastUpdate, nextNow, "Last update correct?");
        equals(testing.current, current, "Current set?");
        equals(testing.started, nextNow, "Started correct?");
        equals(testing.startedSize, 0, "Started size?");
        ...
        equals(testing._update(current), testing, "Returned self?");
        equals(lastPercentage, percentage, "Percentage is correct?");
        equals(timerCount, ++expectedTimer, "Timer reset correctly?");
        equals(lastTitle, MockText.currentOutOfTotalSize(current, file.size), "Title set correctly?");
        equals(lastContent, file.name, "Content set correctly?");
        equals(testing.lastUpdate, lastUpdate, "Last update correct?");
        equals(testing.current, current, "Current set?");
        equals(testing.started, 0, "Started correct?");
        equals(testing.startedSize, 0, "Started size?");
        ...
        equals(testing.lastUpdate, lastUpdate, "Last update correct?");
        equals(testing.current, current, "Current set?");
        equals(testing.started, started, "Started correct?");
        equals(testing.startedSize, startedSize, "Started size?");
        ...
        equals(lastPercentage, percentage, "Percentage is correct?");
        equals(timerCount, ++expectedTimer, "Timer reset correctly?");
        equals(lastTitle, MockText.tr("upload.progress.title.unknown.stalled",
                MockText.currentOutOfTotalSize(current, file.size)), "Title set correctly?");
        equals(lastContent, MockText.tr("upload.file.stalled", file.name), "Content set correctly?");
        equals(testing.lastUpdate, lastUpdate, "Last update correct?");
        equals(testing.current, current, "Current set?");
        equals(testing.started, started, "Started correct?");
        equals(testing.startedSize, startedSize, "Started size?");
        ...
        equals(lastPercentage, percentage, "Percentage is correct?");
        equals(timerCount, ++expectedTimer, "Timer reset correctly?");
        equals(lastTitle, MockText.tr("upload.progress.title.known", nextRate,
                MockText.currentOutOfTotalSize(current, file.size), remaining),
                "Title set correctly?");
        equals(lastContent, MockText.tr("upload.file.remaining", file.name,remaining),
        ...
        equals(testing._update(), testing, "Returned self?");
        equals(lastPercentage, percentage, "Percentage is correct?");
        equals(timerCount, ++expectedTimer, "Timer reset correctly?");
        equals(lastTitle, MockText.tr("upload.progress.title.known", nextRate,
                MockText.currentOutOfTotalSize(current, file.size), remaining),
        ...
        equals(lastPercentage, percentage, "Percentage is correct?");
        equals(timerCount, ++expectedTimer, "Timer reset correctly?");
        equals(lastTitle, MockText.tr("upload.progress.title.known.stalled", nextRate,
                MockText.currentOutOfTotalSize(current, file.size)),
                "Title set correctly?");
        equals(lastContent, mockTr("upload.file.stalled", file.name),
                "Content set correctly?");
        equals(testing.lastUpdate, lastUpdate, "Last update correct?");
        equals(testing.current, current, "Current set?");
        equals(testing.started, started, "Started correct?");
        ...
        equals(testing._update(current), testing, "Returned self?");
        equals(lastPercentage, percentage, "Percentage is correct?");
        equals(timerCount, expectedTimer, "Timer not reset correctly?");
        equals(lastTitle, MockText.tr("upload.progress.title.known", nextRate,
                MockText.currentOutOfTotalSize(current, file.size), remaining),
                "Title set correctly?");
        equals(lastContent, MockText.tr("upload.file.remaining", file.name,remaining),
    ...
    test("onChange", function() {
        ...
        equals(returnValue, testing, "Returned self?");

        //Call without files.
        fn.call({});
        equals(scope, testing, "Correct callback scope?");
        equals(argument, "FileName", "Correct argument?");
        ...
        fn.call({files: "Files"});
        equals(scope, testing, "Correct callback scope?");
        equals(argument, "Files", "Correct argument?");
    });
    ...
    test("_createSubmitData", function() {
        ...
        var expectedData = { projectId: form.projectId, atl_token: form.nextToken };
        deepEqual(testing._createSubmitData(), expectedData, "Generated correct data?");

        form.issueId = 5858658;
        expectedData = { issueId: form.issueId, atl_token: form.nextToken };
        deepEqual(testing._createSubmitData(), expectedData, "Generated correct data?");
    ...
    test("_checkStatus", function() {
        ...
        equals(testing._getErrorFromStatus(400, file), MockText.tr("upload.error.badrequest", file.name),
                "Error for bad request?");
        equals(testing._getErrorFromStatus(401, file), MockText.tr("upload.error.auth", file.name),
                "Error for bad auth?");
        equals(testing._getErrorFromStatus(0, file), MockText.tr("upload.error.server.no.reply", file.name),
                "Error for bad auth?");

        var status = 40383;
        equals(testing._getErrorFromStatus(status, file), MockText.tr("upload.error.unknown.status", file.name, status),
    ...
    test("_uploadFiles", function() {
        ...
        AJS.InlineAttach.AjaxUpload = function(obj) {
            ...
            var scope = obj.scope;
            equals(scope, testing, "Correct scope for AJAXUpload?");
            for (var key in obj) {
        ...
        equals(uploads.length, 1, "Added the upload?");
        var up = uploads[0];
        ...
        equals(up.progress.value, 5, "Progress reported?");
        ...
        equals(uploads.length, 3, "Added the upload?");
        ...
        up.upload.progress(5);
        equals(up.progress.value, Infinity, "Progress ignored reported?");
    ...
    test("_createSubmitData", function() {
        ...
        form.projectId = 38383838302020;
        var expectedData = { projectId: form.projectId, atl_token: form.nextToken, create: true};
        deepEqual(testing._createSubmitData(), expectedData, "Generated correct data?");

        form.issueId = 5858658;
        expectedData = { id: form.issueId, atl_token: form.nextToken};
        deepEqual(testing._createSubmitData(), expectedData, "Generated correct data?");
    ...
    test("_attach", function() {
        ...
        AJS.InlineAttach.FormUpload = function(obj) {
            ...
            var scope = obj.scope;
            equals(scope, testing, "Correct scope for FormUpload?");
            for (var key in obj) {
                //qunit does not deal with circular references when doing a toString. Scope needs to be removed.
                if (key !== "scope") {
                    var value = obj[key];
        ...
        var timersCreated = [];
        AJS.InlineAttach.Timer = function(fn, scope) {
            equals(scope, testing, "Correct timer scope?");
            this.fn = fn;
            this.cancel = recordfn(this);
            this.schedule = recordfn(this);
            this.trigger = function() {
