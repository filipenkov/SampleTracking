...
<body>
    ...
    <page:applyDecorator name="jiraform">
        ...
        <page:param name="leftButtons">
            <input class="toolbar-trigger" type="button" id="test_connection" value="Test Connection" onclick="JIRA.app.admin.email.verifyServerConnection(event,'VerifyPopServerConnection!add.jspa');" />
        </page:param>
