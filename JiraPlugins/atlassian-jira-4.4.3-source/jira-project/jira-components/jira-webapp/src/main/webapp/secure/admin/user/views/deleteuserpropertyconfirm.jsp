...
<html>
<head>
	<title><ww:text name="'admin.deleteuserproperty.delete.property'">: <ww:param name="'value0'" value="key" /></ww:text></title>
...
<body>
	<page:applyDecorator name="jiraform">
        ...
        <page:param name="title"><ww:text name="'admin.deleteuserproperty.delete.property'">: <ww:param name="'value0'" value="key" /></ww:text></page:param>
