...
<%--<%@ page import="com.atlassian.jira.security.xsrf.XsrfErrorAction" %>--%>
...
<%--<%@ page import="com.atlassian.jira.util.collect.MapBuilder" %>--%>
        ...
        <div class="content">
                ...
                <page:applyDecorator name="auifieldset">
                    ...
                    <page:applyDecorator name="auifieldgroup">
                        ...
                        <aui:textfield id="'email1'" label="'Email'" name="'email'" size="'medium'" theme="'aui'">
                            ...
                            <aui:param name="'iconTitle'">what's this</aui:param>
                        </aui:textfield>
                    </page:applyDecorator>
                    ...
                    <page:applyDecorator name="auifieldset">
                        ...
                        <aui:radio id="'gender'" label="''" list="/selectOptionsMap" listKey="'key'" listValue="'value'" name="'gender'" theme="'aui'" />
                    </page:applyDecorator>
            ...
            <div style="margin-bottom:2em;">
                ...
                <div class="module toggle-wrap">
                    <div class="mod-header">
                        <ul class="ops">
                            <li><a class="issueaction-attach-file icon icon-add16" href="#"><span>Link text (hidden)</span></a></li>
            ...
            <div style="margin-bottom:2em;">
                ...
                <div class="buttons-container aui-toolbar noprint">
                    <div class="toolbar-group">
                        <span class="toolbar-item">
                            <input class="toolbar-trigger" type="submit" name="update" value="Button Text"/>
                        </span>
                    </div>
                    <div class="toolbar-group">
                        <span class="toolbar-item active">
                            <input class="toolbar-trigger" type="submit" name="update" value="Active Button"/>
                        </span>
                    </div>
            ...
            <div style="margin-bottom:2em;">
                <a name="form-butts"></a>
                <h3>Form buttons</h3>
                <span class="secondary-text">(got rid of the combined button. Not needed for form buttons)</span>
                <div class="buttons-container aui-toolbar form-buttons noprint">
                    ...
                    <div class="toolbar-group">
                        <span class="toolbar-item">
                            <input class="toolbar-trigger disabled" type="submit" name="update" value="Disabled"/>
                        </span>
                    </div>
                    <div class="toolbar-group">
                        <span class="toolbar-item active">
