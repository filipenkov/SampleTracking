...
<page:applyDecorator name="jirapanel">
    ...
    <page:param name="width">100%</page:param>
        <p><ww:text name="'admin.event.types.table.desc'"/><br>
           <ww:text name="'admin.event.types.table.columns.desc'" />
        </p>
        <p>
            <ww:text name="'admin.event.types.type'" />
            <ul>
                <li>
        ...
        <p>
            <ww:text name="'admin.event.types.state.desc'" />
            <ul>
            ...
            <ww:text name="'admin.event.types.delete.inactive'" />
        </p>
</page:applyDecorator>
