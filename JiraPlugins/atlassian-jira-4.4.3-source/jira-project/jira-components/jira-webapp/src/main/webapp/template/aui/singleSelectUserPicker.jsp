...
<ww:else>
    <select <ww:if test="parameters['inputText']"> data-input-text="<ww:property value="parameters['inputText']" />"</ww:if> id="<ww:property value="parameters['id']" />" class="single-user-picker" name="<ww:property value="parameters['name']" />">
