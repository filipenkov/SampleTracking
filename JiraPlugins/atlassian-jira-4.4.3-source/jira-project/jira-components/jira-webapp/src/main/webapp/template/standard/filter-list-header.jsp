...
<tr>
    <ww:if test="parameters['sort'] != null && parameters['sort'] == true">
        ...
        <ww:if test="parameters['filterList'] != null && parameters['filterList']/size > 0">
            <ww:if test="parameters['issuecount'] != 'false'">
                <th style="width:1%" title="<ww:text name="'filters.issues.desc'"/>"><ww:text name="'common.concepts.issues'"/></th>
            </ww:if>
            ...
            <ww:if test="parameters['subscriptions'] != 'false'">
                <th style="width:12%;"><ww:text name="'managefilters.subscriptions'"/></th>
            </ww:if>
            <ww:if test="parameters['favcount'] != 'false'">
                <th class="<ww:property value="parameters['viewHelper']/generateSortCssClass('favcount')"/>" style="width:5%" title="<ww:text name="'filters.favourite.count.desc'"/>">
                    <a id="filter_sort_popularity" href="<ww:property value="parameters['viewHelper']/generateSortUrl('favcount')"/>"><ww:text name="'common.concepts.popularity'"/>&nbsp;<ww:property value="parameters['viewHelper']/generateSortIcon('favcount')" escape="false"/></a></th>
            </ww:if>
    ...
    <ww:else>
        ...
        <ww:if test="parameters['filterList'] != null && parameters['filterList']/size > 0">
            ...
            <ww:if test="parameters['owner'] != 'false'">
                <th style="width:20%"><ww:text name="'admin.common.words.owner'"/></th>
            </ww:if>
            <ww:if test="parameters['shares'] != 'false'">
                <th style="width:20%"><ww:text name="'common.concepts.shared.with'"/></th>
            </ww:if>
            ...
            <ww:if test="parameters['favcount'] != 'false'">
                <th style="width:5%" title="<ww:text name="'filters.favourite.count.desc'"/>"><ww:text name="'common.concepts.popularity'"/></th>
            </ww:if>
            <ww:if test="parameters['operations'] != 'false'">
                <th style="width:1%">&nbsp;</th>
            </ww:if>
