...
<page:applyDecorator name="jirapanel">
    ...
    <ul class="optionslist">
        ...
        <ww:if test ="hasDefaultFieldLayout == false">
            <li><a id="restore_default" href="RestoreDefaults.jspa"><ww:text name="'admin.common.phrases.restore.defaults'"/></a></li>
        </ww:if>
    </ul>
            ...
            <ww:if test="./hidden == true">
                ...
                <td class="hiddenField">
                    <ul class="operations-list">
                        ...
                        <li><a id="show_<ww:property value="@status/index"/>" href="<ww:url page="IssueFieldHide.jspa"><ww:param name="'hide'" value="@status/index" /></ww:url>" title="<ww:text name="'admin.issuefields.show.field'"><ww:param name="'value0'">'<ww:property value="/fieldName(./orderableField)"/>'</ww:param></ww:text>"><ww:text name="'admin.common.words.show'"/></a></li>
            ...
            <ww:else>
                <td>
                    ...
                    <ww:if test="/mandatory(.) == true || ./required == true">
                        <span class="field-required"><ww:text name="'admin.common.words.required'"/></span>
                    </ww:if>
                    <ww:if test="/renderable(./orderableField) == true">
                        <div id="renderer_value_<ww:property value="./orderableField/id"/>" class="secondary-text"> [<ww:property value="/rendererDisplayName(./rendererType)"/>]</div>
                    </ww:if>
                ...
                <td>
                    <ul class="operations-list">
                        <li><a id="edit_<ww:property value="@status/index"/>" href="<ww:url page="/secure/admin/EditDefaultFieldLayoutItem!default.jspa"><ww:param name="'position'" value="@status/index"/></ww:url>"><ww:text name="'common.words.edit'"/></a></li>
                    <ww:if test="/hideable(.) == true">
                        <li><a id="hide_<ww:property value="@status/index"/>" href="<ww:url page="IssueFieldHide.jspa"><ww:param name="'hide'" value="@status/index" /></ww:url>" title="<ww:text name="'admin.issuefields.hide.field'">
                    ...
                    <ww:if test="/mandatory(.) == false">
                        <ww:if test="/requirable(.) == true">
                            <li><a id="require_<ww:property value="@status/index"/>" href="<ww:url page="IssueFieldRequire.jspa"><ww:param name="'require'" value="@status/index" /></ww:url>" <ww:if test="required == false">title="<ww:text name="'admin.issuefields.make.field.required'">
                                <ww:param name="'value0'">'<ww:property value="/fieldName(./orderableField)"/>'</ww:param>
                    ...
                    <ww:if test="/unscreenable(.) == false">
                        <li><a id="associate_<ww:property value="./orderableField/id" />" href="AssociateFieldToScreens!default.jspa?fieldId=<ww:property value="./orderableField/id"/>&returnUrl=ViewIssueFields.jspa" title="<ww:text name="'admin.issuefields.associate.to.screens'">
                                <ww:param name="'value0'">'<ww:property value="/fieldName(./orderableField)"/>'</ww:param>
                            </ww:text>"><ww:text name="'admin.issuefields.screens'"/></a></li>
                   </ww:if>
                   <ww:if test="/renderable(./orderableField) == true">
                        <li><a id="renderer_<ww:property value="./orderableField/id"/>" href="<ww:url page="EditFieldLayoutItemRenderer!default.jspa"><ww:param name="'rendererEdit'" value="@status/index" /></ww:url>" title="<ww:text name="'admin.issuefields.choose.renderer'">
                            <ww:param name="'value0'">'<ww:property value="/fieldName(./orderableField)"/>'</ww:param>
