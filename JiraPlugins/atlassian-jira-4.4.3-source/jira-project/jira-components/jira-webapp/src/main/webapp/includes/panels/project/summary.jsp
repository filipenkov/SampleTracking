...
<span style="padding-left:30px">
    ...
    <ww:if test="/userExists(./string('lead')) == true">
...
<ww:if test="/hasAssociateRolesPermission() == true">
    <span style="padding-left:30px">
        ...
        <a href="<%=request.getContextPath()%>/plugins/servlet/project-config/<ww:property value="project/string('key')"/>/people"><ww:text name="'admin.projects.project.roles.view.members'"/></a>
    </span>
    <br/>
</ww:if>
