...
<ww:iterator value="roleActorTypes">
    <td>
        ...
        <ww:if test="/configurationUrl(./type) != null">
            <a id="edit_<ww:property value="../name"/>_<ww:property value="./type"/>" href="<ww:property value="/configurationUrl(./type)"/>.jspa?projectRoleId=<ww:property value="../id"/><ww:if test="projectId != null" >&projectId=<ww:property value="projectId"/></ww:if>"><ww:text name="'common.words.edit'"/></a>
        </ww:if>
    </td>
</ww:iterator>
