...
<page:applyDecorator name="jiraform">
    ...
    <page:param name="title"><ww:text name="'admin.issuefields.fieldconfigurations.edit.field.description'"/>: <ww:property value="/fieldNameKey"/></page:param>
    <page:param name="description">
        ...
        <p><ww:text name="'admin.issuefields.fieldconfigurations.update.the.description.for.the.field'">
            <ww:param name="'value0'">'<ww:property value="/fieldNameKey"/>'</ww:param>
        </ww:text></p>
    </page:param>
