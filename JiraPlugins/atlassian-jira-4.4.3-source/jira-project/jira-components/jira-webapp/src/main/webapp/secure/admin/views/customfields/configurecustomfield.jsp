...
-->
	...
	<page:applyDecorator name="jirapanel">
		<page:param name="title"><ww:text name="'admin.issuefields.customfields.configure.custom.field'">
	    <ww:param name="'value0'"><ww:property value="/customField/name" /></ww:param>
	</ww:text></page:param>
            ...
            <ww:if test="./basicMode == true">
                ...
                <tr>
                    ...
                    <td class="fieldValueArea" id="customfield_<ww:property value="/customFieldId"/>-value-<ww:property value="objectKey"/>">
                        <ww:if test="baseEditUrl"><a id="customfield_<ww:property value="/customFieldId"/>-edit-<ww:property value="objectKey"/>" class="actionLinks subText" title="<ww:text name="'admin.issuefields.customfields.edit'">
