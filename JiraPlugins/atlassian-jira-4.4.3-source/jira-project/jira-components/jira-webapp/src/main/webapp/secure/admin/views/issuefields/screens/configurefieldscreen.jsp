            ...
            <table id="field_table" class="aui aui-table-rowhover">
                ...
                <ww:iterator value="./fieldScreenLayoutItems" status="'status'">
                    ...
                    <tr class="totals">
                        ...
                        <ww:if test="./fieldScreenLayoutItems/size > 1"><td><input type="submit" name="moveFieldsToPosition" value="<ww:text name="'common.forms.move'"/>"></td></ww:if>
                        <ww:if test="/fieldScreen/tabs/size > 1"><td><input type="submit" name="moveFieldsToTab" value="<ww:text name="'common.forms.move'"/>"></td></ww:if>
                        <ww:if test="./fieldScreenLayoutItems/empry == false"></ww:if><td><input type="submit" name="deleteFieldsFromTab" value="<ww:text name="'admin.common.words.remove'"/>"></td>
                    </tr>
                </tbody>
            </table>
        </form>
