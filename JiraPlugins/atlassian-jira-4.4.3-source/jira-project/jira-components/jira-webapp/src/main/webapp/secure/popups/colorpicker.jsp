...
<tr>
    ...
    <tr>
    	...
    	<td align="right">
            <font size="-1">
             <input type="submit" class="colorpicker-ok" value="<%=i18nBean.getText("admin.common.words.ok")%>" name="<%=i18nBean.getText("admin.common.words.ok")%>">
             <input type="submit" class="colorpicker-cancel" value="<%=i18nBean.getText("admin.common.words.cancel")%>" name="<%=i18nBean.getText("admin.common.words.cancel")%>">
            </font>
        </td>
    </tr>
    </table>
