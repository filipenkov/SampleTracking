    ...
    <body class="lp">
        <div id="main-content">
            <div id="content" class="active-area">
                <h3><ww:text name="'showtimetrackinghelp.heading'"/></h3>
                <p><ww:text name="'showtimetrackinghelp.preamble'"/></p>
                <ul>
                    <li><strong><ww:text name="'showtimetrackinghelp.logwork.options.title'"/></strong>
                    <ul>
                        ...
                        <li><strong><ww:text name="'showtimetrackinghelp.remainingestimate.title'"/></strong> - <ww:text name="'showtimetrackinghelp.remainingestimate.description'"/>
                            <ul>
                                <li><strong><ww:text name="'showtimetrackinghelp.estimate.autoadjust.title'"/></strong> -
                                ...
                                <li><strong><ww:text name="'showtimetrackinghelp.estimate.existing.title'"/></strong> -
                                    <ww:text name="'showtimetrackinghelp.estimate.existing.description'">
                                        <ww:param name="'value0'"><strong></ww:param>
                                        <ww:param name="'value1'"><ww:text name="'showtimetrackinghelp.remainingestimate.title'"/></ww:param>
                                        <ww:param name="'value2'"></strong></ww:param>
                                    </ww:text></li>
                                <li><strong><ww:text name="'showtimetrackinghelp.estimate.adjust.title'"/></strong> -
                                    <ww:text name="'showtimetrackinghelp.estimate.adjust.description'">
                                        <ww:param name="'value0'"><strong></ww:param>
                                        <ww:param name="'value1'"><ww:text name="'showtimetrackinghelp.remainingestimate.title'"/></ww:param>
                                        <ww:param name="'value2'"></strong></ww:param>
                                    </ww:text></li>
                                <li><strong><ww:text name="'showtimetrackinghelp.estimate.reduce.title'"/></strong> -
                    ...
                    <ww:if test="/commentCopiedToWorkDescription==false">
                        <li><ww:text name="'showtimetrackinghelp.workdescription.description.1'">
                            <ww:param name="'value0'"><strong></ww:param>
                    ...
                    <ww:if test="/commentCopiedToWorkDescription==false"><ww:text name="'showtimetrackinghelp.workdescription.description.3'"/></ww:if></li>
                    <br>
                    <li><strong><ww:text name="'showtimetrackinghelp.timetracking.options.title'"/></strong>
                    <ul>
                    ...
                    <li><strong><ww:text name="'showtimetrackinghelp.timetracking.values.title'"/></strong>
                    <ul>
                        <li><ww:text name="'showtimetrackinghelp.timetracking.values.description.1'"/></li>
                        <li><ww:text name="'showtimetrackinghelp.timetracking.values.description.2'">
                                <ww:param name="'value0'"><ww:property value="defaultTimeUnit"/></ww:param>
                            </ww:text></li>
                        <li><ww:text name="'showtimetrackinghelp.timetracking.values.description.3'">
