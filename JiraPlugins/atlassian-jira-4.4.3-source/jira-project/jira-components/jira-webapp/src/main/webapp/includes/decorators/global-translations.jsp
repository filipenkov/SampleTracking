...
<fieldset class="hidden parameters">
    ...
    <input type="hidden" title="ajaxUnauthorised" value="<ww:text name="'common.forms.ajax.unauthorised'"><ww:param name="'value0'"><a href='<ww:property value="@loginLink"/>'><ww:text name="'login.required.login'"/></a></ww:param></ww:text><ww:if test="@isPublicMode==false"><ww:text name="'common.words.fullstop'"/></ww:if><ww:else><ww:text name="'common.forms.ajax.unauthorised.signup'"><ww:param name="'value0'"><a href='<%= request.getContextPath() %>/secure/Signup!default.jspa'><ww:text name="'common.words.signup'"/></a></ww:param></ww:text></ww:else>">
    <input type="hidden" title="ajaxUnauthorisedAlert" value="<ww:text name="'common.forms.ajax.unauthorised.alert'"/>">
    <input type="hidden" title="JiraVersion" value="<%= ComponentManager.getComponent(BuildUtilsInfo.class).getVersion() %>" />
    ...
    <input type="hidden" title="enterIssueKey" value="<ww:text name="'linkissue.enter.issue.key'"/>">
