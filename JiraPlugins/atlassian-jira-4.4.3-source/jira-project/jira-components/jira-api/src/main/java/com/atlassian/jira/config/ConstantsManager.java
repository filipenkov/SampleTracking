...
public interface ConstantsManager
{
    ...
    /**
     * Used in the generic {@link #getConstant(String, String)} method
     */
     ...
     * @deprecated Use {@link #getPriorityObjects} instead
     */
    @Deprecated
     ...
     * @return A Priority {@link GenericValue}
     * @deprecated Use {@link #getPriorityObject(String)} instead.
     */
    @Deprecated
     ...
     * @deprecated Use {@link #getIssueTypeObject(String)} instead
     */
    @Deprecated
     ...
     * @return A {@link GenericValue} containing the constant. Null if it doesn't exist.
     * @deprecated Use {@link #getConstantObject} instead. Deprecated since v4.0
     */
    @Deprecated
