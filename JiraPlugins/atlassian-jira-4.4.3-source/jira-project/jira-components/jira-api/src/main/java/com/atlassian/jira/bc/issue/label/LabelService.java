...
public interface LabelService
{
     ...
     * @return A set of alphabetically ordered labels for the issue.
     */
    LabelsResult getLabels(final com.opensymphony.user.User user, final Long issueId);
     ...
     * @return A validation result, that can be used to set the labels or to display errors.
     */
    SetLabelValidationResult validateSetLabels(final com.opensymphony.user.User user, final Long issueId, final Set<String> labels);
     ...
     * @return A validation result, that can be used to set the labels or to display errors.
     */
    SetLabelValidationResult validateSetLabels(final com.opensymphony.user.User user, final Long issueId, final Long customFieldId, final Set<String> labels);
     ...
     * @return A set of alphabetically ordered labels for the issue and custom field.
     */
    LabelsResult getLabels(final com.opensymphony.user.User user, final Long issueId, final Long customFieldId);
     ...
     * @return a set of stored label objects in alphabetical order
     */
    LabelsResult setLabels(final com.opensymphony.user.User user, final SetLabelValidationResult result, final boolean sendNotification, final boolean causeChangeNotification);
     ...
     * @return A validation result, that can be used to set the labels or to display errors.
     */
    AddLabelValidationResult validateAddLabel(final com.opensymphony.user.User user, final Long issueId, final String label);
     ...
     * @return A validation result, that can be used to set the labels or to display errors.
     */
    AddLabelValidationResult validateAddLabel(final com.opensymphony.user.User user, final Long issueId, final Long customFieldId, final String label);
     ...
     * @return A result containing the new label.
     */
    LabelsResult addLabel(final com.opensymphony.user.User user, final AddLabelValidationResult result, final boolean sendNotification);
     ...
     *         on the token
     */
    LabelSuggestionResult getSuggestedLabels(final com.opensymphony.user.User user, final Long issueId, String token);
     ...
     *         on the token
     */
    LabelSuggestionResult getSuggestedLabels(final com.opensymphony.user.User user, final Long issueId, final Long customFieldId, String token);
