...
public interface VoteService
{
     ...
     * used in conjunction with the {@link #addVote(com.opensymphony.user.User, VoteValidationResult)}
     * method.
     ...
     * <li>the user has already voted for this issue</li>
     ...
     */
    VoteValidationResult validateAddVote(final com.opensymphony.user.User remoteUser, final com.opensymphony.user.User user, final Issue issue);
     ...
     */
    int addVote(final com.opensymphony.user.User remoteUser, final VoteValidationResult validationResult);
     ...
     * The remoteUser and user arguments may be the same if the current user is voting him/herself.  The
     * {@link com.atlassian.jira.bc.issue.vote.VoteService.VoteValidationResult} produced by this method should be
     * used in conjunction with the {@link #removeVote(com.opensymphony.user.User, VoteValidationResult)}
     * method.
     * The following conditions will fail validation:
     * <ul>
     * <li>remoteUser is null (i.e. not logged in)</li>
     * <li>the user is the reporter of the issue</li>
     * <li>the issue has already been resolved</li>
     * <li>the user has not yet voted for this issue</li>
     * <li>voting has been disabled system wide</li>
     * <li>the user doesn't have permission to browse the issue</li>
     * </ul>
     *
     ...
     * @return A validation result containing all errors, as well as the user and issue being voted on
     */
    VoteValidationResult validateRemoveVote(final com.opensymphony.user.User remoteUser, final com.opensymphony.user.User user, final Issue issue);
     ...
     * @return The updated number of votes for the issue being voted for
     */
    int removeVote(final com.opensymphony.user.User remoteUser, final VoteValidationResult validationResult);
     ...
     */
    ServiceOutcome<Collection<com.opensymphony.user.User>> viewVoters(final Issue issue, final com.opensymphony.user.User remoteUser);
     ...
     */
    boolean hasVoted(final Issue issue, final com.opensymphony.user.User user);
