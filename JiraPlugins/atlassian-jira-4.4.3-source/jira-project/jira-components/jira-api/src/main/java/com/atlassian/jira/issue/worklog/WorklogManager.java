...
public interface WorklogManager
{
     ...
     */
    boolean delete(com.opensymphony.user.User user, Worklog worklog, Long newEstimate, boolean dispatchEvent);
     ...
     */
    Worklog update(com.opensymphony.user.User user, Worklog worklog, Long newEstimate, boolean dispatchEvent);
     ...
     */
    Worklog create(com.opensymphony.user.User user, Worklog worklog, Long newEstimate, boolean dispatchEvent);
