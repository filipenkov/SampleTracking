...
public interface LabelManager
{
     ...
     * @return a set of stored label objects in alphabetical order
     */
    Set<Label> setLabels(final com.opensymphony.user.User remoteUser, final Long issueId, final Set<String> labels, final boolean sendNotification, final boolean causeChangeNotification);
     ...
     * @return a set of stored label objects in alphabetical order
     */
    Set<Label> setLabels(final com.opensymphony.user.User remoteUser, final Long issueId, final Long customFieldId, final Set<String> labels, final boolean sendNotification, final boolean causeChangeNotification);
     ...
     * @return The Label domain object which was created
     */
    Label addLabel(final com.opensymphony.user.User remoteUser, final Long issueId, final String label, final boolean sendNotification);
     ...
     * @return The Label domain object which was created
     */
    Label addLabel(final com.opensymphony.user.User remoteUser, final Long issueId, final Long customFieldId, final String label, final boolean sendNotification);
     ...
     * @return A sorted set of labels in alphabetical order
     */
    Set<String> getSuggestedLabels(final com.opensymphony.user.User user, final Long issueId, final String token);
     ...
     * @return A sorted set of labels in alphabetical order
     */
    Set<String> getSuggestedLabels(final com.opensymphony.user.User user, final Long issueId, final Long customFieldId, final String token);
}
