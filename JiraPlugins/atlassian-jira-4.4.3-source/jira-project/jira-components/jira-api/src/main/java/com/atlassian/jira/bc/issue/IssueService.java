 ...
 * 
 * <p/>
 * NOTE: This service is in flux and may be changed in the next few versions. This is an important service to have in
 * JIRA and it is important to get it right, we therefore reserve the right to change it as we receive feedback.
 * Please feel free to use the service but just keep in mind you may need to update your code if/when this changes.
 *
 * @since v4.1
 */
public interface IssueService
{
     ...
     * when performing the operation.
     */
    IssueResult getIssue(com.opensymphony.user.User user, Long issueId);
     ...
     * when performing the operation.
     */
    IssueResult getIssue(com.opensymphony.user.User user, String issueKey);
     ...
     * to re-render the user inputted values.
     */
    CreateValidationResult validateSubTaskCreate(com.opensymphony.user.User user, Long parentId, IssueInputParameters issueInputParameters);
     ...
     * to re-render the user inputted values.
     */
    CreateValidationResult validateCreate(com.opensymphony.user.User user, IssueInputParameters issueInputParameters);
     ...
     * the issue then the issue will be null and the error collection will contain details of what went wrong.
     */
    IssueResult create(com.opensymphony.user.User user, CreateValidationResult createValidationResult);
     ...
     * the issue then the issue will be null and the error collection will contain details of what went wrong.
     */
    IssueResult create(com.opensymphony.user.User user, CreateValidationResult createValidationResult, String initialWorkflowActionName);
     ...
     * the issue then the issue will be null and the error collection will contain details of what went wrong.
     */
    IssueResult update(com.opensymphony.user.User user, UpdateValidationResult updateValidationResult);
     ...
     * that can be used by the fields to re-render the user inputted values.
     */
    UpdateValidationResult validateUpdate(com.opensymphony.user.User user, Long issueId, IssueInputParameters issueInputParameters);
     ...
     * the issue then the issue will be null and the error collection will contain details of what went wrong.
     */
    IssueResult update(com.opensymphony.user.User user, UpdateValidationResult updateValidationResult, EventDispatchOption eventDispatchOption, boolean sendMail);
     ...
     * collection that contains any validation errors that may have occurred.
     */
    DeleteValidationResult validateDelete(com.opensymphony.user.User user, Long issueId);
     ...
     * @return If there was an error deleting the issue then the error collection will contain details of what went wrong.
     */
    ErrorCollection delete(com.opensymphony.user.User user, DeleteValidationResult deleteValidationResult);
     ...
     * @return If there was an error deleting the issue then the error collection will contain details of what went wrong.
     */
    ErrorCollection delete(com.opensymphony.user.User user, DeleteValidationResult deleteValidationResult, EventDispatchOption eventDispatchOption, boolean sendMail);
     ...
     * that can be used by the fields to re-render the user inputted values.
     */
    TransitionValidationResult validateTransition(com.opensymphony.user.User user, Long issueId, int actionId, IssueInputParameters issueInputParameters);
     ...
     * @return result containing the updated transitioned issue and any errors that may have occurred.
     */
    IssueResult transition(com.opensymphony.user.User user, TransitionValidationResult transitionResult);
