...
public abstract class AbstractSingleFieldType extends AbstractCustomFieldType
{
     ...
     */
    protected abstract Object getDbValueFromObject(Object customFieldObject);

    /**
     * Returns the Domain Object or GenericValue object representing the given Custom Field value as
     * stored in the database
     *
     * @param databaseValue - String, Double or Date objects
     * @return Domain object or GenericValue
     * @throws FieldValidationException
     */
    protected abstract Object getObjectFromDbValue(Object databaseValue) throws FieldValidationException;
    ...
    {
        T visitSingleField(AbstractSingleFieldType singleCustomFieldType);
    }
}
