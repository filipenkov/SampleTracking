...
public interface CommentManager
{
     ...
     * @return Possibly empty List of {@link Comment}s
     *
     * @deprecated Please use {@link #getCommentsForUser(com.atlassian.jira.issue.Issue, com.atlassian.crowd.embedded.api.User)} instead. Since v4.3
     */
     ...
     * @since v4.0
     *
     * @deprecated Please use {@link #isUserCommentAuthor(com.atlassian.crowd.embedded.api.User, Comment)} instead. Since v4.3
     */
    boolean isUserCommentAuthor(com.opensymphony.user.User user, Comment comment);
}