...
public interface OrderableField extends Field, SearchableField
{
     ...
     * showing teh Edit Issue screen to show the issue's current values.
     *
     * @param fieldValuesHolder The fieldValuesHolder Map to be populated.
     * @param issue             The Issue.
     */
    ...
    /**
     * Validates that the sting value passed could be a valid value. Essentially this does some basic type checking
     * @param value
     * @param errorCollectionToAddTo
     * @param issue
     */
//    void validateBasicValue(String value, ErrorCollection errorCollectionToAddTo, Issue issue);

    /**
     * Test whether the parameter for the field in the fieldValuesHolder meets the 'required' criteria of the field
     * @param issue this is passed to get the value of other fields that may or may not have been modified
     */
    // TODOD
//    void validateRequired(Map fieldValuesHolder, ErrorCollection errorCollectionToAddTo, I18nHelper i18n, Issue issue);
