...
public interface PopularIssueTypesUtil
{
     ...
     * @return the list of popular issue types, limited to a hard-coded number; never null.
     */
    List<IssueType> getPopularIssueTypesForProject(Project project, com.opensymphony.user.User user);
     ...
     * @return the rest of the issue types; never null.
     */
    List<IssueType> getOtherIssueTypesForProject(Project project, com.opensymphony.user.User user);
     ...
     * @return a list of popular issue types and a list of other issues (with popular removed)
     */
    PopularIssueTypesHolder getPopularAndOtherIssueTypesForProject(Project project, com.opensymphony.user.User user);
