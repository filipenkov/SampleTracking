...
public interface SharedEntity extends Favourite
{
    ...
    public static class Identifier implements SharedEntity
    {
        ...
        public Identifier(final Long id, final TypeDescriptor<? extends SharedEntity> type, final String ownerUserName)
        {
            ...
            this.id = id;
            this.type = type;
            this.ownerUserName = (StringUtils.isBlank(ownerUserName)) ? "" : ownerUserName;
        }
        ...
        public Identifier(final Long id, final TypeDescriptor<? extends SharedEntity> type, final User owner)
        {
            ...
            this.id = id;
            this.type = type;
            ownerUserName = (owner == null) ? "" : StringUtils.isBlank(owner.getName()) ? "" : owner.getName();
        }

        public Identifier(final Long id, final TypeDescriptor<? extends SharedEntity> type, final com.opensymphony.user.User owner)
        {
            this(id, type, (User) owner);
        }
