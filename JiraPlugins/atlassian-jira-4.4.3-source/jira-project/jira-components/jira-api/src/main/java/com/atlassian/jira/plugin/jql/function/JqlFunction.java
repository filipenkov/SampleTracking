 ...
 * For backward compatibility this Interface still uses {@link com.opensymphony.user.User}.
 * This will be converted to use {@link com.atlassian.crowd.embedded.api.User} in a future version of JIRA.
 *
...
public interface JqlFunction
{
     ...
     */
    void init(@NotNull JqlFunctionModuleDescriptor moduleDescriptor);

    /**
     * Will validate the function operand's arguments and report back any errors.
     * <p>
     * <strong>Important note:</strong>
     * For backward compatibility this method still uses {@link com.opensymphony.user.User}.
     * This will be converted to use {@link com.atlassian.crowd.embedded.api.User} in a future version of JIRA.
     *
     ...
     */
    @NotNull
    MessageSet validate(com.opensymphony.user.User searcher, @NotNull FunctionOperand operand, @NotNull TerminalClause terminalClause);
