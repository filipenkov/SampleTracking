...
public interface UserProjectHistoryManager
{
     ...
     * @return true if the user has at least 1 project in their project history queue that they can see, false otherwise
     */
    boolean hasProjectHistory(int permission, com.opensymphony.user.User user);
     ...
     * @return the last project the use visited.
     */
    Project getCurrentProject(int permission, com.opensymphony.user.User user);
     ...
     */
    @NotNull
    List<Project> getProjectHistoryWithPermissionChecks(int permission, com.opensymphony.user.User user);
