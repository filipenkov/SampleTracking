...
public class ChangeHistoryItem implements Comparable<ChangeHistoryItem>
{
     ...
     * @return  the from string as represented by thris change item
     */
    @Deprecated
     ...
     * @return  the to string as represented by this change item
     */
    @Deprecated
    public String getTo()
    {
    ...
    /**
     * @deprecated As of 4.4.2, prefer to use {@link #getFroms()}
     * @return  the from value as represented by thris change item
     */
    @Deprecated
    ...
    /**
     * @deprecated As of 4.4.2, prefer to use {@link #getTos()}
     * @return  the to value as represented by this change item
     */
    @Deprecated
    ...
    {
        if (changeGroupId.compareTo(changeGroupId) == 0 )
        {
