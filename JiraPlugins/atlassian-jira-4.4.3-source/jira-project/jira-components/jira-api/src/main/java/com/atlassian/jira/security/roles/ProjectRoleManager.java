...
public interface ProjectRoleManager
{
     ...
     * @throws IllegalArgumentException is thrown if the <code>project</code> is null
     *
     * @deprecated Please use {@link #getProjectRoles(com.atlassian.crowd.embedded.api.User, com.atlassian.jira.project.Project)}. Since v4.3
     */
     ...
     * @throws IllegalArgumentException if <code>ProjectRole</code> or <code>Project</code> is null.
     *
     * @deprecated Please use {@link #isUserInProjectRole(com.atlassian.crowd.embedded.api.User, ProjectRole, com.atlassian.jira.project.Project)}. Since v4.3
     */
    ...
    /** @deprecated Please use {@link #createProjectIdToProjectRolesMap(com.atlassian.crowd.embedded.api.User, java.util.Collection)}. Since v4.3 */
    ProjectIdToProjectRoleIdsMap createProjectIdToProjectRolesMap(com.opensymphony.user.User user, Collection<Long> projectIds);
    ...
    public static class ProjectIdToProjectRoleIdsMap implements Iterable<ProjectIdToProjectRoleIdsMap.Entry>
    {
        ...
        public void add(final Long projectId, final Long projectRoleId)
        {
            ...
            {
                map.put(projectId, projectRoleId);
            }
        }
