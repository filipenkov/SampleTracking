...
public interface UserIssueHistoryManager
{
     ...
     * @param issue The issue to add to the history list
     */
    void addIssueToHistory(com.opensymphony.user.User user, Issue issue);
     ...
     * @return true if the user has at least 1 issue in their issue history queue that they can see, false otherwise
     */
    boolean hasIssueHistory(com.opensymphony.user.User user);
     ...
     */
    @NotNull
    List<UserHistoryItem> getFullIssueHistoryWithoutPermissionChecks(com.opensymphony.user.User user);
     ...
     */
    @NotNull
    List<UserHistoryItem> getFullIssueHistoryWithPermissionChecks(com.opensymphony.user.User user);
     ...
     */
    @NotNull
    List<Issue> getShortIssueHistory(com.opensymphony.user.User user);
