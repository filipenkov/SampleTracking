...
public interface APKeys
{
    ...
    public static final String JIRA_OPTION_USER_AVATAR_ENABLED = "jira.user.avatar.enabled";

    /* Trackbacks */
    public static final String JIRA_OPTION_TRACKBACK_SEND = "jira.option.trackback.send";
    public static final String JIRA_OPTION_TRACKBACK_SEND_PUBLIC = "jira.option.trackback.send.public";
//    public static final String JIRA_TRACKBACK_SEND_ALLOWED_PATTERN = "jira.trackback.allowed.pattern";

    public static final String JIRA_OPTION_TRACKBACK_RECEIVE = "jira.option.trackback.receive";
    public static final String JIRA_TRACKBACK_EXCLUDE_PATTERN = "jira.trackback.exclude.pattern";
    ...
    // Columns when viewing linked issues
    public static final String ISSUE_TABLE_COLS_LINKED_ISSUE = "jira.table.cols.linkedissue";
     ...
     */
    public static final String JIRA_AJAX_USER_PICKER_LIMIT = "jira.ajax.autocomplete.userpicker.limit";
