...
public interface TimeTrackingIssueUpdater
{
     ...
     * be fired, otherwise no event will be fired.
     */
    void updateIssueOnWorklogCreate(com.opensymphony.user.User user, Worklog worklog, Long newEstimate, boolean dispatchEvent);
     ...
     * @param dispatchEvent if true then a {@link com.atlassian.jira.event.type.EventType#ISSUE_WORKLOG_UPDATED_ID} will
     */
    void updateIssueOnWorklogUpdate(com.opensymphony.user.User user, Worklog originalWorklog, Worklog newWorklog, Long originalTimeSpent, Long newEstimate, boolean dispatchEvent);
     ...
     * be fired, otherwise no event will be fired.
     */
    void updateIssueOnWorklogDelete(com.opensymphony.user.User user, Worklog worklog, Long newEstimate, boolean dispatchEvent);
}
