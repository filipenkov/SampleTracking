...
public interface GroupService
{
     ...
     * @since v4.3
     */
    BulkEditGroupValidationResult validateAddGroupsToGroup(JiraServiceContext jiraServiceContext, Collection groupsToJoin, Collection groupNames);
     ...
     * @deprecated since v4.3.  Use {@link #validateRemoveUsersFromGroups(JiraServiceContext, GroupRemoveChildMapper)}.
     * @since v3.12
     */
     ...
     * @param mapper represents which users to remove from which groups.
     * @return true if the operation succeeds, false otherwise.
     * @deprecated since v4.3.  Use {@link #removeUsersFromGroups(JiraServiceContext, GroupRemoveChildMapper)}.
     */
