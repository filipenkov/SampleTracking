...
public interface SearchHandlerManager
{
     ...
     */
    Collection<IssueSearcher<?>> getSearchers(com.opensymphony.user.User searcher, SearchContext context);
     ...
     */
    @NotNull
    Collection<ClauseHandler> getClauseHandler(final com.opensymphony.user.User user, final String jqlClauseName);
     ...
     */
    @NotNull
    Collection<String> getFieldIds(final com.opensymphony.user.User searcher, String jqlClauseName);
     ...
     */
    @NotNull
    Collection<ClauseNames> getVisibleJqlClauseNames(com.opensymphony.user.User searcher);
     ...
     */
    @NotNull
    Collection<ClauseHandler> getVisibleClauseHandlers(com.opensymphony.user.User searcher);
     ...
     * by the {@link com.atlassian.jira.issue.search.searchers.renderer.SearchRenderer#isShown(com.opensymphony.user.User, com.atlassian.jira.issue.search.SearchContext)}
     * method.
     *
     * @param user that will be used to perform a permission check.
     * @param jqlClauseName the clause name to search for.
     ...
     */
    @NotNull
    Collection<IssueSearcher<?>> getSearchersByClauseName(final com.opensymphony.user.User user, String jqlClauseName, SearchContext searchContext);
