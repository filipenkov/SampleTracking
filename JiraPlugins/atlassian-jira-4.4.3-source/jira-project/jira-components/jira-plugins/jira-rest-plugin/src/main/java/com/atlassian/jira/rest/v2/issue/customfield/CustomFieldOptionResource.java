...
public class CustomFieldOptionResource
{
    ...
    public CustomFieldOptionResource(JiraAuthenticationContext authContext, OptionsManager optionsManager, final VelocityRequestContextFactory velocityRequestContextFactory, ContextI18n i18n, ContextUriInfo contextUriInfo)
    {
    ...
    public Response getCustomFieldOption(@PathParam ("id") final String id)
    {
        ...
        {
            throw new NotFoundWebException(ErrorCollection.of(i18n.getText("rest.user.error.not.found", id)));
        }
        if (option == null)
        {
            throw new NotFoundWebException(ErrorCollection.of(i18n.getText("rest.user.error.not.found", id)));
