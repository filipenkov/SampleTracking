...
public class SimpleLinkBean
{
    ...
    {
        this(link.getId(), link.getStyleClass(), link.getLabel(), link.getTitle(), link.getUrl());
    }
    public SimpleLinkBean(String id, String styleClass, String label, String title, String href)
    {
        this.id = id;
