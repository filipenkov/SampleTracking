package com.atlassian.jira.rest.v1.filters;
...
public class FilterResource
{
    ...
    public FilterResource(final JiraAuthenticationContext authenticationContext, final FavouritesService favouritesService,
    ...
    public FavouriteResource getFavouriteResource(@PathParam ("entityId") Long entityId)
    {
        return new FavouriteResource(authenticationContext, favouritesService, favouritesManager,
                sharedEntityAccessorFactory, SearchRequest.ENTITY_TYPE, entityId);
    }
}
