...
public class IssueLabelsResource
{
    ...
    public IssueLabelsResource(JiraAuthenticationContext jiraAuthenticationContext, LabelService labelService,
            I18nHelper.BeanFactory i18nBeanFactory, ApplicationProperties applicationProperties)
    {
        this.jiraAuthenticationContext = jiraAuthenticationContext;
        this.labelService = labelService;
        this.i18nHelper = i18nBeanFactory.getInstance(jiraAuthenticationContext.getUser());
