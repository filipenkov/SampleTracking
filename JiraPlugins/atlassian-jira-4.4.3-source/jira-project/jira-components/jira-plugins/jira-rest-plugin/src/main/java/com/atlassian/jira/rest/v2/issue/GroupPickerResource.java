...
public class GroupPickerResource
{
    ...
    @Path("/picker")
    @GET
    public Response findGroups(@QueryParam("query") final String query)
    {
        ...
        final String header = buildHeader(groupBeans, groups.size());
        final GroupSuggestionsBean suggestions = new GroupSuggestionsBean(header, groupBeans);
