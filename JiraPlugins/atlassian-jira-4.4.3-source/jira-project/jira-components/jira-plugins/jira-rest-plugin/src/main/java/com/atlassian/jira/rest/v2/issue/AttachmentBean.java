...
public class AttachmentBean
{
    ...
    public AttachmentBean(URI self, String filename, UserBean author, Date created, long filesize, String mimeType, HashMap<String, String> properties, String content, String thumbnail)
    {
        this.self = self;
