...
/**
 * Uploads logo to well known location
 * Also scales and stores scaled copy
 * If a favicon also stores hires and lores scales
 *
 * @since v4.4
 */
public class LogoUploader
{
    ...
    public boolean validate(ImageDescriptor imageDescriptor)
    {
        ...
        {
            if (!CONTENT_TYPES.contains(imageDescriptor.getContentType().toLowerCase()))
            {
