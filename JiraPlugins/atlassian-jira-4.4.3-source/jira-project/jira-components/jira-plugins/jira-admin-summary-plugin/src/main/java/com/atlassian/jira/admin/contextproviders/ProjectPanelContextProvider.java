...
import com.atlassian.jira.project.ProjectHistoryLinkFactory;
...
public class ProjectPanelContextProvider  extends AdminSummaryPanelContextProvider implements ContextProvider
{
    ...
    public Map<String, Object> getContextMap(Map<String, Object> context)
    {
        ...
        {
            if (!section.getId().equals("recent_project_section") && !section.getId().equals("project_section"))
            {
        ...
        recentProjects = recentProjects.subList(0, Math.min(ProjectHistoryLinkFactory.MAX_RECENT_PROJECTS_TO_SHOW, recentProjects.size()));
