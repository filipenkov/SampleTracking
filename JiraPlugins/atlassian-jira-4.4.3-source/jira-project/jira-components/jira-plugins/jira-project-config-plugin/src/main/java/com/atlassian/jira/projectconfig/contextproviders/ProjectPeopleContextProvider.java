...
public class ProjectPeopleContextProvider implements CacheableContextProvider
{
    ...
    public ProjectPeopleContextProvider(final PermissionManager permissionManager, final UserFormatManager userFormatManager,
            final UserManager userManager, final AvatarService avatarService, ContextProviderUtils contextProviderUtils)
    {
    ...
    public Map<String, Object> getContextMap(Map<String, Object> context)
    {
        ...
        final boolean userAvatarsEnabled = avatarService.isUserAvatarsEnabled();
        ...
        if(leadUser != null)
        {
            ...
            userAvatarUrl = userAvatarsEnabled ?
                    avatarService.getAvatarURL(leadUser, leadUser.getName(), Avatar.Size.SMALL).toString() : null;
        }
        else
        {
        ...
        contextMap.add(CONTEXT_IS_USER_AVATARS_ENABLED_KEY, userAvatarsEnabled);
