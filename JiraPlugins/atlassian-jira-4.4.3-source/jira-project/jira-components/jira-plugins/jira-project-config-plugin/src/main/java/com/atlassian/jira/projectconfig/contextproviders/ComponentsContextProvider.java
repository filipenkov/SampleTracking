...
public class ComponentsContextProvider implements CacheableContextProvider
{
    ...
    public ComponentsContextProvider(AvatarService avatarService, ContextProviderUtils utils, UserManager userManager, UserPickerSearchService userPickerSearchService, JiraAuthenticationContext jiraAuthenticationContext)
    {
    ...
    public Map<String, Object> getContextMap(Map<String, Object> params)
    {
        ...
        return MapBuilder.newBuilder(params)
                ...
                .add("userAvatars", avatarService.isUserAvatarsEnabled())
