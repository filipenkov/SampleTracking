...
public class TimeChart extends DateRangeChart
{
    ...
    public TimeChart(final String location, final String title, final String filterUrl, final String imageMap, final String imageMapName, TimeDataRow[] data, final int width, final int height)
    {
        super(location, title, filterUrl, imageMap, imageMapName, width, height);
        this.data = data;
    }
