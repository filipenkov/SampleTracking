...
public class AvailableColumnsResource
{
            ...
            throws FieldException
    {
        ...
        final Comparator<Field> nameComparator = new NameComparator(new I18nBean(user));
    ...
    private List<ColumnItem> convertToColumnItems(final List<NavigableField> fields)
    {
        final List<ColumnItem> items = new ArrayList<ColumnItem>(fields.size());

        for (NavigableField field : fields)
        {
            items.add(new ColumnItem(field.getId(), field.getName()));
        }
    ...
    public static class ColumnOptions
    {
        ...
        ColumnOptions(List<ColumnItem> availableColumns, List<ColumnItem> defaultColumns)
        {
    ...
    public static class ColumnItem
    {
        ...
        ColumnItem(String value, String label)
        {
            this.label = label;
            this.value = value;
        }
