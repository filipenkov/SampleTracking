...
public class TwoDimensionalStatsResource extends SearchQueryBackedResource
{
    ...
    public TwoDimensionalStatsResource(final ChartUtils chartUtils, final JiraAuthenticationContext authenticationContext,
            ...
            final FieldVisibilityManager fieldVisibilityManager, final ApplicationProperties applicationProperties,
    ...
    {
        HitCollector aHitCollector = new TwoDimensionalTermHitCollector(statsMap, issueIndexManager.getIssueSearcher().getIndexReader(), 
