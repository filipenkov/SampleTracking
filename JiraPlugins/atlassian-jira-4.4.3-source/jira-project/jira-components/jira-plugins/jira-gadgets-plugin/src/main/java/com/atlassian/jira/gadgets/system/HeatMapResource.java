...
public class HeatMapResource extends SearchQueryBackedResource
{
    ...
    @GET
    @Path ("/generate")
    public Response getHeatMap(@QueryParam (SEARCH_QUERY) String queryString,
    ...
    Map<String, Object> createHeatMap(final String statType, final User user, final SearchRequest searchRequest)
    {
        ...
        try
        {
            ...
            final FieldValueToDisplayTransformer<String> fieldValueToDisplayTransformer =
                    new DefaultFieldValueToDisplayTransformer(i18nBean, constantsManager, customFieldManager);
            ...
            final SortedMap<Object, DataRow> rowOrdering = new TreeMap<Object, DataRow>(statMapper.getComparator()); 
    ...
    @GET
    @Path ("validate")
    public Response validateHeatMap(@QueryParam (SEARCH_QUERY) String queryString, @QueryParam (STAT_TYPE) final String statType)
    {
        final Collection<ValidationError> errors = new ArrayList<ValidationError>();
