...
jira.plugin.charting = function () {
    ...
    createDialog = function (width, height, data) {
        ...
        dialog.page[0].addHeader(AJS.params.title + "<div class=\"dialogThrobber\">&nbsp;</div><button class='close'>" + AJS.params.closeButtonLabel + "</button>");
        resetPanels(data);
        dialog.page[0].addButton(AJS.params.saveButtonLabel,
                function(dialog) {
        ...
        dialog.page[1].addHeader(AJS.params.saveTitle+"<div class=\"dialogThrobber\">&nbsp;</div><button class='close'>" + AJS.params.closeButtonLabel + "</button>");
