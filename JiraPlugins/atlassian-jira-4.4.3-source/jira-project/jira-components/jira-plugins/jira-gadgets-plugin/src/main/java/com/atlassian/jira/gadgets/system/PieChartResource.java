...
public class PieChartResource extends SearchQueryBackedResource
{
            ...
            @QueryParam (HEIGHT) @DefaultValue ("250") final int height)
    {
        ...
        try
        {
            final Chart chart = createChart(statType, width, height, user, searchRequest);
            ...
            final Integer issueCount = (Integer) chartParams.get(NUM_ISSUES);
            ...
            final PieChart pieChart = new PieChart(location, title, filterUrl, issueCount, displayName, imageMap, imageMapName, data, chartWidth, chartHeight);
    ...
    Chart createChart(final String statType, final int width, final int height, final User user, final SearchRequest searchRequest)
    {
    ...
    public static class PieChart
    {
        ...
        PieChart(String location, String filterTitle, String filterUrl, int issueCount, String statType, String imageMap, String imageMapName, DataRow[] data, int width, int height)
        {
