...
public class TestTwoDimensionalStatsResource extends ResourceTest
{
    ...
    class MockSearchQueryBackedResource extends TwoDimensionalStatsResource
    {
        ...
        {
            super(chartUtils, authenticationContext, searchService, permissionManager, statisticTypesResource, searchProvider, velocityRequestContextFactory, null, fieldValueToDisplayTransformer, null, null, null);
        }
