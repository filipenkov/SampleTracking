...
test("refresh", function () {
    ...
    var model = new JIRA.QuickForm.Model({
            userFieldsResource: "http://www.example.com",
            fieldsResource: "http://www.example.com"
        });
...
test("updating user preferences", function () {
    ...
    model.getShowWelcomeScreen().done(function (show) {
        ok(show, "Expected user pref showWelcomeScreen NOT to changed");
    });
    ...
    model.getShowWelcomeScreen().done(function (show) {
        ok(!show, "Expected user pref showWelcomeScreen to be updated");
    });
