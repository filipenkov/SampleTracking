...
/**
 * Represents a field to be used in the quick create & edit dialogs.  In order to render this field we need to know the
 * field's id, i18nized label, if it's required and the field's edit HTML (rendered by the field itself).
 *
 * @since 5.0
 */
@XmlRootElement (name = "field")
public class QuickEditField
{
    @XmlElement (name = "id")
    private String id;
    ...
    private QuickEditField() {}

    public QuickEditField(final String id, final String label, final boolean required, final String editHtml, final FieldTab tab)
    {
    ...
    public boolean equals(final Object o)
    {
        ...
        final QuickEditField that = (QuickEditField) o;
