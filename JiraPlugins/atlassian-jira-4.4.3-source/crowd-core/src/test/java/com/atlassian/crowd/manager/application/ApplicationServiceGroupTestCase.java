...
public class ApplicationServiceGroupTestCase extends ApplicationServiceTestCase
{
    ...
    public void testSearchDirectGroupRelationships_Constraints() throws Exception
    {
        ...
        // execute the tested method
        List members = applicationService.searchDirectGroupRelationships(application, QueryBuilder.queryFor(String.class, EntityDescriptor.user()).childrenOf(EntityDescriptor.group()).withName(GROUP1_NAME).returningAtMost(1));

        assertEquals(1, members.size());
        assertEquals(USER2_NAME, members.get(0));
    }
    ...
    public void testSearchNestedGroupRelationships_Constraints() throws Exception
    {
        ...
        // execute the tested method
        List members = applicationService.searchNestedGroupRelationships(application, QueryBuilder.queryFor(String.class, EntityDescriptor.user()).childrenOf(EntityDescriptor.group()).withName(GROUP1_NAME).returningAtMost(1));
    ...
    public void testSearchGroups_Constraints() throws Exception
    {
        ...
        assertEquals(GROUP2_NAME, groups.get(0).getName());
    }
