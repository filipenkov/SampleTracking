...
import com.atlassian.gadgets.test.RhinoJsUnitTest.RhinoJsUnitRunner;
...
public class RhinoJsUnitTest
{
    ...
    private static void checkJsUnitResultByLine(String line)
    {
        ...
        else
        {
            ...
            {
                currentTest = Description.createTestDescription(RhinoJsUnitTest.class, getTextBetweenQuotes(line));
