...
/**
 * <code>CrowdRuntimeException</code> is the superclass of Crowd-specific exceptions that may be thrown but not
 * necessarily caught.
 *
 * @since v2.1
 */
...
{
    /**
     * Constructs a new Crowd runtime exception with <code>null</code> as its
     ...
     * The cause is not initialized, and may subsequently be initialised by a
