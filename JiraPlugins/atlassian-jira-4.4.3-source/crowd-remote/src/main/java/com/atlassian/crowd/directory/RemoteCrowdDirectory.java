...
public class RemoteCrowdDirectory implements RemoteDirectory
{
     ...
     */
    public String getCurrentEventToken() throws OperationFailedException
    {
        try
        {
     ...
     * @throws OperationFailedException   if the operation has failed for any other reason, including invalid arguments
     */
    public Events getNewEvents(String eventToken) throws EventTokenExpiredException, IncrementalSynchronisationNotAvailableException, OperationFailedException
    {
        try
        {
