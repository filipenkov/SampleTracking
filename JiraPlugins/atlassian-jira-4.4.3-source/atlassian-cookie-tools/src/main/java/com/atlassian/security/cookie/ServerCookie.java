...
/**
 *  Server-side cookie representation. Copied from {@code org.apache.tomcat.util.ServerCookie}
 * implementation in Tomcat 6.0.29.
 * <p/>
 * Identical to Tomcat's implementation except for the removal of the functionality
 * which was unrelated to cookie encoding.
 *
 * @see <a href="http://svn.apache.org/repos/asf/tomcat/tc6.0.x/tags/TOMCAT_6_0_29/java/org/apache/tomcat/util/http/ServerCookie.java">org.apache.tomcat.util.ServerCookie</a>
 */
final class ServerCookie implements Serializable {
    ...
    public static final boolean STRICT_SERVLET_COMPLIANCE =
        Boolean.valueOf(System.getProperty("org.apache.catalina.STRICT_SERVLET_COMPLIANCE", "false"));

    /**
     * If set to false, we don't use the IE6/7 Max-Age/Expires work around
     */
    public static final boolean ALWAYS_ADD_EXPIRES =
        Boolean.valueOf(System.getProperty("org.apache.tomcat.util.http.ServerCookie.ALWAYS_ADD_EXPIRES", "true"));
