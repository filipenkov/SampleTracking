...
import static com.atlassian.crowd.embedded.testing.TestData.Attributes.ATTRIBUTE3;
import static com.atlassian.crowd.embedded.testing.TestData.Attributes.VALUE_22;
...
public class OfBizDirectoryDaoTest extends AbstractTransactionalOfBizTestCase
{
    ...
    {
        final DirectoryImpl directory = directoryDao.add(TestData.Directory.getUnmockedTestData());
