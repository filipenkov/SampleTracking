...
public class ErrorEntity
{
     ...
     *
     * @param exception exception from which the ErrorEntity has to be created.
     * @return ErrorEntity.
     */
    public static ErrorEntity of(Exception exception)
    {
        return new ErrorEntity(ErrorEntity.ErrorReason.of(exception), ExceptionMapperUtil.stripNonValidXMLCharacters(exception.getMessage()));
    }
}
