...
public class TestRemoteJiraIssueLinks extends BaseJiraWebTest
{
    ...
    {
        Properties jira2Properties = LocalTestEnvironmentData.loadProperties("test.jira2.server.properties", "jira2test.properties");
        JIRAEnvironmentData jira2EnvironmentData = new LocalTestEnvironmentData(jira2Properties, null);
        jira2 = new JiraTestedProduct(new EnvironmentBasedProductInstance(jira2EnvironmentData));
        Backdoor jira2Backdoor = jira2.injector().getInstance(Backdoor.class);
    ...
    public void testCreateRemoteJiraLinkOAuth() throws Exception
    {
        ...
        ViewIssuePage viewIssuePage = jira.goToViewIssue("HSP-3");
        ...
        IssueLinkSection issueLinkSection = linkRemoteJiraSection.setIssueKey("TST-1").submit().getIssueLinkSection();
        IssueLink issueLink = getOnlyElement(issueLinkSection.getLinks());
    ...
    public void testUpdatingRemoteIssueUpdatesLink() throws Exception
    {
        ...
        assertEquals(jira2.getProductInstance().getBaseUrl() + "/images/icons/status_closed.gif", issueLink.getStatusIconUrl());
    ...
    public void testCreateDuplicateRemoteJiraLinkFails() throws Exception
    {
        ...
        ViewIssuePage viewIssuePage = jira.goToViewIssue("HSP-4");
    ...
    public void testCreateRemoteJiraLinkWithNoPermissionFails() throws Exception
    {
        ...
        ViewIssuePage viewIssuePage = jira.gotoLoginPage().login("fred", "fred", ViewIssuePage.class, "MKY-1");
    ...
    private void createAppLinkWithNoAuthConfiguredToJira2()
    {
        jira.gotoLoginPage()
                .loginAsSysAdmin(ViewApplinksPage.class)
                .createAppLinkWithNoAuthConfigured(jira.getProductInstance().getBaseUrl(),
                        jira2.getProductInstance().getBaseUrl(),
                        "admin", "admin");
    }
    ...
    private OAuthConfirmPage startOAuthDance(LinkJiraSection linkRemoteJiraSection)
    {
