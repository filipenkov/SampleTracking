...
public class TestSchemeComparisonTool extends JIRAWebTest
{
    ...
    public void testPermissionSchemeComparison()
    {
        ...
        assertTextNotPresent("View Version Control");
    ...
    public void testPermissionSchemesWithSomeDifference() throws SAXException
    {
        ...
        assertFalse(tableCellHasText(projectRolesTable, 1, 1, "Project Role (Administrators) "));
        assertFalse(tableCellHasText(projectRolesTable, 1, 1, "Single User (fred)"));
        ...
        assertTrue(tableCellHasText(projectRolesTable, 1, 2, "Single User (fred)"));
    }
