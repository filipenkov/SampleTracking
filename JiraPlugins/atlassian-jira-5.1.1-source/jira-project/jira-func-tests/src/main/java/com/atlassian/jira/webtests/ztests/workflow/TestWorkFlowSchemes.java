...
public class TestWorkFlowSchemes extends JIRAWebTest
{
    ...
    public void testWorkFlowSchemes()
    {
        ...
        gotoWorkFlowScheme();
        tester.clickLink("edit_workflows_10000");
        tester.assertTextPresent("New Workflow Scheme");
        tester.assertTextNotPresent("The \"New Workflow Scheme\" workflow scheme is active therefore you cannot change its workflows.");
        ...
        gotoWorkFlowScheme();
        tester.clickLink("edit_workflows_10000");
        tester.assertTextPresent("The \"New Workflow Scheme\" workflow scheme is active therefore you cannot change its workflows.");
    ...
    public void testNoIssueTypeToWorkflowAssociations()
    {
        ...
        assertions.assertNodeHasText(new CssLocator(tester, ".aui-message.info"), "You do not currently have any Issue Type to Workflow associations configured.");
    }
    ...
    public void workflowAddScheme()
    {
        ...
        tester.assertTextPresent(WORKFLOW_SCHEME);
    }
    ...
    public void workflowAddDuplicateLinkedStatus()
    {
        ...
        tester.assertTextPresent("A status with that name already exists.");
    }
    ...
    public void workflowAddInvalidLinkedStatus()
    {
        ...
        addLinkedStatus("", "");
        tester.assertTextPresent("You must specify a name for the status to be added.");
    }
    ...
    public void workflowAssignWorkflowSchemeToIssueType()
    {
        ...
        assignWorkflowScheme("10000", "Bug", WORKFLOW_COPIED);
