...
/**
 * Mock implementation of {@link com.atlassian.jira.webtest.framework.core.query.TimedQuery}.
 *
 * @since v4.3
 */
public class MockTimedQuery<T> extends AbstractTimedQuery<T>
{
    private static final Logger log = Logger.getLogger(MockTimedQuery.class);
