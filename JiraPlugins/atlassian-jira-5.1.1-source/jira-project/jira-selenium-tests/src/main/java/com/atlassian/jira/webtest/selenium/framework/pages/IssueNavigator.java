...
{
    private static final String DETECTOR = "jquery=section#content header h1:contains(Issue Navigator)";
    ...
    {
        assertThat.elementContainsText("jquery=.results-count", from.toString() + " to " + to.toString());
        assertThat.elementContainsText("class=results-count-total", total.toString());
    }
