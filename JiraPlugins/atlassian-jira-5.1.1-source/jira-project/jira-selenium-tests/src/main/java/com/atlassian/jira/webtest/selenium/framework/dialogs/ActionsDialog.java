...
public class ActionsDialog extends AbstractDialog<ActionsDialog>
{
    ...
    {
        final String activeSelector = "css=#issueactions-suggestions li.active a";
        assertThat.elementPresentByTimeout(activeSelector, WAIT_TIME);
        client.click(activeSelector);
    }
