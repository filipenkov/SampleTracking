...
public class TestIssuePickerPopup extends JiraSeleniumTest
{
    ...
    private static final String CSS_LINK_ISSUE_DIALOG_TEXTAREA = "css=#link-issue-dialog #jira-issue-keys-textarea";
    ...
    public void testLinkIssue() throws InterruptedException
    {
        ...
        final SeleniumTypeWriter writer = new SeleniumTypeWriter(context().client(),
                SeleniumLocators.css("#link-issue-dialog #jira-issue-keys-textarea", context()).fullLocator(), TypeMode.TYPE);
...
//        client.typeWithFullKeyEvents(CSS_LINK_ISSUE_DIALOG_TEXTAREA, "HSP-2");
        assertThat.elementNotPresentByTimeout("jquery=#jira-issue-keys-suggestions li:contains(HSP-2)", TIMEOUT);

        // after remove, does suggest HSP-2
        client.click("jquery=#link-issue-dialog li[title*='HSP-2'] .item-delete");
        client.typeWithFullKeyEvents(CSS_LINK_ISSUE_DIALOG_TEXTAREA,"HSP-2");
        assertThat.elementPresentByTimeout("jquery=#jira-issue-keys-suggestions li:contains(HSP-2)", TIMEOUT);
        ...
        assertThat.elementPresentByTimeout("jquery=#jira-issue-keys-multi-select[data-query='a']");
        client.click("jquery=#jira-issue-keys-suggestions li.active a");
        ...
        client.typeWithFullKeyEvents(CSS_LINK_ISSUE_DIALOG_TEXTAREA, "HSP-2");
        assertThat.elementPresentByTimeout("jquery=#jira-issue-keys-multi-select[data-query='HSP-2']");
        client.click("jquery=#jira-issue-keys-suggestions li.active a");
        assertThat.elementPresentByTimeout("jquery=#link-issue-dialog li[title*='HSP-2']", TIMEOUT);
        openIssuePickerFromMultiSelect();
        client.clickLinkWithText("HSP-2", false);
