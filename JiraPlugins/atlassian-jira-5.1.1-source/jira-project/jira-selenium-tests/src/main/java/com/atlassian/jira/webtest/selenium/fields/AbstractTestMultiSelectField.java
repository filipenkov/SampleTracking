...
public abstract class AbstractTestMultiSelectField extends JiraSeleniumTest
{
    ...
    private static final String JQUERY_EDIT_ISSUE = "edit-issue";
    ...
    {
        super.onSetUp();
        backdoor.dataImport().restoreData(getXMLFileName());
    ...
    abstract class Form
    {
        ...
        {
            assertThat.elementPresentByTimeout(fieldSelector, DROP_DOWN_WAIT * 4);
        }
    ...
    final class EditIssueForm extends Form
    {
        ...
        void gotoForm()
        {
            ...
            client.open(client.getAttribute(JQUERY_EDIT_ISSUE + "@href"));
    ...
    final class CreateSubTask extends Form
    {
        ...
        void gotoForm()
        {
            ...
            quickCreateSubtask.setFieldValue(SUMMARY, BOGUS_ISSUE);
        }
    ...
    final class CreateIssueForm extends Form
    {
        ...
        {
            quickCreate.open();
            client.select(quickCreate.projectSelectLocator(), HOMOSAPIEN);
            client.select(quickCreate.issueTypeSelectLocator(), BUG);
    ...
    final class ConvertToIssue extends Form
    {
        ...
        void gotoForm()
        {
            ...
            //go to the subtask we just created.
    ...
    final class ResolveIssue extends Form
    {
        ...
        void submitForm()
        {
            client.click(ISSUE_WORKFLOW_TRANSITION_SUBMIT);
            waitForContentUpdate();
        }
    }
}
