...
public class TestWorkflowTransition extends AbstractAuiDialogTest
{
...
//        Timeout.waitFor(20).seconds();
            ...
            assertThat.elementContainsText("jquery=section#content header h1", "This is my first test issue!");
