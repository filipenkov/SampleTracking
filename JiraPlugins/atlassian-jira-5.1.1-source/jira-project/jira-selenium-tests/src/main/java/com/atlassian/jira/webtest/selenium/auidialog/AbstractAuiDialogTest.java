...
public abstract class AbstractAuiDialogTest extends JiraSeleniumTest
{
    ...
    private static final String ERROR_MESSAGE_SELECTOR = VISIBLE_DIALOG_CONTENT_SELECTOR + " .aui-message.error";
    private static final String WARNING_MESSAGE_SELECTOR = VISIBLE_DIALOG_CONTENT_SELECTOR + " .aui-message.warning";
    ...
    protected final void assertAuiErrorMessage(String expectedText) {
        assertThat.elementPresentByTimeout(ERROR_MESSAGE_SELECTOR, DEFAULT_TIMEOUT);
