...
public class TestFrotherControlRenderers extends JiraSeleniumTest
{
    ...
    public void testCustomFieldConfigAlsoShowsRenderers()
    {
        ...
        client.click("id=add-field-configuration");
        assertThat.elementPresentByTimeout("name=fieldLayoutName", PAGE_LOAD_WAIT_TIME);

        client.type("fieldLayoutName", "Some random field configuration");
        client.click("id=add-field-configuration-submit", true);

        assertThat.textPresentByTimeout("Autocomplete Renderer");
    }
