 ...
 * <tt>T</tt>. The query may be evaluated immediately ({@link #now()}, within a default timeout ({@link #byDefaultTimeout()},
 * or within a client-specified custom timeout ({@link #by(long)}. Usually there is a specific value of <tt>T</tt> expected
 * by the query and it will not return until the underlying query evaluates to this expected value, or the timeout expires. 
 *
 * <p>
