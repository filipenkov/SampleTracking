            ...
            <div class="toolbar-split toolbar-split-right">
                <ul class="toolbar-group">
                    <li class="toolbar-item">
                        <a id="add-field-configuration" class="toolbar-trigger trigger-dialog" href="AddFieldConfiguration!default.jspa">
                            <span class="icon icon-add16"></span>
                            <ww:text name="'admin.field.configuration.add.button.label'"/>
                        </a>
                    </li>
                    <li class="toolbar-item">
                        <aui:component name="'issuefields'" template="toolbarHelp.jsp" theme="'aui'">
