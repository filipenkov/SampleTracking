...
.calendar,
.calendar table {background-color:#fff;cursor:default;font-size:12px;}
...
.calendar .nav div {background:transparent url("<%= path %>/menuarrow.gif") no-repeat 100% 60%;}

/* Header part -- contains navigation buttons and day names. */
    .calendar .headrow {background-color:#f2f2f2;}
    .calendar .headrow td {border-top:1px solid #bbb;}
    .calendar .daynames td {background-color:#3C78B5;color:#fff}
    ...
    .calendar td.time span.hilite {background-color:#99B5DF;}
     /* active (pressed) buttons */
    .calendar td.active,
    .calendar .combo .active,
    .calendar td.time span.active{background-color:#369;color:#fff;}
    /* row hover */
    .calendar .rowhilite,
    .calendar .rowhilite .wn {background-color:#f7f7f7;}
...
.calendar .combo {background-color:#fff;border:1px solid #bbb;border-top:none;cursor: default;display: none;left: 0;position: absolute;top: 0;width: 4em;z-index: 100;}
    ...
    .calendar .combo .label-IEfix {text-align:center;padding:2px;}
