                ...
                <div class="toolbar-split toolbar-split-right">
                    <ul class="toolbar-group">
                        <li class="toolbar-item">
                            <a id="edit-attachments" class="toolbar-trigger trigger-dialog" href="EditAttachmentSettings!default.jspa">
                                <span class="icon butt-edit"></span>
                                <ww:text name="'admin.common.phrases.edit.settings'"/>
                            </a>
                        </li>
                        <li class="toolbar-item">
                            <aui:component name="'attachments'" template="toolbarHelp.jsp" theme="'aui'">
