                    ...
                    <form class="selectorform" name="selectorform">
                        <table class="aui aui-table-rowhover">
                            ...
                            <ww:iterator value="currentPage" status="'status'">
                                <tr title="<ww:text name="'picker.click.to.select'"><ww:param name="'value0'"><ww:property value="name"/></ww:param></ww:text>" <ww:if test="/multiSelect == false">onclick="select(getElementById('groupname_<ww:property value="@status/index"/>').getAttribute('value'));"</ww:if> >
