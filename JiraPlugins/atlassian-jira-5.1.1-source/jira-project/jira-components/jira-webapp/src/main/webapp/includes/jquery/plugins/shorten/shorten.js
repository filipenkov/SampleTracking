 ...
 *
 * @class Shortener
 * @requires AJS.Control
 *
 */
AJS.Shortener = AJS.Control.extend({
    ...
    _renders: {
        ...
        "expandButton": function () {
            return AJS.$("<a href='#' class='ellipsis shortener-expand' title='" + this.options.expandButtonTooltip + "'></a><br>");
        },
        ...
        "collapseButton": function () {
            return AJS.$("<a title='Hide' class='icon icon-hide shortener-collapse' href='#'><span>" + this.options.collapseButtonTooltip + "</span></a>");
        }
    },
