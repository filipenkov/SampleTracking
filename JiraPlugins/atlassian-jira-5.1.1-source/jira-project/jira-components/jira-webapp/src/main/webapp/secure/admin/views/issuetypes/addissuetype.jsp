...
<page:applyDecorator id="add-issue-type-form" name="auiform">
    ...
    <ww:if test="iconEnabled == true">
        <page:applyDecorator name="auifieldgroup">
            <aui:component label="text('admin.common.phrases.icon.url')" id="'issue-type-icon-picker'" name="'iconurl'" mandatory="true" template="iconpicker.jsp" theme="'aui'">
                <aui:param name="'fieldType'"><ww:property value="fieldId"/></aui:param>
            </aui:component>
