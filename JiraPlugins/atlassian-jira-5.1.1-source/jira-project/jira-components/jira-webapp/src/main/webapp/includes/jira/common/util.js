...
(function() {
    ...
    function preventScrolling(e) {
        ...
        if (keyCode === keys.DOWN || keyCode === keys.UP || keyCode === keys.LEFT || keyCode === keys.RIGHT) {
            ...
            if (AJS.consumesKeyboardEvents($el)) {
                // do nothing
            } else {
                e.preventDefault();
            }
...
// JRA-27574 - including newer cookie.js from AUI until AUI is updated to version 3.6.0 or later
// TODO: Remove this code when AUI is updated to version 3.6.0+
(function () {
