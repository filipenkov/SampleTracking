...
<table class="aui aui-table-rowhover" id="summary_table">
    ...
    <ww:iterator value="/multiBulkMoveBean/issuesInContext" status="'status'">
        <tr>
            ...
            <td>
                <ul class="imagebacked"><li style="background-image: url('<ww:url value="./key/issueTypeObject/iconUrl" />')"><ww:property value="./key/issueTypeObject/nameTranslation" /><br />
                <span class="smallGrey"><ww:property value="./key/issueTypeObject/descTranslation" /></span></li>
                </ul>
            </td>
            <td>
