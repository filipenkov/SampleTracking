        ...
        <div class="toolbar-split toolbar-split-right">
            <ul class="toolbar-group">
                ...
                <ww:if test="/addableIssueOperations/empty == false && /fieldScreens/empty == false">
                    <a id="add-screen-scheme-item" class="toolbar-trigger trigger-dialog" href="<ww:url page="AddFieldScreenSchemeItem!input.jspa" atltoken="false"><ww:param name="'id'" value="/id"/></ww:url>">
                        <span class="icon icon-add16"></span>
                        <ww:text name="'admin.issuefields.screenschemes.add.issue.operation'"/>
                    </a>
                </ww:if>
                <ww:else>
                    <span class="toolbar-trigger disabled" title="<ww:text name="'admin.issuefields.screenschemes.all.operations.have.an.association.edit'"/>">
                        <span class="icon icon-add16"></span>
                        <ww:text name="'admin.issuefields.screenschemes.add.issue.operation'"/>
                    </span>
                </ww:else>
                ...
                <li class="toolbar-item">
                    <aui:component name="'fieldscreenschemes'" template="toolbarHelp.jsp" theme="'aui'">
