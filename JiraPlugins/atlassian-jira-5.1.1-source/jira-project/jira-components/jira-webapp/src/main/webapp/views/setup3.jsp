...
<head>
    ...
    <jira:web-resource-require modules="com.atlassian.jira.jira-mail-plugin:mail-servers"/>
</head>
...
<page:applyDecorator id="jira-setupwizard" name="auiform">
    ...
    <page:applyDecorator name="auifieldset">
        ...
        <page:applyDecorator name="auifieldgroup">
            ...
            <aui:radio id="'email-notifications-disabled'" label="'Disable'" list="null" name="'noemail'" theme="'aui'">
                <aui:param name="'customValue'">true</aui:param>
                <ww:if test="noemail == true">
                    <aui:param name="'checked'">true</aui:param>
                </ww:if>
            </aui:radio>
            <aui:radio id="'email-notifications-enabled'" label="'Enable'" list="null" name="'noemail'" theme="'aui'">
    ...
    <page:applyDecorator name="auifieldgroup">
        ...
        <page:applyDecorator name="auifieldgroup">
            ...
            <div class="hidden throbber-message">
                <span id="test-connection-throbber" class="hidden"><ww:text name="'admin.mailserver.verify.testing'" /></span>
            </div>
