                    ...
                    <tbody>
                        ...
                        <ww:iterator value="attachments" status="'status'">
                            <tr>
                                ...
                                <td><ww:if test="@userUtils/existsUser(author) == true"><ww:property value="@userUtils/user(author)/displayName"/></ww:if><ww:else><span title="<ww:text name="'admin.viewuser.user.does.not.exist.title'" />"><ww:property value="author"/></span></ww:else></td>
