JIRA.ProjectSample = Class.extend({
    init: function(options) {
        ...
        this.events.bind("updated.Name", AJS.$.proxy(function() { this.updateSampleName(arguments[1]); }, this));
        this.events.bind("updated.Key", AJS.$.proxy(function() { this.updateSampleKey(arguments[1]); }, this));
        this.events.bind("updated.Avatar", AJS.$.proxy(function() { this.updateSampleAvatar(arguments[1]); }, this));
    },
