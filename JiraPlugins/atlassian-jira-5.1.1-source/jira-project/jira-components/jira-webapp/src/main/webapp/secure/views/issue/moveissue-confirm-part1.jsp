...
<ww:if test="workflowMatch(issue/string('type'), targetIssueType) == false">
    <tr>
        ...
        <td>
            <ww:if test="statusMatch() == false">
                <span class="status-inactive"><ww:property value="/nameTranslation(constantsManager/status(issue/string('status')))" /></span>
            </ww:if>
            <ww:else>
                <ww:property value="/nameTranslation(constantsManager/status(issue/string('status')))" />
            </ww:else>
                <ww:if test="workflowMatch(issue/string('type'), targetIssueType) == false">
        ...
        <td>
            <ww:if test="statusMatch() == false">
                <span class="status-active"><ww:property value="./moveIssueBean/targetStatusName" /></span>
            </ww:if>
            <ww:else>
                <ww:property value="./moveIssueBean/targetStatusName" />
            </ww:else>
            <ww:if test="workflowMatch(issue/string('type'), targetIssueType) == false">
