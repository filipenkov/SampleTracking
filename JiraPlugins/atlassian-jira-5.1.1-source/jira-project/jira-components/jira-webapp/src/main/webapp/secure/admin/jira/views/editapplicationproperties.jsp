    ...
    <tr>
        ...
        <td>
            ...
            <br><span class="subText">
                <ww:text name="'admin.useravatar.gravatar.option.description'" value0="'<a href=\"http://www.gravatar.com\">'" value1="'</a>'"></ww:text>
            </span>
        </td>
    </tr>
    ...
    <ww:if test="showDisableInlineEdit == 'true'">
        <tr data-property-id="disableInlineEdit">
            ...
            <td>
                ...
                <br><span class="subText">
                    <ww:text name="'admin.generalconfiguration.inline.edit.description'" value0="'<a href=\"http://www.gravatar.com\">'" value1="'</a>'"></ww:text>
                </span>
            </td>
        </tr>
    </ww:if>
