...
(function () {
    ...
    JIRA.ToggleBlock = Class.extend({
        ...
        init: function (options) {
            ...
            AJS.$(document).delegate(this.options.blockSelector, "reveal", {instance: this}, expand);

            // make sure we don't double bind
            AJS.$(document).delegate(this.options.triggerSelector, this.options.eventType, {instance: this}, toggle);

            JIRA.bind(JIRA.Events.REFRESH_TOGGLE_BLOCKS, {instance: this}, refreshToggleBlocks);
