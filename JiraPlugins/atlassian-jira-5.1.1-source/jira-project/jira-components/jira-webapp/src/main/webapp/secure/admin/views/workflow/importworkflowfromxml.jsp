...
<page:applyDecorator id="import-workflow" name="auiform">
    ...
    <page:applyDecorator name="auifieldgroup" id="definition-file-content">
        ...
        <aui:textfield label="text('admin.workflows.importworkflow.file.path')" id="'filePath'" mandatory="true" maxlength="60" name="'filePath'" theme="'aui'" />
    </page:applyDecorator>
    ...
    <page:applyDecorator name="auifieldgroup" id="definition-inline-content">
        ...
        <aui:textarea label="text('admin.workflows.importworkflow.workflow.definition.xml')" id="'workflowXML'" mandatory="true" rows="10" cols="40" name="'workflowXML'" theme="'aui'" />
    </page:applyDecorator>
