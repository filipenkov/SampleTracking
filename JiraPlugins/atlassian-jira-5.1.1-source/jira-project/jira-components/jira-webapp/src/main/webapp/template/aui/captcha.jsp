...
<div id="captcha">
    ...
    class="text captcha-response <ww:property value="parameters['size']"><ww:if test=". == 'long'">long-field</ww:if><ww:elseIf test=". == 'medium'">medium-field</ww:elseIf><ww:elseIf test=". == 'short'">short-field</ww:elseIf><ww:elseIf test=". == 'very-short'">very-short-field</ww:elseIf></ww:property>
    ...
    <div class="captcha-container">
        ...
        <a class="captcha-trigger" href="<ww:property value="parameters['iconURI']"><ww:if test="."><ww:property value="."/></ww:if><ww:else>#</ww:else></ww:property>"<ww:property value="parameters['id']"><ww:if test="."> id="<ww:property value="@jira.sitemesh.decorator.computed.id" /><ww:property value="."/>-icon"</ww:if></ww:property><ww:property value="parameters['iconTitle']"><ww:if test="."> title="<ww:property value="."/>"</ww:if></ww:property>>
            <span class="aui-icon captcha-reload<ww:property value="parameters['iconCssClass']"><ww:if test="."> <ww:property value="."/></ww:if></ww:property>"></span>
