...
<page:applyDecorator id="add-subtask-issue-type-form" name="auiform">
    ...
    <page:applyDecorator name="auifieldgroup">
        <aui:component label="text('admin.common.phrases.icon.url')" id="'subtask-type-icon-picker'" name="'iconurl'" mandatory="true" template="iconpicker.jsp" theme="'aui'">
            <aui:param name="'fieldType'"><ww:property value="'subtasks'"/></aui:param>
        </aui:component>
        <page:param name="description"><ww:text name="'admin.common.phrases.relative.to.jira'"/></page:param>
    </page:applyDecorator>
</page:applyDecorator>
</body>
</html>