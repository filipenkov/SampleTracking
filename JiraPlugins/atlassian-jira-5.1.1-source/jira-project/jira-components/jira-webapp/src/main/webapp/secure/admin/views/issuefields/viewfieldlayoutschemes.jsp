            ...
            <div class="toolbar-split toolbar-split-right">
                <ul class="toolbar-group">
                    <li class="toolbar-item">
                        <a id="add-field-configuration-scheme" class="toolbar-trigger trigger-dialog" href="AddFieldConfigurationScheme!default.jspa">
                            <span class="icon icon-add16"></span>
                            <ww:text name="'admin.issuefields.fieldconfigschemes.add.field.configuration.scheme'"/>
                        </a>
                    </li>
                    <li class="toolbar-item">
                        <aui:component name="'issuefieldschemes'" template="toolbarHelp.jsp" theme="'aui'">
