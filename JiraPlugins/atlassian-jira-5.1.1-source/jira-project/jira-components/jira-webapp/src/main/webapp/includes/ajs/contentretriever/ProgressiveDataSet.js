/**
 * @fileOverview describes a DataSource object.
 *
 * This object serves as part of a series of components to supercede AJS.ContentRetriever and AJS.InlineLayer.
 */

JIRA.ProgressiveDataSet = Backbone.Collection.extend(
/** @lends JIRA.ProgressiveDataSet.prototype */
{
    /**
     * @class JIRA.ProgressiveDataSet
     *
     ...
     *
     * DataSouce can be given a remote query endpoint to fetch data from. Should a remote endpoint
    ...
    query: function(query) {
        ...
        if (!query || !this._queryEndpoint || this.hasQueryCache(query) || !this.shouldGetMoreResults(results)) return;
