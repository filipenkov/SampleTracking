    ...
    return {
        ...
        */
        ...
        _makeRequest: function (options) {
            ...
            var that = this,
                requestParams = AJS.copyObject(options);
            ...
            return this.pendingRequest = JIRA.SmartAjax.makeRequest(requestParams);
        },
...
AJS.namespace("jira.widget.autocomplete", null, JIRA.AutoComplete);
