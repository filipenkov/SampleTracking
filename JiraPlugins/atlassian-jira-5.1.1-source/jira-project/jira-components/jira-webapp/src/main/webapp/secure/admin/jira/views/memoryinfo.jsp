                    ...
                    <tr>
                        ...
                        <td class="cell-type-value">
                            <table border="0" cellpadding="0" cellspacing="0" style="float:left;margin-right:8px;" width="40%">
                                ...
                                <td bgcolor="#00CC00" width="<ww:property value="@math/percentage(/extendedSystemInfoUtils/systemInfoUtils/freeMemory, /extendedSystemInfoUtils/systemInfoUtils/totalMemory)"/>%">
