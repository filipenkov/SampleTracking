            ...
            <div class="toolbar-split toolbar-split-right">
                <ul class="toolbar-group">
                    <li class="toolbar-item">
                        <a id="add-field-screen" class="toolbar-trigger trigger-dialog" href="AddNewFieldScreen.jspa">
                            <span class="icon icon-add16"></span>
                            <ww:text name="'admin.issuefields.screens.add.screen'"/>
                        </a>
                    </li>
                    <li class="toolbar-item">
                        <aui:component name="'fieldscreens'" template="toolbarHelp.jsp" theme="'aui'">
