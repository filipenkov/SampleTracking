...
<ww:if test="/descriptorTab == 'all' || /descriptorTab == 'validators'">
    ...
    <ww:text name="'admin.workflowtransition.addnewvalidator'">
        <ww:param name="'value0'"><a id="add_new_validator" href="<ww:url page="AddWorkflowTransitionValidator!default.jspa"><ww:param name="'workflowMode'" value="workflow/mode" /><ww:param name="'workflowName'" value="workflow/name" /><ww:param name="'workflowStep'" value="step/id" /><ww:param name="'workflowTransition'" value="transition/id" /></ww:url>"><b></ww:param>
