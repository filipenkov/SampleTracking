...
<page:applyDecorator name="jirapanel">
    ...
    <p>
        <ww:text name="'admin.workflows.thispageshows'">
            <ww:param name="'value0'"><b><a href="<ww:url page="ViewWorkflowStep.jspa"><ww:param name="'workflowMode'" value="/workflow/mode" /><ww:param name="'workflowName'" value="/workflow/name" /><ww:param name="'workflowStep'" value="/step/id" /></ww:url>"><ww:property value="/step/name" /></a></b></ww:param>
        </ww:text>
    </p>
    <ul>
