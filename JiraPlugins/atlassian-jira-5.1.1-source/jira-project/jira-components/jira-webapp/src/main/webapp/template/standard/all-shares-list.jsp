...
<ww:else>
    <ww:property value="./allSharePermissions">
        <ww:if test="./size > 2">
            <ul class="shareList" id="share_list_summary_<ww:property value="../id"/>" onclick="atlassian.jira.share.toggleElements('share_list_complete_<ww:property value="../id"/>', 'share_list_summary_<ww:property value="../id"/>')">
            ...
            <ul class="shareList" id="share_list_complete_<ww:property value="../id"/>" style="display: none;" onclick="atlassian.jira.share.toggleElements('share_list_summary_<ww:property value="../id"/>', 'share_list_complete_<ww:property value="../id"/>')">
        </ww:if>
        <ww:else>
            <ul class="shareList">
        </ww:else>
