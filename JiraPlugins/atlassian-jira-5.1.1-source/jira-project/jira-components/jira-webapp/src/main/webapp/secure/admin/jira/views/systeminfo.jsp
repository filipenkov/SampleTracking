            ...
            <div class="toolbar-split toolbar-split-right">
                <ul class="toolbar-group">
                    <li class="toolbar-item">
                        <aui:component name="'system_information_help'" template="toolbarHelp.jsp" theme="'aui'">
    ...
    <aui:component template="module.jsp" theme="'aui'">
        ...
        <aui:param name="'contentHtml'">
            <table class="aui aui-table-rowhover" id="file_paths">
                <tbody>
                    <tr>
                        <td class="cell-type-key"><strong><ww:text name="'admin.systeminfo.location.of.jira.home'"/></strong></td>
