        ...
        <page:applyDecorator name="auifieldset">
            ...
            <ww:if test="/showAutowatch == true">
                <page:applyDecorator name="auifieldgroup">
                    ...
                    <aui:select id="'autowatch'" label="text('preferences.autowatch.title')" list="/autowatchList" listKey="'id'" listValue="'name'" name="'autowatchEnabled'" theme="'aui'" value="autowatchValue"/>
                </page:applyDecorator>
            </ww:if>
