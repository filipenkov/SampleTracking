            ...
            <div class="toolbar-split toolbar-split-right">
                <ul class="toolbar-group">
                    <li class="toolbar-item">
                        <a id="issuetype-scheme-add" class="toolbar-trigger"
                           href="<ww:url page="ConfigureOptionSchemes!default.jspa" atltoken="false">
                ...
                <ww:property value="/options(.)" >
                    <ww:if test=". && ./size() > 0">
                        ...
                        <ww:iterator value="." status="'status2'">
                            <li style="background-image: url('<ww:url value="./imagePath" atltoken="false"/>')"><span class="issue-type-name"><ww:property value="./name" /></span><ww:if test="/default(./id, ../..) == true"> <span class="issue-type-default">(<ww:text name="'admin.common.words.default'"/>)</span></ww:if></li>
                        </ww:iterator>
                        </ul>
                    </ww:if>
                    <ww:else>
