...
<%
    ...
    final KeyboardShortcutManager navigatorKeyboardShortcutManager = ComponentManager.getComponentInstanceOfType(KeyboardShortcutManager.class);
...
<body id="jira" class="aui-layout aui-theme-default page-type-issuenav <decorator:getProperty property="body.class" />">
<div id="page">
