...
<ol class="steps">
    ...
    <ww:else>
        <li class="todo"><ww:text name="'bulkedit.step2.title'"/></li>
    </ww:else>
            ...
            <ww:if test="!@hideSubMenu">
                ...
                <ul class="steps">
                    <ww:iterator value="./bulkEditBeans" status="'status'">
                        <li
                         <ww:if test="@status/index < ../currentBulkEditBeanIndex">
                             class="done"
                         </ww:if>
                         <ww:if test="@status/index == ../currentBulkEditBeanIndex">
                             class="current"
                             title="<ww:text name="'bulk.migrate.currently'" ><ww:param name="'value0'"><ww:property value="./key/project/string('name')" /></ww:param><ww:param name="'value1'"><ww:property value="./key/issueTypeObject/name" /></ww:param></ww:text>"
                         </ww:if>
                         <ww:else>
                             class="todo"
                         </ww:else>
    ...
    <ww:else>
        <li class="todo"><ww:text name="'bulkedit.step3.title'"/></li>
    </ww:else>
    <ww:if test="/rootBulkEditBean/currentStep == 4">
        <li class="current"><ww:text name="'bulkedit.step4.title'"/></li>
    </ww:if>
    <ww:else>
        <li class="todo"><ww:text name="'bulkedit.step4.title'"/></li>
    </ww:else>
</ol>