...
JIRA.AvatarManager = Class.extend({
    ...
    getAvatarSrc: function(avatar, size) {
        ...
        return this.avatarSrcBaseUrl + "?" + jQuery.param({
...
JIRA.AvatarManager.createProjectAvatarManager = function (options) {
    ...
    if (options.projectKey) {
        restQueryUrl = contextPath + "/rest/api/latest/project/" + options.projectKey + "/avatars";
        restUpdateUrl = contextPath + "/rest/api/latest/project/" + options.projectKey + "/avatar";
        restCreateTempUrl = contextPath + "/rest/api/latest/project/" + options.projectKey + "/avatar/temporary";
        restUpdateTempUrl = restUpdateUrl;
        restSingleAvatarUrl = restUpdateUrl;
    } else {
