            ...
            <ul class="toolbar-group">
                <ww:if test="/addableIssueTypes/empty == false">
                    <li class="toolbar-item">
                        <a id="add-issue-type-screen-scheme-configuration-association" class="toolbar-trigger trigger-dialog"
                ...
                <ww:else>
                    <li class="toolbar-item">
                        <span id="add-issue-type-screen-scheme-configuration-association"
                              title="<ww:text name="'admin.issuefields.screens.schemes.issuetype.all.issue.types.have.associations'"/>"
                              class="toolbar-trigger trigger-dialog disabled">
                            <span class="icon icon-add16"></span>
                            <ww:text name="'admin.issue.type.to.screen.scheme.association.button.label'"/>
                        </span>
                    </li>
                ...
                <li class="toolbar-item">
                    <aui:component name="'issuetype_screenschemes'" template="toolbarHelp.jsp" theme="'aui'">
