    ...
    <table class="aui aui-table-rowhover">
        ...
        <ww:iterator value="transition/conditionalResults" status="'status'">
            <tr>
                ...
                <td>
                    <a id="conditional_step_xml_<ww:property value="@status/count"/>" href="<ww:url page="ViewWorkflowTransitionConditionalResult.jspa"><ww:param name="'workflowMode'" value="/workflow/mode" /><ww:param name="'workflowName'" value="/workflow/name" /><ww:param name="'workflowStep'" value="/step/id" /><ww:param name="'workflowTransition'" value="/transition/id" /><ww:param name="'resultCount'" value="@status/count" /></ww:url>"><ww:text name="'admin.common.words.xml'"/></a>
                </td>
            </tr>
        </ww:iterator>
        </tbody>
