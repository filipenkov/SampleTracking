...
public class JiraDurationUtils implements Startable
{
     ...
     */
    protected ResettableLazyReference<DurationFormatter> formatterRef;
            ...
            final I18nHelper.BeanFactory i18nFactory)
    {
        ...
        this.formatterRef = new ResettableLazyReference<DurationFormatter>()
        {
            @Override
            protected DurationFormatter create()
            {
    ...
    public static class PrettyDurationFormatter implements DurationFormatter
    {
        ...
        public String format(Long duration)
        {
            ...
            final long secondsPerDay = hoursPerDay.multiply(secondsPerHour).longValueExact();
            final long secondsPerWeek = daysPerWeek.multiply(hoursPerDay).multiply(secondsPerHour).longValueExact();
            return DateUtils.getDurationPrettySeconds(duration, secondsPerDay, secondsPerWeek, locator.getHelper().getDefaultResourceBundle());
        }
        ...
        public String format(Long duration, Locale locale)
        {
            ...
            final long secondsPerDay = hoursPerDay.multiply(secondsPerHour).longValueExact();
            final long secondsPerWeek = daysPerWeek.multiply(hoursPerDay).multiply(secondsPerHour).longValueExact();
            final ResourceBundle bundle = locator.getHelper(locale).getDefaultResourceBundle();
            return DateUtils.getDurationPrettySeconds(duration, secondsPerDay, secondsPerWeek, bundle);
        }
