...
public interface ProjectManager
{
    ...
    /**
     * This is for informational purposes only. You should not use this to predict or create issue ids, because
     * this value may change concurrently as new issues are created.
     *
