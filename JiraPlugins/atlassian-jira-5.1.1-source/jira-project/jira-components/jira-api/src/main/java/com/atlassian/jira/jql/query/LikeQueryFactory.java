...
public class LikeQueryFactory implements OperatorSpecificQueryFactory
{
    ...
    {
        final QueryParser parser = new QueryParser(IssueIndexManager.LUCENE_VERSION, fieldName, getAnalyzer());
    ...
    {
        return ComponentAccessor.getComponent(IssueIndexManager.class).getAnalyzerForSearching();
    }
    ///CLOVER:ON
}
