 ...
 * Note that there is also another multi-select Custom Field for arbitrary {@link com.atlassian.jira.issue.customfields.option.Option}s - {@link MultiSelectCFType}.
 * <p>
...
public abstract class AbstractMultiCFType<S> extends AbstractCustomFieldType<Collection<S>, S>
{
     ...
     */
    @Override
    public void createValue(final CustomField customField, final Issue issue, final Collection<S> value)
    {
