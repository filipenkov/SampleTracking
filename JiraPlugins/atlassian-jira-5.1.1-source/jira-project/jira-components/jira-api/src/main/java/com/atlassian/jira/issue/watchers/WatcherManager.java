...
public interface WatcherManager
{
     ...
     * @return True if a user is watching the issue specified.
     *
     * @deprecated Use {@link #isWatching(com.atlassian.crowd.embedded.api.User, com.atlassian.jira.issue.Issue)} instead. Since v5.0.
     */
     ...
     * will receive updates for any modifications to the issue.  Note, that this will not
