...
public class RelativeDateSearcherInputTransformer implements SearchInputTransformer
{
    ...
    public void populateFromQuery(User searcher, FieldValuesHolder fieldValuesHolder, Query query, SearchContext searchContext)
    {
        ...
        if (query.getWhereClause() != null)
        {
            ...
            final DateSearcherInputHelper.ConvertClauseResult clauseResult = helper.convertClause(query.getWhereClause(), searcher, false);
    ...
    public boolean doRelevantClausesFitFilterForm(User searcher, Query query, SearchContext searchContext)
    {
        if (query != null && query.getWhereClause() != null)
        {
            ...
            return inputHelper.convertClause(whereClause, searcher, false).fitsFilterForm();
        }
        return true;
    }
