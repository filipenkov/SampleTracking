...
public class SortableTextCustomFieldIndexer extends AbstractCustomFieldIndexer
{
    ...
    private void addDocumentFields(final Document doc, final Issue issue, final Field.Index fieldIndexType, final boolean sortable)
    {
        ...
        if (sortable)
        {
            ...
            doc.add(new Field(sortFieldPrefix + getDocumentFieldId(), string, Field.Store.NO, Field.Index.NOT_ANALYZED_NO_NORMS));
        }
    }
}