...
public interface JiraWorkflow extends Comparable<JiraWorkflow>
{
     ...
     *
     * @deprecated Use {@link #getLinkedStatusObject(com.opensymphony.workflow.loader.StepDescriptor)} instead. Since v5.0.
     */
    ...
    /**
     * Returns either {@link #DRAFT} or {@link #LIVE} depending on the workflow
     * implementation.
