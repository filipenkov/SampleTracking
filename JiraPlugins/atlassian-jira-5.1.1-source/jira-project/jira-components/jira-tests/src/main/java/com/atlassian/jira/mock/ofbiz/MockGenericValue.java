...
public class MockGenericValue extends GenericValue {
    ...
    public List<GenericValue> getRelatedOrderBy(String relationName, List orderBy) throws GenericEntityException {
        return CoreFactory.getGenericDelegator().getRelatedOrderBy(relationName, orderBy, this);
    }

    public List<GenericValue> getRelatedByAnd(String relationName, Map fields) throws GenericEntityException {
    ...
    public Object clone()
    {
        return new MockGenericValue(entityName, newHashMap(fields));
    }
}
