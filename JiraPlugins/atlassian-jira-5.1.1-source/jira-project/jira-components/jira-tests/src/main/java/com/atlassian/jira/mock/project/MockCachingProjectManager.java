...
public class MockCachingProjectManager extends CachingProjectManager
{
    ...
    {
        super(decoratedProjectManager, (ProjectComponentManager) ComponentManager.getComponentInstanceOfType(DefaultProjectComponentManager.class), (ProjectFactory) ComponentManager.getComponentInstanceOfType(ProjectFactory.class), null, null);
    }
