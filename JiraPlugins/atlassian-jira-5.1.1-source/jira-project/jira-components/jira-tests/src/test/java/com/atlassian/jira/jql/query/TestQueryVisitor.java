 ...
 * @since v4.0
 */
public class TestQueryVisitor extends ListeningTestCase
{
    @Test
    public void testVisitAndClauseMustNotOccur() throws Exception
    {
        final DeMorgansVisitor deMorgansVisitor = new DeMorgansVisitor();
        QueryVisitor queryVisitor = new QueryVisitor(null, null, deMorgansVisitor);
    ...
    public void testVisitTerminalClauseHappyPath() throws Exception
    {
        ...
        QueryVisitor queryVisitor = new QueryVisitor(mockQueryRegistry, null, deMorgansVisitor);
    ...
    {
        final DeMorgansVisitor deMorgansVisitor = new DeMorgansVisitor();
        final QueryVisitor queryVisitor = new QueryVisitor(null, null, deMorgansVisitor);
