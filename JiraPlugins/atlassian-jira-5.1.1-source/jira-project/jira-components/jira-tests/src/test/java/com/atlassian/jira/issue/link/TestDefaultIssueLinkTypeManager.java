...
{
    private DefaultIssueLinkTypeManager diltm = new DefaultIssueLinkTypeManager(new MockOfBizDelegator(null, null));
    ...
    public void testRemoveLinkType() throws Exception
    {
        ...
        assertTrue(UtilsForIssueActionTests.contains(flushes, new Object[] { "flush", CacheManager.ISSUE_CACHE, ComponentAccessor.getIssueManager().getIssue(issue1.getLong("id")), null, null }));
        assertTrue(UtilsForIssueActionTests.contains(flushes, new Object[] { "flush", CacheManager.ISSUE_CACHE, ComponentAccessor.getIssueManager().getIssue(issue2.getLong("id")), null, null }));
    }
    ...
    public void testLink() throws Exception
    {
        ...
        assertTrue(UtilsForIssueActionTests.contains(flushes, new Object[] { "flush", CacheManager.ISSUE_CACHE, ComponentAccessor.getIssueManager().getIssue(issue1.getLong("id")), null, null }));
        assertTrue(UtilsForIssueActionTests.contains(flushes, new Object[] { "flush", CacheManager.ISSUE_CACHE, ComponentAccessor.getIssueManager().getIssue(issue2.getLong("id")), null, null }));
        assertEquals(1, ComponentAccessor.getIssueManager().getEntitiesByIssue(IssueRelationConstants.LINKS_OUTWARD, issue1).size());
        assertEquals(1, ComponentAccessor.getIssueManager().getEntitiesByIssue(IssueRelationConstants.LINKS_INWARD, issue2).size());
    }
    ...
    */
    ...
    {
        diltm = new DefaultIssueLinkTypeManager(delegator);
    }
