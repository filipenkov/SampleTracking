 ...
 * @since v4.3
 */
public class TestDefaultIndexManagerConcurrentIndexing extends MockedComponentManagerTestCase
{
    ...
    @Before
    public void stubMockIssueFactory()
    {
    ...
    public void testConcurrentIndexing() throws Exception
    {
        ...
        final DefaultIndexManager tested = new DefaultIndexManager(
                ...
                mockIndexer, indexPath, reindexMessageManager, eventPublisher, null, null);
    ...
    public void testConcurrentIndexingWithExceededIssuesToForceOptimizeThreshold() throws Exception
    {
        ...
        assertNoErrors(requesters);
        verifyIndexCalls(21);
        // max 3 optimizations due to issuesToForceOptimize + 1 due to maxReindexes
        verifyOptimizations(4);
    }
    ...
    private void verifyOptimizations(int max)
    {
        assertTrue(mockIndexer.optimizations.get() > 0);
        assertTrue(mockIndexer.optimizations.get() <= max);
    }
