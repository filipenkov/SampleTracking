...
public class TestDefaultWorklogService extends LegacyJiraMockTestCase
{
    ...
    public void testValidateParamsAndCreateWorklog()
    {
        final User testUser = new MockUser("testValidateCreateUser", "Test User", "test@atlassian.com");
    ...
    public void testHasPermissionToCreateWithUser()
    {
        final User testUser = new MockUser("testHasPermissionToCreateWithUser", "Test User", "test@atlassian.com");
    ...
    {
        final User user = createMockUser("testIsSameAuthorSpecificAuthor");
    ...
    public void testIsSameAuthorDifferentAuthors()
            throws OperationNotPermittedException, InvalidUserException, InvalidCredentialException
    {
        final User user1 = createMockUser("testIsSameAuthorDifferentAuthorsUserOne");
        final User user2 = createMockUser("testIsSameAuthorDifferentAuthorsUserTwo");
    ...
    public void testIsSameAuthorOneAnonymousAuthor()
            throws OperationNotPermittedException, InvalidUserException, InvalidCredentialException
    {
        final User user = createMockUser("testIsSameAuthorOneAnonymousAuthor");
        final Worklog worklog = new WorklogImpl(null, null, null, null, null, null, null, null, new Long(123));
    ...
    public void testHasPermissionToUpdateNoPermissionSpecificUser()
    {
        final Mock mockWorklog = new Mock(Worklog.class);
        mockWorklog.expectAndReturn("getIssue", new MockIssue());
        mockWorklog.expectAndReturn("getId", new Long(1));
        ...
        final User user = new MockUser("testHasPermissionToUpdateNoPermissionSpecificUser", "Tim Fullname", "yo@yo.net");
    ...
    public void testHasPermissionToUpdateHappyPathEditOwn()
    {
        ...
        final DefaultWorklogService defaultWorklogService = new DefaultWorklogService(null, null,
            (VisibilityValidator) mockVisibilityValidator.proxy(), null, null, null, null, null)
        {
            protected boolean hasEditOwnPermission(final User user, final Worklog worklog)
            {
                return true;
    ...
    public void testValidateUpdateWithNewEstimate()
    {
        ...
        final User user = new MockUser("testValidateUpdateWithNewEstimate", "Tim Fullname", "yo@yo.net");
        serviceContext = new JiraServiceContextImpl(user, errorCollection);
    ...
    public void testHasPermissionToDeleteNoPermissionSpecificUser()
    {
        final Mock mockWorklog = new Mock(Worklog.class);
        mockWorklog.expectAndReturn("getIssue", null);
        ...
        final User user = new MockUser("testHasPermissionToDeleteNoPermissionSpecificUser", "Tim Fullname", "yo@yo.net");
        serviceContext = new JiraServiceContextImpl(user, errorCollection);
