...
public class TestJiraCachingPropertySet extends MockControllerTestCase
{
    ...
    public void testXML() throws Exception
    {
        ...
        // Set a value in the underlying PropertySet
        final Document doc1 = getMock(Document.class);
        final Document doc2 = EasyMock.createMock(Document.class);
        replay(doc1,doc2);
    ...
    private JiraCachingPropertySet createJiraCachingPropertySet(final PropertySet underlyingPropertySet)
    {
