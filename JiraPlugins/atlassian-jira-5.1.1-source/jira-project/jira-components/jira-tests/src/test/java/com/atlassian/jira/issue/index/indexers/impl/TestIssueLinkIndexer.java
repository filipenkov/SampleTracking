...
public class TestIssueLinkIndexer
{
    ...
    public void checkAlwaysInScope()
    {
        ...
        Assert.assertTrue("Field should always be in scope because we use links to make epics work in greenhopper", issueLinkIndexer.isFieldVisibleAndInScope(null));
    }
