...
public class TestQuickLinkServlet extends ListeningTestCase
{
    ...
    private MockProjectManager projectManager = new MockProjectManager();
    ...
    private QuickLinkServlet quickLinkServlet;
    private JiraContactHelper mockJiraContactHelper;
    ...
    public void setUp() throws Exception
    {
        ...
        mockJiraContactHelper = EasyMock.createNiceMock(JiraContactHelper.class);
        ...
        quickLinkServlet = buildQuickLinkServlet(projectManager, issueManager, changeHistoryManager,
                mockJiraContactHelper, mockI18nHelper);
    ...
    public void testForwardToMovedIssue() throws Exception
    {
        ...
        QuickLinkServlet quickLinkServlet = buildQuickLinkServlet(null, mockIssueManager, mockChangeHistoryManager, mockJiraContactHelper, mockI18nHelper);
    ...
    private QuickLinkServlet buildQuickLinkServlet(final ProjectManager projectManager, final IssueManager issueManager,
            final ChangeHistoryManager changeHistoryManager, final JiraContactHelper jiraContactHelper, final I18nHelper mockI18nHelper)
    {
