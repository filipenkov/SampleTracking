...
public class TestSchemeIssueSecurities extends AbstractWebworkTestCase
{
    ...
    protected void setUp() throws Exception
    {
        ...
        ManagerFactory.addService(IssueSecurityLevelManager.class, new IssueSecurityLevelManagerImpl(issueSecuritySchemeManager, new IssueSecurityTypeManager(), null, null, null));
        ...
        bob = createMockUser("bobTestGetUsersSecurityLevels");
        joe = createMockUser("joeTestGetUsersSecurityLevels");

        //create a group and add user 2 to this group
        group = createMockGroup("groupA");
        addUserToGroup(bob, group);
        addUserToGroup(joe, group);
