...
public class TestEditLinkType extends LegacyJiraMockTestCase
{
    ...
    public void testValidationFailsWithNoName() throws Exception
    {
        ...
        mockIssueLinkTypeManager.expectAndReturn("getIssueLinkType", P.args(new IsEqual(id)), new IssueLinkTypeImpl(existingLinkType));
    ...
    public void testValidationFailsWithSameLinkNameAndDifferentID() throws Exception
    {
        ...
        mockIssueLinkTypeManager.expectAndReturn("getIssueLinkTypesByName", P.args(new IsEqual(name)), EasyList.build(new IssueLinkTypeImpl(anotherExistingLinkType)));
        mockIssueLinkTypeManager.expectAndReturn("getIssueLinkType", P.args(new IsEqual(id)), new IssueLinkTypeImpl(existingLinkType));
