...
public class TestDefaultJqlClauseBuilder extends MockControllerTestCase
{
    ...
    private DefaultJqlClauseBuilder createBuilder(final SimpleClauseBuilder clauseBuilder)
    {
    ...
    private DefaultJqlClauseBuilder createBuilder(final SimpleClauseBuilder clauseBuilder, final JqlDateSupport dateSupport)
    {
