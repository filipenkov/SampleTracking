...
public class TestSubTaskBeanImpl extends LegacyJiraMockTestCase
{
    ...
    public void testAllView()
    {
        ...
        assertEquals(new SubTaskImpl(new Long(0), subTaskOpen1, issue), iterator.next());
        assertEquals(new SubTaskImpl(new Long(1), subTaskClosed1, issue), iterator.next());
        assertEquals(new SubTaskImpl(new Long(2), subTaskOpen2, issue), iterator.next());
        assertEquals(new SubTaskImpl(new Long(3), subTaskClosed2, issue), iterator.next());
        assertEquals(new SubTaskImpl(new Long(4), subTaskClosed3, issue), iterator.next());
