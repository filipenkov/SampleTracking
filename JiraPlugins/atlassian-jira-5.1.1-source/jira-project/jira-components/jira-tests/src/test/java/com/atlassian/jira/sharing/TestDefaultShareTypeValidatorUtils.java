...
public class TestDefaultShareTypeValidatorUtils extends ListeningTestCase
{
    private User user;
    ...
    public void testIsValidSharePermissionPrivatePermissions()
    {
        ...
        final JiraServiceContext ctx = new JiraServiceContextImpl(null);
        final SharedEntity entity = new MockSharedEntity(new Long(1), SearchRequest.ENTITY_TYPE, user, SharePermissions.PRIVATE);
    ...
    public void testIsValidSharePermissionNullPermissionType()
    {
        ...
        final SharedEntity entity = new MockSharedEntity(new Long(1), SearchRequest.ENTITY_TYPE, user, new SharePermissions(permissions));
        validator.isValidSharePermission(ctx, entity);
