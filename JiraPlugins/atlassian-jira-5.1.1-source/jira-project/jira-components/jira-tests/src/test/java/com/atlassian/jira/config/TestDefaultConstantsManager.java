...
public class TestDefaultConstantsManager extends LegacyJiraMockTestCase
{
    ...
    protected void setUp() throws Exception
    {
        ...
        defaultConstantsManager = new DefaultConstantsManager(null, null, mockOfBizDelegator);
    }
    ...
    public void testGetPriority()
    {
        ...
        assertEquals(priority, ManagerFactory.getConstantsManager().getPriorityObject("1").getGenericValue());
    }
    ...
    public void testCreateIssueType() throws CreateException, GenericEntityException
    {
        ...
        final DefaultConstantsManager defaultConstantsManager = new DefaultConstantsManager(null, null, new MockOfBizDelegator());
    ...
    {
        String id = null;
        final DefaultConstantsManager defaultConstantsManager = new DefaultConstantsManager(null, null, null);
        try
        {
    ...
    public void testUpdateIssueType() throws StoreException, GenericEntityException
    {
        ...
        final DefaultConstantsManager defaultConstantsManager = new DefaultConstantsManager(null, null, ofBizDelegator);
