...
public class TestDefaultAssigneeService
{
    ...
    {
        service = new DefaultAssigneeService(permissionContextFactory, permissionSchemeManager, userManager, userHistoryManager, featureManager, authenticationContext);
    ...
    {
        MockIssue issue = new MockIssue(12345);
        issue.setAssigneeId("currentAssignee");
    ...
    {
        service = new DefaultAssigneeService(null, null, null, null, null, null);
    ...
    private List<ChangeItemBean> makeChangeItems(final int numItems)
    {
        ...
        {
            changeItemsForField.add(new ChangeItemBean("assignee", "assignee", "fakeOldAssignee", "fakeOldAssignee", "user" + i, "user" + i, new Timestamp(time + i)));
        }
    ...
    private List<UserHistoryItem> makeUserHistoryItems(final int numItems)
    {
        ...
        for (int i = 0; i < numItems; i++)
        {
            userHistoryItems.add(new UserHistoryItem(UserHistoryItem.ASSIGNEE, "user" + i));
