...
public class TestPortalPageRetriever extends MockControllerTestCase
{
    ...
    public void setUp() throws Exception
    {
        ...
        page1 = PortalPage.id(10L).name("page1").description("description of page 1").owner("mine").build();
        page2 = PortalPage.id(10L).name("page2").description("description of page 2").owner("yours").build();
