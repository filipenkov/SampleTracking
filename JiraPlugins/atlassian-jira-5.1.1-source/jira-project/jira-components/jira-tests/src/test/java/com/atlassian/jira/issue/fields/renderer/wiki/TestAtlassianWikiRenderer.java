...
public class TestAtlassianWikiRenderer extends ListeningTestCase
{
    ...
    {
        AtlassianWikiRenderer atlassianWikiRenderer = new AtlassianWikiRenderer(mockPublisher, new DefaultVelocityRequestContextFactory(new MockApplicationProperties()));
