...
public class ChainedFilterStepRunnerTest
{
    ...
    {
        final FilterCallContext callContext1 = new FilterCallContextImpl(null,null,null);
        final FilterCallContext callContext2 = new FilterCallContextImpl(null,null,null);
