...
public class UnitTestContainerProvider implements ContainerProvider
{
    ...
    {
        container = (DefaultPicoContainer) parent;
        ...
        container.unregisterComponent(PermissionManager.class);
        container.unregisterComponent(PermissionSchemeManager.class);
        container.unregisterComponent(PluginLoaderFactory.class);
        container.unregisterComponent(OsgiContainerManager.class);
        // .. and switch in the old DefaultPermissionManager (which WorkflowBasedPermissionManager extends).
        container.registerComponentImplementation(PermissionManager.class, DefaultPermissionManager.class);
        container.registerComponentImplementation(PermissionSchemeManager.class, DefaultPermissionSchemeManager.class);
        container.registerComponentImplementation(PluginLoaderFactory.class, EmptyPluginLoaderFactory.class);
    }
