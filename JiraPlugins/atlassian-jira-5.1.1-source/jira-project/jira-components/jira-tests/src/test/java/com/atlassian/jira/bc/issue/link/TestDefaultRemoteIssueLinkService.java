...
public class TestDefaultRemoteIssueLinkService
{
    ...
    private static final Long ISSUE_ID_THAT_DOES_NOT_EXIST = 10001L;
    ...
    public void setUp()
    {
        ...
        when(issueService.getIssue(user, ISSUE_ID_THAT_EXISTS)).thenReturn(new IssueService.IssueResult(ISSUE_THAT_EXISTS));
    ...
    public void testDeleteByGlobalIdWhenGlobalIdDoesNotExist() throws RemoveException
    {
        ...
        verify(remoteIssueLinkManager, times(0)).removeRemoteIssueLinkByGlobalId(any(Issue.class), anyString(), any(User.class));
    }
    ...
    private void createExpectingSuccess(final RemoteIssueLink remoteIssueLink)
    {
        ...
        assertTrue(remoteIssueLinkResult.isValid());
    ...
    {
        final DeleteValidationResult deleteValidationResult = remoteIssueLinkService.validateDelete(user, remoteIssueLinkId);
        assertFalse(deleteValidationResult.isValid());
    ...
    {
        assertFalse(remoteIssueLinkResult.isValid());
    ...
    {
        assertFalse(remoteIssueLinkListResult.isValid());
    ...
    private void assertFailure(final ErrorCollection errors, final Reason reason, final String ... erroneousFields)
    {
        ...
        {
            assertTrue(errors.getErrors().containsKey(erroneousField));
        }
    }
