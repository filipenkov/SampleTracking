 ...
 * @since v4.1
 */
public class TestBulkFieldScreenRendererFactory extends ListeningTestCase
{
    @Test
    ...
    {
        return new CustomFieldTypeModuleDescriptorImpl(new MockSimpleAuthenticationContext(null), null, null, null)
        {
            @Override
