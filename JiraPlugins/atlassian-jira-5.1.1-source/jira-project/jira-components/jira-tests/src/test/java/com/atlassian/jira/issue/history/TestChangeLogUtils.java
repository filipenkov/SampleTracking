...
public class TestChangeLogUtils extends AbstractUsersTestCase
{
    ...
    public void testGenerateChangeItemAssignee() throws Exception
    {
        ...
        User user = createMockUser("bob", "Bob the Builder");
    ...
    private User createMockUser(String userName, String fullname)
            throws OperationNotPermittedException, InvalidUserException, InvalidCredentialException
    {
        User user = new MockUser(userName, fullname, "fullname@somewhere.com");
