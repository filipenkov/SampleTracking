 ...
 */
public class TestIssueNavigator2 extends ListeningTestCase
{
    @Test
    public void testIntersectionOverlapAll() throws Exception
    {
        ...
        List<Issue> intersection = IssueNavigator.intersection(issuesInPage, pager, fromIndex, toIndexExclusive);
