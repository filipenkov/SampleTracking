...
public class TestDefaultCommentManager extends AbstractUsersTestCase
{
    ...
    protected void setUp() throws Exception
    {
        ...
        updater = createMockUser("MrUpdater");
    ...
    private void addToNewGroup(User user, String groupName)
    ...
    public void testGetMutableComment()
            throws GenericEntityException, OperationNotPermittedException, InvalidUserException, InvalidGroupException, InvalidCredentialException
    {
        final CommentManager commentManager = ComponentManager.getComponentInstanceOfType(CommentManager.class);
        addToNewGroup(user, "Group A");
    ...
    public void testActionsOneComment()
            throws GenericEntityException, RepositoryException, OperationNotPermittedException, InvalidUserException, InvalidGroupException, InvalidCredentialException
    {
        final CommentManager commentManager = ComponentManager.getComponentInstanceOfType(CommentManager.class);
        addToNewGroup(user, "Group A");
    ...
    public void testActionsMultipleComments()
            throws GenericEntityException, RepositoryException, OperationNotPermittedException, InvalidUserException, InvalidGroupException, InvalidCredentialException
    {
        final CommentManager commentManager = ComponentManager.getComponentInstanceOfType(CommentManager.class);
    ...
    public void testGetCommentsForUserWithRoleLevels() throws Exception
    {
        ...
        final Mock mockTextFieldCharacterLengthValidator = new Mock(TextFieldCharacterLengthValidator.class);
        mockTextFieldCharacterLengthValidator.expectAndReturn("isTextTooLong", P.ANY_ARGS, Boolean.FALSE);

        final CommentManager commentManager = new DefaultCommentManager(issueManager, projectRoleManager,
            new DefaultCommentPermissionManager(projectRoleManager, null, groupManager), null, null,
                (TextFieldCharacterLengthValidator) mockTextFieldCharacterLengthValidator.proxy()); // TODO add impl of CommentPermissionManager
    ...
    public void testCommentsForUserWithRoleLevelsNotPermitted() throws Exception
    {
        ...
        final User admin = createMockUser("Admin");
    ...
    public void testUpdateCommentDispatchEvent()
    {
        ...
        final CommentManager commentManager = new DefaultCommentManager(ComponentAccessor.getIssueManager(),
            ...
            (TextFieldCharacterLengthValidator) mockTextFieldCharacterLengthValidator.proxy())
        {
    ...
    {
        final DefaultCommentManager commentManager = new DefaultCommentManager(null, null, null, null,
    ...
    {
        final Mock mockTextFieldCharacterLengthValidator = new Mock(TextFieldCharacterLengthValidator.class);
        mockTextFieldCharacterLengthValidator.expectAndReturn("isTextTooLong", P.ANY_ARGS, Boolean.TRUE);
        mockTextFieldCharacterLengthValidator.expectAndReturn("getMaximumNumberOfCharacters", P.ANY_ARGS, Long.valueOf(10));

        final CommentManager commentManager = new DefaultCommentManager(null, null, null, null, ComponentAccessor.getJiraAuthenticationContext(),
                (TextFieldCharacterLengthValidator) mockTextFieldCharacterLengthValidator.proxy());
        try
        {
            commentManager.create(null, null, null, null, null, null, null, null, false, false);
            fail("Exception should be thrown as text length validation failed");
        }
        catch (IllegalArgumentException e)
        {
            assertEquals("The entered text is too long. It exceeds the allowed limit of 10 characters.", e.getMessage());
        }
    }
