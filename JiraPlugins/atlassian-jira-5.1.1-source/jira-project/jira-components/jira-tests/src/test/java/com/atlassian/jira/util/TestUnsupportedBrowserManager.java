...
public class TestUnsupportedBrowserManager extends MockControllerTestCase
{
    ...
    private static UserAgentUtil.Browser firefox = new UserAgentUtil.Browser(UserAgentUtil.BrowserFamily.FIREFOX,
            ...
            "Firefox3.6.6");
    private static UserAgentUtil.Browser ie7 = new UserAgentUtil.Browser(UserAgentUtil.BrowserFamily.MSIE,
            UserAgentUtil.BrowserMajorVersion.MSIE7,
            "MSIE7.0");

    private static final String DON_T_USE_IE6 = "browser.ie6.nosupport";
    private static final String DON_T_USE_IE7 = "browser.ie7.nosupport";
    ...
    public void testIsUnsupported()
    {
        ...
        final MockHttpServletRequest ie7Request = new MockHttpServletRequest();
        ...
        ie7Request.setHeader("USER-AGENT", "Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 5.1; GTB6.4; .NET CLR 1.1.4322; FDM; .NET CLR 2.0.50727; .NET CLR 3.0.04506.30; .NET CLR 3.0.4506.2152; .NET CLR 3.5.30729)");
        assertTrue("IE7 is unsupported", ubm.isUnsupportedBrowser(ie7Request));
        assertTrue("IE7 is unsupported", ubm.isUnsupportedBrowser(ie7));
        assertEquals(DON_T_USE_IE7, DON_T_USE_IE7, ubm.getMessageKey(ie7Request));
        assertEquals(DON_T_USE_IE7, DON_T_USE_IE7, ubm.getMessageKey(ie7));
