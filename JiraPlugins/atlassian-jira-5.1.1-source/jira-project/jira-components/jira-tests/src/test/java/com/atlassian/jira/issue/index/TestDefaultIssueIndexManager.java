...
public class TestDefaultIssueIndexManager extends AbstractIndexingTestCase
{
    ...
    protected void setUp() throws Exception
    {
        ...
        project = UtilsForTests.getTestEntity("Project", EasyMap.build("id", Id.TEN, "name", "A Project"));

        reindexMessageManager = EasyMock.createMock(ReindexMessageManager.class);
        projectManager = EasyMock.createNiceMock(ProjectManager.class);
        ...
        EasyMock.replay(visibilityBean, reindexMessageManager, eventPublisher);
        ...
        indexManager = new DefaultIndexManager(new MockIndexingConfiguration(), new DefaultIssueIndexer(indexDirectoryFactory, new MemoryIssueIndexer.CommentRetrieverImpl(
                ComponentAccessor.getIssueManager()), new MemoryIssueIndexer.ChangeHistoryRetrieverImpl(ComponentAccessor.getIssueManager())), indexPath, reindexMessageManager, eventPublisher, null, projectManager);
    }
    ...
    public void testIndexSearchIssue() throws Exception
    {
        ...
        try
        {
            ...
            assertEquals(1, hits.totalHits);
            final QueryParser parser = new QueryParser(DefaultIndexManager.LUCENE_VERSION, DocumentConstants.ISSUE_DESC, DefaultIndexManager.ANALYZER_FOR_SEARCHING);
    ...
    {
        EasyMock.reset(projectManager);
        projectManager.getProjectObjects();
        EasyMock.expectLastCall().andReturn(new MockProjectFactory().getProjects(Collections.singletonList(project)));
    ...
    public void testIndexLookupIssue() throws Exception
    {
        ...
        indexManager = new DefaultIndexManager(new MockIndexingConfiguration(), new DefaultIssueIndexer(new MockIndexDirectoryFactory(
                ...
                }), new MemoryIssueIndexer.CommentRetrieverImpl(ComponentAccessor.getIssueManager()), new MemoryIssueIndexer.ChangeHistoryRetrieverImpl(ComponentAccessor.getIssueManager())), indexPath, reindexMessageManager, eventPublisher, null, projectManager);
        indexManager.reIndexAll();
    ...
    public void testShutdown() throws Exception
    {
        ...
        indexManager = new DefaultIndexManager(new MockIndexingConfiguration(), (IssueIndexer) mockIssueIndexer.proxy(), indexPath, reindexMessageManager, eventPublisher, null, null);
        // Do the right thang
    ...
    private void prepareIndexDir() throws IOException
    {
        ...
        IndexWriterConfig conf = new IndexWriterConfig(DefaultIndexManager.LUCENE_VERSION, JiraAnalyzer.ANALYZER_FOR_INDEXING);
        conf.setOpenMode(IndexWriterConfig.OpenMode.CREATE);
        new IndexWriter(getIssueIndexDirectory(), conf).close();
        conf = new IndexWriterConfig(DefaultIndexManager.LUCENE_VERSION, JiraAnalyzer.ANALYZER_FOR_INDEXING);
        conf.setOpenMode(IndexWriterConfig.OpenMode.CREATE);
    ...
    public void testDeIndexCouldNotGetLock() throws Exception
    {
        ...
        indexManager = new DefaultIndexManager(new MockIndexingConfiguration(), new MemoryIssueIndexer(), indexPath, reindexMessageManager, eventPublisher, null, null)
        {
            @Override
    ...
    public void testReIndexAllChucksRuntimeExceptionNotIndexExFromIndexerDeleteAndReinit() throws Exception
    {
        ...
        indexManager = new DefaultIndexManager(new MockIndexingConfiguration(), issueIndexer, indexPath, reindexMessageManager, eventPublisher, null, null);
        final Context event = Contexts.nullContext();
    ...
    public void testReIndexChucksRuntimeException() throws Exception
    {
        ...
        indexManager = new DefaultIndexManager(new MockIndexingConfiguration(), issueIndexer, indexPath, reindexMessageManager, eventPublisher, null, projectManager);
    ...
    public void testReindexAllCallsIssueIndexerBatchMode() throws Exception
    {
        ...
        }, indexPath, reindexMessageManager, eventPublisher, null, projectManager);
    ...
    public void testDeactivate() throws Exception
    {
        ...
        }, indexPath, reindexMessageManager, eventPublisher, listenerManager, null);
    ...
    public void testActivate() throws Exception
    {
        ...
        MockListenerManager listenerManager = new MockListenerManager();
        ...
        }, indexPath, reindexMessageManager, eventPublisher,
                listenerManager,
                null
        )
        {
    ...
    public void testActivateDontShutdownScheduler() throws Exception
    {
        ...
        }, new DefaultIssueIndexer(indexDirectoryFactory, new MemoryIssueIndexer.CommentRetrieverImpl(ComponentAccessor.getIssueManager()), new MemoryIssueIndexer.ChangeHistoryRetrieverImpl(ComponentAccessor.getIssueManager())), indexPath, reindexMessageManager, eventPublisher, listenerManager, projectManager);
    ...
    public void testShutdownCallsIndexClose() throws Exception
    {
        ...
        indexManager = new DefaultIndexManager(new MockIndexingConfiguration(), mockIssueIndexer, indexPath, reindexMessageManager, eventPublisher, null, null);
    ...
    public void testOptimize() throws Exception
    {
        ...
        indexManager = new DefaultIndexManager(new MockIndexingConfiguration(), indexer, indexPath, reindexMessageManager, eventPublisher, null, null);
    ...
    public void testOptimizeReturnsZeroIfIndexingIsDisabled() throws Exception
    {
        ...
        }, indexer, indexPath, reindexMessageManager, eventPublisher, null, null);
    ...
    {
        final RAMDirectory directory = new RAMDirectory();
        IndexWriterConfig conf = new IndexWriterConfig(DefaultIndexManager.LUCENE_VERSION, null);
        conf.setOpenMode(IndexWriterConfig.OpenMode.CREATE);
