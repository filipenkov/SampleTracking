...
public class TestIssueToSubtaskUpdateFields extends ListeningTestCase
{
    ...
    public void testFetFieldLayoutItems()
    {
        ...
        fieldLayoutMock.expectAndReturn("getVisibleLayoutItems", P.args(P.eq(ctx.getLoggedInUser()), P.eq(targetProject), P.eq(issueTypeIdList)), Collections.EMPTY_LIST);
        ...
        IssueToSubTaskConversionService service = new DefaultIssueToSubTaskConversionService(null, null, null, null, null, fieldLayoutManager, null);

        Collection items = service.getFieldLayoutItems(ctx, null, issue);
