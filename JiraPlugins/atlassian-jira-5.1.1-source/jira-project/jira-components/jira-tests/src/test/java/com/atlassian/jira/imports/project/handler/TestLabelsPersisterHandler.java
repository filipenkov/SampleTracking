...
public class TestLabelsPersisterHandler extends ListeningTestCase
{
    @Test
    ...
    public void testHandle() throws ParseException, AbortImportException
    {
        ...
        final Map<Object, Object> transformedAttributes = MapBuilder.newBuilder().add("issue", "10004").add("label", "alabel").toMap();
