...
/**
 */
public class TestLoginStoreImpl extends MockControllerTestCase
{
    private User fred;
    private PropertySet fredsPropertySet;
    private Date when;
    ...
    public void testGetLoginInfo_NeverLoggedIn()
    {
        ...
        addObjectInstance(crowdService);

        final LoginStore loginStore = instantiate(LoginStoreImpl.class);
    ...
    {
        addObjectInstance(new ConstantClock(when));
        addObjectInstance(crowdService);
    ...
    {
        expect(applicationProperties.getDefaultBackedString(JIRA_MAXIMUM_AUTHENTICATION_ATTEMPTS_ALLOWED)).andReturn(howMany);
    }
