...
public class TestDefaultFeatureManager
{
    ...
    @Mock private PluginAccessor mockAccessor;
    @Mock private EventPublisher mockEventPublisher;
    @Mock private ApplicationProperties applicationProperties;
    @Mock private UserPreferencesManager preferencesManager;
...
//    @Test
    ...
    {
        return new DefaultFeatureManager(propertiesContainer, eventPublisher, permissionManager, applicationProperties, authenticationContext, preferencesManager);
    }

    private DefaultFeatureManager makeFeatureManager()
    {
        return new DefaultFeatureManager(mockAccessor, mockEventPublisher,permissionManager, applicationProperties, authenticationContext, preferencesManager);
    }
