...
public class TestDefaultExportService
{
    ...
    public void happyPathNoActiveObjects() throws Exception
    {
        ...
        final DefaultExportService exportService = new DefaultExportService(delegatorInterface, entitiesExporter, new MockI18nBean.MockI18nBeanFactory(), eventPublisher)
        {
            @Override
