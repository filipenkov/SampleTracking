...
public class TestMoveIssueUpdateWorkflow extends AbstractUsersTestCase
{
    ...
    public void setUp() throws Exception
    {
        ...
        miuw = new MoveIssueUpdateWorkflow((SubTaskManager) subtaskManager.proxy(), (ConstantsManager) constantsManager.proxy(),
                (WorkflowManager) workflowManager.proxy(), null, (FieldLayoutManager) fieldLayoutManager.proxy(), null, null, null, null);
