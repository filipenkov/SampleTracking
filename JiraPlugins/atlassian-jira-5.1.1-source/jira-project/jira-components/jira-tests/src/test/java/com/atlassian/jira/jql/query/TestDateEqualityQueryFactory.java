...
public class TestDateEqualityQueryFactory extends MockControllerTestCase
{
    ...
    public void testInMultiple() throws Exception
    {
        ...
        assertNotNull(query);
        assertEquals("dateField:" + A_DATE_LOWER_STRING + " dateField:imlow", query.getLuceneQuery().toString(""));
    ...
    public void testInSingle() throws Exception
    {
        ...
        assertNotNull(query);
        assertEquals("dateField:" + A_DATE_LOWER_STRING , query.getLuceneQuery().toString(""));
    ...
    public void testNotInMultiple() throws Exception
    {
        ...
        assertEquals("+(dateField:[* TO " + A_DATE_LOWER_STRING + "} dateField:{" + A_DATE_LOWER_STRING + " TO *]) +(dateField:[* TO imlow} dateField:{imlow TO *])",
    ...
    public void testNotInSingle() throws Exception
    {
        ...
        assertNotNull(query);
        assertFalse(query.mustNotOccur());
        assertEquals("dateField:[* TO " + A_DATE_LOWER_STRING + "} dateField:{" + A_DATE_LOWER_STRING + " TO *]", query.getLuceneQuery().toString());
