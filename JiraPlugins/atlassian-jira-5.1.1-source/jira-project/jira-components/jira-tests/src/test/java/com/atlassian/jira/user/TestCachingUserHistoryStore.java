...
public class TestCachingUserHistoryStore extends MockControllerTestCase
{
    ...
    public void setUp() throws Exception
    {
        ...
        user2 = new DelegatingApplicationUser("test", new MockUser("test"));
        ...
        store = new CachingUserHistoryStore(delegateStore, applicationProperties);
    }
    ...
    {
        store = new CachingUserHistoryStore(delegateStore, applicationProperties, 0);
    ...
    {
        store = new CachingUserHistoryStore(delegateStore, applicationProperties, 2);
