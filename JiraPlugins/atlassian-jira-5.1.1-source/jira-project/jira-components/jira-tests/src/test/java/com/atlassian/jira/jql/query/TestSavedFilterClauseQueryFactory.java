...
public class TestSavedFilterClauseQueryFactory extends MockControllerTestCase
{
    ...
    {
        replay();
        final SavedFilterClauseQueryFactory factory = new SavedFilterClauseQueryFactory(savedFilterResolver, null, jqlOperandResolver, savedFilterCycleDetector);
    ...
    public void testGetQueryNoFiltersFound() throws Exception
    {
        ...
        final SavedFilterClauseQueryFactory filterClauseQueryFactory = new SavedFilterClauseQueryFactory(savedFilterResolver, null, jqlOperandResolver, savedFilterCycleDetector);
