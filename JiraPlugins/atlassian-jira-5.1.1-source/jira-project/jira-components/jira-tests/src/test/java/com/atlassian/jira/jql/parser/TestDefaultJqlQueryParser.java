...
public class TestDefaultJqlQueryParser extends Junit3ListeningTestCase
{
    ...
    private static final Set<String> currentWords = CollectionBuilder.newBuilder("empty", "null", "and", "or", "not", "in", "is", "cf", "order", "by", "desc", "asc", "on", "before", "to", "after", "from", "was", "changed").asSet();
    ...
    public static TestSuite suite()
    {
        ...
        //Some tests for invalid parsing input.
        {
            ...
            test.addException("Incomplete second subclause2", "foo=bar and 78foo=", JqlParseErrorMessages.badOperand(Token.EOF_TOKEN));
            ...
            test.addException("Bad function argument5", "q = func(a, ", JqlParseErrorMessages.badFunctionArgument(Token.EOF_TOKEN));
            test.addException("Bad function argument6", "q = func(a", JqlParseErrorMessages.expectedText(Token.EOF_TOKEN, ")"));
            test.addException("Bad function argument7", "q = func(", JqlParseErrorMessages.expectedText(Token.EOF_TOKEN, ")"));
            ...
            test.addException("No such operator4", "pri is", JqlParseErrorMessages.badOperand(Token.EOF_TOKEN));
