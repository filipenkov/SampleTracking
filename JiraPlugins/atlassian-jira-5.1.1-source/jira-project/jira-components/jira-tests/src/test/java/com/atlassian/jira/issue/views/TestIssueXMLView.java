 ...
 */
public class TestIssueXMLView extends ListeningTestCase
{
    ...
    public void testGetCustomFieldXMLNoXMLTemplateExists()
    {
        ...
        IssueXMLView issueXMLView = new IssueXMLView(null, null, mockFieldLayoutManager, null, null, null, buildUtilsInfo, null);
