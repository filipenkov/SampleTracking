...
{
    private final Analyzer ANALYZER_FOR_INDEXING = new StandardAnalyzer(DefaultIndexManager.LUCENE_VERSION);
    ...
    private void addCommentIdsToIndex(Collection<Integer> commentIds) throws Exception
    {
        ...
        IndexWriterConfig conf = new IndexWriterConfig(DefaultIndexManager.LUCENE_VERSION, ANALYZER_FOR_INDEXING);
