...
public class TestDataValuesExistValidator extends MockControllerTestCase
{
    ...
    public void testLookupFailureStringValue()
    {
        ...
        DataValuesExistValidator clauseValidator = new DataValuesExistValidator(MockJqlOperandResolver.createSimpleSupport(), nameResolver, beanFactory)
        {
    ...
    public void testLookupFailureStringValueFromFunction()
    {
        ...
        DataValuesExistValidator clauseValidator = new DataValuesExistValidator(mockJqlOperandResolver, nameResolver, beanFactory)
        {
            protected I18nHelper getI18n(final User user)
            {
                return new MockI18nBean();
    ...
    public void testLookupLongAsName()
    {
        ...
        DataValuesExistValidator clauseValidator = new DataValuesExistValidator(jqlOperandResolver, nameResolver, beanFactory)
        {
            protected I18nHelper getI18n(final User user)
            {
                return new MockI18nBean();
    ...
    public void testNullArgs()
    {
        ...
        try
        {
            new DataValuesExistValidator(jqlOperandResolver, null, null);
