...
public class TestDefaultResolutionManager
{
    ...
    public void setUp()
    {
        ...
        resolutionManager = new DefaultResolutionManager(constantsManager, translationManager, jiraAuthenticationContext, issueIndexManager, ofBizDelegator, applicationProperties)
        {
            @Override
    ...
    public void testCreateResolution() throws Exception
    {
        ...
        Resolution resolutionFixed = new ResolutionImpl(resFixedGV, translationManager, jiraAuthenticationContext);
        Resolution resolutionNotFixed = new ResolutionImpl(notFixedGV, translationManager, jiraAuthenticationContext);
    ...
    public void testEditResolution() throws Exception
    {
        ...
        Resolution resolutionFixed = new ResolutionImpl(resFixedGV, translationManager, jiraAuthenticationContext);
        Resolution resolutionNotFixed = new ResolutionImpl(notFixedGV, translationManager, jiraAuthenticationContext);
        Resolution resolutionToEdit = new ResolutionImpl(myResGV, translationManager, jiraAuthenticationContext);
    ...
    public void testRemoveResolution() throws Exception
    {
        ...
        Resolution resFixed = new ResolutionImpl(resFixedGV, translationManager, jiraAuthenticationContext);
        Resolution resNotFixed = new ResolutionImpl(notFixedGV, translationManager, jiraAuthenticationContext);
    ...
    public void testMoveResolutionUp() throws Exception
    {
        ...
        Resolution resolutionFixed = new ResolutionImpl(resFixedGV, translationManager, jiraAuthenticationContext);
        Resolution resolutionNotFixed = new ResolutionImpl(notFixedGV, translationManager, jiraAuthenticationContext);
        Resolution resolutionWillNotFix = new ResolutionImpl(willNotFix, translationManager, jiraAuthenticationContext);
