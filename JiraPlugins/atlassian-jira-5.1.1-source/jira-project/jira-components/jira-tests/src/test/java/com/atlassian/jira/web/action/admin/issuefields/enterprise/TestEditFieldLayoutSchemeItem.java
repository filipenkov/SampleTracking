...
public class TestEditFieldLayoutSchemeItem extends AbstractTestEditFieldLayoutItem
{
    ...
    public void testDoExecute() throws Exception
    {
        ...
        OrderableField orderableField = ComponentAccessor.getFieldManager().getOrderableField(IssueFieldConstants.SUMMARY);
        FieldLayout fl = ComponentAccessor.getFieldManager().getFieldLayoutManager().getFieldLayout(fieldLayout.getLong("id"));
        ...
        fieldLayoutItem = (FieldLayoutItem) ComponentAccessor.getFieldManager().getFieldLayoutManager().getFieldLayout(fieldLayout.getLong("id")).getFieldLayoutItem(orderableField);
