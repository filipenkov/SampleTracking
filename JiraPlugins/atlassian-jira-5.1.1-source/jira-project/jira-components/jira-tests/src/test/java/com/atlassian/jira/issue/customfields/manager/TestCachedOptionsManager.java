...
public class TestCachedOptionsManager extends MockControllerTestCase
{
    ...
    public void testGetAllOptions() throws Exception
    {
        ...
        final OptionsManager optionsManager = new CachedOptionsManager(ofBizDelegator, collectionReorderer, fieldConfigManager)
        {
            @Override
    ...
    public void testFindByOptionValue() throws Exception
    {
        ...
        final OptionsManager manager = new CachedOptionsManager(ofBizDelegator, collectionReorderer, fieldConfigManager)
        {
            @Override
