...
public class TestDateRelationalQueryFactory extends MockControllerTestCase
{
    ...
    public void testLessThanWithLong() throws Exception
    {
        ...
        assertNotNull(query);
        assertEquals("dateField:[* TO " + A_DATE_LOWER_STRING + "}", query.getLuceneQuery().toString(""));
    ...
    public void testLessThan() throws Exception
    {
        ...
        assertQueryHappy(Operator.LESS_THAN, "dateField:[* TO " + A_DATE_LOWER_STRING + "}");
    ...
    public void testGreaterThan() throws Exception
    {
        ...
        assertQueryHappy(Operator.GREATER_THAN, "dateField:{" + A_DATE_UPPER_STRING + " TO *]");
