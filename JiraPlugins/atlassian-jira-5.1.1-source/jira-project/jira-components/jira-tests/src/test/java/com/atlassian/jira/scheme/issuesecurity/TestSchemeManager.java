...
public class TestSchemeManager extends LegacyJiraMockTestCase
{
    ...
    protected void setUp() throws Exception
    {
        ...
        ManagerFactory.addService(IssueSecuritySchemeManager.class, new IssueSecuritySchemeManagerImpl(new DefaultProjectManager(), new PermissionTypeManager(), ctxFactory, schemeFactory, eventPublisher, associationManager, ofBizDelegator, null));
