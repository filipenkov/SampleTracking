 ...
 * @since v4.0
 */
public class TestClauseReplacingCloningVisitor extends ListeningTestCase
{
    @Test
    public void testVisitorReplace1() throws Exception
    {
        ...
        ClauseReplacingCloningVisitor cloningVisitor = new ClauseReplacingCloningVisitor(EasyList.build(replacementClause1));
    ...
    public void testVisitorReplace2() throws Exception
    {
        ...
        ClauseReplacingCloningVisitor cloningVisitor = new ClauseReplacingCloningVisitor(EasyList.build(replacementClause1, replacementClause2));
