...
public class TestCachingKeyboardShortcutManager extends ListeningTestCase
{
    ...
    private static final KeyboardShortcut GLOBAL_SHORTCUT_100 = new KeyboardShortcut(KeyboardShortcutManager.Context.global, KeyboardShortcutManager.Operation.execute, "alert('hidden shortcut');", 100, keys("g", "f"), "i18n_key1", false);
    private static final KeyboardShortcut GLOBAL_SHORTCUT_200 = new KeyboardShortcut(KeyboardShortcutManager.Context.global, KeyboardShortcutManager.Operation.execute, "alert('give us the func!');", 200, keys("g", "f"), "i18n_key2", false);
    private static final KeyboardShortcut GREENHOPPER_SHORTCUT_200 = new KeyboardShortcut(KeyboardShortcutManager.Context.greenhopper, KeyboardShortcutManager.Operation.execute, "alert('give us the func!');", 200, keys("g", "f"), "i18n_key2", false);
    ...
    {
        KeyboardShortcut globalShortcut100 = new KeyboardShortcut(KeyboardShortcutManager.Context.global, KeyboardShortcutManager.Operation.execute, "alert('hidden shortcut');", 100, keys("g", "f"), "i18n_key1", false, mockCondition);
    ...
    private static class MockKeyboardShortcutModuleDescriptor extends KeyboardShortcutModuleDescriptor
    {
        ...
        {
            super(authenticationContext, keyboardShortcutManager, null, new ConditionDescriptorFactoryImpl(hostContainer));
            final Set<List<String>> keys = new HashSet<List<String>>();
