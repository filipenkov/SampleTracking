...
public class TestEnterpriseFieldLayoutManager extends MockControllerTestCase
{
    ...
    public void testGetFieldConfigurationSchemes() throws Exception
    {
        ...
        GenericValue gvFieldLayoutSchemeEntity101 = new MockGenericValue("FieldLayoutSchemeEntity", new FieldMap("id", 101L).add("scheme", 1L).add("fieldlayout", 11L));
        ofBizDelegator.store(gvFieldLayoutSchemeEntity101);
        GenericValue gvFieldLayoutSchemeEntity102 = new MockGenericValue("FieldLayoutSchemeEntity", new FieldMap("id", 102L).add("scheme", 1L).add("fieldlayout", null));
        ...
        GenericValue gvFieldLayoutSchemeEntity103 = new MockGenericValue("FieldLayoutSchemeEntity", new FieldMap("id", 103L).add("scheme", 2L).add("fieldlayout", 11L));
