...
public class TestAddDefaultActorsToProjectRole extends AbstractProjectRolesTest
{
    ...
    public void testAddActorsToDefaultProjectRole() throws Exception
    {
        ...
        projectRoleService.expectVoid("addDefaultActorsToProjectRole", new Constraint[]{new IsEqual(u),
                                                                                 new IsEqual(actors),
        ...
        projectRoleService.expectAndReturn("getProjectRole", new Constraint [] {new IsEqual(u), new IsEqual(new Long(1)), new IsEqual(new SimpleErrorCollection())}, MockProjectRoleManager.PROJECT_ROLE_TYPE_1);
