...
public class TestComponentsSystemField extends ListeningTestCase
{
    @Before
    ...
    {
        ComponentsSystemField componentsSystemField = new ComponentsSystemField(null, null, null, null, null, null, null, null, null);
