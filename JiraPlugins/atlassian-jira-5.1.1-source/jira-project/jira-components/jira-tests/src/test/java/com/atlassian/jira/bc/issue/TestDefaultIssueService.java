...
public class TestDefaultIssueService extends ListeningTestCase
{
    ...
    public void testGetIssueById() throws Exception
    {
        ...
        DefaultIssueService defaultIssueService = new DefaultIssueService(null, null, null, mockIssueManager, null, null, null, null, null, null)
        {
            @Override
    ...
    {
        DefaultIssueService defaultIssueService = new DefaultIssueService(null, null, null, null, null, null, null, null, null, null)
        {
            @Override
            I18nHelper getI18n(final User user)
            {
    ...
    public void testGetIssueNoPermission() throws Exception
    {
        ...
        DefaultIssueService defaultIssueService = new DefaultIssueService(null, null, null, null, mockPermissionManager, null, null, null, null, null)
        {
    ...
    public void testValidateCreateDefaultProvidedFields()
    {
        ...
        DefaultIssueService issueService = new DefaultIssueService(null, null, null, null, null, null, null, null, null, null)
        {
            @Override
    ...
    public void testCreate() throws CreateException
    {
        ...
        MockGenericValue mockProject = new MockGenericValue("Project", ImmutableMap.of("key", "TST"));
        ...
        DefaultIssueService issueService = new DefaultIssueService(mockIssueFactory, null, null, mockIssueManager, null, null, null, null, null, null)
        {
    ...
    public void testCreateWithAuxSubmitCreateExceptionThrown() throws CreateException
    {
        ...
        DefaultIssueService issueService = new DefaultIssueService(null, null, null, mockIssueManager, null, null, null, null, null, null)
        {
    ...
    public void testValidateUpdate()
    {
        ...
        DefaultIssueService issueService = new DefaultIssueService(null, null, null, defaultIssueManager, null, null, null, null, null, null)
        {
            @Override
    ...
    public void testValidateAndCreateIssueFromFieldsDefaultFields()
    {
        ...
        mockIssueCreationHelperBean.validateCreateIssueFields(jiraServiceContext, Collections.<String>emptyList(), mockIssue, mockFieldScreenRenderer, new OperationContextImpl(IssueOperations.CREATE_ISSUE_OPERATION, issueInputParameters.getFieldValuesHolder()), issueInputParameters.getActionParameters(), issueInputParameters.applyDefaultValuesWhenParameterNotProvided(), i18nBean);
        ...
        DefaultIssueService issueService = new DefaultIssueService(null, mockIssueCreationHelperBean, null, null, null, null, null, null, null, null)
        {
            @Override
    ...
    public void testValidateAndCreateIssueFromFieldsWithProvidedFields()
    {
        ...
        mockIssueCreationHelperBean.validateCreateIssueFields(jiraServiceContext, providedFields, mockIssue, mockFieldScreenRenderer, new OperationContextImpl(IssueOperations.CREATE_ISSUE_OPERATION, issueInputParameters.getFieldValuesHolder()), issueInputParameters.getActionParameters(), issueInputParameters.applyDefaultValuesWhenParameterNotProvided(), i18nBean);
    ...
    public void testHasPermissionToEditNoPerm()
    {
        ...
        DefaultIssueService issueService = new DefaultIssueService(null, null, null, (IssueManager) mockIssueManager.proxy(), null, null, null, null, null, null);
    ...
    public void testHasPermissionToCreateNoPerm()
    {
        ...
        DefaultIssueService issueService = new DefaultIssueService(null, null, null, null, ((PermissionManager)mockPermissionManager.proxy()), null, null, null, null, null);
    ...
    public void testLicenseInvalidForIssueCreationNotValid() throws Exception
    {
        ...
        DefaultIssueService issueService = new DefaultIssueService(null, issueCreationHelperBean, null, null, null, null, null, null, null, null);
    ...
    public void testConstructNewIssue() throws Exception
    {
        ...
        DefaultIssueService issueService = new DefaultIssueService(mockIssueFactory, null, null, null, null, null, null, null, null, null);
    ...
    public void testGetCreateFieldScreenRenderer() throws Exception
    {
        ...
        DefaultIssueService issueService = new DefaultIssueService(null, null, null, null, null, mockFieldScreenRendererFactory, null, null, null, null);
    ...
    public void testValidateAndPopulateParamsRetainIssueValues()
    {
        ...
        mockFieldScreenRenderTabControl.setReturnValue(Lists.newArrayList(mockFieldScreenRenderLayoutItem));
        mockFieldScreenRenderTabControl.replay();

        final MockControl mockFieldScreenRendererControl = MockControl.createStrictControl(FieldScreenRenderer.class);
        final FieldScreenRenderer mockFieldScreenRenderer = (FieldScreenRenderer) mockFieldScreenRendererControl.getMock();
        mockFieldScreenRenderer.getFieldScreenRenderTabs();
        mockFieldScreenRendererControl.setReturnValue(Lists.newArrayList(mockFieldScreenRenderTab));
        mockFieldScreenRendererControl.replay();
    ...
    public void testValidateAndPopulateParamsWithComment()
    {
        ...
        DefaultIssueService issueService = new DefaultIssueService(null, null, mockFieldManager, null, null, null, null, null, null, null)
        {
            @Override
    ...
    private void assertUpdateIssueFromFields(final boolean updateComment)
    {
        ...
        final OrderableField mockOrderableField = (OrderableField) mockOrderableFieldControl.getMock();
        mockOrderableField.getId();
        mockOrderableFieldControl.setReturnValue("summary");
        ...
        IssueInputParameters issueInputParameters = new IssueInputParametersImpl();
        issueService.updateIssueFromFields(mockFieldScreenRenderer, mockIssue, null, fieldValuesHolder, updateComment, issueInputParameters);
    ...
    public void testTransitionHappyPath() throws Exception
    {
        ...
        DefaultIssueService issueService = new DefaultIssueService(null, null, null, mockIssueManager, null, null, mockWorkflowManager, null, null, null);
    ...
    public void testGetActionDescriptorNullWorkflow() throws Exception
    {
        ...
        DefaultIssueService issueService = new DefaultIssueService(null, null, null, null, null, null, mockWorkflowManager, null, null, null);
    ...
    public void testValidateTransitionInvalidAction() throws Exception
    {
        ...
        EasyMock.replay(defaultIssueManager);
        DefaultIssueService issueService = new DefaultIssueService(null, null, null, defaultIssueManager, null, null, null, mockIssueUtilsBean, null, null)
        {
            @Override
            ActionDescriptor getActionDescriptor(final Issue issue, final int actionId)
            {
    ...
    public void testCreateAdditionalParametersNullUser() throws Exception
    {
        ...
        final DefaultIssueService service = new DefaultIssueService(null, null, fieldManager, null, null, null, null, null, null, null);
