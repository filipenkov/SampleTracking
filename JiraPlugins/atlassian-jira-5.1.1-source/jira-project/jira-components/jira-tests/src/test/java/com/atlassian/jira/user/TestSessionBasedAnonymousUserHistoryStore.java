...
public class TestSessionBasedAnonymousUserHistoryStore extends MockControllerTestCase
{
    ...
    public void setUp() throws Exception
    {
        ...
        store = new SessionBasedAnonymousUserHistoryStore(delegateStore, applicationProperties, velocityRequestContextFactory);
    }
    ...
    public void testGetHistoryNoSessionNoUser()
    {
        ...
        assertTrue(store.getHistory(UserHistoryItem.ISSUE, null).isEmpty());
    ...
    public void testGetHistoryNoUserNoHistory()
    {
        ...
        assertEquals(history, store.getHistory(UserHistoryItem.ISSUE, null));
