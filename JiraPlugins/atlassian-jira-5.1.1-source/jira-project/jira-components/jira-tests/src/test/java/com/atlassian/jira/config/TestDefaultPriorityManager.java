...
public class TestDefaultPriorityManager
{
    ...
    public void setUp()
    {
        ...
        priorityManager = new DefaultPriorityManager(constantsManager, translationManager, jiraAuthenticationContext, ofBizDelegator, issueIndexManager, applicationProperties)
        {
            @Override
    ...
    public void testCreatePriority() throws Exception
    {
        ...
        Priority priorityBlocker = new PriorityImpl(prioBlockerGV, translationManager, jiraAuthenticationContext);
        Priority priorityMinor = new PriorityImpl(prioMinorGV, translationManager, jiraAuthenticationContext);
    ...
    public void testEditPriority() throws Exception
    {
        ...
        Priority priorityToEdit = new PriorityImpl(myPrioGV, translationManager, jiraAuthenticationContext);
    ...
    public void testRemovePriority() throws Exception
    {
        ...
        Priority major = new PriorityImpl(majorGV, translationManager, jiraAuthenticationContext);
        Priority minor = new PriorityImpl(minorGV, translationManager, jiraAuthenticationContext);
    ...
    public void testMovePriorityUp() throws Exception
    {
        ...
        Priority blockerPrio = new PriorityImpl(blockerPrioGV, translationManager, jiraAuthenticationContext);
        Priority criticalPrio = new PriorityImpl(criticalPrioGV, translationManager, jiraAuthenticationContext);
        Priority minorPrio = new PriorityImpl(minorPrioGV, translationManager, jiraAuthenticationContext);
