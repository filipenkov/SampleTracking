...
public class TestNotificationSchemeManager extends LegacyJiraMockTestCase
{
    ...
    {
        // Setup user
        User bill = new MockUser("bill", "bill", "bill@atlassian.com");
        ComponentAccessor.getCrowdService().addUser(bill, "blah");
...
//        Set recipients = nsm.getRecipients(event, UtilsForTests.getTestEntity("Notification", notificationParamsMap));
    ...
    {
        // Setup user
        MockUser bill = new MockUser("bill", "bill", "bill@atlassian.com");
        ...
        // User is inactive, so should not be a recipient
    ...
    public void testGetRecipientsWithCurrentAssigneeNotificationTypes() throws Exception
    {
        ...
        User dave = createMockUser("dave", "dave", "dave@atlassian.com");
