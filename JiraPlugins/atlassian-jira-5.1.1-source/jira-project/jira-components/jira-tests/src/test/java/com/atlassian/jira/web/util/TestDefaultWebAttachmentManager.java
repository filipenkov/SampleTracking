 ...
 * @since v4.0
 */
public class TestDefaultWebAttachmentManager extends ListeningTestCase
{
    ...
    public void testCreateAttachment() throws GenericEntityException, AttachmentException, IOException
    {
        ...
        final AttachmentManager attachmentManager = new AttachmentManager()
        {
            @Override
    ...
    public void testTemporaryStreamZeroSize() throws Exception
    {
        ...
        try
        {
            manager.createTemporaryAttachment(getInputStreamForString("something"), fileName, "type", 0, new MockIssue(5), null);
    ...
    public void testTemporaryStreamCantAttach() throws Exception
    {
        ...
        try
        {
            manager.createTemporaryAttachment(getInputStreamForString("1"), "name", "type", 1, attachIssue, null);
            fail("Expected to fail on the bad filename");
        }
        catch (AttachmentException e)
        {
    ...
    public void testTemporaryStreamBadFileName() throws Exception
    {
        ...
        try
        {
            manager.createTemporaryAttachment(getInputStreamForString("1"), expectedFile, "type", 1, attachIssue, null);
            fail("Expected to fail on the bad filename");
        }
        catch (AttachmentException e)
        {
    ...
    public void testTemporaryStreamTooSmall() throws Exception
    {
        ...
        try
        {
            manager.createTemporaryAttachment(getInputStreamForString("1"), fileName, "type", 20, new MockIssue(5), null);
    ...
    public void testTemporaryStreamNoData() throws Exception
    {
        ...
        try
        {
            manager.createTemporaryAttachment(getInputStreamForString(""), fileName, "type", 20, new MockIssue(5), null);
            fail("Expected to fail.");
        }
        catch (AttachmentException e)
        {
    ...
    public void testTemporaryStreamTooBig() throws Exception
    {
        ...
        try
        {
            manager.createTemporaryAttachment(stream, fileName, "type", data.length() - 1, new MockIssue(5), null);
            fail("Expected to fail.");
        }
        catch (AttachmentException e)
        {
    ...
    public void testTemporaryStreamIOErrorOnClose() throws Exception
    {
        ...
        try
        {
            manager.createTemporaryAttachment(bis, fileName, "type", 1, new MockIssue(5), null);
            fail("Expected to fail.");
        }
        catch (AttachmentException e)
        {
    ...
    public void testTemporaryStreamIOErrorOnCopy() throws Exception
    {
        ...
        try
        {
            manager.createTemporaryAttachment(stream, fileName, "type", 1, new MockIssue(5), null);
            fail("Expected to fail.");
        }
        catch (AttachmentException e)
        {
    ...
    public void testTemporaryStreamHappyPath() throws Exception
    {
        ...
        TemporaryAttachment actualAttachment = manager.createTemporaryAttachment(getInputStreamForString("1"), name, type, size, issue, null);
        TemporaryAttachment expectedAttachment = new TemporaryAttachment(tempFile.getId(), issue.getId(), tempFile.getFile(), name, type);
    ...
    public void testTemporaryStreamNoMonitor() throws Exception
    {
        ...
        final long size = 1;
        final Issue issue = new MockIssue(5);
        final TemporaryAttachment expectedAttachment = new TemporaryAttachment(tempFile.getId(), issue.getId(), tempFile.getFile(), name, type);
        ...
        try
        {
            manager.createTemporaryAttachment(getInputStreamForString("1"), name, type, size, issue, null);
    ...
    {
        TemporaryAttachment expectedAttachment = new TemporaryAttachment(56L, Long.MAX_VALUE, new File("random"), "ranme", "type");
    ...
    public void testAddToMonitorSad() throws Exception
    {
        ...
        TemporaryAttachment expectedAttachment = new TemporaryAttachment(56L, Long.MAX_VALUE, tempFile, "ranme", "type");
    ...
    @Test
    public void testAssertCanAttachIssueDirectoryError() throws Exception
    {
        final MockIssue mockIssue = new MockIssue(10L);
        final String errorMessage = "erro";
        final AtomicReference<Issue> issueRef = new AtomicReference<Issue>();
        ...
        {
            assertSame(mockIssue, issueRef.get());
            assertEquals(errorMessage, e.getMessage());
        }
    ...
    @Test
    public void testAssertCanAttachProjectDirectoryError() throws Exception
    {
        final MockProject mockProject = new MockProject(10L);
        final String errorMessage = "erro";
        ...
        DefaultWebAttachmentManager manager = new DefaultWebAttachmentManager(attachmentManager, factory, authCtx, locator, service)
        {
            ...
            {
                throw new AttachmentException("erro");
            }
        };
    ...
    public void testTemporaryMultipartNoFile() throws Exception
    {
        ...
        TemporaryAttachment temporaryAttachment = manager.createTemporaryAttachment(request, fileParam, new MockIssue(76L), null);
    ...
    public void testTemporaryMultipartHappy() throws Exception
    {
        ...
        TemporaryAttachment actualAttachment = new TemporaryAttachment(target.getId(), null, target.getFile(), fileName, contentType);
        TemporaryAttachment expectedAttachment = manager.createTemporaryAttachment(request, fileParam, null, mockProject);
    ...
    private void assertAttachmentEquals(TemporaryAttachment one1, TemporaryAttachment two1)
    {
        ...
        assertEquals(one1.getIssueId(), two1.getIssueId());
    }
}
