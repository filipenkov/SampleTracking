...
public class TestDefaultReindexMessageManager extends MockControllerTestCase
{
    ...
    public void testPushMessageNullUser() throws Exception
    {
        ...
        DefaultReindexMessageManager manager = new DefaultReindexMessageManager(jiraPropertySetFactory, userFormatManager, i18nFactory, outlookDateManager, velocityRequestContextFactory, permissionManager)
        {
            @Override
            Date getCurrentDate()
            {
