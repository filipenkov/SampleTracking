...
public class TestJiraSortComparatorSource extends ListeningTestCase
{
    ...
    public void setUp() throws Exception
    {
        ...
        indexWriter = new IndexWriter(directory, new IndexWriterConfig(DefaultIndexManager.LUCENE_VERSION, new WhitespaceAnalyzer(DefaultIndexManager.LUCENE_VERSION)));
