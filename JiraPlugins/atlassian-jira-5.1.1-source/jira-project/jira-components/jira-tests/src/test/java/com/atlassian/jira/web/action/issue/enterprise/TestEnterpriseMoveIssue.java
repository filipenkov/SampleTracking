...
public class TestEnterpriseMoveIssue extends TestMoveIssue
{
    ...
    public void testGetAllowedProjectsWorkflowRestrictions() throws Exception
    {
        ...
        WorkflowManager mockWorkflowManager = new OSWorkflowManager(null, null, eventPublisher, null, null)
        {
        ...
        workflowManager.createWorkflow("test", workflow);
    ...
    public void testDoValidationNoChanges() throws Exception
    {
        ...
        MoveIssue mi = new MoveIssue(null, null, null, null, ComponentAccessor.getFieldLayoutManager(), null, null, null, null);
