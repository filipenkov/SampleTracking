 ...
 * @since v3.13
 */
public class TestIssuePersisterHandler extends ListeningTestCase
{
    @Test
    public void testLargestIssueKeyNumber() throws ParseException, AbortImportException
    {
        final Date importDate = new Date();
        final ExternalIssueImpl extIssue1 = new ExternalIssueImpl();
        final ExternalIssueImpl extIssue2 = new ExternalIssueImpl();
        final ExternalIssueImpl extIssue3 = new ExternalIssueImpl();
