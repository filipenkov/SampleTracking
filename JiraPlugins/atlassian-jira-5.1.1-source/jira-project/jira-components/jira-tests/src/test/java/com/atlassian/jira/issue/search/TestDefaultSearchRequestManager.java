...
public class TestDefaultSearchRequestManager extends ListeningTestCase
{
    ...
    private SearchRequest searchRequest1Copy;
    ...
    public void setUp() throws Exception
    {
        ...
        searchRequest1Copy = new SearchRequest(new QueryImpl(), user.getName(), "one", "one description", 1L, 0L);
    ...
    {
        verify(mockShareManager);
        verify(mockSubscriptionManager);
        verify(mockColumnLayoutManager);
