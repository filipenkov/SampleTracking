...
public class TestDefaultRepositoryManager extends LegacyJiraMockTestCase
{
    ...
    protected void setUp() throws Exception
    {
        ...
        erm = new DefaultRepositoryManager(ComponentAccessor.getComponent(AssociationManager.class), ComponentAccessor.getOfBizDelegator(),
                ComponentAccessor.getServiceManager(), ComponentAccessor.getPermissionManager(),
