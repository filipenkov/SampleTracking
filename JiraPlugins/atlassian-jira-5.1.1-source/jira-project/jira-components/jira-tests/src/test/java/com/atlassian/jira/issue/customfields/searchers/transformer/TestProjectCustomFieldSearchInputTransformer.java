...
public class TestProjectCustomFieldSearchInputTransformer extends MockControllerTestCase
{
    ...
    public void testGetParamsFromSearchRequest() throws Exception
    {
        ...
        indexedInputHelper.getAllNavigatorValuesForMatchingClauses(null, names, query, searchContext);
        mockController.setReturnValue(null);

        mockController.replay();
        final ProjectCustomFieldSearchInputTransformer transformer = new ProjectCustomFieldSearchInputTransformer(id, names, customField, jqlOperandResolver, projectIndexInfoResolver, fieldFlagOperandRegistry, searchContextVisibilityChecker, projectResolver, customFieldInputHelper)
        {
            @Override
    ...
    public void testGetParamsFromSearchRequestNullQuery() throws Exception
    {
        ...
        mockController.replay();
        final ProjectCustomFieldSearchInputTransformer transformer = new ProjectCustomFieldSearchInputTransformer(id, clauseNames, customField, jqlOperandResolver, projectIndexInfoResolver, fieldFlagOperandRegistry, searchContextVisibilityChecker, projectResolver, customFieldInputHelper)
        {
            @Override
            IndexedInputHelper createIndexedInputHelper()
            {
    ...
    {
        EasyMock.expect(customField.getName())
                .andReturn(id);
