...
public class TestCanAttachScreenshotToIssueCondition extends ListeningTestCase
{
    @Test
    public void testTrue()
    {
        ...
        expect(attachmentService.canAttachScreenshots(context, issue)).andReturn(true);

        final AbstractIssueCondition condition = new CanAttachScreenshotToIssueCondition(attachmentService);
    ...
    public void testFalse()
    {
        ...
        expect(attachmentService.canAttachScreenshots(context, issue)).andReturn(false);
