...
public class TestSignup extends AbstractUsersTestCase
{
    ...
    public void testValidationOfCaptcha() throws Exception
    {
        ...
        expect(userService.validateCreateUserForSignup(
        ...
        Signup s = new Signup(applicationProperties, userService, userUtil, jiraCaptchaService, null);
        s.setUsername("abc");
    ...
    public void testExecute() throws Exception
    {
        ...
        Signup s = new Signup(new MockApplicationProperties(), userService, userUtil, new JiraCaptchaServiceImpl(), null);
        s.setUsername("a");
        s.setPassword("b");
        s.setConfirm("b");
        s.setFullname("c");
        ...
        User user = userUtil.getUser("a");
        Collection groups = userUtil.getGroupNamesForUser(user.getName());
