...
public class TestWikiIssueLink extends AbstractWikiTestCase
{
    ...
    protected void setUp() throws Exception
    {
        if (is14OrGreater())
        {
            ...
            oldIssueManager = ComponentAccessor.getIssueManager();
            ...
            OPEN_ISSUE_LINK = "<p><a href=\"" + ComponentAccessor.getApplicationProperties().getString(APKeys.JIRA_BASEURL) + "/browse/TST-1\" title=\"summary\">TST-1</a></p>";
            RESOLVED_ISSUE_LINK = "<a href=\"" + ComponentAccessor.getApplicationProperties().getString(APKeys.JIRA_BASEURL) + "/browse/TST-2\" title=\"summary\"><del>TST-2</del></a>";
            OPEN_ISSUE_LINK_NO_TITLE = "<p><a href=\"" + ComponentAccessor.getApplicationProperties().getString(APKeys.JIRA_BASEURL) + "/browse/TST-1\">TST-1</a></p>";
            RESOLVED_ISSUE_LINK_NO_TITLE = "<a href=\"" + ComponentAccessor.getApplicationProperties().getString(APKeys.JIRA_BASEURL) + "/browse/TST-2\"><del>TST-2</del></a>";
