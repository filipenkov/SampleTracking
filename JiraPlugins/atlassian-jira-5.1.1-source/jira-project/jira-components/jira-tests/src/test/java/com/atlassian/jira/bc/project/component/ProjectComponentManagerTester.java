...
public class ProjectComponentManagerTester
{
    ...
    {
        this.store = store;
        managerEnt = new DefaultProjectComponentManager(store, null, new MockEventPublisher());
        managerNonEnt = new DefaultProjectComponentManager(store, null, new MockEventPublisher());
