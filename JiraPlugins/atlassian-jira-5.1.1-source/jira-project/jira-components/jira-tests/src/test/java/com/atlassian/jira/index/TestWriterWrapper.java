...
public class TestWriterWrapper extends ListeningTestCase
{
    static Configuration configuration()
    {
        return new Configuration()
        {
            ...
            {
                return new StandardAnalyzer(DefaultIndexManager.LUCENE_VERSION);
            }
    ...
    public void testOptimize() throws Exception
    {
        ...
        IndexWriterConfig conf = new IndexWriterConfig(DefaultIndexManager.LUCENE_VERSION, configuration.getAnalyzer());
