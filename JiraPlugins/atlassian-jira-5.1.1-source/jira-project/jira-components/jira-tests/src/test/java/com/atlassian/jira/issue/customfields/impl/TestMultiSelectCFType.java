...
public class TestMultiSelectCFType extends LegacyReplayVerifyTestCase
{
    ...
    protected void setUp() throws Exception
    {
        ...
        // Instantiate
        testObject = new MultiSelectCFType(mockOptionsManager, mockCustomFieldPersister, mockGenericConfigManager, null);
    ...
    public void testCreateUpdateValue() throws Exception
    {
        ...
        Collection<Option> output = testObject.getValueFromIssue(mockCustomField, mockIssue);
        assertEquals(2, output.size());
        assertThat(output, hasItem((Option) MockOption._getMockParentOption()));
        assertThat(output, hasItem((Option) MockOption._getMockParent2Option()));

        testObject.updateValue(mockCustomField, mockIssue, o2);
        Collection<Option> output2 = testObject.getValueFromIssue(mockCustomField, mockIssue);
        assertEquals(2, output2.size());
        assertFalse(output2.contains(MockOption._getMockParentOption()));
        assertFalse(output2.contains(MockOption._getMockParent2Option()));
        output2 = testObject.getValueFromIssue(mockCustomField, mockIssue);
        assertEquals(2, output2.size());
        assertTrue(output2.contains(MockOption._getMockChild1Option()));
        assertTrue(output2.contains(MockOption._getMockChild2Option()));
    ...
    {
        // Initialise
        List object = EasyList.build(MockOption._getMockParentOption());
        List o2 = EasyList.build(MockOption._getMockChild1Option(), null);
    ...
    {
        // Initialise
        Collection object = EasyList.build(MockOption._getMockParentOption(), MockOption._getMockParent2Option());
    ...
    public void testValuesEqualWithUnEqual1() throws Exception
    {
        ...
        final MultiSelectCFType type = new MultiSelectCFType(null, null, null, null);
