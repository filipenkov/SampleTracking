...
public class TestDefaultProjectServiceJiraMock extends LegacyJiraMockTestCase
{
    ...
    {
        ProjectService projectService = new DefaultProjectService(jiraAuthenticationContext, projectManager, applicationProperties, null, null, null, null, null, null, null, null, null, null, null, null, null, i18nFactory, null);
    ...
    {
        ComponentAccessor.getApplicationProperties().setString(APKeys.JIRA_PROJECTKEY_PATTERN, regex);
    ...
    {
        ComponentAccessor.getApplicationProperties().setString(APKeys.JIRA_PROJECTKEY_PATTERN, ORIGINAL_PROJECTKEY_PATTERN);
        TestJiraKeyUtils.refreshKeyMatcherOnUtilClass();
    }
}
