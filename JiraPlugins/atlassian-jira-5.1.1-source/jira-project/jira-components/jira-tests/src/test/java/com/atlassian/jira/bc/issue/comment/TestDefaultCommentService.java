...
public class TestDefaultCommentService extends AbstractUsersTestCase
{
    ...
    protected void setUp() throws Exception
    {
        ...
        User u = new MockUser("testuser");
        crowdService.addUser(u, "password");
        ...
        User owen = new MockUser("Owen", "Owen", "owen@secret.place.com");
        crowdService.addUser(owen, "password");
        user = owen;
    }
    ...
    public void testGetCommentByIdHappyPath()
    {
        ...
        CommentService commentService = new DefaultCommentService(
                ...
                (CommentPermissionManager) mockCommentPermissionManager.proxy(), null, null, null, null);
    ...
    public void testGetCommentByIdNoCommentFound()
    {
        ...
        CommentService commentService = new DefaultCommentService(
                (CommentManager) mockCommentManager.proxy(), null,
                ComponentAccessor.getJiraAuthenticationContext(), null, null, null, null, null, null);
    ...
    public void testValidateCommentUpdateHappyPath()
    {
        ...
        Mock mockTextFieldCharacterLenghtValidator = new Mock(TextFieldCharacterLengthValidator.class);
        mockTextFieldCharacterLenghtValidator.expectAndReturn("isTextTooLong", P.ANY_ARGS, Boolean.FALSE);

        CommentService commentService = new DefaultCommentService(
                (CommentManager) mockCommentManager.proxy(), null,
                ComponentAccessor.getJiraAuthenticationContext(), null,
                (CommentPermissionManager) mockCommentPermissionManager.proxy(), null, null, null,
                (TextFieldCharacterLengthValidator) mockTextFieldCharacterLenghtValidator.proxy())
        {
    ...
    public void testUpdateCommentHappyPath()
    {
        ...
        MutableComment mockComment = new MockComment(new Long(1000), "dude", "updateAuthor", "comm-ent", "group-level", new Long(1), date, date, null);
    ...
    {
        Date date = new Date();
        MutableComment mockComment = new MockComment(null, "dude", "updateAuthor", "comm-ent", "group-level", new Long(1), date, date, null);
    ...
    public void testHasPermissionToEditCommentNullId()
    {
        CommentService commentService = new DefaultCommentService(
                ...
                null, null, null, null);
        SimpleErrorCollection errorCollection = new SimpleErrorCollection();
        MutableComment mockComment = new MockComment(null, "dude", "updateAuthor", "comm-ent", "group-level", new Long(1), null, null, null);
    ...
    public void testHasPermissionToEditNoPermission()
    {
        ...
        CommentService commentService = new DefaultCommentService(
                null, null,
                ComponentAccessor.getJiraAuthenticationContext(), null,
                (CommentPermissionManager) mockCommentPermissionManager.proxy(), null, null, visibilityValidator, null)
        {
        ...
        SimpleErrorCollection errorCollection = new SimpleErrorCollection();
        MutableComment mockComment = new MockComment(new Long(9), "dude", "updateAuthor", "comm-ent", "group-level", new Long(1), null, null, null);
        assertFalse(commentService.hasPermissionToEdit(null, mockComment, errorCollection));
        assertTrue(errorCollection.hasAnyErrors());
    ...
    public void testUserHasCommentDeleteAllPermission()
    {
        ...
        DefaultCommentService defaultCommentService = new DefaultCommentService(null, mockPermissionManager, null, null, null, null, null, null, null);
    ...
    {
        DefaultCommentService defaultCommentService = new DefaultCommentService(null, null, jiraAuthenticationContext, null, null, null, null, null, null);
    ...
    public void testHasPermissionToDeleteHasDeleteOwnPermissionUserIsAuthor()
    {
        ...
        commentManager.isUserCommentAuthor((User) jiraServiceContext.getLoggedInUser(), mockComment);
        commentManagerControl.setReturnValue(true);
        commentManagerControl.replay();

        DefaultCommentService defaultCommentService = new DefaultCommentService(commentManager, null, jiraAuthenticationContext, null, null, null, null, null, null)
        {
            protected boolean hasVisibility(JiraServiceContext jiraServiceContext, Comment comment)
            {
                return true;
