...
public class TestDefaultSearchRequestManagerSearch extends MockControllerTestCase
{
    ...
    public void setUp()
    {
        ...
        user = new MockUser("testSearchAsUser");
    ...
    public void testSearchNullPrameters()
    {
        ...
        try
        {
            searchRequestManager.search(null, null, 0, 10);
    ...
    public void testSearchZeroWidth()
    {
        ...
        try
        {
            searchRequestManager.search(new SharedEntitySearchParametersBuilder().toSearchParameters(), null, 0, 0);
    ...
    public void testSearchIllegalOffset()
    {
        ...
        try
        {
            searchRequestManager.search(new SharedEntitySearchParametersBuilder().toSearchParameters(), null, 0, -1);
            fail("An exception should be thrown on invalid width.");
        }
        catch (final IllegalArgumentException expected)
        {
    ...
    private void _testSearch(final User user, final List expectedPages)
    {
