...
public class TestEditFieldLayoutItem extends AbstractTestEditFieldLayoutItem
{
    ...
    public void testDoExecute() throws Exception
    {
        ...
        FieldLayout fieldLayout = ComponentAccessor.getFieldManager().getFieldLayoutManager().getFieldLayout();
        ...
        fieldLayoutItem = (FieldLayoutItem) ComponentAccessor.getFieldManager().getFieldLayoutManager().getFieldLayout().getFieldLayoutItem(orderableField);
