...
public class TestPortalPageServiceSearch
{
    ...
    public void testSearchNullUser()
    {
        ...
        when(portalPageManager.search(sharedEntitySearchParameters, null, 0, 10)).thenReturn(expectedResult);
    ...
    {
        when(userUtil.userExists(USERNAME_FRED)).thenReturn(false);
    ...
    {
        when(userUtil.userExists(USERNAME_FRED)).thenReturn(true);
