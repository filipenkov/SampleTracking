...
public class TestJiraWebResourceManagerImpl
{
    ...
    public void setUp() throws Exception
    {
        ...
        webResourceManager = new JiraWebResourceManagerImpl(applicationProperties, pluginResourceLocator,
                mockWebResourceIntegration, webResourceUrlProvider, resourceBatchingConfiguration);
    }
