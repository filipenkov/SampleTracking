 ...
 *
 */
public class TestAbstractIssuePickerSearchProviderQueryCreator extends ListeningTestCase
{
    ...
    {
        keywordAnalyzer = new WhitespaceAnalyzer();
        searchAnalyzer = new EnglishAnalyzer(DefaultIndexManager.LUCENE_VERSION, false); // DefaultIndexManager.ANALYZER_FOR_SEARCHING cant be used as its DB dependant
    }
