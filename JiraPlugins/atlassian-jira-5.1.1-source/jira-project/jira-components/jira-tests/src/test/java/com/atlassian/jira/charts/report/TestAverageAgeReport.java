...
public class TestAverageAgeReport extends AbstractChartReportTestCase
{
    private TimeZoneManager timeZoneManager;

    public AbstractChartReport getChartReport()
    {
        return new AverageAgeReport(null, (ApplicationProperties) applicationProperties.proxy(), (ProjectManager) projectManager.proxy(),
    ...
    public void testGenerateReportHtml() throws Exception
    {
        ...
        mockChartFactory.generateAverageAgeChart(context, 30, ChartFactory.PeriodName.weekly);
        ...
        AverageAgeReport averageAgeReport =
                new AverageAgeReport(jiraAuthenticationContext, mockApplicationProperties, null, null,
        ...
        mockReportModuleDescriptor.getHtml("view", EasyMap.build("user", null,
                "indexing", true, "action", null, "report", averageAgeReport,
        ...
        averageAgeReport.init(mockReportModuleDescriptor);

        Map<String, Object> params = EasyMap.build("projectOrFilterId", "filter-123", "periodName", "weekly");

        final String html = averageAgeReport.generateReportHtml(null, params);
