...
public class TestLinkIssue extends AbstractJellyTestCase
{
    ...
    protected void setUp() throws Exception
    {
        ...
        ComponentAccessor.getIssueTypeScreenSchemeManager().associateWithDefaultScheme(project1);
        ...
        ComponentAccessor.getApplicationProperties().setOption(APKeys.JIRA_OPTION_ISSUELINKING, true);
    ...
    public void testLinkCreatedIssues() throws Exception
    {
        ...
        ComponentAccessor.getIssueTypeScreenSchemeManager().associateWithDefaultScheme(project2);
