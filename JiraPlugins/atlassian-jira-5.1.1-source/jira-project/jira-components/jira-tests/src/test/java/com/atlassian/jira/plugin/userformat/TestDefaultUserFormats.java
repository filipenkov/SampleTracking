 ...
 * @since v4.4
 */
public class TestDefaultUserFormats extends ListeningTestCase
{
    ...
    public void forTypeShouldReturnTheConfiguredUserFormatForThatTypeIfThereIsAnEntryForIt()
    {
        ...
        final DefaultUserFormats defaultUserFormats =
                new DefaultUserFormats(mockUserFormatTypeConfiguration, mockUserFormatModuleDescriptors);

        final UserFormat actualUserFormatForAConfiguredType = defaultUserFormats.forType("a-configured-type");
    ...
    public void forTypeShouldShouldReturnNullWhenTheTypeHasNoConfiguredFormatAndThereAreNoFormatsThatCanHandleIt()
    {
        ...
        final UserFormat actualUserFormatForANonConfiguredType = defaultUserFormats.forType("a-non-configured-type");
