...
public class TestCompositeKeyCache extends ListeningTestCase
{
    @Test
    public void testSimpleGet() throws Exception
    {
        final SupplierFactory factory = new SupplierFactory();
        final CompositeKeyCache<Integer, Integer, String> cache = CompositeKeyCache.createWeakFirstKeySoftValueCache();
