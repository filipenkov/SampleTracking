...
public class TestSubtokenFilter extends ListeningTestCase
{
    ...
    public void testExceptionStringGreek() throws Exception
    {
        ...
        final TokenStream tokenStream = new GreekAnalyzer(DefaultIndexManager.LUCENE_VERSION).tokenStream("TestField", new StringReader(
    ...
    {
        final TokenStream tokenStream = new GreekAnalyzer(DefaultIndexManager.LUCENE_VERSION).tokenStream("TestField", new StringReader("Throws java.lang.NullPointerException."));
        final SubtokenFilter filter = new SubtokenFilter(tokenStream);
        assertNextToken("throws", "<ALPHANUM>", filter);
    ...
    {
        final TokenStream tokenStream = new GreekAnalyzer(DefaultIndexManager.LUCENE_VERSION).tokenStream("TestField", new StringReader("2,500"));
        final SubtokenFilter filter = new SubtokenFilter(tokenStream);
    ...
    {
        return new EnglishAnalyzer(DefaultIndexManager.LUCENE_VERSION, false).tokenStream("TestField", new StringReader(text));
    }
