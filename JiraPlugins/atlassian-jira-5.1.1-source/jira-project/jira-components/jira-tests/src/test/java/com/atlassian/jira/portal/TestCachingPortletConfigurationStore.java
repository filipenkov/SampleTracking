...
public class TestCachingPortletConfigurationStore extends ListeningTestCase
{
    ...
    public void setUp() throws Exception
    {
        ...
        config1 = new PortletConfigurationImpl(CONFIG1_ID, PAGE1_ID, new Integer(1), new Integer(2), null, null, Collections.<String, String>emptyMap());
        config2 = new PortletConfigurationImpl(CONFIG2_ID, PAGE2_ID, new Integer(1), new Integer(2), null, null, Collections.<String, String>emptyMap());
    }
    ...
    private PortletConfigurationStore createCachingStore()
    {
        ...
        return new CachingPortletConfigurationStore(delegateStore)
        {
            ///CLOVER:OFF
