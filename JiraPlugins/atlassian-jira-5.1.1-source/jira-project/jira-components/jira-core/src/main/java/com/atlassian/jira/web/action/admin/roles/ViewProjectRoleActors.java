...
public class ViewProjectRoleActors extends AbstractRoleActors
{
     ...
     * e.g. {@link com.atlassian.jira.security.roles.actor.UserRoleActor#TYPE}
     * or {@link com.atlassian.jira.security.roles.actor.GroupRoleActor#TYPE}.
     * @param projectRole
    ...
    {
        ProjectRoleActors projectRoleActors = projectRoleService.getProjectRoleActors(getLoggedInUser(), projectRole, getProject(), this);
    ...
    public Collection getRoleActors(ProjectRole projectRole)
    {
        ...
        SortedSet sortedRoleActors = new TreeSet(RoleActorComparator.COMPARATOR);
        if (roleActors != null)
        {
