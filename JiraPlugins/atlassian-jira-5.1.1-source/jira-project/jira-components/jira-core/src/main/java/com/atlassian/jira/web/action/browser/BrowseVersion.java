...
public class BrowseVersion extends JiraWebActionSupport
{
    ...
    public BrowseVersionContext getVersionContext()
    {
        ...
        {
            versionContext = new BrowseVersionContextImpl(getVersion(), getLoggedInUser());
        }
    ...
    {
        return !descriptor.getModule().showPanel(getVersionContext());
    }
    ...
    protected List<VersionTabPanelModuleDescriptor> initTabPanels(Class tabPanelClass)
    {
        ...
        try
        {
            ...
            for (Iterator<VersionTabPanelModuleDescriptor> iterator = tabPanels.iterator(); iterator.hasNext();)
            {
                VersionTabPanelModuleDescriptor descriptor = iterator.next();
