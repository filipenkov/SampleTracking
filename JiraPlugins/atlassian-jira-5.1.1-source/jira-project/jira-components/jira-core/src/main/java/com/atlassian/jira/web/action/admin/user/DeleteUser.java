...
public class DeleteUser extends ViewUser
{
    ...
    {
        validationResult = userService.validateDeleteUser(getLoggedInUser(), getUser().getName());
    ...
    public long getNumberOfAssignedIssues() throws Exception
    {
        if (assignedIssues == -1)
        {
            assignedIssues = userUtil.getNumberOfAssignedIssuesIgnoreSecurity(getLoggedInUser(), getUser());
        }
    ...
    public long getNumberOfReportedIssues() throws Exception
    {
        if (reportedIssues == -1)
        {
            reportedIssues = userUtil.getNumberOfReportedIssuesIgnoreSecurity(getLoggedInUser(), getUser());
        }
