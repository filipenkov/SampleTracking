...
public class IssueConstantSearchInputTransformer<T extends IssueConstant> extends IdIndexedSearchInputTransformer<T>
{
    ...
    {
        super(clauseNames, indexInfoResolver, operandResolver, fieldFlagOperandRegistry, searchContextVisibilityChecker);
    ...
    public IssueConstantSearchInputTransformer(final ClauseNames jqlClauseNames, final String urlParameter, final IndexInfoResolver<T> indexInfoResolver,
            ...
            final SearchContextVisibilityChecker searchContextVisibilityChecker, final NameResolver<T> issueConstantResolver)
    {
        super(jqlClauseNames, urlParameter, indexInfoResolver, operandResolver, fieldFlagOperandRegistry, navigatorStructureChecker, searchContextVisibilityChecker);
        this.issueConstantResolver = notNull("issueConstantResolver", issueConstantResolver);
    ...
    {
        return new IssueConstantIndexedInputHelper<T>(indexInfoResolver, operandResolver, fieldFlagOperandRegistry, searchContextVisibilityChecker, issueConstantResolver);
    }
}
