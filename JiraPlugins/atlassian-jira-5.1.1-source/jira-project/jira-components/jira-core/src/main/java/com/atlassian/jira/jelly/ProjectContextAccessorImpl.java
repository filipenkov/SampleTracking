...
public class ProjectContextAccessorImpl implements ProjectContextAccessor, ProjectAware
{
    ...
    {
        final GenericValue project = ManagerFactory.getProjectManager().getProject(projectId);
        setProjectContext(project);
    }

    private void setProjectContext(String projectKey)
    {
        final GenericValue project = ManagerFactory.getProjectManager().getProjectByKey(projectKey);
        setProjectContext(project);
    }
