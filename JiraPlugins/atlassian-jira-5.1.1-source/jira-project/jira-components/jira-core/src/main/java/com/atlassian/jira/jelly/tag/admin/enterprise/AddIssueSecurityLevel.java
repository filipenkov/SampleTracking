...
public class AddIssueSecurityLevel extends IssueSchemeAwareActionTagSupport
{
    ...
    protected void postTagExecution(XMLOutput output)
    {
        ...
        final List levels = ManagerFactory.getIssueSecurityLevelManager().getSchemeIssueSecurityLevels(getIssueSchemeId());
        for (int i = 0; i < levels.size(); i++)
        {
            GenericValue genericValue = (GenericValue) levels.get(i);
