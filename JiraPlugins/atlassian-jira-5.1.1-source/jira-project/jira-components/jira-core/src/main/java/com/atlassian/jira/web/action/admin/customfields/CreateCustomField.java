...
public class CreateCustomField extends JiraWizardActionSupport
{
    ...
    public String doAddDetails() throws Exception
    {
        ...
        if (customFieldContextConfigHelper.doesAddingContextToCustomFieldAffectIssues(getLoggedInUser(), customField, contexts, returnIssueTypes, true))
        {
    ...
    {
        return customFieldDescription.createRenderablePropertyFor(null);
    }
