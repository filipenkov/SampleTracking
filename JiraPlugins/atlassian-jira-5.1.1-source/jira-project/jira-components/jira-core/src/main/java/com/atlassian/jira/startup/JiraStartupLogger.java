...
public class JiraStartupLogger
{
    ...
    public void printStartedMessage()
    {
        ...
        try
        {
            ...
            info.obtainFilePaths(new SystemTenantJiraHomeLocator.SystemJiraHome());
            info.obtainPlugins();
        ...
        {
            final StringBuffer sb = new StringBuffer().append("The following plugins failed to load:");
        ...
        final ExecutorService pool = MultiTenantExecutors.wrap(Executors.newSingleThreadExecutor(ThreadFactories.namedThreadFactory("Modification Check", ThreadFactories.Type.DAEMON)));
    ...
    private static class ModificationCheck implements Runnable
    {
        ...
        {
            try {
                final HashRegistryCache registry = ComponentManager.getComponentInstanceOfType(HashRegistryCache.class);
