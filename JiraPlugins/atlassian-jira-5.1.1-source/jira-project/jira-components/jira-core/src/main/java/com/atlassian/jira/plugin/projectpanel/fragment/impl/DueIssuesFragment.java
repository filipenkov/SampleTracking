...
{
    public DueIssuesFragment(final VelocityTemplatingEngine templatingEngine, final ApplicationProperties applicationProperites, final JiraAuthenticationContext jiraAuthenticationContext, final SearchProvider searchProvider, final DateTimeFormatterFactory dateTimeFormatterFactory)
    {
