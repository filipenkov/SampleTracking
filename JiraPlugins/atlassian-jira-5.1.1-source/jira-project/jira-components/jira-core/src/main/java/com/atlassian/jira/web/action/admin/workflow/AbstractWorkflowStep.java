 ...
 * All rights reserved.
 */
public class AbstractWorkflowStep extends JiraWebActionSupport
{
    ...
    {
        Collection statuses = constantsManager.getStatusObjects();
    ...
    {
        for (Iterator iterator1 = workflow.getDescriptor().getSteps().iterator(); iterator1.hasNext();)
        {
            StepDescriptor stepDescriptor = (StepDescriptor) iterator1.next();
