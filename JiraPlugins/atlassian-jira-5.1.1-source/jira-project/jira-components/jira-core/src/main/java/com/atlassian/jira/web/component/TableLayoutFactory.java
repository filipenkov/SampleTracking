...
public class TableLayoutFactory
{
    ...
    public TableLayoutFactory(ColumnLayoutManager columnLayoutManager, FieldManager fieldManager,
    ...
    public IssueTableLayoutBean getStandardLayout(SearchRequest searchRequest, User user)
    {
        ...
        if (user != null && userPreferencesManager.getPreferences(user).getBoolean(PreferenceKeys.USER_SHOW_ACTIONS_IN_NAVIGATOR))
        {
    ...
    private List<ColumnLayoutItem> getUserColumns(SearchRequest searchRequest, User user)
    {
        ...
        try
        {
            ...
            if (searchRequest.isLoaded() && searchRequest.useColumns())
            {
