...
public class ViewIssueTypes extends AbstractViewConstants implements AddIssueTypeAction
{
    ...
    public String doAddIssueType() throws Exception
    {
        ...
        if (SubTaskManager.SUB_TASK_ISSUE_TYPE_STYLE.equals(getStyle()))
        {
            issueTypeManager.createSubTaskIssueType(getName(), getDescription(), getIconurl());
        }
        else
        {
            issueTypeManager.createIssueType(name, description, iconurl);
        }
