...
public class WebWorkAdaptor
{
    ...
    public boolean mapJellyTagToAction(ActionTagSupport tag, XMLOutput output) throws JellyTagException
    {
        ...
        InternalWebSudoManager internalWebSudoManager = ComponentManager.getComponent(InternalWebSudoManager.class);
    ...
    protected boolean processResult(ActionTagSupport tag, XMLOutput output) throws JellyTagException
    {
        ...
        try
        {
            ...
            if (hasErrorMessages)
            {
                ...
                {
                    String errorMsg = (String) iterator.next();
            ...
            if (hasErrors)
            {
                ...
                StringBuffer buff = new StringBuffer();
                buff.append("\nResult=").append(result).append("\n");
                for (Iterator iterator = errors.keySet().iterator(); iterator.hasNext();)
                {
    ...
    {
        CrowdService crowdService = ComponentManager.getComponent(CrowdService.class);
