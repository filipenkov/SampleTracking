...
public class SavedFilterClauseValidator implements ClauseValidator
{
    ...
    public SavedFilterClauseValidator(final SavedFilterResolver savedFilterResolver, final JqlOperandResolver jqlOperandResolver,
            final SavedFilterCycleDetector savedFilterCycleDetector, final SessionSearchObjectManagerFactory sessionSearchObjectManagerFactory)
    {
            ...
            if (rawValues != null)
            {
                ...
                for (QueryLiteral rawValue : rawValues)
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (savedFilterCycleDetector.containsSavedFilterReference(searcher, false, matchingFilter, getSearchFilterId()))
                            {
    ...
    {
        final SearchRequest searchRequest = getSearchRequestFromSession();
        return (searchRequest == null ? null : searchRequest.getId());
    }
