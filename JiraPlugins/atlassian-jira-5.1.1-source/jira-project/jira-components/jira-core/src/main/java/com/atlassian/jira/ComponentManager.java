...
import static com.atlassian.jira.ComponentManagerMap.COMPONENT_MANAGER_MAP;
...
public class ComponentManager implements Shutdown
{
    ...
    {
        List<Startable> startables = ((DefaultPicoContainer)getContainer()).getComponentInstancesOfType(Startable.class);
    ...
    {
        return COMPONENT_MANAGER_MAP.get();
    }
    ...
    public static void stopTenant(final Tenant tenant)
    {
        try
        {
            ...
            COMPONENT_MANAGER_MAP.onTenantStop(tenant);
        }
        finally
        {
