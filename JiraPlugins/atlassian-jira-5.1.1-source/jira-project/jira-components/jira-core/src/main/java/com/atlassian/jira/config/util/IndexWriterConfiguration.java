...
public interface IndexWriterConfiguration
{
    ...
    public abstract class WriterSettings
    {
        public IndexWriterConfig getWriterConfiguration(Analyzer analyser)
        {
            ...
            mergePolicy.setMaxMergedSegmentMB(getIntProperty(applicationProperties, APKeys.JiraIndexConfiguration.MergePolicy.MAX_MERGED_SEGMENT_MB, 5120));
            ...
            final IndexWriterConfig luceneConfig = new IndexWriterConfig(DefaultIndexManager.LUCENE_VERSION, analyser);
