...
public final class RenderablePropertyImpl implements RenderableProperty
{
    ...
    {
        return featureManager.isEnabled(ON_DEMAND);
    }
    ...
    private String renderTemplate(String template, Context context)
    {
        ...
        try
        {
            return velocityManager.getEncodedBody(templatePath, "", applicationProperties.getEncoding(), ImmutableMap.of("property", context));
        }
