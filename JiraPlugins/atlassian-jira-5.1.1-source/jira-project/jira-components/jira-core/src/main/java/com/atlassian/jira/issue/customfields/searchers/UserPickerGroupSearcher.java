        ...
        implements CustomFieldSearcher, SortableCustomFieldSearcher, CustomFieldStattable
{
    ...
    public void init(CustomField field)
    {
        ...
        this.searchRenderer = new UserPickerGroupCustomFieldRenderer(field, searchConstants, field.getNameKey(), velocityRequestContextFactory, applicationProperties, templatingEngine, userPickerSearchService, fieldVisibilityManager);
