...
public class TimeTrackingSummaryBean
{
    ...
    TimeTrackingSummaryBean(Collection /* <ReportIssue> */ issues)
    {
        ...
        {
            final ReportIssue reportIssue = ((ReportIssue) iterator.next());
            ...
            for (Iterator subtasks = reportIssue.getSubTasks().iterator(); subtasks.hasNext();)
            {
                Issue subTask = ((ReportIssue) subtasks.next()).getIssue();
