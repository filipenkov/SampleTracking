...
public class PortalPageDisplayBean implements SharesListHelper
{
    ...
    {
        final String ownerUserName = portalPage.getOwnerUserName();
        if (ownerUserName != null)
        {
            return userFormatManager.formatUser(ownerUserName, UserNameUserFormat.TYPE, "portal_page");
        }
        return null;
    }
    ...
    {
        return (getOwnerUserName() != null) && UserNames.equal(getOwnerUserName(), authCtx.getLoggedInUser());
    }
    ...
    public boolean isFavourite()
    {
        if (isFavourite == null)
        {
            isFavourite = favouriteService.isFavourite(authCtx.getLoggedInUser(), portalPage);
        }
        return isFavourite;
    }
