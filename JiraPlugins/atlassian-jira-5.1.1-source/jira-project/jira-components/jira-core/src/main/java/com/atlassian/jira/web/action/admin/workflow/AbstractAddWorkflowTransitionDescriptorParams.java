...
public abstract class AbstractAddWorkflowTransitionDescriptorParams extends AbstractWorkflowTransitionAction
{
    ...
    protected String getRedirectUrl()
    {
        if (getStep() == null)
        {
            return "ViewWorkflowTransition.jspa?workflowName=" + URLEncoder.encode(getWorkflow().getName()) +
                   "&workflowMode=" + getWorkflow().getMode() +
                   "&workflowTransition=" + getTransition().getId() + "&atl_token=" + getXsrfToken();
        }
        else
        {
            return "ViewWorkflowTransition.jspa?workflowName=" + URLEncoder.encode(getWorkflow().getName()) +
    ...
    {
        Collection resourceDescriptors = descriptor.getResourceDescriptors();
