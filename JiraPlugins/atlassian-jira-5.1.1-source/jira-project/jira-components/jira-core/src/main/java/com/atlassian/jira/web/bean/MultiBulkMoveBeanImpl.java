...
public class MultiBulkMoveBeanImpl implements MultiBulkMoveBean
{
    ...
    public void initFromIssues(List issues, BulkEditBean parentBulkEditBean)
    {
        ...
        for (Iterator iterator = keys.iterator(); iterator.hasNext();)
        {
            ...
            bulkEditBean.setTargetIssueTypeId(context.getIssueTypeObject() != null ? context.getIssueTypeObject().getId() : null);
    ...
    public void remapBulkEditBeansByTargetContext()
    {
        ...
        for (Iterator iterator = entries.iterator(); iterator.hasNext();)
        {
            ...
            IssueContext targetIssueContext = new IssueContextImpl(bulkEditBean.getTargetProject(), bulkEditBean.getTargetIssueTypeObject());
    ...
    public void validate(ErrorCollection errors, BulkMoveOperation bulkMoveOperation, User user)
    {
        ...
        for (Iterator iterator = entries.iterator(); iterator.hasNext();)
        {
            ...
            {
                errors.addErrorMessage(authenticationContext.getI18nHelper().getText("admin.errors.bean.no.permission", "" + issueContext.getProject().getString("name"), "" + issueContext.getIssueTypeObject().getName()));
            }
        }
    }
