...
public class ExternalIssueImpl implements ExternalIssue
{
    ...
    public Map<String, Object> toFieldsMap()
    {
        ...
        {
            fields.put("project", getProject());
        }

        if (StringUtils.isNotEmpty(getReporter()))
        {
            fields.put("reporter", getReporter());
        }
        if (StringUtils.isNotEmpty(getAssignee()))
        {
            fields.put("assignee", getAssignee());
        }

        if (StringUtils.isNotEmpty(getIssueType()))
        {
            fields.put("type", getIssueType());
        }
        if (StringUtils.isNotEmpty(getIssueType()))
        {
            fields.put("issuetype", getIssueType());
        }
        if (StringUtils.isNotEmpty(getSummary()))
        {
            fields.put("summary", getSummary());
        }
        ...
        {
            fields.put("resolution", getResolution());
        }
        ...
        if (getCreated() != null)
        {
            fields.put("created", getCreated());
        }
        if (getUpdated() != null)
        {
            fields.put("updated", getUpdated());
        }
        if (getResolutionDate() != null)
        {
            fields.put("resolutiondate", getResolutionDate());
        }
        if (getDuedate() != null)
        {
            fields.put("duedate", getDuedate());
        }

        if (getVotes() != null)
        {
            fields.put("votes", getVotes());
        }

        if (getEstimate() != null)
        {
            fields.put("timeestimate", getEstimate());
        }

        if (getOriginalEstimate() != null)
        {
            fields.put("timeoriginalestimate", getOriginalEstimate());
        }

        if (getTimeSpent() != null)
        {
            fields.put("timespent", getTimeSpent());
        }

        if (getSecurityLevel() != null)
        {
            fields.put("security", getSecurityLevel());
        }
