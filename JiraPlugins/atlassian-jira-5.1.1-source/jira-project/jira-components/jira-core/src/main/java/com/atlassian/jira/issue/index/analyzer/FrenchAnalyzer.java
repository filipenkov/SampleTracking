 ...
 */
public class FrenchAnalyzer extends AbstractLanguageAnalyser
{
    private final Set<?> stopWords;
    private final Version matchVersion;

    public FrenchAnalyzer(Version matchVersion, final boolean indexing)
    {
        super(indexing);
        this.matchVersion = matchVersion;
        stopWords = org.apache.lucene.analysis.fr.FrenchAnalyzer.getDefaultStopSet();
    }
