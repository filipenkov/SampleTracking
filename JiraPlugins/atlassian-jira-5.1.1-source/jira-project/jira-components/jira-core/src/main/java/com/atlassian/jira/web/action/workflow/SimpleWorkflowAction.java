...
public class SimpleWorkflowAction extends AbstractIssueSelectAction
{
    ...
    {
        final IssueService.IssueResult transitionResult = issueService.transition(getLoggedInUser(), new IssueService.TransitionValidationResult(getIssueObject(), this, Collections.<String, Object>emptyMap(), Collections.emptyMap(), getAction()));
