    ...
    public boolean checkSharePermission(final JiraServiceContext ctx, final SharePermission permission)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    if (!permissionManager.hasPermission(Permissions.BROWSE, project, ctx.getLoggedInUser()))
                    {
                        ctx.getErrorCollection().addError(ShareTypeValidator.ERROR_KEY,
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else if (!projectRoleManager.isUserInProjectRole(ctx.getLoggedInUser(), role, project))
                        {
                            ctx.getErrorCollection().addError(ShareTypeValidator.ERROR_KEY,
        ...
        if (projectId != null)
        {
            ...
            else
            {
                ...
                if (roleId != null)
                {
                    ...
                    else if (!projectRoleManager.isUserInProjectRole(serviceCtx.getLoggedInUser(), projectRole, project))
                    {
                ...
                else
                {
                    ...
                    final boolean browsePermission = permissionManager.hasPermission(Permissions.BROWSE, project, serviceCtx.getLoggedInUser());
                    if (!browsePermission)
                    {
                        errorCollection.addError(ShareTypeValidator.ERROR_KEY,
