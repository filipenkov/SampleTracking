...
public class DefaultIssueLinkTypeManager implements IssueLinkTypeManager
{
    ...
    public DefaultIssueLinkTypeManager(final OfBizDelegator delegator)
    {
    ...
    public IssueLinkType getIssueLinkType(Long id, boolean excludeSystemLinks)
    {
        ...
        GenericValue linkTypeGV = cache.get(id);
        return linkTypeGV != null ? buildIssueLinkType(linkTypeGV) : null;
    }
