...
public class IssueTypeSystemField extends AbstractOrderableNavigableFieldImpl implements IssueTypeField, RestAwareField
{
    ...
    public String getEditHtml(FieldLayoutItem fieldLayoutItem, OperationContext operationContext, Action action, Issue issue, Map displayParameters)
    {
        ...
        else
        {
            ...
            velocityParams.put("hasMovePermission", Boolean.valueOf(getPermissionManager().hasPermission(Permissions.MOVE_ISSUE, issue.getProjectObject(), getAuthenticationContext().getLoggedInUser())));
