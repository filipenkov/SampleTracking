...
public class EditProfile extends JiraWebActionSupport
{
    ...
    public EditProfile(final CrowdService crowdService, final EventPublisher eventPublisher)
    {
    ...
    protected String doExecute() throws Exception
    {
        ...
        if (detailsHaveChanged(current))
        {
            ...
            try
            {
                ...
                eventPublisher.publish(new UserProfileUpdatedEvent(user, getLoggedInUser()));
            }
