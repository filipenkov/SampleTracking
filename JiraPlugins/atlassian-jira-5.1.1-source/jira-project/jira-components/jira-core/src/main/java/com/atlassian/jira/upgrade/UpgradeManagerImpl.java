...
public class UpgradeManagerImpl implements UpgradeManager, Startable
{
            ...
            final FeatureManager featureManager)
    {
        this(jiraLicenseService, buildUtilsInfo, i18HelperFactory, applicationProperties, buildVersionRegistry, eventPublisher,
                ofBizDelegator, indexManager, outlookDateManager, UPGRADES_XML, featureManager);
    }
    ...
    public Collection<String> doUpgradeIfNeededAndAllowed(@Nullable final String backupPath) throws IllegalXMLCharactersException
    {
        ...
        final Collection<String> errors = doUpgradeIfNeeded(backupPath);
        if (errors.isEmpty())
        {
    ...
    {
        return isRunningOnDemand() || !applicationProperties.getOption(APKeys.JIRA_AUTO_EXPORT) || JiraSystemProperties.isDevMode();
    }
