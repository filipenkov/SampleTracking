...
public class EditComment extends AbstractCommentableIssue
{
    ...
    protected String doExecute() throws Exception
    {
        ...
        commentService.validateCommentUpdate(getLoggedInUser(), getCommentId(), getComment(),
        ...
        commentService.update(getLoggedInUser(), commentObject, true, this);
    ...
    public String doDefault() throws Exception
    {
        ...
        // Check that we can edit the comment
        if (!commentService.hasPermissionToEdit(getLoggedInUser(), commentObject, this))
        {
            return ERROR;
        }
    ...
    public MutableComment getCommentObject()
    {
        if (commentObject == null)
        {
            commentObject = commentService.getMutableComment(getLoggedInUser(), getCommentId(), this);
        }
