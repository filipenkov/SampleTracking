...
public class ViewDefaultProjectRoleActors extends AbstractRoleActors
{
    ...
    {
        DefaultRoleActors defaultRoleActors = projectRoleService.getDefaultRoleActors(getLoggedInUser(), projectRole, this);
        Set roleActorsByType = defaultRoleActors.getRoleActorsByType(type);
        ...
        else
        {
            ...
            return new ArrayList(defaultRoleActors.getRoleActorsByType(type)).subList(0,length);
        }
    }
