...
public class ProjectSystemField extends AbstractOrderableNavigableFieldImpl implements ProjectField, RestAwareField
{
    ...
    {
        return getPermissionManager().getProjects(Permissions.CREATE_ISSUE, getAuthenticationContext().getLoggedInUser());
    }
    ...
    {
        return Collections.singletonList(new SortField(DocumentConstants.PROJECT_KEY, new StringSortComparator(), sortOrder));
    }
