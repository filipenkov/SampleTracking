...
public class JiraWebResourceIntegration implements WebResourceIntegration
{
    ...
    public JiraWebResourceIntegration(
            ...
            final JiraAuthenticationContext jiraAuthenticationContext, I18nBean.CachingFactory i18nFactory, JiraHome jiraHome)
    {
    ...
    {
        return new File(jiraHome.getHome(), "tmp" + File.separator + "webresources");
    }
}
