...
public class AssignIssue extends AbstractCommentableAssignableIssue implements OperationContext
{
    ...
    public void doValidation()
    {
        try
        {
            ...
            else
            {
                ...
                {
                    User currentAssignee = userUtil.getUser(getAssignee());
    ...
    protected FieldScreenRenderer getFieldScreenRenderer()
    {
        ...
        {
            fieldScreenRenderer = fieldScreenRendererFactory.getFieldScreenRenderer(getLoggedInUser(), getIssueObject(), IssueOperations.EDIT_ISSUE_OPERATION, false);
        }
