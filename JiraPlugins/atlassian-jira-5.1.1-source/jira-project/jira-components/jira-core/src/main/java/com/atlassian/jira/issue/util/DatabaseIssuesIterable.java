...
public class DatabaseIssuesIterable implements IssuesIterable
{
    ...
    public DatabaseIssuesIterable(final OfBizDelegator delegator, final IssueFactory issueFactory, EntityCondition condition)
    {
    ...
    {
        final DatabaseIssuesIterator iterator = new DatabaseIssuesIterator(delegator, issueFactory, condition);
        try
        {
