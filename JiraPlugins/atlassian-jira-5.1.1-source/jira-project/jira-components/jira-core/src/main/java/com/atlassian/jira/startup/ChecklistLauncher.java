...
public class ChecklistLauncher implements JiraLauncher
{
    ...
    public void start()
    {
        try
        {
            System.setProperty("com.atlassian.plugins.rest.shim.JERSEY-291", "true");  // REST-206; JRADEV-11989
            setJiraDevMode();
    ...
    private void setDefault(String key, String value, String... relatedKeys)
    {
        ...
        // Reset the lazy references in JiraSystemProperties to make sure the new default value is seen.
