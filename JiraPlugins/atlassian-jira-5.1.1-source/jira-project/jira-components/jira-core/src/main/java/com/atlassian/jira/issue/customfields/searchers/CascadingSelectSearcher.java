    ...
    implements CustomFieldSearcher
{
    ...
    public void init(CustomField field)
    {
        ...
        this.searchInputTransformer = new CascadingSelectCustomFieldSearchInputTransformer(names, field, searcherInformation.getId(), selectConverter, jqlOperandResolver, jqlSelectOptionsUtil, jqlCascadingSelectLiteralUtil, queryContextConverter, customFieldInputHelper);
