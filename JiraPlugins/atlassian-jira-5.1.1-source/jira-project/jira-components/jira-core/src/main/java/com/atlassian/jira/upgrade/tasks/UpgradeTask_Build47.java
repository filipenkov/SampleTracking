...
public class UpgradeTask_Build47 extends AbstractUpgradeTask
{
    ...
    public void addOldGlobalPermissionsToScheme(SchemeManager psm, int permType, GenericValue scheme) throws GenericEntityException, CreateException
    {
        ...
        List globalPermissions = ComponentAccessor.getOfBizDelegator().findByAnd("Permission", EasyMap.build("type", new Long(permType), "project", null));
    ...
    public void addOldProjectPermissionsToScheme(SchemeManager psm, int permType, GenericValue scheme, Long project) throws GenericEntityException
    {
        ...
        List globalPermissions = ComponentAccessor.getOfBizDelegator().findByAnd("Permission", EasyMap.build("type", new Long(permType), "project", project));
    ...
    {
        List projects = getOfBizDelegator().findAll("Project");
        ...
        for (Iterator iterator = projects.iterator(); iterator.hasNext();)
        {
            ...
            List permissions = ComponentAccessor.getOfBizDelegator().findByAnd("Permission", EasyMap.build("project", project.getLong("id")));
