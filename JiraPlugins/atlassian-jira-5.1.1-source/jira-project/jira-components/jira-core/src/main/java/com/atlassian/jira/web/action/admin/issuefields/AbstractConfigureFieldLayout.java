...
public abstract class AbstractConfigureFieldLayout extends JiraWebActionSupport
{
    ...
    {
        return ComponentAccessor.getFieldManager().isHideableField(fieldLayoutItem.getOrderableField());
    }

    public boolean isRequirable(FieldLayoutItem fieldLayoutItem)
    {
        if (ComponentAccessor.getFieldManager().isRequirableField(fieldLayoutItem.getOrderableField()))
        {
    ...
    {
        return ComponentAccessor.getFieldManager().isMandatoryField(fieldLayoutItem.getOrderableField());
    }    

    public boolean isUnscreenable(FieldLayoutItem fieldLayoutItem)
    {
        return ComponentAccessor.getFieldManager().isUnscreenableField(fieldLayoutItem.getOrderableField());
    }
    ...
    {
        return ComponentAccessor.getFieldManager().isCustomField(fieldLayoutItem.getOrderableField());
    }
