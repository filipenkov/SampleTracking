...
public class ApplicationPropertyMetadata
{
    ...
    private ApplicationPropertyMetadata(final String key, final String type, final String defaultValue, final Supplier<? extends Validator> validatorSupplier,
            boolean userEditable, boolean requiresRestart, final String name, final String nameKey, final String desc, 
            final String descKey, final ApplicationPropertyEnumerator enumerator)
    {
        this.key = key;
        this.type = type;
    ...
    public static class Builder
    {
        ...
        {
            return new ApplicationPropertyMetadata(key, type, defaultValue, validator, userEditable, requiresRestart, 
                    name, nameKey, desc, descKey, enumerator);
        }
    }
}
