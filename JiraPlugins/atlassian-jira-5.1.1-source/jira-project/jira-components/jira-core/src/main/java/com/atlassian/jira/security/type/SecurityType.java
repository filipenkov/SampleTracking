...
{
    Query getQuery(User searcher, GenericValue entity, String parameter);
     ...
     */
    Query getQuery(User searcher, Project project, GenericValue securityLevel, String parameter);
