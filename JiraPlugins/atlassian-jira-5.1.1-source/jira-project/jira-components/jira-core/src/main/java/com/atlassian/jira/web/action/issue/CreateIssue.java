...
public class CreateIssue extends AbstractIssueSelectAction implements Assignable, OperationContext
{
    ...
    {
        return ManagerFactory.getConstantsManager().getIssueType(getIssuetype());
    }
    ...
    protected FieldScreenRenderer getFieldScreenRenderer()
    {
        ...
        {
            fieldScreenRenderer = issueCreationHelperBean.createFieldScreenRenderer(getLoggedInUser(), getIssueObject());
        }
    ...
    {
        return getCustomFieldManager().getCustomFieldObjects(issue.getProject().getLong("id"), issue.getIssueTypeObject().getId());
    }
