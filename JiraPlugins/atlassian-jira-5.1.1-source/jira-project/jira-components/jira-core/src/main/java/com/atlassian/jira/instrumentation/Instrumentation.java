...
public class Instrumentation implements Startable
{
    ...
    {
        return getTenantedInstance().getInstrument(name);
    }

    public static AbsoluteCounter pullAbsoluteCounter(String name)
    {
        return getTenantedInstance().pullAbsoluteCounter(name);
    }
    ...
    {
        return getTenantedInstance().pullCounter(name);
    }
    ...
    {
        return getTenantedInstance().pullDerivedCounter(name);
    }
    ...
    {
        return getTenantedInstance().pullGauge(name);
    }
    ...
    {
        return getTenantedInstance().pullOpCounter(name);
    }
    ...
    {
        return getTenantedInstance().pullTimer(name);
    }
