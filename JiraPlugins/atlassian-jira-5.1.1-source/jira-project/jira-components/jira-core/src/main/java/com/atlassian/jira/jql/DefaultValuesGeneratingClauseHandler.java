...
public class DefaultValuesGeneratingClauseHandler implements ClauseHandler, ValueGeneratingClauseHandler
{
    ...
    public DefaultValuesGeneratingClauseHandler(final ClauseInformation clauseInformation, final ClauseQueryFactory factory, final ClauseValidator validator, final ClausePermissionHandler permissionHandler, final ClauseContextFactory contextFactory, final ClauseValuesGenerator valuesGenerator)
    {
