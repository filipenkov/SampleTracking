...
public class ParameterStore
{
    ...
    {
        timePeriods = Lists.newArrayList(new TextOption("-1h", i18n.getText("time.periods.hour")), new TextOption("-1d", i18n.getText("time.periods.day")), new TextOption("-1w", i18n.getText("time.periods.week")), new TextOption("-4w 2d", i18n.getText("time.periods.month")));
    }
