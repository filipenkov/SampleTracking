...
public abstract class JiraAbstractWebFragmentModuleDescriptor<T> extends DefaultAbstractWebFragmentModuleDescriptor<Void>
{
    protected final JiraAuthenticationContext authenticationContext;

    public JiraAbstractWebFragmentModuleDescriptor(final JiraAuthenticationContext authenticationContext, final AbstractWebFragmentModuleDescriptor abstractDescriptor)
    {
