...
public class ProjectsWhereUserHasRoleFunction extends AbstractUserCapabilityFunction
{
    ...
    protected List<QueryLiteral> getFunctionValuesList(final QueryCreationContext queryCreationContext, final FunctionOperand functionOperand, final User user, final String roleName)
    {
