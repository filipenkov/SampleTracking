...
public class PluginsAwareUserFormatTypeConfiguration implements UserFormatTypeConfiguration
{
    ...
    public PluginsAwareUserFormatTypeConfiguration(final JiraPropertySetFactory jiraPropertySetFactory)
    {
        this.delegate = new PropertySetBackedUserFormatTypeConfiguration(jiraPropertySetFactory);
    }
