...
import com.atlassian.jira.event.web.action.admin.LookAndFeelResetEvent;
...
public class EditLookAndFeel extends ViewApplicationProperties
{
    ...
    public EditLookAndFeel(final UserPickerSearchService searchService, final UserFormatManager userFormatManager,
            ...
            final PluginAccessor pluginAccessor, GzipCompression gzipCompression,
            FeatureManager featureManager, IntroductionProperty introduction)
    {
        super(searchService, localeManager, timeZoneManager, rendererManager, pluginAccessor, gzipCompression, featureManager, introduction);
    ...
    public String doDefault() throws Exception
    {
        ...
        useISO8601Getter = getApplicationProperties().getOption(APKeys.JIRA_DATE_TIME_PICKER_USE_ISO8601);
    ...
    public String doReset() throws Exception
    {
        ...
        getApplicationProperties().setOption(APKeys.JIRA_DATE_TIME_PICKER_USE_ISO8601, false);
        ...
        eventPublisher.publish(new LookAndFeelResetEvent());
    ...
    protected String doExecute() throws Exception
    {
        ...
        ap.setOption(APKeys.JIRA_DATE_TIME_PICKER_USE_ISO8601, useISO8601Setter);
        ...
        // Flushes the dateformat objects to use the new ones.
        ManagerFactory.getOutlookDateManager().refresh();
        eventPublisher.publish(new LookAndFeelUpdatedEvent());
    ...
    {
        this.useISO8601Setter = useISO8601;
    }
