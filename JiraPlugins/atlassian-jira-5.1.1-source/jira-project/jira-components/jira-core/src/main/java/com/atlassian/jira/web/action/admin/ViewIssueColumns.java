...
public class ViewIssueColumns extends AbstractViewIssueColumns
{
    ...
    public ViewIssueColumns(final IssueSearcherManager issueSearcherManager,
            final ApplicationProperties applicationProperties, final UserPreferencesManager userPreferencesManager,
    ...
    {
        if (getLoggedInUser() != null && getPermissionManager().hasPermission(Permissions.ADMINISTER, getLoggedInUser()))
        {
            return runOperation();
        }
        else
