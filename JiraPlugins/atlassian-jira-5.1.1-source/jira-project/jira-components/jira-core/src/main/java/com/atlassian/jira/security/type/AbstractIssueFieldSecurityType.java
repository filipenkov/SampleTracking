...
public abstract class AbstractIssueFieldSecurityType extends AbstractSecurityType
{
    ...
    protected BooleanQuery getQueryForProject(GenericValue project, User searcher)
    {
        ...
        Query userQuery = new TermQuery(new Term(getFieldName(), CaseFolding.foldUsername(searcher.getName())));
    ...
    protected BooleanQuery getQueryForSecurityLevel(GenericValue issueSecurity, User searcher)
    {
        ...
        if (searcher != null)
        {
            ...
            Term customFieldSpecifiesUser = new Term(getFieldName(), CaseFolding.foldUsername(searcher.getName()));
