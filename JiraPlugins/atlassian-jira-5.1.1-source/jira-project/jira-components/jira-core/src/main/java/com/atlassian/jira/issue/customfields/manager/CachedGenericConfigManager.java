...
@EventComponent
public class CachedGenericConfigManager implements GenericConfigManager, JiraCachedManager
{
    ...
    // ---------------------------------------------------------------------------------------------------- Constructors
    public CachedGenericConfigManager(final GenericConfigManager delegate)
    {
