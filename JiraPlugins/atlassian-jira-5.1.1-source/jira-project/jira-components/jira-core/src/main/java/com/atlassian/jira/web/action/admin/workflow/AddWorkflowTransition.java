...
public class AddWorkflowTransition extends AbstractWorkflowTransition
{
    ...
    public String getCancelUrl()
    {
        ...
        {
            return "ViewWorkflowStep.jspa?workflowName=" + URLEncoder.encode(getWorkflow().getName()) +
                   "&workflowMode=" + getWorkflow().getMode() +
                   "&workflowStep=" + getStep().getId();
        }
        else
        {
            return "ViewWorkflowSteps.jspa?workflowName=" + URLEncoder.encode(getWorkflow().getName()) +
                   "&workflowMode=" + getWorkflow().getMode();
        }
    }
    ...
    private void initialiseTransition(ActionDescriptor actionDescriptor) throws PluginParseException
    {
        ...
        {
            WorkflowFunctionModuleDescriptor functionModuleDescriptor = (WorkflowFunctionModuleDescriptor) iterator.next();
        ...
        for (Iterator iterator = functionsToAdd.entrySet().iterator(); iterator.hasNext();)
        {
