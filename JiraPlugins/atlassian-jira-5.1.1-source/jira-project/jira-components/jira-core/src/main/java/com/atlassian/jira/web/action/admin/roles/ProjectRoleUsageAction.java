...
public class ProjectRoleUsageAction extends AbstractProjectRole
{
    ...
    public List getAssociatedNotificationSchemes()
    {
        ...
        {
            associatedNotificationSchemes = new ArrayList(projectRoleService.getAssociatedNotificationSchemes(getLoggedInUser(), getRole(), this));
    ...
    public MultiMap getAssociatedWorkflows()
    {
        ...
        {
            associatedWorkflows = projectRoleService.getAssociatedWorkflows(getLoggedInUser(), getRole(), this);
        }
    ...
    public List getAssociatedPermissionSchemes()
    {
        ...
        {
            associatedPermissionSchemes = new ArrayList(projectRoleService.getAssociatedPermissionSchemes(getLoggedInUser(), getRole(), this));
    ...
    public List getAssociatedIssueSecuritySchemes()
    {
        ...
        {
            associatedIssueSecuritySchemes = new ArrayList(projectRoleService.getAssociatedIssueSecuritySchemes(getLoggedInUser(), getRole(), this));
    ...
    {
        ProjectRoleActors projectRoleActors = projectRoleService.getProjectRoleActors(getLoggedInUser(), getRole(), project, this);
