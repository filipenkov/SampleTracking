...
public class DefaultSearchService implements SearchService
{
    ...
    public MessageSet validateQuery(final User searcher, final Query query)
    {
        ...
        {
            //Validate caluse.
            final ValidatorVisitor visitor = validatorVisitorFactory.createVisitor(searcher);
    ...
    {
        final ValidatorVisitor validatorVisitor = validatorVisitorFactory.createVisitor(user);
