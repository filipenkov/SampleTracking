...
public class SystemPluginsEnabledStartupCheck implements StartupCheck
{
     ...
     */
    private final Logger log = LoggerFactory.getLogger(SystemPluginsEnabledStartupCheck.class);
    ...
    protected ImmutableList<PluginInfo> calculateDisabledSystemPlugins()
    {
        ...
        PluginMetadataManager pluginMetadataManager = (PluginMetadataManager) componentManager.getContainer().getComponentInstanceOfType(PluginMetadataManager.class);
