...
/**
 * Jelly tag that provides jelly access to {@link ProjectRoleService#isProjectRoleNameUnique(com.atlassian.crowd.embedded.api.User, String, com.atlassian.jira.util.ErrorCollection)}
 */
public class IsProjectRoleNameUnique extends ProjectRoleTagSupport
{
    ...
    public void doTag(XMLOutput xmlOutput) throws MissingAttributeException, JellyTagException
    {
        ...
        boolean isUnique = projectRoleService.isProjectRoleNameUnique(getUser(), name, errorCollection);
