...
public abstract class AbstractProjectImportProgress<V> extends JiraWebActionSupport
{
    ...
    public AbstractProjectImportProgress(final TaskManager taskManager, final OutlookDateManager outlookDateManager)
    {
    ...
    public void doValidation()
    {
        ...
        {
            ourTask = new TaskDescriptorBean<V>(descriptor, getJiraServiceContext().getI18nBean(), outlookDateManager, getLoggedInUser());
        }
    }
