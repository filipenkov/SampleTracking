...
{
    //@TODO make a more educated guess or propertise these numbers
    private final BoundedExecutor executor;
    private final IndexingStrategy strategy;

    public MultiThreadedIndexingStrategy(@NotNull final IndexingStrategy strategy, final MultiThreadedIndexingConfiguration config, String threadPrefix)
    {
