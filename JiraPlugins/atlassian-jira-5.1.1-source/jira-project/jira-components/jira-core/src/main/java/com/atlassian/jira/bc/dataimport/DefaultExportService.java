...
public class DefaultExportService implements ExportService
{
    ...
    public DefaultExportService(final DelegatorInterface genericDelegator, final EntitiesExporter entitiesExporter, I18nHelper.BeanFactory i18nFactory, final EventPublisher eventPublisher)
    {
    ...
    {
        eventPublisher.publish(new ExportStartedEvent(loggedInUser, filename));
        ...
        try
        {
            ...
            try
            {
                ...
                eventPublisher.publish(new ExportCompletedEvent(loggedInUser, filename, outcome));
                return outcome;
            }
    ...
    public ServiceOutcome<Void> exportForDevelopment(User loggedInUser, String xmlFilename, TaskProgressSink taskProgressSink)
    {
        ...
        {
            LOG.error("Error during XML backup.", e);
            return ServiceOutcomeImpl.error(i18n.getText("admin.errors.export.ioerror", xmlFilename));
        }
        finally
        {
    ...
    protected ZipArchiveOutputStream getZipOutputStream(final String filename) throws IOException
    {
        ...
        return new ZipArchiveOutputStream(FileUtils.openOutputStream(new File(zipFileName)));
    }
