 ...
 * All rights reserved.
 */
public class ReporterSystemField extends AbstractOrderableNavigableFieldImpl implements HideableField, RequirableField, UserField, RestAwareField, RestFieldOperations
{
    ...
    {
        super(IssueFieldConstants.REPORTER, REPORTER_NAME_KEY, templatingEngine, applicationProperties, authenticationContext, permissionManager, reporterSearchHandlerFactory);
    ...
    {
        return new FieldJsonRepresentation(new JsonData(UserJsonBean.shortBean(issue.getReporter(), jiraBaseUrls)));
    }
    ...
    public JsonData getJsonDefaultValue(IssueContext issueCtx)
    {
        ...
        return new JsonData(UserJsonBean.shortBean(user, jiraBaseUrls));
    }
}
