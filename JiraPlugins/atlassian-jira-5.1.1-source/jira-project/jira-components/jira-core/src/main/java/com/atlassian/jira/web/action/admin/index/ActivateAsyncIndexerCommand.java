...
class ActivateAsyncIndexerCommand extends AbstractAsyncIndexerCommand
{
    ...
    public ActivateAsyncIndexerCommand(final boolean deactivateIndexFirst, final JohnsonEventContainer eventCont, final IndexLifecycleManager indexManager, final Logger log, final I18nHelper i18nHelper)
    {
