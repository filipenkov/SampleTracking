...
public class BulkWorkflowTransition extends AbstractBulkOperationDetailsAction
{
    ...
    public BulkWorkflowTransition(SearchService searchService, IssueWorkflowManager issueWorkflowManager, WorkflowManager workflowManager, IssueManager issueManager,
            ...
            BulkWorkflowTransitionOperation bulkWorkflowTransitionOperation, PermissionManager permissionManager, ConstantsManager constantsManager)
    {
        super(searchService);
    ...
    public String doPerform() throws Exception
    {
        ...
        getBulkWorkflowTransitionOperation().perform(getBulkEditBean(), getLoggedInUser());
    ...
    private void validationPerform()
    {
        ...
        if (!getBulkWorkflowTransitionOperation().canPerform(getBulkEditBean(), getLoggedInUser()))
        {
    ...
    {
        return getBulkWorkflowTransitionOperation().canPerform(getBulkEditBean(), getLoggedInUser());
    }
    ...
    private void setWorkflowTransitionMap() throws WorkflowException
    {
        if (getBulkEditBean().getWorkflowTransitionMap() == null || getBulkEditBean().getWorkflowTransitionMap().isEmpty())
        {
            ...
            for (Iterator iterator = selectedIssues.iterator(); iterator.hasNext();)
            {
                ...
                final Collection<ActionDescriptor> availableActions = issueWorkflowManager.getAvailableActions(issue);
    ...
    {
        GenericValue originStatusGV = getOriginStatus(workflowTransitionKey);
    ...
    {
        GenericValue destinationStatusGV = getDestinationStatus(workflowTransitionKey);

        return constantsManager.getStatusObject(destinationStatusGV != null ? destinationStatusGV.getString("id") : null);
    }
