...
class ForkedThreadExecutor extends AbstractExecutorService
{
    ...
    ForkedThreadExecutor(final int maxThreads, @NotNull final ThreadFactory threadFactory)
    {
    ...
    public synchronized boolean awaitTermination(long length, @NotNull final TimeUnit timeUnit) throws InterruptedException
    {
