        ...
        implements HideableField, RequirableField, NavigableField, RestAwareField, RestFieldOperations
{
    ...
    protected Object getRelevantParams(Map inputParameters)
    {
        ...
        builder.setCreateIssue(asArray(inputParameters, PARAMS_ISCREATEISSUE));
        builder.setLinkDescription(asArray(inputParameters, PARAMS_LINK_TYPE));
        builder.setLinkedIssues(asArray(inputParameters, PARAMS_ISSUE_KEYS));
