...
public class DefaultRepositoryManager implements RepositoryManager
{
    ...
    public DefaultRepositoryManager(AssociationManager associationManager, OfBizDelegator ofBizDelegator,
            ServiceManager serviceManager, PermissionManager permissionManager,
            ChangeHistoryManager changeHistoryManager, ProjectManager projectManager) throws GenericEntityException
    {
