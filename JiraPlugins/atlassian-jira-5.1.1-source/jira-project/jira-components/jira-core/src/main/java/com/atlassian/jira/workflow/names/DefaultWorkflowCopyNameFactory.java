...
public class DefaultWorkflowCopyNameFactory implements WorkflowCopyNameFactory
{
    ...
    {
        checkNotNull(locale, "Can not generate a name for a workflow copy for a 'null' Locale");
        int i = 1;
        do
        {
    ...
    private static class PrefixCopyOf
    {
        ...
        {
            return i18n.getInstance(locale).getText("admin.workflows.copy.name", new Object[] { number, source });
        }
    }
