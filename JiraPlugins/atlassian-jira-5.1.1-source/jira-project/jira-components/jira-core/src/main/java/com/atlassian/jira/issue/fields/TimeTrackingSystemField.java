...
public class TimeTrackingSystemField extends AbstractOrderableField implements HideableField, RequirableField, RestAwareField, RestFieldOperations
{
    ...
    protected Object getRelevantParams(Map inputParameters)
    {
        ...
        else
        {
            ...
            final Object targetField = inputParameters.get(TIMETRACKING_TARGETSUBFIELD);
            final String targetSubField = (targetField == null) ? null : fromArray((String[]) targetField);
