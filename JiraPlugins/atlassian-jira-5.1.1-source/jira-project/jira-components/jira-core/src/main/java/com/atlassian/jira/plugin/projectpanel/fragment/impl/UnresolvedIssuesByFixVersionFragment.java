...
public class UnresolvedIssuesByFixVersionFragment extends AbstractUnresolvedIssuesFragment implements ProjectTabPanelFragment
{
    ...
    public UnresolvedIssuesByFixVersionFragment(final VelocityTemplatingEngine templatingEngine,
    ...
    protected Map<String, Object> createVelocityParams(final BrowseContext ctx)
    {
        ...
        velocityParams.put("urlUtil", new FixVersionUrlUtil(getSearchRequest(ctx), authenticationContext.getLoggedInUser(), applicationProperties));
