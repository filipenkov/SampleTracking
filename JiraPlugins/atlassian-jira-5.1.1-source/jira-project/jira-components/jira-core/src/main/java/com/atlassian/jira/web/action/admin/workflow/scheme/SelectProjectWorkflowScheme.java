...
public class SelectProjectWorkflowScheme extends AbstractSelectProjectScheme
{
    ...
    {
        currentActivateTask = new TaskDescriptorBean(taskDescriptor, authenticationContext.getI18nHelper(), outlookDateManager, authenticationContext.getLoggedInUser());
    }
