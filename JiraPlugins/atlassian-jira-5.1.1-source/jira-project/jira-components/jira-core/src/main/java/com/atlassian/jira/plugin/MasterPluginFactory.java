...
class MasterPluginFactory implements PluginFactory
{
    ...
    public MasterPluginFactory(final List<PluginFactory> pluginFactories, final List<Pattern> pluginWhitelist)
    {
    ...
    {
        log.info("Seen plugin artifact '" + pluginArtifact.getName() + "'");
            ...
            throws PluginParseException
    {
        ...
        return pluginFactory.create(pluginArtifact, moduleDescriptorFactory);
    }
