...
public class DefaultResolutionManager extends AbstractIssueConstantsManager<Resolution> implements ResolutionManager
{
    ...
    public DefaultResolutionManager(final ConstantsManager constantsManager, TranslationManager translationManager, JiraAuthenticationContext jiraAuthenticationContext, IssueIndexManager issueIndexManager, OfBizDelegator ofBizDelegator, ApplicationProperties applicationProperties)
    {
    ...
    @Override
    public synchronized Resolution createResolution(final String name, final String description)
    {
        ...
        try
        {
            ...
            return new ResolutionImpl(resolutionGenericValue, translationManager, jiraAuthenticationContext);
        }
