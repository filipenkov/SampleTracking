...
{
    private final List<ListenerHandler> handlers = ImmutableList.of(new AnnotatedMethodsListenerHandler(PluginEventListener.class),
        new AnnotatedMethodsListenerHandler(), new IssueEventListenerHandler(), new UserEventListenerHandler());
