...
class CreatedVsResolvedChart
{
            ...
            throws IOException, SearchException
    {
        ...
        Collector hitCollector = new OneDimensionalObjectHitCollector(createdMapper, result, issueIndexManager.getIssueSearcher().getIndexReader(), true);
            ...
            throws IOException, SearchException
    {
        ...
        Collector hitCollector = new OneDimensionalObjectHitCollector(resolvedMapper, data, issueIndexManager.getIssueSearcher().getIndexReader(), true);
        searchProvider.search(query, remoteUser, hitCollector);
        return data;
    }
