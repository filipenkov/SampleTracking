...
public class DefaultWatcherService implements WatcherService
{
            ...
            throws WatchingDisabledException
    {
        try
        {
            ...
            if (!canView)
            {
                return ServiceOutcomeImpl.error(buildAddWatcherCannotViewString(issue, remoteUser, watcher));
            }
     ...
     * @return a String containing an error message
     */
    private String buildAddWatcherCannotViewString(Issue issue, User remoteUser, User watcher)
    {
