...
public class AttachTemporaryFile extends AbstractIssueSelectAction
{
    ...
    protected String doExecute() throws Exception
    {
        try
        {
            if (isCreate())
            {
                this.temporaryAttachment = webAttachmentManager.createTemporaryAttachment(getMultipart(), TEMP_FILENAME, null, getProjectObject());
            }
            else
            {
                this.temporaryAttachment = webAttachmentManager.createTemporaryAttachment(getMultipart(), TEMP_FILENAME, getIssueObject(), null);
            }
        }
