...
public class BulkMove extends AbstractBulkOperationDetailsAction
{
    ...
    public String doPerform() throws Exception
    {
        ...
        try
        {
            ...
            if (!getBulkMoveOperation().canPerform(getRootBulkEditBean(), getLoggedInUser()))
            {
        ...
        try
        {
            getBulkMoveOperation().perform(getRootBulkEditBean(), getLoggedInUser());
        }
        catch (Exception e)
        {
...
//        return getResult();
    ...
    {
        return getBulkMoveOperation().canPerform(getBulkEditBean(), getLoggedInUser());
    }
    ...
    public String doContextValidation() throws Exception
    {
        ...
        getBulkMoveOperation().chooseContext(getBulkEditBean(), getLoggedInUser(), this, this);
