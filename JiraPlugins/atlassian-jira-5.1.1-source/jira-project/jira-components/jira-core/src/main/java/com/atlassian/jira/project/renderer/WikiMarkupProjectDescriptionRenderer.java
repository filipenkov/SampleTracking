...
public class WikiMarkupProjectDescriptionRenderer implements ProjectDescriptionRenderer
{
    ...
    {
        return getRenderer().render(project.getDescription(), null);
    }
    ...
    public String getEditHtml(@Nonnull final Project project)
    {
        ...
        return rendererDescriptor.getEditVM(project.getDescription(), null, AtlassianWikiRenderer.RENDERER_TYPE, PROJECT_DESCRIPTION_FIELD_ID, PROJECT_DESCRIPTION_FIELD_NAME, renderParams, NO_SINGLE_LINE);
    }
