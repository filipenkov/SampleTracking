...
public class IntroductionPropertyImpl implements IntroductionProperty
{
    ...
    private class IntroductionDescriptions implements PropertyDescriptions
    {
        ...
        {
            return i18nFactory.getInstance(authenticationContext.getLoggedInUser()).getText("admin.generalconfiguration.introduction.description", "<br/>");
        }

        @Override
        public String getOnDemandDescriptionHtml()
        {
            return i18nFactory.getInstance(authenticationContext.getLoggedInUser()).getText("admin.generalconfiguration.introduction.wiki.description", "<br/>");
        }
    }
}
