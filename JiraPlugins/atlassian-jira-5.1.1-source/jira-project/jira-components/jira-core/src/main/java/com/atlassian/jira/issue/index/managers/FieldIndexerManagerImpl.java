...
public class FieldIndexerManagerImpl implements FieldIndexerManager
{
    ...
    private final ResettableLazyReference<Collection<FieldIndexer>> allIssueIndexers = new ResettableLazyReference<Collection<FieldIndexer>>()
    {
        @Override
        protected Collection<FieldIndexer> create() throws Exception
        {
            return init();
        }
    };
    ...
    {
        final Collection<FieldIndexer> answer = new ArrayList<FieldIndexer>();
