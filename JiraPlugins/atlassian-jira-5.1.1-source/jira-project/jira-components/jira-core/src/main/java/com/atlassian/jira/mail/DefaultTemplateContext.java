...
public class DefaultTemplateContext implements TemplateContext
{
    ...
    public DefaultTemplateContext(Locale locale, WebResourceManager resourceManager, ApplicationProperties applicationProperties, I18nHelper.BeanFactory beanFactory)
    {
        this.locale = locale;
    ...
    public Map<String, Object> getTemplateParams()
    {
        ...
        {
            jiraLogo = resourceManager.getStaticResourcePrefix(UrlMode.ABSOLUTE) + jiraLogo;
        }
