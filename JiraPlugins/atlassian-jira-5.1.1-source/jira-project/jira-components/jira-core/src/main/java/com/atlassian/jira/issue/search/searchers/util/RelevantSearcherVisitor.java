...
public class RelevantSearcherVisitor implements ClauseVisitor<Boolean>
{
    ...
    public RelevantSearcherVisitor(final SearchHandlerManager searchHandlerManager, final User user, final SearchContext searchContext)
    {
    ...
    {
        final Collection<IssueSearcher<?>> searchersByClauseName = searchHandlerManager.getSearchersByClauseName(user, clause.getName(), searchContext);
