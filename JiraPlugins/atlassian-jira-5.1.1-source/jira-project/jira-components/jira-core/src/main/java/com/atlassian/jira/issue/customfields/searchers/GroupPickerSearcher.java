        ...
        implements CustomFieldSearcher, SortableCustomFieldSearcher, CustomFieldStattable
{
    ...
    public void init(CustomField field)
    {
        ...
        this.searchInputTransformer = new GroupCustomFieldSearchInputTransformer(field, clauseNames, searcherInformation.getId(), groupConverter, customFieldInputHelper);
