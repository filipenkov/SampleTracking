...
public class DeleteFilter extends SearchDescriptionEnabledAction
{
    ...
    public int getOtherFavouriteCount()
    {
        if (otherFavouriteCount == null)
        {
            ...
            final boolean isFavourite = favouriteService.isFavourite(getLoggedInUser(), request);
    ...
    public Collection getSubscriptions()
    {
        ...
        {
            subscriptions = subscriptionService.getVisibleSubscriptions(getLoggedInUser(), getFilter());
        }
