...
public interface IssueTabPanelInvoker
{
     ...
     */
    ShowPanelReply invokeShowPanel(ShowPanelRequest request, IssueTabPanelModuleDescriptor descriptor);
     ...
     */
    GetActionsReply invokeGetActions(GetActionsRequest request, IssueTabPanelModuleDescriptor descriptor);
}
