...
public class DefaultRemoteIssueLinkService implements RemoteIssueLinkService
{
    ...
    private void validatePermissionToView(final User user, final RemoteIssueLink remoteIssueLink, final ErrorCollection errors, final I18nHelper i18n)
    {
        final IssueService.IssueResult result = issueService.getIssue(user, remoteIssueLink.getIssueId());
        if (result.isValid())
        {
    ...
    private void validatePermissionToView(final User user, final Issue issue, final ErrorCollection errors, final I18nHelper i18n)
    {
        validatePermissionToViewIssue(user, issue, errors, i18n);
    }

    private void validatePermissionToCreate(final User user, final Issue issue, final ErrorCollection errors, final I18nHelper i18n)
    {
        hasLinkIssuePermission(user, issue, errors, i18n);
    }

    private void validatePermissionToUpdate(final User user, final Issue issue, final ErrorCollection errors, final I18nHelper i18n)
    {
        hasLinkIssuePermission(user, issue, errors, i18n);
    }

    private void validatePermissionToDelete(final User user, final RemoteIssueLink remoteIssueLink, final ErrorCollection errors, final I18nHelper i18n)
    {
        final IssueService.IssueResult result = issueService.getIssue(user, remoteIssueLink.getIssueId());
        if (result.isValid())
        {
    ...
    private void validatePermissionToViewIssue(final User user, final Issue issue, final ErrorCollection errors, final I18nHelper i18n)
    {
    ...
    private void hasLinkIssuePermission(final User user, final Issue issue, final ErrorCollection errors, final I18nHelper i18n)
    {
    ...
    private void handleRemoveException(final I18nHelper i18n, final ErrorCollection errors, final RemoveException removeException)
    {
        errors.addErrorMessage(i18n.getText("remotelink.service.error.removing", removeException.getMessage()), Reason.SERVER_ERROR);
    }
