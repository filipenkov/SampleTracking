 ...
 * {@link ProjectRoleService#createProjectRole(com.atlassian.crowd.embedded.api.User, com.atlassian.jira.security.roles.ProjectRole, com.atlassian.jira.util.ErrorCollection)} .
 */
public class CreateProjectRole  extends ProjectRoleTagSupport
{
    ...
    public void doTag(XMLOutput xmlOutput) throws MissingAttributeException, JellyTagException
    {
        ...
        projectRole = projectRoleService.createProjectRole(getUser(), projectRole, errorCollection);
