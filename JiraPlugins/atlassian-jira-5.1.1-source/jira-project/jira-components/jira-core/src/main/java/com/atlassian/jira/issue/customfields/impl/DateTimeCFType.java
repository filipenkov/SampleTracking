        ...
        implements SortableCustomField<Date>, ProjectImportableCustomField, DateField, RestAwareCustomFieldType, RestCustomFieldTypeOperations
{
    ...
    @Override
    protected Date getObjectFromDbValue(@NotNull final Object databaseValue) throws FieldValidationException
    {
    ...
    public int compare(@NotNull final Date v1, @NotNull final Date v2, final FieldConfig fieldConfig)
    {
