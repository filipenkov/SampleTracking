...
public class MentionEventListener
{
    ...
    {
        this.notificationSchemeManager = checkNotNull(notificationSchemeManager, "notificationSchemeManager");
        this.mentionService = checkNotNull(mentionService, "mentionService");
    }
