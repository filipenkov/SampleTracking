...
public class BulkOnlyIndexManager extends DefaultIndexManager
{
    ...
    public BulkOnlyIndexManager(final IndexingConfiguration properties, final IssueIndexer issueIndexer, final IndexPathManager indexPathManager,
            final ReindexMessageManager reindexMessageManager, final EventPublisher eventPublisher, ListenerManager listenerManager, ProjectManager projectManager)
    {
        super(properties, issueIndexer, indexPathManager, reindexMessageManager, eventPublisher, listenerManager, projectManager);
    }
