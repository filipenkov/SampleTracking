...
public class WebSudoAuthenticate extends JiraWebActionSupport
{
    ...
    public String getCancelUrl()
    {
        ...
        if (StringUtils.isNotBlank(projectKey))
        {
            ...
            {
                url.append("/secure/AdminSummary.jspa");
            }
        }
        else
        {
    ...
    public String getWebSudoDestination()
    {
        ...
        {
            return "/secure/admin/AdminSummary.jspa";
        }
    }

    public void setWebSudoDestination(String destination)
    {
        String safeReturnUrl = destination != null ? getUriValidator().getSafeUri(JiraUrl.constructBaseUrl(request), destination) : null;
        if (safeReturnUrl == null || getRedirectChecker().canRedirectTo(safeReturnUrl))
        {
            this.destination = safeReturnUrl;
        }
    }
