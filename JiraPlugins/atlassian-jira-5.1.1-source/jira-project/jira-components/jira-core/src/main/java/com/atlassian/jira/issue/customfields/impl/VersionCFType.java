...
public class VersionCFType extends AbstractMultiCFType<Version> implements RequiresProjectSelectedMarker, SortableCustomField, ProjectImportableCustomField, RestAwareCustomFieldType, RestCustomFieldTypeOperations
{
    ...
    {
        final LongIdsValueHolder versionIds = new LongIdsValueHolder(relevantParams.getAllValues());
    ...
    public int compare(@NotNull final Object customFieldObjectValue1, @NotNull final Object customFieldObjectValue2, final FieldConfig fieldConfig)
    {
    ...
    public FieldTypeInfo getFieldTypeInfo(FieldTypeInfoContext fieldTypeInfoContext)
    {
        ...
        return new FieldTypeInfo(Collections.singletonList(VersionJsonBean.shortBeans(projects, jiraBaseUrls)), null);
    }
