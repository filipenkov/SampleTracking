...
public interface UserHistoryStore
{
     ...
     */
    void addHistoryItem(@Nullable ApplicationUser user, @NotNull UserHistoryItem historyItem);
     ...
     */
    @NotNull
    List<UserHistoryItem> getHistory(@NotNull UserHistoryItem.Type type, @NotNull ApplicationUser user);
     ...
     */
    Set<UserHistoryItem.Type> removeHistoryForUser(@NotNull ApplicationUser user);
}
