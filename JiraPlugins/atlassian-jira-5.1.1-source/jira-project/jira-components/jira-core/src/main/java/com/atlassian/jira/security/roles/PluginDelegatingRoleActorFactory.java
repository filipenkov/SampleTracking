...
public class PluginDelegatingRoleActorFactory implements RoleActorFactory
{
    ...
    {
        for (Iterator it = getImplementations().values().iterator(); it.hasNext();)
        {
            final ProjectRoleActorModuleDescriptor moduleDescriptor = (ProjectRoleActorModuleDescriptor) it.next();
