 ...
 * {@link Index.Manager#getSearcher()} contains a particular {@link Operation}
...
public interface Index
{
     ...
     */
    @NotNull
    Result perform(@NotNull Operation operation);
    ...
    public abstract class Operation
    {
        ...
        abstract void perform(@NotNull Writer writer) throws IOException;
