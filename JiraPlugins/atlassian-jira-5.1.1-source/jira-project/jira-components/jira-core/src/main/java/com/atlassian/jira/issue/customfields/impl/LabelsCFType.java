        ...
        implements SortableCustomField<Set<Label>>, ProjectImportableCustomFieldParser, ProjectImportableCustomField, RestAwareCustomFieldType, RestCustomFieldTypeOperations
{
    ...
    @Override
    public void createValue(final CustomField field, final Issue issue, final Set<Label> value)
    {
    ...
    @Override
    public int compare(@NotNull final Set<Label> customFieldObjectValue1, @NotNull final Set<Label> customFieldObjectValue2, final FieldConfig fieldConfig)
    {
