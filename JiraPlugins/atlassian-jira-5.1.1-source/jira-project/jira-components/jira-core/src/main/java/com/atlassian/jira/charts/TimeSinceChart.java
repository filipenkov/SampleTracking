...
class TimeSinceChart
{
            ...
            final ChartFactory.PeriodName periodName, int width, int height, boolean cumulative, final String dateFieldId)
    {
        ...
        try
        {
            ...
            final Collector hitCollector = new GenericDateFieldIssuesHitCollector(matchingIssues, issueIndexManager.getIssueSearcher(), timePeriodClass, dateFieldId, chartTimeZone);
