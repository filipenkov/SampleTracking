...
public class DefaultCommentService implements CommentService
{
    ...
    protected boolean hasVisibility(JiraServiceContext jiraServiceContext, Comment comment)
    {
        ...
        final User user = jiraServiceContext.getLoggedInUser();
    ...
    public void delete(JiraServiceContext jiraServiceContext, Comment comment, boolean dispatchEvent)
    {
        ...
        if (hasPermissionToDelete(jiraServiceContext, comment.getId()))
        {
            ...
            doUpdateWithChangelog(EventType.ISSUE_UPDATED_ID, EasyList.build(changeItem), comment.getIssue(), jiraServiceContext.getLoggedInUser(), dispatchEvent);
        }
     ...
     */
    protected void doUpdateWithChangelog(Long eventTypeId, List<ChangeItemBean> changeItems, Issue issue, User user, boolean dispatchEvent)
    {
