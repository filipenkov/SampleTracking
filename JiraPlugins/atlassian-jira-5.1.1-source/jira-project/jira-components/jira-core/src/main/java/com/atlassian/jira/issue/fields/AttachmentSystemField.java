...
public class AttachmentSystemField extends AbstractOrderableField implements HideableField, RestAwareField
{
    ...
    public AttachmentSystemField(VelocityTemplatingEngine templatingEngine, ApplicationProperties applicationProperties, AttachmentManager attachmentManager,
            JiraAuthenticationContext authenticationContext, PermissionManager permissionManager, final TemporaryAttachmentsMonitorLocator temporaryAttachmentsMonitorLocator, JiraBaseUrls jiraBaseUrls, ThumbnailManager thumbnailManager, DateTimeFormatterFactory dateTimeFormatterFactory)
    {
    ...
    public boolean isShown(Issue issue)
    {
        ...
        boolean hasCreateAttachmentPermission = permissionManager.hasPermission(Permissions.CREATE_ATTACHMENT, entity, getAuthenticationContext().getLoggedInUser(), !issue.isCreated());
    ...
    public FieldJsonRepresentation getJsonFromIssue(Issue issue, boolean renderedVersionRequired, FieldLayoutItem fieldLayoutItem)
    {
        ...
        FieldJsonRepresentation fieldJsonRepresentation = new FieldJsonRepresentation(new JsonData(AttachmentJsonBean.shortBeans(comments, jiraBaseUrls, thumbnailManager)));
        if (renderedVersionRequired)
        {
            fieldJsonRepresentation.setRenderedData(new JsonData(AttachmentRenderedJsonBean.shortBeans(comments, jiraBaseUrls, thumbnailManager, dateTimeFormatterFactory)));
        }
