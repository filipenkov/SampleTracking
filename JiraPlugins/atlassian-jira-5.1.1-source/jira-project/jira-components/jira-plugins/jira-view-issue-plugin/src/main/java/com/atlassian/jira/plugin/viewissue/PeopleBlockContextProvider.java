...
public class PeopleBlockContextProvider implements CacheableContextProvider
{
    ...
    public String getAssigneeDisplayHtml(Issue issue)
    {
        ...
        try
        {
            ...
            if (assignee != null)
            {
                return userFormatManager.formatUser(assignee.getName(), "fullNameHover", "issue_summary_assignee");
            }
        }
    ...
    public String getReporterDisplayHtml(Issue issue)
    {
        ...
        try
        {
            ...
            if (reporter != null)
            {
                return userFormatManager.formatUser(reporter.getName(), "fullNameHover", "issue_summary_reporter");
            }
        }
        catch (DataAccessException e)
        {
