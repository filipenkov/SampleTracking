...
public class ActivityBlockViewIssueContextProvider implements CacheableContextProvider
{
    ...
    public Map<String, Object> getContextMap(Map<String, Object> context)
    {
        ...
        GetActionsRequest getActionsRequest = new GetActionsRequest(issue, user, isAsynchronous);
        GetActionsReply getActionsReply = issueTabPanelInvoker.invokeGetActions(getActionsRequest, currentTabPanelModuleDescriptor);

        final List<IssueAction> actions = Lists.newArrayList(getActionsReply.actions());
    ...
    private ArrayList<IssueTabPanelModuleDescriptor> getTabPanels(Issue issue, User user)
    {
        ...
        {
            if (issueTabPanelInvoker.invokeShowPanel(new ShowPanelRequest(issue, user), descriptor).isShow())
            {
