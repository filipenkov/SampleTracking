...
public class DateBlockContextProvider implements CacheableContextProvider
{
    ...
    private List<DateBlockField> getDateCustomFields(Issue issue, Action action)
    {
        ...
        for (FieldScreenRenderLayoutItem renderItem : dateRenderItems)
        {
            ...
            customfields.add(new DateBlockField(customField.getId() + "-val", customField.getName(), null, displayHtml, null, null, fieldType));
        }
    ...
    class DateField extends DateBlockField
    {
        ...
        {
            super(id, getI18nText(key), null, formatDate(date), formatDateIso8601(date), formatDate(date), null);
        }
    }
    ...
    class DateTimeField extends DateBlockField
    {
        ...
        {
            super(id, getI18nText(key), "user-tz", formatDateTime(dateTime), formatDateTimeIso8601(dateTime), formatDateTimeTitle(dateTime), null);
        }
    }
