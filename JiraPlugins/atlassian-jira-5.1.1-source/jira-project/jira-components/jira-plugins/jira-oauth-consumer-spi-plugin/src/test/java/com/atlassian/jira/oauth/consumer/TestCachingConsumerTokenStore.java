...
public class TestCachingConsumerTokenStore extends TestCase
{
    ...
    public void testGet()
    {
        ...
        CachingConsumerTokenStore store = new CachingConsumerTokenStore(delegateStore);
    ...
    public void testPut()
    {
        ...
        //now try to get the token a couple of times.  Shouldn't hit the cache at all
    ...
    public void testRemove()
    {
        ...
        expect(delegateStore.get(new ConsumerTokenStore.Key("mytoken"))).andReturn(null).times(2);
