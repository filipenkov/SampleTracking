...
public class JiraRemoteIssueLinkDecoratingServiceImpl implements JiraRemoteIssueLinkDecoratingService
{
    ...
    public JiraRemoteIssueLinkDecoratingServiceImpl(final RemoteJiraRestService remoteJiraRestService,
            final RemoteJiraGlobalIdFactoryImpl remoteJiraGlobalIdFactory, final JiraAuthenticationContext authContext)
    {
