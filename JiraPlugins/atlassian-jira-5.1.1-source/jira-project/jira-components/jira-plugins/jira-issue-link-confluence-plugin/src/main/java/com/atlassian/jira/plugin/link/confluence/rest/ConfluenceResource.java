...
public class ConfluenceResource
{
    ...
    public ConfluenceResource(final ConfluenceRpcService confluenceRpcService, final ApplicationLinkService applicationLinkService, final I18nHelper.BeanFactory beanFactory, final JiraAuthenticationContext jiraAuthenticationContext)
    {
