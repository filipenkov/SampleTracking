...
public class ConfluenceIssueLinkDecoratingServiceImpl implements ConfluenceIssueLinkDecoratingService
{
    ...
    public ConfluenceIssueLinkDecoratingServiceImpl(final ConfluenceRpcService confluenceRpcService, final ConfluenceGlobalIdFactory confluenceGlobalIdFactory)
    {
            ...
            throws ResponseException, CredentialsRequiredException, PermissionException
    {
        ...
        return new RemoteIssueLinkBuilder(remoteIssueLink)
                .url(BaseUrlSwapper.swapRpcUrlToDisplayUrl(confluencePage.getUrl(), appLink))
