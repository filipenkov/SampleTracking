...
public class AttachTemporaryFileResource
{
    ...
    public AttachTemporaryFileResource(JiraAuthenticationContext authContext,
            ...
            XsrfInvocationChecker xsrfChecker, XsrfTokenGenerator xsrfGenerator, AttachmentHelper attachmentHelper)
    {
            ...
            @QueryParam("size") Long size, @Context HttpServletRequest request)
    {
        ...
        {
            if (validationResult.getErrorType() == AttachmentHelper.ValidationError.FILENAME_BLANK)
            {
            ...
            else if (validationResult.getErrorType() == AttachmentHelper.ValidationError.ATTACHMENT_IO_UNKNOWN)
            {
