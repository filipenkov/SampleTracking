...
public class PriorityBean
{
    ...
    static
    {
        ...
        priority.setIconUrl(Examples.jiraURI("images/icons/priority_major.gif").toString());
        ...
        priority.setIconUrl(Examples.jiraURI("images/icons/priority_trivial.gif").toString());
