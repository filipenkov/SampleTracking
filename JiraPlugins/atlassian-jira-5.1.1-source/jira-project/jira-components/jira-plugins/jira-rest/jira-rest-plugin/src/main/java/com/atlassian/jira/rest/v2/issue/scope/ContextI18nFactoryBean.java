...
public class ContextI18nFactoryBean extends AbstractFactoryBean
{
    ...
    static class I18nWrapper implements ContextI18n
    {
        ...
        @Override
        public String getUntransformedRawText(String key) { return i18n.getUntransformedRawText(key); }

        @Override
        public boolean isKeyDefined(String key) { return i18n.isKeyDefined(key); }
