...
public class AvatarResourceHelper
{
     ...
     */
    public Response getAllAvatars(final Avatar.Type type, final String ownerId, Long selectedAvatarId)
    {
        ...
        final List<AvatarBean> systemAvatarBeans = AvatarBeanFactory.createAvatarBeans(avatarManager.getAllSystemAvatars(type));
        setSelectedAvatar(selectedAvatarId, systemAvatarBeans);
        avatars.put("system", systemAvatarBeans);

        final List<AvatarBean> customAvatarBeans = AvatarBeanFactory.createAvatarBeans(avatarManager.getCustomAvatarsForOwner(type, ownerId));
