...
public class IssueAttachmentsResource
{
    ...
    public IssueAttachmentsResource(JiraAuthenticationContext authContext, IssueManager issueManager, AttachmentService attachmentService, AttachmentManager attachmentManager, IssueUpdater issueUpdater, ContextI18n i18n, IssueFinder issueFinder, JiraBaseUrls jiraBaseUrls, ThumbnailManager thumbnailManager)
    {
    ...
    public Response addAttachment(@PathParam ("issueIdOrKey") String issueIdOrKey, @MultipartFormParam ("file") Collection<FilePart> fileParts)
    {
        ...
        try
        {
            ...
            Collection<AttachmentJsonBean> jsonBeans = AttachmentJsonBean.shortBeans(attachments, jiraBaseUrls, thumbnailManager);
