...
public class AttachmentResource
{
    ...
    public AttachmentResource(final AttachmentService attachmentService, final AttachmentManager attachmentManager, final PermissionManager permissionManager, final JiraAuthenticationContext authContext, BeanBuilderFactory beanBuilderFactory, ContextI18n i18n, ContextUriInfo uriInfo)
    {
    ...
    public Response getAttachment(@PathParam ("id") final String id)
    {
        ...
        try
        {
            ...
            AttachmentBean bean = beanBuilderFactory.newAttachmentBeanBuilder(attachment).context(uriInfo).build();
    ...
    protected boolean hasPermissionToViewAttachment(User user, Attachment attachment) throws DataAccessException
    {
        ...
        if (user == null)
        {
            return permissionManager.hasPermission(Permissions.BROWSE, issue, null);
        }
