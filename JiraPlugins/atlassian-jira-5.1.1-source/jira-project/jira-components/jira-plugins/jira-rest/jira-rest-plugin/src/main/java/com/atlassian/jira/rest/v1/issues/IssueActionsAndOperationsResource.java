...
public class IssueActionsAndOperationsResource
{
    ...
    public IssueActionsAndOperationsResource(
            ...
            final ContextI18n i18n, final WorkflowManager workflowManager,
    ...
    {
        Collection<ActionDescriptor> availableActions = issueWorkflowManager.getAvailableActions(getIssue());
