...
public class EditMetaFieldBeanBuilder extends AbstractMetaFieldBeanBuilder
{
    ...
    protected void addAdditionalFields(Map<String, FieldMetaBean> fields)
    {
        ...
        if (field.isShown(issue))
        {
            ...
            {
                FieldMetaBean fieldMetaBean = getFieldMetaBean(false, field, false);
