...
-->
                ...
                <xsl:variable name="name">
                    ...
                    <xsl:choose>
                        <xsl:when test="string-length($context)">
                            <xsl:value-of select="$rest-uri-prefix"/>/<xsl:value-of select="$context"/>/<xsl:call-template name="trimSlashes"><xsl:with-param select="@path" name="path"/></xsl:call-template>
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:value-of select="$rest-uri-prefix"/>/<xsl:call-template name="trimSlashes"><xsl:with-param select="@path" name="path"/></xsl:call-template>
                        </xsl:otherwise>
                    </xsl:choose>
                ...
                <div class="resource">
                    ...
                    <div class="methods">
                        <xsl:apply-templates select="wadl:method">
                            <xsl:with-param name="parent-name"><xsl:value-of select="$name"/></xsl:with-param>
                        </xsl:apply-templates>
                    </div>
                </div>
                <xsl:apply-templates select="wadl:resource" mode="list">
    ...
    <xsl:template match="wadl:method">
        <xsl:param name="parent-name"></xsl:param>
        <div class="method">
