...
public class StatusResource
{
    ...
    public StatusResource(JiraAuthenticationContext authContext, ConstantsService constantsService, JiraBaseUrls jiraBaseUrls, ResourceUriBuilder uriBuilder)
    {
    ...
    public Response getStatuses(@Context Request request, @Context UriInfo uriInfo)
    {
        ...
        {
            final StatusJsonBean statusBean = createStatusBean(status, uriInfo);
    ...
    private StatusJsonBean createStatusBean(Status status, UriInfo uriInfo)
    {
        ...
        return StatusJsonBean.bean(
                ...
                uriBuilder.build(uriInfo, StatusResource.class, status.getId()).toString(),
                absoluteIconUrl,
