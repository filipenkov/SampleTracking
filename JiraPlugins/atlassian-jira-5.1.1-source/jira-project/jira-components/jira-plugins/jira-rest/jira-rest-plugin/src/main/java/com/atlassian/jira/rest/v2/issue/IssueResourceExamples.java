...
public class IssueResourceExamples
{
    ...
    public static final IssueCreateResponse CREATE_RESPONSE_200 = new IssueCreateResponse()
            .id("10000")
            .key("TST-24")
...
//            .logWork(new LogWork().started("05/Jul/11 11:05 AM").timeSpent("1h"))
    ...
    static
    {
        ...
        fields.put("issuetype", new FieldMetaBean(true, null, "Issue Type", null, Lists.newArrayList(StandardOperation.SET.getName()), null));
        ...
        CreateMetaIssueTypeBean issueType = new CreateMetaIssueTypeBean(
                ...
                false,
                Examples.jiraURI("images/icons/bug.gif").toString(),
                null);

        issueType.setFields(fields);

        Map<String, String> projectAvatarUrls = MapBuilder.<String, String>newBuilder()
            .add("16x16", Examples.jiraURI("secure/projectavatar?size=small&pid=10000&avatarId=10011").toString())
