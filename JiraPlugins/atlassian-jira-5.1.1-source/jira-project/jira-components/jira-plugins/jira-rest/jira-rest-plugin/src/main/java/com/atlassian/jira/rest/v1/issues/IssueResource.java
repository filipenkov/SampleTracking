...
public class IssueResource
{
    ...
    public IssueResource(
            final JiraAuthenticationContext authContext, final ContextI18n i18n,
    ...
    {
        return new IssueActionsAndOperationsResource(authContext, issueManager, i18n, workflowManager, issueId, simpleLinkManager, xsrfTokenGenerator, issueWorkflowManager);
    }
