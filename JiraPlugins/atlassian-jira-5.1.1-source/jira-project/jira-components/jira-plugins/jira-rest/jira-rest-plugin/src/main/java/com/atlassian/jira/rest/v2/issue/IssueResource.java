...
public class IssueResource
{
                    ...
                    final AssignIssueResource assignIssueResource)
    {
        ...
        this.createIssueResource = createIssueResource;
        this.updateIssueResource = updateIssueResource;
        this.deleteIssueResource = deleteIssueResource;
        this.remoteIssueLinkResource = remoteIssueLinkResource;
        this.worklogResource = worklogResource;
        this.commentResource = commentResource;
        this.issueWorkflowManager = issueWorkflowManager;
        this.assignIssueResource = assignIssueResource;
    }
            ...
            @QueryParam ("fields") List<StringList> fields, @QueryParam("expand") String expand)
    {
        ...
        final IssueBean bean = beanBuilderFactory.newIssueBeanBuilder(issue, include).expand(expand).build();
     ...
     *
     * @response.representation.200.example
     *      {@link IssueResourceExamples#CREATE_RESPONSE_200}
     *
     * @response.representation.400.doc
    ...
    {
        return worklogResource.getWorklog(worklogId);
    }
    ...
    public Response getComments(@PathParam ("issueIdOrKey") final String issueIdOrKey)
    {
      return commentResource.getComments(issueIdOrKey);
    }
    ...
    {
       return commentResource.getComment(issueIdOrKey, commentId);
    }
    ...
    @PUT
    @Path ("{issueIdOrKey}/comment/{id}")
    public Response updateComment(@PathParam ("issueIdOrKey") final String issueIdOrKey, @PathParam ("id") final String commentId, CommentJsonBean request)
    {
        return commentResource.updateComment(issueIdOrKey, commentId, request);
    }
    ...
    @POST
    @Path ("{issueIdOrKey}/comment")
    public Response addComment(@PathParam ("issueIdOrKey") final String issueIdOrKey, CommentJsonBean request)
    {
        return commentResource.addComment(issueIdOrKey, request);
    }
