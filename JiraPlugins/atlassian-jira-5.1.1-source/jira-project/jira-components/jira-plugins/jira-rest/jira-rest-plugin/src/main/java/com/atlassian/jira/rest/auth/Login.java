...
public class Login
{
    ...
    public Login(final LoginService loginService, final JiraAuthenticationContext jiraAuthenticationContext, final VelocityRequestContextFactory velocityRequestContextFactory, ContextI18n i18n)
    {
