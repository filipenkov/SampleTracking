...
import com.atlassian.jira.rest.v1.admin.IssueTypeSchemeResource;
...
public class ProjectBean
{
    ...
    static
    {
        ...
        project.avatarUrls = MapBuilder.<String, String>newBuilder()
                .add("16x16", Examples.jiraURI("secure/projectavatar?size=small&pid=10000").toString())
    ...
    static
    {
        ...
        project.avatarUrls = MapBuilder.<String, String>newBuilder()
                .add("16x16", Examples.jiraURI("secure/projectavatar?size=small&pid=10001").toString())
    ...
    ProjectBean(URI self, String id, String key, String name, String description, UserBean lead, Long assigneeType,  String url, Collection<ComponentBean> components,
            Collection<VersionBean> versions, Collection<IssueTypeJsonBean> issueTypes, final Map<String, URI> roles, final Map<String, String> avatarUrls)
    {
        this.self = self;
        this.id = id;
        this.key = key;
