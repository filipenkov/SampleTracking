...
import com.atlassian.jira.rest.v2.issue.context.NoopContextI18n;
...
public class TestVersionResource
{
    ...
    public void testCreateVersionWithoutProject() throws Exception
    {
        ...
        VersionResource resource = new VersionResource(versionService, projectService, context, new NoopContextI18n(), versionBeanFactory, null, null);
