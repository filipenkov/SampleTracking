...
public class SearchResource
{
     ...
     * @param fields the list of fields to return for each issue. By defailt, all navigable fields are returned.
     ...
     */
    @GET
    public SearchResultsBean search(@QueryParam ("jql") String jql, @QueryParam ("startAt") Integer startAt, @QueryParam ("maxResults") Integer maxResults, @QueryParam ("fields") List<StringList> fields, @QueryParam ("expand") StringList expand)
    ...
    public SearchResultsBean searchUsingSearchRequest(SearchRequestBean searchRequest) throws SearchException
    {
        ...
        return search(searchRequest.jql, searchRequest.startAt, searchRequest.maxResults, fields, expand);
    }
    ...
    private class IssueToIssueBean implements Function<Issue, IssueBean>
    {
        ...
        {
            IssueBean bean = beanBuilderFactory.newIssueBeanBuilder(issue, fields).build();
