 ...
 */
JIRA.Admin.Component.ComponentModel = AJS.RestfulTable.EntryModel.extend({
    ...
    changedAttributes: function (attributes) {
        ...
        var currentLead = this.get("lead"),
            ...
            changed = AJS.RestfulTable.EntryModel.prototype.changedAttributes.call(this, attributes);
    ...
    isLeadPickerDisabled: function () {
        return AJS.params.leadPickerDisabled;
    },
    ...
    getProjectLeadAssignee: function () {
        return AJS.params.projectLeadAssignee;
    },
    ...
    isDefaultAssigneeProjectLead: function () {
        return AJS.params.isDefaultAssigneeProjectLead;
    },
