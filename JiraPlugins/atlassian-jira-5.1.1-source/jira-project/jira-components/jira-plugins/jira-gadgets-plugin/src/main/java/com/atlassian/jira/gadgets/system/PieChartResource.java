...
public class PieChartResource extends SearchQueryBackedResource
{
    ...
    public static class PieChart
    {
        ...
        PieChart(String location, String filterTitle, String filterUrl, long issueCount, String statType, String imageMap, String imageMapName, DataRow[] data, int width, int height)
        {
