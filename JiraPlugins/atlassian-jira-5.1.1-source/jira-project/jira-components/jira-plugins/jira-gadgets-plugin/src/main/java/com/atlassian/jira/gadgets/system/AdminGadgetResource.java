...
public class AdminGadgetResource
{
    ...
    public static class AdminProperties
    {
        ...
        private AdminProperties(AdminGadgetResource resource, List<String> warningMessages)
        {
            ...
            isBonfireInstalled = resource.pluginAccessor.getPlugin("com.atlassian.bonfire.plugin") != null;
            isBonfireEnabled = resource.pluginAccessor.isPluginEnabled("com.atlassian.bonfire.plugin");
