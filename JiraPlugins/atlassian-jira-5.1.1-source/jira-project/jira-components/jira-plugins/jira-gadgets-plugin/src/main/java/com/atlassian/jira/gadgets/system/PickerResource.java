...
public class PickerResource
{
    ...
    public FilterPickerWrapper getFilters(String query)
    {
        ...
        final SharedEntitySearchResult<SearchRequest> searchResults = searchRequestManager.search(builder.toSearchParameters(), authenticationContext.getLoggedInUser(), 0, 10);
