...
public class ProjectGadgetResource extends AbstractResource
{
    ...
    public ProjectGadgetResource(final JiraAuthenticationContext authenticationContext, final PermissionManager permissionManager,
            ...
            final SearchService searchService, final SimpleLinkManager simpleLinkManager, final ProjectDescriptionRenderer projectDescriptionRenderer)
    {
    ...
    private Project validateProject(Collection<ValidationError> errors, String projectIdStr)
    {
        try
        {
            ...
            if (projectObj == null || !permissionManager.hasPermission(Permissions.BROWSE, projectObj, authenticationContext.getLoggedInUser()))
            {
    ...
    private DetailedProjectData getProjectDataNoPermissionCheck(User user, Project project, boolean showStats)
    {
        ...
        {
            projectDescription = projectDescriptionRenderer.getViewHtml(project);
    ...
    {
        return new FieldVisibilityBean().isFieldVisible(project.getId(), IssueFieldConstants.PRIORITY, FieldVisibilityManager.ALL_ISSUE_TYPES);
    }
