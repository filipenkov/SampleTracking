...
public class IntroductionResource
{
    ...
    public IntroductionResource(final JiraAuthenticationContext authenticationContext, final PermissionManager permissionManager, final ProjectManager projectManager, final VelocityRequestContextFactory velocityRequestContextFactory, IntroductionProperty introductionProperty)
    {
    ...
    public Response getIntro() throws Exception
    {
        ...
        if (StringUtils.isBlank(html))
        {
            ...
            if (isAdmin)
            {
                ...
                {
                    final String createProjectHref = baseUrl + "/secure/admin/AddProject!default.jspa?nextAction=browseproject";
                    builder.append(i18n.getText("gadget.introduction.thanksforchoosing.title", "<h1>", "</h1>"));
