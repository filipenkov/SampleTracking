...
public class TwoDimensionalStatsResource extends SearchQueryBackedResource
{
    ...
    {
        Collector aHitCollector = new TwoDimensionalTermHitCollector(statsMap, issueIndexManager.getIssueSearcher().getIndexReader(),
                fieldVisibilityManager, readerCache, null, fieldManager);
        try
        {
