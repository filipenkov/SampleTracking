...
public class TestFiltersAndProjectsResource extends TestCase
{
    ...
    public void testFoo()
    {
        ...
        expect(pm.getProjectObjects(Permissions.BROWSE, user)).andReturn(list);
