...
public class TestHeatMapResource extends TestCase {
    ...
    public void testCreateSearchUrl() {
        ...
        final HeatMapResource hmr = new HeatMapResource(null, null, null, null, mockSearchService, null, null, null);
    ...
    public void testCreateDataRow() {
        ...
        HeatMapResource hmr = new HeatMapResource(null, null, null, null, null, null, null, null) {
            @Override
