...
public class TestSearchQueryBackedResource extends ResourceTest
{
    ...
    protected void setUp() throws Exception
    {
        ...
        mockUser = new MockUser("user");
        expect(mockAuthCtx.getLoggedInUser()).andReturn(mockUser).anyTimes();
    ...
    public final void testGetFilterUrl_project()
    {
        Project project = stubProject(100L, "pkey", "pname");
        Map<String, Object> params = MapBuilder.<String, Object>newBuilder().add("project", project).toHashMap();
        expect(mockSearchService.getQueryString(mockUser, new QueryImpl(new TerminalClauseImpl("project", Operator.EQUALS, "pkey")))).andReturn("&jqlQuery=blah");
    ...
    public final void testGetFilterUrl_loadedSearchRequest()
    {
        ...
        SearchRequest r = new SearchRequest(mockQuery, "owner", "name", "desc", 123L, 50L);
    ...
    public final void testGetFilterUrl_notLoadedSearchRequest()
    {
        ...
        expect(mockSearchService.getQueryString(mockUser, mockQuery)).andReturn("&jqlQuery=blah");
    ...
    {
        expect(mockSearchService.getQueryString(eq(mockUser), isA(Query.class))).andReturn("&jqlQuery=foo");
