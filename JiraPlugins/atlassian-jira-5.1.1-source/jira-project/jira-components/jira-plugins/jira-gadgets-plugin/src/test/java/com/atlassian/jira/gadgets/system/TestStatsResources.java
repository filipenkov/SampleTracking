...
public class TestStatsResources extends ResourceTest
{
    ...
    private void assertCorrectForQueryType(String type)
    {
        ...
        assertThat(results.rows, hasItems(
                new StatsResource.StatsRow("<a href='http://localhost:8090/JIRA/secure/IssueNavigator.jspa?reset=true&mode=hidelolmg'>proj1</a>", 1, 25, null),
                new StatsResource.StatsRow("<a href='http://localhost:8090/JIRA/secure/IssueNavigator.jspa?reset=true&mode=hidelolmg2'>proj2</a>", 2, 50, null),
                new StatsResource.StatsRow("<span title=\"The field is not present on some issues\">Irrelevant</span>", 1, 25, null)
        ));
    }
