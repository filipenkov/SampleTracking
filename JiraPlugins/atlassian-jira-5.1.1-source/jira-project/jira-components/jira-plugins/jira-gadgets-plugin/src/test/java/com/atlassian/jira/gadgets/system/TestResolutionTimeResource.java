...
public class TestResolutionTimeResource extends ResourceTest
{
    ...
    public void testGetChart()
    {
        ...
        final TimeChart expectedChart = new TimeChart(chartLocation, null, null, null, null, null, 700, 9000);
        ...
        ResolutionTimeResource rtr = new ResolutionTimeResource(null, mockJiraAuthenticationContext, null, null, null, mockValidator, null, timeZoneManager)
        {
            ...
            @Override
            Chart generateChart(final int width, final int height, final User user, final SearchRequest searchRequest, final ChartFactory.PeriodName period, final int daysInt)
            {
        ...
        Response chart = rtr.getChart(query, testNumDays, testPeriodName, false, 700, 9000);
