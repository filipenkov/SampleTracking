...
public class EditLookAndFeel extends com.atlassian.jira.web.action.admin.EditLookAndFeel
{
    ...
    public EditLookAndFeel(UserPickerSearchService searchService,
            ...
            UploadService uploadService, FeatureManager featureManager, PluginAccessor pluginAccessor, IntroductionProperty introduction)
    {
        this(searchService, userFormatManager, ComponentAccessor.getComponent(UserFormatTypeConfiguration.class),
                ...
                lookAndFeelProperties, pluginSettingsFactory, uploadService, featureManager, pluginAccessor,
                ComponentAccessor.getComponent(GzipCompression.class), introduction);
    }
    ...
    private EditLookAndFeel(final UserPickerSearchService searchService, final UserFormatManager userFormatManager,
            ...
            final LocaleManager localeManager, ApplicationProperties applicationProperties,
            final JiraAuthenticationContext authenticationContext, VelocityRequestContextFactory requestContextFactory,
            ...
            final UploadService uploadService, final FeatureManager featureManager, final PluginAccessor pluginAccessor,
            GzipCompression gzipCompression, IntroductionProperty introduction)
    {
        super(searchService, userFormatManager, userFormatTypeConfiguration, userFormatTypes, userFormatModuleDescriptors,
                i18nBeanFactory, localeManager, timeZoneService, rendererManager, pluginAccessor, gzipCompression,
                featureManager, introduction);
        ...
        try
        {
            switch(choice) {
                case JIRA:
                    ...
                    if (choice != lookAndFeelProperties.getFaviconChoice())
                    {
