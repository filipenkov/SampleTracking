...
public class TestAbstractMessageHandlerUsingMessageFilesFromMultiClients extends AbstractTestMessageHandler
{
    ...
    public void setUp() throws Exception
    {
        ...
        if (issue == null)
        {
            GenericValue issueGv = UTUtils.getTestEntity("Issue",
            ...
            issue = issueObject = getIssueFactory().getIssue(issueGv);
        }
    ...
    protected AttachmentRecorderAttachmentManager getAttachmentManager() {
    ...
    @Test public void testGmailHtmlImageAttached() throws Exception
    {
    ...
    @Test public void testGmailHtmlInlineImage()
    {
        // GMAIL DOESNT support inline images properly
    }

    @Test public void testGmailHtmlBinaryAttached() throws Exception
    {
    ...
    @Test public void testGMailHtmlWithPlainTextAttachment() throws Exception
    {
    ...
    @Test public void testGMailHtmlWithHtmlAttachment() throws Exception
    {
    ...
    @Test public void testEvolutionPlainText() throws Exception
    {
    ...
    @Test public void testEvolutionHtml() throws Exception
    {
    ...
    @Test public void testEvolutionHtmlInlineImage() throws Exception
    {
    ...
    @Test public void testEvolutionImageAttached() throws Exception
    {
    ...
    @Test public void testEvolutionHtmlBinaryAttached() throws Exception
    {
    ...
    @Test public void testEvolutionHtmlWithPlainTextAttachment() throws Exception
    {
    ...
    @Test public void testEvolutionHtmlWithHtmlAttachment() throws Exception
    {
    ...
    @Test public void testEvolutionPlainTextWithPlainTextAttachment() throws Exception
    {
    ...
    @Test public void testEvolutionPlainTextWithHtmlAttachment() throws Exception
    {
    ...
    @Test public void testEvolutionPlainTextWithImageAttachment() throws Exception
    {
    ...
    @Test public void testEvolutionPlainTextWithBinaryAttachment() throws Exception
    {
    ...
    @Test public void testAppleText() throws Exception
    {
    ...
    @Test public void testAppleHtml() throws Exception
    {
    ...
    @Test public void testAppleHtmlInlineImage() throws Exception
    {
    ...
    @Test public void testAppleHtmlBinaryAttached() throws Exception
    {
    ...
    @Test public void testAppleHtmlPlainTextAttached() throws Exception
    {
    ...
    @Test public void testAppleHtmlWithHtmlFileAttached() throws Exception
    {
    ...
    SimpleMockAbstractMessageHandler createAbstractMessageHandler()
    {
        ...
        return new SimpleMockAbstractMessageHandler(applicationProperties,
                jiraApplicationContext);
    }

    class SimpleMockAbstractMessageHandler extends MockAbstractMessageHandler
    {
        SimpleMockAbstractMessageHandler(final ApplicationProperties applicationProperties,
    ...
    Collection<SimpleAttachment> createThenReturnAttachments(final Message message, final SimpleMockAbstractMessageHandler handler)
    {
        try
        {
            final Collection<ChangeItemBean> parts = handler.createAttachmentsForMessage(message, issue, context);
        ...
        {
            throw new RuntimeException("Unable to get the attachments for the message, message: \"" + e.getMessage() + "\"...", e);
        }
    }
    ...
    static class AttachmentRecorderAttachmentManager implements AttachmentManager
    {
        ...
        public ChangeItemBean createAttachment(final File file, final String filename, final String contentType,
                final User remoteUser, final GenericValue issue) throws AttachmentException
        {
        ...
        @Override
        public ChangeItemBean createAttachment(final File file, final String filename, final String contentType,
                final User remoteUser, final Issue issue) throws AttachmentException
        {
            final String cleanContentType = MailUtils.getContentType(contentType);
            this.attachments.add(new SimpleAttachment(filename, cleanContentType));
            // don't care about the ChangeItemBean in our tests
