...
public interface ShareService
{
    ...
    {
        protected final User remoteUser;
        protected final ShareBean shareBean;

        public ValidateShareResult(ErrorCollection errorCollection, final User remoteUser, final ShareBean shareBean)
        {
    ...
    static class ValidateShareIssueResult extends ValidateShareResult
    {
        ...
        public ValidateShareIssueResult(ErrorCollection errorCollection, final User remoteUser, final ShareBean shareBean, final Issue issue)
        {
    ...
    static class ValidateShareSearchRequestResult extends ValidateShareResult
    {
        ...
        public ValidateShareSearchRequestResult(ErrorCollection errorCollection, final User remoteUser, final ShareBean shareBean, final SearchRequest SearchRequest)
        {
            super(errorCollection, remoteUser, shareBean);
