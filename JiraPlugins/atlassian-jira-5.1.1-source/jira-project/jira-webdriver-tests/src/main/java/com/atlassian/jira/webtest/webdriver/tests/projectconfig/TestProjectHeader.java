...
public class TestProjectHeader extends BaseJiraWebTest
{
    ...
    public void testCorrectDefaultProjectDetails()
    {
        ...
        assertEquals(header.getProjectCategoryLink(), baseUrl + "/secure/project/SelectProjectCategory!default.jspa?pid=10000");
    }
    ...
    public void testCorrectCustomisedProjectDetails()
    {
        ...
        assertEquals(header.getProjectCategoryLink(), baseUrl + "/secure/project/SelectProjectCategory!default.jspa?pid=10001");
