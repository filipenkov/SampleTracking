...
public class TestAssociateIssueOperationToScreen extends BaseJiraWebTest
{
    ...
    {
        backdoor.restoreBlankInstance();
        jira.gotoLoginPage().loginAsSysAdmin(ConfigureScreenScheme.class, SCREEN_SCHEME_ID);
        assertAssociateScreen(new Function<Void, AssociateIssueOperationToScreen>()
        {
            @Override
            public AssociateIssueOperationToScreen apply(@Nullable Void input)
    ...
    public void associateScreenFormWebSudo()
    {
        ...
        final PageWithArgs<AdminSummaryPage> cancelPage = PageWithArgs.create(AdminSummaryPage.class);
    ...
    {
        final ConfigureScreenScheme page = jira.gotoLoginPage().loginAsSysAdmin(ConfigureScreenScheme.class, SCREEN_SCHEME_ID);
    ...
    {
        backdoor.restoreBlankInstance();
        ConfigureScreenScheme config = jira.gotoLoginPage().loginAsSysAdmin(ConfigureScreenScheme.class, SCREEN_SCHEME_ID);
    ...
    {
        backdoor.restoreBlankInstance();
        AssociateIssueOperationToScreenPage associate = jira.gotoLoginPage().loginAsSysAdmin(AssociateIssueOperationToScreenPage.class, SCREEN_SCHEME_ID);
