...
public class TestProjectSharedBy extends BaseJiraWebTest
{
    ...
    public void testFieldLayoutScheme()
    {
        ...
        final ConfigureFieldConfigurationSchemePage configureFieldConfigurationSchemePage =
                jira.gotoLoginPage().loginAsSysAdmin(ConfigureFieldConfigurationSchemePage.class, 10000L);
        ...
        ConfigureFieldConfigurationSchemePage notUsedFieldConfigurationConfigureFieldConfigurationPage =
                jira.gotoLoginPage().loginAsSysAdmin(ConfigureFieldConfigurationSchemePage.class, 10100L);
    ...
    {
        //Check an active field layout.
        ConfigureScreenScheme configPage = jira.gotoLoginPage().loginAsSysAdmin(ConfigureScreenScheme.class, 1L);
        ...
        //Check an active system default field layout.
        configPage = jira.gotoLoginPage().loginAsSysAdmin(ConfigureScreenScheme.class, 10000L);
        ...
        //Check a field layout not used
        ConfigureScreenScheme notUsedScreenScheme = jira.gotoLoginPage().loginAsSysAdmin(ConfigureScreenScheme.class, 10001L);
    ...
    public void testIssueTypeScreenScheme()
    {
        ...
        //Check a field scheme not used
        ConfigureIssueTypeScreenSchemePage notUsedIssueTypeScreenScheme = jira.gotoLoginPage()
