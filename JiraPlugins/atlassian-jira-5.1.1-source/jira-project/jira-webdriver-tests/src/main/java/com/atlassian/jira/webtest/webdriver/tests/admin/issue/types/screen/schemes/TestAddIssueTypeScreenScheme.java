...
public class TestAddIssueTypeScreenScheme extends BaseJiraWebTest
{
    ...
    public void shouldBeAbleToAddAnIssueTypeScreenSchemeByOnlyDefiningANameForItAndSelectingTheDefaultScreenScheme()
    {
        ...
        jira.gotoLoginPage().
                loginAsSysAdmin(ViewIssueTypeScreenSchemesPage.class).
    ...
    public void shouldNotBeAbleToAddAnIssueTypeScreenSchemeGivenThatItsNameIsEmpty()
    {
        ...
        final AddIssueTypeScreenSchemeDialog addIssueTypeScreenSchemeDialog = jira.gotoLoginPage().
                loginAsSysAdmin(ViewIssueTypeScreenSchemesPage.class).
                openAddIssueTypeScreenSchemeDialog();
        ...
        assertTrue(addIssueTypeScreenSchemeDialog.isOpen());
    ...
    public void shouldBeAbleToAddAnIssueTypeScreenSchemeWhenTheLoggedInUserIsAJiraAdministrator()
    {
        ...
        jira.gotoLoginPage().
                login(ADMIN_USERNAME, ADMIN_PASSWORD, ViewIssueTypeScreenSchemesPage.class).
                openAddIssueTypeScreenSchemeDialog().
                    setName(expectedIssueTypeScreenSchemeItem.getName()).
                    setDescription(expectedIssueTypeScreenSchemeItem.getDescription()).
    ...
    @Test
    public void shouldNotBeAbleToAddAnIssueTypeScreenSchemeWhenTheLoggedInUserIsNeitherAJiraOrSystemAdministrator()
    {
        jira.gotoLoginPage().loginAndGoToHome(FRED_USERNAME, FRED_PASSWORD);
        jira.visitDelayed(ViewIssueTypeScreenSchemesPage.class);
