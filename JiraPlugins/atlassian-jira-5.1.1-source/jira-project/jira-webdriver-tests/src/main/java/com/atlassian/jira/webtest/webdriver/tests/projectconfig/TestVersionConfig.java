...
public class TestVersionConfig extends BaseJiraWebTest
{
    ...
    public void testArchiveVersionWithServerError() throws InterruptedException
    {
        ...
        waitUntilTrue(versionToArchive.hasFinishedVersionOperation());
        assertFalse(versionToArchive.isArchived());
        assertTrue("Expected an error, because anonymous user does not have sufficient permissions.", hspVersionPage.getServerError().contains("You must have browse project rights in order to view versions."));
    ...
    public void testVersionReorderingErrors()
    {
        ...
        WindowSession windowSession = jira.windowSession();
        ...
        versionPage.moveVersionAbove(versionPage.getVersionByName(VERSION_3), versionPage.getVersionByName(VERSION_4));
