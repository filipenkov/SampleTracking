...
public class TestEditProject extends BaseJiraWebTest
{
    ...
    {
        backdoor.restoreData("TestEditProjectDialog.xml");
    ...
    public void testEditWithInlineErrors()
    {
        ...
        assertEquals("The project name must not exceed 80 characters in length.", errors.get("name"));
    }
    ...
    public void testChangeAvatar()
    {
        ...
        editProjectDialog.setAvatar("10001");
        editProjectDialog.submit();

        assertEquals("10001", projectSummaryPageTab.getProjectHeader().getProjectAvatarIconId());
    }
