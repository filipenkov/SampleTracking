...
public class WorkflowHeaderDelegate implements WorkflowHeader
{
    ...
    @ElementBy(cssSelector = "header #loz-workflow-system")
    private PageElement systemLozenge;

    @ElementBy(cssSelector = "header #loz-workflow-draft")
    private PageElement draftLozenge;

    @ElementBy(cssSelector = "header #loz-workflow-active")
    private PageElement activeLozenge;

    @ElementBy(cssSelector = "header #loz-workflow-inactive")
    private PageElement inactiveLozenge;

    @ElementBy(cssSelector = "header #publish_draft_workflow")
    private PageElement publishTrigger;

    @ElementBy(cssSelector = "header #discard_draft_workflow")
    private PageElement discardTrigger;

    @ElementBy(cssSelector = "header #draft-workflow-trigger")
    private PageElement draftTrigger;

    @ElementBy (cssSelector = "header .shared-by")
    private PageElement sharedBy;

    @ElementBy (cssSelector = "header #edit-workflow-trigger")
    private PageElement renameTrigger;

    @ElementBy (cssSelector = "header #view_live_workflow")
    ...
    {
        return getTextsFromElements(finder.findAll(By.cssSelector("header .aui-message.info")));
    }

    @Override
    public List<String> getWarningMessages()
    {
        return getTextsFromElements(finder.findAll(By.cssSelector("header .aui-message.warning")));
    }

    @Override
    public WorkflowMode<?> getCurrentMode()
    {
        PageElement pageElement = finder.find(By.cssSelector(".toolbar-item.active a"));
