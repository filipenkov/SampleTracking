...
public class IssueLink
{
    ...
    private IssueLink(String elementId, String relationship, String title, String url, String summary, String iconUrl, String deleteUrl, String priorityIconUrl, String statusIconUrl, boolean resolved)
    {
    ...
    public String toString()
    {
        return new ToStringBuilder(this).
                ...
                append("statusIconUrl", statusIconUrl).
    ...
    public static class Builder
    {
        ...
        public Builder statusIconUrl(String statusIconUrl)
        {
            this.statusIconUrl = statusIconUrl;
            return this;
        }
        ...
        {
            return new IssueLink(elementId, relationship, title, url, summary, iconUrl, deleteUrl, priorityIconUrl, statusIconUrl, resolved);
        }
    }
}
