...
public class FormDialog
{
    ...
    final public void initAbstractDialog()
    {
        ...
        header = element.find(By.className("aui-popup-heading"));
    }
    ...
    {
       return isOpenTimed().now();
    }

    public TimedCondition isOpenTimed()
    {
        return getDialogElement().timed().hasClass("aui-dialog-content-ready");
    }
    ...
    {
        waitUntilTrue(form.find(By.cssSelector("div.error")).timed().isVisible());
        return this;
    }
    ...
    protected void waitUntilClosed()
    {
        ...
        waitUntilTrue(not(and(timed.isPresent(), timed.isVisible())));
    }
    ...
    protected <T extends PageElement> T find(final By locator, final Class<T> elementClass)
    {
