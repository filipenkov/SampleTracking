...
public class FieldsPanel extends AbstractJiraPage
{
    ...
    public void initialise()
    {
        ...
        schemeEditLink = elementFinder.find(By.id(CONFIGURE_LINK_ID));
    ...
    {
        return dropDown.hasItemById(CONFIGURE_LINK_ID);
    }
    ...
    {
        return dropDown.openAndClick(By.id(CONFIGURE_LINK_ID), ConfigureFieldConfigurationSchemePage.class);
    }

    public EditDefaultFieldConfigPage gotoEditDefaultFieldConfigScheme()
    {
        return dropDown.openAndClick(By.id(CONFIGURE_LINK_ID), EditDefaultFieldConfigPage.class);
    }
    ...
    public static class FieldConfigurationImpl implements FieldConfiguration
    {
        ...
        public SharedProjectsDialog openSharedProjects()
        {
            ...
            int triggerTargetStart = trigger.getAttribute("href").indexOf("#");
            final String triggerTarget = trigger.getAttribute("href").substring(triggerTargetStart + 1);
