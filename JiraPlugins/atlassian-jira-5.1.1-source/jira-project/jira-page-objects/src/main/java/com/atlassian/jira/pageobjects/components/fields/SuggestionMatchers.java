...
public class SuggestionMatchers
{
    ...
    public static Matcher<Suggestion> hasText(final String text)
    {
        return new BaseMatcher<Suggestion>()
        {
            ...
            public boolean matches(Object obj)
            {
                ...
                return suggestion.getText().equals(text);
            }
    ...
    public static Matcher<List<Suggestion>> hasNoMatches()
    {
        return new BaseMatcher<List<Suggestion>>()
        {
            ...
            public boolean matches(Object obj)
            {
                ...
                return suggestions.size() == 1 && suggestions.get(0).getText().equals("No Matches");
            }
