...
public class UserBrowserPage extends AbstractJiraPage
{
    ...
    @FindBy (name = "max")
    protected WebElement usersPerPageDropdown;
    ...
    {
        driver.findElement(By.id("user-filter-userNameFilter")).sendKeys(username);
        filterSubmit.click();
    ...
    {
        usersPerPageDropdown.findElement(By.cssSelector("option[value=\"" + MAX + "\"]")).click();
        filterSubmit.click();
    }

    private UserBrowserPage setUserFilterTo10Users()
    {
        filterUsersPerPage.select(Options.text(TEN));
        return this;
    }
