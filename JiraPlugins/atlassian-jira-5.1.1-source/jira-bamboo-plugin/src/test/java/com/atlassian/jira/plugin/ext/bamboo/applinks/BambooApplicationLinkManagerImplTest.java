...
public class BambooApplicationLinkManagerImplTest
{
    ...
    public void setup() throws Exception
    {
        ...
        app2associations = new ArrayList<String>();
        ...
        when(applink2.putProperty(eq(JBAM_ASSOCIATIONS), anyObject())).thenAnswer(new Answer<Object>()
        {
            public Object answer(InvocationOnMock invocation) throws Throwable
            {
        ...
        when(applink2.getProperty(JBAM_ASSOCIATIONS)).thenAnswer(new Answer<Object>()
        {
            public Object answer(InvocationOnMock invocationOnMock) throws Throwable
            {
                return app2associations;
            }
        });
        when(applink2.removeProperty(JBAM_ASSOCIATIONS)).thenAnswer(new Answer<Object>()
        {
            public Object answer(InvocationOnMock invocationOnMock) throws Throwable
            {
                app2associations = new ArrayList<String>();
