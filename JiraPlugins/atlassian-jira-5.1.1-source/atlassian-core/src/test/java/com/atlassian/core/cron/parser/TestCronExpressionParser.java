 ...
 *
 */
public class TestCronExpressionParser extends TestCase
{
    ...
    public void testDailySpecOncePerDay()
    {
        ...
        assertEquals(DateUtils.AM, cronExpressionParser.getHoursEntry().getRunOnceMeridian());
    ...
    public void testDailySpecEvery15MinutesForOneHourOnlyUsingRange()
    {
        ...
        assertEquals(DateUtils.AM, cronExpressionParser.getHoursEntry().getFromMeridian());
        assertEquals(9, cronExpressionParser.getHoursEntry().getTo());
        assertEquals(DateUtils.AM, cronExpressionParser.getHoursEntry().getToMeridian());
