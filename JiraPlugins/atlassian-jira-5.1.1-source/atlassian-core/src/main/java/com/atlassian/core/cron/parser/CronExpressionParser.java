 ...
 * the string against a {@link org.quartz.CronTrigger}.
 */
public class CronExpressionParser
{
    ...
    /**
     * Will provide the {@link com.atlassian.core.cron.CronEditorBean} which represents the state of the
    ...
    /**
     * Gets the {@see CronMinutesEntry} that represents the minutes cron field.
     *
    ...
    /**
     * Gets the {@see CronHoursEntry} that represents the hours cron field.
     *
    ...
    /**
     * Gets the {@see CronDayOfWeekEntry} that represents the day of week cron field.
     *
