...
{
    private static final Map<String, String> MINUTE_INCREMENT_TO_MESG_KEY = EasyMap.build(
    ...
    private static final Map<String, String> DAY_NUMBERS = EasyMap.build(
            "1", "sunday",
            "2", "monday",
            "3", "tuesday",
            "4", "wednesday",
    ...
    {
        Validate.notNull(i18n, "I18nTextProvider must nnot be null");
        this.i18n = i18n;
    }
    ...
    private String getDay(String number)
    {
        ...
        Validate.notNull(keypart, "Unable to get day for number '" + number + "'. CronEditorBean likely to be inconsistent");
    ...
    private String getDayPerMonthDescriptor(CronEditorBean bean)
    {
        ...
        if (bean.isDayOfWeekOfMonth())
        {
            ...
            desc.append(i18n.getText("cron.editor.the.of.every.month", new String[]{ordinalWeekday}));
            desc.append(" ");
            desc.append(getTimePart(bean));
        }
        else
        {
            ...
            desc.append(i18n.getText("cron.editor.the.day.of.every.month", new String[]{i18n.getText("cron.editor.nth." + bean.getDayOfMonth())}));
            desc.append(" ");
            desc.append(getTimePart(bean));
        }
        return desc.toString();
