...
public class WorkflowThumbnailServletTest
{
    ...
    public void setup() throws IOException, SAXException, InvalidWorkflowDescriptorException, ServletException
    {
        ...
        WorkflowLayoutManager layoutManager = new WorkflowLayoutManagerImpl(new MockVWDPropertySet());
        workflowImageManager = new CachingWorkflowImageManagerImpl(new WorkflowImageManagerImpl(layoutManager), jiraHome);
