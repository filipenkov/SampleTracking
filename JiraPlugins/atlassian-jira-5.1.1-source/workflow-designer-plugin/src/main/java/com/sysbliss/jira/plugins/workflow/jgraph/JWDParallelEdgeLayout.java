...
public class JWDParallelEdgeLayout extends mxGraphLayout
{
	 ...
	 */
	public JWDParallelEdgeLayout(mxGraph graph)
	{
		this(graph, 20);
	}
	 ...
	 * spacing, orientation and offset.
	 */
	public JWDParallelEdgeLayout(mxGraph graph, int spacing)
	{
		super(graph);
