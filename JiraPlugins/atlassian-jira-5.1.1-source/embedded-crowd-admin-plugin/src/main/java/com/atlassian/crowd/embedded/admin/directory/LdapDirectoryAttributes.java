...
public class LdapDirectoryAttributes
{
    ...
    public Map<String, String> toAttributesMap()
    {
        ...
        map.put(LDAPPropertiesMapper.LDAP_SECURE_KEY, String.valueOf(ldapSecure));
        ...
        map.put(LDAPPropertiesMapper.LDAP_PROPOGATE_CHANGES, String.valueOf(ldapPropogateChanges));
        map.put(LDAPPropertiesMapper.USER_DN_ADDITION, ldapUserDn);
        map.put(LDAPPropertiesMapper.GROUP_DN_ADDITION, ldapGroupDn);
        map.put(LDAPPropertiesMapper.LDAP_NESTED_GROUPS_DISABLED, String.valueOf(ldapNestedgroupsDisabled));
        map.put(LDAPPropertiesMapper.ROLES_DISABLED, String.valueOf(rolesDisabled));
        ...
        map.put(LDAPPropertiesMapper.LDAP_RELAXED_DN_STANDARDISATION, String.valueOf(ldapRelaxedDnStandardisation));
        map.put(LDAPPropertiesMapper.LDAP_USER_ENCRYPTION_METHOD, ldapUserEncryption);
        ...
        map.put(LDAPPropertiesMapper.USER_PASSWORD_KEY, ldapUserPassword);
        ...
        map.put(LDAPPropertiesMapper.LOCAL_GROUPS, String.valueOf(localGroups));
        map.put(LDAPPropertiesMapper.LDAP_POOL_INITSIZE, ldapPoolInitSize);
        map.put(LDAPPropertiesMapper.LDAP_POOL_PREFSIZE, ldapPoolPrefSize);
        map.put(LDAPPropertiesMapper.LDAP_POOL_MAXSIZE, ldapPoolMaxSize);
        ...
        map.put(SynchronisableDirectoryProperties.CACHE_SYNCHRONISE_INTERVAL, Long.toString(NumberUtils.toLong(ldapCacheSynchroniseIntervalInMin) * 60));
        map.put(LDAPPropertiesMapper.LDAP_POOL_TIMEOUT, Long.toString(TimeUnit.MILLISECONDS.convert(NumberUtils.toLong(ldapPoolTimeoutInSec), TimeUnit.SECONDS)));
        map.put(LDAPPropertiesMapper.LDAP_CONNECTION_TIMEOUT, Long.toString(TimeUnit.MILLISECONDS.convert(NumberUtils.toLong(ldapConnectionTimeoutInSec), TimeUnit.SECONDS)));
        map.put(LDAPPropertiesMapper.LDAP_READ_TIMEOUT, Long.toString(TimeUnit.MILLISECONDS.convert(NumberUtils.toLong(ldapReadTimeoutInSec), TimeUnit.SECONDS)));
        map.put(LDAPPropertiesMapper.LDAP_SEARCH_TIMELIMIT, Long.toString(TimeUnit.MILLISECONDS.convert(NumberUtils.toLong(ldapSearchTimelimitInSec), TimeUnit.SECONDS)));
