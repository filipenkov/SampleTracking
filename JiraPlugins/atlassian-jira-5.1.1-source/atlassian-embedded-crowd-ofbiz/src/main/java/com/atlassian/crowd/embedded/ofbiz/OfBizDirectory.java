...
import static com.atlassian.crowd.embedded.ofbiz.DirectoryEntity.ACTIVE;
import static com.atlassian.crowd.embedded.ofbiz.DirectoryEntity.CREATED_DATE;
import static com.atlassian.crowd.embedded.ofbiz.DirectoryEntity.DESCRIPTION;
import static com.atlassian.crowd.embedded.ofbiz.DirectoryEntity.DIRECTORY_ID;
import static com.atlassian.crowd.embedded.ofbiz.DirectoryEntity.IMPLEMENTATION;
import static com.atlassian.crowd.embedded.ofbiz.DirectoryEntity.NAME;
import static com.atlassian.crowd.embedded.ofbiz.DirectoryEntity.TYPE;
import static com.atlassian.crowd.embedded.ofbiz.DirectoryEntity.UPDATED_DATE;
...
public class OfBizDirectory extends DirectoryImpl
{
    ...
    {
        checkNotNull(directoryGenericValue);
    ...
    {
        return new OfBizDirectory(checkNotNull(genericValue), attributesGenericValues, operationGenericValues);
    }
