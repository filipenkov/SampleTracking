...
import static com.atlassian.crowd.embedded.ofbiz.ApplicationEntity.ACTIVE;
import static com.atlassian.crowd.embedded.ofbiz.ApplicationEntity.CREATED_DATE;
import static com.atlassian.crowd.embedded.ofbiz.ApplicationEntity.DESCRIPTION;
import static com.atlassian.crowd.embedded.ofbiz.ApplicationEntity.APPLICATION_ID;
import static com.atlassian.crowd.embedded.ofbiz.ApplicationEntity.NAME;
import static com.atlassian.crowd.embedded.ofbiz.ApplicationEntity.APPLICATION_TYPE;
import static com.atlassian.crowd.embedded.ofbiz.ApplicationEntity.UPDATED_DATE;
...
public class OfBizApplication extends ApplicationImpl
{
    ...
    {
        checkNotNull(applicationGenericValue);
    ...
    {
        return new OfBizApplication(checkNotNull(genericValue), remoteAddressGenericValue);
    }
