...
public class RenderMode
{
    ...
    /** Render an embedded object excluding images */
    public static final long F_EMBEDDED_OBJECTS =  0x0000000000008000;
    ...
    public static final RenderMode INLINE = RenderMode.allow(F_HTMLESCAPE | F_BACKSLASH_ESCAPE | F_PRESERVE_ENTITIES |F_PHRASES | F_IMAGES | F_EMBEDDED_OBJECTS | F_LINKS | F_LINEBREAKS | F_TEMPLATE);
    /** Render phrases and images */
    public static final RenderMode PHRASES_IMAGES = RenderMode.allow(F_HTMLESCAPE | F_BACKSLASH_ESCAPE | F_PRESERVE_ENTITIES | F_PHRASES | F_IMAGES | F_EMBEDDED_OBJECTS | F_TEMPLATE);
    ...
    public boolean renderEmbeddedObjects()
    {
        return flagSet(F_EMBEDDED_OBJECTS);
    }
