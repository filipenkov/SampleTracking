...
public class TestHomeAction extends TestCase
{
	private SupportToolsHerculesScanAction action;

	@Override
	protected void setUp() throws Exception
	{
		super.setUp();
		this.action = new SupportToolsHerculesScanAction(new MockApplicationInfo());
	}
