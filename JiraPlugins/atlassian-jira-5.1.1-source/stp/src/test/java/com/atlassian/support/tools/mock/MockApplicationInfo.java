...
public class MockApplicationInfo extends AbstractSupportApplicationInfo implements Serializable
{
	...
	{
		return getPatternSourceByURL("https://confluence.atlassian.com/download/attachments/179443532/confluence_regex.xml");
	}
	...
	{
		return new MultiValuePropertyStore();
	}
