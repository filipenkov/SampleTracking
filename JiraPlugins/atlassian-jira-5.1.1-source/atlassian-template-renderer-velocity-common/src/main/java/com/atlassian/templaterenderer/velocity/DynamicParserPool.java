...
import static org.apache.commons.pool.impl.GenericObjectPool.Config;
...
public class DynamicParserPool implements ParserPool
{
    ...
    {
        return "DynamicParserPool{config=" + reflectionToString(config, SHORT_PREFIX_STYLE) + '}';
    }
