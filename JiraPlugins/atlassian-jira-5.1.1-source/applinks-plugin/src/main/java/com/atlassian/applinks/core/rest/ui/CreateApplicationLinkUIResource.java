...
import com.atlassian.applinks.core.rest.model.*;
    ...
    public javax.ws.rs.core.Response tryToFetchManifest(@QueryParam("url") String url)
    {
        ...
        catch (ManifestNotFoundException e)
        {
            ...
            if (responseException != null)
            {
                ...
                {
                    return ok(new ResponseInfoEntity("applinks.warning.unknown.host", i18nResolver.getText("applinks.warning.unknown.host")));
                }
            }
        }
        catch (Exception e)
