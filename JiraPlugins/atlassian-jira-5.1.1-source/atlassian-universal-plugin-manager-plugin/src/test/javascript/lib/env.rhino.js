...
__extend__(HTMLDocument.prototype, {
    createElement: function(tagName){
          ...
          if(     upperTag.match(/^A$/))                 {node = new HTMLAnchorElement(this);}
          else if(upperTag.match(/^AREA$/))              {node = new HTMLAreaElement(this);}
          else if(upperTag.match(/BASE/))                {node = new HTMLBaseElement(this);}
          else if(upperTag.match(/BLOCKQUOTE|Q/))        {node = new HTMLQuoteElement(this);}
          else if(upperTag.match(/BODY/))                {node = new HTMLBodyElement(this);}
          else if(upperTag.match(/BR/))                  {node = new HTMLElement(this);}
          else if(upperTag.match(/BUTTON/))              {node = new HTMLButtonElement(this);}
          else if(upperTag.match(/CAPTION/))             {node = new HTMLElement(this);}
          else if(upperTag.match(/COL|COLGROUP/))        {node = new HTMLTableColElement(this);}
          else if(upperTag.match(/DEL|INS/))             {node = new HTMLModElement(this);}
          else if(upperTag.match(/DIV/))                 {node = new HTMLDivElement(this);}
          else if(upperTag.match(/DL/))                  {node = new HTMLElement(this);}
          else if(upperTag.match(/FIELDSET/))            {node = new HTMLFieldSetElement(this);}
          else if(upperTag.match(/FORM/))                {node = new HTMLFormElement(this);}
          else if(upperTag.match(/^FRAME$/))             {node = new HTMLFrameElement(this);}
          else if(upperTag.match(/FRAMESET/))            {node = new HTMLFrameSetElement(this);}
          else if(upperTag.match(/H1|H2|H3|H4|H5|H6/))   {node = new HTMLElement(this);}
          else if(upperTag.match(/HEAD/))                {node = new HTMLHeadElement(this);}
          else if(upperTag.match(/HR/))                  {node = new HTMLElement(this);}
          else if(upperTag.match(/HTML/))                {node = new HTMLElement(this);}
          else if(upperTag.match(/IFRAME/))              {node = new HTMLIFrameElement(this);}
          else if(upperTag.match(/IMG/))                 {node = new HTMLImageElement(this);}
          else if(upperTag.match(/INPUT/))               {node = new HTMLInputElement(this);}
          else if(upperTag.match(/LABEL/))               {node = new HTMLLabelElement(this);}
          else if(upperTag.match(/LEGEND/))              {node = new HTMLLegendElement(this);}
          else if(upperTag.match(/^LI$/))                {node = new HTMLElement(this);}
          else if(upperTag.match(/LINK/))                {node = new HTMLLinkElement(this);}
          else if(upperTag.match(/MAP/))                 {node = new HTMLMapElement(this);}
          else if(upperTag.match(/META/))                {node = new HTMLMetaElement(this);}
          else if(upperTag.match(/OBJECT/))              {node = new HTMLObjectElement(this);}
          else if(upperTag.match(/OL/))                  {node = new HTMLElement(this);}
          else if(upperTag.match(/OPTGROUP/))            {node = new HTMLOptGroupElement(this);}
          else if(upperTag.match(/OPTION/))              {node = new HTMLOptionElement(this);;}
          else if(upperTag.match(/^P$/))                 {node = new HTMLElement(this);}
          else if(upperTag.match(/PARAM/))               {node = new HTMLParamElement(this);}
          else if(upperTag.match(/PRE/))                 {node = new HTMLElement(this);}
          else if(upperTag.match(/SCRIPT/))              {node = new HTMLScriptElement(this);}
          else if(upperTag.match(/SELECT/))              {node = new HTMLSelectElement(this);}
          else if(upperTag.match(/STYLE/))               {node = new HTMLStyleElement(this);}
          else if(upperTag.match(/TABLE/))               {node = new HTMLTableElement(this);}
          else if(upperTag.match(/TBODY|TFOOT|THEAD/))   {node = new HTMLTableSectionElement(this);}
          else if(upperTag.match(/TD|TH/))               {node = new HTMLTableCellElement(this);}
          else if(upperTag.match(/TEXTAREA/))            {node = new HTMLTextAreaElement(this);}
          else if(upperTag.match(/TITLE/))               {node = new HTMLTitleElement(this);}
          else if(upperTag.match(/TR/))                  {node = new HTMLTableRowElement(this);}
          else if(upperTag.match(/UL/))                  {node = new HTMLElement(this);}
          else{
