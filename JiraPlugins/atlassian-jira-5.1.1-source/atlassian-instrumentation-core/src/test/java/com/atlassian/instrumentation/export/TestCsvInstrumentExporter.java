...
/**
 */
public class TestCsvInstrumentExporter extends TestCase
{
    public void testNullInput() throws IOException
    {
        CsvInstrumentExporter exporter = new CsvInstrumentExporter();
        try
        {
    ...
    {
        InstrumentExporter exporter = new CsvInstrumentExporter();
    ...
    public void testEmptyList() throws IOException
    {
        ...
        assertEquals("#name, value, type, count, time, size\n", actual);
    }
    ...
    public void testBasicExport() throws IOException
    {
        ...
        String actual = export(instruments);
        assertEquals("#name, value, type, count, time, size\nname1,666,opInstrument,333,666,999,1212\n", actual);
    }
    ...
    public void testMoreTypes() throws IOException
    {
        ...
        assertEquals("#name, value, type, count, time, size\n"
                + "ag1,123,gauge\n"
                + "ac1,456,counter\n"
                + "aac1,666,absoluteCounter\n"
                + "dac1,789,derivedCounter\n"
                , actual);
    }
