...
/**
 */
public class TestJsonInstrumentExporter extends TestCase
{
    public void testNullInput() throws IOException
    {
        JsonInstrumentExporter exporter = new JsonInstrumentExporter();
        try
        {
    ...
    {
        InstrumentExporter exporter = new JsonInstrumentExporter();
    ...
    public void testBasicExport() throws IOException
    {
        ...
        String actual = export(instruments);
        assertEquals("{\"instruments\":[{\"instrument\":{\"name\":\"name1\",\"value\":\"666\",\"type\":\"opInstrument\",\"count\":\"333\",\"time\":\"666\",\"size\":\"999\",\"cpu\":\"1212\"}]}", actual);
    }
