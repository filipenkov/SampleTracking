...
/**
 * A JSON implementation of {@link com.atlassian.instrumentation.export.InstrumentExporter}
 *
 * @since v4.0
 */
public class JsonInstrumentExporter implements InstrumentExporter
{
    ...
    {
        final int posQuote = sb.lastIndexOf("\"");
