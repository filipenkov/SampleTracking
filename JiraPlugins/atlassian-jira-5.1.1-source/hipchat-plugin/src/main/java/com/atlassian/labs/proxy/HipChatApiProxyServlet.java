...
package com.atlassian.labs.proxy;
...
public class HipChatApiProxyServlet extends HttpServlet {
    ...
    private static final String ENDPOINT_HOSTNAME = "api.hipchat.com";
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        path += "?auth_token=" + configurationManager.getHipChatApiToken();
        ...
        URL url;
        try {
            url = new URL(request.getScheme(), ENDPOINT_HOSTNAME, path);
