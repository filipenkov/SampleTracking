...
public class HipChatPostFunctionFactory extends AbstractWorkflowPluginFactory implements WorkflowPluginFunctionFactory {
    ...
    public HipChatPostFunctionFactory(HipChatApiClient hipChatApiClient, ConfigurationManager configurationManager,
    ...
    protected void getVelocityParamsForInput(Map<String, Object> velocityParams) {
        ...
        if (!Strings.isNullOrEmpty(configurationManager.getHipChatApiToken())) {
            try {
                editDto = new EditDto(findAvailableRoomsDto());
    ...
    protected void getVelocityParamsForEdit(Map<String, Object> velocityParams, AbstractDescriptor descriptor) {
        ...
        if (!Strings.isNullOrEmpty(configurationManager.getHipChatApiToken())) {
            ...
            try {
                editDto = new EditDto(Lists.newArrayList(roomsToNotifyIds), jql, findAvailableRoomsDto(), isValidQuery(jql));
            } catch (ResponseException e) {
                editDto = new EditDto(true, true);
            }
        } else {
    ...
    protected void getVelocityParamsForView(Map<String, Object> velocityParams, AbstractDescriptor descriptor) {
        ...
        if (!Strings.isNullOrEmpty(configurationManager.getHipChatApiToken())) {
            ...
            try {
                ...
                final ImmutableMap<Long, HipChatApiClient.Room> roomsById = Maps.uniqueIndex(hipChatApiClient.getRooms(), new Function<HipChatApiClient.Room, Long>() {
                    @Override
                    public Long apply(HipChatApiClient.Room from) {
    ...
    private Collection<RoomDto> findAvailableRoomsDto() throws ResponseException {
        return Collections2.transform(hipChatApiClient.getRooms(), new Function<HipChatApiClient.Room, RoomDto>() {
            @Override
            public RoomDto apply(HipChatApiClient.Room from) {
    ...
    public static class ViewDto {
        ...
        public ViewDto(Collection<RoomDto> roomsToNotify, String jql, boolean jqlValid) {
    ...
    public static class EditDto {
        ...
        public EditDto(Collection<String> roomsToNotifyIds, String jql, Collection<RoomDto> rooms, boolean jqlValid) {
        ...
        public EditDto(Collection<RoomDto> rooms) {
            this(Collections.<String>emptyList(), null, rooms, true);
        }
