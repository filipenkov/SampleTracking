...
public abstract class Option<A> implements Iterable<A>
{
     ...
     */
    public abstract <B> B fold(Supplier<B> none, Function<? super A, B> some);
    ...
    /**
     * Returns {@code this} if this is a some, otherwise returns orElse.
     */
    public final Option<A> orElse(Option<A> orElse)
    {
        return fold(Suppliers.ofInstance(orElse), Option.<A>option());
    }
    ...
    private static final class Some<A> extends Option<A>
    {
        ...
        @Override
        public <B> B fold(final Supplier<B> none, final Function<? super A, B> f)
        {
