...
public class OpenSocialConsumerInformationRendererTest
{
    ...
    private static final String USER_FULL_NAME = "User One";
    ...
    public void setUp()
    {
        renderer = new OpenSocialConsumerInformationRenderer(templateRenderer, gadgetSpecFactory, gadgetRequestContextFactory, userManager, i18nResolver);
    }
    ...
    public void verifyThatRenderFetchesGadgetSpecAndWritesToTemplateRenderer() throws Exception
    {
        ...
        when(userProfile.getFullName()).thenReturn(USER_FULL_NAME);
