 ...
 *
 */
public class Jira5CompatProjectTabPanelFactory implements CompatProjectTabPanelFactory
{
    ...
    {
        return new ProjectTabPanelModuleDescriptorImpl(context, moduleFactory);
    }
    ...
    public static class AdaptingProjectTabPanel implements ProjectTabPanel
    {
        ...
        {
            return delegate.getHtml(ctx.getUser(), ctx.getProject());
        }
