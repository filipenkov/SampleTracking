...
public class RemoteDirectoryCacheRefresherTest
{
    ...
    public void synchronisingADirectoryWithMultipleGroupsWithTheSameNameFailsWithSpecificException() throws Exception
    {
        remoteDirectory = mock(RemoteDirectory.class);

        when(remoteDirectory.searchGroups(Mockito.<EntityQuery<Object>>any())).thenReturn(
                Arrays.<Object>asList(new GroupTemplate(lemmings), new GroupTemplate(lemmings))
        );
