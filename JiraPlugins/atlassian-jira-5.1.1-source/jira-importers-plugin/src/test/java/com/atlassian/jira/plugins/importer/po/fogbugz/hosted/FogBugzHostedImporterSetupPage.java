...
public class FogBugzHostedImporterSetupPage extends AbstractImporterWizardPage {
	...
	public String getUrl() {
		return "/secure/admin/views/FogBugzHostedSetupPage!default.jspa?externalSystem=com.atlassian.jira.plugins.jira-importers-plugin:fogbugzOnDemandImporter";
	}

	public FogBugzHostedProjectsMappingsPage next() {
		Assert.assertTrue(nextButton.isEnabled());
		nextButton.click();
		return pageBinder.bind(FogBugzHostedProjectsMappingsPage.class);
	}
}
