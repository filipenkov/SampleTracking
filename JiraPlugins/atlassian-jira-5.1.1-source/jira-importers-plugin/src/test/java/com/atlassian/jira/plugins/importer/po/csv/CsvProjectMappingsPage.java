...
public class CsvProjectMappingsPage extends AbstractImporterWizardPage {
	...
	public String getUserEmailSuffix() {
		return userEmailSuffix.getAttribute("value");
	}
	...
	public String getDateImportFormat() {
		return dateImportFormat.getAttribute("value");
	}
    ...
    public boolean isCreateProjectAvailable() {
        driver.findElement(By.cssSelector("#CSV-select-single-select span.drop-menu")).click();
        return driver.elementExists(By.cssSelector("#CSV-select-suggestions a[title='Create New']"));
    }

	public String getProjectName() {
		return driver.findElement(By.id("CSV_project_name")).getAttribute("value");
	}

	public String getProjectKey() {
		return driver.findElement(By.id("CSV_project_key")).getAttribute("value");
	}
