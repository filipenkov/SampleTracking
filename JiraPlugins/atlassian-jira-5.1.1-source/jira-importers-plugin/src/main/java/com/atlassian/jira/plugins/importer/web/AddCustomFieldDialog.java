...
import com.atlassian.jira.plugins.importer.customfields.SupportedCustomFieldType;
...
public class AddCustomFieldDialog extends JiraWebActionSupport {
	...
	public Map<String, String> getCustomFieldTypes() {
		...
		final Iterable<CustomFieldType> customFieldTypes = Iterables.filter(customFieldManager.getCustomFieldTypes(), new SupportedCustomFieldType());
