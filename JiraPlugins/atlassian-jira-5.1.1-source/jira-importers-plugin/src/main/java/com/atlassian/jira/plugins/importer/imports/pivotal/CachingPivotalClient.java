...
public class CachingPivotalClient extends PivotalClient {
	...
	private Collection<String> externalProjectNames;

	public CachingPivotalClient(UserNameMapper userNameMapper) {
		super(userNameMapper);
	}

	CachingPivotalClient(URI rootUri, UserNameMapper userNameMapper) {
		super(rootUri, userNameMapper);
	}

	@Override
	public Collection<String> getAllProjectNames() throws PivotalRemoteException {
		if (externalProjectNames == null) {
			externalProjectNames = super.getAllProjectNames();
		}
