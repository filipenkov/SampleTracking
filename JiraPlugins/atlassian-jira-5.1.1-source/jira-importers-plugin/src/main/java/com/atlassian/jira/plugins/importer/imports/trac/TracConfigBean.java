...
public class TracConfigBean extends AbstractDatabaseConfigBean {
	...
	public List<String> getExternalProjectNames() {
		return Lists.newArrayList(StringUtils.defaultIfEmpty(environmentConfiguration.getString("descr"), "Trac Project"));
	}
    ...
    public Map<String, Map<String, String>> getAvailableFieldMappings(ExternalCustomField customField, final Set<ExternalProject> projects) {
        ...
        fieldMappings.put(getI18n().getText("admin.csv.import.mappings.custom.fields.header"),
                getAvailableCustomFieldMappings(customField, projects));
