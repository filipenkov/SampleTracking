...
public class ExternalProject implements NamedExternalObject {
    ...
    public void setVersions(@Nullable Collection<ExternalVersion> versions) {
        this.versions = versions != null ? ImmutableSet.copyOf(versions) : null;
    }
    ...
    public void setComponents(@Nullable Collection<ExternalComponent> components) {
        this.components = components != null ? ImmutableSet.copyOf(components) : null;
    }
    ...
    public void setIssues(@Nullable List<ExternalIssue> issues) {
        this.issues = issues != null ? ImmutableList.copyOf(issues) : null;
    }
}
