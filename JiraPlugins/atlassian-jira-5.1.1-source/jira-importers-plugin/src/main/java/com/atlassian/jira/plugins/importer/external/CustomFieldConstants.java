...
public class CustomFieldConstants {
    ...
    public static final String MULTIUSER_PICKER_FIELD_TYPE = CreateCustomField.FIELD_TYPE_PREFIX + "multiuserpicker";

    public static final String GROUP_PICKER_FIELD_TYPE = CreateCustomField.FIELD_TYPE_PREFIX + "grouppicker";

    public static final String MULTIGROUP_PICKER_FIELD_TYPE = CreateCustomField.FIELD_TYPE_PREFIX + "multigrouppicker";
    ...
    public static final String LABELS_TYPE = CreateCustomField.FIELD_TYPE_PREFIX + "labels";
}
