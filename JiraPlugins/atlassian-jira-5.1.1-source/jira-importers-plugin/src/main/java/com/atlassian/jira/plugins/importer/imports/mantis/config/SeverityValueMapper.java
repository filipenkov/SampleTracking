...
public class SeverityValueMapper extends AbstractValueMappingDefinition {
	...
	protected SeverityValueMapper(final AbstractDatabaseConfigBean configBean,
	...
	public Set<String> getDistinctValues() {
		return Sets.newHashSet(jdbcConnection.queryDb(new SeverityToPriorityValueMapper.SeverityTransformer()));
	}
}
