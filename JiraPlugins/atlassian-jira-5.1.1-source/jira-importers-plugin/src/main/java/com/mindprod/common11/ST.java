 ...
 * <p/>
 * Augmented by com.mindprod.common15.ST for JDK 1.5+.
 * <p/>
 *
 * @author Roedy Green, Canadian Mind Products
 * @version 2.6 2010-02-11 removed removeHead (redundant - same as chopLeadingString).
 *          renamed chopLeading to chopLeadingString to clearify does not trim a variety of chars.
...
public class ST
     ...
     * It can also me though of as like an indexOf that scans for multiple characters at once.
     *
     ...
     * Enhanced version available in com.mindprod.common11.ST for JDK 1.5+.
     *
     ...
     *
     * @param text        text with possible trailing characters, possibly empty, but not null.
     * @param charsToTrim the leading characters of interest, usually ' ' or '\n'
     *
     ...
     *
     * @param text        text with possible trailing characters, possibly empty, but not null.
     * @param charsToTrim the trailing characters of interest, usually ' ' or '\n'
     *
