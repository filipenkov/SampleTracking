 ...
 *
 * Copyright: (c) 1997-2011 Roedy Green, Canadian Mind Products, http://mindprod.com
 *
 ...
 * datestamp form). BigDate objects are not designed for <strong>storing</strong> dates in a database, just for conversion. Long
 ...
 * happened.
 * <p/>
 * Britain and its territories (including the USA and Canada) adopted the Gregorian correction in 1752: <strong>Yes</strong>.  By
 ...
 * recent dates. <strong>You must recompile BigDate with the <strong>isBritish</strong> boolean changed to true.</strong>. It was used by
 ...
 * @version 5.7 2011-02-09 add toOrdinal ( yyyy_mm_dd ), throw NumberFormatException instead of IllegalArgumentException.
...
public final class BigDate implements Cloneable, Serializable, Comparable
     ...
     * @see #NORMALISE
     */
    public static final int NORMALIZE;// same as NORMALISE
    ...
    /**
     * Convert ISO date string in form YYYY-MM-DD into days since the 1970-01-01. This method lets you convert directly from
